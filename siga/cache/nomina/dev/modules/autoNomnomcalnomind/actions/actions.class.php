 ...
 */
class autoNomnomcalnomindActions extends sfActions
{
  public function executeIndex()
  {
    return $this->forward('nomnomcalnomind', 'list');
  }
  ...
  {
    return $this->forward('nomnomcalnomind', 'edit');
  }
  ...
  public function executeEdit()
  {
    ...
    $this->Bitacora('Guardo');
      ...
      {
        return $this->redirect('nomnomcalnomind/edit?id='.$this->npnomina->getId());
      }
    }
    else
    {
  ...
  public function SalvarBitacora($id, $acc)
  {
    try{
      ...
      $segbitaco->setCodmod('nomnomcalnomind');

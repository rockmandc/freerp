...
<?php echo form_tag('nomdefesptipnom/save', array(
...
<div class="form-row">
  <?php echo label_for('npnomina[codban]', __($labels['npnomina{codban}']), '') ?>
...
<div class="form-row">
  <?php echo label_for('npnomina[numcue]', __($labels['npnomina{numcue}']), '') ?>
...
<div class="form-row">
  <?php echo label_for('npnomina[codcta]', __($labels['npnomina{codcta}']), '') ?>

 ...
 */
class autoNomdefesptipnomActions extends sfActions
{
  public function executeIndex()
  {
    return $this->forward('nomdefesptipnom', 'list');
  }
  ...
  {
    return $this->forward('nomdefesptipnom', 'edit');
  }
  ...
  protected function processFilters()
  {
    if ($this->getRequest()->hasParameter('filter'))
    {
      ...
      $this->getUser()->getAttributeHolder()->removeNamespace('sf_admin/npnomina/filters');
      $this->getUser()->getAttributeHolder()->add($filters, 'sf_admin/npnomina/filters');
    }
  }
  ...
  protected function processSort()
  {
    ...
    {
      $this->getUser()->setAttribute('sort', 'codnom', 'sf_admin/npnomina/sort');
      $this->getUser()->setAttribute('type', 'asc', 'sf_admin/npnomina/sort');
    }
  }
   ...
   protected function addFiltersCriteria($c)
  {
    ...
    {
      $criterion = $c->getNewCriterion(NpnominaPeer::CODNOM, '');
      $criterion->addOr($c->getNewCriterion(NpnominaPeer::CODNOM, null, Criteria::ISNULL));
      $c->add($criterion);
    }
    else if (isset($this->filters['codnom']) && $this->filters['codnom'] !== '')
    {
      $c->add(NpnominaPeer::CODNOM, '%'.strtr($this->filters['codnom'], '*', '%').'%', Criteria::LIKE);
    $c->setIgnoreCase(true);
    }
    if (isset($this->filters['nomnom_is_empty']))
    {
      $criterion = $c->getNewCriterion(NpnominaPeer::NOMNOM, '');
      $criterion->addOr($c->getNewCriterion(NpnominaPeer::NOMNOM, null, Criteria::ISNULL));
      $c->add($criterion);
    }
    else if (isset($this->filters['nomnom']) && $this->filters['nomnom'] !== '')
    {
      $c->add(NpnominaPeer::NOMNOM, '%'.strtr($this->filters['nomnom'], '*', '%').'%', Criteria::LIKE);
    $c->setIgnoreCase(true);
    }
  }
  ...
  protected function getLabels()
  {
    return array(
      ...
      'npnomina{nomnom}' => 'Nombre:',
      'npnomina{frecal}' => 'Frecuencia de Pago:',
      'npnomina{ultfec}' => 'Desde:',
      'npnomina{profec}' => 'Hasta:',
      'npnomina{numsem}' => 'Semana Nro:',
      'npnomina{ordpag}' => 'Genera Orden de Pago:',
      'npnomina{codban}' => 'Banco:',
      'npnomina{numcue}' => 'Cuenta Bancaria:',
      'npnomina{codcta}' => 'Cuenta Contable:',
    );
  }
  ...
  public function SalvarBitacora($id, $acc)
  {
    try{
      ...
      $segbitaco->setCodmod('nomdefesptipnom');

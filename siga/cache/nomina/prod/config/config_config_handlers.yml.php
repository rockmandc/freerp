...
$this->handlers['modules/nomnomcalnomind/config/security.yml'] = new sfSecurityConfigHandler();
$this->handlers['modules/nomnomcalnomind/config/security.yml']->initialize();

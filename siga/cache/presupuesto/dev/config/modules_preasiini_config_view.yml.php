...
$response = $context->getResponse();
  ...
  $response->addMeta('title', 'Módulo Presupuesto', false, false);
  $response->addMeta('robots', 'modulo, presupuesto', false, false);
  $response->addMeta('description', 'Módulo de Presupuesto', false, false);
  $response->addMeta('keywords', 'Módulo, Presupuesto', false, false);
  ...
  $response->addJavascript('presupuesto/preasiini', '');

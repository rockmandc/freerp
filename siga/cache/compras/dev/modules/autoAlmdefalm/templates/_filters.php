...
<?php echo form_tag('almdefalm/list', array('method' => 'get','name'=>'sf_admin_filters_form')) ?>
  ...
  'size' => 15,
        ...
        <div class="form-row">
    <label for="filters_codcat"><?php echo __('Cod. Unidad Asociada:') ?></label>
    <div class="content">
  ...
  <ul class="sf_admin_actions">
    <li><?php echo button_to(__('reset'), 'almdefalm/list?filter=filter', 'class=sf_admin_action_reset_filter') ?></li>

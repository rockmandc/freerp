...
<div class="form-errors">
  <h2><?php echo __('No se puede eliminar', array('%name%' => 'Fapresup')) ?></h2>
  <ul>
...
<div class="form-errors">
  <h2><?php echo __('Validaciones', array('%name%' => 'Fapresup')) ?></h2>
  <ul>
...
<div class="form-errors">
  <h2><?php echo __('Errores', array('%name%' => 'Fapresup')) ?></h2>
  <ul>

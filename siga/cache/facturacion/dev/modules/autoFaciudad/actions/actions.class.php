...
class autoFaciudadActions extends sfActions
{
  ...
  {
    return $this->forward('faciudad', 'list');
  }
  ...
  public function executeList()
  {
    ...
    $this->filters = $this->getUser()->getAttributeHolder()->getAll('sf_admin/faciudad/filters');


     // 15    // pager
    $this->pager = new sfPropelPager('Faciudad', 15);
    $c = new Criteria();
    $this->c ? $c=$this->c : '';
  ...
  {
    return $this->forward('faciudad', 'edit');
  }
  ...
  public function executeEdit()
  {
    ...
    if ($this->getRequest()->getMethod() == sfRequest::POST)
    {
      ...
      if($this->saveFaciudad($this->faciudad) ==-1){
        {$this->setFlash('notice', 'Your modifications have been saved');

         $id= $this->faciudad->getId();
  ...
  {
    $this->faciudad = FaciudadPeer::retrieveByPk($this->getRequestParameter('id'));
    $this->forward404Unless($this->faciudad);

    try
    {
      $this->deleteFaciudad($this->faciudad);
      $id= $this->faciudad->getId();
  ...
  protected function saveFaciudad($faciudad)
  {
    ...
    try {
      ...
      $this->coderr = $this->saving($faciudad);
   ...
   *
   */
  protected function saving($faciudad)
  {
    $faciudad->save();
    return -1;
   ...
   *
   */
  protected function deleting($faciudad)
  {
  	$faciudad->delete();
    return -1;
   ...
   *
   */
  protected function deleteFaciudad($faciudad)
  {
    try {
      ...
      // OJO ----> Eliminar esta linea al modificar este método
      $this->coderr = $this->deleting($faciudad);
  ...
  protected function updateFaciudadFromRequest()
  {
    ...
    {
      if (isset($faciudad['codalmusu']))
      {
        $this->faciudad->setCodalmusu($faciudad['codalmusu']);
      }
    }
    if (isset($faciudad['faestado_id']))
    {
    $this->faciudad->setFaestadoId($faciudad['faestado_id'] ? $faciudad['faestado_id'] : null);
    }
   ...
   *
   */
  protected function getFaciudadOrCreate($id = 'id')
  {
    if (!$this->getRequestParameter($id))
    {
      $faciudad = new Faciudad();
    }
    else
    {
      $faciudad = FaciudadPeer::retrieveByPk($this->getRequestParameter($id));

      $this->forward404Unless($faciudad);
    }
  ...
  protected function processFilters()
  {
    if ($this->getRequest()->hasParameter('filter'))
    {
      ...
      $this->getUser()->getAttributeHolder()->removeNamespace('sf_admin/faciudad/filters');
      $this->getUser()->getAttributeHolder()->add($filters, 'sf_admin/faciudad/filters');
    }
  }
  ...
  protected function processSort()
  {
    ...
    {
      $this->getUser()->setAttribute('sort', $this->getRequestParameter('sort'), 'sf_admin/faciudad/sort');
      $this->getUser()->setAttribute('type', $this->getRequestParameter('type', 'asc'), 'sf_admin/faciudad/sort');
    }

    if (!$this->getUser()->getAttribute('sort', null, 'sf_admin/faciudad/sort'))
    {
    }
  }
  ...
  protected function addFiltersCriteria($c)
  {
    ...
    {
      $criterion = $c->getNewCriterion(FaciudadPeer::NOMEDO, '');
      $criterion->addOr($c->getNewCriterion(FaciudadPeer::NOMEDO, null, Criteria::ISNULL));
      $c->add($criterion);
    }
    else if (isset($this->filters['nomedo']) && $this->filters['nomedo'] !== '')
    {
      $c->add(FaciudadPeer::NOMEDO, $this->filters['nomedo']);
    }
  }
  ...
  {
    if ($sort_column = $this->getUser()->getAttribute('sort', null, 'sf_admin/faciudad/sort'))
    {
      $sort_column = FaciudadPeer::translateFieldName($sort_column, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_COLNAME);
      if ($this->getUser()->getAttribute('type', null, 'sf_admin/faciudad/sort') == 'asc')
      {
  ...
  {
    $arreglo=array(
                  'faciudad{faestado_id}' => 'Estado:',
              'faciudad{nomciu}' => 'Nombre:',
              'faciudad{id}' => 'Id:',
                          'faciudad{faestado_id}' => 'Estado:',
              'faciudad{nomciu}' => 'Nombre:',
              'faciudad{id}' => 'Id:',
 ...
 public function SalvarBitacora($id, $acc)
  {
    try{
      ...
      $segbitaco->setCodmod('faciudad');
      $segbitaco->setValcla('Faciudad');

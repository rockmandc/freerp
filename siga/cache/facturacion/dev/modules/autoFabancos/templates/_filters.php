...
<?php echo form_tag('fabancos/list', array('method' => 'get','name'=>'sf_admin_filters_form')) ?>

  <fieldset>
    <h2><?php echo __('filters') ?></h2>
    <div class="form-row">
    <label for="filters_nomban"><?php echo __('Nombre:') ?></label>
    <div class="content">
  ...
  <ul class="sf_admin_actions">
    <li><?php echo button_to(__('reset'), 'fabancos/list?filter=filter', 'class=sf_admin_action_reset_filter') ?></li>

...
<div class="form-errors">
  <h2><?php echo __('No se puede eliminar', array('%name%' => 'Facliente')) ?></h2>
  <ul>
...
<div class="form-errors">
  <h2><?php echo __('Validaciones', array('%name%' => 'Facliente')) ?></h2>
  <ul>
...
<div class="form-errors">
  <h2><?php echo __('Errores', array('%name%' => 'Facliente')) ?></h2>
  <ul>

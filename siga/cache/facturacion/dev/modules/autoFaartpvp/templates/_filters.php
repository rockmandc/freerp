...
<?php echo form_tag('faartpvp/list', array('method' => 'get','name'=>'sf_admin_filters_form')) ?>
  ...
  'size' => 15,
        ...
        <div class="form-row">
    <label for="filters_codbar"><?php echo __('Código de Barra:') ?></label>
    <div class="content">
    <?php echo input_tag('filters[codbar]', isset($filters['codbar']) ? $filters['codbar'] : null, array (
  'size' => 20,
  'maxlength' => 32,
)) ?>
    </div>
  ...
  <ul class="sf_admin_actions">
    <li><?php echo button_to(__('reset'), 'faartpvp/list?filter=filter', 'class=sf_admin_action_reset_filter') ?></li>
	...
	<script language="JavaScript" type="text/javascript">
	    if(document.sf_admin_filters_form.filters_pvpart)
	    {
	    	obj = document.sf_admin_filters_form.filters_pvpart;
			opt = obj.getElementsByTagName('optgroup');
			for (i=0;i<opt.length;i++)
		    opt[i].label='';
	    }
	...
	<script language="JavaScript" type="text/javascript">
	    if(document.sf_admin_filters_form.filters_despvp)
	    {
	    	obj = document.sf_admin_filters_form.filters_despvp;
			opt = obj.getElementsByTagName('optgroup');
			for (i=0;i<opt.length;i++)
		    opt[i].label='';
	    }

...
class autoFatipmovActions extends sfActions
{
  ...
  {
    return $this->forward('fatipmov', 'list');
  }
  ...
  public function executeList()
  {
    ...
    $this->filters = $this->getUser()->getAttributeHolder()->getAll('sf_admin/fatipmov/filters');


     // 15    // pager
    $this->pager = new sfPropelPager('Fatipmov', 15);
    $c = new Criteria();
    $this->c ? $c=$this->c : '';
  ...
  {
    return $this->forward('fatipmov', 'edit');
  }
  ...
  {
    $this->params=array();
    $this->fatipmov = $this->getFatipmovOrCreate();

    $this->editing();

    if ($this->getRequest()->getMethod() == sfRequest::POST)
    {
      $this->updateFatipmovFromRequest();

      if($this->saveFatipmov($this->fatipmov) ==-1){
        {$this->setFlash('notice', 'Your modifications have been saved');

         $id= $this->fatipmov->getId();
         $this->SalvarBitacora($id ,'Guardo');}

        if ($this->getRequestParameter('save_and_add'))
        {
          return $this->redirect('fatipmov/create');
        }
        else if ($this->getRequestParameter('save_and_list'))
        {
          return $this->redirect('fatipmov/list');
        }
        else
        {
            return $this->redirect('fatipmov/edit?id='.$this->fatipmov->getId());
        }
  ...
  {
    $this->fatipmov = FatipmovPeer::retrieveByPk($this->getRequestParameter('id'));
    $this->forward404Unless($this->fatipmov);

    try
    {
      $this->deleteFatipmov($this->fatipmov);
      $id= $this->fatipmov->getId();
   ...
   *
   */
  protected function saveFatipmov($fatipmov)
  {
    ...
    try {
      ...
      $this->coderr = $this->saving($fatipmov);
   ...
   *
   */
  protected function saving($fatipmov)
  {
    $fatipmov->save();
    return -1;
   ...
   *
   */
  protected function deleting($fatipmov)
  {
  	$fatipmov->delete();
    return -1;
   ...
   *
   */
  protected function deleteFatipmov($fatipmov)
  {
    try {
      ...
      // OJO ----> Eliminar esta linea al modificar este método
      $this->coderr = $this->deleting($fatipmov);
   ...
   *
   */
  protected function updateFatipmovFromRequest()
  {
    $fatipmov = $this->getRequestParameter('fatipmov');

    $fields = FatipmovPeer::getFieldNames();

    if(array_search('Codalmusu', $fields))
    {
      if (isset($fatipmov['codalmusu']))
      {
        $this->fatipmov->setCodalmusu($fatipmov['codalmusu']);
      }
    }
    if (isset($fatipmov['desmov']))
    {
      $this->fatipmov->setDesmov($fatipmov['desmov']);
    }
    if (isset($fatipmov['nomabr']))
    {
      $this->fatipmov->setNomabr($fatipmov['nomabr']);
    }
    if (isset($fatipmov['debcre']))
    {
      $this->fatipmov->setDebcre($fatipmov['debcre']);
    }
    if (isset($fatipmov['codcta']))
    {
      $this->fatipmov->setCodcta($fatipmov['codcta']);
    }
    if (isset($fatipmov['codtiptra']))
    {
      $this->fatipmov->setCodtiptra($fatipmov['codtiptra']);
    }
   ...
   *
   */
  protected function getFatipmovOrCreate($id = 'id')
  {
    if (!$this->getRequestParameter($id))
    {
      $fatipmov = new Fatipmov();
    }
    else
    {
      $fatipmov = FatipmovPeer::retrieveByPk($this->getRequestParameter($id));

      $this->forward404Unless($fatipmov);
    }
  ...
  protected function processFilters()
  {
    if ($this->getRequest()->hasParameter('filter'))
    {
      ...
      $this->getUser()->getAttributeHolder()->removeNamespace('sf_admin/fatipmov/filters');
      $this->getUser()->getAttributeHolder()->add($filters, 'sf_admin/fatipmov/filters');
    }
  }
  ...
  protected function processSort()
  {
    ...
    {
      $this->getUser()->setAttribute('sort', $this->getRequestParameter('sort'), 'sf_admin/fatipmov/sort');
      $this->getUser()->setAttribute('type', $this->getRequestParameter('type', 'asc'), 'sf_admin/fatipmov/sort');
    }

    if (!$this->getUser()->getAttribute('sort', null, 'sf_admin/fatipmov/sort'))
    {
      $this->getUser()->setAttribute('sort', 'desmov', 'sf_admin/fatipmov/sort');
      $this->getUser()->setAttribute('type', 'asc', 'sf_admin/fatipmov/sort');
    }
  }
  ...
  {
    if (isset($this->filters['desmov_is_empty']))
    {
      $criterion = $c->getNewCriterion(FatipmovPeer::DESMOV, '');
      $criterion->addOr($c->getNewCriterion(FatipmovPeer::DESMOV, null, Criteria::ISNULL));
      $c->add($criterion);
    }
    else if (isset($this->filters['desmov']) && $this->filters['desmov'] !== '')
    {
      $c->add(FatipmovPeer::DESMOV, strtr("%".$this->filters['desmov']."%", '*', '%'), Criteria::LIKE);
  ...
  {
    if ($sort_column = $this->getUser()->getAttribute('sort', null, 'sf_admin/fatipmov/sort'))
    {
      $sort_column = FatipmovPeer::translateFieldName($sort_column, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_COLNAME);
      if ($this->getUser()->getAttribute('type', null, 'sf_admin/fatipmov/sort') == 'asc')
      {
  ...
  {
    $arreglo=array(
                  'fatipmov{desmov}' => 'Descripción:',
              'fatipmov{nomabr}' => 'Nombre Abreviado:',
              'fatipmov{debcre}' => 'Tipo:',
              'fatipmov{codcta}' => 'Cta. Contable Asociada:',
              'fatipmov{codtiptra}' => 'Tipo de Transacción:',
                          'fatipmov{desmov}' => 'Descripción:',
              'fatipmov{nomabr}' => 'Nombre Abreviado:',
              'fatipmov{debcre}' => 'Tipo:',
              'fatipmov{codcta}' => 'Cta. Contable Asociada:',
 ...
 public function SalvarBitacora($id, $acc)
  {
    try{
      ...
      $segbitaco->setCodmod('fatipmov');
      $segbitaco->setValcla('Fatipmov');

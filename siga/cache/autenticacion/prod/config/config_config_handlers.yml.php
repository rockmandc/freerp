...
$this->handlers['config/databases.yml'] = new cidesaDatabaseConfigHandler();
...
$this->handlers['config/app.yml'] = new cidesaDefineEnvironmentConfigHandler();
...
$this->handlers['modules/*/config/security.yml'] = new cidesaSecurityConfigHandler();
...
$this->handlers['../configurations/databases.yml'] = new cidesaDatabaseConfigHandler();
$this->handlers['../configurations/databases.yml']->initialize();
$this->handlers['modules/generales/config/security.yml'] = new sfSecurityConfigHandler();
$this->handlers['modules/generales/config/security.yml']->initialize();
$this->handlers['modules/login/config/security.yml'] = new sfSecurityConfigHandler();
$this->handlers['modules/login/config/security.yml']->initialize();
$this->handlers['modules/ayudas/config/security.yml'] = new sfSecurityConfigHandler();
$this->handlers['modules/ayudas/config/security.yml']->initialize();
$this->handlers['modules/principal/config/security.yml'] = new sfSecurityConfigHandler();
$this->handlers['modules/principal/config/security.yml']->initialize();

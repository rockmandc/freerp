...
<ul class="flat">
  ...
  <li class="category">Updaters</li>
  <ul>
    <li class="task"><?php echo link_to_remote_pane('siga updater', 'sfControlPanel/taskExecute?task=propel-siga-updater') ?></li>    
    <li class="task"><?php echo link_to_remote_pane('siga updater v2', 'sfControlPanel/taskExecute?task=propel-siga-updater-v2') ?></li>    
    <li class="task"><?php echo link_to_remote_pane('siga rollback', 'sfControlPanel/taskExecute?task=propel-siga-rollback') ?></li>    
    <li class="task"><?php echo link_to_remote_pane('siga svn info', 'sfControlPanel/taskExecute?task=siga-svn-info') ?></li>    
  </ul>

 ...
 * @version SVN: $Id: OpcionesGrid.class.php 44637 2011-06-02 22:27:59Z amelendez $
 * 
...
class OpcionesGrid
{
  ...
  private $camposcomoindices=false;
...
/**
  ...
  /**
   * Indica si el grid se configura con los campos como indices
   *
   * @param $val (bool) si esta activo
   * @return bool
   */
  public function setCamposcomoindices($val){

    $this->camposcomoindices = (bool)$val;
  ...
  'jseliminar' => $this->jseliminar, 'ajaxfila' => $ajaxfila, 'ajaxcolumna' => $ajaxcolumna, 'ajaxgrid' => $ajaxgrid, 'decimal' => $decimal, 'ajaxadicionales' => $ajaxadicionales,
  'anchogrid' => $anchogrid, 'valida' => $valida, 'camposcombo'=> $camposcombo, 'onchange' => $onchange, 'comofecha' => $comofecha, 'tabindex' => $this->tabindex, 'tabindexstart' => $this->tabindexstart,
  'camposcomoindices' => $this->camposcomoindices,'ajaxupdate'=> $ajaxupdate);

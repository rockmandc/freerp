 ...
 */
  ...
  {
      $code = '<input type="hidden" id="'.$option['name'].'" name="'.$option['name'].'" value="'.$value.'">';

  	$code .= '<input value="'.$value.'" type="button" class="'.$option['class'].'" onclick="this.disabled=true;salvar'.$option['name'].'();">';

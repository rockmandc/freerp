...
class CidefnivMapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('CODCTAREC', 'Codctarec', 'string', CreoleTypes::VARCHAR, false, 32);
		...
		$tMap->addColumn('CODCTADES', 'Codctades', 'string', CreoleTypes::VARCHAR, false, 32);

		$tMap->addColumn('TIPMOVCOM', 'Tipmovcom', 'string', CreoleTypes::VARCHAR, false, 4);

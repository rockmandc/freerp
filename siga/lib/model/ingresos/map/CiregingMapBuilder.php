...
class CiregingMapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('TIPLIQ', 'Tipliq', 'string', CreoleTypes::VARCHAR, false, 20);
		...
		$tMap->addColumn('STAREC', 'Starec', 'string', CreoleTypes::VARCHAR, false, 1);

		$tMap->addColumn('FECREC', 'Fecrec', 'int', CreoleTypes::DATE, false, null);

		$tMap->addColumn('CODPAR', 'Codpar', 'string', CreoleTypes::VARCHAR, false, 5);

...
class CiimpingMapBuilder {
	...
	const CLASS_NAME = 'lib.model.ingresos.map.CiimpingMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('CODTIPRUB', 'Codtiprub', 'string', CreoleTypes::VARCHAR, false, 6);
		...
		$tMap->addColumn('DEVING', 'Deving', 'string', CreoleTypes::VARCHAR, false, 1);

...
abstract class BaseCiimping extends BaseObject  implements Persistent {
  ...
  public function getDeving()
  {

    return trim($this->deving);
  ...
  public function getId()
  {
	...
	public function setDeving($v)
	{

    if ($this->deving !== $v) {
        $this->deving = $v;
        $this->modifiedColumns[] = CiimpingPeer::DEVING;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->deving = $rs->getString($startcol + 10);
  ...
  public function get($m, $a)
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[10], $arr)) $this->setDeving($arr[$keys[10]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CiimpingPeer::DEVING)) $criteria->add(CiimpingPeer::DEVING, $this->deving);

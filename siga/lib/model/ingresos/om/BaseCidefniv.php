...
abstract class BaseCidefniv extends BaseObject  implements Persistent {
  ...
  public function getCodctarec()
  {

    return trim($this->codctarec);
  ...
  public function getCodctades()
  {

    return trim($this->codctades);

  }
  
  public function getTipmovcom()
  {

    return trim($this->tipmovcom);
  ...
  public function getId()
  {
	...
	public function setCodctarec($v)
	{

    if ($this->codctarec !== $v) {
        $this->codctarec = $v;
        $this->modifiedColumns[] = CidefnivPeer::CODCTAREC;
      }
    ...
    if ($this->rifcon !== $v) {
        $this->rifcon = $v;
        $this->modifiedColumns[] = CidefnivPeer::RIFCON;
      }
    ...
    if ($this->codtip !== $v) {
        $this->codtip = $v;
        $this->modifiedColumns[] = CidefnivPeer::CODTIP;
      }
    ...
    if ($this->tipmov !== $v) {
        $this->tipmov = $v;
        $this->modifiedColumns[] = CidefnivPeer::TIPMOV;
      }
  
	} 
	
	public function setCodctades($v)
	{

    if ($this->codctades !== $v) {
        $this->codctades = $v;
        $this->modifiedColumns[] = CidefnivPeer::CODCTADES;
      }
  
	} 
	
	public function setTipmovcom($v)
	{

    if ($this->tipmovcom !== $v) {
        $this->tipmovcom = $v;
        $this->modifiedColumns[] = CidefnivPeer::TIPMOVCOM;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->codctarec = $rs->getString($startcol + 19);

      $this->rifcon = $rs->getString($startcol + 20);

      $this->codtip = $rs->getString($startcol + 21);

      $this->tipmov = $rs->getString($startcol + 22);

      $this->codctades = $rs->getString($startcol + 23);

      $this->tipmovcom = $rs->getString($startcol + 24);
  ...
  public function get($m, $a)
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 22:
				...
				break;
			case 23:
				return $this->getCodctades();
				break;
			case 24:
				return $this->getTipmovcom();
				break;
			case 25:
				return $this->getId();
				break;
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		$result = array(
			...
			$keys[19] => $this->getCodctarec(),
			$keys[20] => $this->getRifcon(),
			$keys[21] => $this->getCodtip(),
			$keys[22] => $this->getTipmov(),
			$keys[23] => $this->getCodctades(),
			$keys[24] => $this->getTipmovcom(),
			$keys[25] => $this->getId(),
		);
		return $result;
	}
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 22:
				...
				break;
			case 23:
				$this->setCodctades($value);
				break;
			case 24:
				$this->setTipmovcom($value);
				break;
			case 25:
				$this->setId($value);
				break;
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[19], $arr)) $this->setCodctarec($arr[$keys[19]]);
		if (array_key_exists($keys[20], $arr)) $this->setRifcon($arr[$keys[20]]);
		if (array_key_exists($keys[21], $arr)) $this->setCodtip($arr[$keys[21]]);
		if (array_key_exists($keys[22], $arr)) $this->setTipmov($arr[$keys[22]]);
		if (array_key_exists($keys[23], $arr)) $this->setCodctades($arr[$keys[23]]);
		if (array_key_exists($keys[24], $arr)) $this->setTipmovcom($arr[$keys[24]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CidefnivPeer::CODCTAREC)) $criteria->add(CidefnivPeer::CODCTAREC, $this->codctarec);
		if ($this->isColumnModified(CidefnivPeer::RIFCON)) $criteria->add(CidefnivPeer::RIFCON, $this->rifcon);
		if ($this->isColumnModified(CidefnivPeer::CODTIP)) $criteria->add(CidefnivPeer::CODTIP, $this->codtip);
		if ($this->isColumnModified(CidefnivPeer::TIPMOV)) $criteria->add(CidefnivPeer::TIPMOV, $this->tipmov);
		if ($this->isColumnModified(CidefnivPeer::CODCTADES)) $criteria->add(CidefnivPeer::CODCTADES, $this->codctades);
		if ($this->isColumnModified(CidefnivPeer::TIPMOVCOM)) $criteria->add(CidefnivPeer::TIPMOVCOM, $this->tipmovcom);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setCodctarec($this->codctarec);
		...
		$copyObj->setCodctades($this->codctades);

		$copyObj->setTipmovcom($this->tipmovcom);

...
abstract class BaseCiperejePeer {
	...
	const CLASS_DEFAULT = 'lib.model.ingresos.Cipereje';
	...
	const ESTPER = 'cipereje.ESTPER';

	
	const CERRADO = 'cipereje.CERRADO';
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (CiperejePeer::FECINI, CiperejePeer::FECCIE, CiperejePeer::PEREJE, CiperejePeer::FECDES, CiperejePeer::FECHAS, CiperejePeer::ESTPER, CiperejePeer::CERRADO, CiperejePeer::ID, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (CiperejePeer::FECINI => 0, CiperejePeer::FECCIE => 1, CiperejePeer::PEREJE => 2, CiperejePeer::FECDES => 3, CiperejePeer::FECHAS => 4, CiperejePeer::ESTPER => 5, CiperejePeer::CERRADO => 6, CiperejePeer::ID => 7, ),
	...
	{
		include_once 'lib/model/ingresos/map/CiperejeMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.ingresos.map.CiperejeMapBuilder');
	}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(CiperejePeer::ESTPER);

		$criteria->addSelectColumn(CiperejePeer::CERRADO);
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/ingresos/map/CiperejeMapBuilder.php';
	Propel::registerMapBuilder('lib.model.ingresos.map.CiperejeMapBuilder');
}

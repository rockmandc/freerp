...
abstract class BaseCiregingPeer {
	...
	const TIPLIQ = 'cireging.TIPLIQ';

	
	const CODMON = 'cireging.CODMON';

	
	const VALMON = 'cireging.VALMON';

	
	const PERPRE = 'cireging.PERPRE';

	
	const STAREC = 'cireging.STAREC';

	
	const FECREC = 'cireging.FECREC';

	
	const CODPAR = 'cireging.CODPAR';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Refing', 'Fecing', 'Desing', 'Codtip', 'Rifcon', 'Moning', 'Monrec', 'Mondes', 'Montot', 'Desanu', 'Fecanu', 'Staing', 'Ctaban', 'Tipmov', 'Previs', 'Anoing', 'Numdep', 'Numofi', 'Numcom', 'Reflib', 'Staliq', 'Fecliq', 'Refliq', 'Desliq', 'Fecdep', 'Codtipper', 'Banco', 'Cheque', 'Agencia', 'Fecha', 'Tipliq', 'Codmon', 'Valmon', 'Perpre', 'Starec', 'Fecrec', 'Codpar', 'Id', ),
		BasePeer::TYPE_COLNAME => array (CiregingPeer::REFING, CiregingPeer::FECING, CiregingPeer::DESING, CiregingPeer::CODTIP, CiregingPeer::RIFCON, CiregingPeer::MONING, CiregingPeer::MONREC, CiregingPeer::MONDES, CiregingPeer::MONTOT, CiregingPeer::DESANU, CiregingPeer::FECANU, CiregingPeer::STAING, CiregingPeer::CTABAN, CiregingPeer::TIPMOV, CiregingPeer::PREVIS, CiregingPeer::ANOING, CiregingPeer::NUMDEP, CiregingPeer::NUMOFI, CiregingPeer::NUMCOM, CiregingPeer::REFLIB, CiregingPeer::STALIQ, CiregingPeer::FECLIQ, CiregingPeer::REFLIQ, CiregingPeer::DESLIQ, CiregingPeer::FECDEP, CiregingPeer::CODTIPPER, CiregingPeer::BANCO, CiregingPeer::CHEQUE, CiregingPeer::AGENCIA, CiregingPeer::FECHA, CiregingPeer::TIPLIQ, CiregingPeer::CODMON, CiregingPeer::VALMON, CiregingPeer::PERPRE, CiregingPeer::STAREC, CiregingPeer::FECREC, CiregingPeer::CODPAR, CiregingPeer::ID, ),
		BasePeer::TYPE_FIELDNAME => array ('refing', 'fecing', 'desing', 'codtip', 'rifcon', 'moning', 'monrec', 'mondes', 'montot', 'desanu', 'fecanu', 'staing', 'ctaban', 'tipmov', 'previs', 'anoing', 'numdep', 'numofi', 'numcom', 'reflib', 'staliq', 'fecliq', 'refliq', 'desliq', 'fecdep', 'codtipper', 'banco', 'cheque', 'agencia', 'fecha', 'tipliq', 'codmon', 'valmon', 'perpre', 'starec', 'fecrec', 'codpar', 'id', ),
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(CiregingPeer::TIPLIQ);

		$criteria->addSelectColumn(CiregingPeer::CODMON);

		$criteria->addSelectColumn(CiregingPeer::VALMON);

		$criteria->addSelectColumn(CiregingPeer::PERPRE);

		$criteria->addSelectColumn(CiregingPeer::STAREC);

		$criteria->addSelectColumn(CiregingPeer::FECREC);

		$criteria->addSelectColumn(CiregingPeer::CODPAR);
	...
	public static function doCountJoinTsdefmon(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(CiregingPeer::CODMON, TsdefmonPeer::CODMON);
	...
	public static function doSelectJoinTsdefmon(Criteria $c, $con = null)
	{
		...
		CiregingPeer::addSelectColumns($c);
		$startcol = (CiregingPeer::NUM_COLUMNS - CiregingPeer::NUM_LAZY_LOAD_COLUMNS) + 1;
		TsdefmonPeer::addSelectColumns($c);

		$c->addJoin(CiregingPeer::CODMON, TsdefmonPeer::CODMON);
		$rs = BasePeer::doSelect($c, $con);
		$results = array();

		while($rs->next()) {

			$omClass = CiregingPeer::getOMClass();
			...
			foreach($results as $temp_obj1) {
				$temp_obj2 = $temp_obj1->getTsdefmon(); 				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					$newObject = false;
										$temp_obj2->addCireging($obj1); 					break;
				}
			}
			if ($newObject) {
				$obj2->initCiregings();
				$obj2->addCireging($obj1); 			}
			$results[] = $obj1;
		}
		return $results;
	}
	...
	public static function doSelectJoinAll(Criteria $c, $con = null)
	{
		...
		CiregingPeer::addSelectColumns($c);
		$startcol2 = (CiregingPeer::NUM_COLUMNS - CiregingPeer::NUM_LAZY_LOAD_COLUMNS) + 1;

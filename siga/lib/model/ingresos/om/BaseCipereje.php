...
abstract class BaseCipereje extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->estper !== $v) {
        $this->estper = $v;
        $this->modifiedColumns[] = CiperejePeer::ESTPER;
      }
    ...
    if ($this->cerrado !== $v) {
        $this->cerrado = $v;
        $this->modifiedColumns[] = CiperejePeer::CERRADO;
      }
  ...
  public function get($m, $a)
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CiperejePeer::ESTPER)) $criteria->add(CiperejePeer::ESTPER, $this->estper);
		if ($this->isColumnModified(CiperejePeer::CERRADO)) $criteria->add(CiperejePeer::CERRADO, $this->cerrado);

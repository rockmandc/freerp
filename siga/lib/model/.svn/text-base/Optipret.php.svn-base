...
class Optipret extends BaseOptipret
{
  ...
  public function getMbasmi($val=false)
  {
    ...
    if($val) return number_format($this->mbasmi,4,',','.');
  ...
  public function getMbasma($val=false)
  {
    ...
    if($val) return number_format($this->mbasma,4,',','.');
  ...
  public function setMbasmi($v)
  {
    ...
    if ($this->mbasmi !== $v) {
        $this->mbasmi = Herramientas::toFloat($v,4);
  ...
  public function setMbasma($v)
  {
    ...
    if ($this->mbasma !== $v) {
        $this->mbasma = Herramientas::toFloat($v,4);

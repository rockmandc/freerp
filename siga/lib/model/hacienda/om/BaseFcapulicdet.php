...
abstract class BaseFcapulicdet extends BaseObject  implements Persistent {
  ...
  public function getStsdec()
  {

    return trim($this->stsdec);
  ...
  public function getId()
  {
	...
	public function setStsdec($v)
	{

    if ($this->stsdec !== $v) {
        $this->stsdec = $v;
        $this->modifiedColumns[] = FcapulicdetPeer::STSDEC;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->stsdec = $rs->getString($startcol + 5);
  ...
  public function __call($m, $a)
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[5], $arr)) $this->setStsdec($arr[$keys[5]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(FcapulicdetPeer::STSDEC)) $criteria->add(FcapulicdetPeer::STSDEC, $this->stsdec);

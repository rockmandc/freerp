...
abstract class BaseFcdetpagPeer {
	...
	const CLASS_DEFAULT = 'lib.model.hacienda.Fcdetpag';
	...
	const FECDET = 'fcdetpag.FECDET';

	
	const CTABAN = 'fcdetpag.CTABAN';

	
	const NOMCUE = 'fcdetpag.NOMCUE';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Numpag', 'Nrodet', 'Monpag', 'Tippag', 'Fecdet', 'Ctaban', 'Nomcue', 'Id', ),
		BasePeer::TYPE_COLNAME => array (FcdetpagPeer::NUMPAG, FcdetpagPeer::NRODET, FcdetpagPeer::MONPAG, FcdetpagPeer::TIPPAG, FcdetpagPeer::FECDET, FcdetpagPeer::CTABAN, FcdetpagPeer::NOMCUE, FcdetpagPeer::ID, ),
		BasePeer::TYPE_FIELDNAME => array ('numpag', 'nrodet', 'monpag', 'tippag', 'fecdet', 'ctaban', 'nomcue', 'id', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Numpag' => 0, 'Nrodet' => 1, 'Monpag' => 2, 'Tippag' => 3, 'Fecdet' => 4, 'Ctaban' => 5, 'Nomcue' => 6, 'Id' => 7, ),
		BasePeer::TYPE_COLNAME => array (FcdetpagPeer::NUMPAG => 0, FcdetpagPeer::NRODET => 1, FcdetpagPeer::MONPAG => 2, FcdetpagPeer::TIPPAG => 3, FcdetpagPeer::FECDET => 4, FcdetpagPeer::CTABAN => 5, FcdetpagPeer::NOMCUE => 6, FcdetpagPeer::ID => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('numpag' => 0, 'nrodet' => 1, 'monpag' => 2, 'tippag' => 3, 'fecdet' => 4, 'ctaban' => 5, 'nomcue' => 6, 'id' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	{
		include_once 'lib/model/hacienda/map/FcdetpagMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.hacienda.map.FcdetpagMapBuilder');
	}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(FcdetpagPeer::FECDET);

		$criteria->addSelectColumn(FcdetpagPeer::CTABAN);

		$criteria->addSelectColumn(FcdetpagPeer::NOMCUE);
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/hacienda/map/FcdetpagMapBuilder.php';
	Propel::registerMapBuilder('lib.model.hacienda.map.FcdetpagMapBuilder');
}

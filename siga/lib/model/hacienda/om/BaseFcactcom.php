...
abstract class BaseFcactcom extends BaseObject  implements Persistent {
  ...
  public function getBascan()
  {

    return trim($this->bascan);
  ...
  public function getId()
  {
	...
	public function setBascan($v)
	{

    if ($this->bascan !== $v) {
        $this->bascan = $v;
        $this->modifiedColumns[] = FcactcomPeer::BASCAN;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->bascan = $rs->getString($startcol + 13);
  ...
  public function __call($m, $a)
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[13], $arr)) $this->setBascan($arr[$keys[13]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(FcactcomPeer::BASCAN)) $criteria->add(FcactcomPeer::BASCAN, $this->bascan);

...
abstract class BaseFcdeclar extends BaseObject  implements Persistent {
  ...
  public function getExipaguni()
  {

    return trim($this->exipaguni);
  ...
  public function getId()
  {
	...
	public function setExipaguni($v)
	{

    if ($this->exipaguni !== $v) {
        $this->exipaguni = $v;
        $this->modifiedColumns[] = FcdeclarPeer::EXIPAGUNI;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->exipaguni = $rs->getString($startcol + 27);
  ...
  public function __call($m, $a)
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[27], $arr)) $this->setExipaguni($arr[$keys[27]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(FcdeclarPeer::EXIPAGUNI)) $criteria->add(FcdeclarPeer::EXIPAGUNI, $this->exipaguni);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setExipaguni($this->exipaguni);

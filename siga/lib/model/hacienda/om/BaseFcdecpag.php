...
abstract class BaseFcdecpag extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->stsdec !== $v) {
        $this->stsdec = $v;
        $this->modifiedColumns[] = FcdecpagPeer::STSDEC;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->stsdec = $rs->getString($startcol + 8);
  ...
  public function __call($m, $a)
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[8], $arr)) $this->setStsdec($arr[$keys[8]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(FcdecpagPeer::STSDEC)) $criteria->add(FcdecpagPeer::STSDEC, $this->stsdec);

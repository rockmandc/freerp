...
class FcpagosMapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('FUNVAL', 'Funval', 'string', CreoleTypes::VARCHAR, false, 1000);

		$tMap->addColumn('FECHORVAL', 'Fechorval', 'int', CreoleTypes::TIMESTAMP, false, null);

		$tMap->addColumn('FECHORREGPAG', 'Fechorregpag', 'int', CreoleTypes::TIMESTAMP, false, null);

...
class FcsollicMapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('HORINI', 'Horini', 'int', CreoleTypes::TIME, false, null);

		$tMap->addColumn('HORCIE', 'Horcie', 'int', CreoleTypes::TIME, false, null);
		...
		$tMap->addColumn('HORAINIE', 'Horainie', 'int', CreoleTypes::TIME, false, null);

		$tMap->addColumn('HORACIEE', 'Horaciee', 'int', CreoleTypes::TIME, false, null);

...
class FcfuepreMapBuilder {
	...
	const CLASS_NAME = 'lib.model.hacienda.map.FcfuepreMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('INGREC', 'Ingrec', 'string', CreoleTypes::VARCHAR, false, 32);
		...
		$tMap->addColumn('CODPREI', 'Codprei', 'string', CreoleTypes::VARCHAR, false, 50);
		...
		$tMap->addColumn('SUMFUE', 'Sumfue', 'string', CreoleTypes::VARCHAR, false, 1);

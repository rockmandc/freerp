...
class UsuariosMapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('LOGUSE', 'Loguse', 'string', CreoleTypes::VARCHAR, true, 250);
		...
		$tMap->addColumn('PASUSE', 'Pasuse', 'string', CreoleTypes::VARCHAR, true, 250);
		...
		$tMap->addColumn('CODNIV', 'Codniv', 'string', CreoleTypes::VARCHAR, false, 3);

		$tMap->addColumn('CODGRU', 'Codgru', 'string', CreoleTypes::VARCHAR, false, 3);

		$tMap->addColumn('FECCAD', 'Feccad', 'int', CreoleTypes::DATE, false, null);

		$tMap->addColumn('STABLO', 'Stablo', 'string', CreoleTypes::VARCHAR, false, 1);

		$tMap->addColumn('FECINT', 'Fecint', 'int', CreoleTypes::DATE, false, null);

		$tMap->addColumn('CONINT', 'Conint', 'int', CreoleTypes::INTEGER, false, null);

		$tMap->addColumn('ESGEREN', 'Esgeren', 'string', CreoleTypes::VARCHAR, false, 1);

...
/**
 * Subclase para representar una fila de la tabla 'bndetregpolcer'.
 *
 * Tabla que almacena el detalle de registro de Póliza/Certificado
 *
 * @package    Roraima
 ...
 */ 
class Bndetregpolcer extends BaseBndetregpolcer
{
  protected $desmue="";
  protected $marmue="";
  protected $modmue="";

...
abstract class BaseContabbhis extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->codcta !== $v) {
        $this->codcta = $v;
        $this->modifiedColumns[] = ContabbhisPeer::CODCTA;
      }
    ...
    if ($this->descta !== $v) {
        $this->descta = $v;
        $this->modifiedColumns[] = ContabbhisPeer::DESCTA;
      }
    ...
    if ($this->fecini !== $ts) {
      $this->fecini = $ts;
      $this->modifiedColumns[] = ContabbhisPeer::FECINI;
    }
    ...
    if ($this->feccie !== $ts) {
      $this->feccie = $ts;
      $this->modifiedColumns[] = ContabbhisPeer::FECCIE;
    }
    ...
    if ($this->salant !== $v) {
        ...
        $this->modifiedColumns[] = ContabbhisPeer::SALANT;
      }
    ...
    if ($this->debcre !== $v) {
        $this->debcre = $v;
        $this->modifiedColumns[] = ContabbhisPeer::DEBCRE;
      }
    ...
    if ($this->cargab !== $v) {
        $this->cargab = $v;
        $this->modifiedColumns[] = ContabbhisPeer::CARGAB;
      }
    ...
    if ($this->salprgper !== $v) {
        ...
        $this->modifiedColumns[] = ContabbhisPeer::SALPRGPER;
      }
    ...
    if ($this->salacuper !== $v) {
        ...
        $this->modifiedColumns[] = ContabbhisPeer::SALACUPER;
      }
    ...
    if ($this->salprgperfor !== $v) {
        ...
        $this->modifiedColumns[] = ContabbhisPeer::SALPRGPERFOR;
      }
    ...
    if ($this->id !== $v) {
        $this->id = $v;
        $this->modifiedColumns[] = ContabbhisPeer::ID;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      throw new PropelException("Error populating Contabbhis object", $e);
    }
  }
  ...
  public function get($m, $a)
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			ContabbhisPeer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			$this->alreadyInSave = true;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = ContabbhisPeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += ContabbhisPeer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = ContabbhisPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = ContabbhisPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = ContabbhisPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ContabbhisPeer::CODCTA)) $criteria->add(ContabbhisPeer::CODCTA, $this->codcta);
		if ($this->isColumnModified(ContabbhisPeer::DESCTA)) $criteria->add(ContabbhisPeer::DESCTA, $this->descta);
		if ($this->isColumnModified(ContabbhisPeer::FECINI)) $criteria->add(ContabbhisPeer::FECINI, $this->fecini);
		if ($this->isColumnModified(ContabbhisPeer::FECCIE)) $criteria->add(ContabbhisPeer::FECCIE, $this->feccie);
		if ($this->isColumnModified(ContabbhisPeer::SALANT)) $criteria->add(ContabbhisPeer::SALANT, $this->salant);
		if ($this->isColumnModified(ContabbhisPeer::DEBCRE)) $criteria->add(ContabbhisPeer::DEBCRE, $this->debcre);
		if ($this->isColumnModified(ContabbhisPeer::CARGAB)) $criteria->add(ContabbhisPeer::CARGAB, $this->cargab);
		if ($this->isColumnModified(ContabbhisPeer::SALPRGPER)) $criteria->add(ContabbhisPeer::SALPRGPER, $this->salprgper);
		if ($this->isColumnModified(ContabbhisPeer::SALACUPER)) $criteria->add(ContabbhisPeer::SALACUPER, $this->salacuper);
		if ($this->isColumnModified(ContabbhisPeer::SALPRGPERFOR)) $criteria->add(ContabbhisPeer::SALPRGPERFOR, $this->salprgperfor);
		if ($this->isColumnModified(ContabbhisPeer::ID)) $criteria->add(ContabbhisPeer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(ContabbhisPeer::ID, $this->id);

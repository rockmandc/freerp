...
abstract class BaseContabb1his extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->codcta !== $v) {
        $this->codcta = $v;
        $this->modifiedColumns[] = Contabb1hisPeer::CODCTA;
      }
    ...
    if ($this->fecini !== $ts) {
      $this->fecini = $ts;
      $this->modifiedColumns[] = Contabb1hisPeer::FECINI;
    }
    ...
    if ($this->feccie !== $ts) {
      $this->feccie = $ts;
      $this->modifiedColumns[] = Contabb1hisPeer::FECCIE;
    }
    ...
    if ($this->pereje !== $v) {
        $this->pereje = $v;
        $this->modifiedColumns[] = Contabb1hisPeer::PEREJE;
      }
    ...
    if ($this->totdeb !== $v) {
        ...
        $this->modifiedColumns[] = Contabb1hisPeer::TOTDEB;
      }
    ...
    if ($this->totcre !== $v) {
        ...
        $this->modifiedColumns[] = Contabb1hisPeer::TOTCRE;
      }
    ...
    if ($this->salact !== $v) {
        ...
        $this->modifiedColumns[] = Contabb1hisPeer::SALACT;
      }
    ...
    if ($this->salprgper !== $v) {
        ...
        $this->modifiedColumns[] = Contabb1hisPeer::SALPRGPER;
      }
    ...
    if ($this->salprgperfor !== $v) {
        ...
        $this->modifiedColumns[] = Contabb1hisPeer::SALPRGPERFOR;
      }
    ...
    if ($this->id !== $v) {
        $this->id = $v;
        $this->modifiedColumns[] = Contabb1hisPeer::ID;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      throw new PropelException("Error populating Contabb1his object", $e);
    }
  }
  ...
  public function get($m, $a)
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			Contabb1hisPeer::doDelete($this, $con);
		...
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			...
			if ($this->aContabb !== null) {
				...
				$this->setContabb($this->aContabb);
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = Contabb1hisPeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += Contabb1hisPeer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Contabb1hisPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Contabb1hisPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = Contabb1hisPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Contabb1hisPeer::CODCTA)) $criteria->add(Contabb1hisPeer::CODCTA, $this->codcta);
		if ($this->isColumnModified(Contabb1hisPeer::FECINI)) $criteria->add(Contabb1hisPeer::FECINI, $this->fecini);
		if ($this->isColumnModified(Contabb1hisPeer::FECCIE)) $criteria->add(Contabb1hisPeer::FECCIE, $this->feccie);
		if ($this->isColumnModified(Contabb1hisPeer::PEREJE)) $criteria->add(Contabb1hisPeer::PEREJE, $this->pereje);
		if ($this->isColumnModified(Contabb1hisPeer::TOTDEB)) $criteria->add(Contabb1hisPeer::TOTDEB, $this->totdeb);
		if ($this->isColumnModified(Contabb1hisPeer::TOTCRE)) $criteria->add(Contabb1hisPeer::TOTCRE, $this->totcre);
		if ($this->isColumnModified(Contabb1hisPeer::SALACT)) $criteria->add(Contabb1hisPeer::SALACT, $this->salact);
		if ($this->isColumnModified(Contabb1hisPeer::SALPRGPER)) $criteria->add(Contabb1hisPeer::SALPRGPER, $this->salprgper);
		if ($this->isColumnModified(Contabb1hisPeer::SALPRGPERFOR)) $criteria->add(Contabb1hisPeer::SALPRGPERFOR, $this->salprgperfor);
		if ($this->isColumnModified(Contabb1hisPeer::ID)) $criteria->add(Contabb1hisPeer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(Contabb1hisPeer::ID, $this->id);

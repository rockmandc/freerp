...
class Contabb1hisMapBuilder {

	
	const CLASS_NAME = 'lib.model.contabilidad.map.Contabb1hisMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('contabb1his');
		$tMap->setPhpName('Contabb1his');

		$tMap->setUseIdGenerator(true);

		$tMap->setPrimaryKeyMethodInfo('contabb1his_SEQ');

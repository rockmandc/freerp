...
class ContabbhisMapBuilder {

	
	const CLASS_NAME = 'lib.model.contabilidad.map.ContabbhisMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('contabbhis');
		$tMap->setPhpName('Contabbhis');

		$tMap->setUseIdGenerator(true);

		$tMap->setPrimaryKeyMethodInfo('contabbhis_SEQ');

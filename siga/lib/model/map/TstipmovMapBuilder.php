...
class TstipmovMapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('PAGNOM', 'Pagnom', 'boolean', CreoleTypes::BOOLEAN, false, null);

		$tMap->addColumn('CODTIPTRA', 'Codtiptra', 'string', CreoleTypes::VARCHAR, false, 3);

		$tMap->addColumn('ESTRAN', 'Estran', 'string', CreoleTypes::VARCHAR, false, 1);

		$tMap->addColumn('GENMOV', 'Genmov', 'string', CreoleTypes::VARCHAR, false, 1);

		$tMap->addColumn('CARBAN', 'Carban', 'string', CreoleTypes::VARCHAR, false, 1);

		$tMap->addColumn('ESREIN', 'Esrein', 'string', CreoleTypes::VARCHAR, false, 1);

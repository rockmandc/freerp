...
class ViacalviatraMapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('VERIFICADO', 'Verificado', 'string', CreoleTypes::VARCHAR, false, 1);

		$tMap->addColumn('STAINF', 'Stainf', 'string', CreoleTypes::VARCHAR, false, 1);

		$tMap->addColumn('REFCOMVAR', 'Refcomvar', 'string', CreoleTypes::VARCHAR, false, 2000);

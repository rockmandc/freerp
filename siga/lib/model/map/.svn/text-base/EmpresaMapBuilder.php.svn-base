...
class EmpresaMapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('CODCAT', 'Codcat', 'string', CreoleTypes::VARCHAR, false, 50);
		...
		$tMap->addColumn('TIPDOC', 'Tipdoc', 'string', CreoleTypes::VARCHAR, false, 50);

		$tMap->addColumn('RIFEMP', 'Rifemp', 'string', CreoleTypes::VARCHAR, false, 50);

		$tMap->addColumn('NUMTAR', 'Numtar', 'string', CreoleTypes::VARCHAR, false, 50);

		$tMap->addColumn('MES', 'Mes', 'string', CreoleTypes::VARCHAR, false, 4);

		$tMap->addColumn('MESISLR', 'Mesislr', 'string', CreoleTypes::VARCHAR, false, 4);

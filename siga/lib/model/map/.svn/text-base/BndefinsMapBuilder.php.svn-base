...
class BndefinsMapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('CORMUENACD', 'Cormuenacd', 'double', CreoleTypes::NUMERIC, false, 8);

		$tMap->addColumn('CORMUEREGD', 'Cormueregd', 'double', CreoleTypes::NUMERIC, false, 8);

		$tMap->addColumn('CORMUENACH', 'Cormuenach', 'double', CreoleTypes::NUMERIC, false, 8);

		$tMap->addColumn('CORMUEREGH', 'Cormueregh', 'double', CreoleTypes::NUMERIC, false, 8);

		$tMap->addColumn('MODCORMUE', 'Modcormue', 'boolean', CreoleTypes::BOOLEAN, false, null);

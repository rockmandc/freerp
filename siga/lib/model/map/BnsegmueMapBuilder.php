...
class BnsegmueMapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('NUMDEPPOL', 'Numdeppol', 'string', CreoleTypes::VARCHAR, false, 25);

		$tMap->addColumn('FECVIGDES', 'Fecvigdes', 'int', CreoleTypes::DATE, false, null);

		$tMap->addColumn('FECVIGHAS', 'Fecvighas', 'int', CreoleTypes::DATE, false, null);

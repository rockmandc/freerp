...
class CobdocumeMapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('DESDOC', 'Desdoc', 'string', CreoleTypes::VARCHAR, false, 3000);
		...
		$tMap->addColumn('TOTRET', 'Totret', 'double', CreoleTypes::NUMERIC, false, 14);
		...
		$tMap->addColumn('REFTRA', 'Reftra', 'string', CreoleTypes::VARCHAR, false, 10);

		$tMap->addColumn('CODDIREC', 'Coddirec', 'string', CreoleTypes::VARCHAR, false, 32);

		$tMap->addColumn('TRADOC', 'Tradoc', 'string', CreoleTypes::VARCHAR, false, 1);

		$tMap->addColumn('REFDOCNC', 'Refdocnc', 'string', CreoleTypes::VARCHAR, false, 10);

		$tMap->addColumn('MONEXO', 'Monexo', 'double', CreoleTypes::NUMERIC, false, 14);

		$tMap->addColumn('REFDOCND', 'Refdocnd', 'string', CreoleTypes::VARCHAR, false, 10);

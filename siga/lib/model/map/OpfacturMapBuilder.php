...
class OpfacturMapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('BASIMN', 'Basimn', 'double', CreoleTypes::NUMERIC, false, 18);

		$tMap->addColumn('PORIMN', 'Porimn', 'double', CreoleTypes::NUMERIC, false, 18);

		$tMap->addColumn('MONIMN', 'Monimn', 'double', CreoleTypes::NUMERIC, false, 18);

		$tMap->addColumn('CODIMN', 'Codimn', 'string', CreoleTypes::VARCHAR, false, 50);

		$tMap->addColumn('FECRECFAC', 'Fecrecfac', 'int', CreoleTypes::DATE, false, null);

		$tMap->addColumn('MNOSUJ', 'Mnosuj', 'double', CreoleTypes::NUMERIC, false, 18);

		$tMap->addColumn('MDECRE', 'Mdecre', 'double', CreoleTypes::NUMERIC, false, 18);

		$tMap->addColumn('MONEXO', 'Monexo', 'double', CreoleTypes::NUMERIC, false, 18);

		$tMap->addColumn('CODIVA', 'Codiva', 'string', CreoleTypes::VARCHAR, false, 50);

...
class TsmovlibMapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('STADIF', 'Stadif', 'string', CreoleTypes::VARCHAR, false, 1);

		$tMap->addColumn('CODPRO', 'Codpro', 'string', CreoleTypes::VARCHAR, false, 20);

		$tMap->addColumn('TIPMOVAJU', 'Tipmovaju', 'string', CreoleTypes::VARCHAR, false, 4);

		$tMap->addColumn('REFLIBAJU', 'Reflibaju', 'string', CreoleTypes::VARCHAR, false, 20);

		$tMap->addColumn('CODDIREC', 'Coddirec', 'string', CreoleTypes::VARCHAR, false, 32);

		$tMap->addColumn('REFREI', 'Refrei', 'string', CreoleTypes::VARCHAR, false, 8);

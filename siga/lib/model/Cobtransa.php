...
class Cobtransa extends BaseCobtransa {
    ...
    protected $estado = "";
    protected $codcenaco = "";
    protected $btnrec = false;
    protected $btndes = false;
    protected $totant = "0,00";
    protected $totret = "0,00";
    protected $montotche= "0,00";
    protected $pagmaytra="";
    protected $filgennotcre="";
    protected $objdetche=array();
  ...
  public function getEtiqueta(){
      if (self::getStatus() == 'N'){
          $this->etiqueta = 'ANULADA EL '.date('d/m/Y',strtotime(self::getFecanu())). ' POR MOTIVO DE '.self::getDesanu();
      }else{
          $this->etiqueta = '';
      }
    ...
    public function getIntercamfil()
    {
      return H::getConfApp2('intercamfil', 'cuentasxcobrar', 'cobtransa');
    }  

    public function getPagmaytra()
    {
      return H::getConfApp2('pagmaytra', 'cuentasxcobrar', 'cobtransa');
    }      

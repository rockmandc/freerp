...
abstract class BaseFarecarg extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->codrgo !== $v) {
        $this->codrgo = $v;
        $this->modifiedColumns[] = FarecargPeer::CODRGO;
      }
    ...
    if ($this->nomrgo !== $v) {
        $this->nomrgo = $v;
        $this->modifiedColumns[] = FarecargPeer::NOMRGO;
      }
    ...
    if ($this->codpre !== $v) {
        $this->codpre = $v;
        $this->modifiedColumns[] = FarecargPeer::CODPRE;
      }
    ...
    if ($this->tiprgo !== $v) {
        $this->tiprgo = $v;
        $this->modifiedColumns[] = FarecargPeer::TIPRGO;
      }
    ...
    if ($this->monrgo !== $v) {
        ...
        $this->modifiedColumns[] = FarecargPeer::MONRGO;
      }
    ...
    if ($this->calcul !== $v) {
        $this->calcul = $v;
        $this->modifiedColumns[] = FarecargPeer::CALCUL;
      }
    ...
    if ($this->codcta !== $v) {
        $this->codcta = $v;
        $this->modifiedColumns[] = FarecargPeer::CODCTA;
      }
    ...
    if ($this->id !== $v) {
        $this->id = $v;
        $this->modifiedColumns[] = FarecargPeer::ID;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      throw new PropelException("Error populating Farecarg object", $e);
    }
  }
  ...
  public function get($m, $a)
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			FarecargPeer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			$this->alreadyInSave = true;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = FarecargPeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += FarecargPeer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = FarecargPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = FarecargPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = FarecargPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(FarecargPeer::CODRGO)) $criteria->add(FarecargPeer::CODRGO, $this->codrgo);
		if ($this->isColumnModified(FarecargPeer::NOMRGO)) $criteria->add(FarecargPeer::NOMRGO, $this->nomrgo);
		if ($this->isColumnModified(FarecargPeer::CODPRE)) $criteria->add(FarecargPeer::CODPRE, $this->codpre);
		if ($this->isColumnModified(FarecargPeer::TIPRGO)) $criteria->add(FarecargPeer::TIPRGO, $this->tiprgo);
		if ($this->isColumnModified(FarecargPeer::MONRGO)) $criteria->add(FarecargPeer::MONRGO, $this->monrgo);
		if ($this->isColumnModified(FarecargPeer::CALCUL)) $criteria->add(FarecargPeer::CALCUL, $this->calcul);
		if ($this->isColumnModified(FarecargPeer::CODCTA)) $criteria->add(FarecargPeer::CODCTA, $this->codcta);
		if ($this->isColumnModified(FarecargPeer::ID)) $criteria->add(FarecargPeer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(FarecargPeer::ID, $this->id);

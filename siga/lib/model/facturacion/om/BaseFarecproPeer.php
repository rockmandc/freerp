...
abstract class BaseFarecproPeer {
	...
	const CLASS_DEFAULT = 'lib.model.facturacion.Farecpro';
	...
	{
		include_once 'lib/model/facturacion/map/FarecproMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.facturacion.map.FarecproMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/facturacion/map/FarecproMapBuilder.php';
	Propel::registerMapBuilder('lib.model.facturacion.map.FarecproMapBuilder');
}

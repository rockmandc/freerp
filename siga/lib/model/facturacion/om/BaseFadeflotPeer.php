...
abstract class BaseFadeflotPeer {
	...
	const CLASS_DEFAULT = 'lib.model.facturacion.Fadeflot';
	...
	{
		include_once 'lib/model/facturacion/map/FadeflotMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.facturacion.map.FadeflotMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/facturacion/map/FadeflotMapBuilder.php';
	Propel::registerMapBuilder('lib.model.facturacion.map.FadeflotMapBuilder');
}

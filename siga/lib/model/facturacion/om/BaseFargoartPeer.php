...
abstract class BaseFargoartPeer {
	...
	const CLASS_DEFAULT = 'lib.model.facturacion.Fargoart';
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (FargoartPeer::CODRGO, FargoartPeer::CODART, FargoartPeer::REFDOC, FargoartPeer::MONRGO, FargoartPeer::TIPDOC, FargoartPeer::DESART, FargoartPeer::ID, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (FargoartPeer::CODRGO => 0, FargoartPeer::CODART => 1, FargoartPeer::REFDOC => 2, FargoartPeer::MONRGO => 3, FargoartPeer::TIPDOC => 4, FargoartPeer::DESART => 5, FargoartPeer::ID => 6, ),
	...
	{
		include_once 'lib/model/facturacion/map/FargoartMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.facturacion.map.FargoartMapBuilder');
	}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(FargoartPeer::DESART);
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/facturacion/map/FargoartMapBuilder.php';
	Propel::registerMapBuilder('lib.model.facturacion.map.FargoartMapBuilder');
}

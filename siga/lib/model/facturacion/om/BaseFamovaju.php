...
abstract class BaseFamovaju extends BaseObject  implements Persistent {
  ...
  public function getRefdetfacid()
  {

    return $this->refdetfacid;
  ...
  public function getId()
  {
	...
	public function setRefdetfacid($v)
	{

    if ($this->refdetfacid !== $v) {
        $this->refdetfacid = $v;
        $this->modifiedColumns[] = FamovajuPeer::REFDETFACID;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->refdetfacid = $rs->getInt($startcol + 8);
  ...
  public function get($m, $a)
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[8], $arr)) $this->setRefdetfacid($arr[$keys[8]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(FamovajuPeer::REFDETFACID)) $criteria->add(FamovajuPeer::REFDETFACID, $this->refdetfacid);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setRefdetfacid($this->refdetfacid);

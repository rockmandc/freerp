...
abstract class BaseFarecartPeer {
	...
	const CLASS_DEFAULT = 'lib.model.facturacion.Farecart';
	...
	{
		include_once 'lib/model/facturacion/map/FarecartMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.facturacion.map.FarecartMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/facturacion/map/FarecartMapBuilder.php';
	Propel::registerMapBuilder('lib.model.facturacion.map.FarecartMapBuilder');
}

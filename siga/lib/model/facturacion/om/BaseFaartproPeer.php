...
abstract class BaseFaartproPeer {
	...
	const CLASS_DEFAULT = 'lib.model.facturacion.Faartpro';
	...
	{
		include_once 'lib/model/facturacion/map/FaartproMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.facturacion.map.FaartproMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/facturacion/map/FaartproMapBuilder.php';
	Propel::registerMapBuilder('lib.model.facturacion.map.FaartproMapBuilder');
}

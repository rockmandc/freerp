...
abstract class BaseFafaclibPeer {
	...
	const CLASS_DEFAULT = 'lib.model.facturacion.Fafaclib';
	...
	{
		include_once 'lib/model/facturacion/map/FafaclibMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.facturacion.map.FafaclibMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/facturacion/map/FafaclibMapBuilder.php';
	Propel::registerMapBuilder('lib.model.facturacion.map.FafaclibMapBuilder');
}

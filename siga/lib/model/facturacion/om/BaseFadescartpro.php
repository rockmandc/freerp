...
abstract class BaseFadescartpro extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->desart !== $v) {
        $this->desart = $v;
        $this->modifiedColumns[] = FadescartproPeer::DESART;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->desart = $rs->getString($startcol + 6);
  ...
  public function get($m, $a)
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[6], $arr)) $this->setDesart($arr[$keys[6]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(FadescartproPeer::DESART)) $criteria->add(FadescartproPeer::DESART, $this->desart);

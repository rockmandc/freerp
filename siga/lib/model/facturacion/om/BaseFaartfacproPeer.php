...
abstract class BaseFaartfacproPeer {
	...
	const CLASS_DEFAULT = 'lib.model.facturacion.Faartfacpro';
	...
	const FACAFI = 'faartfacpro.FACAFI';

	
	const CODPRO = 'faartfacpro.CODPRO';

	
	const FECDEV = 'faartfacpro.FECDEV';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Reffac', 'Codart', 'Desart', 'Codref', 'Cantot', 'Precio', 'Monrgo', 'Mondes', 'Totart', 'Canaju', 'Candes', 'Nronot', 'Orddespacho', 'Guia', 'Contenedores', 'Billleading', 'Placa', 'Rifpro', 'Fecsal', 'Horsal', 'Feclleg', 'Horlleg', 'Codprod', 'Kg', 'Cajas', 'Estatus', 'Observaciones', 'Tm', 'Cedrif', 'Notentdig', 'Tipov', 'Fecllca', 'Horllca', 'Fecdesc', 'Hordesc', 'Kgent', 'Difkg', 'Cajasent', 'Difcaj', 'Tment', 'Difton', 'Ier', 'Numfac', 'Facafi', 'Codpro', 'Fecdev', 'Id', ),
		BasePeer::TYPE_COLNAME => array (FaartfacproPeer::REFFAC, FaartfacproPeer::CODART, FaartfacproPeer::DESART, FaartfacproPeer::CODREF, FaartfacproPeer::CANTOT, FaartfacproPeer::PRECIO, FaartfacproPeer::MONRGO, FaartfacproPeer::MONDES, FaartfacproPeer::TOTART, FaartfacproPeer::CANAJU, FaartfacproPeer::CANDES, FaartfacproPeer::NRONOT, FaartfacproPeer::ORDDESPACHO, FaartfacproPeer::GUIA, FaartfacproPeer::CONTENEDORES, FaartfacproPeer::BILLLEADING, FaartfacproPeer::PLACA, FaartfacproPeer::RIFPRO, FaartfacproPeer::FECSAL, FaartfacproPeer::HORSAL, FaartfacproPeer::FECLLEG, FaartfacproPeer::HORLLEG, FaartfacproPeer::CODPROD, FaartfacproPeer::KG, FaartfacproPeer::CAJAS, FaartfacproPeer::ESTATUS, FaartfacproPeer::OBSERVACIONES, FaartfacproPeer::TM, FaartfacproPeer::CEDRIF, FaartfacproPeer::NOTENTDIG, FaartfacproPeer::TIPOV, FaartfacproPeer::FECLLCA, FaartfacproPeer::HORLLCA, FaartfacproPeer::FECDESC, FaartfacproPeer::HORDESC, FaartfacproPeer::KGENT, FaartfacproPeer::DIFKG, FaartfacproPeer::CAJASENT, FaartfacproPeer::DIFCAJ, FaartfacproPeer::TMENT, FaartfacproPeer::DIFTON, FaartfacproPeer::IER, FaartfacproPeer::NUMFAC, FaartfacproPeer::FACAFI, FaartfacproPeer::CODPRO, FaartfacproPeer::FECDEV, FaartfacproPeer::ID, ),
		BasePeer::TYPE_FIELDNAME => array ('reffac', 'codart', 'desart', 'codref', 'cantot', 'precio', 'monrgo', 'mondes', 'totart', 'canaju', 'candes', 'nronot', 'orddespacho', 'guia', 'contenedores', 'billleading', 'placa', 'rifpro', 'fecsal', 'horsal', 'feclleg', 'horlleg', 'codprod', 'kg', 'cajas', 'estatus', 'observaciones', 'tm', 'cedrif', 'notentdig', 'tipov', 'fecllca', 'horllca', 'fecdesc', 'hordesc', 'kgent', 'difkg', 'cajasent', 'difcaj', 'tment', 'difton', 'ier', 'numfac', 'facafi', 'codpro', 'fecdev', 'id', ),
	...
	{
		include_once 'lib/model/facturacion/map/FaartfacproMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.facturacion.map.FaartfacproMapBuilder');
	}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(FaartfacproPeer::FACAFI);

		$criteria->addSelectColumn(FaartfacproPeer::CODPRO);

		$criteria->addSelectColumn(FaartfacproPeer::FECDEV);
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/facturacion/map/FaartfacproMapBuilder.php';
	Propel::registerMapBuilder('lib.model.facturacion.map.FaartfacproMapBuilder');
}

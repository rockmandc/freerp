...
abstract class BaseFacontctePeer {
	...
	const CLASS_DEFAULT = 'lib.model.facturacion.Facontcte';
	...
	{
		include_once 'lib/model/facturacion/map/FacontcteMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.facturacion.map.FacontcteMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/facturacion/map/FacontcteMapBuilder.php';
	Propel::registerMapBuilder('lib.model.facturacion.map.FacontcteMapBuilder');
}

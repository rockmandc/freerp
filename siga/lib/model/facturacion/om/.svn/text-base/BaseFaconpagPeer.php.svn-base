...
abstract class BaseFaconpagPeer {
	...
	const CLASS_DEFAULT = 'lib.model.facturacion.Faconpag';
	...
	{
		include_once 'lib/model/facturacion/map/FaconpagMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.facturacion.map.FaconpagMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/facturacion/map/FaconpagMapBuilder.php';
	Propel::registerMapBuilder('lib.model.facturacion.map.FaconpagMapBuilder');
}

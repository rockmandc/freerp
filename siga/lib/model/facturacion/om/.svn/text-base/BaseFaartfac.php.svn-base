...
abstract class BaseFaartfac extends BaseObject  implements Persistent {
  ...
  public function getFeclleg($format = 'Y-m-d H:i:s')
  {
    ...
    if ($this->feclleg === null || $this->feclleg === '') {
      return null;
            ...
            $ts = adodb_strtotime($this->feclleg);
  ...
  public function getFecllca($format = 'Y-m-d H:i:s')
  {
    ...
    if ($this->fecllca === null || $this->fecllca === '') {
      return null;
            ...
            $ts = adodb_strtotime($this->fecllca);
  ...
  public function getFecdesc($format = 'Y-m-d H:i:s')
  {
    ...
    if ($this->fecdesc === null || $this->fecdesc === '') {
      return null;
            ...
            $ts = adodb_strtotime($this->fecdesc);
  ...
  public function getFacafi()
  {

    return trim($this->facafi);
  ...
  public function getId()
  {
    ...
    if ($this->btucon !== $v) {
        ...
        $this->modifiedColumns[] = FaartfacPeer::BTUCON;
      }
    ...
    if ($this->prebtu !== $v) {
        ...
        $this->modifiedColumns[] = FaartfacPeer::PREBTU;
      }
    ...
    if ($this->monbtu !== $v) {
        ...
        $this->modifiedColumns[] = FaartfacPeer::MONBTU;
      }
    ...
    if ($this->codcan !== $v) {
        $this->codcan = $v;
        $this->modifiedColumns[] = FaartfacPeer::CODCAN;
      }
    ...
    if ($this->fecrecfac !== $ts) {
      $this->fecrecfac = $ts;
      $this->modifiedColumns[] = FaartfacPeer::FECRECFAC;
    }
    ...
    if ($this->rifprod !== $v) {
        $this->rifprod = $v;
        $this->modifiedColumns[] = FaartfacPeer::RIFPROD;
      }
    ...
    if ($this->moncom !== $v) {
        ...
        $this->modifiedColumns[] = FaartfacPeer::MONCOM;
      }
  
	} 
	
	public function setFacafi($v)
	{

    if ($this->facafi !== $v) {
        $this->facafi = $v;
        $this->modifiedColumns[] = FaartfacPeer::FACAFI;
      }
    ...
    if ($this->codpro !== $v) {
        $this->codpro = $v;
        $this->modifiedColumns[] = FaartfacPeer::CODPRO;
      }
    ...
    if ($this->fecdev !== $ts) {
      $this->fecdev = $ts;
      $this->modifiedColumns[] = FaartfacPeer::FECDEV;
    }
    ...
    if ($this->unimed !== $v) {
        $this->unimed = $v;
        $this->modifiedColumns[] = FaartfacPeer::UNIMED;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->btucon = $rs->getFloat($startcol + 44);

      $this->prebtu = $rs->getFloat($startcol + 45);

      $this->monbtu = $rs->getFloat($startcol + 46);

      $this->codcan = $rs->getString($startcol + 47);

      $this->fecrecfac = $rs->getDate($startcol + 48, null);

      $this->rifprod = $rs->getString($startcol + 49);

      $this->moncom = $rs->getFloat($startcol + 50);

      $this->facafi = $rs->getString($startcol + 51);

      $this->codpro = $rs->getString($startcol + 52);

      $this->fecdev = $rs->getDate($startcol + 53, null);

      $this->unimed = $rs->getString($startcol + 54);
  ...
  public function get($m, $a)
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		$result = array(
			...
			$keys[44] => $this->getBtucon(),
			$keys[45] => $this->getPrebtu(),
			$keys[46] => $this->getMonbtu(),
			$keys[47] => $this->getCodcan(),
			$keys[48] => $this->getFecrecfac(),
			$keys[49] => $this->getRifprod(),
			$keys[50] => $this->getMoncom(),
			$keys[51] => $this->getFacafi(),
			$keys[52] => $this->getCodpro(),
			$keys[53] => $this->getFecdev(),
			$keys[54] => $this->getUnimed(),
			$keys[55] => $this->getId(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[44], $arr)) $this->setBtucon($arr[$keys[44]]);
		if (array_key_exists($keys[45], $arr)) $this->setPrebtu($arr[$keys[45]]);
		if (array_key_exists($keys[46], $arr)) $this->setMonbtu($arr[$keys[46]]);
		if (array_key_exists($keys[47], $arr)) $this->setCodcan($arr[$keys[47]]);
		if (array_key_exists($keys[48], $arr)) $this->setFecrecfac($arr[$keys[48]]);
		if (array_key_exists($keys[49], $arr)) $this->setRifprod($arr[$keys[49]]);
		if (array_key_exists($keys[50], $arr)) $this->setMoncom($arr[$keys[50]]);
		if (array_key_exists($keys[51], $arr)) $this->setFacafi($arr[$keys[51]]);
		if (array_key_exists($keys[52], $arr)) $this->setCodpro($arr[$keys[52]]);
		if (array_key_exists($keys[53], $arr)) $this->setFecdev($arr[$keys[53]]);
		if (array_key_exists($keys[54], $arr)) $this->setUnimed($arr[$keys[54]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(FaartfacPeer::BTUCON)) $criteria->add(FaartfacPeer::BTUCON, $this->btucon);
		if ($this->isColumnModified(FaartfacPeer::PREBTU)) $criteria->add(FaartfacPeer::PREBTU, $this->prebtu);
		if ($this->isColumnModified(FaartfacPeer::MONBTU)) $criteria->add(FaartfacPeer::MONBTU, $this->monbtu);
		if ($this->isColumnModified(FaartfacPeer::CODCAN)) $criteria->add(FaartfacPeer::CODCAN, $this->codcan);
		if ($this->isColumnModified(FaartfacPeer::FECRECFAC)) $criteria->add(FaartfacPeer::FECRECFAC, $this->fecrecfac);
		if ($this->isColumnModified(FaartfacPeer::RIFPROD)) $criteria->add(FaartfacPeer::RIFPROD, $this->rifprod);
		if ($this->isColumnModified(FaartfacPeer::MONCOM)) $criteria->add(FaartfacPeer::MONCOM, $this->moncom);
		if ($this->isColumnModified(FaartfacPeer::FACAFI)) $criteria->add(FaartfacPeer::FACAFI, $this->facafi);
		if ($this->isColumnModified(FaartfacPeer::CODPRO)) $criteria->add(FaartfacPeer::CODPRO, $this->codpro);
		if ($this->isColumnModified(FaartfacPeer::FECDEV)) $criteria->add(FaartfacPeer::FECDEV, $this->fecdev);
		if ($this->isColumnModified(FaartfacPeer::UNIMED)) $criteria->add(FaartfacPeer::UNIMED, $this->unimed);

...
abstract class BaseFadefcom extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->fadescripfac_id !== $v) {
        ...
        $this->modifiedColumns[] = FadefcomPeer::FADESCRIPFAC_ID;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->fadescripfac_id = $rs->getInt($startcol + 2);
  ...
  public function get($m, $a)
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setFadescripfacId($arr[$keys[2]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(FadefcomPeer::FADESCRIPFAC_ID)) $criteria->add(FadefcomPeer::FADESCRIPFAC_ID, $this->fadescripfac_id);

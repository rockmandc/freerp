...
abstract class BaseFadescartproPeer {
	...
	const CLASS_DEFAULT = 'lib.model.facturacion.Fadescartpro';
	...
	const DESART = 'fadescartpro.DESART';
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (FadescartproPeer::CODDESC, FadescartproPeer::REFDOC, FadescartproPeer::CODART, FadescartproPeer::MONDESC, FadescartproPeer::MONDETDESC, FadescartproPeer::TIPDOC, FadescartproPeer::DESART, FadescartproPeer::ID, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (FadescartproPeer::CODDESC => 0, FadescartproPeer::REFDOC => 1, FadescartproPeer::CODART => 2, FadescartproPeer::MONDESC => 3, FadescartproPeer::MONDETDESC => 4, FadescartproPeer::TIPDOC => 5, FadescartproPeer::DESART => 6, FadescartproPeer::ID => 7, ),
	...
	{
		include_once 'lib/model/facturacion/map/FadescartproMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.facturacion.map.FadescartproMapBuilder');
	}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(FadescartproPeer::DESART);
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/facturacion/map/FadescartproMapBuilder.php';
	Propel::registerMapBuilder('lib.model.facturacion.map.FadescartproMapBuilder');
}

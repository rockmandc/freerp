...
abstract class BaseFafecpedPeer {
	...
	const CLASS_DEFAULT = 'lib.model.facturacion.Fafecped';
	...
	{
		include_once 'lib/model/facturacion/map/FafecpedMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.facturacion.map.FafecpedMapBuilder');
	}
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(FafecpedPeer::ID); 
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/facturacion/map/FafecpedMapBuilder.php';
	Propel::registerMapBuilder('lib.model.facturacion.map.FafecpedMapBuilder');
}

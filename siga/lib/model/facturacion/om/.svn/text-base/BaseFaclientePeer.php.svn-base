...
abstract class BaseFaclientePeer {
	...
	const CLASS_DEFAULT = 'lib.model.facturacion.Facliente';
	...
	const CODEDO = 'facliente.CODEDO';

	
	const PORIVA = 'facliente.PORIVA';

	
	const FATIPCTE_ID = 'facliente.FATIPCTE_ID';

	
	const ESPROSPEC = 'facliente.ESPROSPEC';

	
	const VALDOC = 'facliente.VALDOC';

	
	const CODCTAANT = 'facliente.CODCTAANT';
	...
	{
		include_once 'lib/model/facturacion/map/FaclienteMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.facturacion.map.FaclienteMapBuilder');
	}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(FaclientePeer::CODEDO);

		$criteria->addSelectColumn(FaclientePeer::PORIVA);

		$criteria->addSelectColumn(FaclientePeer::FATIPCTE_ID);

		$criteria->addSelectColumn(FaclientePeer::ESPROSPEC);

		$criteria->addSelectColumn(FaclientePeer::VALDOC);

		$criteria->addSelectColumn(FaclientePeer::CODCTAANT);
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/facturacion/map/FaclienteMapBuilder.php';
	Propel::registerMapBuilder('lib.model.facturacion.map.FaclienteMapBuilder');
}

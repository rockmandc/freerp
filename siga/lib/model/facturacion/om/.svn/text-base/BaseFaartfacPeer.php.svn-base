...
abstract class BaseFaartfacPeer {
	...
	const CLASS_DEFAULT = 'lib.model.facturacion.Faartfac';
	...
	const RECAJU = 'faartfac.RECAJU';

	
	const BTUCON = 'faartfac.BTUCON';

	
	const PREBTU = 'faartfac.PREBTU';

	
	const MONBTU = 'faartfac.MONBTU';

	
	const CODCAN = 'faartfac.CODCAN';

	
	const FECRECFAC = 'faartfac.FECRECFAC';

	
	const RIFPROD = 'faartfac.RIFPROD';

	
	const MONCOM = 'faartfac.MONCOM';

	
	const FACAFI = 'faartfac.FACAFI';

	
	const CODPRO = 'faartfac.CODPRO';

	
	const FECDEV = 'faartfac.FECDEV';

	
	const UNIMED = 'faartfac.UNIMED';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Reffac', 'Codart', 'Desart', 'Codref', 'Cantot', 'Precio', 'Monrgo', 'Mondes', 'Totart', 'Canaju', 'Candes', 'Nronot', 'Orddespacho', 'Guia', 'Contenedores', 'Billleading', 'Placa', 'Rifpro', 'Fecsal', 'Horsal', 'Feclleg', 'Horlleg', 'Codprod', 'Kg', 'Cajas', 'Estatus', 'Observaciones', 'Tm', 'Preaju', 'Cedrif', 'Notentdig', 'Tipov', 'Fecllca', 'Horllca', 'Fecdesc', 'Hordesc', 'Kgent', 'Difkg', 'Cajasent', 'Difcaj', 'Tment', 'Difton', 'Ier', 'Recaju', 'Btucon', 'Prebtu', 'Monbtu', 'Codcan', 'Fecrecfac', 'Rifprod', 'Moncom', 'Facafi', 'Codpro', 'Fecdev', 'Unimed', 'Id', ),
		BasePeer::TYPE_COLNAME => array (FaartfacPeer::REFFAC, FaartfacPeer::CODART, FaartfacPeer::DESART, FaartfacPeer::CODREF, FaartfacPeer::CANTOT, FaartfacPeer::PRECIO, FaartfacPeer::MONRGO, FaartfacPeer::MONDES, FaartfacPeer::TOTART, FaartfacPeer::CANAJU, FaartfacPeer::CANDES, FaartfacPeer::NRONOT, FaartfacPeer::ORDDESPACHO, FaartfacPeer::GUIA, FaartfacPeer::CONTENEDORES, FaartfacPeer::BILLLEADING, FaartfacPeer::PLACA, FaartfacPeer::RIFPRO, FaartfacPeer::FECSAL, FaartfacPeer::HORSAL, FaartfacPeer::FECLLEG, FaartfacPeer::HORLLEG, FaartfacPeer::CODPROD, FaartfacPeer::KG, FaartfacPeer::CAJAS, FaartfacPeer::ESTATUS, FaartfacPeer::OBSERVACIONES, FaartfacPeer::TM, FaartfacPeer::PREAJU, FaartfacPeer::CEDRIF, FaartfacPeer::NOTENTDIG, FaartfacPeer::TIPOV, FaartfacPeer::FECLLCA, FaartfacPeer::HORLLCA, FaartfacPeer::FECDESC, FaartfacPeer::HORDESC, FaartfacPeer::KGENT, FaartfacPeer::DIFKG, FaartfacPeer::CAJASENT, FaartfacPeer::DIFCAJ, FaartfacPeer::TMENT, FaartfacPeer::DIFTON, FaartfacPeer::IER, FaartfacPeer::RECAJU, FaartfacPeer::BTUCON, FaartfacPeer::PREBTU, FaartfacPeer::MONBTU, FaartfacPeer::CODCAN, FaartfacPeer::FECRECFAC, FaartfacPeer::RIFPROD, FaartfacPeer::MONCOM, FaartfacPeer::FACAFI, FaartfacPeer::CODPRO, FaartfacPeer::FECDEV, FaartfacPeer::UNIMED, FaartfacPeer::ID, ),
		BasePeer::TYPE_FIELDNAME => array ('reffac', 'codart', 'desart', 'codref', 'cantot', 'precio', 'monrgo', 'mondes', 'totart', 'canaju', 'candes', 'nronot', 'orddespacho', 'guia', 'contenedores', 'billleading', 'placa', 'rifpro', 'fecsal', 'horsal', 'feclleg', 'horlleg', 'codprod', 'kg', 'cajas', 'estatus', 'observaciones', 'tm', 'preaju', 'cedrif', 'notentdig', 'tipov', 'fecllca', 'horllca', 'fecdesc', 'hordesc', 'kgent', 'difkg', 'cajasent', 'difcaj', 'tment', 'difton', 'ier', 'recaju', 'btucon', 'prebtu', 'monbtu', 'codcan', 'fecrecfac', 'rifprod', 'moncom', 'facafi', 'codpro', 'fecdev', 'unimed', 'id', ),
	...
	{
		include_once 'lib/model/facturacion/map/FaartfacMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.facturacion.map.FaartfacMapBuilder');
	}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(FaartfacPeer::RECAJU);

		$criteria->addSelectColumn(FaartfacPeer::BTUCON);

		$criteria->addSelectColumn(FaartfacPeer::PREBTU);

		$criteria->addSelectColumn(FaartfacPeer::MONBTU);

		$criteria->addSelectColumn(FaartfacPeer::CODCAN);

		$criteria->addSelectColumn(FaartfacPeer::FECRECFAC);

		$criteria->addSelectColumn(FaartfacPeer::RIFPROD);

		$criteria->addSelectColumn(FaartfacPeer::MONCOM);

		$criteria->addSelectColumn(FaartfacPeer::FACAFI);

		$criteria->addSelectColumn(FaartfacPeer::CODPRO);

		$criteria->addSelectColumn(FaartfacPeer::FECDEV);

		$criteria->addSelectColumn(FaartfacPeer::UNIMED);
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/facturacion/map/FaartfacMapBuilder.php';
	Propel::registerMapBuilder('lib.model.facturacion.map.FaartfacMapBuilder');
}

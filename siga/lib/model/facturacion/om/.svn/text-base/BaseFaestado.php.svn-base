  ...
  public function get($m, $a)
	...
	public function getFapais($con = null)
	{
		if ($this->aFapais === null && ($this->fapais_id !== null)) {
						include_once 'lib/model/facturacion/om/BaseFapaisPeer.php';

      $c = new Criteria();
      $c->add(FapaisPeer::ID,$this->fapais_id);
      
			$this->aFapais = FapaisPeer::doSelectOne($c, $con);
	...
	{
				include_once 'lib/model/facturacion/om/BaseFaciudadPeer.php';
		if ($criteria === null) {

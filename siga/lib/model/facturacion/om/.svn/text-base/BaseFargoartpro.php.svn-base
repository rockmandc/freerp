...
abstract class BaseFargoartpro extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->desart !== $v) {
        $this->desart = $v;
        $this->modifiedColumns[] = FargoartproPeer::DESART;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->desart = $rs->getString($startcol + 5);
  ...
  public function get($m, $a)
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[5], $arr)) $this->setDesart($arr[$keys[5]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(FargoartproPeer::DESART)) $criteria->add(FargoartproPeer::DESART, $this->desart);

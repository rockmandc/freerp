...
abstract class BaseFadtoctePeer {
	...
	const CLASS_DEFAULT = 'lib.model.facturacion.Fadtocte';
	...
	{
		include_once 'lib/model/facturacion/map/FadtocteMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.facturacion.map.FadtocteMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/facturacion/map/FadtocteMapBuilder.php';
	Propel::registerMapBuilder('lib.model.facturacion.map.FadtocteMapBuilder');
}

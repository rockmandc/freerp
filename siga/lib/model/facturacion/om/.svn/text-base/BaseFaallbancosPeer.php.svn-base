...
abstract class BaseFaallbancosPeer {
	...
	const CLASS_DEFAULT = 'lib.model.facturacion.Faallbancos';
	...
	{
		include_once 'lib/model/facturacion/map/FaallbancosMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.facturacion.map.FaallbancosMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/facturacion/map/FaallbancosMapBuilder.php';
	Propel::registerMapBuilder('lib.model.facturacion.map.FaallbancosMapBuilder');
}

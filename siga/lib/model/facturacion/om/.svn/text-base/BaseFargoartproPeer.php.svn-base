...
abstract class BaseFargoartproPeer {
	...
	const CLASS_DEFAULT = 'lib.model.facturacion.Fargoartpro';
	...
	const DESART = 'fargoartpro.DESART';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Codrgo', 'Codart', 'Refdoc', 'Monrgo', 'Tipdoc', 'Desart', 'Id', ),
		BasePeer::TYPE_COLNAME => array (FargoartproPeer::CODRGO, FargoartproPeer::CODART, FargoartproPeer::REFDOC, FargoartproPeer::MONRGO, FargoartproPeer::TIPDOC, FargoartproPeer::DESART, FargoartproPeer::ID, ),
		BasePeer::TYPE_FIELDNAME => array ('codrgo', 'codart', 'refdoc', 'monrgo', 'tipdoc', 'desart', 'id', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Codrgo' => 0, 'Codart' => 1, 'Refdoc' => 2, 'Monrgo' => 3, 'Tipdoc' => 4, 'Desart' => 5, 'Id' => 6, ),
		BasePeer::TYPE_COLNAME => array (FargoartproPeer::CODRGO => 0, FargoartproPeer::CODART => 1, FargoartproPeer::REFDOC => 2, FargoartproPeer::MONRGO => 3, FargoartproPeer::TIPDOC => 4, FargoartproPeer::DESART => 5, FargoartproPeer::ID => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('codrgo' => 0, 'codart' => 1, 'refdoc' => 2, 'monrgo' => 3, 'tipdoc' => 4, 'desart' => 5, 'id' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	{
		include_once 'lib/model/facturacion/map/FargoartproMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.facturacion.map.FargoartproMapBuilder');
	}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(FargoartproPeer::DESART);
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/facturacion/map/FargoartproMapBuilder.php';
	Propel::registerMapBuilder('lib.model.facturacion.map.FargoartproMapBuilder');
}

...
abstract class BaseFaforpagPeer {
	...
	const CLASS_DEFAULT = 'lib.model.facturacion.Faforpag';
	...
	{
		include_once 'lib/model/facturacion/map/FaforpagMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.facturacion.map.FaforpagMapBuilder');
	}
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(FaforpagPeer::ID); 
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/facturacion/map/FaforpagMapBuilder.php';
	Propel::registerMapBuilder('lib.model.facturacion.map.FaforpagMapBuilder');
}

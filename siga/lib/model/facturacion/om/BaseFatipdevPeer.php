...
abstract class BaseFatipdevPeer {
	...
	const CLASS_DEFAULT = 'lib.model.facturacion.Fatipdev';
	...
	{
		include_once 'lib/model/facturacion/map/FatipdevMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.facturacion.map.FatipdevMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/facturacion/map/FatipdevMapBuilder.php';
	Propel::registerMapBuilder('lib.model.facturacion.map.FatipdevMapBuilder');
}

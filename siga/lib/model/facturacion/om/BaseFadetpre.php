...
abstract class BaseFadetpre extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->unimed !== $v) {
        $this->unimed = $v;
        $this->modifiedColumns[] = FadetprePeer::UNIMED;
      }
    ...
    if ($this->desart !== $v) {
        $this->desart = $v;
        $this->modifiedColumns[] = FadetprePeer::DESART;
      }
    ...
    if ($this->codmon !== $v) {
        $this->codmon = $v;
        $this->modifiedColumns[] = FadetprePeer::CODMON;
      }
    ...
    if ($this->valmon !== $v || $v === 1) {
        ...
        $this->modifiedColumns[] = FadetprePeer::VALMON;
      }
    ...
    if ($this->nuitem !== $v) {
        $this->nuitem = $v;
        $this->modifiedColumns[] = FadetprePeer::NUITEM;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->desart = $rs->getString($startcol + 9);

      $this->codmon = $rs->getString($startcol + 10);

      $this->valmon = $rs->getFloat($startcol + 11);

      $this->nuitem = $rs->getString($startcol + 12);
  ...
  public function get($m, $a)
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(FadetprePeer::UNIMED)) $criteria->add(FadetprePeer::UNIMED, $this->unimed);
		if ($this->isColumnModified(FadetprePeer::DESART)) $criteria->add(FadetprePeer::DESART, $this->desart);
		if ($this->isColumnModified(FadetprePeer::CODMON)) $criteria->add(FadetprePeer::CODMON, $this->codmon);
		if ($this->isColumnModified(FadetprePeer::VALMON)) $criteria->add(FadetprePeer::VALMON, $this->valmon);
		if ($this->isColumnModified(FadetprePeer::NUITEM)) $criteria->add(FadetprePeer::NUITEM, $this->nuitem);

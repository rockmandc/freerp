...
abstract class BaseFaartped extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->btucon !== $v) {
        ...
        $this->modifiedColumns[] = FaartpedPeer::BTUCON;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->btucon = $rs->getFloat($startcol + 10);
  ...
  public function get($m, $a)
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[10], $arr)) $this->setBtucon($arr[$keys[10]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(FaartpedPeer::BTUCON)) $criteria->add(FaartpedPeer::BTUCON, $this->btucon);

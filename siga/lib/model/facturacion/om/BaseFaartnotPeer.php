...
abstract class BaseFaartnotPeer {
	...
	const CLASS_DEFAULT = 'lib.model.facturacion.Faartnot';
	...
	{
		include_once 'lib/model/facturacion/map/FaartnotMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.facturacion.map.FaartnotMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/facturacion/map/FaartnotMapBuilder.php';
	Propel::registerMapBuilder('lib.model.facturacion.map.FaartnotMapBuilder');
}

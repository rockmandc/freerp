 ...
 * @version SVN: $Id: Facliente.php 59696 2014-11-27 21:11:41Z dmartinez $
 * 
...
class Facliente extends BaseFacliente
{
 ...
 public function getNomram()
  ...
  return self::getNompro();
   ...
   public function getDesctaant()
  {
    return H::getX_vacio('Codcta','Contabb','Descta',self::getCodctaant());
  }

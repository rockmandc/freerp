...
class FadesctoMapBuilder {

	
	const CLASS_NAME = 'lib.model.facturacion.map.FadesctoMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('fadescto');
		$tMap->setPhpName('Fadescto');

		$tMap->setUseIdGenerator(true);

		$tMap->setPrimaryKeyMethodInfo('fadescto_SEQ');
		...
		$tMap->addColumn('COMRET', 'Comret', 'string', CreoleTypes::VARCHAR, false, 1);

		$tMap->addColumn('PORBAS', 'Porbas', 'double', CreoleTypes::NUMERIC, false, 14);

...
class FaclienteMapBuilder {
	...
	const CLASS_NAME = 'lib.model.facturacion.map.FaclienteMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('DIRPRO', 'Dirpro', 'string', CreoleTypes::VARCHAR, false, 500);
		...
		$tMap->addForeignKey('FATIPCTE_ID', 'FatipcteId', 'int', CreoleTypes::INTEGER, 'fatipcte', 'ID', true, null);

		$tMap->addColumn('ESPROSPEC', 'Esprospec', 'boolean', CreoleTypes::BOOLEAN, false, null);

		$tMap->addColumn('VALDOC', 'Valdoc', 'double', CreoleTypes::NUMERIC, false, 3);

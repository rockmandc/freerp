...
class FaartfacMapBuilder {
	...
	const CLASS_NAME = 'lib.model.facturacion.map.FaartfacMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('GUIA', 'Guia', 'string', CreoleTypes::VARCHAR, false, 20);
		...
		$tMap->addColumn('CODCAN', 'Codcan', 'string', CreoleTypes::VARCHAR, false, 3);
		...
		$tMap->addColumn('FACAFI', 'Facafi', 'string', CreoleTypes::VARCHAR, false, 20);

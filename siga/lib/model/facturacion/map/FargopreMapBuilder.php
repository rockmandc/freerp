...
class FargopreMapBuilder {

	
	const CLASS_NAME = 'lib.model.facturacion.map.FargopreMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('fargopre');
		$tMap->setPhpName('Fargopre');

		$tMap->setUseIdGenerator(true);

		$tMap->setPrimaryKeyMethodInfo('fargopre_SEQ');

...
abstract class BaseCpsolmovtraperdes extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->reftra !== $v) {
        $this->reftra = $v;
        $this->modifiedColumns[] = CpsolmovtraperdesPeer::REFTRA;
      }
    ...
    if ($this->coddes !== $v) {
        $this->coddes = $v;
        $this->modifiedColumns[] = CpsolmovtraperdesPeer::CODDES;
      }
    ...
    if ($this->perpre !== $v) {
        $this->perpre = $v;
        $this->modifiedColumns[] = CpsolmovtraperdesPeer::PERPRE;
      }
    ...
    if ($this->monmov !== $v) {
        ...
        $this->modifiedColumns[] = CpsolmovtraperdesPeer::MONMOV;
      }
    ...
    if ($this->id !== $v) {
        $this->id = $v;
        $this->modifiedColumns[] = CpsolmovtraperdesPeer::ID;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      throw new PropelException("Error populating Cpsolmovtraperdes object", $e);
    }
  }
  ...
  public function get($m, $a)
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			CpsolmovtraperdesPeer::doDelete($this, $con);
		...
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			...
			if ($this->aCpsoltrasla !== null) {
				...
				$this->setCpsoltrasla($this->aCpsoltrasla);
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = CpsolmovtraperdesPeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += CpsolmovtraperdesPeer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = CpsolmovtraperdesPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = CpsolmovtraperdesPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = CpsolmovtraperdesPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CpsolmovtraperdesPeer::REFTRA)) $criteria->add(CpsolmovtraperdesPeer::REFTRA, $this->reftra);
		if ($this->isColumnModified(CpsolmovtraperdesPeer::CODDES)) $criteria->add(CpsolmovtraperdesPeer::CODDES, $this->coddes);
		if ($this->isColumnModified(CpsolmovtraperdesPeer::PERPRE)) $criteria->add(CpsolmovtraperdesPeer::PERPRE, $this->perpre);
		if ($this->isColumnModified(CpsolmovtraperdesPeer::MONMOV)) $criteria->add(CpsolmovtraperdesPeer::MONMOV, $this->monmov);
		if ($this->isColumnModified(CpsolmovtraperdesPeer::ID)) $criteria->add(CpsolmovtraperdesPeer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(CpsolmovtraperdesPeer::ID, $this->id);
	...
	{
		if (self::$peer === null) {
			self::$peer = new CpsolmovtraperdesPeer();
		}
		return self::$peer;
	}

...
abstract class BaseCpcausad extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->fecreg !== $ts || $ts === 1400878777) {
      $this->fecreg = $ts;
      $this->modifiedColumns[] = CpcausadPeer::FECREG;
    }
    ...
    if ($this->numcom !== $v) {
        $this->numcom = $v;
        $this->modifiedColumns[] = CpcausadPeer::NUMCOM;
      }
    ...
    if ($this->coddirec !== $v) {
        $this->coddirec = $v;
        $this->modifiedColumns[] = CpcausadPeer::CODDIREC;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->fecreg = $rs->getTimestamp($startcol + 14, null);
  ...
  public function get($m, $a)
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CpcausadPeer::FECREG)) $criteria->add(CpcausadPeer::FECREG, $this->fecreg);
		if ($this->isColumnModified(CpcausadPeer::NUMCOM)) $criteria->add(CpcausadPeer::NUMCOM, $this->numcom);
		if ($this->isColumnModified(CpcausadPeer::CODDIREC)) $criteria->add(CpcausadPeer::CODDIREC, $this->coddirec);

...
abstract class BaseCpprecom extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->fecreg !== $ts || $ts === 1400878777) {
      $this->fecreg = $ts;
      $this->modifiedColumns[] = CpprecomPeer::FECREG;
    }
    ...
    if ($this->coddirec !== $v) {
        $this->coddirec = $v;
        $this->modifiedColumns[] = CpprecomPeer::CODDIREC;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->fecreg = $rs->getTimestamp($startcol + 15, null);
  ...
  public function get($m, $a)
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CpprecomPeer::FECREG)) $criteria->add(CpprecomPeer::FECREG, $this->fecreg);
		if ($this->isColumnModified(CpprecomPeer::CODDIREC)) $criteria->add(CpprecomPeer::CODDIREC, $this->coddirec);
	...
	public function getCpcomprosJoinCaprovee($criteria = null, $con = null)
	{
				include_once 'lib/model/presupuesto/om/BaseCpcomproPeer.php';
		if ($criteria === null) {
			$criteria = new Criteria();
		...
		if ($this->collCpcompros === null) {
			if ($this->isNew()) {
				...
				$this->collCpcompros = CpcomproPeer::doSelectJoinCaprovee($criteria, $con);
			}
		} else {

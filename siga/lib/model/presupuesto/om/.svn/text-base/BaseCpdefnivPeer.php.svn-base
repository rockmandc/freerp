...
abstract class BaseCpdefnivPeer {
	...
	const CONPAR = 'cpdefniv.CONPAR';

	
	const TIPCAU = 'cpdefniv.TIPCAU';

	
	const CEDRIF = 'cpdefniv.CEDRIF';

	
	const TIPCOM = 'cpdefniv.TIPCOM';

	
	const REPSOLADIDIS1 = 'cpdefniv.REPSOLADIDIS1';

	
	const REPSOLADIDIS2 = 'cpdefniv.REPSOLADIDIS2';

	
	const NOMDIRPRE = 'cpdefniv.NOMDIRPRE';

	
	const CARDIRPRE = 'cpdefniv.CARDIRPRE';

	
	const REPSOLTRASLA1 = 'cpdefniv.REPSOLTRASLA1';

	
	const REPSOLTRASLA2 = 'cpdefniv.REPSOLTRASLA2';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Codemp', 'Loncod', 'Rupcat', 'Ruppar', 'Nivdis', 'Forpre', 'Asiper', 'Numper', 'Peract', 'Fecper', 'Fecini', 'Feccie', 'Etadef', 'Staprc', 'Coraep', 'Gencom', 'Numcom', 'Caraep', 'Tiptraprc', 'Fueord', 'Fuecre', 'Fuetra', 'Nomgob', 'Nomsec', 'Unidad', 'Cortrasla', 'Coradidis', 'Corprc', 'Corcom', 'Corcau', 'Corpag', 'Corsoladidis', 'Corsoltra', 'Coraju', 'Corfue', 'Btnanu', 'Btneli', 'Conpar', 'Tipcau', 'Cedrif', 'Tipcom', 'Repsoladidis1', 'Repsoladidis2', 'Nomdirpre', 'Cardirpre', 'Repsoltrasla1', 'Repsoltrasla2', 'Id', ),
		BasePeer::TYPE_COLNAME => array (CpdefnivPeer::CODEMP, CpdefnivPeer::LONCOD, CpdefnivPeer::RUPCAT, CpdefnivPeer::RUPPAR, CpdefnivPeer::NIVDIS, CpdefnivPeer::FORPRE, CpdefnivPeer::ASIPER, CpdefnivPeer::NUMPER, CpdefnivPeer::PERACT, CpdefnivPeer::FECPER, CpdefnivPeer::FECINI, CpdefnivPeer::FECCIE, CpdefnivPeer::ETADEF, CpdefnivPeer::STAPRC, CpdefnivPeer::CORAEP, CpdefnivPeer::GENCOM, CpdefnivPeer::NUMCOM, CpdefnivPeer::CARAEP, CpdefnivPeer::TIPTRAPRC, CpdefnivPeer::FUEORD, CpdefnivPeer::FUECRE, CpdefnivPeer::FUETRA, CpdefnivPeer::NOMGOB, CpdefnivPeer::NOMSEC, CpdefnivPeer::UNIDAD, CpdefnivPeer::CORTRASLA, CpdefnivPeer::CORADIDIS, CpdefnivPeer::CORPRC, CpdefnivPeer::CORCOM, CpdefnivPeer::CORCAU, CpdefnivPeer::CORPAG, CpdefnivPeer::CORSOLADIDIS, CpdefnivPeer::CORSOLTRA, CpdefnivPeer::CORAJU, CpdefnivPeer::CORFUE, CpdefnivPeer::BTNANU, CpdefnivPeer::BTNELI, CpdefnivPeer::CONPAR, CpdefnivPeer::TIPCAU, CpdefnivPeer::CEDRIF, CpdefnivPeer::TIPCOM, CpdefnivPeer::REPSOLADIDIS1, CpdefnivPeer::REPSOLADIDIS2, CpdefnivPeer::NOMDIRPRE, CpdefnivPeer::CARDIRPRE, CpdefnivPeer::REPSOLTRASLA1, CpdefnivPeer::REPSOLTRASLA2, CpdefnivPeer::ID, ),
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(CpdefnivPeer::CONPAR);

		$criteria->addSelectColumn(CpdefnivPeer::TIPCAU);

		$criteria->addSelectColumn(CpdefnivPeer::CEDRIF);

		$criteria->addSelectColumn(CpdefnivPeer::TIPCOM);

		$criteria->addSelectColumn(CpdefnivPeer::REPSOLADIDIS1);

		$criteria->addSelectColumn(CpdefnivPeer::REPSOLADIDIS2);

		$criteria->addSelectColumn(CpdefnivPeer::NOMDIRPRE);

		$criteria->addSelectColumn(CpdefnivPeer::CARDIRPRE);

		$criteria->addSelectColumn(CpdefnivPeer::REPSOLTRASLA1);

		$criteria->addSelectColumn(CpdefnivPeer::REPSOLTRASLA2);

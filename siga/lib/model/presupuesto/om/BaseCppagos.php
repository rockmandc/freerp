...
abstract class BaseCppagos extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->fecreg !== $ts || $ts === 1400878777) {
      $this->fecreg = $ts;
      $this->modifiedColumns[] = CppagosPeer::FECREG;
    }
    ...
    if ($this->coddirec !== $v) {
        $this->coddirec = $v;
        $this->modifiedColumns[] = CppagosPeer::CODDIREC;
      }
  ...
  public function get($m, $a)
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CppagosPeer::FECREG)) $criteria->add(CppagosPeer::FECREG, $this->fecreg);
		if ($this->isColumnModified(CppagosPeer::CODDIREC)) $criteria->add(CppagosPeer::CODDIREC, $this->coddirec);

...
abstract class BaseCpsoltrasla extends BaseObject  implements Persistent {
	...
	protected $collCpsolmovtraperoris;

	
	protected $lastCpsolmovtraperoriCriteria = null;

	
	protected $collCpsolmovtraperdess;

	
	protected $lastCpsolmovtraperdesCriteria = null;
  ...
  public function getId()
  {
    ...
    if ($this->coddirec !== $v) {
        $this->coddirec = $v;
        $this->modifiedColumns[] = CpsoltraslaPeer::CODDIREC;
      }
    ...
    if ($this->bascal !== $v) {
        $this->bascal = $v;
        $this->modifiedColumns[] = CpsoltraslaPeer::BASCAL;
      }
    ...
    if ($this->iniana !== $v) {
        $this->iniana = $v;
        $this->modifiedColumns[] = CpsoltraslaPeer::INIANA;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->bascal = $rs->getString($startcol + 42);

      $this->iniana = $rs->getString($startcol + 43);
  ...
  public function get($m, $a)
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			...
			if ($this->collCpsolmovtraperoris !== null) {
				foreach($this->collCpsolmovtraperoris as $referrerFK) {
					if (!$referrerFK->isDeleted()) {
						$affectedRows += $referrerFK->save($con);
					}
				}
			...
			if ($this->collCpsolmovtraperdess !== null) {
				foreach($this->collCpsolmovtraperdess as $referrerFK) {
					if (!$referrerFK->isDeleted()) {
						$affectedRows += $referrerFK->save($con);
					}
				}
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		$result = array(
			...
			$keys[42] => $this->getBascal(),
			$keys[43] => $this->getIniana(),
			$keys[44] => $this->getId(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[42], $arr)) $this->setBascal($arr[$keys[42]]);
		if (array_key_exists($keys[43], $arr)) $this->setIniana($arr[$keys[43]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CpsoltraslaPeer::CODDIREC)) $criteria->add(CpsoltraslaPeer::CODDIREC, $this->coddirec);
		if ($this->isColumnModified(CpsoltraslaPeer::BASCAL)) $criteria->add(CpsoltraslaPeer::BASCAL, $this->bascal);
		if ($this->isColumnModified(CpsoltraslaPeer::INIANA)) $criteria->add(CpsoltraslaPeer::INIANA, $this->iniana);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		if ($deepCopy) {
			...
			foreach($this->getCpsolmovtraperoris() as $relObj) {
				$copyObj->addCpsolmovtraperori($relObj->copy($deepCopy));
			}

			foreach($this->getCpsolmovtraperdess() as $relObj) {
				$copyObj->addCpsolmovtraperdes($relObj->copy($deepCopy));
			}
	...
	public function initCpsolmovtraperoris()
	{
		if ($this->collCpsolmovtraperoris === null) {
			$this->collCpsolmovtraperoris = array();
		}
	}

	
	public function getCpsolmovtraperoris($criteria = null, $con = null)
	{
				include_once 'lib/model/presupuesto/om/BaseCpsolmovtraperoriPeer.php';
		if ($criteria === null) {
			$criteria = new Criteria();
		}
		elseif ($criteria instanceof Criteria)
		...
		if ($this->collCpsolmovtraperoris === null) {
			if ($this->isNew()) {
			   $this->collCpsolmovtraperoris = array();
				...
				$criteria->add(CpsolmovtraperoriPeer::REFTRA, $this->getReftra());

				CpsolmovtraperoriPeer::addSelectColumns($criteria);
				$this->collCpsolmovtraperoris = CpsolmovtraperoriPeer::doSelect($criteria, $con);
			}
		} else {
						if (!$this->isNew()) {
				...
				CpsolmovtraperoriPeer::addSelectColumns($criteria);
				if (!isset($this->lastCpsolmovtraperoriCriteria) || !$this->lastCpsolmovtraperoriCriteria->equals($criteria)) {
					$this->collCpsolmovtraperoris = CpsolmovtraperoriPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastCpsolmovtraperoriCriteria = $criteria;
		return $this->collCpsolmovtraperoris;
	}

	
	public function countCpsolmovtraperoris($criteria = null, $distinct = false, $con = null)
	{
				include_once 'lib/model/presupuesto/om/BaseCpsolmovtraperoriPeer.php';
		if ($criteria === null) {
			$criteria = new Criteria();
		...
		return CpsolmovtraperoriPeer::doCount($criteria, $distinct, $con);
	}

	
	public function addCpsolmovtraperori(Cpsolmovtraperori $l)
	{
		$this->collCpsolmovtraperoris[] = $l;
		$l->setCpsoltrasla($this);
	}

	
	public function initCpsolmovtraperdess()
	{
		if ($this->collCpsolmovtraperdess === null) {
			$this->collCpsolmovtraperdess = array();
		}
	}

	
	public function getCpsolmovtraperdess($criteria = null, $con = null)
	{
				include_once 'lib/model/presupuesto/om/BaseCpsolmovtraperdesPeer.php';
		if ($criteria === null) {
			$criteria = new Criteria();
		}
		elseif ($criteria instanceof Criteria)
		...
		if ($this->collCpsolmovtraperdess === null) {
			if ($this->isNew()) {
			   $this->collCpsolmovtraperdess = array();
				...
				$criteria->add(CpsolmovtraperdesPeer::REFTRA, $this->getReftra());

				CpsolmovtraperdesPeer::addSelectColumns($criteria);
				$this->collCpsolmovtraperdess = CpsolmovtraperdesPeer::doSelect($criteria, $con);
			}
		} else {
						if (!$this->isNew()) {
				...
				CpsolmovtraperdesPeer::addSelectColumns($criteria);
				if (!isset($this->lastCpsolmovtraperdesCriteria) || !$this->lastCpsolmovtraperdesCriteria->equals($criteria)) {
					$this->collCpsolmovtraperdess = CpsolmovtraperdesPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastCpsolmovtraperdesCriteria = $criteria;
		return $this->collCpsolmovtraperdess;
	}

	
	public function countCpsolmovtraperdess($criteria = null, $distinct = false, $con = null)
	{
				include_once 'lib/model/presupuesto/om/BaseCpsolmovtraperdesPeer.php';
		if ($criteria === null) {
			$criteria = new Criteria();
		...
		return CpsolmovtraperdesPeer::doCount($criteria, $distinct, $con);
	}

	
	public function addCpsolmovtraperdes(Cpsolmovtraperdes $l)
	{
		$this->collCpsolmovtraperdess[] = $l;
		$l->setCpsoltrasla($this);
	}

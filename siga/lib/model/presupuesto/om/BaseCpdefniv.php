...
abstract class BaseCpdefniv extends BaseObject  implements Persistent {
	...
	protected $repsoladidis1;


	
	protected $repsoladidis2;
	...
	protected $repsoltrasla1;


	
	protected $repsoltrasla2;
  ...
  public function getRepsoladidis1()
  {

    return trim($this->repsoladidis1);

  }
  
  public function getRepsoladidis2()
  {

    return trim($this->repsoladidis2);

  }
  
  public function getNomdirpre()
  {

    return trim($this->nomdirpre);

  }
  
  public function getCardirpre()
  {

    return trim($this->cardirpre);

  }
  
  public function getRepsoltrasla1()
  {

    return trim($this->repsoltrasla1);

  }
  
  public function getRepsoltrasla2()
  {

    return trim($this->repsoltrasla2);
  ...
  public function getId()
  {
    ...
    if ($this->tipcau !== $v) {
        $this->tipcau = $v;
        $this->modifiedColumns[] = CpdefnivPeer::TIPCAU;
      }
    ...
    if ($this->cedrif !== $v) {
        $this->cedrif = $v;
        $this->modifiedColumns[] = CpdefnivPeer::CEDRIF;
      }
    ...
    if ($this->tipcom !== $v) {
        $this->tipcom = $v;
        $this->modifiedColumns[] = CpdefnivPeer::TIPCOM;
      }
  
	} 
	
	public function setRepsoladidis1($v)
	{

    if ($this->repsoladidis1 !== $v) {
        $this->repsoladidis1 = $v;
        $this->modifiedColumns[] = CpdefnivPeer::REPSOLADIDIS1;
      }
  
	} 
	
	public function setRepsoladidis2($v)
	{

    if ($this->repsoladidis2 !== $v) {
        $this->repsoladidis2 = $v;
        $this->modifiedColumns[] = CpdefnivPeer::REPSOLADIDIS2;
      }
  
	} 
	
	public function setNomdirpre($v)
	{

    if ($this->nomdirpre !== $v) {
        $this->nomdirpre = $v;
        $this->modifiedColumns[] = CpdefnivPeer::NOMDIRPRE;
      }
  
	} 
	
	public function setCardirpre($v)
	{

    if ($this->cardirpre !== $v) {
        $this->cardirpre = $v;
        $this->modifiedColumns[] = CpdefnivPeer::CARDIRPRE;
      }
  
	} 
	
	public function setRepsoltrasla1($v)
	{

    if ($this->repsoltrasla1 !== $v) {
        $this->repsoltrasla1 = $v;
        $this->modifiedColumns[] = CpdefnivPeer::REPSOLTRASLA1;
      }
  
	} 
	
	public function setRepsoltrasla2($v)
	{

    if ($this->repsoltrasla2 !== $v) {
        $this->repsoltrasla2 = $v;
        $this->modifiedColumns[] = CpdefnivPeer::REPSOLTRASLA2;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->tipcau = $rs->getString($startcol + 38);

      $this->cedrif = $rs->getString($startcol + 39);

      $this->tipcom = $rs->getString($startcol + 40);

      $this->repsoladidis1 = $rs->getString($startcol + 41);

      $this->repsoladidis2 = $rs->getString($startcol + 42);

      $this->nomdirpre = $rs->getString($startcol + 43);

      $this->cardirpre = $rs->getString($startcol + 44);

      $this->repsoltrasla1 = $rs->getString($startcol + 45);

      $this->repsoltrasla2 = $rs->getString($startcol + 46);
  ...
  public function get($m, $a)
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 40:
				...
				break;
			case 41:
				return $this->getRepsoladidis1();
				break;
			case 42:
				return $this->getRepsoladidis2();
				break;
			case 43:
				return $this->getNomdirpre();
				break;
			case 44:
				return $this->getCardirpre();
				break;
			case 45:
				return $this->getRepsoltrasla1();
				break;
			case 46:
				return $this->getRepsoltrasla2();
				break;
			case 47:
				return $this->getId();
				break;
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		$result = array(
			...
			$keys[38] => $this->getTipcau(),
			$keys[39] => $this->getCedrif(),
			$keys[40] => $this->getTipcom(),
			$keys[41] => $this->getRepsoladidis1(),
			$keys[42] => $this->getRepsoladidis2(),
			$keys[43] => $this->getNomdirpre(),
			$keys[44] => $this->getCardirpre(),
			$keys[45] => $this->getRepsoltrasla1(),
			$keys[46] => $this->getRepsoltrasla2(),
			$keys[47] => $this->getId(),
		);
		return $result;
	}
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 40:
				...
				break;
			case 41:
				$this->setRepsoladidis1($value);
				break;
			case 42:
				$this->setRepsoladidis2($value);
				break;
			case 43:
				$this->setNomdirpre($value);
				break;
			case 44:
				$this->setCardirpre($value);
				break;
			case 45:
				$this->setRepsoltrasla1($value);
				break;
			case 46:
				$this->setRepsoltrasla2($value);
				break;
			case 47:
				$this->setId($value);
				break;
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[38], $arr)) $this->setTipcau($arr[$keys[38]]);
		if (array_key_exists($keys[39], $arr)) $this->setCedrif($arr[$keys[39]]);
		if (array_key_exists($keys[40], $arr)) $this->setTipcom($arr[$keys[40]]);
		if (array_key_exists($keys[41], $arr)) $this->setRepsoladidis1($arr[$keys[41]]);
		if (array_key_exists($keys[42], $arr)) $this->setRepsoladidis2($arr[$keys[42]]);
		if (array_key_exists($keys[43], $arr)) $this->setNomdirpre($arr[$keys[43]]);
		if (array_key_exists($keys[44], $arr)) $this->setCardirpre($arr[$keys[44]]);
		if (array_key_exists($keys[45], $arr)) $this->setRepsoltrasla1($arr[$keys[45]]);
		if (array_key_exists($keys[46], $arr)) $this->setRepsoltrasla2($arr[$keys[46]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CpdefnivPeer::TIPCAU)) $criteria->add(CpdefnivPeer::TIPCAU, $this->tipcau);
		if ($this->isColumnModified(CpdefnivPeer::CEDRIF)) $criteria->add(CpdefnivPeer::CEDRIF, $this->cedrif);
		if ($this->isColumnModified(CpdefnivPeer::TIPCOM)) $criteria->add(CpdefnivPeer::TIPCOM, $this->tipcom);
		if ($this->isColumnModified(CpdefnivPeer::REPSOLADIDIS1)) $criteria->add(CpdefnivPeer::REPSOLADIDIS1, $this->repsoladidis1);
		if ($this->isColumnModified(CpdefnivPeer::REPSOLADIDIS2)) $criteria->add(CpdefnivPeer::REPSOLADIDIS2, $this->repsoladidis2);
		if ($this->isColumnModified(CpdefnivPeer::NOMDIRPRE)) $criteria->add(CpdefnivPeer::NOMDIRPRE, $this->nomdirpre);
		if ($this->isColumnModified(CpdefnivPeer::CARDIRPRE)) $criteria->add(CpdefnivPeer::CARDIRPRE, $this->cardirpre);
		if ($this->isColumnModified(CpdefnivPeer::REPSOLTRASLA1)) $criteria->add(CpdefnivPeer::REPSOLTRASLA1, $this->repsoltrasla1);
		if ($this->isColumnModified(CpdefnivPeer::REPSOLTRASLA2)) $criteria->add(CpdefnivPeer::REPSOLTRASLA2, $this->repsoltrasla2);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setRepsoladidis1($this->repsoladidis1);

		$copyObj->setRepsoladidis2($this->repsoladidis2);

		$copyObj->setNomdirpre($this->nomdirpre);

		$copyObj->setCardirpre($this->cardirpre);

		$copyObj->setRepsoltrasla1($this->repsoltrasla1);

		$copyObj->setRepsoltrasla2($this->repsoltrasla2);

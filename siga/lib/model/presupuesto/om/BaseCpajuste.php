...
abstract class BaseCpajuste extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->tipaju !== $v) {
		...
		if ($this->aCpdocaju !== null && $this->aCpdocaju->getTipaju() !== $v) {
			$this->aCpdocaju = null;
		}
    ...
    if ($this->fecreg !== $ts || $ts === 1428418573) {
      $this->fecreg = $ts;
      $this->modifiedColumns[] = CpajustePeer::FECREG;
    }
    ...
    if ($this->loguse !== $v) {
        $this->loguse = $v;
        $this->modifiedColumns[] = CpajustePeer::LOGUSE;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->fecreg = $rs->getTimestamp($startcol + 17, null);

      $this->loguse = $rs->getString($startcol + 18);
  ...
  public function get($m, $a)
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			...
			if ($this->aCpdocaju !== null) {
				if ($this->aCpdocaju->isModified()) {
					$affectedRows += $this->aCpdocaju->save($con);
				}
				$this->setCpdocaju($this->aCpdocaju);
			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if ($this->aCpdocaju !== null) {
				if (!$this->aCpdocaju->validate($columns)) {
					$failureMap = array_merge($failureMap, $this->aCpdocaju->getValidationFailures());
				}
			}
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		$result = array(
			...
			$keys[17] => $this->getFecreg(),
			$keys[18] => $this->getLoguse(),
			$keys[19] => $this->getId(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[17], $arr)) $this->setFecreg($arr[$keys[17]]);
		if (array_key_exists($keys[18], $arr)) $this->setLoguse($arr[$keys[18]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CpajustePeer::FECREG)) $criteria->add(CpajustePeer::FECREG, $this->fecreg);
		if ($this->isColumnModified(CpajustePeer::LOGUSE)) $criteria->add(CpajustePeer::LOGUSE, $this->loguse);
	...
	public function getCpdocaju($con = null)
	{
		if ($this->aCpdocaju === null && (($this->tipaju !== "" && $this->tipaju !== null))) {
						include_once 'lib/model/presupuesto/om/BaseCpdocajuPeer.php';

      $c = new Criteria();
      $c->add(CpdocajuPeer::TIPAJU,$this->tipaju);
      
			$this->aCpdocaju = CpdocajuPeer::doSelectOne($c, $con);

			
		}
		return $this->aCpdocaju;
	}
		...
		if ($this->collCpmovajus === null) {
			if ($this->isNew()) {
			   $this->collCpmovajus = array();
				...
				$criteria->add(CpmovajuPeer::REFAJU, $this->getRefaju());
	...
	public function getCpmovajusJoinCpdeftit($criteria = null, $con = null)
	{
				include_once 'lib/model/presupuesto/om/BaseCpmovajuPeer.php';
		if ($criteria === null) {
			$criteria = new Criteria();
		...
		if ($this->collCpmovajus === null) {
			if ($this->isNew()) {
				...
				$this->collCpmovajus = CpmovajuPeer::doSelectJoinCpdeftit($criteria, $con);
			}
		} else {

...
class CpdefnivMapBuilder {
	...
	const CLASS_NAME = 'lib.model.presupuesto.map.CpdefnivMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('CORTRASLA', 'Cortrasla', 'int', CreoleTypes::INTEGER, false, null);

		$tMap->addColumn('CORADIDIS', 'Coradidis', 'int', CreoleTypes::INTEGER, false, null);

		$tMap->addColumn('CORPRC', 'Corprc', 'int', CreoleTypes::INTEGER, false, null);

		$tMap->addColumn('CORCOM', 'Corcom', 'int', CreoleTypes::INTEGER, false, null);

		$tMap->addColumn('CORCAU', 'Corcau', 'int', CreoleTypes::INTEGER, false, null);

		$tMap->addColumn('CORPAG', 'Corpag', 'int', CreoleTypes::INTEGER, false, null);

		$tMap->addColumn('CORSOLADIDIS', 'Corsoladidis', 'int', CreoleTypes::INTEGER, false, null);

		$tMap->addColumn('CORSOLTRA', 'Corsoltra', 'int', CreoleTypes::INTEGER, false, null);

		$tMap->addColumn('CORAJU', 'Coraju', 'int', CreoleTypes::INTEGER, false, null);

		$tMap->addColumn('CORFUE', 'Corfue', 'int', CreoleTypes::INTEGER, false, null);
		...
		$tMap->addColumn('REPSOLADIDIS1', 'Repsoladidis1', 'string', CreoleTypes::VARCHAR, false, 50);

		$tMap->addColumn('REPSOLADIDIS2', 'Repsoladidis2', 'string', CreoleTypes::VARCHAR, false, 50);

		$tMap->addColumn('NOMDIRPRE', 'Nomdirpre', 'string', CreoleTypes::VARCHAR, false, 250);

		$tMap->addColumn('CARDIRPRE', 'Cardirpre', 'string', CreoleTypes::VARCHAR, false, 250);

		$tMap->addColumn('REPSOLTRASLA1', 'Repsoltrasla1', 'string', CreoleTypes::VARCHAR, false, 50);

		$tMap->addColumn('REPSOLTRASLA2', 'Repsoltrasla2', 'string', CreoleTypes::VARCHAR, false, 50);

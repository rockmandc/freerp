 ...
 * @version SVN: $Id: Cpdisfuefin.php 59375 2014-11-10 15:15:20Z dmartinez $
 *
...
////  DEL MODULO PreEjeGloFin   ////
  ...
  public function getMondisf2()
  {

  return self::getMonasi() - H::QuitarMontov2(self::getMontra()) - H::QuitarMontov2(self::getMonpre());
  }

 ...
 * @version SVN: $Id: Cpsoltrasla.php 58920 2014-10-08 19:19:11Z dmartinez $
 * 
...
class Cpsoltrasla extends BaseCpsoltrasla
{
    ...
    protected $formatras="";
    protected $diftra="0,00";
    protected $desart='';
    protected $totori="0,00";
    protected $totdes="0,00";
    protected $obj2=array();
    protected $toteve="0,00";  
    protected $obj3=array();  
    protected $obj4=array();
    protected $actualfila="";
    protected $actualfila1="";

    public function getEtiqueta()
    {
        if($this->getReftra() != '' && $this->getId() != '')
        {
            if (strtoupper($this->getStatra()) == "A" ){
                ...
                if($defApr){
                  if ($this->getStacon() == "" && $this->getStagob() == "" && $this->getStapre() == ""  ){
                       $etiqueta = "Elaborado el ".$this->getFectra('d/m/Y');
                  ...
                  if ($this->getStaniv4() == "S"){
                    $etiqueta = $etiqueta.", Conformado por ".$defApr->getStaniv4()." el ".$this->getFecniv4();
                  }else if ($this->getStaniv5() == "S"){
                    $etiqueta = $etiqueta.", Conformado por ".$defApr->getStaniv5()." el ".$this->getFecniv5();
                  }else if ($this->getStaniv6() == "S"){
                    $etiqueta = $etiqueta.", Conformado por ".$defApr->getStaniv6()." el ".$this->getFecniv6();

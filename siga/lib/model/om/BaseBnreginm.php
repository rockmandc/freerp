...
abstract class BaseBnreginm extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->codest !== $v) {
        ...
        $this->modifiedColumns[] = BnreginmPeer::CODEST;
      }
    ...
    if ($this->deprec !== $v) {
        ...
        $this->modifiedColumns[] = BnreginmPeer::DEPREC;
      }
  
	} 
	
	public function setCodcl2($v)
	{

    if ($this->codcl2 !== $v) {
        $this->codcl2 = strtoupper($v);
        $this->modifiedColumns[] = BnreginmPeer::CODCL2;
      }
    ...
    if ($this->coduso !== $v) {
        ...
        $this->modifiedColumns[] = BnreginmPeer::CODUSO;
      }
    ...
    if ($this->codunimed !== $v) {
        $this->codunimed = strtoupper($v);
        $this->modifiedColumns[] = BnreginmPeer::CODUNIMED;
      }
    ...
    if ($this->codpai !== $v) {
        ...
        $this->modifiedColumns[] = BnreginmPeer::CODPAI;
      }
    ...
    if ($this->codes2 !== $v) {
        ...
        $this->modifiedColumns[] = BnreginmPeer::CODES2;
      }
    ...
    if ($this->codmun !== $v) {
        ...
        $this->modifiedColumns[] = BnreginmPeer::CODMUN;
      }
    ...
    if ($this->codpar !== $v) {
        ...
        $this->modifiedColumns[] = BnreginmPeer::CODPAR;
      }
    ...
    if ($this->codciu !== $v) {
        ...
        $this->modifiedColumns[] = BnreginmPeer::CODCIU;
      }
    ...
    if ($this->codtlu !== $v) {
        ...
        $this->modifiedColumns[] = BnreginmPeer::CODTLU;
      }
    ...
    if ($this->sudebip !== $v) {
        ...
        $this->modifiedColumns[] = BnreginmPeer::SUDEBIP;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->codest = $rs->getString($startcol + 56);

      $this->deprec = $rs->getString($startcol + 57);

      $this->codcl2 = $rs->getString($startcol + 58);

      $this->coduso = $rs->getString($startcol + 59);

      $this->codunimed = $rs->getString($startcol + 60);

      $this->codpai = $rs->getString($startcol + 61);

      $this->codes2 = $rs->getString($startcol + 62);

      $this->codmun = $rs->getString($startcol + 63);

      $this->codpar = $rs->getString($startcol + 64);

      $this->codciu = $rs->getString($startcol + 65);

      $this->codtlu = $rs->getString($startcol + 66);

      $this->sudebip = $rs->getString($startcol + 67);
  ...
  public function get($m, $a)
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		$result = array(
			...
			$keys[56] => $this->getCodest(),
			$keys[57] => $this->getDeprec(),
			$keys[58] => $this->getCodcl2(),
			$keys[59] => $this->getCoduso(),
			$keys[60] => $this->getCodunimed(),
			$keys[61] => $this->getCodpai(),
			$keys[62] => $this->getCodes2(),
			$keys[63] => $this->getCodmun(),
			$keys[64] => $this->getCodpar(),
			$keys[65] => $this->getCodciu(),
			$keys[66] => $this->getCodtlu(),
			$keys[67] => $this->getSudebip(),
			$keys[68] => $this->getId(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[56], $arr)) $this->setCodest($arr[$keys[56]]);
		if (array_key_exists($keys[57], $arr)) $this->setDeprec($arr[$keys[57]]);
		if (array_key_exists($keys[58], $arr)) $this->setCodcl2($arr[$keys[58]]);
		if (array_key_exists($keys[59], $arr)) $this->setCoduso($arr[$keys[59]]);
		if (array_key_exists($keys[60], $arr)) $this->setCodunimed($arr[$keys[60]]);
		if (array_key_exists($keys[61], $arr)) $this->setCodpai($arr[$keys[61]]);
		if (array_key_exists($keys[62], $arr)) $this->setCodes2($arr[$keys[62]]);
		if (array_key_exists($keys[63], $arr)) $this->setCodmun($arr[$keys[63]]);
		if (array_key_exists($keys[64], $arr)) $this->setCodpar($arr[$keys[64]]);
		if (array_key_exists($keys[65], $arr)) $this->setCodciu($arr[$keys[65]]);
		if (array_key_exists($keys[66], $arr)) $this->setCodtlu($arr[$keys[66]]);
		if (array_key_exists($keys[67], $arr)) $this->setSudebip($arr[$keys[67]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(BnreginmPeer::CODEST)) $criteria->add(BnreginmPeer::CODEST, $this->codest);
		if ($this->isColumnModified(BnreginmPeer::DEPREC)) $criteria->add(BnreginmPeer::DEPREC, $this->deprec);
		if ($this->isColumnModified(BnreginmPeer::CODCL2)) $criteria->add(BnreginmPeer::CODCL2, $this->codcl2);
		if ($this->isColumnModified(BnreginmPeer::CODUSO)) $criteria->add(BnreginmPeer::CODUSO, $this->coduso);
		if ($this->isColumnModified(BnreginmPeer::CODUNIMED)) $criteria->add(BnreginmPeer::CODUNIMED, $this->codunimed);
		if ($this->isColumnModified(BnreginmPeer::CODPAI)) $criteria->add(BnreginmPeer::CODPAI, $this->codpai);
		if ($this->isColumnModified(BnreginmPeer::CODES2)) $criteria->add(BnreginmPeer::CODES2, $this->codes2);
		if ($this->isColumnModified(BnreginmPeer::CODMUN)) $criteria->add(BnreginmPeer::CODMUN, $this->codmun);
		if ($this->isColumnModified(BnreginmPeer::CODPAR)) $criteria->add(BnreginmPeer::CODPAR, $this->codpar);
		if ($this->isColumnModified(BnreginmPeer::CODCIU)) $criteria->add(BnreginmPeer::CODCIU, $this->codciu);
		if ($this->isColumnModified(BnreginmPeer::CODTLU)) $criteria->add(BnreginmPeer::CODTLU, $this->codtlu);
		if ($this->isColumnModified(BnreginmPeer::SUDEBIP)) $criteria->add(BnreginmPeer::SUDEBIP, $this->sudebip);

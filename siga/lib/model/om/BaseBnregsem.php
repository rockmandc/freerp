...
abstract class BaseBnregsem extends BaseObject  implements Persistent {
  ...
  public function getCodani()
  {

    return trim($this->codani);
  ...
  public function getId()
  {
	...
	public function setCodani($v)
	{

    if ($this->codani !== $v) {
        $this->codani = strtoupper($v);
        $this->modifiedColumns[] = BnregsemPeer::CODANI;
      }
    ...
    if ($this->codpai !== $v) {
        ...
        $this->modifiedColumns[] = BnregsemPeer::CODPAI;
      }
    ...
    if ($this->codest !== $v) {
        ...
        $this->modifiedColumns[] = BnregsemPeer::CODEST;
      }
    ...
    if ($this->codmun !== $v) {
        ...
        $this->modifiedColumns[] = BnregsemPeer::CODMUN;
      }
    ...
    if ($this->codpar !== $v) {
        ...
        $this->modifiedColumns[] = BnregsemPeer::CODPAR;
      }
    ...
    if ($this->codciu !== $v) {
        ...
        $this->modifiedColumns[] = BnregsemPeer::CODCIU;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->codani = $rs->getString($startcol + 26);

      $this->codpai = $rs->getString($startcol + 27);

      $this->codest = $rs->getString($startcol + 28);

      $this->codmun = $rs->getString($startcol + 29);

      $this->codpar = $rs->getString($startcol + 30);

      $this->codciu = $rs->getString($startcol + 31);
  ...
  public function get($m, $a)
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		$result = array(
			...
			$keys[26] => $this->getCodani(),
			$keys[27] => $this->getCodpai(),
			$keys[28] => $this->getCodest(),
			$keys[29] => $this->getCodmun(),
			$keys[30] => $this->getCodpar(),
			$keys[31] => $this->getCodciu(),
			$keys[32] => $this->getId(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[26], $arr)) $this->setCodani($arr[$keys[26]]);
		if (array_key_exists($keys[27], $arr)) $this->setCodpai($arr[$keys[27]]);
		if (array_key_exists($keys[28], $arr)) $this->setCodest($arr[$keys[28]]);
		if (array_key_exists($keys[29], $arr)) $this->setCodmun($arr[$keys[29]]);
		if (array_key_exists($keys[30], $arr)) $this->setCodpar($arr[$keys[30]]);
		if (array_key_exists($keys[31], $arr)) $this->setCodciu($arr[$keys[31]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(BnregsemPeer::CODANI)) $criteria->add(BnregsemPeer::CODANI, $this->codani);
		if ($this->isColumnModified(BnregsemPeer::CODPAI)) $criteria->add(BnregsemPeer::CODPAI, $this->codpai);
		if ($this->isColumnModified(BnregsemPeer::CODEST)) $criteria->add(BnregsemPeer::CODEST, $this->codest);
		if ($this->isColumnModified(BnregsemPeer::CODMUN)) $criteria->add(BnregsemPeer::CODMUN, $this->codmun);
		if ($this->isColumnModified(BnregsemPeer::CODPAR)) $criteria->add(BnregsemPeer::CODPAR, $this->codpar);
		if ($this->isColumnModified(BnregsemPeer::CODCIU)) $criteria->add(BnregsemPeer::CODCIU, $this->codciu);

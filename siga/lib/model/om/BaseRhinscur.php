...
abstract class BaseRhinscur extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->codplacur !== $v) {
        $this->codplacur = $v;
        $this->modifiedColumns[] = RhinscurPeer::CODPLACUR;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->codplacur = $rs->getString($startcol + 5);
  ...
  public function get($m, $a)
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[5], $arr)) $this->setCodplacur($arr[$keys[5]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(RhinscurPeer::CODPLACUR)) $criteria->add(RhinscurPeer::CODPLACUR, $this->codplacur);

...
abstract class BaseBnregmue extends BaseObject  implements Persistent {
  ...
  public function getFecregcom($format = 'Y-m-d')
  {

    if ($this->fecregcom === null || $this->fecregcom === '') {
      return null;
    } elseif (!is_int($this->fecregcom)) {
            $ts = adodb_strtotime($this->fecregcom);
      if ($ts === -1 || $ts === false) {         throw new PropelException("Unable to parse value of [fecregcom] as date/time value: " . var_export($this->fecregcom, true));
      }
    } else {
      $ts = $this->fecregcom;
    }
  ...
  public function getActrec()
  {

    return trim($this->actrec);

  }
  
  public function getFecasiact($format = 'Y-m-d')
  {

    if ($this->fecasiact === null || $this->fecasiact === '') {
      return null;
    } elseif (!is_int($this->fecasiact)) {
            $ts = adodb_strtotime($this->fecasiact);
      if ($ts === -1 || $ts === false) {         throw new PropelException("Unable to parse value of [fecasiact] as date/time value: " . var_export($this->fecasiact, true));
      }
    } else {
      $ts = $this->fecasiact;
    }
  ...
  public function getFecdesact($format = 'Y-m-d')
  {

    if ($this->fecdesact === null || $this->fecdesact === '') {
      return null;
    } elseif (!is_int($this->fecdesact)) {
            $ts = adodb_strtotime($this->fecdesact);
      if ($ts === -1 || $ts === false) {         throw new PropelException("Unable to parse value of [fecdesact] as date/time value: " . var_export($this->fecdesact, true));
      }
    } else {
      $ts = $this->fecdesact;
    }
  ...
  public function getAnoinv()
  {

    return trim($this->anoinv);

  }
  
  public function getCodactdep()
  {

    return trim($this->codactdep);

  }
  
  public function getCodmuedep()
  {

    return trim($this->codmuedep);

  }
  
  public function getFecont($format = 'Y-m-d')
  {

    if ($this->fecont === null || $this->fecont === '') {
      return null;
    } elseif (!is_int($this->fecont)) {
            $ts = adodb_strtotime($this->fecont);
      if ($ts === -1 || $ts === false) {         throw new PropelException("Unable to parse value of [fecont] as date/time value: " . var_export($this->fecont, true));
      }
    } else {
      $ts = $this->fecont;
    }
  ...
  public function getStafal()
  {

    return trim($this->stafal);
  ...
  public function getId()
  {
    ...
    if ($this->nrocon !== $v) {
        $this->nrocon = strtoupper($v);
        $this->modifiedColumns[] = BnregmuePeer::NROCON;
      }
    ...
    if ($this->feccon !== $ts) {
      $this->feccon = $ts;
      $this->modifiedColumns[] = BnregmuePeer::FECCON;
    }
    ...
    if ($this->fecfac !== $ts) {
      $this->fecfac = $ts;
      $this->modifiedColumns[] = BnregmuePeer::FECFAC;
    }
    ...
    if ($this->codest !== $v) {
        ...
        $this->modifiedColumns[] = BnregmuePeer::CODEST;
      }
    ...
    if ($this->codmod !== $v) {
        $this->codmod = strtoupper($v);
        $this->modifiedColumns[] = BnregmuePeer::CODMOD;
      }
    ...
    if ($this->numcue !== $v) {
        ...
        $this->modifiedColumns[] = BnregmuePeer::NUMCUE;
      }
    ...
    if ($this->numdep !== $v) {
        ...
        $this->modifiedColumns[] = BnregmuePeer::NUMDEP;
      }
    ...
    if ($this->fecdepseg !== $ts) {
      $this->fecdepseg = $ts;
      $this->modifiedColumns[] = BnregmuePeer::FECDEPSEG;
    }
    ...
    if ($this->codtip !== $v) {
        ...
        $this->modifiedColumns[] = BnregmuePeer::CODTIP;
      }
    ...
    if ($this->monpag !== $v) {
        ...
        $this->modifiedColumns[] = BnregmuePeer::MONPAG;
      }
    ...
    if ($this->porpri !== $v) {
        ...
        $this->modifiedColumns[] = BnregmuePeer::PORPRI;
      }
    ...
    if ($this->monpri !== $v) {
        ...
        $this->modifiedColumns[] = BnregmuePeer::MONPRI;
      }
    ...
    if ($this->numcom !== $v) {
        ...
        $this->modifiedColumns[] = BnregmuePeer::NUMCOM;
      }
    ...
    if ($this->deprec !== $v) {
        ...
        $this->modifiedColumns[] = BnregmuePeer::DEPREC;
      }
    ...
    if ($this->segnom !== $v) {
        ...
        $this->modifiedColumns[] = BnregmuePeer::SEGNOM;
      }
    ...
    if ($this->monnom !== $v) {
        ...
        $this->modifiedColumns[] = BnregmuePeer::MONNOM;
      }
    ...
    if ($this->frenom !== $v) {
        ...
        $this->modifiedColumns[] = BnregmuePeer::FRENOM;
      }
  
	} 
	
	public function setFecregcom($v)
	{

    if ($v !== null && !is_int($v)) {
      $ts = adodb_strtotime($v);
      if ($ts === -1 || $ts === false) {         throw new PropelException("Unable to parse date/time value for [fecregcom] from input: " . var_export($v, true));
      }
    } else {
      $ts = $v;
    }
    if ($this->fecregcom !== $ts) {
      $this->fecregcom = $ts;
      $this->modifiedColumns[] = BnregmuePeer::FECREGCOM;
    }
    ...
    if ($this->codproc !== $v) {
        ...
        $this->modifiedColumns[] = BnregmuePeer::CODPROC;
      }
    ...
    if ($this->cedest !== $v) {
        ...
        $this->modifiedColumns[] = BnregmuePeer::CEDEST;
      }
    ...
    if ($this->perest !== $v) {
        $this->perest = $v;
        $this->modifiedColumns[] = BnregmuePeer::PEREST;
      }
    ...
    if ($this->codcol !== $v) {
        $this->codcol = strtoupper($v);
        $this->modifiedColumns[] = BnregmuePeer::CODCOL;
      }
    ...
    if ($this->codpai !== $v) {
        $this->codpai = strtoupper($v);
        $this->modifiedColumns[] = BnregmuePeer::CODPAI;
      }
    ...
    if ($this->codes2 !== $v) {
        $this->codes2 = strtoupper($v);
        $this->modifiedColumns[] = BnregmuePeer::CODES2;
      }
    ...
    if ($this->codmun !== $v) {
        ...
        $this->modifiedColumns[] = BnregmuePeer::CODMUN;
      }
    ...
    if ($this->codpar !== $v) {
        ...
        $this->modifiedColumns[] = BnregmuePeer::CODPAR;
      }
    ...
    if ($this->codciu !== $v) {
        ...
        $this->modifiedColumns[] = BnregmuePeer::CODCIU;
      }
    ...
    if ($this->proced !== $v) {
        $this->proced = strtoupper($v);
        $this->modifiedColumns[] = BnregmuePeer::PROCED;
      }
    ...
    if ($this->sudebip !== $v) {
        ...
        $this->modifiedColumns[] = BnregmuePeer::SUDEBIP;
      }
  
	} 
	
	public function setActrec($v)
	{

    if ($this->actrec !== $v) {
        $this->actrec = strtoupper($v);
        $this->modifiedColumns[] = BnregmuePeer::ACTREC;
      }
  
	} 
	
	public function setFecasiact($v)
	{

    if ($v !== null && !is_int($v)) {
      $ts = adodb_strtotime($v);
      if ($ts === -1 || $ts === false) {         throw new PropelException("Unable to parse date/time value for [fecasiact] from input: " . var_export($v, true));
      }
    } else {
      $ts = $v;
    }
    if ($this->fecasiact !== $ts) {
      $this->fecasiact = $ts;
      $this->modifiedColumns[] = BnregmuePeer::FECASIACT;
    }

	} 
	
	public function setFecdesact($v)
	{

    if ($v !== null && !is_int($v)) {
      $ts = adodb_strtotime($v);
      if ($ts === -1 || $ts === false) {         throw new PropelException("Unable to parse date/time value for [fecdesact] from input: " . var_export($v, true));
      }
    } else {
      $ts = $v;
    }
    if ($this->fecdesact !== $ts) {
      $this->fecdesact = $ts;
      $this->modifiedColumns[] = BnregmuePeer::FECDESACT;
    }
    ...
    if ($this->fectra !== $ts) {
      $this->fectra = $ts;
      $this->modifiedColumns[] = BnregmuePeer::FECTRA;
    }
    ...
    if ($this->codusobie !== $v) {
        ...
        $this->modifiedColumns[] = BnregmuePeer::CODUSOBIE;
      }
  
	} 
	
	public function setAnoinv($v)
	{

    if ($this->anoinv !== $v) {
        $this->anoinv = strtoupper($v);
        $this->modifiedColumns[] = BnregmuePeer::ANOINV;
      }
  
	} 
	
	public function setCodactdep($v)
	{

    if ($this->codactdep !== $v) {
        $this->codactdep = strtoupper($v);
        $this->modifiedColumns[] = BnregmuePeer::CODACTDEP;
      }
  
	} 
	
	public function setCodmuedep($v)
	{

    if ($this->codmuedep !== $v) {
        $this->codmuedep = strtoupper($v);
        $this->modifiedColumns[] = BnregmuePeer::CODMUEDEP;
      }
  
	} 
	
	public function setFecont($v)
	{

    if ($v !== null && !is_int($v)) {
      $ts = adodb_strtotime($v);
      if ($ts === -1 || $ts === false) {         throw new PropelException("Unable to parse date/time value for [fecont] from input: " . var_export($v, true));
      }
    } else {
      $ts = $v;
    }
    if ($this->fecont !== $ts) {
      $this->fecont = $ts;
      $this->modifiedColumns[] = BnregmuePeer::FECONT;
    }

	} 
	
	public function setStafal($v)
	{

    if ($this->stafal !== $v || $v === 'N') {
        $this->stafal = strtoupper($v);
        $this->modifiedColumns[] = BnregmuePeer::STAFAL;
      }
    ...
    if ($this->fecins !== $ts) {
      $this->fecins = $ts;
      $this->modifiedColumns[] = BnregmuePeer::FECINS;
    }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->nrocon = $rs->getString($startcol + 58);

      $this->feccon = $rs->getDate($startcol + 59, null);

      $this->fecfac = $rs->getDate($startcol + 60, null);

      $this->codest = $rs->getString($startcol + 61);

      $this->codmod = $rs->getString($startcol + 62);

      $this->numcue = $rs->getString($startcol + 63);

      $this->numdep = $rs->getString($startcol + 64);

      $this->fecdepseg = $rs->getDate($startcol + 65, null);

      $this->codtip = $rs->getString($startcol + 66);

      $this->monpag = $rs->getFloat($startcol + 67);

      $this->porpri = $rs->getFloat($startcol + 68);

      $this->monpri = $rs->getFloat($startcol + 69);

      $this->numcom = $rs->getString($startcol + 70);

      $this->deprec = $rs->getString($startcol + 71);

      $this->segnom = $rs->getString($startcol + 72);

      $this->monnom = $rs->getFloat($startcol + 73);

      $this->frenom = $rs->getString($startcol + 74);

      $this->fecregcom = $rs->getDate($startcol + 75, null);

      $this->codproc = $rs->getString($startcol + 76);

      $this->cedest = $rs->getString($startcol + 77);

      $this->perest = $rs->getBoolean($startcol + 78);

      $this->codcol = $rs->getString($startcol + 79);

      $this->codpai = $rs->getString($startcol + 80);

      $this->codes2 = $rs->getString($startcol + 81);

      $this->codmun = $rs->getString($startcol + 82);

      $this->codpar = $rs->getString($startcol + 83);

      $this->codciu = $rs->getString($startcol + 84);

      $this->proced = $rs->getString($startcol + 85);

      $this->sudebip = $rs->getString($startcol + 86);

      $this->actrec = $rs->getString($startcol + 87);

      $this->fecasiact = $rs->getDate($startcol + 88, null);

      $this->fecdesact = $rs->getDate($startcol + 89, null);

      $this->fectra = $rs->getDate($startcol + 90, null);

      $this->codusobie = $rs->getString($startcol + 91);

      $this->anoinv = $rs->getString($startcol + 92);

      $this->codactdep = $rs->getString($startcol + 93);

      $this->codmuedep = $rs->getString($startcol + 94);

      $this->fecont = $rs->getDate($startcol + 95, null);

      $this->stafal = $rs->getString($startcol + 96);

      $this->fecins = $rs->getDate($startcol + 97, null);

      $this->id = $rs->getInt($startcol + 98);
  ...
  public function get($m, $a)
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 86:
				...
				break;
			case 87:
				return $this->getActrec();
				break;
			case 88:
				return $this->getFecasiact();
				break;
			case 89:
				return $this->getFecdesact();
				break;
			case 90:
			...
			case 91:
				...
				break;
			case 92:
				return $this->getAnoinv();
				break;
			case 93:
				return $this->getCodactdep();
				break;
			case 94:
				return $this->getCodmuedep();
				break;
			case 95:
				return $this->getFecont();
				break;
			case 96:
				return $this->getStafal();
				break;
			case 97:
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		$result = array(
			...
			$keys[58] => $this->getNrocon(),
			$keys[59] => $this->getFeccon(),
			$keys[60] => $this->getFecfac(),
			$keys[61] => $this->getCodest(),
			$keys[62] => $this->getCodmod(),
			$keys[63] => $this->getNumcue(),
			$keys[64] => $this->getNumdep(),
			$keys[65] => $this->getFecdepseg(),
			$keys[66] => $this->getCodtip(),
			$keys[67] => $this->getMonpag(),
			$keys[68] => $this->getPorpri(),
			$keys[69] => $this->getMonpri(),
			$keys[70] => $this->getNumcom(),
			$keys[71] => $this->getDeprec(),
			$keys[72] => $this->getSegnom(),
			$keys[73] => $this->getMonnom(),
			$keys[74] => $this->getFrenom(),
			$keys[75] => $this->getFecregcom(),
			$keys[76] => $this->getCodproc(),
			$keys[77] => $this->getCedest(),
			$keys[78] => $this->getPerest(),
			$keys[79] => $this->getCodcol(),
			$keys[80] => $this->getCodpai(),
			$keys[81] => $this->getCodes2(),
			$keys[82] => $this->getCodmun(),
			$keys[83] => $this->getCodpar(),
			$keys[84] => $this->getCodciu(),
			$keys[85] => $this->getProced(),
			$keys[86] => $this->getSudebip(),
			$keys[87] => $this->getActrec(),
			$keys[88] => $this->getFecasiact(),
			$keys[89] => $this->getFecdesact(),
			$keys[90] => $this->getFectra(),
			$keys[91] => $this->getCodusobie(),
			$keys[92] => $this->getAnoinv(),
			$keys[93] => $this->getCodactdep(),
			$keys[94] => $this->getCodmuedep(),
			$keys[95] => $this->getFecont(),
			$keys[96] => $this->getStafal(),
			$keys[97] => $this->getFecins(),
			$keys[98] => $this->getId(),
		);
		return $result;
	}
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 86:
				...
				break;
			case 87:
				$this->setActrec($value);
				break;
			case 88:
				$this->setFecasiact($value);
				break;
			case 89:
				$this->setFecdesact($value);
				break;
			case 90:
			...
			case 91:
				...
				break;
			case 92:
				$this->setAnoinv($value);
				break;
			case 93:
				$this->setCodactdep($value);
				break;
			case 94:
				$this->setCodmuedep($value);
				break;
			case 95:
				$this->setFecont($value);
				break;
			case 96:
				$this->setStafal($value);
				break;
			case 97:
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[58], $arr)) $this->setNrocon($arr[$keys[58]]);
		if (array_key_exists($keys[59], $arr)) $this->setFeccon($arr[$keys[59]]);
		if (array_key_exists($keys[60], $arr)) $this->setFecfac($arr[$keys[60]]);
		if (array_key_exists($keys[61], $arr)) $this->setCodest($arr[$keys[61]]);
		if (array_key_exists($keys[62], $arr)) $this->setCodmod($arr[$keys[62]]);
		if (array_key_exists($keys[63], $arr)) $this->setNumcue($arr[$keys[63]]);
		if (array_key_exists($keys[64], $arr)) $this->setNumdep($arr[$keys[64]]);
		if (array_key_exists($keys[65], $arr)) $this->setFecdepseg($arr[$keys[65]]);
		if (array_key_exists($keys[66], $arr)) $this->setCodtip($arr[$keys[66]]);
		if (array_key_exists($keys[67], $arr)) $this->setMonpag($arr[$keys[67]]);
		if (array_key_exists($keys[68], $arr)) $this->setPorpri($arr[$keys[68]]);
		if (array_key_exists($keys[69], $arr)) $this->setMonpri($arr[$keys[69]]);
		if (array_key_exists($keys[70], $arr)) $this->setNumcom($arr[$keys[70]]);
		if (array_key_exists($keys[71], $arr)) $this->setDeprec($arr[$keys[71]]);
		if (array_key_exists($keys[72], $arr)) $this->setSegnom($arr[$keys[72]]);
		if (array_key_exists($keys[73], $arr)) $this->setMonnom($arr[$keys[73]]);
		if (array_key_exists($keys[74], $arr)) $this->setFrenom($arr[$keys[74]]);
		if (array_key_exists($keys[75], $arr)) $this->setFecregcom($arr[$keys[75]]);
		if (array_key_exists($keys[76], $arr)) $this->setCodproc($arr[$keys[76]]);
		if (array_key_exists($keys[77], $arr)) $this->setCedest($arr[$keys[77]]);
		if (array_key_exists($keys[78], $arr)) $this->setPerest($arr[$keys[78]]);
		if (array_key_exists($keys[79], $arr)) $this->setCodcol($arr[$keys[79]]);
		if (array_key_exists($keys[80], $arr)) $this->setCodpai($arr[$keys[80]]);
		if (array_key_exists($keys[81], $arr)) $this->setCodes2($arr[$keys[81]]);
		if (array_key_exists($keys[82], $arr)) $this->setCodmun($arr[$keys[82]]);
		if (array_key_exists($keys[83], $arr)) $this->setCodpar($arr[$keys[83]]);
		if (array_key_exists($keys[84], $arr)) $this->setCodciu($arr[$keys[84]]);
		if (array_key_exists($keys[85], $arr)) $this->setProced($arr[$keys[85]]);
		if (array_key_exists($keys[86], $arr)) $this->setSudebip($arr[$keys[86]]);
		if (array_key_exists($keys[87], $arr)) $this->setActrec($arr[$keys[87]]);
		if (array_key_exists($keys[88], $arr)) $this->setFecasiact($arr[$keys[88]]);
		if (array_key_exists($keys[89], $arr)) $this->setFecdesact($arr[$keys[89]]);
		if (array_key_exists($keys[90], $arr)) $this->setFectra($arr[$keys[90]]);
		if (array_key_exists($keys[91], $arr)) $this->setCodusobie($arr[$keys[91]]);
		if (array_key_exists($keys[92], $arr)) $this->setAnoinv($arr[$keys[92]]);
		if (array_key_exists($keys[93], $arr)) $this->setCodactdep($arr[$keys[93]]);
		if (array_key_exists($keys[94], $arr)) $this->setCodmuedep($arr[$keys[94]]);
		if (array_key_exists($keys[95], $arr)) $this->setFecont($arr[$keys[95]]);
		if (array_key_exists($keys[96], $arr)) $this->setStafal($arr[$keys[96]]);
		if (array_key_exists($keys[97], $arr)) $this->setFecins($arr[$keys[97]]);
		if (array_key_exists($keys[98], $arr)) $this->setId($arr[$keys[98]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(BnregmuePeer::NROCON)) $criteria->add(BnregmuePeer::NROCON, $this->nrocon);
		if ($this->isColumnModified(BnregmuePeer::FECCON)) $criteria->add(BnregmuePeer::FECCON, $this->feccon);
		if ($this->isColumnModified(BnregmuePeer::FECFAC)) $criteria->add(BnregmuePeer::FECFAC, $this->fecfac);
		if ($this->isColumnModified(BnregmuePeer::CODEST)) $criteria->add(BnregmuePeer::CODEST, $this->codest);
		if ($this->isColumnModified(BnregmuePeer::CODMOD)) $criteria->add(BnregmuePeer::CODMOD, $this->codmod);
		if ($this->isColumnModified(BnregmuePeer::NUMCUE)) $criteria->add(BnregmuePeer::NUMCUE, $this->numcue);
		if ($this->isColumnModified(BnregmuePeer::NUMDEP)) $criteria->add(BnregmuePeer::NUMDEP, $this->numdep);
		if ($this->isColumnModified(BnregmuePeer::FECDEPSEG)) $criteria->add(BnregmuePeer::FECDEPSEG, $this->fecdepseg);
		if ($this->isColumnModified(BnregmuePeer::CODTIP)) $criteria->add(BnregmuePeer::CODTIP, $this->codtip);
		if ($this->isColumnModified(BnregmuePeer::MONPAG)) $criteria->add(BnregmuePeer::MONPAG, $this->monpag);
		if ($this->isColumnModified(BnregmuePeer::PORPRI)) $criteria->add(BnregmuePeer::PORPRI, $this->porpri);
		if ($this->isColumnModified(BnregmuePeer::MONPRI)) $criteria->add(BnregmuePeer::MONPRI, $this->monpri);
		if ($this->isColumnModified(BnregmuePeer::NUMCOM)) $criteria->add(BnregmuePeer::NUMCOM, $this->numcom);
		if ($this->isColumnModified(BnregmuePeer::DEPREC)) $criteria->add(BnregmuePeer::DEPREC, $this->deprec);
		if ($this->isColumnModified(BnregmuePeer::SEGNOM)) $criteria->add(BnregmuePeer::SEGNOM, $this->segnom);
		if ($this->isColumnModified(BnregmuePeer::MONNOM)) $criteria->add(BnregmuePeer::MONNOM, $this->monnom);
		if ($this->isColumnModified(BnregmuePeer::FRENOM)) $criteria->add(BnregmuePeer::FRENOM, $this->frenom);
		if ($this->isColumnModified(BnregmuePeer::FECREGCOM)) $criteria->add(BnregmuePeer::FECREGCOM, $this->fecregcom);
		if ($this->isColumnModified(BnregmuePeer::CODPROC)) $criteria->add(BnregmuePeer::CODPROC, $this->codproc);
		if ($this->isColumnModified(BnregmuePeer::CEDEST)) $criteria->add(BnregmuePeer::CEDEST, $this->cedest);
		if ($this->isColumnModified(BnregmuePeer::PEREST)) $criteria->add(BnregmuePeer::PEREST, $this->perest);
		if ($this->isColumnModified(BnregmuePeer::CODCOL)) $criteria->add(BnregmuePeer::CODCOL, $this->codcol);
		if ($this->isColumnModified(BnregmuePeer::CODPAI)) $criteria->add(BnregmuePeer::CODPAI, $this->codpai);
		if ($this->isColumnModified(BnregmuePeer::CODES2)) $criteria->add(BnregmuePeer::CODES2, $this->codes2);
		if ($this->isColumnModified(BnregmuePeer::CODMUN)) $criteria->add(BnregmuePeer::CODMUN, $this->codmun);
		if ($this->isColumnModified(BnregmuePeer::CODPAR)) $criteria->add(BnregmuePeer::CODPAR, $this->codpar);
		if ($this->isColumnModified(BnregmuePeer::CODCIU)) $criteria->add(BnregmuePeer::CODCIU, $this->codciu);
		if ($this->isColumnModified(BnregmuePeer::PROCED)) $criteria->add(BnregmuePeer::PROCED, $this->proced);
		if ($this->isColumnModified(BnregmuePeer::SUDEBIP)) $criteria->add(BnregmuePeer::SUDEBIP, $this->sudebip);
		if ($this->isColumnModified(BnregmuePeer::ACTREC)) $criteria->add(BnregmuePeer::ACTREC, $this->actrec);
		if ($this->isColumnModified(BnregmuePeer::FECASIACT)) $criteria->add(BnregmuePeer::FECASIACT, $this->fecasiact);
		if ($this->isColumnModified(BnregmuePeer::FECDESACT)) $criteria->add(BnregmuePeer::FECDESACT, $this->fecdesact);
		if ($this->isColumnModified(BnregmuePeer::FECTRA)) $criteria->add(BnregmuePeer::FECTRA, $this->fectra);
		if ($this->isColumnModified(BnregmuePeer::CODUSOBIE)) $criteria->add(BnregmuePeer::CODUSOBIE, $this->codusobie);
		if ($this->isColumnModified(BnregmuePeer::ANOINV)) $criteria->add(BnregmuePeer::ANOINV, $this->anoinv);
		if ($this->isColumnModified(BnregmuePeer::CODACTDEP)) $criteria->add(BnregmuePeer::CODACTDEP, $this->codactdep);
		if ($this->isColumnModified(BnregmuePeer::CODMUEDEP)) $criteria->add(BnregmuePeer::CODMUEDEP, $this->codmuedep);
		if ($this->isColumnModified(BnregmuePeer::FECONT)) $criteria->add(BnregmuePeer::FECONT, $this->fecont);
		if ($this->isColumnModified(BnregmuePeer::STAFAL)) $criteria->add(BnregmuePeer::STAFAL, $this->stafal);
		if ($this->isColumnModified(BnregmuePeer::FECINS)) $criteria->add(BnregmuePeer::FECINS, $this->fecins);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setFecregcom($this->fecregcom);
		...
		$copyObj->setActrec($this->actrec);

		$copyObj->setFecasiact($this->fecasiact);

		$copyObj->setFecdesact($this->fecdesact);

		$copyObj->setFectra($this->fectra);

		$copyObj->setCodusobie($this->codusobie);

		$copyObj->setAnoinv($this->anoinv);

		$copyObj->setCodactdep($this->codactdep);

		$copyObj->setCodmuedep($this->codmuedep);

		$copyObj->setFecont($this->fecont);

		$copyObj->setStafal($this->stafal);

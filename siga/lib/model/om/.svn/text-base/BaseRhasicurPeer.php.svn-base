...
abstract class BaseRhasicurPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Codcur', 'Numcla', 'Codemp', 'Asicla', 'Codmot', 'Id', ),
		BasePeer::TYPE_COLNAME => array (RhasicurPeer::CODCUR, RhasicurPeer::NUMCLA, RhasicurPeer::CODEMP, RhasicurPeer::ASICLA, RhasicurPeer::CODMOT, RhasicurPeer::ID, ),
		BasePeer::TYPE_FIELDNAME => array ('codcur', 'numcla', 'codemp', 'asicla', 'codmot', 'id', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Codcur' => 0, 'Numcla' => 1, 'Codemp' => 2, 'Asicla' => 3, 'Codmot' => 4, 'Id' => 5, ),
		BasePeer::TYPE_COLNAME => array (RhasicurPeer::CODCUR => 0, RhasicurPeer::NUMCLA => 1, RhasicurPeer::CODEMP => 2, RhasicurPeer::ASICLA => 3, RhasicurPeer::CODMOT => 4, RhasicurPeer::ID => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('codcur' => 0, 'numcla' => 1, 'codemp' => 2, 'asicla' => 3, 'codmot' => 4, 'id' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(RhasicurPeer::CODMOT);

...
abstract class BaseBncobseginm extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->codact !== $v) {
        ...
        $this->modifiedColumns[] = BncobseginmPeer::CODACT;
      }
    ...
    if ($this->codinm !== $v) {
        ...
        $this->modifiedColumns[] = BncobseginmPeer::CODINM;
      }
    ...
    if ($this->nrosegmue !== $v) {
        ...
        $this->modifiedColumns[] = BncobseginmPeer::NROSEGMUE;
      }
    ...
    if ($this->codcob !== $v) {
        ...
        $this->modifiedColumns[] = BncobseginmPeer::CODCOB;
      }
    ...
    if ($this->monto !== $v) {
        ...
        $this->modifiedColumns[] = BncobseginmPeer::MONTO;
      }
    ...
    if ($this->id !== $v) {
        $this->id = $v;
        $this->modifiedColumns[] = BncobseginmPeer::ID;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      throw new PropelException("Error populating Bncobseginm object", $e);
    }
  }
  ...
  public function get($m, $a)
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			BncobseginmPeer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			$this->alreadyInSave = true;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = BncobseginmPeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += BncobseginmPeer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = BncobseginmPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = BncobseginmPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = BncobseginmPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(BncobseginmPeer::CODACT)) $criteria->add(BncobseginmPeer::CODACT, $this->codact);
		if ($this->isColumnModified(BncobseginmPeer::CODINM)) $criteria->add(BncobseginmPeer::CODINM, $this->codinm);
		if ($this->isColumnModified(BncobseginmPeer::NROSEGMUE)) $criteria->add(BncobseginmPeer::NROSEGMUE, $this->nrosegmue);
		if ($this->isColumnModified(BncobseginmPeer::CODCOB)) $criteria->add(BncobseginmPeer::CODCOB, $this->codcob);
		if ($this->isColumnModified(BncobseginmPeer::MONTO)) $criteria->add(BncobseginmPeer::MONTO, $this->monto);
		if ($this->isColumnModified(BncobseginmPeer::ID)) $criteria->add(BncobseginmPeer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(BncobseginmPeer::ID, $this->id);

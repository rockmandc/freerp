...
abstract class BaseBndisbie extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
	...
	public function setFaltan($v)
	{

    if ($this->faltan !== $v) {
        $this->faltan = strtoupper($v);
        $this->modifiedColumns[] = BndisbiePeer::FALTAN;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->faltan = $rs->getString($startcol + 7);
  ...
  public function get($m, $a)
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[7], $arr)) $this->setFaltan($arr[$keys[7]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(BndisbiePeer::FALTAN)) $criteria->add(BndisbiePeer::FALTAN, $this->faltan);

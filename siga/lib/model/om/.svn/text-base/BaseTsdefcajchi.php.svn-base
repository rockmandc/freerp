...
abstract class BaseTsdefcajchi extends BaseObject  implements Persistent {
  ...
  public function getSujren()
  {

    return trim($this->sujren);
  ...
  public function getId()
  {
    ...
    if ($this->tipcom !== $v) {
        $this->tipcom = $v;
        $this->modifiedColumns[] = TsdefcajchiPeer::TIPCOM;
      }
    ...
    if ($this->ctapag !== $v) {
        $this->ctapag = $v;
        $this->modifiedColumns[] = TsdefcajchiPeer::CTAPAG;
      }
  
	} 
	
	public function setSujren($v)
	{

    if ($this->sujren !== $v) {
        $this->sujren = $v;
        $this->modifiedColumns[] = TsdefcajchiPeer::SUJREN;
      }
    ...
    if ($this->tippag !== $v) {
        $this->tippag = $v;
        $this->modifiedColumns[] = TsdefcajchiPeer::TIPPAG;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->sujren = $rs->getString($startcol + 12);
  ...
  public function get($m, $a)
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[12], $arr)) $this->setSujren($arr[$keys[12]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TsdefcajchiPeer::TIPCOM)) $criteria->add(TsdefcajchiPeer::TIPCOM, $this->tipcom);
		if ($this->isColumnModified(TsdefcajchiPeer::CTAPAG)) $criteria->add(TsdefcajchiPeer::CTAPAG, $this->ctapag);
		if ($this->isColumnModified(TsdefcajchiPeer::SUJREN)) $criteria->add(TsdefcajchiPeer::SUJREN, $this->sujren);
		if ($this->isColumnModified(TsdefcajchiPeer::TIPPAG)) $criteria->add(TsdefcajchiPeer::TIPPAG, $this->tippag);

...
abstract class BaseBndefins extends BaseObject  implements Persistent {
	...
	protected $cormuenacd;


	
	protected $cormueregd;


	
	protected $cormuenach;


	
	protected $cormueregh;
  ...
  public function getCormuenacd($val=false)
  {

    if($val) return number_format($this->cormuenacd,2,',','.');
    else return $this->cormuenacd;

  }
  
  public function getCormueregd($val=false)
  {

    if($val) return number_format($this->cormueregd,2,',','.');
    else return $this->cormueregd;

  }
  
  public function getCormuenach($val=false)
  {

    if($val) return number_format($this->cormuenach,2,',','.');
    else return $this->cormuenach;

  }
  
  public function getCormueregh($val=false)
  {

    if($val) return number_format($this->cormueregh,2,',','.');
    else return $this->cormueregh;

  }
  
  public function getModcormue()
  {

    return $this->modcormue;
  ...
  public function getId()
  {
    ...
    if ($this->porpri !== $v) {
        ...
        $this->modifiedColumns[] = BndefinsPeer::PORPRI;
      }
    ...
    if ($this->codtiptra !== $v) {
        $this->codtiptra = strtoupper($v);
        $this->modifiedColumns[] = BndefinsPeer::CODTIPTRA;
      }
  
	} 
	
	public function setCormuenacd($v)
	{

    if ($this->cormuenacd !== $v) {
        $this->cormuenacd = Herramientas::toFloat($v);
        $this->modifiedColumns[] = BndefinsPeer::CORMUENACD;
      }
  
	} 
	
	public function setCormueregd($v)
	{

    if ($this->cormueregd !== $v) {
        $this->cormueregd = Herramientas::toFloat($v);
        $this->modifiedColumns[] = BndefinsPeer::CORMUEREGD;
      }
  
	} 
	
	public function setCormuenach($v)
	{

    if ($this->cormuenach !== $v) {
        $this->cormuenach = Herramientas::toFloat($v);
        $this->modifiedColumns[] = BndefinsPeer::CORMUENACH;
      }
  
	} 
	
	public function setCormueregh($v)
	{

    if ($this->cormueregh !== $v) {
        $this->cormueregh = Herramientas::toFloat($v);
        $this->modifiedColumns[] = BndefinsPeer::CORMUEREGH;
      }
  
	} 
	
	public function setModcormue($v)
	{

    if ($this->modcormue !== $v) {
        $this->modcormue = $v;
        $this->modifiedColumns[] = BndefinsPeer::MODCORMUE;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->porpri = $rs->getFloat($startcol + 23);

      $this->codtiptra = $rs->getString($startcol + 24);

      $this->cormuenacd = $rs->getFloat($startcol + 25);

      $this->cormueregd = $rs->getFloat($startcol + 26);

      $this->cormuenach = $rs->getFloat($startcol + 27);

      $this->cormueregh = $rs->getFloat($startcol + 28);

      $this->modcormue = $rs->getBoolean($startcol + 29);
  ...
  public function get($m, $a)
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 24:
				...
				break;
			case 25:
				return $this->getCormuenacd();
				break;
			case 26:
				return $this->getCormueregd();
				break;
			case 27:
				return $this->getCormuenach();
				break;
			case 28:
				return $this->getCormueregh();
				break;
			case 29:
				return $this->getModcormue();
				break;
			case 30:
				return $this->getId();
				break;
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		$result = array(
			...
			$keys[23] => $this->getPorpri(),
			$keys[24] => $this->getCodtiptra(),
			$keys[25] => $this->getCormuenacd(),
			$keys[26] => $this->getCormueregd(),
			$keys[27] => $this->getCormuenach(),
			$keys[28] => $this->getCormueregh(),
			$keys[29] => $this->getModcormue(),
			$keys[30] => $this->getId(),
		);
		return $result;
	}
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 24:
				...
				break;
			case 25:
				$this->setCormuenacd($value);
				break;
			case 26:
				$this->setCormueregd($value);
				break;
			case 27:
				$this->setCormuenach($value);
				break;
			case 28:
				$this->setCormueregh($value);
				break;
			case 29:
				$this->setModcormue($value);
				break;
			case 30:
				$this->setId($value);
				break;
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[23], $arr)) $this->setPorpri($arr[$keys[23]]);
		if (array_key_exists($keys[24], $arr)) $this->setCodtiptra($arr[$keys[24]]);
		if (array_key_exists($keys[25], $arr)) $this->setCormuenacd($arr[$keys[25]]);
		if (array_key_exists($keys[26], $arr)) $this->setCormueregd($arr[$keys[26]]);
		if (array_key_exists($keys[27], $arr)) $this->setCormuenach($arr[$keys[27]]);
		if (array_key_exists($keys[28], $arr)) $this->setCormueregh($arr[$keys[28]]);
		if (array_key_exists($keys[29], $arr)) $this->setModcormue($arr[$keys[29]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(BndefinsPeer::PORPRI)) $criteria->add(BndefinsPeer::PORPRI, $this->porpri);
		if ($this->isColumnModified(BndefinsPeer::CODTIPTRA)) $criteria->add(BndefinsPeer::CODTIPTRA, $this->codtiptra);
		if ($this->isColumnModified(BndefinsPeer::CORMUENACD)) $criteria->add(BndefinsPeer::CORMUENACD, $this->cormuenacd);
		if ($this->isColumnModified(BndefinsPeer::CORMUEREGD)) $criteria->add(BndefinsPeer::CORMUEREGD, $this->cormueregd);
		if ($this->isColumnModified(BndefinsPeer::CORMUENACH)) $criteria->add(BndefinsPeer::CORMUENACH, $this->cormuenach);
		if ($this->isColumnModified(BndefinsPeer::CORMUEREGH)) $criteria->add(BndefinsPeer::CORMUEREGH, $this->cormueregh);
		if ($this->isColumnModified(BndefinsPeer::MODCORMUE)) $criteria->add(BndefinsPeer::MODCORMUE, $this->modcormue);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setCormuenacd($this->cormuenacd);

		$copyObj->setCormueregd($this->cormueregd);

		$copyObj->setCormuenach($this->cormuenach);

		$copyObj->setCormueregh($this->cormueregh);

		$copyObj->setModcormue($this->modcormue);

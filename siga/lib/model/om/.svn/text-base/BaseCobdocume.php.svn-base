...
abstract class BaseCobdocume extends BaseObject  implements Persistent {
  ...
  public function getTotret($val=false)
  {

    if($val) return number_format($this->totret,2,',','.');
    else return $this->totret;
  ...
  public function getTradoc()
  {

    return trim($this->tradoc);

  }
  
  public function getRefdocnc()
  {

    return trim($this->refdocnc);
  ...
  public function getRefdocnd()
  {

    return trim($this->refdocnd);
  ...
  public function getId()
  {
    ...
    if ($this->totret !== $v) {
        $this->totret = Herramientas::toFloat($v);
        $this->modifiedColumns[] = CobdocumePeer::TOTRET;
      }
    ...
    if ($this->totant !== $v) {
        ...
        $this->modifiedColumns[] = CobdocumePeer::TOTANT;
      }
    ...
    if ($this->fadescripfac_id !== $v) {
        ...
        $this->modifiedColumns[] = CobdocumePeer::FADESCRIPFAC_ID;
      }
    ...
    if ($this->reftra !== $v) {
        $this->reftra = $v;
        $this->modifiedColumns[] = CobdocumePeer::REFTRA;
      }
    ...
    if ($this->coddirec !== $v) {
        $this->coddirec = $v;
        $this->modifiedColumns[] = CobdocumePeer::CODDIREC;
      }
  
	} 
	
	public function setTradoc($v)
	{

    if ($this->tradoc !== $v) {
        $this->tradoc = $v;
        $this->modifiedColumns[] = CobdocumePeer::TRADOC;
      }
  
	} 
	
	public function setRefdocnc($v)
	{

    if ($this->refdocnc !== $v) {
        $this->refdocnc = $v;
        $this->modifiedColumns[] = CobdocumePeer::REFDOCNC;
      }
    ...
    if ($this->monexo !== $v) {
        ...
        $this->modifiedColumns[] = CobdocumePeer::MONEXO;
      }
  
	} 
	
	public function setRefdocnd($v)
	{

    if ($this->refdocnd !== $v) {
        $this->refdocnd = $v;
        $this->modifiedColumns[] = CobdocumePeer::REFDOCND;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->totret = $rs->getFloat($startcol + 18);

      $this->totant = $rs->getFloat($startcol + 19);

      $this->fadescripfac_id = $rs->getInt($startcol + 20);

      $this->reftra = $rs->getString($startcol + 21);

      $this->coddirec = $rs->getString($startcol + 22);

      $this->tradoc = $rs->getString($startcol + 23);

      $this->refdocnc = $rs->getString($startcol + 24);

      $this->monexo = $rs->getFloat($startcol + 25);

      $this->refdocnd = $rs->getString($startcol + 26);
  ...
  public function get($m, $a)
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 22:
				...
				break;
			case 23:
				return $this->getTradoc();
				break;
			case 24:
				return $this->getRefdocnc();
				break;
			case 25:
				return $this->getMonexo();
				break;
			case 26:
				return $this->getRefdocnd();
				break;
			case 27:
				return $this->getId();
				break;
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		$result = array(
			...
			$keys[18] => $this->getTotret(),
			$keys[19] => $this->getTotant(),
			$keys[20] => $this->getFadescripfacId(),
			$keys[21] => $this->getReftra(),
			$keys[22] => $this->getCoddirec(),
			$keys[23] => $this->getTradoc(),
			$keys[24] => $this->getRefdocnc(),
			$keys[25] => $this->getMonexo(),
			$keys[26] => $this->getRefdocnd(),
			$keys[27] => $this->getId(),
		);
		return $result;
	}
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 22:
				...
				break;
			case 23:
				$this->setTradoc($value);
				break;
			case 24:
				$this->setRefdocnc($value);
				break;
			case 25:
				$this->setMonexo($value);
				break;
			case 26:
				$this->setRefdocnd($value);
				break;
			case 27:
				$this->setId($value);
				break;
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[18], $arr)) $this->setTotret($arr[$keys[18]]);
		if (array_key_exists($keys[19], $arr)) $this->setTotant($arr[$keys[19]]);
		if (array_key_exists($keys[20], $arr)) $this->setFadescripfacId($arr[$keys[20]]);
		if (array_key_exists($keys[21], $arr)) $this->setReftra($arr[$keys[21]]);
		if (array_key_exists($keys[22], $arr)) $this->setCoddirec($arr[$keys[22]]);
		if (array_key_exists($keys[23], $arr)) $this->setTradoc($arr[$keys[23]]);
		if (array_key_exists($keys[24], $arr)) $this->setRefdocnc($arr[$keys[24]]);
		if (array_key_exists($keys[25], $arr)) $this->setMonexo($arr[$keys[25]]);
		if (array_key_exists($keys[26], $arr)) $this->setRefdocnd($arr[$keys[26]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CobdocumePeer::TOTRET)) $criteria->add(CobdocumePeer::TOTRET, $this->totret);
		if ($this->isColumnModified(CobdocumePeer::TOTANT)) $criteria->add(CobdocumePeer::TOTANT, $this->totant);
		if ($this->isColumnModified(CobdocumePeer::FADESCRIPFAC_ID)) $criteria->add(CobdocumePeer::FADESCRIPFAC_ID, $this->fadescripfac_id);
		if ($this->isColumnModified(CobdocumePeer::REFTRA)) $criteria->add(CobdocumePeer::REFTRA, $this->reftra);
		if ($this->isColumnModified(CobdocumePeer::CODDIREC)) $criteria->add(CobdocumePeer::CODDIREC, $this->coddirec);
		if ($this->isColumnModified(CobdocumePeer::TRADOC)) $criteria->add(CobdocumePeer::TRADOC, $this->tradoc);
		if ($this->isColumnModified(CobdocumePeer::REFDOCNC)) $criteria->add(CobdocumePeer::REFDOCNC, $this->refdocnc);
		if ($this->isColumnModified(CobdocumePeer::MONEXO)) $criteria->add(CobdocumePeer::MONEXO, $this->monexo);
		if ($this->isColumnModified(CobdocumePeer::REFDOCND)) $criteria->add(CobdocumePeer::REFDOCND, $this->refdocnd);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setTradoc($this->tradoc);

		$copyObj->setRefdocnc($this->refdocnc);

		$copyObj->setMonexo($this->monexo);

		$copyObj->setRefdocnd($this->refdocnd);

...
abstract class BaseTsmovtra extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->codmon !== $v) {
        $this->codmon = $v;
        $this->modifiedColumns[] = TsmovtraPeer::CODMON;
      }
	...
	public function setTipmovdesd($v)
	{

    if ($this->tipmovdesd !== $v) {
        $this->tipmovdesd = $v;
        $this->modifiedColumns[] = TsmovtraPeer::TIPMOVDESD;
      }
  
	} 
	
	public function setTipmovhast($v)
	{

    if ($this->tipmovhast !== $v) {
        $this->tipmovhast = $v;
        $this->modifiedColumns[] = TsmovtraPeer::TIPMOVHAST;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->codmon = $rs->getString($startcol + 10);

      $this->valmon = $rs->getFloat($startcol + 11);

      $this->tipmovdesd = $rs->getString($startcol + 12);

      $this->tipmovhast = $rs->getString($startcol + 13);
  ...
  public function get($m, $a)
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 11:
				...
				break;
			case 12:
				return $this->getTipmovdesd();
				break;
			case 13:
				return $this->getTipmovhast();
				break;
			case 14:
				return $this->getId();
				break;
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		$result = array(
			...
			$keys[10] => $this->getCodmon(),
			$keys[11] => $this->getValmon(),
			$keys[12] => $this->getTipmovdesd(),
			$keys[13] => $this->getTipmovhast(),
			$keys[14] => $this->getId(),
		);
		return $result;
	}
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 11:
				...
				break;
			case 12:
				$this->setTipmovdesd($value);
				break;
			case 13:
				$this->setTipmovhast($value);
				break;
			case 14:
				$this->setId($value);
				break;
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[10], $arr)) $this->setCodmon($arr[$keys[10]]);
		if (array_key_exists($keys[11], $arr)) $this->setValmon($arr[$keys[11]]);
		if (array_key_exists($keys[12], $arr)) $this->setTipmovdesd($arr[$keys[12]]);
		if (array_key_exists($keys[13], $arr)) $this->setTipmovhast($arr[$keys[13]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TsmovtraPeer::CODMON)) $criteria->add(TsmovtraPeer::CODMON, $this->codmon);
		if ($this->isColumnModified(TsmovtraPeer::VALMON)) $criteria->add(TsmovtraPeer::VALMON, $this->valmon);
		if ($this->isColumnModified(TsmovtraPeer::TIPMOVDESD)) $criteria->add(TsmovtraPeer::TIPMOVDESD, $this->tipmovdesd);
		if ($this->isColumnModified(TsmovtraPeer::TIPMOVHAST)) $criteria->add(TsmovtraPeer::TIPMOVHAST, $this->tipmovhast);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setTipmovdesd($this->tipmovdesd);

		$copyObj->setTipmovhast($this->tipmovhast);

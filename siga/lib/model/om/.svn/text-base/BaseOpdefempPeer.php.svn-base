...
abstract class BaseOpdefempPeer {
	...
	const CODMON = 'opdefemp.CODMON';

	
	const TIPPAG = 'opdefemp.TIPPAG';

	
	const CORPAGELE = 'opdefemp.CORPAGELE';

	
	const TIPAGELE = 'opdefemp.TIPAGELE';

	
	const CORMOVELE = 'opdefemp.CORMOVELE';

	
	const RIFEMP = 'opdefemp.RIFEMP';

	
	const NUMNEG = 'opdefemp.NUMNEG';

	
	const ORDAMO = 'opdefemp.ORDAMO';

	
	const ORDANT = 'opdefemp.ORDANT';

	
	const ORDANTCOM = 'opdefemp.ORDANTCOM';

	
	const REPPREIMPOP = 'opdefemp.REPPREIMPOP';

	
	const CORCIECAJ = 'opdefemp.CORCIECAJ';

	
	const ORDHCM = 'opdefemp.ORDHCM';

	
	const COMIVA = 'opdefemp.COMIVA';

	
	const COMISLR = 'opdefemp.COMISLR';

	
	const COMLTF = 'opdefemp.COMLTF';

	
	const COMRS = 'opdefemp.COMRS';

	
	const ORDCARAVA = 'opdefemp.ORDCARAVA';

	
	const ORDCIECAJ = 'opdefemp.ORDCIECAJ';

	
	const NOMFIRREP = 'opdefemp.NOMFIRREP';

	
	const RANFIRREP = 'opdefemp.RANFIRREP';

	
	const CARFIRREP = 'opdefemp.CARFIRREP';

	
	const AGROPNOMESP = 'opdefemp.AGROPNOMESP';

	
	const NOMREPTRAS = 'opdefemp.NOMREPTRAS';
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(OpdefempPeer::CODMON);

		$criteria->addSelectColumn(OpdefempPeer::TIPPAG);

		$criteria->addSelectColumn(OpdefempPeer::CORPAGELE);

		$criteria->addSelectColumn(OpdefempPeer::TIPAGELE);

		$criteria->addSelectColumn(OpdefempPeer::CORMOVELE);

		$criteria->addSelectColumn(OpdefempPeer::RIFEMP);

		$criteria->addSelectColumn(OpdefempPeer::NUMNEG);

		$criteria->addSelectColumn(OpdefempPeer::ORDAMO);

		$criteria->addSelectColumn(OpdefempPeer::ORDANT);

		$criteria->addSelectColumn(OpdefempPeer::ORDANTCOM);

		$criteria->addSelectColumn(OpdefempPeer::REPPREIMPOP);

		$criteria->addSelectColumn(OpdefempPeer::CORCIECAJ);

		$criteria->addSelectColumn(OpdefempPeer::ORDHCM);

		$criteria->addSelectColumn(OpdefempPeer::COMIVA);

		$criteria->addSelectColumn(OpdefempPeer::COMISLR);

		$criteria->addSelectColumn(OpdefempPeer::COMLTF);

		$criteria->addSelectColumn(OpdefempPeer::COMRS);

		$criteria->addSelectColumn(OpdefempPeer::ORDCARAVA);

		$criteria->addSelectColumn(OpdefempPeer::ORDCIECAJ);

		$criteria->addSelectColumn(OpdefempPeer::NOMFIRREP);

		$criteria->addSelectColumn(OpdefempPeer::RANFIRREP);

		$criteria->addSelectColumn(OpdefempPeer::CARFIRREP);

		$criteria->addSelectColumn(OpdefempPeer::AGROPNOMESP);

		$criteria->addSelectColumn(OpdefempPeer::NOMREPTRAS);

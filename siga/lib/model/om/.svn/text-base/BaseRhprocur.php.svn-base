...
abstract class BaseRhprocur extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
	...
	public function setInstr($v)
	{

    if ($this->instr !== $v) {
        $this->instr = $v;
        $this->modifiedColumns[] = RhprocurPeer::INSTR;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->instr = $rs->getBoolean($startcol + 3);
  ...
  public function get($m, $a)
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setInstr($arr[$keys[3]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(RhprocurPeer::INSTR)) $criteria->add(RhprocurPeer::INSTR, $this->instr);

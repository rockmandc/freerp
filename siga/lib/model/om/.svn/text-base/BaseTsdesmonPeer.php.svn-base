...
abstract class BaseTsdesmonPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Codmon', 'Nommon', 'Valmon', 'Fecmon', 'Id', ),
		BasePeer::TYPE_COLNAME => array (TsdesmonPeer::CODMON, TsdesmonPeer::NOMMON, TsdesmonPeer::VALMON, TsdesmonPeer::FECMON, TsdesmonPeer::ID, ),
		BasePeer::TYPE_FIELDNAME => array ('codmon', 'nommon', 'valmon', 'fecmon', 'id', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Codmon' => 0, 'Nommon' => 1, 'Valmon' => 2, 'Fecmon' => 3, 'Id' => 4, ),
		BasePeer::TYPE_COLNAME => array (TsdesmonPeer::CODMON => 0, TsdesmonPeer::NOMMON => 1, TsdesmonPeer::VALMON => 2, TsdesmonPeer::FECMON => 3, TsdesmonPeer::ID => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('codmon' => 0, 'nommon' => 1, 'valmon' => 2, 'fecmon' => 3, 'id' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);

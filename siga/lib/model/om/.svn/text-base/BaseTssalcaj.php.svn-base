...
abstract class BaseTssalcaj extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->coddirec !== $v) {
        $this->coddirec = $v;
        $this->modifiedColumns[] = TssalcajPeer::CODDIREC;
      }
    ...
    if ($this->codeve !== $v) {
        $this->codeve = $v;
        $this->modifiedColumns[] = TssalcajPeer::CODEVE;
      }
    ...
    if ($this->numfac !== $v) {
        $this->numfac = $v;
        $this->modifiedColumns[] = TssalcajPeer::NUMFAC;
      }
    ...
    if ($this->fecfac !== $ts) {
      $this->fecfac = $ts;
      $this->modifiedColumns[] = TssalcajPeer::FECFAC;
    }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->coddirec = $rs->getString($startcol + 7);

      $this->codeve = $rs->getString($startcol + 8);

      $this->numfac = $rs->getString($startcol + 9);

      $this->fecfac = $rs->getDate($startcol + 10, null);
  ...
  public function get($m, $a)
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		$result = array(
			...
			$keys[7] => $this->getCoddirec(),
			$keys[8] => $this->getCodeve(),
			$keys[9] => $this->getNumfac(),
			$keys[10] => $this->getFecfac(),
			$keys[11] => $this->getId(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[7], $arr)) $this->setCoddirec($arr[$keys[7]]);
		if (array_key_exists($keys[8], $arr)) $this->setCodeve($arr[$keys[8]]);
		if (array_key_exists($keys[9], $arr)) $this->setNumfac($arr[$keys[9]]);
		if (array_key_exists($keys[10], $arr)) $this->setFecfac($arr[$keys[10]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TssalcajPeer::CODDIREC)) $criteria->add(TssalcajPeer::CODDIREC, $this->coddirec);
		if ($this->isColumnModified(TssalcajPeer::CODEVE)) $criteria->add(TssalcajPeer::CODEVE, $this->codeve);
		if ($this->isColumnModified(TssalcajPeer::NUMFAC)) $criteria->add(TssalcajPeer::NUMFAC, $this->numfac);
		if ($this->isColumnModified(TssalcajPeer::FECFAC)) $criteria->add(TssalcajPeer::FECFAC, $this->fecfac);

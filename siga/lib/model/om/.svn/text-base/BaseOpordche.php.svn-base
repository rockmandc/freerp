...
abstract class BaseOpordche extends BaseObject  implements Persistent {
  ...
  public function getCompret()
  {

    return trim($this->compret);
  ...
  public function getId()
  {
	...
	public function setCompret($v)
	{

    if ($this->compret !== $v) {
        $this->compret = $v;
        $this->modifiedColumns[] = OpordchePeer::COMPRET;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->compret = $rs->getString($startcol + 5);
  ...
  public function get($m, $a)
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[5], $arr)) $this->setCompret($arr[$keys[5]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(OpordchePeer::COMPRET)) $criteria->add(OpordchePeer::COMPRET, $this->compret);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setCompret($this->compret);

...
abstract class BaseEmpresaPeer {
	...
	const TIPDOC = 'empresa.TIPDOC';

	
	const RIFEMP = 'empresa.RIFEMP';

	
	const NUMTAR = 'empresa.NUMTAR';

	
	const MES = 'empresa.MES';

	
	const MESISLR = 'empresa.MESISLR';
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(EmpresaPeer::TIPDOC);

		$criteria->addSelectColumn(EmpresaPeer::RIFEMP);

		$criteria->addSelectColumn(EmpresaPeer::NUMTAR);

		$criteria->addSelectColumn(EmpresaPeer::MES);

		$criteria->addSelectColumn(EmpresaPeer::MESISLR);

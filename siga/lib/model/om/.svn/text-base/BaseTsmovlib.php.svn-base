...
abstract class BaseTsmovlib extends BaseObject  implements Persistent {
  ...
  public function getStadif()
  {

    return trim($this->stadif);
  ...
  public function getTipmovaju()
  {

    return trim($this->tipmovaju);

  }
  
  public function getReflibaju()
  {

    return trim($this->reflibaju);
  ...
  public function getId()
  {
    ...
    if ($this->codmon !== $v) {
        $this->codmon = $v;
        $this->modifiedColumns[] = TsmovlibPeer::CODMON;
      }
    ...
    if ($this->codconcepto !== $v) {
        $this->codconcepto = $v;
        $this->modifiedColumns[] = TsmovlibPeer::CODCONCEPTO;
      }
  
	} 
	
	public function setStadif($v)
	{

    if ($this->stadif !== $v) {
        $this->stadif = $v;
        $this->modifiedColumns[] = TsmovlibPeer::STADIF;
      }
    ...
    if ($this->codpro !== $v) {
        $this->codpro = $v;
        $this->modifiedColumns[] = TsmovlibPeer::CODPRO;
      }
  
	} 
	
	public function setTipmovaju($v)
	{

    if ($this->tipmovaju !== $v) {
        $this->tipmovaju = $v;
        $this->modifiedColumns[] = TsmovlibPeer::TIPMOVAJU;
      }
  
	} 
	
	public function setReflibaju($v)
	{

    if ($this->reflibaju !== $v) {
        $this->reflibaju = $v;
        $this->modifiedColumns[] = TsmovlibPeer::REFLIBAJU;
      }
    ...
    if ($this->coddirec !== $v) {
        $this->coddirec = $v;
        $this->modifiedColumns[] = TsmovlibPeer::CODDIREC;
      }
    ...
    if ($this->refrei !== $v) {
        $this->refrei = $v;
        $this->modifiedColumns[] = TsmovlibPeer::REFREI;
      }
    ...
    if ($this->rifcon !== $v) {
        $this->rifcon = $v;
        $this->modifiedColumns[] = TsmovlibPeer::RIFCON;
      }
    ...
    if ($this->codtipgas !== $v) {
        $this->codtipgas = $v;
        $this->modifiedColumns[] = TsmovlibPeer::CODTIPGAS;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->codmon = $rs->getString($startcol + 26);

      $this->valmon = $rs->getFloat($startcol + 27);

      $this->codconcepto = $rs->getString($startcol + 28);

      $this->stadif = $rs->getString($startcol + 29);

      $this->codpro = $rs->getString($startcol + 30);

      $this->tipmovaju = $rs->getString($startcol + 31);

      $this->reflibaju = $rs->getString($startcol + 32);

      $this->coddirec = $rs->getString($startcol + 33);

      $this->refrei = $rs->getString($startcol + 34);

      $this->rifcon = $rs->getString($startcol + 35);

      $this->codtipgas = $rs->getString($startcol + 36);
  ...
  public function get($m, $a)
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 28:
				...
				break;
			case 29:
				return $this->getStadif();
				break;
			case 30:
				return $this->getCodpro();
				break;
			case 31:
				return $this->getTipmovaju();
				break;
			case 32:
				return $this->getReflibaju();
				break;
			case 33:
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		$result = array(
			...
			$keys[26] => $this->getCodmon(),
			$keys[27] => $this->getValmon(),
			$keys[28] => $this->getCodconcepto(),
			$keys[29] => $this->getStadif(),
			$keys[30] => $this->getCodpro(),
			$keys[31] => $this->getTipmovaju(),
			$keys[32] => $this->getReflibaju(),
			$keys[33] => $this->getCoddirec(),
			$keys[34] => $this->getRefrei(),
			$keys[35] => $this->getRifcon(),
			$keys[36] => $this->getCodtipgas(),
			$keys[37] => $this->getId(),
		);
		return $result;
	}
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 28:
				...
				break;
			case 29:
				$this->setStadif($value);
				break;
			case 30:
				$this->setCodpro($value);
				break;
			case 31:
				$this->setTipmovaju($value);
				break;
			case 32:
				$this->setReflibaju($value);
				break;
			case 33:
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[26], $arr)) $this->setCodmon($arr[$keys[26]]);
		if (array_key_exists($keys[27], $arr)) $this->setValmon($arr[$keys[27]]);
		if (array_key_exists($keys[28], $arr)) $this->setCodconcepto($arr[$keys[28]]);
		if (array_key_exists($keys[29], $arr)) $this->setStadif($arr[$keys[29]]);
		if (array_key_exists($keys[30], $arr)) $this->setCodpro($arr[$keys[30]]);
		if (array_key_exists($keys[31], $arr)) $this->setTipmovaju($arr[$keys[31]]);
		if (array_key_exists($keys[32], $arr)) $this->setReflibaju($arr[$keys[32]]);
		if (array_key_exists($keys[33], $arr)) $this->setCoddirec($arr[$keys[33]]);
		if (array_key_exists($keys[34], $arr)) $this->setRefrei($arr[$keys[34]]);
		if (array_key_exists($keys[35], $arr)) $this->setRifcon($arr[$keys[35]]);
		if (array_key_exists($keys[36], $arr)) $this->setCodtipgas($arr[$keys[36]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TsmovlibPeer::CODMON)) $criteria->add(TsmovlibPeer::CODMON, $this->codmon);
		if ($this->isColumnModified(TsmovlibPeer::VALMON)) $criteria->add(TsmovlibPeer::VALMON, $this->valmon);
		if ($this->isColumnModified(TsmovlibPeer::CODCONCEPTO)) $criteria->add(TsmovlibPeer::CODCONCEPTO, $this->codconcepto);
		if ($this->isColumnModified(TsmovlibPeer::STADIF)) $criteria->add(TsmovlibPeer::STADIF, $this->stadif);
		if ($this->isColumnModified(TsmovlibPeer::CODPRO)) $criteria->add(TsmovlibPeer::CODPRO, $this->codpro);
		if ($this->isColumnModified(TsmovlibPeer::TIPMOVAJU)) $criteria->add(TsmovlibPeer::TIPMOVAJU, $this->tipmovaju);
		if ($this->isColumnModified(TsmovlibPeer::REFLIBAJU)) $criteria->add(TsmovlibPeer::REFLIBAJU, $this->reflibaju);
		if ($this->isColumnModified(TsmovlibPeer::CODDIREC)) $criteria->add(TsmovlibPeer::CODDIREC, $this->coddirec);
		if ($this->isColumnModified(TsmovlibPeer::REFREI)) $criteria->add(TsmovlibPeer::REFREI, $this->refrei);
		if ($this->isColumnModified(TsmovlibPeer::RIFCON)) $criteria->add(TsmovlibPeer::RIFCON, $this->rifcon);
		if ($this->isColumnModified(TsmovlibPeer::CODTIPGAS)) $criteria->add(TsmovlibPeer::CODTIPGAS, $this->codtipgas);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setStadif($this->stadif);

		$copyObj->setCodpro($this->codpro);

		$copyObj->setTipmovaju($this->tipmovaju);

		$copyObj->setReflibaju($this->reflibaju);

...
abstract class BaseTsdefbanPeer {
	...
	const CODMON = 'tsdefban.CODMON';

	
	const CODCOM = 'tsdefban.CODCOM';

	
	const CODTIPTRA = 'tsdefban.CODTIPTRA';

	
	const CODADI = 'tsdefban.CODADI';

	
	const CODUBI = 'tsdefban.CODUBI';

	
	const CODDIREC = 'tsdefban.CODDIREC';

	
	const CONFORMABLE = 'tsdefban.CONFORMABLE';

	
	const MONCONFOR = 'tsdefban.MONCONFOR';

	
	const AGENBAN = 'tsdefban.AGENBAN';

	
	const CORCHETRAN = 'tsdefban.CORCHETRAN';

	
	const NOMCIU = 'tsdefban.NOMCIU';

	
	const AREREP = 'tsdefban.AREREP';

	
	const ATEREP = 'tsdefban.ATEREP';

	
	const CUEBCV = 'tsdefban.CUEBCV';

	
	const ESCAJCHI = 'tsdefban.ESCAJCHI';
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(TsdefbanPeer::CODMON);

		$criteria->addSelectColumn(TsdefbanPeer::CODCOM);

		$criteria->addSelectColumn(TsdefbanPeer::CODTIPTRA);

		$criteria->addSelectColumn(TsdefbanPeer::CODADI);

		$criteria->addSelectColumn(TsdefbanPeer::CODUBI);

		$criteria->addSelectColumn(TsdefbanPeer::CODDIREC);

		$criteria->addSelectColumn(TsdefbanPeer::CONFORMABLE);

		$criteria->addSelectColumn(TsdefbanPeer::MONCONFOR);

		$criteria->addSelectColumn(TsdefbanPeer::AGENBAN);

		$criteria->addSelectColumn(TsdefbanPeer::CORCHETRAN);

		$criteria->addSelectColumn(TsdefbanPeer::NOMCIU);

		$criteria->addSelectColumn(TsdefbanPeer::AREREP);

		$criteria->addSelectColumn(TsdefbanPeer::ATEREP);

		$criteria->addSelectColumn(TsdefbanPeer::CUEBCV);

		$criteria->addSelectColumn(TsdefbanPeer::ESCAJCHI);

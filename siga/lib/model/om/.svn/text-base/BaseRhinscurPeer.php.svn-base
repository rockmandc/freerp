...
abstract class BaseRhinscurPeer {
	...
	const TIPPER = 'rhinscur.TIPPER';

	
	const CODPLACUR = 'rhinscur.CODPLACUR';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Codcur', 'Codemp', 'Codcar', 'Fecins', 'Tipper', 'Codplacur', 'Id', ),
		BasePeer::TYPE_COLNAME => array (RhinscurPeer::CODCUR, RhinscurPeer::CODEMP, RhinscurPeer::CODCAR, RhinscurPeer::FECINS, RhinscurPeer::TIPPER, RhinscurPeer::CODPLACUR, RhinscurPeer::ID, ),
		BasePeer::TYPE_FIELDNAME => array ('codcur', 'codemp', 'codcar', 'fecins', 'tipper', 'codplacur', 'id', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Codcur' => 0, 'Codemp' => 1, 'Codcar' => 2, 'Fecins' => 3, 'Tipper' => 4, 'Codplacur' => 5, 'Id' => 6, ),
		BasePeer::TYPE_COLNAME => array (RhinscurPeer::CODCUR => 0, RhinscurPeer::CODEMP => 1, RhinscurPeer::CODCAR => 2, RhinscurPeer::FECINS => 3, RhinscurPeer::TIPPER => 4, RhinscurPeer::CODPLACUR => 5, RhinscurPeer::ID => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('codcur' => 0, 'codemp' => 1, 'codcar' => 2, 'fecins' => 3, 'tipper' => 4, 'codplacur' => 5, 'id' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(RhinscurPeer::TIPPER);

		$criteria->addSelectColumn(RhinscurPeer::CODPLACUR);

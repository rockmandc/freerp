...
abstract class BaseOpfactur extends BaseObject  implements Persistent {
  ...
  public function getBasimn($val=false)
  {

    if($val) return number_format($this->basimn,2,',','.');
    else return $this->basimn;

  }
  
  public function getPorimn($val=false)
  {

    if($val) return number_format($this->porimn,2,',','.');
    else return $this->porimn;

  }
  
  public function getMonimn($val=false)
  {

    if($val) return number_format($this->monimn,2,',','.');
    else return $this->monimn;

  }
  
  public function getCodimn()
  {

    return trim($this->codimn);

  }
  
  public function getFecrecfac($format = 'Y-m-d')
  {
  ...
  public function getMnosuj($val=false)
  {

    if($val) return number_format($this->mnosuj,2,',','.');
    else return $this->mnosuj;

  }
  
  public function getMdecre($val=false)
  {

    if($val) return number_format($this->mdecre,2,',','.');
    else return $this->mdecre;
  ...
  public function getId()
  {
	...
	public function setBasimn($v)
	{

    if ($this->basimn !== $v) {
        $this->basimn = Herramientas::toFloat($v);
        $this->modifiedColumns[] = OpfacturPeer::BASIMN;
      }
  
	} 
	
	public function setPorimn($v)
	{

    if ($this->porimn !== $v) {
        $this->porimn = Herramientas::toFloat($v);
        $this->modifiedColumns[] = OpfacturPeer::PORIMN;
      }
  
	} 
	
	public function setMonimn($v)
	{

    if ($this->monimn !== $v) {
        $this->monimn = Herramientas::toFloat($v);
        $this->modifiedColumns[] = OpfacturPeer::MONIMN;
      }
  
	} 
	
	public function setCodimn($v)
	{

    if ($this->codimn !== $v) {
        $this->codimn = $v;
        $this->modifiedColumns[] = OpfacturPeer::CODIMN;
      }
    ...
    if ($this->fecrecfac !== $ts) {
      $this->fecrecfac = $ts;
      $this->modifiedColumns[] = OpfacturPeer::FECRECFAC;
    }

	} 
	
	public function setMnosuj($v)
	{

    if ($this->mnosuj !== $v) {
        $this->mnosuj = Herramientas::toFloat($v);
        $this->modifiedColumns[] = OpfacturPeer::MNOSUJ;
      }
  
	} 
	
	public function setMdecre($v)
	{

    if ($this->mdecre !== $v) {
        $this->mdecre = Herramientas::toFloat($v);
        $this->modifiedColumns[] = OpfacturPeer::MDECRE;
      }
    ...
    if ($this->monexo !== $v) {
        ...
        $this->modifiedColumns[] = OpfacturPeer::MONEXO;
      }
  
	} 
	
	public function setCodiva($v)
	{

    if ($this->codiva !== $v) {
        $this->codiva = $v;
        $this->modifiedColumns[] = OpfacturPeer::CODIVA;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->basimn = $rs->getFloat($startcol + 25);

      $this->porimn = $rs->getFloat($startcol + 26);

      $this->monimn = $rs->getFloat($startcol + 27);

      $this->codimn = $rs->getString($startcol + 28);

      $this->fecrecfac = $rs->getDate($startcol + 29, null);

      $this->mnosuj = $rs->getFloat($startcol + 30);

      $this->mdecre = $rs->getFloat($startcol + 31);

      $this->monexo = $rs->getFloat($startcol + 32);

      $this->codiva = $rs->getString($startcol + 33);
  ...
  public function get($m, $a)
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 24:
				...
				break;
			case 25:
				return $this->getBasimn();
				break;
			case 26:
				return $this->getPorimn();
				break;
			case 27:
				return $this->getMonimn();
				break;
			case 28:
				return $this->getCodimn();
				break;
			case 29:
				return $this->getFecrecfac();
				break;
			case 30:
				return $this->getMnosuj();
				break;
			case 31:
				return $this->getMdecre();
				break;
			case 32:
				return $this->getMonexo();
				break;
			case 33:
				return $this->getCodiva();
				break;
			case 34:
				return $this->getId();
				break;
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		$result = array(
			...
			$keys[25] => $this->getBasimn(),
			$keys[26] => $this->getPorimn(),
			$keys[27] => $this->getMonimn(),
			$keys[28] => $this->getCodimn(),
			$keys[29] => $this->getFecrecfac(),
			$keys[30] => $this->getMnosuj(),
			$keys[31] => $this->getMdecre(),
			$keys[32] => $this->getMonexo(),
			$keys[33] => $this->getCodiva(),
			$keys[34] => $this->getId(),
		);
		return $result;
	}
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 24:
				...
				break;
			case 25:
				$this->setBasimn($value);
				break;
			case 26:
				$this->setPorimn($value);
				break;
			case 27:
				$this->setMonimn($value);
				break;
			case 28:
				$this->setCodimn($value);
				break;
			case 29:
				$this->setFecrecfac($value);
				break;
			case 30:
				$this->setMnosuj($value);
				break;
			case 31:
				$this->setMdecre($value);
				break;
			case 32:
				$this->setMonexo($value);
				break;
			case 33:
				$this->setCodiva($value);
				break;
			case 34:
				$this->setId($value);
				break;
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[25], $arr)) $this->setBasimn($arr[$keys[25]]);
		if (array_key_exists($keys[26], $arr)) $this->setPorimn($arr[$keys[26]]);
		if (array_key_exists($keys[27], $arr)) $this->setMonimn($arr[$keys[27]]);
		if (array_key_exists($keys[28], $arr)) $this->setCodimn($arr[$keys[28]]);
		if (array_key_exists($keys[29], $arr)) $this->setFecrecfac($arr[$keys[29]]);
		if (array_key_exists($keys[30], $arr)) $this->setMnosuj($arr[$keys[30]]);
		if (array_key_exists($keys[31], $arr)) $this->setMdecre($arr[$keys[31]]);
		if (array_key_exists($keys[32], $arr)) $this->setMonexo($arr[$keys[32]]);
		if (array_key_exists($keys[33], $arr)) $this->setCodiva($arr[$keys[33]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(OpfacturPeer::BASIMN)) $criteria->add(OpfacturPeer::BASIMN, $this->basimn);
		if ($this->isColumnModified(OpfacturPeer::PORIMN)) $criteria->add(OpfacturPeer::PORIMN, $this->porimn);
		if ($this->isColumnModified(OpfacturPeer::MONIMN)) $criteria->add(OpfacturPeer::MONIMN, $this->monimn);
		if ($this->isColumnModified(OpfacturPeer::CODIMN)) $criteria->add(OpfacturPeer::CODIMN, $this->codimn);
		if ($this->isColumnModified(OpfacturPeer::FECRECFAC)) $criteria->add(OpfacturPeer::FECRECFAC, $this->fecrecfac);
		if ($this->isColumnModified(OpfacturPeer::MNOSUJ)) $criteria->add(OpfacturPeer::MNOSUJ, $this->mnosuj);
		if ($this->isColumnModified(OpfacturPeer::MDECRE)) $criteria->add(OpfacturPeer::MDECRE, $this->mdecre);
		if ($this->isColumnModified(OpfacturPeer::MONEXO)) $criteria->add(OpfacturPeer::MONEXO, $this->monexo);
		if ($this->isColumnModified(OpfacturPeer::CODIVA)) $criteria->add(OpfacturPeer::CODIVA, $this->codiva);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setBasimn($this->basimn);

		$copyObj->setPorimn($this->porimn);

		$copyObj->setMonimn($this->monimn);

		$copyObj->setCodimn($this->codimn);

		$copyObj->setFecrecfac($this->fecrecfac);

		$copyObj->setMnosuj($this->mnosuj);

		$copyObj->setMdecre($this->mdecre);

		$copyObj->setMonexo($this->monexo);

		$copyObj->setCodiva($this->codiva);

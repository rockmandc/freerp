...
abstract class BaseBnreginmPeer {
	...
	const CODALT = 'bnreginm.CODALT';

	
	const CODDIS = 'bnreginm.CODDIS';

	
	const VALADIS = 'bnreginm.VALADIS';

	
	const NUMREG = 'bnreginm.NUMREG';

	
	const NUMFOL = 'bnreginm.NUMFOL';

	
	const FECREGINM = 'bnreginm.FECREGINM';

	
	const OFIREG = 'bnreginm.OFIREG';

	
	const PROTOCOLO = 'bnreginm.PROTOCOLO';

	
	const TOMO = 'bnreginm.TOMO';

	
	const TRIMESTRE = 'bnreginm.TRIMESTRE';

	
	const NUMORD = 'bnreginm.NUMORD';

	
	const CODEST = 'bnreginm.CODEST';

	
	const DEPREC = 'bnreginm.DEPREC';

	
	const CODCL2 = 'bnreginm.CODCL2';

	
	const CODUSO = 'bnreginm.CODUSO';

	
	const CODUNIMED = 'bnreginm.CODUNIMED';

	
	const CODPAI = 'bnreginm.CODPAI';

	
	const CODES2 = 'bnreginm.CODES2';

	
	const CODMUN = 'bnreginm.CODMUN';

	
	const CODPAR = 'bnreginm.CODPAR';

	
	const CODCIU = 'bnreginm.CODCIU';

	
	const CODTLU = 'bnreginm.CODTLU';

	
	const SUDEBIP = 'bnreginm.SUDEBIP';
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(BnreginmPeer::CODALT);

		$criteria->addSelectColumn(BnreginmPeer::CODDIS);

		$criteria->addSelectColumn(BnreginmPeer::VALADIS);

		$criteria->addSelectColumn(BnreginmPeer::NUMREG);

		$criteria->addSelectColumn(BnreginmPeer::NUMFOL);

		$criteria->addSelectColumn(BnreginmPeer::FECREGINM);

		$criteria->addSelectColumn(BnreginmPeer::OFIREG);

		$criteria->addSelectColumn(BnreginmPeer::PROTOCOLO);

		$criteria->addSelectColumn(BnreginmPeer::TOMO);

		$criteria->addSelectColumn(BnreginmPeer::TRIMESTRE);

		$criteria->addSelectColumn(BnreginmPeer::NUMORD);

		$criteria->addSelectColumn(BnreginmPeer::CODEST);

		$criteria->addSelectColumn(BnreginmPeer::DEPREC);

		$criteria->addSelectColumn(BnreginmPeer::CODCL2);

		$criteria->addSelectColumn(BnreginmPeer::CODUSO);

		$criteria->addSelectColumn(BnreginmPeer::CODUNIMED);

		$criteria->addSelectColumn(BnreginmPeer::CODPAI);

		$criteria->addSelectColumn(BnreginmPeer::CODES2);

		$criteria->addSelectColumn(BnreginmPeer::CODMUN);

		$criteria->addSelectColumn(BnreginmPeer::CODPAR);

		$criteria->addSelectColumn(BnreginmPeer::CODCIU);

		$criteria->addSelectColumn(BnreginmPeer::CODTLU);

		$criteria->addSelectColumn(BnreginmPeer::SUDEBIP);
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(BnreginmPeer::ID); 

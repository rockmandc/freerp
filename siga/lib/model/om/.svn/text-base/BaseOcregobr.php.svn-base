...
abstract class BaseOcregobr extends BaseObject  implements Persistent {
  ...
  public function getClaobr()
  {

    return trim($this->claobr);
  ...
  public function getId()
  {
	...
	public function setClaobr($v)
	{

    if ($this->claobr !== $v) {
        $this->claobr = $v;
        $this->modifiedColumns[] = OcregobrPeer::CLAOBR;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->claobr = $rs->getString($startcol + 21);
  ...
  public function __call($m, $a)
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[21], $arr)) $this->setClaobr($arr[$keys[21]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(OcregobrPeer::CLAOBR)) $criteria->add(OcregobrPeer::CLAOBR, $this->claobr);

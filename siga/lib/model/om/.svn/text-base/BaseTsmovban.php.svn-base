...
abstract class BaseTsmovban extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->codmon !== $v) {
        $this->codmon = $v;
        $this->modifiedColumns[] = TsmovbanPeer::CODMON;
      }
    ...
    if ($this->coddirec !== $v) {
        $this->coddirec = $v;
        $this->modifiedColumns[] = TsmovbanPeer::CODDIREC;
      }
    ...
    if ($this->loguse !== $v) {
        $this->loguse = $v;
        $this->modifiedColumns[] = TsmovbanPeer::LOGUSE;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->loguse = $rs->getString($startcol + 14);
  ...
  public function get($m, $a)
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[14], $arr)) $this->setLoguse($arr[$keys[14]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TsmovbanPeer::CODMON)) $criteria->add(TsmovbanPeer::CODMON, $this->codmon);
		if ($this->isColumnModified(TsmovbanPeer::VALMON)) $criteria->add(TsmovbanPeer::VALMON, $this->valmon);
		if ($this->isColumnModified(TsmovbanPeer::CODDIREC)) $criteria->add(TsmovbanPeer::CODDIREC, $this->coddirec);
		if ($this->isColumnModified(TsmovbanPeer::LOGUSE)) $criteria->add(TsmovbanPeer::LOGUSE, $this->loguse);

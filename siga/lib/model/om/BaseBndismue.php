...
abstract class BaseBndismue extends BaseObject  implements Persistent {
  ...
  public function getCodestori()
  {

    return trim($this->codestori);

  }
  
  public function getCodestdes()
  {

    return trim($this->codestdes);
  ...
  public function getId()
  {
    ...
    if ($this->codresuso !== $v) {
        ...
        $this->modifiedColumns[] = BndismuePeer::CODRESUSO;
      }
    ...
    if ($this->codrespat !== $v) {
        ...
        $this->modifiedColumns[] = BndismuePeer::CODRESPAT;
      }
    ...
    if ($this->cedest !== $v) {
        ...
        $this->modifiedColumns[] = BndismuePeer::CEDEST;
      }
    ...
    if ($this->numcom !== $v) {
        ...
        $this->modifiedColumns[] = BndismuePeer::NUMCOM;
      }
  
	} 
	
	public function setCodestori($v)
	{

    if ($this->codestori !== $v) {
        $this->codestori = strtoupper($v);
        $this->modifiedColumns[] = BndismuePeer::CODESTORI;
      }
  
	} 
	
	public function setCodestdes($v)
	{

    if ($this->codestdes !== $v) {
        $this->codestdes = strtoupper($v);
        $this->modifiedColumns[] = BndismuePeer::CODESTDES;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->codresuso = $rs->getString($startcol + 16);

      $this->codrespat = $rs->getString($startcol + 17);

      $this->cedest = $rs->getString($startcol + 18);

      $this->numcom = $rs->getString($startcol + 19);

      $this->codestori = $rs->getString($startcol + 20);

      $this->codestdes = $rs->getString($startcol + 21);
  ...
  public function get($m, $a)
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 19:
				...
				break;
			case 20:
				return $this->getCodestori();
				break;
			case 21:
				return $this->getCodestdes();
				break;
			case 22:
				return $this->getId();
				break;
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		$result = array(
			...
			$keys[16] => $this->getCodresuso(),
			$keys[17] => $this->getCodrespat(),
			$keys[18] => $this->getCedest(),
			$keys[19] => $this->getNumcom(),
			$keys[20] => $this->getCodestori(),
			$keys[21] => $this->getCodestdes(),
			$keys[22] => $this->getId(),
		);
		return $result;
	}
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 19:
				...
				break;
			case 20:
				$this->setCodestori($value);
				break;
			case 21:
				$this->setCodestdes($value);
				break;
			case 22:
				$this->setId($value);
				break;
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[16], $arr)) $this->setCodresuso($arr[$keys[16]]);
		if (array_key_exists($keys[17], $arr)) $this->setCodrespat($arr[$keys[17]]);
		if (array_key_exists($keys[18], $arr)) $this->setCedest($arr[$keys[18]]);
		if (array_key_exists($keys[19], $arr)) $this->setNumcom($arr[$keys[19]]);
		if (array_key_exists($keys[20], $arr)) $this->setCodestori($arr[$keys[20]]);
		if (array_key_exists($keys[21], $arr)) $this->setCodestdes($arr[$keys[21]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(BndismuePeer::CODRESUSO)) $criteria->add(BndismuePeer::CODRESUSO, $this->codresuso);
		if ($this->isColumnModified(BndismuePeer::CODRESPAT)) $criteria->add(BndismuePeer::CODRESPAT, $this->codrespat);
		if ($this->isColumnModified(BndismuePeer::CEDEST)) $criteria->add(BndismuePeer::CEDEST, $this->cedest);
		if ($this->isColumnModified(BndismuePeer::NUMCOM)) $criteria->add(BndismuePeer::NUMCOM, $this->numcom);
		if ($this->isColumnModified(BndismuePeer::CODESTORI)) $criteria->add(BndismuePeer::CODESTORI, $this->codestori);
		if ($this->isColumnModified(BndismuePeer::CODESTDES)) $criteria->add(BndismuePeer::CODESTDES, $this->codestdes);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setCodestori($this->codestori);

		$copyObj->setCodestdes($this->codestdes);

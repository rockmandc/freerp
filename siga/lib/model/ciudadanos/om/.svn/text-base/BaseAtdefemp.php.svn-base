...
abstract class BaseAtdefemp extends BaseObject  implements Persistent {
  ...
  public function getPrecordon()
  {

    return trim($this->precordon);
  ...
  public function getId()
  {
	...
	public function setPrecordon($v)
	{

    if ($this->precordon !== $v) {
        $this->precordon = $v;
        $this->modifiedColumns[] = AtdefempPeer::PRECORDON;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->precordon = $rs->getString($startcol + 10);
  ...
  public function get($m, $a)
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[10], $arr)) $this->setPrecordon($arr[$keys[10]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(AtdefempPeer::PRECORDON)) $criteria->add(AtdefempPeer::PRECORDON, $this->precordon);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setPrecordon($this->precordon);

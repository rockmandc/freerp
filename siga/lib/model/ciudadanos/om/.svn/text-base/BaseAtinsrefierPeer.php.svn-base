...
abstract class BaseAtinsrefierPeer {
	...
	const CLASS_DEFAULT = 'lib.model.ciudadanos.Atinsrefier';
	...
	const PERCON = 'atinsrefier.PERCON';

	
	const TELEFONO = 'atinsrefier.TELEFONO';

	
	const CORREO = 'atinsrefier.CORREO';

	
	const CARGO = 'atinsrefier.CARGO';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Desinsref', 'Percon', 'Telefono', 'Correo', 'Cargo', 'Id', ),
		BasePeer::TYPE_COLNAME => array (AtinsrefierPeer::DESINSREF, AtinsrefierPeer::PERCON, AtinsrefierPeer::TELEFONO, AtinsrefierPeer::CORREO, AtinsrefierPeer::CARGO, AtinsrefierPeer::ID, ),
		BasePeer::TYPE_FIELDNAME => array ('desinsref', 'percon', 'telefono', 'correo', 'cargo', 'id', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Desinsref' => 0, 'Percon' => 1, 'Telefono' => 2, 'Correo' => 3, 'Cargo' => 4, 'Id' => 5, ),
		BasePeer::TYPE_COLNAME => array (AtinsrefierPeer::DESINSREF => 0, AtinsrefierPeer::PERCON => 1, AtinsrefierPeer::TELEFONO => 2, AtinsrefierPeer::CORREO => 3, AtinsrefierPeer::CARGO => 4, AtinsrefierPeer::ID => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('desinsref' => 0, 'percon' => 1, 'telefono' => 2, 'correo' => 3, 'cargo' => 4, 'id' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	{
		include_once 'lib/model/ciudadanos/map/AtinsrefierMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.ciudadanos.map.AtinsrefierMapBuilder');
	}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(AtinsrefierPeer::PERCON);

		$criteria->addSelectColumn(AtinsrefierPeer::TELEFONO);

		$criteria->addSelectColumn(AtinsrefierPeer::CORREO);

		$criteria->addSelectColumn(AtinsrefierPeer::CARGO);
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/ciudadanos/map/AtinsrefierMapBuilder.php';
	Propel::registerMapBuilder('lib.model.ciudadanos.map.AtinsrefierMapBuilder');
}

...
abstract class BaseAtdonacionesPeer {
	...
	const CLASS_DEFAULT = 'lib.model.ciudadanos.Atdonaciones';
	...
	const ATGRUDON_ID = 'atdonaciones.ATGRUDON_ID';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Coddon', 'Desdon', 'Unidon', 'AtgrudonId', 'Id', ),
		BasePeer::TYPE_COLNAME => array (AtdonacionesPeer::CODDON, AtdonacionesPeer::DESDON, AtdonacionesPeer::UNIDON, AtdonacionesPeer::ATGRUDON_ID, AtdonacionesPeer::ID, ),
		BasePeer::TYPE_FIELDNAME => array ('coddon', 'desdon', 'unidon', 'atgrudon_id', 'id', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Coddon' => 0, 'Desdon' => 1, 'Unidon' => 2, 'AtgrudonId' => 3, 'Id' => 4, ),
		BasePeer::TYPE_COLNAME => array (AtdonacionesPeer::CODDON => 0, AtdonacionesPeer::DESDON => 1, AtdonacionesPeer::UNIDON => 2, AtdonacionesPeer::ATGRUDON_ID => 3, AtdonacionesPeer::ID => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('coddon' => 0, 'desdon' => 1, 'unidon' => 2, 'atgrudon_id' => 3, 'id' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	{
		include_once 'lib/model/ciudadanos/map/AtdonacionesMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.ciudadanos.map.AtdonacionesMapBuilder');
	}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(AtdonacionesPeer::ATGRUDON_ID);
	...
	public static function doCountJoinAtgrudon(Criteria $criteria, $distinct = false, $con = null)
	{
				$criteria = clone $criteria;
		...
		$criteria->addJoin(AtdonacionesPeer::ATGRUDON_ID, AtgrudonPeer::ID);
	...
	public static function doSelectJoinAtgrudon(Criteria $c, $con = null)
	{
		$c = clone $c;
		...
		$startcol = (AtdonacionesPeer::NUM_COLUMNS - AtdonacionesPeer::NUM_LAZY_LOAD_COLUMNS) + 1;
		AtgrudonPeer::addSelectColumns($c);

		$c->addJoin(AtdonacionesPeer::ATGRUDON_ID, AtgrudonPeer::ID);
		...
		while($rs->next()) {
			...
			$omClass = AtgrudonPeer::getOMClass();
			...
			foreach($results as $temp_obj1) {
				$temp_obj2 = $temp_obj1->getAtgrudon(); 				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					$newObject = false;
										$temp_obj2->addAtdonaciones($obj1); 					break;
				}
			}
			if ($newObject) {
				$obj2->initAtdonacioness();
				$obj2->addAtdonaciones($obj1); 			}
			$results[] = $obj1;
		}
		return $results;
	}
	...
	public static function doSelectJoinAll(Criteria $c, $con = null)
	{
		...
		AtdonacionesPeer::addSelectColumns($c);
		$startcol2 = (AtdonacionesPeer::NUM_COLUMNS - AtdonacionesPeer::NUM_LAZY_LOAD_COLUMNS) + 1;

			AtgrudonPeer::addSelectColumns($c);
			$startcol3 = $startcol2 + AtgrudonPeer::NUM_COLUMNS;
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/ciudadanos/map/AtdonacionesMapBuilder.php';
	Propel::registerMapBuilder('lib.model.ciudadanos.map.AtdonacionesMapBuilder');
}

...
abstract class BaseAtayudas extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->atinsrefier_id !== $v) {
        ...
        $this->modifiedColumns[] = AtayudasPeer::ATINSREFIER_ID;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->atinsrefier_id = $rs->getInt($startcol + 35);
  ...
  public function get($m, $a)
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[35], $arr)) $this->setAtinsrefierId($arr[$keys[35]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(AtayudasPeer::ATINSREFIER_ID)) $criteria->add(AtayudasPeer::ATINSREFIER_ID, $this->atinsrefier_id);
	...
	public function getAtdetestsJoinAtdenuncias($criteria = null, $con = null)
	{
				include_once 'lib/model/ciudadanos/om/BaseAtdetestPeer.php';
		if ($criteria === null) {
			$criteria = new Criteria();
		...
		if ($this->collAtdetests === null) {
			if ($this->isNew()) {
				...
				$this->collAtdetests = AtdetestPeer::doSelectJoinAtdenuncias($criteria, $con);
			}
		} else {

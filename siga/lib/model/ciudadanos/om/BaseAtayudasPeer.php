...
abstract class BaseAtayudasPeer {
	...
	const ATINSREFIER_ID = 'atayudas.ATINSREFIER_ID';
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(AtayudasPeer::ATINSREFIER_ID);
	...
	public static function doCountJoinAtinsrefier(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(AtayudasPeer::ATINSREFIER_ID, AtinsrefierPeer::ID);
	...
	public static function doSelectJoinAtinsrefier(Criteria $c, $con = null)
	{
		...
		$c->addJoin(AtayudasPeer::ATINSREFIER_ID, AtinsrefierPeer::ID);
		$rs = BasePeer::doSelect($c, $con);
		$results = array();
	...
	public static function doSelectJoinAll(Criteria $c, $con = null)
	{
		...
		$startcol2 = (AtayudasPeer::NUM_COLUMNS - AtayudasPeer::NUM_LAZY_LOAD_COLUMNS) + 1;
			...
			AtinsrefierPeer::addSelectColumns($c);
			$startcol14 = $startcol13 + AtinsrefierPeer::NUM_COLUMNS;
		...
		while($rs->next()) {
			...
			$obj1->hydrate($rs);
				...
				for ($j=0, $resCount=count($results); $j < $resCount; $j++) {
					$temp_obj1 = $results[$j];
					$temp_obj13 = $temp_obj1->getAtinsrefier(); 					if ($temp_obj13->getPrimaryKey() === $obj13->getPrimaryKey()) {
						$newObject = false;
						$temp_obj13->addAtayudas($obj1); 						break;
					}
				}

				if ($newObject) {
					$obj13->initAtayudass();
					$obj13->addAtayudas($obj1);
				}
	...
	public static function doSelectJoinAllExceptCaordcom(Criteria $c, $con = null)
	{
		...
		$startcol2 = (AtayudasPeer::NUM_COLUMNS - AtayudasPeer::NUM_LAZY_LOAD_COLUMNS) + 1;
			...
			AtinsrefierPeer::addSelectColumns($c);
			$startcol13 = $startcol12 + AtinsrefierPeer::NUM_COLUMNS;
		...
		while($rs->next()) {
			...
			$obj1->hydrate($rs);
				...
				for ($j=0, $resCount=count($results); $j < $resCount; $j++) {
					$temp_obj1 = $results[$j];
					$temp_obj12 = $temp_obj1->getAtinsrefier(); 					if ($temp_obj12->getPrimaryKey() === $obj12->getPrimaryKey()) {
						$newObject = false;
						$temp_obj12->addAtayudas($obj1);
						break;
					}
				}
	...
	public static function doSelectJoinAllExceptAtciudadanoRelatedByAtsolici(Criteria $c, $con = null)
	{
		...
		$startcol2 = (AtayudasPeer::NUM_COLUMNS - AtayudasPeer::NUM_LAZY_LOAD_COLUMNS) + 1;
			...
			AtinsrefierPeer::addSelectColumns($c);
			$startcol12 = $startcol11 + AtinsrefierPeer::NUM_COLUMNS;
		...
		while($rs->next()) {
			...
			$obj1->hydrate($rs);
				...
				for ($j=0, $resCount=count($results); $j < $resCount; $j++) {
					$temp_obj1 = $results[$j];
					$temp_obj11 = $temp_obj1->getAtinsrefier(); 					if ($temp_obj11->getPrimaryKey() === $obj11->getPrimaryKey()) {
						$newObject = false;
						$temp_obj11->addAtayudas($obj1);
						break;
					}

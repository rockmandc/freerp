...
abstract class BaseAtdetestPeer {
	...
	const ATDENUNCIAS_ID = 'atdetest.ATDENUNCIAS_ID';
	...
	const DESCRIPCION = 'atdetest.DESCRIPCION';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('AtayudasId', 'AtdenunciasId', 'AtestayuDesde', 'AtestayuHasta', 'Usuario', 'Descripcion', 'CreatedAt', 'Id', ),
		BasePeer::TYPE_COLNAME => array (AtdetestPeer::ATAYUDAS_ID, AtdetestPeer::ATDENUNCIAS_ID, AtdetestPeer::ATESTAYU_DESDE, AtdetestPeer::ATESTAYU_HASTA, AtdetestPeer::USUARIO, AtdetestPeer::DESCRIPCION, AtdetestPeer::CREATED_AT, AtdetestPeer::ID, ),
		BasePeer::TYPE_FIELDNAME => array ('atayudas_id', 'atdenuncias_id', 'atestayu_desde', 'atestayu_hasta', 'usuario', 'descripcion', 'created_at', 'id', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('AtayudasId' => 0, 'AtdenunciasId' => 1, 'AtestayuDesde' => 2, 'AtestayuHasta' => 3, 'Usuario' => 4, 'Descripcion' => 5, 'CreatedAt' => 6, 'Id' => 7, ),
		BasePeer::TYPE_COLNAME => array (AtdetestPeer::ATAYUDAS_ID => 0, AtdetestPeer::ATDENUNCIAS_ID => 1, AtdetestPeer::ATESTAYU_DESDE => 2, AtdetestPeer::ATESTAYU_HASTA => 3, AtdetestPeer::USUARIO => 4, AtdetestPeer::DESCRIPCION => 5, AtdetestPeer::CREATED_AT => 6, AtdetestPeer::ID => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('atayudas_id' => 0, 'atdenuncias_id' => 1, 'atestayu_desde' => 2, 'atestayu_hasta' => 3, 'usuario' => 4, 'descripcion' => 5, 'created_at' => 6, 'id' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(AtdetestPeer::ATDENUNCIAS_ID);
		...
		$criteria->addSelectColumn(AtdetestPeer::DESCRIPCION);
	...
	public static function doCountJoinAtdenuncias(Criteria $criteria, $distinct = false, $con = null)
	{
				$criteria = clone $criteria;
		...
		$criteria->addJoin(AtdetestPeer::ATDENUNCIAS_ID, AtdenunciasPeer::ID);
	...
	public static function doSelectJoinAtdenuncias(Criteria $c, $con = null)
	{
		$c = clone $c;
		...
		$c->addJoin(AtdetestPeer::ATDENUNCIAS_ID, AtdenunciasPeer::ID);
		$rs = BasePeer::doSelect($c, $con);
		$results = array();
		...
		while($rs->next()) {
			...
			$newObject = true;
			foreach($results as $temp_obj1) {
				$temp_obj2 = $temp_obj1->getAtdenuncias(); 				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					$newObject = false;
										$temp_obj2->addAtdetest($obj1); 					break;
				}
			}
	...
	public static function doSelectJoinAll(Criteria $c, $con = null)
	{
		...
		$startcol2 = (AtdetestPeer::NUM_COLUMNS - AtdetestPeer::NUM_LAZY_LOAD_COLUMNS) + 1;
			...
			AtdenunciasPeer::addSelectColumns($c);
			$startcol4 = $startcol3 + AtdenunciasPeer::NUM_COLUMNS;
		...
		while($rs->next()) {
			...
			$obj1->hydrate($rs);
				...
				for ($j=0, $resCount=count($results); $j < $resCount; $j++) {
					$temp_obj1 = $results[$j];
					$temp_obj3 = $temp_obj1->getAtdenuncias(); 					if ($temp_obj3->getPrimaryKey() === $obj3->getPrimaryKey()) {
						$newObject = false;
						$temp_obj3->addAtdetest($obj1); 						break;
					}
				}

				if ($newObject) {
					$obj3->initAtdetests();
					$obj3->addAtdetest($obj1);
				}
				...
				for ($j=0, $resCount=count($results); $j < $resCount; $j++) {
					$temp_obj1 = $results[$j];
					$temp_obj4 = $temp_obj1->getAtestayuRelatedByAtestayuDesde(); 					if ($temp_obj4->getPrimaryKey() === $obj4->getPrimaryKey()) {
						$newObject = false;
						$temp_obj4->addAtdetestRelatedByAtestayuDesde($obj1); 						break;
					}
				}

				if ($newObject) {
					$obj4->initAtdetestsRelatedByAtestayuDesde();
					$obj4->addAtdetestRelatedByAtestayuDesde($obj1);
				}
				...
				for ($j=0, $resCount=count($results); $j < $resCount; $j++) {
					$temp_obj1 = $results[$j];
					$temp_obj5 = $temp_obj1->getAtestayuRelatedByAtestayuHasta(); 					if ($temp_obj5->getPrimaryKey() === $obj5->getPrimaryKey()) {
						$newObject = false;
						$temp_obj5->addAtdetestRelatedByAtestayuHasta($obj1); 						break;
					}
				}

				if ($newObject) {
					$obj5->initAtdetestsRelatedByAtestayuHasta();
					$obj5->addAtdetestRelatedByAtestayuHasta($obj1);
				}
		...
		public static function doCountJoinAllExceptAtdenuncias(Criteria $criteria, $distinct = false, $con = null)
		{
						$criteria = clone $criteria;
	...
	public static function doSelectJoinAllExceptAtayudas(Criteria $c, $con = null)
	{
		...
		$startcol2 = (AtdetestPeer::NUM_COLUMNS - AtdetestPeer::NUM_LAZY_LOAD_COLUMNS) + 1;
			...
			AtdenunciasPeer::addSelectColumns($c);
			$startcol3 = $startcol2 + AtdenunciasPeer::NUM_COLUMNS;
			...
			$obj1->hydrate($rs);
				...
				for ($j=0, $resCount=count($results); $j < $resCount; $j++) {
					...
					$temp_obj3 = $temp_obj1->getAtestayuRelatedByAtestayuDesde(); 					if ($temp_obj3->getPrimaryKey() === $obj3->getPrimaryKey()) {
						$newObject = false;
						$temp_obj3->addAtdetestRelatedByAtestayuDesde($obj1);
						break;
					}
				}
				...
				for ($j=0, $resCount=count($results); $j < $resCount; $j++) {
					...
					$temp_obj4 = $temp_obj1->getAtestayuRelatedByAtestayuHasta(); 					if ($temp_obj4->getPrimaryKey() === $obj4->getPrimaryKey()) {
						$newObject = false;
						$temp_obj4->addAtdetestRelatedByAtestayuHasta($obj1);
						break;
					}
				}
	...
	public static function doSelectJoinAllExceptAtdenuncias(Criteria $c, $con = null)
	{
		$c = clone $c;

...
class Atayudas extends BaseAtayudas
{
  ...
  public function afterHydrate(){
    ...
    $c= new Criteria();
    $c->add(CaproveePeer::ID,$this->atprovee_id);
    $dato=CaproveePeer::doSelectOne($c);
    if ($dato) {
     $this->nompro = $dato->getNompro();
      $this->rifpro = $dato->getRifpro();
    }
  ...
  public function save($con = null)
  {
    if($this->id){
      ...
      if($atayudas->getAtestayuId()!=$this->atestayu_id){
        ...
        $atdetest->setDescripcion($this->desayu);

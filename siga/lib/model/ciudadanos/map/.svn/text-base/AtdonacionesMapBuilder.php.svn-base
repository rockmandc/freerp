...
class AtdonacionesMapBuilder {
	...
	const CLASS_NAME = 'lib.model.ciudadanos.map.AtdonacionesMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap->addForeignKey('ATGRUDON_ID', 'AtgrudonId', 'int', CreoleTypes::INTEGER, 'atgrudon', 'ID', false, null);

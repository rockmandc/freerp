...
class AtdetestMapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addForeignKey('ATDENUNCIAS_ID', 'AtdenunciasId', 'int', CreoleTypes::INTEGER, 'atdenuncias', 'ID', false, null);
		...
		$tMap->addColumn('DESCRIPCION', 'Descripcion', 'string', CreoleTypes::VARCHAR, false, 5000);

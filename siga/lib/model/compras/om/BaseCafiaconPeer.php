...
abstract class BaseCafiaconPeer {
	...
	const CLASS_DEFAULT = 'lib.model.compras.Cafiacon';
	...
	{
		include_once 'lib/model/compras/map/CafiaconMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.compras.map.CafiaconMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/compras/map/CafiaconMapBuilder.php';
	Propel::registerMapBuilder('lib.model.compras.map.CafiaconMapBuilder');
}

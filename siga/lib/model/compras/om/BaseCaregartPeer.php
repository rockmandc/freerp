...
abstract class BaseCaregartPeer {
	...
	const CLASS_DEFAULT = 'lib.model.compras.Caregart';
	...
	const TIPPRO = 'caregart.TIPPRO';

	
	const CODBAR = 'caregart.CODBAR';

	
	const NACIMP = 'caregart.NACIMP';

	
	const CODALT = 'caregart.CODALT';

	
	const STAART = 'caregart.STAART';

	
	const CODUNIMED = 'caregart.CODUNIMED';

	
	const CLAART = 'caregart.CLAART';

	
	const NOMCOM = 'caregart.NOMCOM';

	
	const COSACT = 'caregart.COSACT';

	
	const FECCAC = 'caregart.FECCAC';

	
	const CONSBUE = 'caregart.CONSBUE';

	
	const TIPMAT = 'caregart.TIPMAT';

	
	const CLAMAT = 'caregart.CLAMAT';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Codart', 'Desart', 'Codcta', 'Codpar', 'Ramart', 'Cosult', 'Cospro', 'Exitot', 'Unimed', 'Unialt', 'Relart', 'Fecult', 'Invini', 'Codmar', 'Codref', 'Costot', 'Sigecof', 'Codclaart', 'Lotuni', 'Ctavta', 'Ctacos', 'Ctapro', 'Preart', 'Distot', 'Tipo', 'Tip0', 'Coding', 'Mercon', 'Codartsnc', 'Tipreg', 'Perbienes', 'Ctatra', 'Cosunipri', 'Ctadef', 'Tippro', 'Codbar', 'Nacimp', 'Codalt', 'Staart', 'Codunimed', 'Claart', 'Nomcom', 'Cosact', 'Feccac', 'Consbue', 'Tipmat', 'Clamat', 'Id', ),
		BasePeer::TYPE_COLNAME => array (CaregartPeer::CODART, CaregartPeer::DESART, CaregartPeer::CODCTA, CaregartPeer::CODPAR, CaregartPeer::RAMART, CaregartPeer::COSULT, CaregartPeer::COSPRO, CaregartPeer::EXITOT, CaregartPeer::UNIMED, CaregartPeer::UNIALT, CaregartPeer::RELART, CaregartPeer::FECULT, CaregartPeer::INVINI, CaregartPeer::CODMAR, CaregartPeer::CODREF, CaregartPeer::COSTOT, CaregartPeer::SIGECOF, CaregartPeer::CODCLAART, CaregartPeer::LOTUNI, CaregartPeer::CTAVTA, CaregartPeer::CTACOS, CaregartPeer::CTAPRO, CaregartPeer::PREART, CaregartPeer::DISTOT, CaregartPeer::TIPO, CaregartPeer::TIP0, CaregartPeer::CODING, CaregartPeer::MERCON, CaregartPeer::CODARTSNC, CaregartPeer::TIPREG, CaregartPeer::PERBIENES, CaregartPeer::CTATRA, CaregartPeer::COSUNIPRI, CaregartPeer::CTADEF, CaregartPeer::TIPPRO, CaregartPeer::CODBAR, CaregartPeer::NACIMP, CaregartPeer::CODALT, CaregartPeer::STAART, CaregartPeer::CODUNIMED, CaregartPeer::CLAART, CaregartPeer::NOMCOM, CaregartPeer::COSACT, CaregartPeer::FECCAC, CaregartPeer::CONSBUE, CaregartPeer::TIPMAT, CaregartPeer::CLAMAT, CaregartPeer::ID, ),
	...
	{
		include_once 'lib/model/compras/map/CaregartMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.compras.map.CaregartMapBuilder');
	}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(CaregartPeer::TIPPRO);

		$criteria->addSelectColumn(CaregartPeer::CODBAR);

		$criteria->addSelectColumn(CaregartPeer::NACIMP);

		$criteria->addSelectColumn(CaregartPeer::CODALT);

		$criteria->addSelectColumn(CaregartPeer::STAART);

		$criteria->addSelectColumn(CaregartPeer::CODUNIMED);

		$criteria->addSelectColumn(CaregartPeer::CLAART);

		$criteria->addSelectColumn(CaregartPeer::NOMCOM);

		$criteria->addSelectColumn(CaregartPeer::COSACT);

		$criteria->addSelectColumn(CaregartPeer::FECCAC);

		$criteria->addSelectColumn(CaregartPeer::CONSBUE);

		$criteria->addSelectColumn(CaregartPeer::TIPMAT);

		$criteria->addSelectColumn(CaregartPeer::CLAMAT);
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/compras/map/CaregartMapBuilder.php';
	Propel::registerMapBuilder('lib.model.compras.map.CaregartMapBuilder');
}

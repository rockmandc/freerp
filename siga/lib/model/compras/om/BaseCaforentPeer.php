...
abstract class BaseCaforentPeer {
	...
	const CLASS_DEFAULT = 'lib.model.compras.Caforent';
	...
	{
		include_once 'lib/model/compras/map/CaforentMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.compras.map.CaforentMapBuilder');
	}
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(CaforentPeer::ID); 
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/compras/map/CaforentMapBuilder.php';
	Propel::registerMapBuilder('lib.model.compras.map.CaforentMapBuilder');
}

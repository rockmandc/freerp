...
abstract class BaseCaartalmubiPeer {
	...
	const CLASS_DEFAULT = 'lib.model.compras.Caartalmubi';
	...
	{
		include_once 'lib/model/compras/map/CaartalmubiMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.compras.map.CaartalmubiMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/compras/map/CaartalmubiMapBuilder.php';
	Propel::registerMapBuilder('lib.model.compras.map.CaartalmubiMapBuilder');
}

...
abstract class BaseCatalogoPeer {
	...
	const CLASS_DEFAULT = 'lib.model.compras.Catalogo';
	...
	{
		include_once 'lib/model/compras/map/CatalogoMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.compras.map.CatalogoMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/compras/map/CatalogoMapBuilder.php';
	Propel::registerMapBuilder('lib.model.compras.map.CatalogoMapBuilder');
}

...
abstract class BaseCaconclaPeer {
	...
	const CLASS_DEFAULT = 'lib.model.compras.Caconcla';
	...
	{
		include_once 'lib/model/compras/map/CaconclaMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.compras.map.CaconclaMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/compras/map/CaconclaMapBuilder.php';
	Propel::registerMapBuilder('lib.model.compras.map.CaconclaMapBuilder');
}

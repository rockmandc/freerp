...
abstract class BaseCaresordcomPeer {
	...
	const CLASS_DEFAULT = 'lib.model.compras.Caresordcom';
	...
	{
		include_once 'lib/model/compras/map/CaresordcomMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.compras.map.CaresordcomMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/compras/map/CaresordcomMapBuilder.php';
	Propel::registerMapBuilder('lib.model.compras.map.CaresordcomMapBuilder');
}

...
abstract class BaseCaartrcp extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->codunimed !== $v) {
        $this->codunimed = $v;
        $this->modifiedColumns[] = CaartrcpPeer::CODUNIMED;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->codunimed = $rs->getString($startcol + 20);
  ...
  public function get($m, $a)
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[20], $arr)) $this->setCodunimed($arr[$keys[20]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CaartrcpPeer::CODUNIMED)) $criteria->add(CaartrcpPeer::CODUNIMED, $this->codunimed);

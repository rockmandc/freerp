...
abstract class BaseCaconproPeer {
	...
	const CLASS_DEFAULT = 'lib.model.compras.Caconpro';
	...
	{
		include_once 'lib/model/compras/map/CaconproMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.compras.map.CaconproMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/compras/map/CaconproMapBuilder.php';
	Propel::registerMapBuilder('lib.model.compras.map.CaconproMapBuilder');
}

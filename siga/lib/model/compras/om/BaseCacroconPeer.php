...
abstract class BaseCacroconPeer {
	...
	const CLASS_DEFAULT = 'lib.model.compras.Cacrocon';
	...
	{
		include_once 'lib/model/compras/map/CacroconMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.compras.map.CacroconMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/compras/map/CacroconMapBuilder.php';
	Propel::registerMapBuilder('lib.model.compras.map.CacroconMapBuilder');
}

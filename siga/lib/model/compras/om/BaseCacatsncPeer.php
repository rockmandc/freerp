...
abstract class BaseCacatsncPeer {
	...
	const CLASS_DEFAULT = 'lib.model.compras.Cacatsnc';
	...
	{
		include_once 'lib/model/compras/map/CacatsncMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.compras.map.CacatsncMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/compras/map/CacatsncMapBuilder.php';
	Propel::registerMapBuilder('lib.model.compras.map.CacatsncMapBuilder');
}

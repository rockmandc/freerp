...
abstract class BaseCargosolPeer {
	...
	const CLASS_DEFAULT = 'lib.model.compras.Cargosol';
	...
	{
		include_once 'lib/model/compras/map/CargosolMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.compras.map.CargosolMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/compras/map/CargosolMapBuilder.php';
	Propel::registerMapBuilder('lib.model.compras.map.CargosolMapBuilder');
}

...
abstract class BaseCaclagruPeer {
	...
	const CLASS_DEFAULT = 'lib.model.compras.Caclagru';
	...
	{
		include_once 'lib/model/compras/map/CaclagruMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.compras.map.CaclagruMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/compras/map/CaclagruMapBuilder.php';
	Propel::registerMapBuilder('lib.model.compras.map.CaclagruMapBuilder');
}

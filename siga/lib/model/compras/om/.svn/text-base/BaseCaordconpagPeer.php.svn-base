...
abstract class BaseCaordconpagPeer {
	...
	const CLASS_DEFAULT = 'lib.model.compras.Caordconpag';
	...
	{
		include_once 'lib/model/compras/map/CaordconpagMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.compras.map.CaordconpagMapBuilder');
	}
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(CaordconpagPeer::ID); 
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/compras/map/CaordconpagMapBuilder.php';
	Propel::registerMapBuilder('lib.model.compras.map.CaordconpagMapBuilder');
}

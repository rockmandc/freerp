...
abstract class BaseCadefubi extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->tipreg !== $v) {
        $this->tipreg = $v;
        $this->modifiedColumns[] = CadefubiPeer::TIPREG;
      }
  ...
  public function get($m, $a)
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CadefubiPeer::TIPREG)) $criteria->add(CadefubiPeer::TIPREG, $this->tipreg);
	...
	{
				include_once 'lib/model/compras/om/BaseCaartalmubiPeer.php';
		if ($criteria === null) {
	...
	{
				include_once 'lib/model/compras/om/BaseCaalmubiPeer.php';
		if ($criteria === null) {
			$criteria = new Criteria();
		}
		elseif ($criteria instanceof Criteria)

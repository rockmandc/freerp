...
abstract class BaseCaproveePeer {
	...
	const CLASS_DEFAULT = 'lib.model.compras.Caprovee';
	...
	const ESTAPO = 'caprovee.ESTAPO';

	
	const CLAPRO = 'caprovee.CLAPRO';

	
	const FECACT = 'caprovee.FECACT';

	
	const CODNIV = 'caprovee.CODNIV';
	...
	{
		include_once 'lib/model/compras/map/CaproveeMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.compras.map.CaproveeMapBuilder');
	}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(CaproveePeer::ESTAPO);

		$criteria->addSelectColumn(CaproveePeer::CLAPRO);

		$criteria->addSelectColumn(CaproveePeer::FECACT);

		$criteria->addSelectColumn(CaproveePeer::CODNIV);
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/compras/map/CaproveeMapBuilder.php';
	Propel::registerMapBuilder('lib.model.compras.map.CaproveeMapBuilder');
}

...
abstract class BaseCarecargPeer {
	...
	const CLASS_DEFAULT = 'lib.model.compras.Carecarg';
	...
	{
		include_once 'lib/model/compras/map/CarecargMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.compras.map.CarecargMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/compras/map/CarecargMapBuilder.php';
	Propel::registerMapBuilder('lib.model.compras.map.CarecargMapBuilder');
}

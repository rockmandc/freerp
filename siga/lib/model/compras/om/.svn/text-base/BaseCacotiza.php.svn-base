...
abstract class BaseCacotiza extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->numproc !== $v) {
        $this->numproc = $v;
        $this->modifiedColumns[] = CacotizaPeer::NUMPROC;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->numproc = $rs->getString($startcol + 19);
  ...
  public function get($m, $a)
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[19], $arr)) $this->setNumproc($arr[$keys[19]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CacotizaPeer::NUMPROC)) $criteria->add(CacotizaPeer::NUMPROC, $this->numproc);

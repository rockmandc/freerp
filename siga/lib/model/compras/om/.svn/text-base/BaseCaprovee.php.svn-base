...
abstract class BaseCaprovee extends BaseObject  implements Persistent {
	...
	protected $collCaevadespros;

	
	protected $lastCaevadesproCriteria = null;
  ...
  public function getEstapo()
  {

    return trim($this->estapo);
  ...
  public function getId()
  {
	...
	public function setEstapo($v)
	{

    if ($this->estapo !== $v) {
        $this->estapo = $v;
        $this->modifiedColumns[] = CaproveePeer::ESTAPO;
      }
    ...
    if ($this->clapro !== $v) {
        $this->clapro = $v;
        $this->modifiedColumns[] = CaproveePeer::CLAPRO;
      }
    ...
    if ($this->fecact !== $ts) {
      $this->fecact = $ts;
      $this->modifiedColumns[] = CaproveePeer::FECACT;
    }
    ...
    if ($this->codniv !== $v) {
        $this->codniv = $v;
        $this->modifiedColumns[] = CaproveePeer::CODNIV;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->estapo = $rs->getString($startcol + 46);

      $this->clapro = $rs->getString($startcol + 47);

      $this->fecact = $rs->getDate($startcol + 48, null);

      $this->codniv = $rs->getString($startcol + 49);
  ...
  public function get($m, $a)
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			...
			if ($this->collCaevadespros !== null) {
				foreach($this->collCaevadespros as $referrerFK) {
					if (!$referrerFK->isDeleted()) {
						$affectedRows += $referrerFK->save($con);
					}
				}
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		$result = array(
			...
			$keys[46] => $this->getEstapo(),
			$keys[47] => $this->getClapro(),
			$keys[48] => $this->getFecact(),
			$keys[49] => $this->getCodniv(),
			$keys[50] => $this->getId(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[46], $arr)) $this->setEstapo($arr[$keys[46]]);
		if (array_key_exists($keys[47], $arr)) $this->setClapro($arr[$keys[47]]);
		if (array_key_exists($keys[48], $arr)) $this->setFecact($arr[$keys[48]]);
		if (array_key_exists($keys[49], $arr)) $this->setCodniv($arr[$keys[49]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CaproveePeer::ESTAPO)) $criteria->add(CaproveePeer::ESTAPO, $this->estapo);
		if ($this->isColumnModified(CaproveePeer::CLAPRO)) $criteria->add(CaproveePeer::CLAPRO, $this->clapro);
		if ($this->isColumnModified(CaproveePeer::FECACT)) $criteria->add(CaproveePeer::FECACT, $this->fecact);
		if ($this->isColumnModified(CaproveePeer::CODNIV)) $criteria->add(CaproveePeer::CODNIV, $this->codniv);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		if ($deepCopy) {
			...
			foreach($this->getCaevadespros() as $relObj) {
				$copyObj->addCaevadespro($relObj->copy($deepCopy));
			}
	...
	{
				include_once 'lib/model/compras/om/BaseCarecproPeer.php';
		if ($criteria === null) {
	...
	{
				include_once 'lib/model/compras/om/BaseCaordcomPeer.php';
		if ($criteria === null) {
			$criteria = new Criteria();
		}
		elseif ($criteria instanceof Criteria)
	...
	public function getCaordcomsJoinTsdefmon($criteria = null, $con = null)
	{
				include_once 'lib/model/compras/om/BaseCaordcomPeer.php';
		if ($criteria === null) {
			$criteria = new Criteria();
		...
		if ($this->collCaordcoms === null) {
			if ($this->isNew()) {
				...
				$this->collCaordcoms = CaordcomPeer::doSelectJoinTsdefmon($criteria, $con);
			}
		} else {
	...
	{
				include_once 'lib/model/compras/om/BaseCacotizaPeer.php';
		if ($criteria === null) {
			$criteria = new Criteria();
		}
		elseif ($criteria instanceof Criteria)
	...
	public function getCacotizasJoinTsdefmon($criteria = null, $con = null)
	{
				include_once 'lib/model/compras/om/BaseCacotizaPeer.php';
		if ($criteria === null) {
			$criteria = new Criteria();
		...
		if ($this->collCacotizas === null) {
			if ($this->isNew()) {
				...
				$this->collCacotizas = CacotizaPeer::doSelectJoinTsdefmon($criteria, $con);
			}
		} else {
		...
		if ($this->collCadetpdas === null) {
			if ($this->isNew()) {
			   $this->collCadetpdas = array();
				...
				$criteria->add(CadetpdaPeer::CODPRO, $this->getCodpro());
	...
	public function getCadetpdasJoinCatipalm($criteria = null, $con = null)
	{
				include_once 'lib/model/compras/om/BaseCadetpdaPeer.php';
		if ($criteria === null) {
			$criteria = new Criteria();
		...
		if ($this->collCadetpdas === null) {
			if ($this->isNew()) {
				...
				$this->collCadetpdas = CadetpdaPeer::doSelectJoinCatipalm($criteria, $con);
			}
		} else {
	...
	public function initCaevadespros()
	{
		if ($this->collCaevadespros === null) {
			$this->collCaevadespros = array();
		}
	}

	
	public function getCaevadespros($criteria = null, $con = null)
	{
				include_once 'lib/model/compras/om/BaseCaevadesproPeer.php';
		if ($criteria === null) {
			$criteria = new Criteria();
		}
		elseif ($criteria instanceof Criteria)
		...
		if ($this->collCaevadespros === null) {
			if ($this->isNew()) {
			   $this->collCaevadespros = array();
				...
				$criteria->add(CaevadesproPeer::CODPRO, $this->getCodpro());

				CaevadesproPeer::addSelectColumns($criteria);
				$this->collCaevadespros = CaevadesproPeer::doSelect($criteria, $con);
			}
		} else {
						if (!$this->isNew()) {
				...
				CaevadesproPeer::addSelectColumns($criteria);
				if (!isset($this->lastCaevadesproCriteria) || !$this->lastCaevadesproCriteria->equals($criteria)) {
					$this->collCaevadespros = CaevadesproPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastCaevadesproCriteria = $criteria;
		return $this->collCaevadespros;
	}

	
	public function countCaevadespros($criteria = null, $distinct = false, $con = null)
	{
				include_once 'lib/model/compras/om/BaseCaevadesproPeer.php';
		if ($criteria === null) {
			$criteria = new Criteria();
		...
		return CaevadesproPeer::doCount($criteria, $distinct, $con);
	}

	
	public function addCaevadespro(Caevadespro $l)
	{
		$this->collCaevadespros[] = $l;
		$l->setCaprovee($this);
	}

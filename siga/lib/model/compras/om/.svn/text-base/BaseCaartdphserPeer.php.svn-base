...
abstract class BaseCaartdphserPeer {
	...
	const CLASS_DEFAULT = 'lib.model.compras.Caartdphser';
	...
	{
		include_once 'lib/model/compras/map/CaartdphserMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.compras.map.CaartdphserMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/compras/map/CaartdphserMapBuilder.php';
	Propel::registerMapBuilder('lib.model.compras.map.CaartdphserMapBuilder');
}

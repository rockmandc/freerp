...
abstract class BaseCaartsol extends BaseObject  implements Persistent {
  ...
  public function getDettec()
  {

    return trim($this->dettec);
  ...
  public function getId()
  {
    ...
    if ($this->codcen !== $v) {
        $this->codcen = $v;
        $this->modifiedColumns[] = CaartsolPeer::CODCEN;
      }
    ...
    if ($this->codunimed !== $v) {
        $this->codunimed = $v;
        $this->modifiedColumns[] = CaartsolPeer::CODUNIMED;
      }
    ...
    if ($this->observ !== $v) {
        $this->observ = $v;
        $this->modifiedColumns[] = CaartsolPeer::OBSERV;
      }
  
	} 
	
	public function setDettec($v)
	{

    if ($this->dettec !== $v) {
        $this->dettec = $v;
        $this->modifiedColumns[] = CaartsolPeer::DETTEC;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->codcen = $rs->getString($startcol + 14);

      $this->codunimed = $rs->getString($startcol + 15);

      $this->observ = $rs->getString($startcol + 16);

      $this->dettec = $rs->getString($startcol + 17);
  ...
  public function get($m, $a)
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		$result = array(
			...
			$keys[14] => $this->getCodcen(),
			$keys[15] => $this->getCodunimed(),
			$keys[16] => $this->getObserv(),
			$keys[17] => $this->getDettec(),
			$keys[18] => $this->getId(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[14], $arr)) $this->setCodcen($arr[$keys[14]]);
		if (array_key_exists($keys[15], $arr)) $this->setCodunimed($arr[$keys[15]]);
		if (array_key_exists($keys[16], $arr)) $this->setObserv($arr[$keys[16]]);
		if (array_key_exists($keys[17], $arr)) $this->setDettec($arr[$keys[17]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CaartsolPeer::CODCEN)) $criteria->add(CaartsolPeer::CODCEN, $this->codcen);
		if ($this->isColumnModified(CaartsolPeer::CODUNIMED)) $criteria->add(CaartsolPeer::CODUNIMED, $this->codunimed);
		if ($this->isColumnModified(CaartsolPeer::OBSERV)) $criteria->add(CaartsolPeer::OBSERV, $this->observ);
		if ($this->isColumnModified(CaartsolPeer::DETTEC)) $criteria->add(CaartsolPeer::DETTEC, $this->dettec);

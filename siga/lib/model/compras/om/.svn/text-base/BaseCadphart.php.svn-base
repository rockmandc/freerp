...
abstract class BaseCadphart extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->codalmusu !== $v) {
        $this->codalmusu = $v;
        $this->modifiedColumns[] = CadphartPeer::CODALMUSU;
      }
    ...
    if ($this->created_at !== $ts) {
      $this->created_at = $ts;
      $this->modifiedColumns[] = CadphartPeer::CREATED_AT;
    }
    ...
    if ($this->updated_at !== $ts) {
      $this->updated_at = $ts;
      $this->modifiedColumns[] = CadphartPeer::UPDATED_AT;
    }
    ...
    if ($this->created_by_user !== $v) {
        ...
        $this->modifiedColumns[] = CadphartPeer::CREATED_BY_USER;
      }
    ...
    if ($this->updated_by_user !== $v) {
        ...
        $this->modifiedColumns[] = CadphartPeer::UPDATED_BY_USER;
      }
    ...
    if ($this->fecdes !== $ts) {
      $this->fecdes = $ts;
      $this->modifiedColumns[] = CadphartPeer::FECDES;
    }
    ...
    if ($this->fechas !== $ts) {
      $this->fechas = $ts;
      $this->modifiedColumns[] = CadphartPeer::FECHAS;
    }
    ...
    if ($this->codedo !== $v) {
        $this->codedo = $v;
        $this->modifiedColumns[] = CadphartPeer::CODEDO;
      }
    ...
    if ($this->codciu !== $v) {
        $this->codciu = $v;
        $this->modifiedColumns[] = CadphartPeer::CODCIU;
      }
    ...
    if ($this->codmun !== $v) {
        $this->codmun = $v;
        $this->modifiedColumns[] = CadphartPeer::CODMUN;
      }
    ...
    if ($this->codpar !== $v) {
        $this->codpar = $v;
        $this->modifiedColumns[] = CadphartPeer::CODPAR;
      }
    ...
    if ($this->codinst !== $v) {
        $this->codinst = $v;
        $this->modifiedColumns[] = CadphartPeer::CODINST;
      }
    ...
    if ($this->codprg !== $v) {
        $this->codprg = $v;
        $this->modifiedColumns[] = CadphartPeer::CODPRG;
      }
    ...
    if ($this->stadev !== $v) {
        $this->stadev = $v;
        $this->modifiedColumns[] = CadphartPeer::STADEV;
      }
    ...
    if ($this->codpro !== $v) {
        $this->codpro = $v;
        $this->modifiedColumns[] = CadphartPeer::CODPRO;
      }
    ...
    if ($this->coddirec !== $v) {
        $this->coddirec = $v;
        $this->modifiedColumns[] = CadphartPeer::CODDIREC;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->codalmusu = $rs->getString($startcol + 39);

      $this->created_at = $rs->getTimestamp($startcol + 40, null);

      $this->updated_at = $rs->getTimestamp($startcol + 41, null);

      $this->created_by_user = $rs->getString($startcol + 42);

      $this->updated_by_user = $rs->getString($startcol + 43);

      $this->fecdes = $rs->getDate($startcol + 44, null);

      $this->fechas = $rs->getDate($startcol + 45, null);

      $this->codedo = $rs->getString($startcol + 46);

      $this->codciu = $rs->getString($startcol + 47);

      $this->codmun = $rs->getString($startcol + 48);

      $this->codpar = $rs->getString($startcol + 49);

      $this->codinst = $rs->getString($startcol + 50);

      $this->codprg = $rs->getString($startcol + 51);

      $this->stadev = $rs->getString($startcol + 52);

      $this->codpro = $rs->getString($startcol + 53);

      $this->coddirec = $rs->getString($startcol + 54);
  ...
  public function get($m, $a)
	...
	{
    if ($this->isNew() && !$this->isColumnModified(CadphartPeer::CREATED_AT))
    {
      $this->setCreatedAt(time());
    }

    if ($this->isModified() && !$this->isColumnModified(CadphartPeer::UPDATED_AT))
    {
      $this->setUpdatedAt(time());
    }

    if ($this->isNew() && !$this->isColumnModified(CadphartPeer::CREATED_BY_USER))
    {
      $this->setCreatedByUser(sfContext::getInstance()->getUser()->getAttribute('loguse','Sin Usuario'));
    }

    if ($this->isModified() && !$this->isColumnModified(CadphartPeer::UPDATED_BY_USER))
    {
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		$result = array(
			...
			$keys[39] => $this->getCodalmusu(),
			$keys[40] => $this->getCreatedAt(),
			$keys[41] => $this->getUpdatedAt(),
			$keys[42] => $this->getCreatedByUser(),
			$keys[43] => $this->getUpdatedByUser(),
			$keys[44] => $this->getFecdes(),
			$keys[45] => $this->getFechas(),
			$keys[46] => $this->getCodedo(),
			$keys[47] => $this->getCodciu(),
			$keys[48] => $this->getCodmun(),
			$keys[49] => $this->getCodpar(),
			$keys[50] => $this->getCodinst(),
			$keys[51] => $this->getCodprg(),
			$keys[52] => $this->getStadev(),
			$keys[53] => $this->getCodpro(),
			$keys[54] => $this->getCoddirec(),
			$keys[55] => $this->getId(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[39], $arr)) $this->setCodalmusu($arr[$keys[39]]);
		...
		if (array_key_exists($keys[42], $arr)) $this->setCreatedByUser($arr[$keys[42]]);
		if (array_key_exists($keys[43], $arr)) $this->setUpdatedByUser($arr[$keys[43]]);
		if (array_key_exists($keys[44], $arr)) $this->setFecdes($arr[$keys[44]]);
		if (array_key_exists($keys[45], $arr)) $this->setFechas($arr[$keys[45]]);
		if (array_key_exists($keys[46], $arr)) $this->setCodedo($arr[$keys[46]]);
		if (array_key_exists($keys[47], $arr)) $this->setCodciu($arr[$keys[47]]);
		if (array_key_exists($keys[48], $arr)) $this->setCodmun($arr[$keys[48]]);
		if (array_key_exists($keys[49], $arr)) $this->setCodpar($arr[$keys[49]]);
		if (array_key_exists($keys[50], $arr)) $this->setCodinst($arr[$keys[50]]);
		if (array_key_exists($keys[51], $arr)) $this->setCodprg($arr[$keys[51]]);
		if (array_key_exists($keys[52], $arr)) $this->setStadev($arr[$keys[52]]);
		if (array_key_exists($keys[53], $arr)) $this->setCodpro($arr[$keys[53]]);
		if (array_key_exists($keys[54], $arr)) $this->setCoddirec($arr[$keys[54]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CadphartPeer::CODALMUSU)) $criteria->add(CadphartPeer::CODALMUSU, $this->codalmusu);
		if ($this->isColumnModified(CadphartPeer::CREATED_AT)) $criteria->add(CadphartPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(CadphartPeer::UPDATED_AT)) $criteria->add(CadphartPeer::UPDATED_AT, $this->updated_at);
		if ($this->isColumnModified(CadphartPeer::CREATED_BY_USER)) $criteria->add(CadphartPeer::CREATED_BY_USER, $this->created_by_user);
		if ($this->isColumnModified(CadphartPeer::UPDATED_BY_USER)) $criteria->add(CadphartPeer::UPDATED_BY_USER, $this->updated_by_user);
		if ($this->isColumnModified(CadphartPeer::FECDES)) $criteria->add(CadphartPeer::FECDES, $this->fecdes);
		if ($this->isColumnModified(CadphartPeer::FECHAS)) $criteria->add(CadphartPeer::FECHAS, $this->fechas);
		if ($this->isColumnModified(CadphartPeer::CODEDO)) $criteria->add(CadphartPeer::CODEDO, $this->codedo);
		if ($this->isColumnModified(CadphartPeer::CODCIU)) $criteria->add(CadphartPeer::CODCIU, $this->codciu);
		if ($this->isColumnModified(CadphartPeer::CODMUN)) $criteria->add(CadphartPeer::CODMUN, $this->codmun);
		if ($this->isColumnModified(CadphartPeer::CODPAR)) $criteria->add(CadphartPeer::CODPAR, $this->codpar);
		if ($this->isColumnModified(CadphartPeer::CODINST)) $criteria->add(CadphartPeer::CODINST, $this->codinst);
		if ($this->isColumnModified(CadphartPeer::CODPRG)) $criteria->add(CadphartPeer::CODPRG, $this->codprg);
		if ($this->isColumnModified(CadphartPeer::STADEV)) $criteria->add(CadphartPeer::STADEV, $this->stadev);
		if ($this->isColumnModified(CadphartPeer::CODPRO)) $criteria->add(CadphartPeer::CODPRO, $this->codpro);
		if ($this->isColumnModified(CadphartPeer::CODDIREC)) $criteria->add(CadphartPeer::CODDIREC, $this->coddirec);

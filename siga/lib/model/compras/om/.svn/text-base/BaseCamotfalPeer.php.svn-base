...
abstract class BaseCamotfalPeer {
	...
	const CLASS_DEFAULT = 'lib.model.compras.Camotfal';
	...
	{
		include_once 'lib/model/compras/map/CamotfalMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.compras.map.CamotfalMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/compras/map/CamotfalMapBuilder.php';
	Propel::registerMapBuilder('lib.model.compras.map.CamotfalMapBuilder');
}

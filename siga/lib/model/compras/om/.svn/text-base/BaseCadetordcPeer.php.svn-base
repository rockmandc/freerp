...
abstract class BaseCadetordcPeer {
	...
	const CLASS_DEFAULT = 'lib.model.compras.Cadetordc';
	...
	{
		include_once 'lib/model/compras/map/CadetordcMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.compras.map.CadetordcMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/compras/map/CadetordcMapBuilder.php';
	Propel::registerMapBuilder('lib.model.compras.map.CadetordcMapBuilder');
}

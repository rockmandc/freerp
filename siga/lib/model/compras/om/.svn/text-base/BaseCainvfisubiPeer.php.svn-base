...
abstract class BaseCainvfisubiPeer {
	...
	const CLASS_DEFAULT = 'lib.model.compras.Cainvfisubi';
	...
	{
		include_once 'lib/model/compras/map/CainvfisubiMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.compras.map.CainvfisubiMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/compras/map/CainvfisubiMapBuilder.php';
	Propel::registerMapBuilder('lib.model.compras.map.CainvfisubiMapBuilder');
}

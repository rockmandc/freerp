...
abstract class BaseCaartreq extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->codalm !== $v) {
        $this->codalm = $v;
        $this->modifiedColumns[] = CaartreqPeer::CODALM;
      }
    ...
    if ($this->codubi !== $v) {
        $this->codubi = $v;
        $this->modifiedColumns[] = CaartreqPeer::CODUBI;
      }
  ...
  public function get($m, $a)
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CaartreqPeer::CODALM)) $criteria->add(CaartreqPeer::CODALM, $this->codalm);
		if ($this->isColumnModified(CaartreqPeer::CODUBI)) $criteria->add(CaartreqPeer::CODUBI, $this->codubi);

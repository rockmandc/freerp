...
abstract class BaseCatipproPeer {
	...
	const CLASS_DEFAULT = 'lib.model.compras.Catippro';
	...
	{
		include_once 'lib/model/compras/map/CatipproMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.compras.map.CatipproMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/compras/map/CatipproMapBuilder.php';
	Propel::registerMapBuilder('lib.model.compras.map.CatipproMapBuilder');
}

...
abstract class BaseCacotdisrgoPeer {
	...
	const CLASS_DEFAULT = 'lib.model.compras.Cacotdisrgo';
	...
	{
		include_once 'lib/model/compras/map/CacotdisrgoMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.compras.map.CacotdisrgoMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/compras/map/CacotdisrgoMapBuilder.php';
	Propel::registerMapBuilder('lib.model.compras.map.CacotdisrgoMapBuilder');
}

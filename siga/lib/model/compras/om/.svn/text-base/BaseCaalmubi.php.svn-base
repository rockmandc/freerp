...
abstract class BaseCaalmubi extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->tipreg !== $v) {
        $this->tipreg = $v;
        $this->modifiedColumns[] = CaalmubiPeer::TIPREG;
      }
  ...
  public function get($m, $a)
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CaalmubiPeer::TIPREG)) $criteria->add(CaalmubiPeer::TIPREG, $this->tipreg);
	...
	public function getCadefubi($con = null)
	{
		if ($this->aCadefubi === null && (($this->codubi !== "" && $this->codubi !== null))) {
						include_once 'lib/model/compras/om/BaseCadefubiPeer.php';

...
abstract class BaseCaordcomPeer {
	...
	const CLASS_DEFAULT = 'lib.model.compras.Caordcom';
	...
	const TIPOCOM = 'caordcom.TIPOCOM';

	
	const CEDDON = 'caordcom.CEDDON';

	
	const NOMDON = 'caordcom.NOMDON';

	
	const FECDON = 'caordcom.FECDON';

	
	const SEXDON = 'caordcom.SEXDON';

	
	const EDADON = 'caordcom.EDADON';

	
	const SERDON = 'caordcom.SERDON';

	
	const MOTANU = 'caordcom.MOTANU';

	
	const USUANU = 'caordcom.USUANU';

	
	const CODCENACO = 'caordcom.CODCENACO';

	
	const NUMPROC = 'caordcom.NUMPROC';

	
	const USUROC = 'caordcom.USUROC';

	
	const FECREC = 'caordcom.FECREC';

	
	const ENVIAD = 'caordcom.ENVIAD';

	
	const FECENV = 'caordcom.FECENV';

	
	const STAPDA = 'caordcom.STAPDA';

	
	const NUMCON = 'caordcom.NUMCON';

	
	const CODDIREC = 'caordcom.CODDIREC';

	
	const CODDIVI = 'caordcom.CODDIVI';

	
	const CODEVE = 'caordcom.CODEVE';

	
	const LUGFEC = 'caordcom.LUGFEC';

	
	const DIRENT = 'caordcom.DIRENT';

	
	const NUMPRO = 'caordcom.NUMPRO';

	
	const STAVER = 'caordcom.STAVER';

	
	const PERCON = 'caordcom.PERCON';

	
	const TELCON = 'caordcom.TELCON';

	
	const FAXCON = 'caordcom.FAXCON';

	
	const EMACON = 'caordcom.EMACON';

	
	const CODGAR = 'caordcom.CODGAR';

	
	const USUAPR = 'caordcom.USUAPR';

	
	const FECAPR = 'caordcom.FECAPR';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Ordcom', 'Fecord', 'Codpro', 'Desord', 'Crecon', 'Plaent', 'Tiecan', 'Monord', 'Dtoord', 'Refcom', 'Staord', 'Afepre', 'Conpag', 'Forent', 'Fecanu', 'Tipmon', 'Valmon', 'Tipcom', 'Tipord', 'Tipo', 'Coduni', 'Codemp', 'Notord', 'Tipdoc', 'Tippro', 'Afepro', 'Doccom', 'Refsol', 'Tipfin', 'Justif', 'Refprc', 'Codmedcom', 'Codprocom', 'Codpai', 'Codedo', 'Codmun', 'Aplart', 'Aplart6', 'Numsigecof', 'Fecsigecof', 'Expsigecof', 'Codcen', 'Tipocom', 'Ceddon', 'Nomdon', 'Fecdon', 'Sexdon', 'Edadon', 'Serdon', 'Motanu', 'Usuanu', 'Codcenaco', 'Numproc', 'Usuroc', 'Fecrec', 'Enviad', 'Fecenv', 'Stapda', 'Numcon', 'Coddirec', 'Coddivi', 'Codeve', 'Lugfec', 'Dirent', 'Numpro', 'Staver', 'Percon', 'Telcon', 'Faxcon', 'Emacon', 'Codgar', 'Usuapr', 'Fecapr', 'Id', ),
		BasePeer::TYPE_COLNAME => array (CaordcomPeer::ORDCOM, CaordcomPeer::FECORD, CaordcomPeer::CODPRO, CaordcomPeer::DESORD, CaordcomPeer::CRECON, CaordcomPeer::PLAENT, CaordcomPeer::TIECAN, CaordcomPeer::MONORD, CaordcomPeer::DTOORD, CaordcomPeer::REFCOM, CaordcomPeer::STAORD, CaordcomPeer::AFEPRE, CaordcomPeer::CONPAG, CaordcomPeer::FORENT, CaordcomPeer::FECANU, CaordcomPeer::TIPMON, CaordcomPeer::VALMON, CaordcomPeer::TIPCOM, CaordcomPeer::TIPORD, CaordcomPeer::TIPO, CaordcomPeer::CODUNI, CaordcomPeer::CODEMP, CaordcomPeer::NOTORD, CaordcomPeer::TIPDOC, CaordcomPeer::TIPPRO, CaordcomPeer::AFEPRO, CaordcomPeer::DOCCOM, CaordcomPeer::REFSOL, CaordcomPeer::TIPFIN, CaordcomPeer::JUSTIF, CaordcomPeer::REFPRC, CaordcomPeer::CODMEDCOM, CaordcomPeer::CODPROCOM, CaordcomPeer::CODPAI, CaordcomPeer::CODEDO, CaordcomPeer::CODMUN, CaordcomPeer::APLART, CaordcomPeer::APLART6, CaordcomPeer::NUMSIGECOF, CaordcomPeer::FECSIGECOF, CaordcomPeer::EXPSIGECOF, CaordcomPeer::CODCEN, CaordcomPeer::TIPOCOM, CaordcomPeer::CEDDON, CaordcomPeer::NOMDON, CaordcomPeer::FECDON, CaordcomPeer::SEXDON, CaordcomPeer::EDADON, CaordcomPeer::SERDON, CaordcomPeer::MOTANU, CaordcomPeer::USUANU, CaordcomPeer::CODCENACO, CaordcomPeer::NUMPROC, CaordcomPeer::USUROC, CaordcomPeer::FECREC, CaordcomPeer::ENVIAD, CaordcomPeer::FECENV, CaordcomPeer::STAPDA, CaordcomPeer::NUMCON, CaordcomPeer::CODDIREC, CaordcomPeer::CODDIVI, CaordcomPeer::CODEVE, CaordcomPeer::LUGFEC, CaordcomPeer::DIRENT, CaordcomPeer::NUMPRO, CaordcomPeer::STAVER, CaordcomPeer::PERCON, CaordcomPeer::TELCON, CaordcomPeer::FAXCON, CaordcomPeer::EMACON, CaordcomPeer::CODGAR, CaordcomPeer::USUAPR, CaordcomPeer::FECAPR, CaordcomPeer::ID, ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Ordcom' => 0, 'Fecord' => 1, 'Codpro' => 2, 'Desord' => 3, 'Crecon' => 4, 'Plaent' => 5, 'Tiecan' => 6, 'Monord' => 7, 'Dtoord' => 8, 'Refcom' => 9, 'Staord' => 10, 'Afepre' => 11, 'Conpag' => 12, 'Forent' => 13, 'Fecanu' => 14, 'Tipmon' => 15, 'Valmon' => 16, 'Tipcom' => 17, 'Tipord' => 18, 'Tipo' => 19, 'Coduni' => 20, 'Codemp' => 21, 'Notord' => 22, 'Tipdoc' => 23, 'Tippro' => 24, 'Afepro' => 25, 'Doccom' => 26, 'Refsol' => 27, 'Tipfin' => 28, 'Justif' => 29, 'Refprc' => 30, 'Codmedcom' => 31, 'Codprocom' => 32, 'Codpai' => 33, 'Codedo' => 34, 'Codmun' => 35, 'Aplart' => 36, 'Aplart6' => 37, 'Numsigecof' => 38, 'Fecsigecof' => 39, 'Expsigecof' => 40, 'Codcen' => 41, 'Tipocom' => 42, 'Ceddon' => 43, 'Nomdon' => 44, 'Fecdon' => 45, 'Sexdon' => 46, 'Edadon' => 47, 'Serdon' => 48, 'Motanu' => 49, 'Usuanu' => 50, 'Codcenaco' => 51, 'Numproc' => 52, 'Usuroc' => 53, 'Fecrec' => 54, 'Enviad' => 55, 'Fecenv' => 56, 'Stapda' => 57, 'Numcon' => 58, 'Coddirec' => 59, 'Coddivi' => 60, 'Codeve' => 61, 'Lugfec' => 62, 'Dirent' => 63, 'Numpro' => 64, 'Staver' => 65, 'Percon' => 66, 'Telcon' => 67, 'Faxcon' => 68, 'Emacon' => 69, 'Codgar' => 70, 'Usuapr' => 71, 'Fecapr' => 72, 'Id' => 73, ),
		BasePeer::TYPE_COLNAME => array (CaordcomPeer::ORDCOM => 0, CaordcomPeer::FECORD => 1, CaordcomPeer::CODPRO => 2, CaordcomPeer::DESORD => 3, CaordcomPeer::CRECON => 4, CaordcomPeer::PLAENT => 5, CaordcomPeer::TIECAN => 6, CaordcomPeer::MONORD => 7, CaordcomPeer::DTOORD => 8, CaordcomPeer::REFCOM => 9, CaordcomPeer::STAORD => 10, CaordcomPeer::AFEPRE => 11, CaordcomPeer::CONPAG => 12, CaordcomPeer::FORENT => 13, CaordcomPeer::FECANU => 14, CaordcomPeer::TIPMON => 15, CaordcomPeer::VALMON => 16, CaordcomPeer::TIPCOM => 17, CaordcomPeer::TIPORD => 18, CaordcomPeer::TIPO => 19, CaordcomPeer::CODUNI => 20, CaordcomPeer::CODEMP => 21, CaordcomPeer::NOTORD => 22, CaordcomPeer::TIPDOC => 23, CaordcomPeer::TIPPRO => 24, CaordcomPeer::AFEPRO => 25, CaordcomPeer::DOCCOM => 26, CaordcomPeer::REFSOL => 27, CaordcomPeer::TIPFIN => 28, CaordcomPeer::JUSTIF => 29, CaordcomPeer::REFPRC => 30, CaordcomPeer::CODMEDCOM => 31, CaordcomPeer::CODPROCOM => 32, CaordcomPeer::CODPAI => 33, CaordcomPeer::CODEDO => 34, CaordcomPeer::CODMUN => 35, CaordcomPeer::APLART => 36, CaordcomPeer::APLART6 => 37, CaordcomPeer::NUMSIGECOF => 38, CaordcomPeer::FECSIGECOF => 39, CaordcomPeer::EXPSIGECOF => 40, CaordcomPeer::CODCEN => 41, CaordcomPeer::TIPOCOM => 42, CaordcomPeer::CEDDON => 43, CaordcomPeer::NOMDON => 44, CaordcomPeer::FECDON => 45, CaordcomPeer::SEXDON => 46, CaordcomPeer::EDADON => 47, CaordcomPeer::SERDON => 48, CaordcomPeer::MOTANU => 49, CaordcomPeer::USUANU => 50, CaordcomPeer::CODCENACO => 51, CaordcomPeer::NUMPROC => 52, CaordcomPeer::USUROC => 53, CaordcomPeer::FECREC => 54, CaordcomPeer::ENVIAD => 55, CaordcomPeer::FECENV => 56, CaordcomPeer::STAPDA => 57, CaordcomPeer::NUMCON => 58, CaordcomPeer::CODDIREC => 59, CaordcomPeer::CODDIVI => 60, CaordcomPeer::CODEVE => 61, CaordcomPeer::LUGFEC => 62, CaordcomPeer::DIRENT => 63, CaordcomPeer::NUMPRO => 64, CaordcomPeer::STAVER => 65, CaordcomPeer::PERCON => 66, CaordcomPeer::TELCON => 67, CaordcomPeer::FAXCON => 68, CaordcomPeer::EMACON => 69, CaordcomPeer::CODGAR => 70, CaordcomPeer::USUAPR => 71, CaordcomPeer::FECAPR => 72, CaordcomPeer::ID => 73, ),
	...
	{
		include_once 'lib/model/compras/map/CaordcomMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.compras.map.CaordcomMapBuilder');
	}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(CaordcomPeer::TIPOCOM);

		$criteria->addSelectColumn(CaordcomPeer::CEDDON);

		$criteria->addSelectColumn(CaordcomPeer::NOMDON);

		$criteria->addSelectColumn(CaordcomPeer::FECDON);

		$criteria->addSelectColumn(CaordcomPeer::SEXDON);

		$criteria->addSelectColumn(CaordcomPeer::EDADON);

		$criteria->addSelectColumn(CaordcomPeer::SERDON);

		$criteria->addSelectColumn(CaordcomPeer::MOTANU);

		$criteria->addSelectColumn(CaordcomPeer::USUANU);

		$criteria->addSelectColumn(CaordcomPeer::CODCENACO);

		$criteria->addSelectColumn(CaordcomPeer::NUMPROC);

		$criteria->addSelectColumn(CaordcomPeer::USUROC);

		$criteria->addSelectColumn(CaordcomPeer::FECREC);

		$criteria->addSelectColumn(CaordcomPeer::ENVIAD);

		$criteria->addSelectColumn(CaordcomPeer::FECENV);

		$criteria->addSelectColumn(CaordcomPeer::STAPDA);

		$criteria->addSelectColumn(CaordcomPeer::NUMCON);

		$criteria->addSelectColumn(CaordcomPeer::CODDIREC);

		$criteria->addSelectColumn(CaordcomPeer::CODDIVI);

		$criteria->addSelectColumn(CaordcomPeer::CODEVE);

		$criteria->addSelectColumn(CaordcomPeer::LUGFEC);

		$criteria->addSelectColumn(CaordcomPeer::DIRENT);

		$criteria->addSelectColumn(CaordcomPeer::NUMPRO);

		$criteria->addSelectColumn(CaordcomPeer::STAVER);

		$criteria->addSelectColumn(CaordcomPeer::PERCON);

		$criteria->addSelectColumn(CaordcomPeer::TELCON);

		$criteria->addSelectColumn(CaordcomPeer::FAXCON);

		$criteria->addSelectColumn(CaordcomPeer::EMACON);

		$criteria->addSelectColumn(CaordcomPeer::CODGAR);

		$criteria->addSelectColumn(CaordcomPeer::USUAPR);

		$criteria->addSelectColumn(CaordcomPeer::FECAPR);
	...
	public static function doCountJoinTsdefmon(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(CaordcomPeer::TIPMON, TsdefmonPeer::CODMON);
	...
	public static function doSelectJoinTsdefmon(Criteria $c, $con = null)
	{
		...
		$c->addJoin(CaordcomPeer::TIPMON, TsdefmonPeer::CODMON);
		$rs = BasePeer::doSelect($c, $con);
		$results = array();
	...
	public static function doSelectJoinAll(Criteria $c, $con = null)
	{
		...
		$startcol2 = (CaordcomPeer::NUM_COLUMNS - CaordcomPeer::NUM_LAZY_LOAD_COLUMNS) + 1;
			...
			TsdefmonPeer::addSelectColumns($c);
			$startcol6 = $startcol5 + TsdefmonPeer::NUM_COLUMNS;
		...
		while($rs->next()) {
			...
			$obj1->hydrate($rs);
				...
				for ($j=0, $resCount=count($results); $j < $resCount; $j++) {
					$temp_obj1 = $results[$j];
					$temp_obj5 = $temp_obj1->getTsdefmon(); 					if ($temp_obj5->getPrimaryKey() === $obj5->getPrimaryKey()) {
						$newObject = false;
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/compras/map/CaordcomMapBuilder.php';
	Propel::registerMapBuilder('lib.model.compras.map.CaordcomMapBuilder');
}

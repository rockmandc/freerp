...
abstract class BaseCamigtxtven extends BaseObject  implements Persistent {
  ...
  public function getMd5arch()
  {

    return trim($this->md5arch);
  ...
  public function getId()
  {
	...
	public function setMd5arch($v)
	{

    if ($this->md5arch !== $v) {
        $this->md5arch = $v;
        $this->modifiedColumns[] = CamigtxtvenPeer::MD5ARCH;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->md5arch = $rs->getString($startcol + 10);
  ...
  public function get($m, $a)
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[10], $arr)) $this->setMd5arch($arr[$keys[10]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CamigtxtvenPeer::MD5ARCH)) $criteria->add(CamigtxtvenPeer::MD5ARCH, $this->md5arch);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setMd5arch($this->md5arch);

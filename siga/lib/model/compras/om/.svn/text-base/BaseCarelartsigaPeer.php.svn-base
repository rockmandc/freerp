...
abstract class BaseCarelartsigaPeer {
	...
	const CLASS_DEFAULT = 'lib.model.compras.Carelartsiga';
	...
	{
		include_once 'lib/model/compras/map/CarelartsigaMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.compras.map.CarelartsigaMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/compras/map/CarelartsigaMapBuilder.php';
	Propel::registerMapBuilder('lib.model.compras.map.CarelartsigaMapBuilder');
}

...
abstract class BaseCaramartPeer {
	...
	const CLASS_DEFAULT = 'lib.model.compras.Caramart';
	...
	{
		include_once 'lib/model/compras/map/CaramartMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.compras.map.CaramartMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/compras/map/CaramartMapBuilder.php';
	Propel::registerMapBuilder('lib.model.compras.map.CaramartMapBuilder');
}

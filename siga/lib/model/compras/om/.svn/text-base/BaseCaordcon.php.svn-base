...
abstract class BaseCaordcon extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->refcom !== $v) {
        $this->refcom = $v;
        $this->modifiedColumns[] = CaordconPeer::REFCOM;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->refcom = $rs->getString($startcol + 27);
  ...
  public function get($m, $a)
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[27], $arr)) $this->setRefcom($arr[$keys[27]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CaordconPeer::REFCOM)) $criteria->add(CaordconPeer::REFCOM, $this->refcom);

...
abstract class BaseCaprocomartPeer {
	...
	const CLASS_DEFAULT = 'lib.model.compras.Caprocomart';
	...
	{
		include_once 'lib/model/compras/map/CaprocomartMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.compras.map.CaprocomartMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/compras/map/CaprocomartMapBuilder.php';
	Propel::registerMapBuilder('lib.model.compras.map.CaprocomartMapBuilder');
}

...
abstract class BaseCaconpagPeer {
	...
	const CLASS_DEFAULT = 'lib.model.compras.Caconpag';
	...
	{
		include_once 'lib/model/compras/map/CaconpagMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.compras.map.CaconpagMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/compras/map/CaconpagMapBuilder.php';
	Propel::registerMapBuilder('lib.model.compras.map.CaconpagMapBuilder');
}

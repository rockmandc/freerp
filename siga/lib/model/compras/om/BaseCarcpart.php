...
abstract class BaseCarcpart extends BaseObject  implements Persistent {
  ...
  public function getUpdatedByUser()
  {
    ...
    if ($this->coddirec !== $v) {
        $this->coddirec = $v;
        $this->modifiedColumns[] = CarcpartPeer::CODDIREC;
      }
    ...
    if ($this->codalmusu !== $v) {
        $this->codalmusu = $v;
        $this->modifiedColumns[] = CarcpartPeer::CODALMUSU;
      }
    ...
    if ($this->created_at !== $ts) {
      $this->created_at = $ts;
      $this->modifiedColumns[] = CarcpartPeer::CREATED_AT;
    }
    ...
    if ($this->updated_at !== $ts) {
      $this->updated_at = $ts;
      $this->modifiedColumns[] = CarcpartPeer::UPDATED_AT;
    }
    ...
    if ($this->created_by_user !== $v) {
        ...
        $this->modifiedColumns[] = CarcpartPeer::CREATED_BY_USER;
      }
    ...
    if ($this->updated_by_user !== $v) {
        ...
        $this->modifiedColumns[] = CarcpartPeer::UPDATED_BY_USER;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->coddirec = $rs->getString($startcol + 20);

      $this->id = $rs->getInt($startcol + 21);

      $this->codalmusu = $rs->getString($startcol + 22);

      $this->created_at = $rs->getTimestamp($startcol + 23, null);

      $this->updated_at = $rs->getTimestamp($startcol + 24, null);

      $this->created_by_user = $rs->getString($startcol + 25);

      $this->updated_by_user = $rs->getString($startcol + 26);
  ...
  public function get($m, $a)
	...
	{
    if ($this->isNew() && !$this->isColumnModified(CarcpartPeer::CREATED_AT))
    {
      $this->setCreatedAt(time());
    }

    if ($this->isModified() && !$this->isColumnModified(CarcpartPeer::UPDATED_AT))
    {
      $this->setUpdatedAt(time());
    }

    if ($this->isNew() && !$this->isColumnModified(CarcpartPeer::CREATED_BY_USER))
    {
      $this->setCreatedByUser(sfContext::getInstance()->getUser()->getAttribute('loguse','Sin Usuario'));
    }

    if ($this->isModified() && !$this->isColumnModified(CarcpartPeer::UPDATED_BY_USER))
    {
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		$result = array(
			...
			$keys[20] => $this->getCoddirec(),
			$keys[21] => $this->getId(),
			$keys[22] => $this->getCodalmusu(),
			$keys[23] => $this->getCreatedAt(),
			$keys[24] => $this->getUpdatedAt(),
			$keys[25] => $this->getCreatedByUser(),
			$keys[26] => $this->getUpdatedByUser(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[20], $arr)) $this->setCoddirec($arr[$keys[20]]);
		if (array_key_exists($keys[21], $arr)) $this->setId($arr[$keys[21]]);
		if (array_key_exists($keys[22], $arr)) $this->setCodalmusu($arr[$keys[22]]);
		...
		if (array_key_exists($keys[25], $arr)) $this->setCreatedByUser($arr[$keys[25]]);
		if (array_key_exists($keys[26], $arr)) $this->setUpdatedByUser($arr[$keys[26]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CarcpartPeer::CODDIREC)) $criteria->add(CarcpartPeer::CODDIREC, $this->coddirec);
		if ($this->isColumnModified(CarcpartPeer::ID)) $criteria->add(CarcpartPeer::ID, $this->id);
		if ($this->isColumnModified(CarcpartPeer::CODALMUSU)) $criteria->add(CarcpartPeer::CODALMUSU, $this->codalmusu);
		if ($this->isColumnModified(CarcpartPeer::CREATED_AT)) $criteria->add(CarcpartPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(CarcpartPeer::UPDATED_AT)) $criteria->add(CarcpartPeer::UPDATED_AT, $this->updated_at);
		if ($this->isColumnModified(CarcpartPeer::CREATED_BY_USER)) $criteria->add(CarcpartPeer::CREATED_BY_USER, $this->created_by_user);
		if ($this->isColumnModified(CarcpartPeer::UPDATED_BY_USER)) $criteria->add(CarcpartPeer::UPDATED_BY_USER, $this->updated_by_user);

...
abstract class BaseCagruclaPeer {
	...
	const CLASS_DEFAULT = 'lib.model.compras.Cagrucla';
	...
	{
		include_once 'lib/model/compras/map/CagruclaMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.compras.map.CagruclaMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/compras/map/CagruclaMapBuilder.php';
	Propel::registerMapBuilder('lib.model.compras.map.CagruclaMapBuilder');
}

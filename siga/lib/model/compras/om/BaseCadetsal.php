...
abstract class BaseCadetsal extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->codalt !== $v) {
        $this->codalt = $v;
        $this->modifiedColumns[] = CadetsalPeer::CODALT;
      }
    ...
    if ($this->unimed !== $v) {
        $this->unimed = $v;
        $this->modifiedColumns[] = CadetsalPeer::UNIMED;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->codalt = $rs->getString($startcol + 10);
  ...
  public function get($m, $a)
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[10], $arr)) $this->setCodalt($arr[$keys[10]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CadetsalPeer::CODALT)) $criteria->add(CadetsalPeer::CODALT, $this->codalt);
		if ($this->isColumnModified(CadetsalPeer::UNIMED)) $criteria->add(CadetsalPeer::UNIMED, $this->unimed);

...
abstract class BaseCaartord extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->codunimed !== $v) {
        $this->codunimed = $v;
        $this->modifiedColumns[] = CaartordPeer::CODUNIMED;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->codunimed = $rs->getString($startcol + 23);
  ...
  public function get($m, $a)
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[23], $arr)) $this->setCodunimed($arr[$keys[23]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CaartordPeer::CODUNIMED)) $criteria->add(CaartordPeer::CODUNIMED, $this->codunimed);

...
abstract class BaseCaentordPeer {
	...
	const CLASS_DEFAULT = 'lib.model.compras.Caentord';
	...
	{
		include_once 'lib/model/compras/map/CaentordMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.compras.map.CaentordMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/compras/map/CaentordMapBuilder.php';
	Propel::registerMapBuilder('lib.model.compras.map.CaentordMapBuilder');
}

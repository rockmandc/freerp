...
abstract class BaseCasolpagPeer {
	...
	const CLASS_DEFAULT = 'lib.model.compras.Casolpag';
	...
	{
		include_once 'lib/model/compras/map/CasolpagMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.compras.map.CasolpagMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/compras/map/CasolpagMapBuilder.php';
	Propel::registerMapBuilder('lib.model.compras.map.CasolpagMapBuilder');
}

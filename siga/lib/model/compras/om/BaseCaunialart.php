...
abstract class BaseCaunialart extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->codunimed !== $v) {
        $this->codunimed = $v;
        $this->modifiedColumns[] = CaunialartPeer::CODUNIMED;
      }
    ...
    if ($this->cosuni !== $v) {
        ...
        $this->modifiedColumns[] = CaunialartPeer::COSUNI;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->cosuni = $rs->getFloat($startcol + 4);
  ...
  public function get($m, $a)
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[4], $arr)) $this->setCosuni($arr[$keys[4]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CaunialartPeer::CODUNIMED)) $criteria->add(CaunialartPeer::CODUNIMED, $this->codunimed);
		if ($this->isColumnModified(CaunialartPeer::COSUNI)) $criteria->add(CaunialartPeer::COSUNI, $this->cosuni);

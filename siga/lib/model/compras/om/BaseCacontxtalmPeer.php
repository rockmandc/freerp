...
abstract class BaseCacontxtalmPeer {
	...
	const CLASS_DEFAULT = 'lib.model.compras.Cacontxtalm';
	...
	{
		include_once 'lib/model/compras/map/CacontxtalmMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.compras.map.CacontxtalmMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/compras/map/CacontxtalmMapBuilder.php';
	Propel::registerMapBuilder('lib.model.compras.map.CacontxtalmMapBuilder');
}

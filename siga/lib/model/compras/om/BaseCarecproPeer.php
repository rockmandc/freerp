...
abstract class BaseCarecproPeer {
	...
	const CLASS_DEFAULT = 'lib.model.compras.Carecpro';
	...
	{
		include_once 'lib/model/compras/map/CarecproMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.compras.map.CarecproMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/compras/map/CarecproMapBuilder.php';
	Propel::registerMapBuilder('lib.model.compras.map.CarecproMapBuilder');
}

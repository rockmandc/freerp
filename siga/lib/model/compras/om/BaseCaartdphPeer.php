...
abstract class BaseCaartdphPeer {
	...
	const CLASS_DEFAULT = 'lib.model.compras.Caartdph';
	...
	{
		include_once 'lib/model/compras/map/CaartdphMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.compras.map.CaartdphMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/compras/map/CaartdphMapBuilder.php';
	Propel::registerMapBuilder('lib.model.compras.map.CaartdphMapBuilder');
}

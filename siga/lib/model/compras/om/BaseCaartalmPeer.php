...
abstract class BaseCaartalmPeer {
	...
	const CLASS_DEFAULT = 'lib.model.compras.Caartalm';
	...
	{
		include_once 'lib/model/compras/map/CaartalmMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.compras.map.CaartalmMapBuilder');
	}
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(CaartalmPeer::ID); 
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/compras/map/CaartalmMapBuilder.php';
	Propel::registerMapBuilder('lib.model.compras.map.CaartalmMapBuilder');
}

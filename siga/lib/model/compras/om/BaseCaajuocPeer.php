...
abstract class BaseCaajuocPeer {
	...
	const CLASS_DEFAULT = 'lib.model.compras.Caajuoc';
	...
	{
		include_once 'lib/model/compras/map/CaajuocMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.compras.map.CaajuocMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/compras/map/CaajuocMapBuilder.php';
	Propel::registerMapBuilder('lib.model.compras.map.CaajuocMapBuilder');
}

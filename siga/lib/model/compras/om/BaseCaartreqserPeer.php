...
abstract class BaseCaartreqserPeer {
	...
	const CLASS_DEFAULT = 'lib.model.compras.Caartreqser';
	...
	const CANREQ = 'caartreqser.CANREQ';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Reqart', 'Codart', 'Codcat', 'Fecrea', 'Canreq', 'Id', ),
		BasePeer::TYPE_COLNAME => array (CaartreqserPeer::REQART, CaartreqserPeer::CODART, CaartreqserPeer::CODCAT, CaartreqserPeer::FECREA, CaartreqserPeer::CANREQ, CaartreqserPeer::ID, ),
		BasePeer::TYPE_FIELDNAME => array ('reqart', 'codart', 'codcat', 'fecrea', 'canreq', 'id', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Reqart' => 0, 'Codart' => 1, 'Codcat' => 2, 'Fecrea' => 3, 'Canreq' => 4, 'Id' => 5, ),
		BasePeer::TYPE_COLNAME => array (CaartreqserPeer::REQART => 0, CaartreqserPeer::CODART => 1, CaartreqserPeer::CODCAT => 2, CaartreqserPeer::FECREA => 3, CaartreqserPeer::CANREQ => 4, CaartreqserPeer::ID => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('reqart' => 0, 'codart' => 1, 'codcat' => 2, 'fecrea' => 3, 'canreq' => 4, 'id' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	{
		include_once 'lib/model/compras/map/CaartreqserMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.compras.map.CaartreqserMapBuilder');
	}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(CaartreqserPeer::CANREQ);
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/compras/map/CaartreqserMapBuilder.php';
	Propel::registerMapBuilder('lib.model.compras.map.CaartreqserMapBuilder');
}

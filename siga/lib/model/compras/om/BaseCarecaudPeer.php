...
abstract class BaseCarecaudPeer {
	...
	const CLASS_DEFAULT = 'lib.model.compras.Carecaud';
	...
	{
		include_once 'lib/model/compras/map/CarecaudMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.compras.map.CarecaudMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/compras/map/CarecaudMapBuilder.php';
	Propel::registerMapBuilder('lib.model.compras.map.CarecaudMapBuilder');
}

...
abstract class BaseCadefcenPeer {
	...
	const CLASS_DEFAULT = 'lib.model.compras.Cadefcen';
	...
	{
		include_once 'lib/model/compras/map/CadefcenMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.compras.map.CadefcenMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/compras/map/CadefcenMapBuilder.php';
	Propel::registerMapBuilder('lib.model.compras.map.CadefcenMapBuilder');
}

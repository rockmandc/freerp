...
abstract class BaseCaartfecPeer {
	...
	const CLASS_DEFAULT = 'lib.model.compras.Caartfec';
	...
	{
		include_once 'lib/model/compras/map/CaartfecMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.compras.map.CaartfecMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/compras/map/CaartfecMapBuilder.php';
	Propel::registerMapBuilder('lib.model.compras.map.CaartfecMapBuilder');
}

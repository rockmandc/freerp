...
abstract class BaseCadesctoPeer {
	...
	const CLASS_DEFAULT = 'lib.model.compras.Cadescto';
	...
	{
		include_once 'lib/model/compras/map/CadesctoMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.compras.map.CadesctoMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/compras/map/CadesctoMapBuilder.php';
	Propel::registerMapBuilder('lib.model.compras.map.CadesctoMapBuilder');
}

...
abstract class BaseCadefartPeer {
	...
	const CLASS_DEFAULT = 'lib.model.compras.Cadefart';
	...
	const CODCONPAG = 'cadefart.CODCONPAG';

	
	const CODFORENT = 'cadefart.CODFORENT';

	
	const FORPRO = 'cadefart.FORPRO';

	
	const DESPRO = 'cadefart.DESPRO';

	
	const TIPFIN = 'cadefart.TIPFIN';

	
	const CODMON = 'cadefart.CODMON';

	
	const REPPREIMPSC = 'cadefart.REPPREIMPSC';

	
	const REPPREIMPOC = 'cadefart.REPPREIMPOC';

	
	const CODTIPTRA = 'cadefart.CODTIPTRA';

	
	const PERCON = 'cadefart.PERCON';

	
	const FAXCON = 'cadefart.FAXCON';

	
	const EMACON = 'cadefart.EMACON';

	
	const TIPDOCCON = 'cadefart.TIPDOCCON';

	
	const CODUBI = 'cadefart.CODUBI';

	
	const RECCOO = 'cadefart.RECCOO';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Codemp', 'Lonart', 'Rupart', 'Forart', 'Desart', 'Forubi', 'Desubi', 'Correq', 'Corord', 'Correc', 'Cordes', 'Generaop', 'Asiparrec', 'Generacom', 'Mercon', 'Ctadev', 'Ctavco', 'Univta', 'Artven', 'Artins', 'Artser', 'Codalmven', 'Recart', 'Ordcom', 'Reqart', 'Dphart', 'Ordser', 'Tipimprec', 'Artvenhas', 'Corcot', 'Solart', 'Apliclades', 'Solcom', 'Unidad', 'Prcasopre', 'Prcreqapr', 'Comasopre', 'Comreqapr', 'Almcorre', 'Forsnc', 'Dessnc', 'Reqreqapr', 'Solreqapr', 'Gencorart', 'Tipdocpre', 'Cornac', 'Corext', 'Tipodoc', 'Codconpag', 'Codforent', 'Forpro', 'Despro', 'Tipfin', 'Codmon', 'Reppreimpsc', 'Reppreimpoc', 'Codtiptra', 'Percon', 'Faxcon', 'Emacon', 'Tipdoccon', 'Codubi', 'Reccoo', 'Id', ),
		BasePeer::TYPE_COLNAME => array (CadefartPeer::CODEMP, CadefartPeer::LONART, CadefartPeer::RUPART, CadefartPeer::FORART, CadefartPeer::DESART, CadefartPeer::FORUBI, CadefartPeer::DESUBI, CadefartPeer::CORREQ, CadefartPeer::CORORD, CadefartPeer::CORREC, CadefartPeer::CORDES, CadefartPeer::GENERAOP, CadefartPeer::ASIPARREC, CadefartPeer::GENERACOM, CadefartPeer::MERCON, CadefartPeer::CTADEV, CadefartPeer::CTAVCO, CadefartPeer::UNIVTA, CadefartPeer::ARTVEN, CadefartPeer::ARTINS, CadefartPeer::ARTSER, CadefartPeer::CODALMVEN, CadefartPeer::RECART, CadefartPeer::ORDCOM, CadefartPeer::REQART, CadefartPeer::DPHART, CadefartPeer::ORDSER, CadefartPeer::TIPIMPREC, CadefartPeer::ARTVENHAS, CadefartPeer::CORCOT, CadefartPeer::SOLART, CadefartPeer::APLICLADES, CadefartPeer::SOLCOM, CadefartPeer::UNIDAD, CadefartPeer::PRCASOPRE, CadefartPeer::PRCREQAPR, CadefartPeer::COMASOPRE, CadefartPeer::COMREQAPR, CadefartPeer::ALMCORRE, CadefartPeer::FORSNC, CadefartPeer::DESSNC, CadefartPeer::REQREQAPR, CadefartPeer::SOLREQAPR, CadefartPeer::GENCORART, CadefartPeer::TIPDOCPRE, CadefartPeer::CORNAC, CadefartPeer::COREXT, CadefartPeer::TIPODOC, CadefartPeer::CODCONPAG, CadefartPeer::CODFORENT, CadefartPeer::FORPRO, CadefartPeer::DESPRO, CadefartPeer::TIPFIN, CadefartPeer::CODMON, CadefartPeer::REPPREIMPSC, CadefartPeer::REPPREIMPOC, CadefartPeer::CODTIPTRA, CadefartPeer::PERCON, CadefartPeer::FAXCON, CadefartPeer::EMACON, CadefartPeer::TIPDOCCON, CadefartPeer::CODUBI, CadefartPeer::RECCOO, CadefartPeer::ID, ),
		BasePeer::TYPE_FIELDNAME => array ('codemp', 'lonart', 'rupart', 'forart', 'desart', 'forubi', 'desubi', 'correq', 'corord', 'correc', 'cordes', 'generaop', 'asiparrec', 'generacom', 'mercon', 'ctadev', 'ctavco', 'univta', 'artven', 'artins', 'artser', 'codalmven', 'recart', 'ordcom', 'reqart', 'dphart', 'ordser', 'tipimprec', 'artvenhas', 'corcot', 'solart', 'apliclades', 'solcom', 'unidad', 'prcasopre', 'prcreqapr', 'comasopre', 'comreqapr', 'almcorre', 'forsnc', 'dessnc', 'reqreqapr', 'solreqapr', 'gencorart', 'tipdocpre', 'cornac', 'corext', 'tipodoc', 'codconpag', 'codforent', 'forpro', 'despro', 'tipfin', 'codmon', 'reppreimpsc', 'reppreimpoc', 'codtiptra', 'percon', 'faxcon', 'emacon', 'tipdoccon', 'codubi', 'reccoo', 'id', ),
	...
	{
		include_once 'lib/model/compras/map/CadefartMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.compras.map.CadefartMapBuilder');
	}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(CadefartPeer::CODCONPAG);

		$criteria->addSelectColumn(CadefartPeer::CODFORENT);

		$criteria->addSelectColumn(CadefartPeer::FORPRO);

		$criteria->addSelectColumn(CadefartPeer::DESPRO);

		$criteria->addSelectColumn(CadefartPeer::TIPFIN);

		$criteria->addSelectColumn(CadefartPeer::CODMON);

		$criteria->addSelectColumn(CadefartPeer::REPPREIMPSC);

		$criteria->addSelectColumn(CadefartPeer::REPPREIMPOC);

		$criteria->addSelectColumn(CadefartPeer::CODTIPTRA);

		$criteria->addSelectColumn(CadefartPeer::PERCON);

		$criteria->addSelectColumn(CadefartPeer::FAXCON);

		$criteria->addSelectColumn(CadefartPeer::EMACON);

		$criteria->addSelectColumn(CadefartPeer::TIPDOCCON);

		$criteria->addSelectColumn(CadefartPeer::CODUBI);

		$criteria->addSelectColumn(CadefartPeer::RECCOO);
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/compras/map/CadefartMapBuilder.php';
	Propel::registerMapBuilder('lib.model.compras.map.CadefartMapBuilder');
}

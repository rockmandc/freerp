...
class CadefartMapBuilder {
	...
	const CLASS_NAME = 'lib.model.compras.map.CadefartMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('FORPRO', 'Forpro', 'string', CreoleTypes::VARCHAR, false, 15);

		$tMap->addColumn('DESPRO', 'Despro', 'string', CreoleTypes::VARCHAR, false, 15);
		...
		$tMap->addColumn('REPPREIMPSC', 'Reppreimpsc', 'string', CreoleTypes::VARCHAR, false, 50);

		$tMap->addColumn('REPPREIMPOC', 'Reppreimpoc', 'string', CreoleTypes::VARCHAR, false, 50);

		$tMap->addColumn('CODTIPTRA', 'Codtiptra', 'string', CreoleTypes::VARCHAR, false, 3);

		$tMap->addColumn('PERCON', 'Percon', 'string', CreoleTypes::VARCHAR, false, 250);

		$tMap->addColumn('FAXCON', 'Faxcon', 'string', CreoleTypes::VARCHAR, false, 30);

		$tMap->addColumn('EMACON', 'Emacon', 'string', CreoleTypes::VARCHAR, false, 50);

		$tMap->addColumn('TIPDOCCON', 'Tipdoccon', 'string', CreoleTypes::VARCHAR, false, 4);

		$tMap->addColumn('CODUBI', 'Codubi', 'string', CreoleTypes::VARCHAR, false, 20);

		$tMap->addColumn('RECCOO', 'Reccoo', 'string', CreoleTypes::VARCHAR, false, 1);

...
class CaartreqserMapBuilder {
	...
	const CLASS_NAME = 'lib.model.compras.map.CaartreqserMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap->setPrimaryKeyMethodInfo('caartreqser_SEQ');
		...
		$tMap->addColumn('FECREA', 'Fecrea', 'int', CreoleTypes::DATE, false, null);

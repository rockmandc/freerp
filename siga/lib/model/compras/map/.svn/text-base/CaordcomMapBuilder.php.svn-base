...
class CaordcomMapBuilder {
	...
	const CLASS_NAME = 'lib.model.compras.map.CaordcomMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('TIPPRO', 'Tippro', 'string', CreoleTypes::VARCHAR, false, 20);
		...
		$tMap->addColumn('REFSOL', 'Refsol', 'string', CreoleTypes::VARCHAR, false, 1000);
		...
		$tMap->addColumn('USUROC', 'Usuroc', 'string', CreoleTypes::VARCHAR, false, 50);

		$tMap->addColumn('FECREC', 'Fecrec', 'int', CreoleTypes::DATE, false, null);

		$tMap->addColumn('ENVIAD', 'Enviad', 'string', CreoleTypes::VARCHAR, false, 1);

		$tMap->addColumn('FECENV', 'Fecenv', 'int', CreoleTypes::DATE, false, null);

		$tMap->addColumn('STAPDA', 'Stapda', 'string', CreoleTypes::VARCHAR, false, 1);
		...
		$tMap->addColumn('LUGFEC', 'Lugfec', 'string', CreoleTypes::VARCHAR, false, 250);

		$tMap->addColumn('DIRENT', 'Dirent', 'string', CreoleTypes::VARCHAR, false, 250);

		$tMap->addColumn('NUMPRO', 'Numpro', 'string', CreoleTypes::VARCHAR, false, 30);

		$tMap->addColumn('STAVER', 'Staver', 'string', CreoleTypes::VARCHAR, false, 1);

		$tMap->addColumn('PERCON', 'Percon', 'string', CreoleTypes::VARCHAR, false, 500);

		$tMap->addColumn('TELCON', 'Telcon', 'string', CreoleTypes::VARCHAR, false, 50);
		...
		$tMap->addColumn('CODGAR', 'Codgar', 'string', CreoleTypes::VARCHAR, false, 3);

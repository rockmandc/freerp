...
class CaajuocMapBuilder {

	
	const CLASS_NAME = 'lib.model.compras.map.CaajuocMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('caajuoc');
		$tMap->setPhpName('Caajuoc');

		$tMap->setUseIdGenerator(true);

		$tMap->setPrimaryKeyMethodInfo('caajuoc_SEQ');

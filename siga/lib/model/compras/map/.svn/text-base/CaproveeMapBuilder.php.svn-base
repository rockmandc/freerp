...
class CaproveeMapBuilder {
	...
	const CLASS_NAME = 'lib.model.compras.map.CaproveeMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap->setPrimaryKeyMethodInfo('caprovee_SEQ');
		...
		$tMap->addColumn('ESTAPO', 'Estapo', 'string', CreoleTypes::VARCHAR, false, 1);

		$tMap->addColumn('CLAPRO', 'Clapro', 'string', CreoleTypes::VARCHAR, false, 1);

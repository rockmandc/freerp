...
/**
 * Subclase para representar una fila de la tabla 'liregofe'.
 *
 * 
 *
 * @package    Roraima
 ...
 */
class Liregofe extends BaseLiregofe {
    ...
    public function getMonofetotlet() {
        return self::getMonofetot() == 0 ? '' : H::obtenermontoescrito(H::FormatoNum(self::getMonofetot()));
    }

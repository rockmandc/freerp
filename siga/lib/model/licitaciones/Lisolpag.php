...
/**
 * Subclase para representar una fila de la tabla 'lisolpag'.
 *
 * Solicitud de Pagos
 *
 * @package    Roraima
 ...
 */ 
class Lisolpag extends BaseLisolpag
{
  protected $resolu = '';
  ...
  {
    if(!$this->aLitipact) $this->getLitipact();

    if($this->aLitipact)
      return $this->aLitipact->getNomtipact();
    else return 'dddd';
  }

...
/**
 * Subclase para representar una fila de la tabla 'lidetactsolpag'.
 *
 * Detalle de las actas por solicitud de pago
 *
 * @package    Roraima
 ...
 */ 
class Lidetactsolpag extends BaseLidetactsolpag
{

...
class LisolpagMapBuilder {

	
	const CLASS_NAME = 'lib.model.licitaciones.map.LisolpagMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('lisolpag');
		$tMap->setPhpName('Lisolpag');

		$tMap->setUseIdGenerator(true);

		$tMap->setPrimaryKeyMethodInfo('lisolpag_SEQ');

		$tMap->addColumn('NUMSOLPAG', 'Numsolpag', 'string', CreoleTypes::VARCHAR, false, 8);
		...
		$tMap->addColumn('OBSSOLPAG', 'Obssolpag', 'string', CreoleTypes::VARCHAR, false, 1000);

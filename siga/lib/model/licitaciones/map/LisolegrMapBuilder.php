...
class LisolegrMapBuilder {
	...
	const CLASS_NAME = 'lib.model.licitaciones.map.LisolegrMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('NUMSOL', 'Numsol', 'string', CreoleTypes::VARCHAR, false, 32);

		$tMap->addColumn('NUMPTOCUE', 'Numptocue', 'string', CreoleTypes::VARCHAR, false, 32);

		$tMap->addColumn('NUMPRE', 'Numpre', 'string', CreoleTypes::VARCHAR, false, 32);
		...
		$tMap->addColumn('MONSUB', 'Monsub', 'double', CreoleTypes::NUMERIC, false, 14);

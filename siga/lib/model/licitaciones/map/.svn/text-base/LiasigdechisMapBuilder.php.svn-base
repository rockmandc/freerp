...
class LiasigdechisMapBuilder {

	
	const CLASS_NAME = 'lib.model.licitaciones.map.LiasigdechisMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('liasigdechis');
		$tMap->setPhpName('Liasigdechis');

		$tMap->setUseIdGenerator(true);

		$tMap->setPrimaryKeyMethodInfo('liasigdechis_SEQ');

...
class LianaempMapBuilder {

	
	const CLASS_NAME = 'lib.model.licitaciones.map.LianaempMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('lianaemp');
		$tMap->setPhpName('Lianaemp');

		$tMap->setUseIdGenerator(true);

		$tMap->setPrimaryKeyMethodInfo('lianaemp_SEQ');

		$tMap->addColumn('NUMANAEMP', 'Numanaemp', 'string', CreoleTypes::VARCHAR, false, 32);

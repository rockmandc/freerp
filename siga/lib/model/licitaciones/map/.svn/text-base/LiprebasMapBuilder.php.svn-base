...
class LiprebasMapBuilder {
	...
	const CLASS_NAME = 'lib.model.licitaciones.map.LiprebasMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('DIROBR', 'Dirobr', 'string', CreoleTypes::VARCHAR, false, 1000);

		$tMap->addColumn('CODPRO', 'Codpro', 'string', CreoleTypes::VARCHAR, false, 15);

		$tMap->addColumn('REQART', 'Reqart', 'string', CreoleTypes::VARCHAR, false, 15);

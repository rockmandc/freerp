...
class LianaemptecMapBuilder {

	
	const CLASS_NAME = 'lib.model.licitaciones.map.LianaemptecMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('lianaemptec');
		$tMap->setPhpName('Lianaemptec');

		$tMap->setUseIdGenerator(true);

		$tMap->setPrimaryKeyMethodInfo('lianaemptec_SEQ');

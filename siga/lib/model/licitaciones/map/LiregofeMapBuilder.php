...
class LiregofeMapBuilder {
	...
	const CLASS_NAME = 'lib.model.licitaciones.map.LiregofeMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('NUMOFE', 'Numofe', 'string', CreoleTypes::VARCHAR, false, 32);
		...
		$tMap->addColumn('MONOFETOT', 'Monofetot', 'double', CreoleTypes::NUMERIC, false, 14);

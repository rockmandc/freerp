...
class LianaofeMapBuilder {

	
	const CLASS_NAME = 'lib.model.licitaciones.map.LianaofeMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('lianaofe');
		$tMap->setPhpName('Lianaofe');

		$tMap->setUseIdGenerator(true);

		$tMap->setPrimaryKeyMethodInfo('lianaofe_SEQ');

		$tMap->addColumn('NUMANAOFE', 'Numanaofe', 'string', CreoleTypes::VARCHAR, false, 32);
		...
		$tMap->addColumn('PORTOT', 'Portot', 'double', CreoleTypes::NUMERIC, false, 14);

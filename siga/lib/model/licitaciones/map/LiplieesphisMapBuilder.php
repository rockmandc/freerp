...
class LiplieesphisMapBuilder {

	
	const CLASS_NAME = 'lib.model.licitaciones.map.LiplieesphisMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('liplieesphis');
		$tMap->setPhpName('Liplieesphis');

		$tMap->setUseIdGenerator(true);

		$tMap->setPrimaryKeyMethodInfo('liplieesphis_SEQ');
		...
		$tMap->addColumn('PORLEG', 'Porleg', 'double', CreoleTypes::NUMERIC, false, 14);

		$tMap->addColumn('MINLEG', 'Minleg', 'double', CreoleTypes::NUMERIC, false, 14);

		$tMap->addColumn('PORTEC', 'Portec', 'double', CreoleTypes::NUMERIC, false, 14);

		$tMap->addColumn('MINTEC', 'Mintec', 'double', CreoleTypes::NUMERIC, false, 14);

		$tMap->addColumn('PORFIN', 'Porfin', 'double', CreoleTypes::NUMERIC, false, 14);

		$tMap->addColumn('MINFIN', 'Minfin', 'double', CreoleTypes::NUMERIC, false, 14);

		$tMap->addColumn('PORFIA', 'Porfia', 'double', CreoleTypes::NUMERIC, false, 14);

		$tMap->addColumn('MINFIA', 'Minfia', 'double', CreoleTypes::NUMERIC, false, 14);

		$tMap->addColumn('PORTIPEMP', 'Portipemp', 'double', CreoleTypes::NUMERIC, false, 14);

		$tMap->addColumn('MINTIPEMP', 'Mintipemp', 'double', CreoleTypes::NUMERIC, false, 14);

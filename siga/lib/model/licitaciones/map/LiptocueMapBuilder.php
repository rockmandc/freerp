...
class LiptocueMapBuilder {
	...
	const CLASS_NAME = 'lib.model.licitaciones.map.LiptocueMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('NUMEMO', 'Numemo', 'string', CreoleTypes::VARCHAR, true, 32);

		$tMap->addColumn('NUMPRE', 'Numpre', 'string', CreoleTypes::VARCHAR, true, 32);

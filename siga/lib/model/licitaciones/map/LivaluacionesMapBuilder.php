...
class LivaluacionesMapBuilder {

	
	const CLASS_NAME = 'lib.model.licitaciones.map.LivaluacionesMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('livaluaciones');
		$tMap->setPhpName('Livaluaciones');

		$tMap->setUseIdGenerator(true);

		$tMap->setPrimaryKeyMethodInfo('livaluaciones_SEQ');

		$tMap->addColumn('NUMVAL', 'Numval', 'string', CreoleTypes::VARCHAR, false, 8);

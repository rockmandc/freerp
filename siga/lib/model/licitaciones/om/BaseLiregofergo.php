...
abstract class BaseLiregofergo extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->tipconpub !== $v) {
        $this->tipconpub = $v;
        $this->modifiedColumns[] = LiregofergoPeer::TIPCONPUB;
      }
  ...
  public function get($m, $a)
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(LiregofergoPeer::TIPCONPUB)) $criteria->add(LiregofergoPeer::TIPCONPUB, $this->tipconpub);

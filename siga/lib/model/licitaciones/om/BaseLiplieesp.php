...
abstract class BaseLiplieesp extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->fecdecla !== $ts) {
      $this->fecdecla = $ts;
      $this->modifiedColumns[] = LiplieespPeer::FECDECLA;
    }
    ...
    if ($this->porleg !== $v) {
        ...
        $this->modifiedColumns[] = LiplieespPeer::PORLEG;
      }
    ...
    if ($this->minleg !== $v) {
        ...
        $this->modifiedColumns[] = LiplieespPeer::MINLEG;
      }
    ...
    if ($this->portec !== $v) {
        ...
        $this->modifiedColumns[] = LiplieespPeer::PORTEC;
      }
    ...
    if ($this->mintec !== $v) {
        ...
        $this->modifiedColumns[] = LiplieespPeer::MINTEC;
      }
    ...
    if ($this->porfin !== $v) {
        ...
        $this->modifiedColumns[] = LiplieespPeer::PORFIN;
      }
    ...
    if ($this->minfin !== $v) {
        ...
        $this->modifiedColumns[] = LiplieespPeer::MINFIN;
      }
    ...
    if ($this->porfia !== $v) {
        ...
        $this->modifiedColumns[] = LiplieespPeer::PORFIA;
      }
    ...
    if ($this->minfia !== $v) {
        ...
        $this->modifiedColumns[] = LiplieespPeer::MINFIA;
      }
    ...
    if ($this->portipemp !== $v) {
        ...
        $this->modifiedColumns[] = LiplieespPeer::PORTIPEMP;
      }
    ...
    if ($this->mintipemp !== $v) {
        ...
        $this->modifiedColumns[] = LiplieespPeer::MINTIPEMP;
      }
    ...
    if ($this->tipconpub !== $v) {
        $this->tipconpub = $v;
        $this->modifiedColumns[] = LiplieespPeer::TIPCONPUB;
      }
  ...
  public function get($m, $a)
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(LiplieespPeer::FECDECLA)) $criteria->add(LiplieespPeer::FECDECLA, $this->fecdecla);
		if ($this->isColumnModified(LiplieespPeer::PORLEG)) $criteria->add(LiplieespPeer::PORLEG, $this->porleg);
		if ($this->isColumnModified(LiplieespPeer::MINLEG)) $criteria->add(LiplieespPeer::MINLEG, $this->minleg);
		if ($this->isColumnModified(LiplieespPeer::PORTEC)) $criteria->add(LiplieespPeer::PORTEC, $this->portec);
		if ($this->isColumnModified(LiplieespPeer::MINTEC)) $criteria->add(LiplieespPeer::MINTEC, $this->mintec);
		if ($this->isColumnModified(LiplieespPeer::PORFIN)) $criteria->add(LiplieespPeer::PORFIN, $this->porfin);
		if ($this->isColumnModified(LiplieespPeer::MINFIN)) $criteria->add(LiplieespPeer::MINFIN, $this->minfin);
		if ($this->isColumnModified(LiplieespPeer::PORFIA)) $criteria->add(LiplieespPeer::PORFIA, $this->porfia);
		if ($this->isColumnModified(LiplieespPeer::MINFIA)) $criteria->add(LiplieespPeer::MINFIA, $this->minfia);
		if ($this->isColumnModified(LiplieespPeer::PORTIPEMP)) $criteria->add(LiplieespPeer::PORTIPEMP, $this->portipemp);
		if ($this->isColumnModified(LiplieespPeer::MINTIPEMP)) $criteria->add(LiplieespPeer::MINTIPEMP, $this->mintipemp);
		if ($this->isColumnModified(LiplieespPeer::TIPCONPUB)) $criteria->add(LiplieespPeer::TIPCONPUB, $this->tipconpub);

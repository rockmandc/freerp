...
abstract class BaseLiaspfinanalisPeer {
	...
	const CLASS_DEFAULT = 'lib.model.licitaciones.Liaspfinanalis';
	...
	{
		include_once 'lib/model/licitaciones/map/LiaspfinanalisMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.licitaciones.map.LiaspfinanalisMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/licitaciones/map/LiaspfinanalisMapBuilder.php';
	Propel::registerMapBuilder('lib.model.licitaciones.map.LiaspfinanalisMapBuilder');
}

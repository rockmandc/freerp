...
abstract class BaseLianaofefia extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->tipconpub !== $v) {
        $this->tipconpub = $v;
        $this->modifiedColumns[] = LianaofefiaPeer::TIPCONPUB;
      }
  ...
  public function get($m, $a)
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(LianaofefiaPeer::TIPCONPUB)) $criteria->add(LianaofefiaPeer::TIPCONPUB, $this->tipconpub);

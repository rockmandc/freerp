...
abstract class BaseLimemoran extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->fecreg !== $ts) {
      $this->fecreg = $ts;
      $this->modifiedColumns[] = LimemoranPeer::FECREG;
    }
    ...
    if ($this->dias !== $v) {
        $this->dias = $v;
        $this->modifiedColumns[] = LimemoranPeer::DIAS;
      }
    ...
    if ($this->fecven !== $ts) {
      $this->fecven = $ts;
      $this->modifiedColumns[] = LimemoranPeer::FECVEN;
    }
    ...
    if ($this->fecdecla !== $ts) {
      $this->fecdecla = $ts;
      $this->modifiedColumns[] = LimemoranPeer::FECDECLA;
    }
    ...
    if ($this->tipconpub !== $v) {
        $this->tipconpub = $v;
        $this->modifiedColumns[] = LimemoranPeer::TIPCONPUB;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->fecreg = $rs->getDate($startcol + 17, null);

      $this->dias = $rs->getInt($startcol + 18);

      $this->fecven = $rs->getDate($startcol + 19, null);

      $this->fecdecla = $rs->getDate($startcol + 20, null);

      $this->tipconpub = $rs->getString($startcol + 21);
  ...
  public function get($m, $a)
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		$result = array(
			...
			$keys[18] => $this->getDias(),
			$keys[19] => $this->getFecven(),
			$keys[20] => $this->getFecdecla(),
			$keys[21] => $this->getTipconpub(),
			$keys[22] => $this->getId(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[18], $arr)) $this->setDias($arr[$keys[18]]);
		if (array_key_exists($keys[19], $arr)) $this->setFecven($arr[$keys[19]]);
		if (array_key_exists($keys[20], $arr)) $this->setFecdecla($arr[$keys[20]]);
		if (array_key_exists($keys[21], $arr)) $this->setTipconpub($arr[$keys[21]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(LimemoranPeer::FECREG)) $criteria->add(LimemoranPeer::FECREG, $this->fecreg);
		if ($this->isColumnModified(LimemoranPeer::DIAS)) $criteria->add(LimemoranPeer::DIAS, $this->dias);
		if ($this->isColumnModified(LimemoranPeer::FECVEN)) $criteria->add(LimemoranPeer::FECVEN, $this->fecven);
		if ($this->isColumnModified(LimemoranPeer::FECDECLA)) $criteria->add(LimemoranPeer::FECDECLA, $this->fecdecla);
		if ($this->isColumnModified(LimemoranPeer::TIPCONPUB)) $criteria->add(LimemoranPeer::TIPCONPUB, $this->tipconpub);

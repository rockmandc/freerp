...
abstract class BaseLiregofeleg extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->tipconpub !== $v) {
        $this->tipconpub = $v;
        $this->modifiedColumns[] = LiregofelegPeer::TIPCONPUB;
      }
  ...
  public function get($m, $a)
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(LiregofelegPeer::TIPCONPUB)) $criteria->add(LiregofelegPeer::TIPCONPUB, $this->tipconpub);

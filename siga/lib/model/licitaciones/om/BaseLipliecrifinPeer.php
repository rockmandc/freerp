...
abstract class BaseLipliecrifinPeer {
	...
	const CLASS_DEFAULT = 'lib.model.licitaciones.Lipliecrifin';
	...
	const LIMITA = 'lipliecrifin.LIMITA';

	
	const TIPCONPUB = 'lipliecrifin.TIPCONPUB';
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (LipliecrifinPeer::NUMPLIE, LipliecrifinPeer::NUMEXP, LipliecrifinPeer::CODCRI, LipliecrifinPeer::PUNTUA, LipliecrifinPeer::PORCEN, LipliecrifinPeer::LIMITA, LipliecrifinPeer::TIPCONPUB, LipliecrifinPeer::ID, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (LipliecrifinPeer::NUMPLIE => 0, LipliecrifinPeer::NUMEXP => 1, LipliecrifinPeer::CODCRI => 2, LipliecrifinPeer::PUNTUA => 3, LipliecrifinPeer::PORCEN => 4, LipliecrifinPeer::LIMITA => 5, LipliecrifinPeer::TIPCONPUB => 6, LipliecrifinPeer::ID => 7, ),
	...
	{
		include_once 'lib/model/licitaciones/map/LipliecrifinMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.licitaciones.map.LipliecrifinMapBuilder');
	}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(LipliecrifinPeer::LIMITA);

		$criteria->addSelectColumn(LipliecrifinPeer::TIPCONPUB);
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/licitaciones/map/LipliecrifinMapBuilder.php';
	Propel::registerMapBuilder('lib.model.licitaciones.map.LipliecrifinMapBuilder');
}

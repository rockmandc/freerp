...
abstract class BaseLidetcomPeer {
	...
	const CLASS_DEFAULT = 'lib.model.licitaciones.Lidetcom';
	...
	{
		include_once 'lib/model/licitaciones/map/LidetcomMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.licitaciones.map.LidetcomMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/licitaciones/map/LidetcomMapBuilder.php';
	Propel::registerMapBuilder('lib.model.licitaciones.map.LidetcomMapBuilder');
}

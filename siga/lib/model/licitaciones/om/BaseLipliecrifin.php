...
abstract class BaseLipliecrifin extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->limita !== $v) {
        $this->limita = $v;
        $this->modifiedColumns[] = LipliecrifinPeer::LIMITA;
      }
    ...
    if ($this->tipconpub !== $v) {
        $this->tipconpub = $v;
        $this->modifiedColumns[] = LipliecrifinPeer::TIPCONPUB;
      }
  ...
  public function get($m, $a)
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(LipliecrifinPeer::LIMITA)) $criteria->add(LipliecrifinPeer::LIMITA, $this->limita);
		if ($this->isColumnModified(LipliecrifinPeer::TIPCONPUB)) $criteria->add(LipliecrifinPeer::TIPCONPUB, $this->tipconpub);

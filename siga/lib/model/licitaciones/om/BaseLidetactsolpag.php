...
abstract class BaseLidetactsolpag extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->numsolpag !== $v) {
        $this->numsolpag = $v;
        $this->modifiedColumns[] = LidetactsolpagPeer::NUMSOLPAG;
      }
    ...
    if ($this->numact !== $v) {
        $this->numact = $v;
        $this->modifiedColumns[] = LidetactsolpagPeer::NUMACT;
      }
    ...
    if ($this->id !== $v) {
        $this->id = $v;
        $this->modifiedColumns[] = LidetactsolpagPeer::ID;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      throw new PropelException("Error populating Lidetactsolpag object", $e);
    }
  }
  ...
  public function get($m, $a)
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			LidetactsolpagPeer::doDelete($this, $con);
		...
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			...
			if ($this->aLiactas !== null) {
				...
				$this->setLiactas($this->aLiactas);
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = LidetactsolpagPeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += LidetactsolpagPeer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = LidetactsolpagPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = LidetactsolpagPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = LidetactsolpagPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(LidetactsolpagPeer::NUMSOLPAG)) $criteria->add(LidetactsolpagPeer::NUMSOLPAG, $this->numsolpag);
		if ($this->isColumnModified(LidetactsolpagPeer::NUMACT)) $criteria->add(LidetactsolpagPeer::NUMACT, $this->numact);
		if ($this->isColumnModified(LidetactsolpagPeer::ID)) $criteria->add(LidetactsolpagPeer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(LidetactsolpagPeer::ID, $this->id);
	...
	{
		if (self::$peer === null) {
			self::$peer = new LidetactsolpagPeer();
		}
		return self::$peer;
	}

...
abstract class BaseLiplietipemp extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->limita !== $v) {
        $this->limita = $v;
        $this->modifiedColumns[] = LiplietipempPeer::LIMITA;
      }
    ...
    if ($this->tipconpub !== $v) {
        $this->tipconpub = $v;
        $this->modifiedColumns[] = LiplietipempPeer::TIPCONPUB;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->limita = $rs->getString($startcol + 7);

      $this->tipconpub = $rs->getString($startcol + 8);
  ...
  public function get($m, $a)
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		$result = array(
			...
			$keys[7] => $this->getLimita(),
			$keys[8] => $this->getTipconpub(),
			$keys[9] => $this->getId(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[7], $arr)) $this->setLimita($arr[$keys[7]]);
		if (array_key_exists($keys[8], $arr)) $this->setTipconpub($arr[$keys[8]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(LiplietipempPeer::LIMITA)) $criteria->add(LiplietipempPeer::LIMITA, $this->limita);
		if ($this->isColumnModified(LiplietipempPeer::TIPCONPUB)) $criteria->add(LiplietipempPeer::TIPCONPUB, $this->tipconpub);

...
abstract class BaseLilichisPeer {
	...
	const CLASS_DEFAULT = 'lib.model.licitaciones.Lilichis';
	...
	{
		include_once 'lib/model/licitaciones/map/LilichisMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.licitaciones.map.LilichisMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/licitaciones/map/LilichisMapBuilder.php';
	Propel::registerMapBuilder('lib.model.licitaciones.map.LilichisMapBuilder');
}

  ...
  public function get($m, $a)
	...
	public function getLitiplic($con = null)
	{
		if ($this->aLitiplic === null && ($this->litiplic_id !== null)) {
						include_once 'lib/model/licitaciones/om/BaseLitiplicPeer.php';
	...
	{
				include_once 'lib/model/licitaciones/om/BaseLioferprePeer.php';
		if ($criteria === null) {
	...
	{
				include_once 'lib/model/licitaciones/om/BaseLiasptecanalisPeer.php';
		if ($criteria === null) {
			$criteria = new Criteria();
		}
		elseif ($criteria instanceof Criteria)
	...
	{
				include_once 'lib/model/licitaciones/om/BaseLiaspfinanalisPeer.php';
		if ($criteria === null) {
			$criteria = new Criteria();
		}
		elseif ($criteria instanceof Criteria)
	...
	{
				include_once 'lib/model/licitaciones/om/BaseLicalvanPeer.php';
		if ($criteria === null) {
			$criteria = new Criteria();
		}
		elseif ($criteria instanceof Criteria)

...
abstract class BaseLirecomen extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->fecdecla !== $ts) {
      $this->fecdecla = $ts;
      $this->modifiedColumns[] = LirecomenPeer::FECDECLA;
    }
    ...
    if ($this->tipconpub !== $v) {
        $this->tipconpub = $v;
        $this->modifiedColumns[] = LirecomenPeer::TIPCONPUB;
      }
  ...
  public function get($m, $a)
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(LirecomenPeer::FECDECLA)) $criteria->add(LirecomenPeer::FECDECLA, $this->fecdecla);
		if ($this->isColumnModified(LirecomenPeer::TIPCONPUB)) $criteria->add(LirecomenPeer::TIPCONPUB, $this->tipconpub);

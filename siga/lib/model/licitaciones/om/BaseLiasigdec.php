...
abstract class BaseLiasigdec extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->lisicact_id !== $v) {
        $this->lisicact_id = $v;
        $this->modifiedColumns[] = LiasigdecPeer::LISICACT_ID;
      }
    ...
    if ($this->fecdecla !== $ts) {
      $this->fecdecla = $ts;
      $this->modifiedColumns[] = LiasigdecPeer::FECDECLA;
    }
    ...
    if ($this->detdecmod !== $v) {
        $this->detdecmod = $v;
        $this->modifiedColumns[] = LiasigdecPeer::DETDECMOD;
      }
    ...
    if ($this->anapor !== $v) {
        $this->anapor = $v;
        $this->modifiedColumns[] = LiasigdecPeer::ANAPOR;
      }
    ...
    if ($this->anaporcar !== $v) {
        $this->anaporcar = $v;
        $this->modifiedColumns[] = LiasigdecPeer::ANAPORCAR;
      }
    ...
    if ($this->status !== $v) {
        $this->status = $v;
        $this->modifiedColumns[] = LiasigdecPeer::STATUS;
      }
    ...
    if ($this->numdoc !== $v) {
        $this->numdoc = $v;
        $this->modifiedColumns[] = LiasigdecPeer::NUMDOC;
      }
    ...
    if ($this->tabla !== $v) {
        $this->tabla = $v;
        $this->modifiedColumns[] = LiasigdecPeer::TABLA;
      }
    ...
    if ($this->numdec !== $v) {
        $this->numdec = $v;
        $this->modifiedColumns[] = LiasigdecPeer::NUMDEC;
      }
    ...
    if ($this->tipconpub !== $v) {
        $this->tipconpub = $v;
        $this->modifiedColumns[] = LiasigdecPeer::TIPCONPUB;
      }
    ...
    if ($this->id !== $v) {
        $this->id = $v;
        $this->modifiedColumns[] = LiasigdecPeer::ID;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      throw new PropelException("Error populating Liasigdec object", $e);
    }
  }
  ...
  public function get($m, $a)
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			LiasigdecPeer::doDelete($this, $con);
		...
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			...
			if ($this->aLisicact !== null) {
				...
				$this->setLisicact($this->aLisicact);
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = LiasigdecPeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += LiasigdecPeer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = LiasigdecPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = LiasigdecPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = LiasigdecPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(LiasigdecPeer::LISICACT_ID)) $criteria->add(LiasigdecPeer::LISICACT_ID, $this->lisicact_id);
		if ($this->isColumnModified(LiasigdecPeer::FECDECLA)) $criteria->add(LiasigdecPeer::FECDECLA, $this->fecdecla);
		if ($this->isColumnModified(LiasigdecPeer::DETDECMOD)) $criteria->add(LiasigdecPeer::DETDECMOD, $this->detdecmod);
		if ($this->isColumnModified(LiasigdecPeer::ANAPOR)) $criteria->add(LiasigdecPeer::ANAPOR, $this->anapor);
		if ($this->isColumnModified(LiasigdecPeer::ANAPORCAR)) $criteria->add(LiasigdecPeer::ANAPORCAR, $this->anaporcar);
		if ($this->isColumnModified(LiasigdecPeer::STATUS)) $criteria->add(LiasigdecPeer::STATUS, $this->status);
		if ($this->isColumnModified(LiasigdecPeer::NUMDOC)) $criteria->add(LiasigdecPeer::NUMDOC, $this->numdoc);
		if ($this->isColumnModified(LiasigdecPeer::TABLA)) $criteria->add(LiasigdecPeer::TABLA, $this->tabla);
		if ($this->isColumnModified(LiasigdecPeer::NUMDEC)) $criteria->add(LiasigdecPeer::NUMDEC, $this->numdec);
		if ($this->isColumnModified(LiasigdecPeer::TIPCONPUB)) $criteria->add(LiasigdecPeer::TIPCONPUB, $this->tipconpub);
		if ($this->isColumnModified(LiasigdecPeer::ID)) $criteria->add(LiasigdecPeer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(LiasigdecPeer::ID, $this->id);

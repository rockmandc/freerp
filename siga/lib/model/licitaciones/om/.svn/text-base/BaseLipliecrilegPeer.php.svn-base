...
abstract class BaseLipliecrilegPeer {
	...
	const CLASS_DEFAULT = 'lib.model.licitaciones.Lipliecrileg';
	...
	const LIMITA = 'lipliecrileg.LIMITA';

	
	const TIPCONPUB = 'lipliecrileg.TIPCONPUB';
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (LipliecrilegPeer::NUMPLIE, LipliecrilegPeer::NUMEXP, LipliecrilegPeer::CODCRI, LipliecrilegPeer::PUNTUA, LipliecrilegPeer::PORCEN, LipliecrilegPeer::LIMITA, LipliecrilegPeer::TIPCONPUB, LipliecrilegPeer::ID, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (LipliecrilegPeer::NUMPLIE => 0, LipliecrilegPeer::NUMEXP => 1, LipliecrilegPeer::CODCRI => 2, LipliecrilegPeer::PUNTUA => 3, LipliecrilegPeer::PORCEN => 4, LipliecrilegPeer::LIMITA => 5, LipliecrilegPeer::TIPCONPUB => 6, LipliecrilegPeer::ID => 7, ),
	...
	{
		include_once 'lib/model/licitaciones/map/LipliecrilegMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.licitaciones.map.LipliecrilegMapBuilder');
	}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(LipliecrilegPeer::LIMITA);

		$criteria->addSelectColumn(LipliecrilegPeer::TIPCONPUB);
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/licitaciones/map/LipliecrilegMapBuilder.php';
	Propel::registerMapBuilder('lib.model.licitaciones.map.LipliecrilegMapBuilder');
}

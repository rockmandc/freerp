  ...
  public function get($m, $a)
	...
	public function getLidatste($con = null)
	{
		if ($this->aLidatste === null && ($this->lidatste_id !== null)) {
						include_once 'lib/model/licitaciones/om/BaseLidatstePeer.php';
	...
	public function getLitipsol($con = null)
	{
		if ($this->aLitipsol === null && ($this->litipsol_id !== null)) {
						include_once 'lib/model/licitaciones/om/BaseLitipsolPeer.php';
	...
	public function getLicomlic($con = null)
	{
		if ($this->aLicomlic === null && ($this->licomlic_id !== null)) {
						include_once 'lib/model/licitaciones/om/BaseLicomlicPeer.php';
	...
	{
				include_once 'lib/model/licitaciones/om/BaseLiressolPeer.php';
		if ($criteria === null) {

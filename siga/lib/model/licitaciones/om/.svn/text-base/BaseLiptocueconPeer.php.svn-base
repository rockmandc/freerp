...
abstract class BaseLiptocueconPeer {
	...
	const CLASS_DEFAULT = 'lib.model.licitaciones.Liptocuecon';
	...
	const FECDECLA = 'liptocuecon.FECDECLA';

	
	const TIPCONPUB = 'liptocuecon.TIPCONPUB';
	...
	{
		include_once 'lib/model/licitaciones/map/LiptocueconMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.licitaciones.map.LiptocueconMapBuilder');
	}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(LiptocueconPeer::FECDECLA);

		$criteria->addSelectColumn(LiptocueconPeer::TIPCONPUB);
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/licitaciones/map/LiptocueconMapBuilder.php';
	Propel::registerMapBuilder('lib.model.licitaciones.map.LiptocueconMapBuilder');
}

...
abstract class BaseLiregofe extends BaseObject  implements Persistent {
  ...
  public function getMonofetot($val=false)
  {

    if($val) return number_format($this->monofetot,2,',','.');
    else return $this->monofetot;
  ...
  public function getId()
  {
	...
	public function setMonofetot($v)
	{

    if ($this->monofetot !== $v) {
        $this->monofetot = Herramientas::toFloat($v);
        $this->modifiedColumns[] = LiregofePeer::MONOFETOT;
      }
    ...
    if ($this->fecdecla !== $ts) {
      $this->fecdecla = $ts;
      $this->modifiedColumns[] = LiregofePeer::FECDECLA;
    }
    ...
    if ($this->tipconpub !== $v) {
        $this->tipconpub = $v;
        $this->modifiedColumns[] = LiregofePeer::TIPCONPUB;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->monofetot = $rs->getFloat($startcol + 27);

      $this->porvan = $rs->getFloat($startcol + 28);

      $this->declar = $rs->getString($startcol + 29);

      $this->fecdecla = $rs->getDate($startcol + 30, null);

      $this->tipconpub = $rs->getString($startcol + 31);
  ...
  public function get($m, $a)
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		$result = array(
			...
			$keys[27] => $this->getMonofetot(),
			$keys[28] => $this->getPorvan(),
			$keys[29] => $this->getDeclar(),
			$keys[30] => $this->getFecdecla(),
			$keys[31] => $this->getTipconpub(),
			$keys[32] => $this->getId(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[27], $arr)) $this->setMonofetot($arr[$keys[27]]);
		if (array_key_exists($keys[28], $arr)) $this->setPorvan($arr[$keys[28]]);
		if (array_key_exists($keys[29], $arr)) $this->setDeclar($arr[$keys[29]]);
		if (array_key_exists($keys[30], $arr)) $this->setFecdecla($arr[$keys[30]]);
		if (array_key_exists($keys[31], $arr)) $this->setTipconpub($arr[$keys[31]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(LiregofePeer::MONOFETOT)) $criteria->add(LiregofePeer::MONOFETOT, $this->monofetot);
		...
		if ($this->isColumnModified(LiregofePeer::FECDECLA)) $criteria->add(LiregofePeer::FECDECLA, $this->fecdecla);
		if ($this->isColumnModified(LiregofePeer::TIPCONPUB)) $criteria->add(LiregofePeer::TIPCONPUB, $this->tipconpub);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setMonofetot($this->monofetot);

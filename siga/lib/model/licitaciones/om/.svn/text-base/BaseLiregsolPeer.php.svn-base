...
abstract class BaseLiregsolPeer {
	...
	const CLASS_DEFAULT = 'lib.model.licitaciones.Liregsol';
	...
	{
		include_once 'lib/model/licitaciones/map/LiregsolMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.licitaciones.map.LiregsolMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/licitaciones/map/LiregsolMapBuilder.php';
	Propel::registerMapBuilder('lib.model.licitaciones.map.LiregsolMapBuilder');
}

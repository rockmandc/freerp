...
abstract class BaseLiregforpagmodcont extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->nummod !== $v) {
        $this->nummod = $v;
        $this->modifiedColumns[] = LiregforpagmodcontPeer::NUMMOD;
      }
    ...
    if ($this->desant !== $v) {
        $this->desant = $v;
        $this->modifiedColumns[] = LiregforpagmodcontPeer::DESANT;
      }
    ...
    if ($this->porant !== $v) {
        ...
        $this->modifiedColumns[] = LiregforpagmodcontPeer::PORANT;
      }
    ...
    if ($this->montot !== $v) {
        ...
        $this->modifiedColumns[] = LiregforpagmodcontPeer::MONTOT;
      }
    ...
    if ($this->monrec !== $v) {
        ...
        $this->modifiedColumns[] = LiregforpagmodcontPeer::MONREC;
      }
    ...
    if ($this->subtot !== $v) {
        ...
        $this->modifiedColumns[] = LiregforpagmodcontPeer::SUBTOT;
      }
    ...
    if ($this->poramoant !== $v) {
        ...
        $this->modifiedColumns[] = LiregforpagmodcontPeer::PORAMOANT;
      }
    ...
    if ($this->netpag !== $v) {
        ...
        $this->modifiedColumns[] = LiregforpagmodcontPeer::NETPAG;
      }
    ...
    if ($this->fecant !== $ts) {
      $this->fecant = $ts;
      $this->modifiedColumns[] = LiregforpagmodcontPeer::FECANT;
    }
    ...
    if ($this->condic !== $v) {
        $this->condic = $v;
        $this->modifiedColumns[] = LiregforpagmodcontPeer::CONDIC;
      }
    ...
    if ($this->tipconpub !== $v) {
        $this->tipconpub = $v;
        $this->modifiedColumns[] = LiregforpagmodcontPeer::TIPCONPUB;
      }
    ...
    if ($this->numord !== $v) {
        $this->numord = $v;
        $this->modifiedColumns[] = LiregforpagmodcontPeer::NUMORD;
      }
    ...
    if ($this->numche !== $v) {
        $this->numche = $v;
        $this->modifiedColumns[] = LiregforpagmodcontPeer::NUMCHE;
      }
    ...
    if ($this->feccom !== $ts) {
      $this->feccom = $ts;
      $this->modifiedColumns[] = LiregforpagmodcontPeer::FECCOM;
    }
    ...
    if ($this->feccau !== $ts) {
      $this->feccau = $ts;
      $this->modifiedColumns[] = LiregforpagmodcontPeer::FECCAU;
    }
    ...
    if ($this->fecpag !== $ts) {
      $this->fecpag = $ts;
      $this->modifiedColumns[] = LiregforpagmodcontPeer::FECPAG;
    }
    ...
    if ($this->liregforpagcont_id !== $v) {
        ...
        $this->modifiedColumns[] = LiregforpagmodcontPeer::LIREGFORPAGCONT_ID;
      }
    ...
    if ($this->numval !== $v) {
        $this->numval = $v;
        $this->modifiedColumns[] = LiregforpagmodcontPeer::NUMVAL;
      }
    ...
    if ($this->id !== $v) {
        $this->id = $v;
        $this->modifiedColumns[] = LiregforpagmodcontPeer::ID;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      throw new PropelException("Error populating Liregforpagmodcont object", $e);
    }
  }
  ...
  public function get($m, $a)
	...
	public function delete($con = null)
	{
		...
		if ($con === null) {
			$con = Propel::getConnection(LiregforpagmodcontPeer::DATABASE_NAME);
		}

		try {
			$con->begin();
			LiregforpagmodcontPeer::doDelete($this, $con);
		...
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			...
			if ($this->aLiregforpagcont !== null) {
				...
				$this->setLiregforpagcont($this->aLiregforpagcont);
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = LiregforpagmodcontPeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += LiregforpagmodcontPeer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = LiregforpagmodcontPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = LiregforpagmodcontPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = LiregforpagmodcontPeer::getFieldNames($keyType);
		$result = array(
	...
	{
		$criteria = new Criteria(LiregforpagmodcontPeer::DATABASE_NAME);

		if ($this->isColumnModified(LiregforpagmodcontPeer::NUMMOD)) $criteria->add(LiregforpagmodcontPeer::NUMMOD, $this->nummod);
		if ($this->isColumnModified(LiregforpagmodcontPeer::DESANT)) $criteria->add(LiregforpagmodcontPeer::DESANT, $this->desant);
		if ($this->isColumnModified(LiregforpagmodcontPeer::PORANT)) $criteria->add(LiregforpagmodcontPeer::PORANT, $this->porant);
		if ($this->isColumnModified(LiregforpagmodcontPeer::MONTOT)) $criteria->add(LiregforpagmodcontPeer::MONTOT, $this->montot);
		if ($this->isColumnModified(LiregforpagmodcontPeer::MONREC)) $criteria->add(LiregforpagmodcontPeer::MONREC, $this->monrec);
		if ($this->isColumnModified(LiregforpagmodcontPeer::SUBTOT)) $criteria->add(LiregforpagmodcontPeer::SUBTOT, $this->subtot);
		if ($this->isColumnModified(LiregforpagmodcontPeer::PORAMOANT)) $criteria->add(LiregforpagmodcontPeer::PORAMOANT, $this->poramoant);
		if ($this->isColumnModified(LiregforpagmodcontPeer::NETPAG)) $criteria->add(LiregforpagmodcontPeer::NETPAG, $this->netpag);
		if ($this->isColumnModified(LiregforpagmodcontPeer::FECANT)) $criteria->add(LiregforpagmodcontPeer::FECANT, $this->fecant);
		if ($this->isColumnModified(LiregforpagmodcontPeer::CONDIC)) $criteria->add(LiregforpagmodcontPeer::CONDIC, $this->condic);
		if ($this->isColumnModified(LiregforpagmodcontPeer::TIPCONPUB)) $criteria->add(LiregforpagmodcontPeer::TIPCONPUB, $this->tipconpub);
		if ($this->isColumnModified(LiregforpagmodcontPeer::NUMORD)) $criteria->add(LiregforpagmodcontPeer::NUMORD, $this->numord);
		if ($this->isColumnModified(LiregforpagmodcontPeer::NUMCHE)) $criteria->add(LiregforpagmodcontPeer::NUMCHE, $this->numche);
		if ($this->isColumnModified(LiregforpagmodcontPeer::FECCOM)) $criteria->add(LiregforpagmodcontPeer::FECCOM, $this->feccom);
		if ($this->isColumnModified(LiregforpagmodcontPeer::FECCAU)) $criteria->add(LiregforpagmodcontPeer::FECCAU, $this->feccau);
		if ($this->isColumnModified(LiregforpagmodcontPeer::FECPAG)) $criteria->add(LiregforpagmodcontPeer::FECPAG, $this->fecpag);
		if ($this->isColumnModified(LiregforpagmodcontPeer::LIREGFORPAGCONT_ID)) $criteria->add(LiregforpagmodcontPeer::LIREGFORPAGCONT_ID, $this->liregforpagcont_id);
		if ($this->isColumnModified(LiregforpagmodcontPeer::NUMVAL)) $criteria->add(LiregforpagmodcontPeer::NUMVAL, $this->numval);
		if ($this->isColumnModified(LiregforpagmodcontPeer::ID)) $criteria->add(LiregforpagmodcontPeer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(LiregforpagmodcontPeer::ID, $this->id);
	...
	{
		if (self::$peer === null) {
			self::$peer = new LiregforpagmodcontPeer();
		}
		return self::$peer;
	}

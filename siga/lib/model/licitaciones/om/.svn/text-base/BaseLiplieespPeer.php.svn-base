...
abstract class BaseLiplieespPeer {
	...
	const CLASS_DEFAULT = 'lib.model.licitaciones.Liplieesp';
	...
	const FECDECLA = 'liplieesp.FECDECLA';

	
	const PORLEG = 'liplieesp.PORLEG';

	
	const MINLEG = 'liplieesp.MINLEG';

	
	const PORTEC = 'liplieesp.PORTEC';

	
	const MINTEC = 'liplieesp.MINTEC';

	
	const PORFIN = 'liplieesp.PORFIN';

	
	const MINFIN = 'liplieesp.MINFIN';

	
	const PORFIA = 'liplieesp.PORFIA';

	
	const MINFIA = 'liplieesp.MINFIA';

	
	const PORTIPEMP = 'liplieesp.PORTIPEMP';

	
	const MINTIPEMP = 'liplieesp.MINTIPEMP';

	
	const TIPCONPUB = 'liplieesp.TIPCONPUB';
	...
	{
		include_once 'lib/model/licitaciones/map/LiplieespMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.licitaciones.map.LiplieespMapBuilder');
	}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(LiplieespPeer::FECDECLA);

		$criteria->addSelectColumn(LiplieespPeer::PORLEG);

		$criteria->addSelectColumn(LiplieespPeer::MINLEG);

		$criteria->addSelectColumn(LiplieespPeer::PORTEC);

		$criteria->addSelectColumn(LiplieespPeer::MINTEC);

		$criteria->addSelectColumn(LiplieespPeer::PORFIN);

		$criteria->addSelectColumn(LiplieespPeer::MINFIN);

		$criteria->addSelectColumn(LiplieespPeer::PORFIA);

		$criteria->addSelectColumn(LiplieespPeer::MINFIA);

		$criteria->addSelectColumn(LiplieespPeer::PORTIPEMP);

		$criteria->addSelectColumn(LiplieespPeer::MINTIPEMP);

		$criteria->addSelectColumn(LiplieespPeer::TIPCONPUB);
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/licitaciones/map/LiplieespMapBuilder.php';
	Propel::registerMapBuilder('lib.model.licitaciones.map.LiplieespMapBuilder');
}

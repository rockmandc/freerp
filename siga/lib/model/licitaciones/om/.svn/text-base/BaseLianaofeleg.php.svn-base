...
abstract class BaseLianaofeleg extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->tipconpub !== $v) {
        $this->tipconpub = $v;
        $this->modifiedColumns[] = LianaofelegPeer::TIPCONPUB;
      }
  ...
  public function get($m, $a)
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(LianaofelegPeer::TIPCONPUB)) $criteria->add(LianaofelegPeer::TIPCONPUB, $this->tipconpub);

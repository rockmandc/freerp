...
abstract class BaseLiprebasdet extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->tipconpub !== $v) {
        $this->tipconpub = $v;
        $this->modifiedColumns[] = LiprebasdetPeer::TIPCONPUB;
      }
  ...
  public function get($m, $a)
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(LiprebasdetPeer::TIPCONPUB)) $criteria->add(LiprebasdetPeer::TIPCONPUB, $this->tipconpub);

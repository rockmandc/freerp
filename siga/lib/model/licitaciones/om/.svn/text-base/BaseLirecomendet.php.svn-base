...
abstract class BaseLirecomendet extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->tipconpub !== $v) {
        $this->tipconpub = $v;
        $this->modifiedColumns[] = LirecomendetPeer::TIPCONPUB;
      }
  ...
  public function get($m, $a)
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(LirecomendetPeer::TIPCONPUB)) $criteria->add(LirecomendetPeer::TIPCONPUB, $this->tipconpub);

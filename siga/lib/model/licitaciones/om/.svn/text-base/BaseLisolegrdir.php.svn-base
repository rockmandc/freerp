...
abstract class BaseLisolegrdir extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->tipconpub !== $v) {
        $this->tipconpub = $v;
        $this->modifiedColumns[] = LisolegrdirPeer::TIPCONPUB;
      }
  ...
  public function get($m, $a)
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(LisolegrdirPeer::TIPCONPUB)) $criteria->add(LisolegrdirPeer::TIPCONPUB, $this->tipconpub);

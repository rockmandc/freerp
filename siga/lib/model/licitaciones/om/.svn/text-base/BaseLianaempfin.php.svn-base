...
abstract class BaseLianaempfin extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->numanaemp !== $v) {
        $this->numanaemp = $v;
        $this->modifiedColumns[] = LianaempfinPeer::NUMANAEMP;
      }
    ...
    if ($this->codcri !== $v) {
        $this->codcri = $v;
        $this->modifiedColumns[] = LianaempfinPeer::CODCRI;
      }
    ...
    if ($this->punemp !== $v) {
        ...
        $this->modifiedColumns[] = LianaempfinPeer::PUNEMP;
      }
    ...
    if ($this->poremp !== $v) {
        ...
        $this->modifiedColumns[] = LianaempfinPeer::POREMP;
      }
    ...
    if ($this->observ !== $v) {
        $this->observ = $v;
        $this->modifiedColumns[] = LianaempfinPeer::OBSERV;
      }
    ...
    if ($this->tipconpub !== $v) {
        $this->tipconpub = $v;
        $this->modifiedColumns[] = LianaempfinPeer::TIPCONPUB;
      }
    ...
    if ($this->id !== $v) {
        $this->id = $v;
        $this->modifiedColumns[] = LianaempfinPeer::ID;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      throw new PropelException("Error populating Lianaempfin object", $e);
    }
  }
  ...
  public function get($m, $a)
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			LianaempfinPeer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			$this->alreadyInSave = true;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = LianaempfinPeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += LianaempfinPeer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = LianaempfinPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = LianaempfinPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = LianaempfinPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(LianaempfinPeer::NUMANAEMP)) $criteria->add(LianaempfinPeer::NUMANAEMP, $this->numanaemp);
		if ($this->isColumnModified(LianaempfinPeer::CODCRI)) $criteria->add(LianaempfinPeer::CODCRI, $this->codcri);
		if ($this->isColumnModified(LianaempfinPeer::PUNEMP)) $criteria->add(LianaempfinPeer::PUNEMP, $this->punemp);
		if ($this->isColumnModified(LianaempfinPeer::POREMP)) $criteria->add(LianaempfinPeer::POREMP, $this->poremp);
		if ($this->isColumnModified(LianaempfinPeer::OBSERV)) $criteria->add(LianaempfinPeer::OBSERV, $this->observ);
		if ($this->isColumnModified(LianaempfinPeer::TIPCONPUB)) $criteria->add(LianaempfinPeer::TIPCONPUB, $this->tipconpub);
		if ($this->isColumnModified(LianaempfinPeer::ID)) $criteria->add(LianaempfinPeer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(LianaempfinPeer::ID, $this->id);

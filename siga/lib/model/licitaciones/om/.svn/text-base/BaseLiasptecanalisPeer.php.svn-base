...
abstract class BaseLiasptecanalisPeer {
	...
	const CLASS_DEFAULT = 'lib.model.licitaciones.Liasptecanalis';
	...
	{
		include_once 'lib/model/licitaciones/map/LiasptecanalisMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.licitaciones.map.LiasptecanalisMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/licitaciones/map/LiasptecanalisMapBuilder.php';
	Propel::registerMapBuilder('lib.model.licitaciones.map.LiasptecanalisMapBuilder');
}

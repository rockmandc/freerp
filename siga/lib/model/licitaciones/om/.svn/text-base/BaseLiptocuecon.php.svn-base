...
abstract class BaseLiptocuecon extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->fecdecla !== $ts) {
      $this->fecdecla = $ts;
      $this->modifiedColumns[] = LiptocueconPeer::FECDECLA;
    }
    ...
    if ($this->tipconpub !== $v) {
        $this->tipconpub = $v;
        $this->modifiedColumns[] = LiptocueconPeer::TIPCONPUB;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->fecdecla = $rs->getDate($startcol + 28, null);
  ...
  public function get($m, $a)
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[28], $arr)) $this->setFecdecla($arr[$keys[28]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(LiptocueconPeer::FECDECLA)) $criteria->add(LiptocueconPeer::FECDECLA, $this->fecdecla);
		if ($this->isColumnModified(LiptocueconPeer::TIPCONPUB)) $criteria->add(LiptocueconPeer::TIPCONPUB, $this->tipconpub);

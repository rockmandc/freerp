...
abstract class BaseLireglicPeer {
	...
	const CLASS_DEFAULT = 'lib.model.licitaciones.Lireglic';
	...
	const ARCHIVOPLI = 'lireglic.ARCHIVOPLI';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Codlic', 'Deslic', 'LitiplicId', 'LisicactId', 'Fecreg', 'Fecedi', 'Numemo', 'Plamodifi', 'Plaaclara', 'Plaprorro', 'Fecdisdes', 'Fecdishas', 'Costo', 'Forpag', 'Decretos', 'Dirret', 'Percontac', 'Horaret', 'Periodico', 'Fecpub', 'Pagina', 'Cuerpo', 'Mes', 'Codpaiefec', 'Codpairecep', 'Codfin', 'Fecofer', 'Horaofer', 'Dirofer', 'Percontacofer', 'Codclacomp', 'Observaciones', 'Archivopli', 'Id', ),
		BasePeer::TYPE_COLNAME => array (LireglicPeer::CODLIC, LireglicPeer::DESLIC, LireglicPeer::LITIPLIC_ID, LireglicPeer::LISICACT_ID, LireglicPeer::FECREG, LireglicPeer::FECEDI, LireglicPeer::NUMEMO, LireglicPeer::PLAMODIFI, LireglicPeer::PLAACLARA, LireglicPeer::PLAPRORRO, LireglicPeer::FECDISDES, LireglicPeer::FECDISHAS, LireglicPeer::COSTO, LireglicPeer::FORPAG, LireglicPeer::DECRETOS, LireglicPeer::DIRRET, LireglicPeer::PERCONTAC, LireglicPeer::HORARET, LireglicPeer::PERIODICO, LireglicPeer::FECPUB, LireglicPeer::PAGINA, LireglicPeer::CUERPO, LireglicPeer::MES, LireglicPeer::CODPAIEFEC, LireglicPeer::CODPAIRECEP, LireglicPeer::CODFIN, LireglicPeer::FECOFER, LireglicPeer::HORAOFER, LireglicPeer::DIROFER, LireglicPeer::PERCONTACOFER, LireglicPeer::CODCLACOMP, LireglicPeer::OBSERVACIONES, LireglicPeer::ARCHIVOPLI, LireglicPeer::ID, ),
		BasePeer::TYPE_FIELDNAME => array ('codlic', 'deslic', 'litiplic_id', 'lisicact_id', 'fecreg', 'fecedi', 'numemo', 'plamodifi', 'plaaclara', 'plaprorro', 'fecdisdes', 'fecdishas', 'costo', 'forpag', 'decretos', 'dirret', 'percontac', 'horaret', 'periodico', 'fecpub', 'pagina', 'cuerpo', 'mes', 'codpaiefec', 'codpairecep', 'codfin', 'fecofer', 'horaofer', 'dirofer', 'percontacofer', 'codclacomp', 'observaciones', 'archivopli', 'id', ),
	...
	{
		include_once 'lib/model/licitaciones/map/LireglicMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.licitaciones.map.LireglicMapBuilder');
	}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(LireglicPeer::NUMEMO);
		...
		$criteria->addSelectColumn(LireglicPeer::ARCHIVOPLI);
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/licitaciones/map/LireglicMapBuilder.php';
	Propel::registerMapBuilder('lib.model.licitaciones.map.LireglicMapBuilder');
}

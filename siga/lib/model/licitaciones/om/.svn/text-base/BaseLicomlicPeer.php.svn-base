...
abstract class BaseLicomlicPeer {
	...
	const CLASS_DEFAULT = 'lib.model.licitaciones.Licomlic';
	...
	{
		include_once 'lib/model/licitaciones/map/LicomlicMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.licitaciones.map.LicomlicMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/licitaciones/map/LicomlicMapBuilder.php';
	Propel::registerMapBuilder('lib.model.licitaciones.map.LicomlicMapBuilder');
}

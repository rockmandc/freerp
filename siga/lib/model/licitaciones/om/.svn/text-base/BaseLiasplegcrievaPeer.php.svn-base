...
abstract class BaseLiasplegcrievaPeer {
	...
	const CLASS_DEFAULT = 'lib.model.licitaciones.Liasplegcrieva';
	...
	{
		include_once 'lib/model/licitaciones/map/LiasplegcrievaMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.licitaciones.map.LiasplegcrievaMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/licitaciones/map/LiasplegcrievaMapBuilder.php';
	Propel::registerMapBuilder('lib.model.licitaciones.map.LiasplegcrievaMapBuilder');
}

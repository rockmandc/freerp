...
abstract class BaseLiempofePeer {
	...
	const CLASS_DEFAULT = 'lib.model.licitaciones.Liempofe';
	...
	const TIPCONPUB = 'liempofe.TIPCONPUB';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Numplie', 'Numexp', 'Codpro', 'Fecofe', 'Observaciones', 'Montot', 'Tipconpub', 'Id', ),
		BasePeer::TYPE_COLNAME => array (LiempofePeer::NUMPLIE, LiempofePeer::NUMEXP, LiempofePeer::CODPRO, LiempofePeer::FECOFE, LiempofePeer::OBSERVACIONES, LiempofePeer::MONTOT, LiempofePeer::TIPCONPUB, LiempofePeer::ID, ),
		BasePeer::TYPE_FIELDNAME => array ('numplie', 'numexp', 'codpro', 'fecofe', 'observaciones', 'montot', 'tipconpub', 'id', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Numplie' => 0, 'Numexp' => 1, 'Codpro' => 2, 'Fecofe' => 3, 'Observaciones' => 4, 'Montot' => 5, 'Tipconpub' => 6, 'Id' => 7, ),
		BasePeer::TYPE_COLNAME => array (LiempofePeer::NUMPLIE => 0, LiempofePeer::NUMEXP => 1, LiempofePeer::CODPRO => 2, LiempofePeer::FECOFE => 3, LiempofePeer::OBSERVACIONES => 4, LiempofePeer::MONTOT => 5, LiempofePeer::TIPCONPUB => 6, LiempofePeer::ID => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('numplie' => 0, 'numexp' => 1, 'codpro' => 2, 'fecofe' => 3, 'observaciones' => 4, 'montot' => 5, 'tipconpub' => 6, 'id' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	{
		include_once 'lib/model/licitaciones/map/LiempofeMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.licitaciones.map.LiempofeMapBuilder');
	}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(LiempofePeer::TIPCONPUB);
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/licitaciones/map/LiempofeMapBuilder.php';
	Propel::registerMapBuilder('lib.model.licitaciones.map.LiempofeMapBuilder');
}

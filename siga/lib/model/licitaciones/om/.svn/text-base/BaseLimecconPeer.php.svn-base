...
abstract class BaseLimecconPeer {
	...
	const CLASS_DEFAULT = 'lib.model.licitaciones.Limeccon';
	...
	{
		include_once 'lib/model/licitaciones/map/LimecconMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.licitaciones.map.LimecconMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/licitaciones/map/LimecconMapBuilder.php';
	Propel::registerMapBuilder('lib.model.licitaciones.map.LimecconMapBuilder');
}

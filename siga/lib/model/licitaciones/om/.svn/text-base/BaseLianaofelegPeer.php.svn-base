...
abstract class BaseLianaofelegPeer {
	...
	const CLASS_DEFAULT = 'lib.model.licitaciones.Lianaofeleg';
	...
	const TIPCONPUB = 'lianaofeleg.TIPCONPUB';
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (LianaofelegPeer::NUMANAOFE, LianaofelegPeer::CODCRI, LianaofelegPeer::PUNEMP, LianaofelegPeer::POREMP, LianaofelegPeer::OBSERV, LianaofelegPeer::TIPCONPUB, LianaofelegPeer::ID, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (LianaofelegPeer::NUMANAOFE => 0, LianaofelegPeer::CODCRI => 1, LianaofelegPeer::PUNEMP => 2, LianaofelegPeer::POREMP => 3, LianaofelegPeer::OBSERV => 4, LianaofelegPeer::TIPCONPUB => 5, LianaofelegPeer::ID => 6, ),
	...
	{
		include_once 'lib/model/licitaciones/map/LianaofelegMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.licitaciones.map.LianaofelegMapBuilder');
	}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(LianaofelegPeer::TIPCONPUB);
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/licitaciones/map/LianaofelegMapBuilder.php';
	Propel::registerMapBuilder('lib.model.licitaciones.map.LianaofelegMapBuilder');
}

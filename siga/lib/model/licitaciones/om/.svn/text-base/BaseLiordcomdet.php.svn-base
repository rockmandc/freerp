...
abstract class BaseLiordcomdet extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->numord !== $v) {
        $this->numord = $v;
        $this->modifiedColumns[] = LiordcomdetPeer::NUMORD;
      }
    ...
    if ($this->codart !== $v) {
        $this->codart = $v;
        $this->modifiedColumns[] = LiordcomdetPeer::CODART;
      }
    ...
    if ($this->unimed !== $v) {
        $this->unimed = $v;
        $this->modifiedColumns[] = LiordcomdetPeer::UNIMED;
      }
    ...
    if ($this->cantid !== $v) {
        ...
        $this->modifiedColumns[] = LiordcomdetPeer::CANTID;
      }
    ...
    if ($this->preuni !== $v) {
        ...
        $this->modifiedColumns[] = LiordcomdetPeer::PREUNI;
      }
    ...
    if ($this->monrec !== $v) {
        ...
        $this->modifiedColumns[] = LiordcomdetPeer::MONREC;
      }
    ...
    if ($this->subtot !== $v) {
        ...
        $this->modifiedColumns[] = LiordcomdetPeer::SUBTOT;
      }
    ...
    if ($this->id !== $v) {
        $this->id = $v;
        $this->modifiedColumns[] = LiordcomdetPeer::ID;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      throw new PropelException("Error populating Liordcomdet object", $e);
    }
  }
  ...
  public function get($m, $a)
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			LiordcomdetPeer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			$this->alreadyInSave = true;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = LiordcomdetPeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += LiordcomdetPeer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = LiordcomdetPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = LiordcomdetPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = LiordcomdetPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(LiordcomdetPeer::NUMORD)) $criteria->add(LiordcomdetPeer::NUMORD, $this->numord);
		if ($this->isColumnModified(LiordcomdetPeer::CODART)) $criteria->add(LiordcomdetPeer::CODART, $this->codart);
		if ($this->isColumnModified(LiordcomdetPeer::UNIMED)) $criteria->add(LiordcomdetPeer::UNIMED, $this->unimed);
		if ($this->isColumnModified(LiordcomdetPeer::CANTID)) $criteria->add(LiordcomdetPeer::CANTID, $this->cantid);
		if ($this->isColumnModified(LiordcomdetPeer::PREUNI)) $criteria->add(LiordcomdetPeer::PREUNI, $this->preuni);
		if ($this->isColumnModified(LiordcomdetPeer::MONREC)) $criteria->add(LiordcomdetPeer::MONREC, $this->monrec);
		if ($this->isColumnModified(LiordcomdetPeer::SUBTOT)) $criteria->add(LiordcomdetPeer::SUBTOT, $this->subtot);
		if ($this->isColumnModified(LiordcomdetPeer::ID)) $criteria->add(LiordcomdetPeer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(LiordcomdetPeer::ID, $this->id);

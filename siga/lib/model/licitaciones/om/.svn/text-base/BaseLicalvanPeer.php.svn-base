...
abstract class BaseLicalvanPeer {
	...
	const CLASS_DEFAULT = 'lib.model.licitaciones.Licalvan';
	...
	{
		include_once 'lib/model/licitaciones/map/LicalvanMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.licitaciones.map.LicalvanMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/licitaciones/map/LicalvanMapBuilder.php';
	Propel::registerMapBuilder('lib.model.licitaciones.map.LicalvanMapBuilder');
}

...
abstract class BaseLipliedepPeer {
	...
	const CLASS_DEFAULT = 'lib.model.licitaciones.Lipliedep';
	...
	const TIPCONPUB = 'lipliedep.TIPCONPUB';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Numplie', 'Numexp', 'Numcue', 'Nomcue', 'Tipcue', 'Tipconpub', 'Id', ),
		BasePeer::TYPE_COLNAME => array (LipliedepPeer::NUMPLIE, LipliedepPeer::NUMEXP, LipliedepPeer::NUMCUE, LipliedepPeer::NOMCUE, LipliedepPeer::TIPCUE, LipliedepPeer::TIPCONPUB, LipliedepPeer::ID, ),
		BasePeer::TYPE_FIELDNAME => array ('numplie', 'numexp', 'numcue', 'nomcue', 'tipcue', 'tipconpub', 'id', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Numplie' => 0, 'Numexp' => 1, 'Numcue' => 2, 'Nomcue' => 3, 'Tipcue' => 4, 'Tipconpub' => 5, 'Id' => 6, ),
		BasePeer::TYPE_COLNAME => array (LipliedepPeer::NUMPLIE => 0, LipliedepPeer::NUMEXP => 1, LipliedepPeer::NUMCUE => 2, LipliedepPeer::NOMCUE => 3, LipliedepPeer::TIPCUE => 4, LipliedepPeer::TIPCONPUB => 5, LipliedepPeer::ID => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('numplie' => 0, 'numexp' => 1, 'numcue' => 2, 'nomcue' => 3, 'tipcue' => 4, 'tipconpub' => 5, 'id' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	{
		include_once 'lib/model/licitaciones/map/LipliedepMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.licitaciones.map.LipliedepMapBuilder');
	}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(LipliedepPeer::TIPCONPUB);
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/licitaciones/map/LipliedepMapBuilder.php';
	Propel::registerMapBuilder('lib.model.licitaciones.map.LipliedepMapBuilder');
}

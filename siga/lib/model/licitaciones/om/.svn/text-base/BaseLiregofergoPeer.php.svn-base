...
abstract class BaseLiregofergoPeer {
	...
	const CLASS_DEFAULT = 'lib.model.licitaciones.Liregofergo';
	...
	const TIPCONPUB = 'liregofergo.TIPCONPUB';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Numofe', 'Codrgo', 'Monrgo', 'Tipconpub', 'Id', ),
		BasePeer::TYPE_COLNAME => array (LiregofergoPeer::NUMOFE, LiregofergoPeer::CODRGO, LiregofergoPeer::MONRGO, LiregofergoPeer::TIPCONPUB, LiregofergoPeer::ID, ),
		BasePeer::TYPE_FIELDNAME => array ('numofe', 'codrgo', 'monrgo', 'tipconpub', 'id', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Numofe' => 0, 'Codrgo' => 1, 'Monrgo' => 2, 'Tipconpub' => 3, 'Id' => 4, ),
		BasePeer::TYPE_COLNAME => array (LiregofergoPeer::NUMOFE => 0, LiregofergoPeer::CODRGO => 1, LiregofergoPeer::MONRGO => 2, LiregofergoPeer::TIPCONPUB => 3, LiregofergoPeer::ID => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('numofe' => 0, 'codrgo' => 1, 'monrgo' => 2, 'tipconpub' => 3, 'id' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	{
		include_once 'lib/model/licitaciones/map/LiregofergoMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.licitaciones.map.LiregofergoMapBuilder');
	}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(LiregofergoPeer::TIPCONPUB);
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/licitaciones/map/LiregofergoMapBuilder.php';
	Propel::registerMapBuilder('lib.model.licitaciones.map.LiregofergoMapBuilder');
}

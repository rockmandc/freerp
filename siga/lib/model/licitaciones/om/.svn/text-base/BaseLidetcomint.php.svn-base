...
abstract class BaseLidetcomint extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->valcam !== $v) {
        ...
        $this->modifiedColumns[] = LidetcomintPeer::VALCAM;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->valcam = $rs->getFloat($startcol + 3);
  ...
  public function get($m, $a)
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setValcam($arr[$keys[3]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(LidetcomintPeer::VALCAM)) $criteria->add(LidetcomintPeer::VALCAM, $this->valcam);

...
abstract class BaseLioferprePeer {
	...
	const CLASS_DEFAULT = 'lib.model.licitaciones.Lioferpre';
	...
	{
		include_once 'lib/model/licitaciones/map/LioferpreMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.licitaciones.map.LioferpreMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/licitaciones/map/LioferpreMapBuilder.php';
	Propel::registerMapBuilder('lib.model.licitaciones.map.LioferpreMapBuilder');
}

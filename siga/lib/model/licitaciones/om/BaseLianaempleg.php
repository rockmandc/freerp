...
abstract class BaseLianaempleg extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->numanaemp !== $v) {
        $this->numanaemp = $v;
        $this->modifiedColumns[] = LianaemplegPeer::NUMANAEMP;
      }
    ...
    if ($this->codcri !== $v) {
        $this->codcri = $v;
        $this->modifiedColumns[] = LianaemplegPeer::CODCRI;
      }
    ...
    if ($this->punemp !== $v) {
        ...
        $this->modifiedColumns[] = LianaemplegPeer::PUNEMP;
      }
    ...
    if ($this->poremp !== $v) {
        ...
        $this->modifiedColumns[] = LianaemplegPeer::POREMP;
      }
    ...
    if ($this->observ !== $v) {
        $this->observ = $v;
        $this->modifiedColumns[] = LianaemplegPeer::OBSERV;
      }
    ...
    if ($this->tipconpub !== $v) {
        $this->tipconpub = $v;
        $this->modifiedColumns[] = LianaemplegPeer::TIPCONPUB;
      }
    ...
    if ($this->id !== $v) {
        $this->id = $v;
        $this->modifiedColumns[] = LianaemplegPeer::ID;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      throw new PropelException("Error populating Lianaempleg object", $e);
    }
  }
  ...
  public function get($m, $a)
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			LianaemplegPeer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			$this->alreadyInSave = true;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = LianaemplegPeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += LianaemplegPeer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = LianaemplegPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = LianaemplegPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = LianaemplegPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(LianaemplegPeer::NUMANAEMP)) $criteria->add(LianaemplegPeer::NUMANAEMP, $this->numanaemp);
		if ($this->isColumnModified(LianaemplegPeer::CODCRI)) $criteria->add(LianaemplegPeer::CODCRI, $this->codcri);
		if ($this->isColumnModified(LianaemplegPeer::PUNEMP)) $criteria->add(LianaemplegPeer::PUNEMP, $this->punemp);
		if ($this->isColumnModified(LianaemplegPeer::POREMP)) $criteria->add(LianaemplegPeer::POREMP, $this->poremp);
		if ($this->isColumnModified(LianaemplegPeer::OBSERV)) $criteria->add(LianaemplegPeer::OBSERV, $this->observ);
		if ($this->isColumnModified(LianaemplegPeer::TIPCONPUB)) $criteria->add(LianaemplegPeer::TIPCONPUB, $this->tipconpub);
		if ($this->isColumnModified(LianaemplegPeer::ID)) $criteria->add(LianaemplegPeer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(LianaemplegPeer::ID, $this->id);

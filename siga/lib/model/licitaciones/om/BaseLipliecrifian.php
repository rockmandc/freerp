...
abstract class BaseLipliecrifian extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->limita !== $v) {
        $this->limita = $v;
        $this->modifiedColumns[] = LipliecrifianPeer::LIMITA;
      }
    ...
    if ($this->tipconpub !== $v) {
        $this->tipconpub = $v;
        $this->modifiedColumns[] = LipliecrifianPeer::TIPCONPUB;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->limita = $rs->getString($startcol + 8);
  ...
  public function get($m, $a)
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[8], $arr)) $this->setLimita($arr[$keys[8]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(LipliecrifianPeer::LIMITA)) $criteria->add(LipliecrifianPeer::LIMITA, $this->limita);
		if ($this->isColumnModified(LipliecrifianPeer::TIPCONPUB)) $criteria->add(LipliecrifianPeer::TIPCONPUB, $this->tipconpub);

...
abstract class BaseLinotific extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->fecdecla !== $ts) {
      $this->fecdecla = $ts;
      $this->modifiedColumns[] = LinotificPeer::FECDECLA;
    }
    ...
    if ($this->tipconpub !== $v) {
        $this->tipconpub = $v;
        $this->modifiedColumns[] = LinotificPeer::TIPCONPUB;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->tipconpub = $rs->getString($startcol + 25);
  ...
  public function get($m, $a)
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[25], $arr)) $this->setTipconpub($arr[$keys[25]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(LinotificPeer::FECDECLA)) $criteria->add(LinotificPeer::FECDECLA, $this->fecdecla);
		if ($this->isColumnModified(LinotificPeer::TIPCONPUB)) $criteria->add(LinotificPeer::TIPCONPUB, $this->tipconpub);

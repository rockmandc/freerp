...
abstract class BaseLiregofePeer {
	...
	const CLASS_DEFAULT = 'lib.model.licitaciones.Liregofe';
	...
	const MONOFETOT = 'liregofe.MONOFETOT';
	...
	const FECDECLA = 'liregofe.FECDECLA';

	
	const TIPCONPUB = 'liregofe.TIPCONPUB';
	...
	{
		include_once 'lib/model/licitaciones/map/LiregofeMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.licitaciones.map.LiregofeMapBuilder');
	}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(LiregofePeer::MONOFETOT);

		$criteria->addSelectColumn(LiregofePeer::PORVAN);

		$criteria->addSelectColumn(LiregofePeer::DECLAR);

		$criteria->addSelectColumn(LiregofePeer::FECDECLA);

		$criteria->addSelectColumn(LiregofePeer::TIPCONPUB);
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/licitaciones/map/LiregofeMapBuilder.php';
	Propel::registerMapBuilder('lib.model.licitaciones.map.LiregofeMapBuilder');
}

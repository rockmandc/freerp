...
abstract class BaseLianaofefiaPeer {
	...
	const CLASS_DEFAULT = 'lib.model.licitaciones.Lianaofefia';
	...
	const TIPCONPUB = 'lianaofefia.TIPCONPUB';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Numanaofe', 'Codcomres', 'Punemp', 'Poremp', 'Observ', 'Tipconpub', 'Id', ),
		BasePeer::TYPE_COLNAME => array (LianaofefiaPeer::NUMANAOFE, LianaofefiaPeer::CODCOMRES, LianaofefiaPeer::PUNEMP, LianaofefiaPeer::POREMP, LianaofefiaPeer::OBSERV, LianaofefiaPeer::TIPCONPUB, LianaofefiaPeer::ID, ),
		BasePeer::TYPE_FIELDNAME => array ('numanaofe', 'codcomres', 'punemp', 'poremp', 'observ', 'tipconpub', 'id', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Numanaofe' => 0, 'Codcomres' => 1, 'Punemp' => 2, 'Poremp' => 3, 'Observ' => 4, 'Tipconpub' => 5, 'Id' => 6, ),
		BasePeer::TYPE_COLNAME => array (LianaofefiaPeer::NUMANAOFE => 0, LianaofefiaPeer::CODCOMRES => 1, LianaofefiaPeer::PUNEMP => 2, LianaofefiaPeer::POREMP => 3, LianaofefiaPeer::OBSERV => 4, LianaofefiaPeer::TIPCONPUB => 5, LianaofefiaPeer::ID => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('numanaofe' => 0, 'codcomres' => 1, 'punemp' => 2, 'poremp' => 3, 'observ' => 4, 'tipconpub' => 5, 'id' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	{
		include_once 'lib/model/licitaciones/map/LianaofefiaMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.licitaciones.map.LianaofefiaMapBuilder');
	}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(LianaofefiaPeer::TIPCONPUB);
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/licitaciones/map/LianaofefiaMapBuilder.php';
	Propel::registerMapBuilder('lib.model.licitaciones.map.LianaofefiaMapBuilder');
}

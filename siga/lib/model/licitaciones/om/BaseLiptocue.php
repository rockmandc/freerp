...
abstract class BaseLiptocue extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->fecreg !== $ts) {
      $this->fecreg = $ts;
      $this->modifiedColumns[] = LiptocuePeer::FECREG;
    }
    ...
    if ($this->dias !== $v) {
        $this->dias = $v;
        $this->modifiedColumns[] = LiptocuePeer::DIAS;
      }
    ...
    if ($this->fecven !== $ts) {
      $this->fecven = $ts;
      $this->modifiedColumns[] = LiptocuePeer::FECVEN;
    }
    ...
    if ($this->fecdecla !== $ts) {
      $this->fecdecla = $ts;
      $this->modifiedColumns[] = LiptocuePeer::FECDECLA;
    }
    ...
    if ($this->tipconpub !== $v) {
        $this->tipconpub = $v;
        $this->modifiedColumns[] = LiptocuePeer::TIPCONPUB;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->fecreg = $rs->getDate($startcol + 18, null);

      $this->dias = $rs->getInt($startcol + 19);

      $this->fecven = $rs->getDate($startcol + 20, null);

      $this->fecdecla = $rs->getDate($startcol + 21, null);

      $this->tipconpub = $rs->getString($startcol + 22);
  ...
  public function get($m, $a)
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		$result = array(
			...
			$keys[18] => $this->getFecreg(),
			$keys[19] => $this->getDias(),
			$keys[20] => $this->getFecven(),
			$keys[21] => $this->getFecdecla(),
			$keys[22] => $this->getTipconpub(),
			$keys[23] => $this->getId(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[18], $arr)) $this->setFecreg($arr[$keys[18]]);
		if (array_key_exists($keys[19], $arr)) $this->setDias($arr[$keys[19]]);
		if (array_key_exists($keys[20], $arr)) $this->setFecven($arr[$keys[20]]);
		if (array_key_exists($keys[21], $arr)) $this->setFecdecla($arr[$keys[21]]);
		if (array_key_exists($keys[22], $arr)) $this->setTipconpub($arr[$keys[22]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(LiptocuePeer::FECREG)) $criteria->add(LiptocuePeer::FECREG, $this->fecreg);
		if ($this->isColumnModified(LiptocuePeer::DIAS)) $criteria->add(LiptocuePeer::DIAS, $this->dias);
		if ($this->isColumnModified(LiptocuePeer::FECVEN)) $criteria->add(LiptocuePeer::FECVEN, $this->fecven);
		if ($this->isColumnModified(LiptocuePeer::FECDECLA)) $criteria->add(LiptocuePeer::FECDECLA, $this->fecdecla);
		if ($this->isColumnModified(LiptocuePeer::TIPCONPUB)) $criteria->add(LiptocuePeer::TIPCONPUB, $this->tipconpub);

...
abstract class BaseLiaspteccrievaPeer {
	...
	const CLASS_DEFAULT = 'lib.model.licitaciones.Liaspteccrieva';
	...
	{
		include_once 'lib/model/licitaciones/map/LiaspteccrievaMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.licitaciones.map.LiaspteccrievaMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/licitaciones/map/LiaspteccrievaMapBuilder.php';
	Propel::registerMapBuilder('lib.model.licitaciones.map.LiaspteccrievaMapBuilder');
}

...
abstract class BaseLiaclara extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->tipconpub !== $v) {
        $this->tipconpub = $v;
        $this->modifiedColumns[] = LiaclaraPeer::TIPCONPUB;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->tipconpub = $rs->getString($startcol + 20);
  ...
  public function get($m, $a)
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[20], $arr)) $this->setTipconpub($arr[$keys[20]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(LiaclaraPeer::TIPCONPUB)) $criteria->add(LiaclaraPeer::TIPCONPUB, $this->tipconpub);

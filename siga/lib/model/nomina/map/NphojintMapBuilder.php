...
class NphojintMapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('POSVEH', 'Posveh', 'boolean', CreoleTypes::BOOLEAN, false, null);

		$tMap->addColumn('MARVEH', 'Marveh', 'string', CreoleTypes::VARCHAR, false, 100);

		$tMap->addColumn('MODVEH', 'Modveh', 'string', CreoleTypes::VARCHAR, false, 100);

		$tMap->addColumn('COLVEH', 'Colveh', 'string', CreoleTypes::VARCHAR, false, 100);

		$tMap->addColumn('ANOVEH', 'Anoveh', 'string', CreoleTypes::VARCHAR, false, 100);

		$tMap->addColumn('PLAVEH', 'Plaveh', 'string', CreoleTypes::VARCHAR, false, 100);

		$tMap->addColumn('EMAOPC', 'Emaopc', 'string', CreoleTypes::VARCHAR, false, 40);

		$tMap->addColumn('PESEMP', 'Pesemp', 'double', CreoleTypes::NUMERIC, false, 14);

		$tMap->addColumn('ESTEMP', 'Estemp', 'double', CreoleTypes::NUMERIC, false, 14);

		$tMap->addColumn('PRIVEHMOT', 'Privehmot', 'boolean', CreoleTypes::BOOLEAN, false, null);

		$tMap->addColumn('SOSHOG', 'Soshog', 'boolean', CreoleTypes::BOOLEAN, false, null);

		$tMap->addColumn('CAPBIE', 'Capbie', 'boolean', CreoleTypes::BOOLEAN, false, null);

		$tMap->addColumn('TIPMED', 'Tipmed', 'string', CreoleTypes::VARCHAR, false, 1000);

		$tMap->addColumn('ESALERG', 'Esalerg', 'boolean', CreoleTypes::BOOLEAN, false, null);

		$tMap->addColumn('DESALER', 'Desaler', 'string', CreoleTypes::VARCHAR, false, 1000);

		$tMap->addColumn('MONINDEM', 'Monindem', 'double', CreoleTypes::NUMERIC, false, 14);

		$tMap->addColumn('TIPETN', 'Tipetn', 'string', CreoleTypes::VARCHAR, false, 500);

		$tMap->addColumn('CODPAINAC', 'Codpainac', 'string', CreoleTypes::VARCHAR, false, 4);

		$tMap->addColumn('NUMPAS', 'Numpas', 'string', CreoleTypes::VARCHAR, false, 20);

		$tMap->addColumn('CODPRO', 'Codpro', 'string', CreoleTypes::VARCHAR, false, 4);

		$tMap->addColumn('FECTITULAR', 'Fectitular', 'int', CreoleTypes::DATE, false, null);

		$tMap->addColumn('TIPCUEFID', 'Tipcuefid', 'string', CreoleTypes::VARCHAR, false, 20);

		$tMap->addColumn('TIEFUN', 'Tiefun', 'boolean', CreoleTypes::BOOLEAN, false, null);

		$tMap->addColumn('NUMTARCES', 'Numtarces', 'string', CreoleTypes::VARCHAR, false, 50);

		$tMap->addColumn('PRITRA', 'Pritra', 'string', CreoleTypes::VARCHAR, false, 1);

		$tMap->addColumn('CUEBANMAT', 'Cuebanmat', 'string', CreoleTypes::VARCHAR, false, 20);

		$tMap->addColumn('CODOFI', 'Codofi', 'string', CreoleTypes::VARCHAR, false, 4);

		$tMap->addColumn('CODDEP', 'Coddep', 'string', CreoleTypes::VARCHAR, false, 4);
		...
		$tMap->addColumn('CODUNIADS', 'Coduniads', 'string', CreoleTypes::VARCHAR, false, 20);

		$tMap->addColumn('CODPAGBON', 'Codpagbon', 'string', CreoleTypes::VARCHAR, false, 2);

		$tMap->addColumn('CODBANBON', 'Codbanbon', 'string', CreoleTypes::VARCHAR, false, 2);

		$tMap->addColumn('TIPCUEBON', 'Tipcuebon', 'string', CreoleTypes::VARCHAR, false, 20);

		$tMap->addColumn('NUMCUEBON', 'Numcuebon', 'string', CreoleTypes::VARCHAR, false, 31);

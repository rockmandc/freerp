...
class NpinffamMapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('VALGUA', 'Valgua', 'double', CreoleTypes::NUMERIC, false, 14);
		...
		$tMap->addColumn('CONFIS', 'Confis', 'string', CreoleTypes::VARCHAR, false, 500);

		$tMap->addColumn('NIVACA', 'Nivaca', 'string', CreoleTypes::VARCHAR, false, 500);

		$tMap->addColumn('OBSERV', 'Observ', 'string', CreoleTypes::VARCHAR, false, 1000);

		$tMap->addColumn('STATUS', 'Status', 'string', CreoleTypes::VARCHAR, false, 1);

		$tMap->addColumn('CTAPEN', 'Ctapen', 'string', CreoleTypes::VARCHAR, false, 20);

		$tMap->addColumn('CPTPEN', 'Cptpen', 'string', CreoleTypes::VARCHAR, false, 3);

		$tMap->addColumn('SEGFUN', 'Segfun', 'boolean', CreoleTypes::BOOLEAN, false, null);

		$tMap->addColumn('FECINGHCM', 'Fecinghcm', 'int', CreoleTypes::DATE, false, null);

		$tMap->addColumn('CONINSEST', 'Coninsest', 'string', CreoleTypes::VARCHAR, false, 1);

		$tMap->addColumn('BECESC', 'Becesc', 'string', CreoleTypes::VARCHAR, false, 1);

		$tMap->addColumn('FECENTCIE', 'Fecentcie', 'int', CreoleTypes::DATE, false, null);

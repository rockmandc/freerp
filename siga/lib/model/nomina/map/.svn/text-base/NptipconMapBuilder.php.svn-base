...
class NptipconMapBuilder {
	...
	const CLASS_NAME = 'lib.model.nomina.map.NptipconMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('MESINI', 'Mesini', 'int', CreoleTypes::INTEGER, false, null);

		$tMap->addColumn('TRIMFIS', 'Trimfis', 'string', CreoleTypes::VARCHAR, false, 1);

		$tMap->addColumn('FECFIN108', 'Fecfin108', 'int', CreoleTypes::DATE, false, null);

		$tMap->addColumn('APLIREGANT', 'Apliregant', 'string', CreoleTypes::VARCHAR, false, 1);

...
class NpcargosMapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('CARVAN', 'Carvan', 'int', CreoleTypes::INTEGER, false, null);
		...
		$tMap->addColumn('CANVHOM', 'Canvhom', 'int', CreoleTypes::INTEGER, false, null);

		$tMap->addColumn('CANVMUJ', 'Canvmuj', 'int', CreoleTypes::INTEGER, false, null);

		$tMap->addColumn('CODNIV', 'Codniv', 'string', CreoleTypes::VARCHAR, false, 2);

		$tMap->addColumn('RETCAR', 'Retcar', 'double', CreoleTypes::NUMERIC, false, 14);

		$tMap->addColumn('CANPMIX', 'Canpmix', 'double', CreoleTypes::NUMERIC, false, 6);

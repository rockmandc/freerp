...
class NpcosnivfMapBuilder {

	
	const CLASS_NAME = 'lib.model.nomina.map.NpcosnivfMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('npcosnivf');
		$tMap->setPhpName('Npcosnivf');

		$tMap->setUseIdGenerator(true);

		$tMap->setPrimaryKeyMethodInfo('npcosnivf_SEQ');

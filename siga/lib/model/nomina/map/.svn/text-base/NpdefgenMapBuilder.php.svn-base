...
class NpdefgenMapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('FORORG', 'Fororg', 'string', CreoleTypes::VARCHAR, true, 32);
		...
		$tMap->addColumn('FORCED', 'Forced', 'string', CreoleTypes::VARCHAR, false, 10);

		$tMap->addColumn('CORAYU', 'Corayu', 'double', CreoleTypes::NUMERIC, false, 8);

		$tMap->addColumn('SUEMIN', 'Suemin', 'double', CreoleTypes::NUMERIC, false, 14);
		...
		$tMap->addColumn('CORPTO', 'Corpto', 'double', CreoleTypes::NUMERIC, false, 8);

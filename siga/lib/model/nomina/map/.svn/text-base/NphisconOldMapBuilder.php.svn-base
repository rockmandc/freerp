...
class NphisconOldMapBuilder {

	
	const CLASS_NAME = 'lib.model.nomina.map.NphisconOldMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('nphiscon_old');
		$tMap->setPhpName('NphisconOld');

		$tMap->setUseIdGenerator(true);

		$tMap->setPrimaryKeyMethodInfo('nphiscon_old_SEQ');

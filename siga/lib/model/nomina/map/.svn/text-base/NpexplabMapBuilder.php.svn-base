...
class NpexplabMapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('ESTLAB', 'Estlab', 'string', CreoleTypes::VARCHAR, false, 1);

		$tMap->addColumn('MOTEGR', 'Motegr', 'string', CreoleTypes::VARCHAR, false, 500);

		$tMap->addColumn('DESNIV', 'Desniv', 'string', CreoleTypes::VARCHAR, false, 200);

		$tMap->addColumn('PAGPRE', 'Pagpre', 'string', CreoleTypes::VARCHAR, false, 1);
		...
		$tMap->addColumn('REFDOC', 'Refdoc', 'string', CreoleTypes::VARCHAR, false, 2000);

		$tMap->addColumn('EDUUNI', 'Eduuni', 'string', CreoleTypes::VARCHAR, false, 1);

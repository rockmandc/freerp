...
class NptabhcmMapBuilder {

	
	const CLASS_NAME = 'lib.model.nomina.map.NptabhcmMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('nptabhcm');
		$tMap->setPhpName('Nptabhcm');

		$tMap->setUseIdGenerator(true);

		$tMap->setPrimaryKeyMethodInfo('nptabhcm_SEQ');

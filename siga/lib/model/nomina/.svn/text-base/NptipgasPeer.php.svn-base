...
/**
 * Subclase para crear funcionalidades específicas de busqueda y actualización en la tabla 'nptipgas'.
 *
 * 
 *
 * @package    Roraima
...
const COLUMNS = 'columns';
  ...
  public static function getGastos()
  {
    ...
    $c = new Criteria();
    $m = NptipgasPeer::doSelect($c);
    if($m){
      foreach($m as $mon){
        $resp[$mon->getCodtipgas()] = $mon->getDestipgas();
      }
    }
    return $resp;
  }

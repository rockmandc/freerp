...
abstract class BaseNphojint extends BaseObject  implements Persistent {
  ...
  public function getEmaopc()
  {

    return trim($this->emaopc);

  }
  
  public function getPesemp($val=false)
  {

    if($val) return number_format($this->pesemp,2,',','.');
    else return $this->pesemp;

  }
  
  public function getEstemp($val=false)
  {

    if($val) return number_format($this->estemp,2,',','.');
    else return $this->estemp;

  }
  
  public function getPrivehmot()
  {

    return $this->privehmot;

  }
  
  public function getSoshog()
  {
  ...
  public function getTipmed()
  {

    return trim($this->tipmed);

  }
  
  public function getEsalerg()
  {
  ...
  public function getDesaler()
  {

    return trim($this->desaler);

  }
  
  public function getMonindem($val=false)
  {

    if($val) return number_format($this->monindem,2,',','.');
    else return $this->monindem;

  }
  
  public function getTipetn()
  {

    return trim($this->tipetn);

  }
  
  public function getCodpainac()
  {

    return trim($this->codpainac);
  ...
  public function getFectitular($format = 'Y-m-d')
  {

    if ($this->fectitular === null || $this->fectitular === '') {
      return null;
    } elseif (!is_int($this->fectitular)) {
            $ts = adodb_strtotime($this->fectitular);
      if ($ts === -1 || $ts === false) {         throw new PropelException("Unable to parse value of [fectitular] as date/time value: " . var_export($this->fectitular, true));
      }
    } else {
      $ts = $this->fectitular;
    }
  ...
  public function getTipcuefid()
  {

    return trim($this->tipcuefid);

  }
  
  public function getTiefun()
  {
  ...
  public function getNumtarces()
  {

    return trim($this->numtarces);
  ...
  public function getPritra()
  {
    ...
    return trim($this->pritra);

  }
  
  public function getCuebanmat()
  {

    return trim($this->cuebanmat);
  ...
  public function getCodpagbon()
  {

    return trim($this->codpagbon);

  }
  
  public function getCodbanbon()
  {

    return trim($this->codbanbon);

  }
  
  public function getTipcuebon()
  {

    return trim($this->tipcuebon);

  }
  
  public function getNumcuebon()
  {

    return trim($this->numcuebon);
  ...
  public function getId()
  {
	...
	public function setPosveh($v)
	{

    if ($this->posveh !== $v) {
        $this->posveh = $v;
        $this->modifiedColumns[] = NphojintPeer::POSVEH;
      }
    ...
    if ($this->marveh !== $v) {
        $this->marveh = $v;
        $this->modifiedColumns[] = NphojintPeer::MARVEH;
      }
    ...
    if ($this->modveh !== $v) {
        $this->modveh = $v;
        $this->modifiedColumns[] = NphojintPeer::MODVEH;
      }
    ...
    if ($this->colveh !== $v) {
        $this->colveh = $v;
        $this->modifiedColumns[] = NphojintPeer::COLVEH;
      }
    ...
    if ($this->anoveh !== $v) {
        $this->anoveh = $v;
        $this->modifiedColumns[] = NphojintPeer::ANOVEH;
      }
    ...
    if ($this->plaveh !== $v) {
        $this->plaveh = $v;
        $this->modifiedColumns[] = NphojintPeer::PLAVEH;
      }
  
	} 
	
	public function setEmaopc($v)
	{

    if ($this->emaopc !== $v) {
        $this->emaopc = $v;
        $this->modifiedColumns[] = NphojintPeer::EMAOPC;
      }
  
	} 
	
	public function setPesemp($v)
	{

    if ($this->pesemp !== $v) {
        $this->pesemp = Herramientas::toFloat($v);
        $this->modifiedColumns[] = NphojintPeer::PESEMP;
      }
  
	} 
	
	public function setEstemp($v)
	{

    if ($this->estemp !== $v) {
        $this->estemp = Herramientas::toFloat($v);
        $this->modifiedColumns[] = NphojintPeer::ESTEMP;
      }
  
	} 
	
	public function setPrivehmot($v)
	{

    if ($this->privehmot !== $v) {
        $this->privehmot = $v;
        $this->modifiedColumns[] = NphojintPeer::PRIVEHMOT;
      }
  
	} 
	
	public function setSoshog($v)
	{

    if ($this->soshog !== $v) {
        $this->soshog = $v;
        $this->modifiedColumns[] = NphojintPeer::SOSHOG;
      }
  
	} 
	
	public function setCapbie($v)
	{

    if ($this->capbie !== $v) {
        $this->capbie = $v;
        $this->modifiedColumns[] = NphojintPeer::CAPBIE;
      }
  
	} 
	
	public function setTipmed($v)
	{

    if ($this->tipmed !== $v) {
        $this->tipmed = $v;
        $this->modifiedColumns[] = NphojintPeer::TIPMED;
      }
  
	} 
	
	public function setEsalerg($v)
	{

    if ($this->esalerg !== $v) {
        $this->esalerg = $v;
        $this->modifiedColumns[] = NphojintPeer::ESALERG;
      }
  
	} 
	
	public function setDesaler($v)
	{

    if ($this->desaler !== $v) {
        $this->desaler = $v;
        $this->modifiedColumns[] = NphojintPeer::DESALER;
      }
  
	} 
	
	public function setMonindem($v)
	{

    if ($this->monindem !== $v) {
        $this->monindem = Herramientas::toFloat($v);
        $this->modifiedColumns[] = NphojintPeer::MONINDEM;
      }
  
	} 
	
	public function setTipetn($v)
	{

    if ($this->tipetn !== $v) {
        $this->tipetn = $v;
        $this->modifiedColumns[] = NphojintPeer::TIPETN;
      }
  
	} 
	
	public function setCodpainac($v)
	{

    if ($this->codpainac !== $v) {
        $this->codpainac = $v;
        $this->modifiedColumns[] = NphojintPeer::CODPAINAC;
      }
    ...
    if ($this->numpas !== $v) {
        $this->numpas = $v;
        $this->modifiedColumns[] = NphojintPeer::NUMPAS;
      }
    ...
    if ($this->codpro !== $v) {
        $this->codpro = $v;
        $this->modifiedColumns[] = NphojintPeer::CODPRO;
      }
  
	} 
	
	public function setFectitular($v)
	{

    if ($v !== null && !is_int($v)) {
      $ts = adodb_strtotime($v);
      if ($ts === -1 || $ts === false) {         throw new PropelException("Unable to parse date/time value for [fectitular] from input: " . var_export($v, true));
      }
    } else {
      $ts = $v;
    }
    if ($this->fectitular !== $ts) {
      $this->fectitular = $ts;
      $this->modifiedColumns[] = NphojintPeer::FECTITULAR;
    }

	} 
	
	public function setTipcuefid($v)
	{

    if ($this->tipcuefid !== $v) {
        $this->tipcuefid = $v;
        $this->modifiedColumns[] = NphojintPeer::TIPCUEFID;
      }
  
	} 
	
	public function setTiefun($v)
	{

    if ($this->tiefun !== $v || $v === false) {
        $this->tiefun = $v;
        $this->modifiedColumns[] = NphojintPeer::TIEFUN;
      }
  
	} 
	
	public function setNumtarces($v)
	{

    if ($this->numtarces !== $v) {
        $this->numtarces = $v;
        $this->modifiedColumns[] = NphojintPeer::NUMTARCES;
      }
    ...
    if ($this->pritra !== $v) {
        $this->pritra = $v;
        $this->modifiedColumns[] = NphojintPeer::PRITRA;
      }
  
	} 
	
	public function setCuebanmat($v)
	{

    if ($this->cuebanmat !== $v) {
        $this->cuebanmat = $v;
        $this->modifiedColumns[] = NphojintPeer::CUEBANMAT;
      }
    ...
    if ($this->codofi !== $v) {
        $this->codofi = $v;
        $this->modifiedColumns[] = NphojintPeer::CODOFI;
      }
    ...
    if ($this->coddep !== $v) {
        $this->coddep = $v;
        $this->modifiedColumns[] = NphojintPeer::CODDEP;
      }
    ...
    if ($this->coddirec !== $v) {
        $this->coddirec = $v;
        $this->modifiedColumns[] = NphojintPeer::CODDIREC;
      }
    ...
    if ($this->codubi !== $v) {
        $this->codubi = $v;
        $this->modifiedColumns[] = NphojintPeer::CODUBI;
      }
    ...
    if ($this->coduniads !== $v) {
        $this->coduniads = $v;
        $this->modifiedColumns[] = NphojintPeer::CODUNIADS;
      }
  
	} 
	
	public function setCodpagbon($v)
	{

    if ($this->codpagbon !== $v) {
        $this->codpagbon = $v;
        $this->modifiedColumns[] = NphojintPeer::CODPAGBON;
      }
  
	} 
	
	public function setCodbanbon($v)
	{

    if ($this->codbanbon !== $v) {
        $this->codbanbon = $v;
        $this->modifiedColumns[] = NphojintPeer::CODBANBON;
      }
  
	} 
	
	public function setTipcuebon($v)
	{

    if ($this->tipcuebon !== $v) {
        $this->tipcuebon = $v;
        $this->modifiedColumns[] = NphojintPeer::TIPCUEBON;
      }
  
	} 
	
	public function setNumcuebon($v)
	{

    if ($this->numcuebon !== $v) {
        $this->numcuebon = $v;
        $this->modifiedColumns[] = NphojintPeer::NUMCUEBON;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->posveh = $rs->getBoolean($startcol + 103);

      $this->marveh = $rs->getString($startcol + 104);

      $this->modveh = $rs->getString($startcol + 105);

      $this->colveh = $rs->getString($startcol + 106);

      $this->anoveh = $rs->getString($startcol + 107);

      $this->plaveh = $rs->getString($startcol + 108);

      $this->emaopc = $rs->getString($startcol + 109);

      $this->pesemp = $rs->getFloat($startcol + 110);

      $this->estemp = $rs->getFloat($startcol + 111);

      $this->privehmot = $rs->getBoolean($startcol + 112);

      $this->soshog = $rs->getBoolean($startcol + 113);

      $this->capbie = $rs->getBoolean($startcol + 114);

      $this->tipmed = $rs->getString($startcol + 115);

      $this->esalerg = $rs->getBoolean($startcol + 116);

      $this->desaler = $rs->getString($startcol + 117);

      $this->monindem = $rs->getFloat($startcol + 118);

      $this->tipetn = $rs->getString($startcol + 119);

      $this->codpainac = $rs->getString($startcol + 120);

      $this->numpas = $rs->getString($startcol + 121);

      $this->codpro = $rs->getString($startcol + 122);

      $this->fectitular = $rs->getDate($startcol + 123, null);

      $this->tipcuefid = $rs->getString($startcol + 124);

      $this->tiefun = $rs->getBoolean($startcol + 125);

      $this->numtarces = $rs->getString($startcol + 126);

      $this->pritra = $rs->getString($startcol + 127);

      $this->cuebanmat = $rs->getString($startcol + 128);

      $this->codofi = $rs->getString($startcol + 129);

      $this->coddep = $rs->getString($startcol + 130);

      $this->coddirec = $rs->getString($startcol + 131);

      $this->codubi = $rs->getString($startcol + 132);

      $this->coduniads = $rs->getString($startcol + 133);

      $this->codpagbon = $rs->getString($startcol + 134);

      $this->codbanbon = $rs->getString($startcol + 135);

      $this->tipcuebon = $rs->getString($startcol + 136);

      $this->numcuebon = $rs->getString($startcol + 137);

      $this->id = $rs->getInt($startcol + 138);
  ...
  public function get($m, $a)
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 108:
				...
				break;
			case 109:
				return $this->getEmaopc();
				break;
			case 110:
				return $this->getPesemp();
				break;
			case 111:
				return $this->getEstemp();
				break;
			case 112:
				return $this->getPrivehmot();
				break;
			case 113:
				return $this->getSoshog();
				break;
			case 114:
				return $this->getCapbie();
				break;
			case 115:
				return $this->getTipmed();
				break;
			case 116:
				return $this->getEsalerg();
				break;
			case 117:
				return $this->getDesaler();
				break;
			case 118:
				return $this->getMonindem();
				break;
			case 119:
				return $this->getTipetn();
				break;
			case 120:
				return $this->getCodpainac();
				break;
			case 121:
			...
			case 122:
				...
				break;
			case 123:
				return $this->getFectitular();
				break;
			case 124:
				return $this->getTipcuefid();
				break;
			case 125:
				return $this->getTiefun();
				break;
			case 126:
				return $this->getNumtarces();
				break;
			case 127:
				return $this->getPritra();
				break;
			case 128:
				return $this->getCuebanmat();
				break;
			case 129:
			...
			case 133:
				...
				break;
			case 134:
				return $this->getCodpagbon();
				break;
			case 135:
				return $this->getCodbanbon();
				break;
			case 136:
				return $this->getTipcuebon();
				break;
			case 137:
				return $this->getNumcuebon();
				break;
			case 138:
				return $this->getId();
				break;
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		$result = array(
			...
			$keys[103] => $this->getPosveh(),
			$keys[104] => $this->getMarveh(),
			$keys[105] => $this->getModveh(),
			$keys[106] => $this->getColveh(),
			$keys[107] => $this->getAnoveh(),
			$keys[108] => $this->getPlaveh(),
			$keys[109] => $this->getEmaopc(),
			$keys[110] => $this->getPesemp(),
			$keys[111] => $this->getEstemp(),
			$keys[112] => $this->getPrivehmot(),
			$keys[113] => $this->getSoshog(),
			$keys[114] => $this->getCapbie(),
			$keys[115] => $this->getTipmed(),
			$keys[116] => $this->getEsalerg(),
			$keys[117] => $this->getDesaler(),
			$keys[118] => $this->getMonindem(),
			$keys[119] => $this->getTipetn(),
			$keys[120] => $this->getCodpainac(),
			$keys[121] => $this->getNumpas(),
			$keys[122] => $this->getCodpro(),
			$keys[123] => $this->getFectitular(),
			$keys[124] => $this->getTipcuefid(),
			$keys[125] => $this->getTiefun(),
			$keys[126] => $this->getNumtarces(),
			$keys[127] => $this->getPritra(),
			$keys[128] => $this->getCuebanmat(),
			$keys[129] => $this->getCodofi(),
			$keys[130] => $this->getCoddep(),
			$keys[131] => $this->getCoddirec(),
			$keys[132] => $this->getCodubi(),
			$keys[133] => $this->getCoduniads(),
			$keys[134] => $this->getCodpagbon(),
			$keys[135] => $this->getCodbanbon(),
			$keys[136] => $this->getTipcuebon(),
			$keys[137] => $this->getNumcuebon(),
			$keys[138] => $this->getId(),
		);
		return $result;
	}
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 108:
				...
				break;
			case 109:
				$this->setEmaopc($value);
				break;
			case 110:
				$this->setPesemp($value);
				break;
			case 111:
				$this->setEstemp($value);
				break;
			case 112:
				$this->setPrivehmot($value);
				break;
			case 113:
				$this->setSoshog($value);
				break;
			case 114:
				$this->setCapbie($value);
				break;
			case 115:
				$this->setTipmed($value);
				break;
			case 116:
				$this->setEsalerg($value);
				break;
			case 117:
				$this->setDesaler($value);
				break;
			case 118:
				$this->setMonindem($value);
				break;
			case 119:
				$this->setTipetn($value);
				break;
			case 120:
				$this->setCodpainac($value);
				break;
			case 121:
			...
			case 122:
				...
				break;
			case 123:
				$this->setFectitular($value);
				break;
			case 124:
				$this->setTipcuefid($value);
				break;
			case 125:
				$this->setTiefun($value);
				break;
			case 126:
				$this->setNumtarces($value);
				break;
			case 127:
				$this->setPritra($value);
				break;
			case 128:
				$this->setCuebanmat($value);
				break;
			case 129:
			...
			case 133:
				...
				break;
			case 134:
				$this->setCodpagbon($value);
				break;
			case 135:
				$this->setCodbanbon($value);
				break;
			case 136:
				$this->setTipcuebon($value);
				break;
			case 137:
				$this->setNumcuebon($value);
				break;
			case 138:
				$this->setId($value);
				break;
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[103], $arr)) $this->setPosveh($arr[$keys[103]]);
		if (array_key_exists($keys[104], $arr)) $this->setMarveh($arr[$keys[104]]);
		if (array_key_exists($keys[105], $arr)) $this->setModveh($arr[$keys[105]]);
		if (array_key_exists($keys[106], $arr)) $this->setColveh($arr[$keys[106]]);
		if (array_key_exists($keys[107], $arr)) $this->setAnoveh($arr[$keys[107]]);
		if (array_key_exists($keys[108], $arr)) $this->setPlaveh($arr[$keys[108]]);
		if (array_key_exists($keys[109], $arr)) $this->setEmaopc($arr[$keys[109]]);
		if (array_key_exists($keys[110], $arr)) $this->setPesemp($arr[$keys[110]]);
		if (array_key_exists($keys[111], $arr)) $this->setEstemp($arr[$keys[111]]);
		if (array_key_exists($keys[112], $arr)) $this->setPrivehmot($arr[$keys[112]]);
		if (array_key_exists($keys[113], $arr)) $this->setSoshog($arr[$keys[113]]);
		if (array_key_exists($keys[114], $arr)) $this->setCapbie($arr[$keys[114]]);
		if (array_key_exists($keys[115], $arr)) $this->setTipmed($arr[$keys[115]]);
		if (array_key_exists($keys[116], $arr)) $this->setEsalerg($arr[$keys[116]]);
		if (array_key_exists($keys[117], $arr)) $this->setDesaler($arr[$keys[117]]);
		if (array_key_exists($keys[118], $arr)) $this->setMonindem($arr[$keys[118]]);
		if (array_key_exists($keys[119], $arr)) $this->setTipetn($arr[$keys[119]]);
		if (array_key_exists($keys[120], $arr)) $this->setCodpainac($arr[$keys[120]]);
		if (array_key_exists($keys[121], $arr)) $this->setNumpas($arr[$keys[121]]);
		if (array_key_exists($keys[122], $arr)) $this->setCodpro($arr[$keys[122]]);
		if (array_key_exists($keys[123], $arr)) $this->setFectitular($arr[$keys[123]]);
		if (array_key_exists($keys[124], $arr)) $this->setTipcuefid($arr[$keys[124]]);
		if (array_key_exists($keys[125], $arr)) $this->setTiefun($arr[$keys[125]]);
		if (array_key_exists($keys[126], $arr)) $this->setNumtarces($arr[$keys[126]]);
		if (array_key_exists($keys[127], $arr)) $this->setPritra($arr[$keys[127]]);
		if (array_key_exists($keys[128], $arr)) $this->setCuebanmat($arr[$keys[128]]);
		if (array_key_exists($keys[129], $arr)) $this->setCodofi($arr[$keys[129]]);
		if (array_key_exists($keys[130], $arr)) $this->setCoddep($arr[$keys[130]]);
		if (array_key_exists($keys[131], $arr)) $this->setCoddirec($arr[$keys[131]]);
		if (array_key_exists($keys[132], $arr)) $this->setCodubi($arr[$keys[132]]);
		if (array_key_exists($keys[133], $arr)) $this->setCoduniads($arr[$keys[133]]);
		if (array_key_exists($keys[134], $arr)) $this->setCodpagbon($arr[$keys[134]]);
		if (array_key_exists($keys[135], $arr)) $this->setCodbanbon($arr[$keys[135]]);
		if (array_key_exists($keys[136], $arr)) $this->setTipcuebon($arr[$keys[136]]);
		if (array_key_exists($keys[137], $arr)) $this->setNumcuebon($arr[$keys[137]]);
		if (array_key_exists($keys[138], $arr)) $this->setId($arr[$keys[138]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(NphojintPeer::POSVEH)) $criteria->add(NphojintPeer::POSVEH, $this->posveh);
		if ($this->isColumnModified(NphojintPeer::MARVEH)) $criteria->add(NphojintPeer::MARVEH, $this->marveh);
		if ($this->isColumnModified(NphojintPeer::MODVEH)) $criteria->add(NphojintPeer::MODVEH, $this->modveh);
		if ($this->isColumnModified(NphojintPeer::COLVEH)) $criteria->add(NphojintPeer::COLVEH, $this->colveh);
		if ($this->isColumnModified(NphojintPeer::ANOVEH)) $criteria->add(NphojintPeer::ANOVEH, $this->anoveh);
		if ($this->isColumnModified(NphojintPeer::PLAVEH)) $criteria->add(NphojintPeer::PLAVEH, $this->plaveh);
		if ($this->isColumnModified(NphojintPeer::EMAOPC)) $criteria->add(NphojintPeer::EMAOPC, $this->emaopc);
		if ($this->isColumnModified(NphojintPeer::PESEMP)) $criteria->add(NphojintPeer::PESEMP, $this->pesemp);
		if ($this->isColumnModified(NphojintPeer::ESTEMP)) $criteria->add(NphojintPeer::ESTEMP, $this->estemp);
		if ($this->isColumnModified(NphojintPeer::PRIVEHMOT)) $criteria->add(NphojintPeer::PRIVEHMOT, $this->privehmot);
		if ($this->isColumnModified(NphojintPeer::SOSHOG)) $criteria->add(NphojintPeer::SOSHOG, $this->soshog);
		if ($this->isColumnModified(NphojintPeer::CAPBIE)) $criteria->add(NphojintPeer::CAPBIE, $this->capbie);
		if ($this->isColumnModified(NphojintPeer::TIPMED)) $criteria->add(NphojintPeer::TIPMED, $this->tipmed);
		if ($this->isColumnModified(NphojintPeer::ESALERG)) $criteria->add(NphojintPeer::ESALERG, $this->esalerg);
		if ($this->isColumnModified(NphojintPeer::DESALER)) $criteria->add(NphojintPeer::DESALER, $this->desaler);
		if ($this->isColumnModified(NphojintPeer::MONINDEM)) $criteria->add(NphojintPeer::MONINDEM, $this->monindem);
		if ($this->isColumnModified(NphojintPeer::TIPETN)) $criteria->add(NphojintPeer::TIPETN, $this->tipetn);
		if ($this->isColumnModified(NphojintPeer::CODPAINAC)) $criteria->add(NphojintPeer::CODPAINAC, $this->codpainac);
		if ($this->isColumnModified(NphojintPeer::NUMPAS)) $criteria->add(NphojintPeer::NUMPAS, $this->numpas);
		if ($this->isColumnModified(NphojintPeer::CODPRO)) $criteria->add(NphojintPeer::CODPRO, $this->codpro);
		if ($this->isColumnModified(NphojintPeer::FECTITULAR)) $criteria->add(NphojintPeer::FECTITULAR, $this->fectitular);
		if ($this->isColumnModified(NphojintPeer::TIPCUEFID)) $criteria->add(NphojintPeer::TIPCUEFID, $this->tipcuefid);
		if ($this->isColumnModified(NphojintPeer::TIEFUN)) $criteria->add(NphojintPeer::TIEFUN, $this->tiefun);
		if ($this->isColumnModified(NphojintPeer::NUMTARCES)) $criteria->add(NphojintPeer::NUMTARCES, $this->numtarces);
		if ($this->isColumnModified(NphojintPeer::PRITRA)) $criteria->add(NphojintPeer::PRITRA, $this->pritra);
		if ($this->isColumnModified(NphojintPeer::CUEBANMAT)) $criteria->add(NphojintPeer::CUEBANMAT, $this->cuebanmat);
		if ($this->isColumnModified(NphojintPeer::CODOFI)) $criteria->add(NphojintPeer::CODOFI, $this->codofi);
		if ($this->isColumnModified(NphojintPeer::CODDEP)) $criteria->add(NphojintPeer::CODDEP, $this->coddep);
		if ($this->isColumnModified(NphojintPeer::CODDIREC)) $criteria->add(NphojintPeer::CODDIREC, $this->coddirec);
		if ($this->isColumnModified(NphojintPeer::CODUBI)) $criteria->add(NphojintPeer::CODUBI, $this->codubi);
		if ($this->isColumnModified(NphojintPeer::CODUNIADS)) $criteria->add(NphojintPeer::CODUNIADS, $this->coduniads);
		if ($this->isColumnModified(NphojintPeer::CODPAGBON)) $criteria->add(NphojintPeer::CODPAGBON, $this->codpagbon);
		if ($this->isColumnModified(NphojintPeer::CODBANBON)) $criteria->add(NphojintPeer::CODBANBON, $this->codbanbon);
		if ($this->isColumnModified(NphojintPeer::TIPCUEBON)) $criteria->add(NphojintPeer::TIPCUEBON, $this->tipcuebon);
		if ($this->isColumnModified(NphojintPeer::NUMCUEBON)) $criteria->add(NphojintPeer::NUMCUEBON, $this->numcuebon);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setEmaopc($this->emaopc);

		$copyObj->setPesemp($this->pesemp);

		$copyObj->setEstemp($this->estemp);

		$copyObj->setPrivehmot($this->privehmot);

		$copyObj->setSoshog($this->soshog);

		$copyObj->setCapbie($this->capbie);

		$copyObj->setTipmed($this->tipmed);

		$copyObj->setEsalerg($this->esalerg);

		$copyObj->setDesaler($this->desaler);

		$copyObj->setMonindem($this->monindem);

		$copyObj->setTipetn($this->tipetn);

		$copyObj->setCodpainac($this->codpainac);

		$copyObj->setNumpas($this->numpas);

		$copyObj->setCodpro($this->codpro);

		$copyObj->setFectitular($this->fectitular);

		$copyObj->setTipcuefid($this->tipcuefid);

		$copyObj->setTiefun($this->tiefun);

		$copyObj->setNumtarces($this->numtarces);

		$copyObj->setPritra($this->pritra);

		$copyObj->setCuebanmat($this->cuebanmat);
		...
		$copyObj->setCodpagbon($this->codpagbon);

		$copyObj->setCodbanbon($this->codbanbon);

		$copyObj->setTipcuebon($this->tipcuebon);

		$copyObj->setNumcuebon($this->numcuebon);

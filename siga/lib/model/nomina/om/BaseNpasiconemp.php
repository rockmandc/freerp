...
abstract class BaseNpasiconemp extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->varia !== $v) {
        $this->varia = $v;
        $this->modifiedColumns[] = NpasiconempPeer::VARIA;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->varia = $rs->getString($startcol + 16);
  ...
  public function get($m, $a)
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[16], $arr)) $this->setVaria($arr[$keys[16]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(NpasiconempPeer::VARIA)) $criteria->add(NpasiconempPeer::VARIA, $this->varia);

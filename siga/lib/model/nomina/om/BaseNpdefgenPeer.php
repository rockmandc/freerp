...
abstract class BaseNpdefgenPeer {
	...
	const FORCED = 'npdefgen.FORCED';

	
	const CORAYU = 'npdefgen.CORAYU';

	
	const SUEMIN = 'npdefgen.SUEMIN';

	
	const CODSITEMP = 'npdefgen.CODSITEMP';

	
	const CODESTEMP = 'npdefgen.CODESTEMP';

	
	const CODTIPGAS = 'npdefgen.CODTIPGAS';

	
	const CORPTO = 'npdefgen.CORPTO';
	...
	{
		include_once 'lib/model/nomina/map/NpdefgenMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.nomina.map.NpdefgenMapBuilder');
	}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(NpdefgenPeer::FORCED);

		$criteria->addSelectColumn(NpdefgenPeer::CORAYU);

		$criteria->addSelectColumn(NpdefgenPeer::SUEMIN);

		$criteria->addSelectColumn(NpdefgenPeer::CODSITEMP);

		$criteria->addSelectColumn(NpdefgenPeer::CODESTEMP);

		$criteria->addSelectColumn(NpdefgenPeer::CODTIPGAS);

		$criteria->addSelectColumn(NpdefgenPeer::CORPTO);
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/nomina/map/NpdefgenMapBuilder.php';
	Propel::registerMapBuilder('lib.model.nomina.map.NpdefgenMapBuilder');
}

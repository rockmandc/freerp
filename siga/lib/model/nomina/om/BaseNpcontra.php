...
abstract class BaseNpcontra extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
	...
	public function setSalnor($v)
	{

    if ($this->salnor !== $v) {
        $this->salnor = $v;
        $this->modifiedColumns[] = NpcontraPeer::SALNOR;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->salnor = $rs->getBoolean($startcol + 5);
  ...
  public function __call($m, $a)
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[5], $arr)) $this->setSalnor($arr[$keys[5]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(NpcontraPeer::SALNOR)) $criteria->add(NpcontraPeer::SALNOR, $this->salnor);

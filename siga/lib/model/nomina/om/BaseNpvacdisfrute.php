...
abstract class BaseNpvacdisfrute extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->diasajust !== $v) {
        ...
        $this->modifiedColumns[] = NpvacdisfrutePeer::DIASAJUST;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->diasajust = $rs->getFloat($startcol + 7);
  ...
  public function __call($m, $a)
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[7], $arr)) $this->setDiasajust($arr[$keys[7]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(NpvacdisfrutePeer::DIASAJUST)) $criteria->add(NpvacdisfrutePeer::DIASAJUST, $this->diasajust);

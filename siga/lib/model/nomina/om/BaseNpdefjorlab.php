...
abstract class BaseNpdefjorlab extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->hordes !== $v) {
        $this->hordes = $v;
        $this->modifiedColumns[] = NpdefjorlabPeer::HORDES;
      }
    ...
    if ($this->horhas !== $v) {
        $this->horhas = $v;
        $this->modifiedColumns[] = NpdefjorlabPeer::HORHAS;
      }
  ...
  public function get($m, $a)
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(NpdefjorlabPeer::HORDES)) $criteria->add(NpdefjorlabPeer::HORDES, $this->hordes);
		if ($this->isColumnModified(NpdefjorlabPeer::HORHAS)) $criteria->add(NpdefjorlabPeer::HORHAS, $this->horhas);

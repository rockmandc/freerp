...
abstract class BaseNpvacsalidas extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->nomsup !== $v) {
        $this->nomsup = $v;
        $this->modifiedColumns[] = NpvacsalidasPeer::NOMSUP;
      }
    ...
    if ($this->monsup !== $v) {
        ...
        $this->modifiedColumns[] = NpvacsalidasPeer::MONSUP;
      }
    ...
    if ($this->fecfin !== $ts) {
      $this->fecfin = $ts;
      $this->modifiedColumns[] = NpvacsalidasPeer::FECFIN;
    }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->monsup = $rs->getFloat($startcol + 13);

      $this->fecfin = $rs->getDate($startcol + 14, null);
  ...
  public function __call($m, $a)
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		$result = array(
			...
			$keys[13] => $this->getMonsup(),
			$keys[14] => $this->getFecfin(),
			$keys[15] => $this->getId(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[13], $arr)) $this->setMonsup($arr[$keys[13]]);
		if (array_key_exists($keys[14], $arr)) $this->setFecfin($arr[$keys[14]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(NpvacsalidasPeer::NOMSUP)) $criteria->add(NpvacsalidasPeer::NOMSUP, $this->nomsup);
		if ($this->isColumnModified(NpvacsalidasPeer::MONSUP)) $criteria->add(NpvacsalidasPeer::MONSUP, $this->monsup);
		if ($this->isColumnModified(NpvacsalidasPeer::FECFIN)) $criteria->add(NpvacsalidasPeer::FECFIN, $this->fecfin);

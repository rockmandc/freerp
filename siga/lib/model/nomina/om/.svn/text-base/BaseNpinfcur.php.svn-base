...
abstract class BaseNpinfcur extends BaseObject  implements Persistent {
  ...
  public function getCodpaitit()
  {

    return trim($this->codpaitit);
  ...
  public function getId()
  {
	...
	public function setCodpaitit($v)
	{

    if ($this->codpaitit !== $v) {
        $this->codpaitit = $v;
        $this->modifiedColumns[] = NpinfcurPeer::CODPAITIT;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->codpaitit = $rs->getString($startcol + 11);
  ...
  public function get($m, $a)
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[11], $arr)) $this->setCodpaitit($arr[$keys[11]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(NpinfcurPeer::CODPAITIT)) $criteria->add(NpinfcurPeer::CODPAITIT, $this->codpaitit);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setCodpaitit($this->codpaitit);

...
abstract class BaseNpinfdocPeer {
	...
	const FECCON = 'npinfdoc.FECCON';

	
	const OBSERV = 'npinfdoc.OBSERV';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Codemp', 'Coddoc', 'Feccon', 'Observ', 'Id', ),
		BasePeer::TYPE_COLNAME => array (NpinfdocPeer::CODEMP, NpinfdocPeer::CODDOC, NpinfdocPeer::FECCON, NpinfdocPeer::OBSERV, NpinfdocPeer::ID, ),
		BasePeer::TYPE_FIELDNAME => array ('codemp', 'coddoc', 'feccon', 'observ', 'id', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Codemp' => 0, 'Coddoc' => 1, 'Feccon' => 2, 'Observ' => 3, 'Id' => 4, ),
		BasePeer::TYPE_COLNAME => array (NpinfdocPeer::CODEMP => 0, NpinfdocPeer::CODDOC => 1, NpinfdocPeer::FECCON => 2, NpinfdocPeer::OBSERV => 3, NpinfdocPeer::ID => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('codemp' => 0, 'coddoc' => 1, 'feccon' => 2, 'observ' => 3, 'id' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(NpinfdocPeer::FECCON);

		$criteria->addSelectColumn(NpinfdocPeer::OBSERV);

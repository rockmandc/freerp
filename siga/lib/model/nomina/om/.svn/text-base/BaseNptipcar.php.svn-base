...
abstract class BaseNptipcar extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
	...
	public function setDocsn($v)
	{

    if ($this->docsn !== $v) {
        $this->docsn = $v;
        $this->modifiedColumns[] = NptipcarPeer::DOCSN;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->docsn = $rs->getBoolean($startcol + 2);
  ...
  public function get($m, $a)
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setDocsn($arr[$keys[2]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(NptipcarPeer::DOCSN)) $criteria->add(NptipcarPeer::DOCSN, $this->docsn);

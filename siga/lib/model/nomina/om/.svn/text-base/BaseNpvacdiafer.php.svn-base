...
abstract class BaseNpvacdiafer extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->codpai !== $v) {
        $this->codpai = $v;
        $this->modifiedColumns[] = NpvacdiaferPeer::CODPAI;
      }
    ...
    if ($this->codniv !== $v) {
        $this->codniv = $v;
        $this->modifiedColumns[] = NpvacdiaferPeer::CODNIV;
      }
  ...
  public function get($m, $a)
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(NpvacdiaferPeer::CODPAI)) $criteria->add(NpvacdiaferPeer::CODPAI, $this->codpai);
		if ($this->isColumnModified(NpvacdiaferPeer::CODNIV)) $criteria->add(NpvacdiaferPeer::CODNIV, $this->codniv);

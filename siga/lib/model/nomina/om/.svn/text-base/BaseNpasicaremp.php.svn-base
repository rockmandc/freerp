...
abstract class BaseNpasicaremp extends BaseObject  implements Persistent {
  ...
  public function getCodnivc()
  {

    return trim($this->codnivc);

  }
  
  public function getCarlibnom()
  {

    return $this->carlibnom;
  ...
  public function getId()
  {
    ...
    if ($this->codcen !== $v) {
        $this->codcen = $v;
        $this->modifiedColumns[] = NpasicarempPeer::CODCEN;
      }
    ...
    if ($this->codttrab !== $v) {
        $this->codttrab = $v;
        $this->modifiedColumns[] = NpasicarempPeer::CODTTRAB;
      }
  
	} 
	
	public function setCodnivc($v)
	{

    if ($this->codnivc !== $v) {
        $this->codnivc = $v;
        $this->modifiedColumns[] = NpasicarempPeer::CODNIVC;
      }
  
	} 
	
	public function setCarlibnom($v)
	{

    if ($this->carlibnom !== $v) {
        $this->carlibnom = $v;
        $this->modifiedColumns[] = NpasicarempPeer::CARLIBNOM;
      }
    ...
    if ($this->codeve !== $v) {
        $this->codeve = $v;
        $this->modifiedColumns[] = NpasicarempPeer::CODEVE;
      }
    ...
    if ($this->codtipemp !== $v) {
        $this->codtipemp = $v;
        $this->modifiedColumns[] = NpasicarempPeer::CODTIPEMP;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->codcen = $rs->getString($startcol + 24);

      $this->codttrab = $rs->getString($startcol + 25);

      $this->codnivc = $rs->getString($startcol + 26);

      $this->carlibnom = $rs->getBoolean($startcol + 27);

      $this->codeve = $rs->getString($startcol + 28);

      $this->codtipemp = $rs->getString($startcol + 29);
  ...
  public function get($m, $a)
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 25:
				...
				break;
			case 26:
				return $this->getCodnivc();
				break;
			case 27:
				return $this->getCarlibnom();
				break;
			case 28:
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		$result = array(
			...
			$keys[24] => $this->getCodcen(),
			$keys[25] => $this->getCodttrab(),
			$keys[26] => $this->getCodnivc(),
			$keys[27] => $this->getCarlibnom(),
			$keys[28] => $this->getCodeve(),
			$keys[29] => $this->getCodtipemp(),
			$keys[30] => $this->getId(),
		);
		return $result;
	}
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 25:
				...
				break;
			case 26:
				$this->setCodnivc($value);
				break;
			case 27:
				$this->setCarlibnom($value);
				break;
			case 28:
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[24], $arr)) $this->setCodcen($arr[$keys[24]]);
		if (array_key_exists($keys[25], $arr)) $this->setCodttrab($arr[$keys[25]]);
		if (array_key_exists($keys[26], $arr)) $this->setCodnivc($arr[$keys[26]]);
		if (array_key_exists($keys[27], $arr)) $this->setCarlibnom($arr[$keys[27]]);
		if (array_key_exists($keys[28], $arr)) $this->setCodeve($arr[$keys[28]]);
		if (array_key_exists($keys[29], $arr)) $this->setCodtipemp($arr[$keys[29]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(NpasicarempPeer::CODCEN)) $criteria->add(NpasicarempPeer::CODCEN, $this->codcen);
		if ($this->isColumnModified(NpasicarempPeer::CODTTRAB)) $criteria->add(NpasicarempPeer::CODTTRAB, $this->codttrab);
		if ($this->isColumnModified(NpasicarempPeer::CODNIVC)) $criteria->add(NpasicarempPeer::CODNIVC, $this->codnivc);
		if ($this->isColumnModified(NpasicarempPeer::CARLIBNOM)) $criteria->add(NpasicarempPeer::CARLIBNOM, $this->carlibnom);
		if ($this->isColumnModified(NpasicarempPeer::CODEVE)) $criteria->add(NpasicarempPeer::CODEVE, $this->codeve);
		if ($this->isColumnModified(NpasicarempPeer::CODTIPEMP)) $criteria->add(NpasicarempPeer::CODTIPEMP, $this->codtipemp);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setCodnivc($this->codnivc);

		$copyObj->setCarlibnom($this->carlibnom);

...
abstract class BaseNpcontraPeer {
	...
	const CLASS_DEFAULT = 'lib.model.nomina.Npcontra';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Codnom', 'Codcon', 'Periodico', 'Identi', 'Tipo', 'Salnor', 'Id', ),
		BasePeer::TYPE_COLNAME => array (NpcontraPeer::CODNOM, NpcontraPeer::CODCON, NpcontraPeer::PERIODICO, NpcontraPeer::IDENTI, NpcontraPeer::TIPO, NpcontraPeer::SALNOR, NpcontraPeer::ID, ),
		BasePeer::TYPE_FIELDNAME => array ('codnom', 'codcon', 'periodico', 'identi', 'tipo', 'salnor', 'id', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Codnom' => 0, 'Codcon' => 1, 'Periodico' => 2, 'Identi' => 3, 'Tipo' => 4, 'Salnor' => 5, 'Id' => 6, ),
		BasePeer::TYPE_COLNAME => array (NpcontraPeer::CODNOM => 0, NpcontraPeer::CODCON => 1, NpcontraPeer::PERIODICO => 2, NpcontraPeer::IDENTI => 3, NpcontraPeer::TIPO => 4, NpcontraPeer::SALNOR => 5, NpcontraPeer::ID => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('codnom' => 0, 'codcon' => 1, 'periodico' => 2, 'identi' => 3, 'tipo' => 4, 'salnor' => 5, 'id' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	{
		include_once 'lib/model/nomina/map/NpcontraMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.nomina.map.NpcontraMapBuilder');
	}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(NpcontraPeer::SALNOR);
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/nomina/map/NpcontraMapBuilder.php';
	Propel::registerMapBuilder('lib.model.nomina.map.NpcontraMapBuilder');
}

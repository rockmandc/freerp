...
abstract class BaseNpbancos extends BaseObject  implements Persistent {
  ...
  public function getCodbanele()
  {

    return trim($this->codbanele);
  ...
  public function getId()
  {
	...
	public function setCodbanele($v)
	{

    if ($this->codbanele !== $v) {
        $this->codbanele = $v;
        $this->modifiedColumns[] = NpbancosPeer::CODBANELE;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->codbanele = $rs->getString($startcol + 2);
  ...
  public function __call($m, $a)
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setCodbanele($arr[$keys[2]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(NpbancosPeer::CODBANELE)) $criteria->add(NpbancosPeer::CODBANELE, $this->codbanele);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setCodbanele($this->codbanele);

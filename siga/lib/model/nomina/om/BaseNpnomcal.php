...
abstract class BaseNpnomcal extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->varia !== $v) {
        $this->varia = $v;
        $this->modifiedColumns[] = NpnomcalPeer::VARIA;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->varia = $rs->getString($startcol + 21);
  ...
  public function get($m, $a)
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[21], $arr)) $this->setVaria($arr[$keys[21]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(NpnomcalPeer::VARIA)) $criteria->add(NpnomcalPeer::VARIA, $this->varia);

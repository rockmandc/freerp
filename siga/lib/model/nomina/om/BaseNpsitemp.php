...
abstract class BaseNpsitemp extends BaseObject  implements Persistent {
  ...
  public function getCalnomesp()
  {

    return $this->calnomesp;
  ...
  public function getId()
  {
	...
	public function setCalnomesp($v)
	{

    if ($this->calnomesp !== $v || $v === false) {
        $this->calnomesp = $v;
        $this->modifiedColumns[] = NpsitempPeer::CALNOMESP;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->calnomesp = $rs->getBoolean($startcol + 3);
  ...
  public function get($m, $a)
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setCalnomesp($arr[$keys[3]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(NpsitempPeer::CALNOMESP)) $criteria->add(NpsitempPeer::CALNOMESP, $this->calnomesp);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setCalnomesp($this->calnomesp);

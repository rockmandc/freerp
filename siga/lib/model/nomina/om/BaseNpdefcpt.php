...
abstract class BaseNpdefcpt extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->codcta !== $v) {
        $this->codcta = $v;
        $this->modifiedColumns[] = NpdefcptPeer::CODCTA;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->codcta = $rs->getString($startcol + 12);
  ...
  public function get($m, $a)
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[12], $arr)) $this->setCodcta($arr[$keys[12]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(NpdefcptPeer::CODCTA)) $criteria->add(NpdefcptPeer::CODCTA, $this->codcta);
		...
		if ($this->collNpconsalints === null) {
			if ($this->isNew()) {
			   $this->collNpconsalints = array();
				...
				$criteria->add(NpconsalintPeer::CODCON, $this->getCodcon());
	...
	public function getNpconsalintsJoinNpnomina($criteria = null, $con = null)
	{
				include_once 'lib/model/nomina/om/BaseNpconsalintPeer.php';
		if ($criteria === null) {
			$criteria = new Criteria();
		...
		if ($this->collNpconsalints === null) {
			if ($this->isNew()) {
				...
				$this->collNpconsalints = NpconsalintPeer::doSelectJoinNpnomina($criteria, $con);
			}
		} else {
		...
		if ($this->collNpconsalintfids === null) {
			if ($this->isNew()) {
			   $this->collNpconsalintfids = array();
				...
				$criteria->add(NpconsalintfidPeer::CODCON, $this->getCodcon());
	...
	public function getNpconsalintfidsJoinNpnomina($criteria = null, $con = null)
	{
				include_once 'lib/model/nomina/om/BaseNpconsalintfidPeer.php';
		if ($criteria === null) {
			$criteria = new Criteria();
		...
		if ($this->collNpconsalintfids === null) {
			if ($this->isNew()) {
				...
				$this->collNpconsalintfids = NpconsalintfidPeer::doSelectJoinNpnomina($criteria, $con);
			}
		} else {

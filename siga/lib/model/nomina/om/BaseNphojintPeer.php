...
abstract class BaseNphojintPeer {
	...
	const FECMAT = 'nphojint.FECMAT';

	
	const FECINGSSO = 'nphojint.FECINGSSO';

	
	const POSVEH = 'nphojint.POSVEH';

	
	const MARVEH = 'nphojint.MARVEH';

	
	const MODVEH = 'nphojint.MODVEH';

	
	const COLVEH = 'nphojint.COLVEH';

	
	const ANOVEH = 'nphojint.ANOVEH';

	
	const PLAVEH = 'nphojint.PLAVEH';

	
	const EMAOPC = 'nphojint.EMAOPC';

	
	const PESEMP = 'nphojint.PESEMP';

	
	const ESTEMP = 'nphojint.ESTEMP';

	
	const PRIVEHMOT = 'nphojint.PRIVEHMOT';

	
	const SOSHOG = 'nphojint.SOSHOG';

	
	const CAPBIE = 'nphojint.CAPBIE';

	
	const TIPMED = 'nphojint.TIPMED';

	
	const ESALERG = 'nphojint.ESALERG';

	
	const DESALER = 'nphojint.DESALER';

	
	const MONINDEM = 'nphojint.MONINDEM';

	
	const TIPETN = 'nphojint.TIPETN';

	
	const CODPAINAC = 'nphojint.CODPAINAC';

	
	const NUMPAS = 'nphojint.NUMPAS';

	
	const CODPRO = 'nphojint.CODPRO';

	
	const FECTITULAR = 'nphojint.FECTITULAR';

	
	const TIPCUEFID = 'nphojint.TIPCUEFID';

	
	const TIEFUN = 'nphojint.TIEFUN';

	
	const NUMTARCES = 'nphojint.NUMTARCES';

	
	const PRITRA = 'nphojint.PRITRA';

	
	const CUEBANMAT = 'nphojint.CUEBANMAT';

	
	const CODOFI = 'nphojint.CODOFI';

	
	const CODDEP = 'nphojint.CODDEP';

	
	const CODDIREC = 'nphojint.CODDIREC';

	
	const CODUBI = 'nphojint.CODUBI';

	
	const CODUNIADS = 'nphojint.CODUNIADS';

	
	const CODPAGBON = 'nphojint.CODPAGBON';

	
	const CODBANBON = 'nphojint.CODBANBON';

	
	const TIPCUEBON = 'nphojint.TIPCUEBON';

	
	const NUMCUEBON = 'nphojint.NUMCUEBON';
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(NphojintPeer::FECMAT);

		$criteria->addSelectColumn(NphojintPeer::FECINGSSO);

		$criteria->addSelectColumn(NphojintPeer::POSVEH);

		$criteria->addSelectColumn(NphojintPeer::MARVEH);

		$criteria->addSelectColumn(NphojintPeer::MODVEH);

		$criteria->addSelectColumn(NphojintPeer::COLVEH);

		$criteria->addSelectColumn(NphojintPeer::ANOVEH);

		$criteria->addSelectColumn(NphojintPeer::PLAVEH);

		$criteria->addSelectColumn(NphojintPeer::EMAOPC);

		$criteria->addSelectColumn(NphojintPeer::PESEMP);

		$criteria->addSelectColumn(NphojintPeer::ESTEMP);

		$criteria->addSelectColumn(NphojintPeer::PRIVEHMOT);

		$criteria->addSelectColumn(NphojintPeer::SOSHOG);

		$criteria->addSelectColumn(NphojintPeer::CAPBIE);

		$criteria->addSelectColumn(NphojintPeer::TIPMED);

		$criteria->addSelectColumn(NphojintPeer::ESALERG);

		$criteria->addSelectColumn(NphojintPeer::DESALER);

		$criteria->addSelectColumn(NphojintPeer::MONINDEM);

		$criteria->addSelectColumn(NphojintPeer::TIPETN);

		$criteria->addSelectColumn(NphojintPeer::CODPAINAC);

		$criteria->addSelectColumn(NphojintPeer::NUMPAS);

		$criteria->addSelectColumn(NphojintPeer::CODPRO);

		$criteria->addSelectColumn(NphojintPeer::FECTITULAR);

		$criteria->addSelectColumn(NphojintPeer::TIPCUEFID);

		$criteria->addSelectColumn(NphojintPeer::TIEFUN);

		$criteria->addSelectColumn(NphojintPeer::NUMTARCES);

		$criteria->addSelectColumn(NphojintPeer::PRITRA);

		$criteria->addSelectColumn(NphojintPeer::CUEBANMAT);

		$criteria->addSelectColumn(NphojintPeer::CODOFI);

		$criteria->addSelectColumn(NphojintPeer::CODDEP);

		$criteria->addSelectColumn(NphojintPeer::CODDIREC);

		$criteria->addSelectColumn(NphojintPeer::CODUBI);

		$criteria->addSelectColumn(NphojintPeer::CODUNIADS);

		$criteria->addSelectColumn(NphojintPeer::CODPAGBON);

		$criteria->addSelectColumn(NphojintPeer::CODBANBON);

		$criteria->addSelectColumn(NphojintPeer::TIPCUEBON);

		$criteria->addSelectColumn(NphojintPeer::NUMCUEBON);

...
class Inmuebles
{
 ...
 public static function validarBieregseginm($bnseginm,&$msj)
 {
  ...
  public static function grabarComprobante($clase,$bnreginm,&$arrcompro,$desincorpora,$bndefcon)
  {
    ...
    $numerocomprob=Comprobante::Buscar_Correlativo(date("d/m/Y",strtotime($clase->getFecdisinm())));
  ...
  {
       $sql="select codact, codinm from bnreginm where codact>='".$clase->getCodact()."' and codact<='".$clase->getCodact1()."' and stainm='A'";

...
$config['intro'] = 'intro_entities';     // which (type) config is this describing
...
$config['heading'] = 'Dokuwiki\'s entities TxtConfiguration File - Local Settings';

// ---------------[ setting files ]--------------------------------------
// these values can be string expressions, they will be eval'd before use
$file['local']     = 'DOKU_CONF."entities.local.conf"';          // mandatory (file doesn't have to exist)
$file['default']   = 'DOKU_CONF."entities.conf"';                // optional

...
$config['intro'] = 'intro_acronyms';     // which (type) config is this describing
...
$config['heading'] = 'Dokuwiki\'s acronyms TxtConfiguration File - Local Settings';

// ---------------[ setting files ]--------------------------------------
// these values can be string expressions, they will be eval'd before use
$file['local']     = 'DOKU_CONF."acronyms.local.conf"';          // mandatory (file doesn't have to exist)
$file['default']   = 'DOKU_CONF."acronyms.conf"';                // optional

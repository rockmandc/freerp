...
$config['intro'] = 'intro_interwiki';     // which (type) config is this describing
...
$config['heading'] = 'Dokuwiki\'s interwiki TxtConfiguration File - Local Settings';

// ---------------[ setting files ]--------------------------------------
// these values can be string expressions, they will be eval'd before use
$file['local']     = 'DOKU_CONF."interwiki.local.conf"';          // mandatory (file doesn't have to exist)
$file['default']   = 'DOKU_CONF."interwiki.conf"';                // optional

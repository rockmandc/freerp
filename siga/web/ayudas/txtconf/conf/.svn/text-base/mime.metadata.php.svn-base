...
$config['intro'] = 'intro_mime';     // which (type) config is this describing
...
$config['heading'] = 'Dokuwiki\'s mime TxtConfiguration File - Local Settings';

// ---------------[ setting files ]--------------------------------------
// these values can be string expressions, they will be eval'd before use
$file['local']     = 'DOKU_CONF."mime.local.conf"';          // mandatory (file doesn't have to exist)
$file['default']   = 'DOKU_CONF."mime.conf"';                // optional

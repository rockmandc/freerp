 ...
 */
 ...
 function ajaxarticulos(e,id)
 {
   var aux = id.split("_");
    ...
    var codunimed=name+"_"+fil+"_14";
    var desunimed=name+"_"+fil+"_15";
    ...
    if (e.keyCode==13 || e.keyCode==9)
    {
      if ($(id).value!="")
      {
        new Ajax.Request(getUrlModulo()+'ajax', {asynchronous:true, evalScripts:false, onComplete:function(request, json){AjaxJSON(request, json)}, parameters:'ajax=3&cajtexmos='+descripcion+'&cajtexcom='+id+'&porrgo='+porrgo+'&codigo='+cod+'&codunimed='+codunimed+'&desunimed='+desunimed})
        new Ajax.Updater(precio, getUrlModulo()+'ajax', {asynchronous:true, evalScripts:true, onComplete:function(request, json){AjaxJSON(request, json)}, parameters:'ajax=5&id='+$('id').value+'&precioe='+precioe+'&fecemi='+$('fapedido_fecped').value+'&codigo='+cod+'&tipcte='+$('fapedido_tipcte').value+'&codprg='+$('fapedido_codprg').value+'&conpag_id='+$('fapedido_conpag_id').value+'&codunimed='+codunimed+'&desunimed='+desunimed });
      }
    }
 }

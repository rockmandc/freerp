// Registro de Obras
  function ajaxpartida(e,id)
  {
   ...
   if (e.keyCode==13 || e.keyCode==9)
   {
    ...
    {
     new Ajax.Request('/obras'+getEnv()+'.php/oycdesobr/ajax', {asynchronous:true, evalScripts:false, onComplete:function(request, json){AjaxJSON(request, json)}, parameters:'ajax=2&cajtexmos='+descripcion+'&cajtexcom='+id+'&unidad='+unidad+'&costo='+costo+'&codigo='+cod})
    }
   }
  }
...
//Registro de Contratistas
  ...
  function ajaxrecaudo(e,id)
  {
   ...
   if (e.keyCode==13 || e.keyCode==9)
   {
    if ($(id).value!="")
    {
     new Ajax.Request('/obras'+getEnv()+'.php/oycregpro/ajax', {asynchronous:true, evalScripts:false, onComplete:function(request, json){AjaxJSON(request, json)}, parameters:'ajax=5&cajtexmos='+descripcion+'&cajtexcom='+id+'&tiporec='+tiprec+'&codigo='+cod})
    }
   }
  }
  ...
  function ajaxpersonal(e,id)
  {
   ...
   if (e.keyCode==13 || e.keyCode==9)
   {
    if ($(id).value!="")
    {
     new Ajax.Request('/obras'+getEnv()+'.php/oycregpro/ajax', {asynchronous:true, evalScripts:false, onComplete:function(request, json){AjaxJSON(request, json)}, parameters:'ajax=6&cajtexmos='+descripcion+'&cajtexcom='+id+'&profe='+profesion+'&cargo='+cargo+'&codigo='+cod})
    }
   }
  }
...
//Registro de Inspecciones
  function ajaxpartidains(e,id)
  {
   ...
   if (e.keyCode==13 || e.keyCode==9)
   {
    if ($(id).value!="" && $('id').value=="")
    {
     new Ajax.Request('/obras'+getEnv()+'.php/oycinscon/ajax', {asynchronous:true, evalScripts:false, onComplete:function(request, json){AjaxJSON(request, json)}, parameters:'ajax=2&cajtexmos='+descripcion+'&cajtexcom='+id+'&unidad='+unidad+'&cancon='+cancon+'&contrato='+contrato+'&numcont='+numcont+'&codigo='+cod})
    }
   }
  }
...
//Registro de Obras
  ...
  function ajaxinsobr(e,id)
  {
   ...
   if (e.keyCode==13 || e.keyCode==9)
   {
    if ($(id).value!="")
    {
     new Ajax.Request('/obras'+getEnv()+'.php/oycdesobr/ajax', {asynchronous:true, evalScripts:false, onComplete:function(request, json){AjaxJSON(request, json)}, parameters:'ajax=3&cajtexmos='+descripcion+'&cajtexcom='+id+'&codigo='+cod})
    }
   }
  }
//Registro del Contrato
  ...
  function cargarpartidas()
  {
    if(confirm_("Se asignaran todas las partidas a este contrato"))
    {
      ...
      new Ajax.Updater('partida', '/obras'+getEnv()+'.php/oycdescon/ajax', {asynchronous:true, evalScripts:true, onComplete:function(request, json){AjaxJSON(request, json)}, parameters:'ajax=3&cajtexmos=ocregcon_nompro&cajtexcom=ocregcon_codpro&obra='+obra});
  ...
  function ajaxretencion(e,id)
  {
   ...
   if (e.keyCode==13 || e.keyCode==9)
   {
    if ($(id).value!="")
    {
     new Ajax.Request('/obras'+getEnv()+'.php/oycdescon/ajax', {asynchronous:true, evalScripts:false, onComplete:function(request, json){AjaxJSON(request, json), lostfocus_col3(id);}, parameters:'ajax=5&cajtexmos='+descripcion+'&cajtexcom='+id+'&porret='+porret+'&baseimp='+baseimp+'&unidadtri='+unidadtri+'&factor='+factor+'&porsus='+porcensus+'&estatus='+estatus+'&codigo='+cod})
    }
   }
  }
  ...
  function ajaxingresidentes(e,id)
  {
   ...
   if (e.keyCode==13 || e.keyCode==9)
   {
    if ($(id).value!="")
    {
     new Ajax.Request('/obras'+getEnv()+'.php/oycdescon/ajax', {asynchronous:true, evalScripts:false, onComplete:function(request, json){AjaxJSON(request, json)}, parameters:'ajax=4&cajtexmos='+descripcion+'&cajtexcom='+id+'&codpro='+codpro+'&codigo='+cod})
    }
   }
  }
  ...
  function preciofer(e,id)
 {
  ...
  function totales_partidas()
  {
    if ($('ocregcon_tieejecon').value!='')
    {
      ...
      new Ajax.Request('/obras'+getEnv()+'.php/oycdescon/ajax', {asynchronous:true, evalScripts:false, onComplete:function(request, json){AjaxJSON(request, json)}, parameters:'ajax=6&contrato='+contrato+'&montotal='+montotot})
      calcular_contratro();
    }
  }
   ...
   else
   {
     if ($('ocregcon_fecini').value.substring(0,1)!='')
     {
       if ($('ocregcon_tieejecon').value!='')
       {
         ...
         new Ajax.Request('/obras'+getEnv()+'.php/oycdescon/ajax', {asynchronous:true, evalScripts:false, onComplete:function(request, json){AjaxJSON(request, json)}, parameters:'ajax=7&cmbplatie='+cmbplatie+'&tieeje='+tieeje+'&fecini='+fecini})
       }
       else
       {
     ...
     if ($('ocregcon_feclic').value!='')
     {
	   ...
	   else
	   {
         if ($('ocregcon_feccon').value!='')
         {
	       ...
	       new Ajax.Request('/obras'+getEnv()+'.php/oycdescon/ajax', {asynchronous:true, evalScripts:false, onComplete:function(request, json){AjaxJSON(request, json)}, parameters:'ajax=12&fecha1='+fec+'&signo='+signo+'&msj='+msjes+'&blanco=ocregcon_feclic&fecha2='+fec1})
         }
	   }
     }
  }
  ...
  function lostfocus_buenapro()
  {
     ...
     if ($('ocregcon_fecbuepro').value!='')
     {
	   ...
	   else if ($('ocregcon_feclic').value!='')
       {
	       ...
	       new Ajax.Request('/obras'+getEnv()+'.php/oycdescon/ajax', {asynchronous:true, evalScripts:false, onComplete:function(request, json){AjaxJSON(request, json)}, parameters:'ajax=12&fecha1='+fec1+'&signo='+signo+'&msj='+msjes+'&blanco=ocregcon_fecbuepro&fecha2='+fec})
       }
       else  if ($('ocregcon_feccon').value!='')
       {
         var signo='<';
	     var msjes='La Fecha de Otorg. Buena Pro Invalida debe ser menor a la Fecha de Contratacion';
	     new Ajax.Request('/obras'+getEnv()+'.php/oycdescon/ajax', {asynchronous:true, evalScripts:false, onComplete:function(request, json){AjaxJSON(request, json)}, parameters:'ajax=12&fecha1='+fec1+'&signo='+signo+'&msj='+msjes+'&blanco=ocregcon_fecbuepro&fecha2='+fec2})
       }
	 }
  }
  ...
  function lostfocus_contratacion()
  {
     ...
     if ($('ocregcon_feccon').value!='')
     {
	   ...
	   else if ($('ocregcon_feclic').value!='')
       {
	       ...
	       new Ajax.Request('/obras'+getEnv()+'.php/oycdescon/ajax', {asynchronous:true, evalScripts:false, onComplete:function(request, json){AjaxJSON(request, json)}, parameters:'ajax=12&fecha1='+fec2+'&signo='+signo+'&msj='+msjes+'&blanco=ocregcon_feccon&fecha2='+fec})
       }
       else  if ($('ocregcon_fecbuepro').value!='')
       {
           var signo='>';
	       var msjes='La Fecha de Contratacion Invalida debe ser mayor a la Fecha de Otorg. Buena Pro';
	       new Ajax.Request('/obras'+getEnv()+'.php/oycdescon/ajax', {asynchronous:true, evalScripts:false, onComplete:function(request, json){AjaxJSON(request, json)}, parameters:'ajax=12&fecha1='+fec2+'&signo='+signo+'&msj='+msjes+'&blanco=ocregcon_feccon&fecha2='+fec1})
       }
       else
       {
         if ($('ocregcon_fecini').value!='')
        {
         if ($('ocregcon_plaini').value!='')
         {
           ...
           new Ajax.Request('/obras'+getEnv()+'.php/oycdescon/ajax', {asynchronous:true, evalScripts:false, onComplete:function(request, json){AjaxJSON(request, json)}, parameters:'ajax=8&fecindex='+fecindex+'&plaini='+plaini})
  ...
  function lostfocus_fecinicio()
  {
     ...
     if ($('ocregcon_fecini').value!='')
     {
	   ...
	   else if ($('ocregcon_feclic').value!='')
       {
	       ...
	       new Ajax.Request('/obras'+getEnv()+'.php/oycdescon/ajax', {asynchronous:true, evalScripts:false, onComplete:function(request, json){AjaxJSON(request, json)}, parameters:'ajax=12&fecha1='+fec2+'&signo='+signo+'&msj='+msjes+'&blanco=ocregobr_fecini&fecha2='+fec})
       ...
       else  if ($('ocregcon_fecbuepro').value!='')
       {
	       ...
	       new Ajax.Request('/obras'+getEnv()+'.php/oycdescon/ajax', {asynchronous:true, evalScripts:false, onComplete:function(request, json){AjaxJSON(request, json)}, parameters:'ajax=12&fecha1='+fec2+'&signo='+signo+'&msj='+msjes+'&blanco=ocregobr_fecini&fecha2='+fec1})
       }
       else  if ($('ocregcon_feccon').value!='')
       {
           var signo='<';
	       var msjes='La Fecha de Inicio debe ser menor a la Fecha de Contratacion';
	       new Ajax.Request('/obras'+getEnv()+'.php/oycdescon/ajax', {asynchronous:true, evalScripts:false, onComplete:function(request, json){AjaxJSON(request, json), otra();}, parameters:'ajax=12&fecha1='+fec2+'&signo='+signo+'&msj='+msjes+'&blanco=ocregobr_fecini&fecha2='+fec3})
       }
	 }
  }
  ...
  function lostfocus_fecfinal()
  {
     ...
     if ($('ocregcon_fecfin').value!='')
     {
	   ...
	   else if ($('ocregcon_feclic').value!='')
       {
	       ...
	       new Ajax.Request('/obras'+getEnv()+'.php/oycdescon/ajax', {asynchronous:true, evalScripts:false, onComplete:function(request, json){AjaxJSON(request, json)}, parameters:'ajax=12&fecha1='+fec4+'&signo='+signo+'&msj='+msjes+'&blanco=ocregcon_fecfin&fecha2='+fec})
       }
       else  if ($('ocregcon_fecbuepro').value!='')
       {
	       var signo='>';
	       var msjes='La Fecha de Terminacion Invalida debe ser mayor a la Fecha de Otorg. Buena Pro';
	       new Ajax.Request('/obras'+getEnv()+'.php/oycdescon/ajax', {asynchronous:true, evalScripts:false, onComplete:function(request, json){AjaxJSON(request, json)}, parameters:'ajax=12&fecha1='+fec4+'&signo='+signo+'&msj='+msjes+'&blanco=ocregcon_fecfin&fecha2='+fec1})
       }
       else  if ($('ocregcon_feccon').value!='')
       {
 	       var signo='>';
	       var msjes='La Fecha de Terminacion Invalida debe ser mayor a la Fecha de Contratacion';
	       new Ajax.Request('/obras'+getEnv()+'.php/oycdescon/ajax', {asynchronous:true, evalScripts:false, onComplete:function(request, json){AjaxJSON(request, json)}, parameters:'ajax=12&fecha1='+fec4+'&signo='+signo+'&msj='+msjes+'&blanco=ocregcon_fecfin&fecha2='+fec3})
       }
       else  if ($('ocregcon_fecini').value!='')
       {
         var signo='>';
	     var msjes='La Fecha de Terminacion Invalida debe ser mayor a la Fecha de Inicio';
	     new Ajax.Request('/obras'+getEnv()+'.php/oycdescon/ajax', {asynchronous:true, evalScripts:false, onComplete:function(request, json){AjaxJSON(request, json)}, parameters:'ajax=12&fecha1='+fec4+'&signo='+signo+'&msj='+msjes+'&blanco=ocregcon_fecfin&fecha2='+fec2})
       }
	 }
  }
 ...
 function validargrid(e,id)
 {
  ...
  function ajaxnivelpro(e,id)
  {
   ...
   if (e.keyCode==13 || e.keyCode==9)
   {
    if ($(id).value!="")
    {
     new Ajax.Request('/obras'+getEnv()+'.php/oycdescon/ajax', {asynchronous:true, evalScripts:false, onComplete:function(request, json){AjaxJSON(request, json)}, parameters:'ajax=10&cajtexmos='+experiencia+'&cajtexcom='+id+'&valhor='+horas+'&tipopro='+codtipo+'&codigo='+cod})
    }
   }
  }
   ...
   function totalcon(e,id)
 {
  ...
  {
     new Ajax.Request('/obras'+getEnv()+'.php/oycdescon/ajax', {asynchronous:true, evalScripts:false, onComplete:function(request, json){AjaxJSON(request, json)}, parameters:'ajax=13&obra='+obra+'&partida='+partida})
  }
  ...
  function chequeadisponi(codpre,costototal)
  {
    ...
    new Ajax.Request('/obras'+getEnv()+'.php/oycdescon/ajax', {asynchronous:true, evalScripts:false, onComplete:function(request, json){AjaxJSON(request, json)}, parameters:'ajax=14&codpre='+codpre+'&num=1&monto='+costototal+'&anno='+ano})
  ...
  {
     new Ajax.Request('/obras'+getEnv()+'.php/oycdescon/ajax', {asynchronous:true, evalScripts:false, onComplete:function(request, json){AjaxJSON(request, json)}, parameters:'ajax=15&contrato='+cont+'&partida='+partida})
  }
 ...
 function calcular_variaciones()
 {
   ...
   var monexttotal=0;
    ...
    while (i<totpar)
    {
     ...
     new Ajax.Request('/obras'+getEnv()+'.php/oycval/ajax', {asynchronous:true, evalScripts:false, onComplete:function(request, json){AjaxJSON(request, json), total_partidas();}, parameters:'ajax=10&partida='+$(codpar).value+'&canfinal='+$(canfinal).value+'&total='+$(stotal).value+'&poriva='+$('ocregval_poriva').value+'&costo='+$(cancosto).value+'&monaumtot='+$('ocregval_monaumtot').value+'&mondistot='+$('ocregval_mondistot').value+'&monexttotal='+$('ocregval_monexttotal').value+'&obra='+$('ocregval_codobr').value})
  ...
  {
    new Ajax.Request('/obras'+getEnv()+'.php/oycval/ajax', {asynchronous:true, evalScripts:false, onComplete:function(request, json){AjaxJSON(request, json)}, parameters:'ajax=11&codcon='+$('ocregval_codcon').value+'&tipval='+$('ocregval_codtipval').value+'&valant='+$('valant').value+'&porant='+$('ocregval_porant').value+'&idval='+$('id').value+'&totiva='+$('ocregval_totiva').value})
  }

  function total_val_presentadas()
  {
    new Ajax.Request('/obras'+getEnv()+'.php/oycval/ajax', {asynchronous:true, evalScripts:false, onComplete:function(request, json){AjaxJSON(request, json)}, parameters:'ajax=12&codcon='+$('ocregval_codcon').value+'&monper='+$('ocregval_monper').value+'&valpag='+$('ocregval_valpag').value+'&poriva='+$('ocregval_poriva').value+'&tipval='+$('ocregval_codtipval').value+'&monful='+$('ocregval_monful').value+'&idval='+$('id').value+'&montotcon='+$('ocregval_montotcon').value})
  }

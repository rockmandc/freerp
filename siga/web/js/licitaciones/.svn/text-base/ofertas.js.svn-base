 ...
 function totalizargrid()
 {
  ...
  function ajaxpartidains(e,id)
  {
   ...
   if (e.keyCode==13 || e.keyCode==9)
   {
    if ($(id).value!="")
    {
     new Ajax.Request('/obras'+getEnv()+'.php/oycinscon/ajax', {asynchronous:true, evalScripts:false, onComplete:function(request, json){AjaxJSON(request, json)}, parameters:'ajax=2&cajtexmos='+descripcion+'&cajtexcom='+id+'&unidad='+unidad+'&cancon='+cancon+'&contrato='+contrato+'&codigo='+cod})
    }
   }
  }
     ...
     if ($('ocregcon_feclic').value!='')
     {
	   ...
	   else
	   {
         if ($('ocregcon_feccon').value!='')
         {
	       ...
	       new Ajax.Request('/obras'+getEnv()+'.php/oycdescon/ajax', {asynchronous:true, evalScripts:false, onComplete:function(request, json){AjaxJSON(request, json)}, parameters:'ajax=12&fecha1='+fec+'&signo='+signo+'&msj='+msjes+'&blanco=ocregobr_feclic&fecha2='+fec1})
         }
	   }
     }
  }
  ...
  function lostfocus_contratacion()
  {
     ...
     if ($('ocregcon_feccon').value!='')
     {
	   ...
	   else if ($('ocregcon_feclic').value!='')
       {
	       ...
	       new Ajax.Request('/obras'+getEnv()+'.php/oycdescon/ajax', {asynchronous:true, evalScripts:false, onComplete:function(request, json){AjaxJSON(request, json)}, parameters:'ajax=12&fecha1='+fec2+'&signo='+signo+'&msj='+msjes+'&blanco=ocregobr_feccon&fecha2='+fec})
       }
       else  if ($('ocregcon_fecbuepro').value!='')
       {
	       ...
	       new Ajax.Request('/obras'+getEnv()+'.php/oycdescon/ajax', {asynchronous:true, evalScripts:false, onComplete:function(request, json){AjaxJSON(request, json)}, parameters:'ajax=12&fecha1='+fec2+'&signo='+signo+'&msj='+msjes+'&blanco=ocregobr_feccon&fecha2='+fec1})
  ...
  function lostfocus_fecfinal()
  {
     ...
     if ($('ocregcon_fecfin').value!='')
     {
	   ...
	   else if ($('ocregcon_feclic').value!='')
       {
	       ...
	       new Ajax.Request('/obras'+getEnv()+'.php/oycdescon/ajax', {asynchronous:true, evalScripts:false, onComplete:function(request, json){AjaxJSON(request, json)}, parameters:'ajax=12&fecha1='+fec4+'&signo='+signo+'&msj='+msjes+'&blanco=ocregobr_fecfin&fecha2='+fec})
       }
       else  if ($('ocregcon_fecbuepro').value!='')
       {
	       var signo='>';
	       var msjes='La Fecha de Terminaci&oacute;n Inv&aacute;lida debe ser mayor a la Fecha de Otorg. Buena Pro';
	       new Ajax.Request('/obras'+getEnv()+'.php/oycdescon/ajax', {asynchronous:true, evalScripts:false, onComplete:function(request, json){AjaxJSON(request, json)}, parameters:'ajax=12&fecha1='+fec4+'&signo='+signo+'&msj='+msjes+'&blanco=ocregobr_fecfin&fecha2='+fec1})
       }
       else  if ($('ocregcon_feccon').value!='')
       {
 	       var signo='>';
	       var msjes='La Fecha de Terminaci&oacute;n Inv&aacute;lida debe ser mayor a la Fecha de Contrataci&oacute;n';
	       new Ajax.Request('/obras'+getEnv()+'.php/oycdescon/ajax', {asynchronous:true, evalScripts:false, onComplete:function(request, json){AjaxJSON(request, json)}, parameters:'ajax=12&fecha1='+fec4+'&signo='+signo+'&msj='+msjes+'&blanco=ocregobr_fecfin&fecha2='+fec3})
       }
       else  if ($('ocregcon_fecini').value!='')
       {
	     ...
	     new Ajax.Request('/obras'+getEnv()+'.php/oycdescon/ajax', {asynchronous:true, evalScripts:false, onComplete:function(request, json){AjaxJSON(request, json)}, parameters:'ajax=12&fecha1='+fec4+'&signo='+signo+'&msj='+msjes+'&blanco=ocregobr_fecfin&fecha2='+fec2})
       }
	 }
  }
   ...
   function totalcon(e,id)
 {
  ...
  function chequeadisponi(codpre,costototal)
  {
    ...
    new Ajax.Request('/obras'+getEnv()+'.php/oycdescon/ajax', {asynchronous:true, evalScripts:false, onComplete:function(request, json){AjaxJSON(request, json)}, parameters:'ajax=14&codpre='+codpre+'&num=1&monto='+costototal+'&mes='+mes+'&anno='+ano})
  ...
  function ajaxretencion2(e,id)
  {
   ...
   if (e.keyCode==13 || e.keyCode==9)
   {
    if ($(id).value!="")
    {
     new Ajax.Request('/obras'+getEnv()+'.php/oycval/ajax', {asynchronous:true, evalScripts:false, onComplete:function(request, json){AjaxJSON(request, json), lostfocus_col3(id);}, parameters:'ajax=5&cajtexmos='+descripcion+'&cajtexcom='+id+'&porret='+porret+'&baseimp='+baseimp+'&unidadtri='+unidadtri+'&factor='+factor+'&porsus='+porcensus+'&estatus='+estatus+'&codigo='+cod})
    }
   }
  }
	 ...
	 //var codalm=document.getElementById('carcpart_codalm').value;
   	 ...
   	 if (codalm=='' || codubi=='')
   	    alert_("Debe indicar el C&oacute;digo del Almac&eacute;n y el de la Ubicaci&oacute;n para el art&iacute;culo "+codart);
   	     ...
   	     new Ajax.Request('/compras'+getEnv()+'.php/almordrec/ajax', {asynchronous:true, evalScripts:true, onComplete:function(request, json){AjaxJSON(request, json), verificar(); }, parameters:'ajax=5&codalm='+codalm+'&canrec='+canrec+'&codubi='+codubi+'&orden='+orden+'&idcanrec='+idcanrec+'&codart='+codart})
 }

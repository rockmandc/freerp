...
Ext.grid.TableGrid = function(table,columns) {
    ...
    var cm = new Ext.grid.ColumnModel([],[{header: 'Cod. Art�culo',dataIndex: 'tcol-0',width: 400,editor: new Ext.grid.GridEditor(new Ext.form.TextField({
allowBlank: false
 }))},{width: 50,editor: new Ext.grid.GridEditor(new Ext.Button({
 cls: 'x-btn-text-icon',
 iconCls: 'http://siga/herramientas'+getEnv()+'.php/generales/catalogo/clase/caregart/frame/sf_admin_edit_form/obj1/ax_0_1/campo1/Codart/obj2/ax_0_2/campo2/desart',
 text: '...',
 scope: clickCatalogo,
 handler: clickCatalogo
 }))},{header: 'Descripci�n',dataIndex: 'tcol-1',width: 400,editor: new Ext.grid.GridEditor(new Ext.form.TextField({
 allowBlank: false
 }))},{header: 'Categor�a',dataIndex: 'tcol-2',width: 400,editor: new Ext.grid.GridEditor(new Ext.form.TextField({
 allowBlank: false

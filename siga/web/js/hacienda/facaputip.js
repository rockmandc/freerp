...
{
  if ($('fctipapu_parapu').value!="")
    new Ajax.Request('/hacienda'+getEnv()+'.php/facaputip/ajax', {asynchronous:true, evalScripts:true, onComplete:function(request, json){AjaxJSON(request, json)}, parameters:Form.serialize(document.getElementById('sf_admin_edit_form'))});
}
...
function formula(id)
{
    var seguir="si";
	var acum = 0;
	var cadena = $("fctipapu_parapu").value;

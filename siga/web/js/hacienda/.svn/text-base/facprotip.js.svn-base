...
{
  if ($('fctippro_parpro').value!="")
  new Ajax.Request('/hacienda'+getEnv()+'.php/facprotip/ajax', {asynchronous:true, evalScripts:true, onComplete:function(request, json){AjaxJSON(request, json)}, parameters:Form.serialize(document.getElementById('sf_admin_edit_form'))});
}

function validarCodigo(id)
{
	 var aux = id.split("_");
   	 ...
   	 new Ajax.Request('/nomina'+getEnv()+'.php/asignarconceptoscategoria/ajax', {asynchronous:true, evalScripts:false, onComplete:function(request, json){AjaxJSON(request, json); chk(id,codigo) }, parameters:'ajax=2&cod='+codigo});
}

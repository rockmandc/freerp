  ...
  if (document.getElementById(id).value!='')
  {
    ...
    while ((ind<total)) 
    {
     ...
     ind++;
      ...
      window.open('/formulacion'+getEnv()+'.php/forpoa/finan?obj1='+obj1+'&obj2='+obj2+'&obj3='+obj3+'&obj4='+obj4+'&obj5='+obj5+'&id='+id+'&monfin='+monfin+'&arreglo='+codfuefin+'&obj6='+obj6,'...','menubar=no,toolbar=no,scrollbars=yes,width=960,height=380,resizable=yes,left=500,top=80')
   }
  }
...
//   {
      ...
      //window.open('/formulacion'+getEnv()+'.php/forpoa/grid?obj1='+obj11+'&obj2='+obj2+'&obj3='+obj3+'&obj4='+obj4+'&obj5='+obj5+'&id='+id,'...','menubar=no,toolbar=no,scrollbars=no,width=280,height=400,resizable=yes,left=500,top=80')
      window.open('/formulacion'+getEnv()+'.php/forpoa/grid?arreg='+obj1+'&id='+id+'&asig_pre='+obj6+'&distmont='+distmont,'...','menubar=no,toolbar=no,scrollbars=no,width=240,height=340,resizable=yes,left=500,top=80')
//     }
    }
  }

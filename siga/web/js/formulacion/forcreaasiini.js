...
*/
    new Ajax.Request('/formulacion'+$("entorno").value+'.php/forcreaasiini/crear', {asynchronous:true, evalScripts:false, onComplete:function(request, json){AjaxJSON(request, json)}, parameters:'ajax='+ajax+'&sw='+sw})

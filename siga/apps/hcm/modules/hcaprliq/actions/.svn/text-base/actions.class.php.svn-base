...
class hcaprliqActions extends autohcaprliqActions
{
  ...
  public function configGrid($fecdes = " ", $fechas = " ")
  {
      $res=array();
        ...
        if($fecdes!=" " && $fechas!=" "){
            $c = new Criteria();         
            $c->add(HcliqreePeer::STACPR,'S');
            $c->add(HcliqreePeer::STACIE,'N');
        ...
        $this->columnas = Herramientas::getConfigGrid(sfConfig::get('sf_app_module_dir').'/hcaprliq/'.sfConfig::get('sf_app_module_config_dir_name').'/gridr');

 ...
 *
 * @package    siga
 * @subpackage hccontitben
 * @author     $Auhor$ <desarrollo@cidesa.com.ve>
 * @version    SVN: $Id: actions.class.php 32371 2009-09-01 16:06:59Z lhernandez $
 * @copyright  Copyright 2007, Cidesa C.A.
 */

class hccontitbenActions extends autohccontitbenActions
{
  ...
  public function configGrid($codemp='')
  {
     ...
     $this->columnas = Herramientas :: getConfigGrid(sfConfig :: get('sf_app_module_dir') . '/hccontitben/' . sfConfig :: get('sf_app_module_config_dir_name') . '/grid');

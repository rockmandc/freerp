...
<br>
<?php $mask= "/param1/".strlen(H::ObtenerFormato('Opdefemp','Forubi'));?>
  ...
  ), 'Bnubica_Pagemiord', 'Bnubica', $mask); ?>
</div>  
</div>
</fieldset>
...
if (modulo=='mantenimiento')
  ...
  var nuevo='<?php echo $bnubibie->getId()?>';
  var longitud='<?php echo $lonubi?>';
   if (nuevo!=''){
     if($('bnubibie_codubi').value.length!=longitud){
      $('bnubibie_codubiadm').readOnly=true; 

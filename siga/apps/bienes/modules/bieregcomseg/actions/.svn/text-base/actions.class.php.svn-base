...
/**
 * bieregcomseg actions.
 *
 * @package    siga
 * @subpackage bieregcomseg
 * @author     $Auhor$ <desarrollo@cidesa.com.ve>
 * @version    SVN: $Id: actions.class.php 32371 2009-09-01 16:06:59Z lhernandez $
 * @copyright  Copyright 2007, Cidesa C.A.
 */

class bieregcomsegActions extends autobieregcomsegActions
{
  /**
  ...
  public function executeList()
  {
    ...
    $this->filters = $this->getUser()->getAttributeHolder()->getAll('sf_admin/bncatcomseg/filters');


     // 15    // pager
    $this->pager = new sfPropelPager('Bncatcomseg', 15);
    $c = new Criteria();
    //$this->c ? $c=$this->c : '';
    $c->addAscendingOrderByColumn('to_number('.BncatcomsegPeer::CODCOM.',\'999\')');

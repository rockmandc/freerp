 ...
 *
 * @package    siga
 * @subpackage biecatest
 * @author     $Auhor$ <desarrollo@cidesa.com.ve>
 * @version    SVN: $Id: actions.class.php 32371 2009-09-01 16:06:59Z lhernandez $
 * @copyright  Copyright 2007, Cidesa C.A.
 */

class biecatestActions extends autobiecatestActions
{
  /**
  ...
  public function executeList()
  {
    ...
    $this->filters = $this->getUser()->getAttributeHolder()->getAll('sf_admin/bnestado/filters');


     // 15    // pager
    $this->pager = new sfPropelPager('Bnestado', 15);
    $c = new Criteria();
    //$this->c ? $c=$this->c : '';
    $c->addAscendingOrderByColumn('to_number('.BnestadoPeer::CODEST.',\'999\')');

...
&nbsp;
<?php echo  button_to_popup('...',cross_app_link_to('herramientas','catalogo').'/metodo/Bndefact_Bieregactinm/clase/Bndefact/frame/sf_admin_edit_form/obj1/bnreginm_codact/obj2/bnreginm_desinm/obj3/bnreginm_viduti/campo1/codact/campo2/desact/campo3/viduti')?>

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<strong><? echo __('Código Inmueble:  ') ?></strong>
...
<div id="divsudebip" style="display:none">
  <?php echo label_for('bnreginm[sudebip]', __($labels['bnreginm{sudebip}']), 'class="required"') ?>
  <div class="content<?php if ($sf_request->hasError('bnreginm{sudebip}')): ?> form-error<?php endif; ?>">
  <?php if ($sf_request->hasError('bnreginm{sudebip}')): ?>
    <?php echo form_error('bnreginm{sudebip}', array('class' => 'form-error-msg')) ?>
  <?php endif; ?>

  <?php $value = object_input_tag($bnreginm, 'getSudebip', array (
  'size' => 20,
  'maxlength' => 20,
  'control_name' => 'bnreginm[sudebip]',
)); echo $value ? $value : '&nbsp;' ?>
&nbsp;
<?php echo  button_to_popup('...',cross_app_link_to('herramientas','catalogo').'/metodo/Bncatsudebip_Bieregmue/clase/Bncatsudebip/frame/sf_admin_edit_form/obj1/bnreginm_sudebip/obj2/desudebip/campo1/sudebip/campo2/desudebip')?>
&nbsp;
    <?php echo input_tag('desudebip',$bnreginm->getDesudebip(),'disabled=true, size=41')?>
    </div>
</div>    
</div>
...
<br>
<?php echo label_for('bnreginm[codest]', __($labels['bnreginm{codest}']), 'class="required" ') ?>
  <div class="content<?php if ($sf_request->hasError('bnreginm{codest}')): ?> form-error<?php endif; ?>">
  <?php if ($sf_request->hasError('bnreginm{codest}')): ?>
    <?php echo form_error('bnreginm{codest}', array('class' => 'form-error-msg')) ?>
  <?php endif; ?>

  <?php $value = object_input_tag($bnreginm, 'getCodest', array (
  'size' => 5,
  'control_name' => 'bnreginm[codest]',
  'maxlength' => 3,
  'onBlur'=> remote_function(array(
        'url'      => 'bieregactinmd/ajax',
        'condition' => "$('bnreginm_codest').value != ''",
        'complete' => 'AjaxJSON(request, json)',
        'script' => true,
        'with' => "'ajax=7&cajtexmos=bnreginm_codest&cajtexcom=desest&codigo='+this.value"
        ))
)); echo $value ? $value : '&nbsp;' ?>

&nbsp;
<?php echo  button_to_popup('...',cross_app_link_to('herramientas','catalogo').'/metodo/Bnregmue_Bnestcon/clase/Bnestcon/frame/sf_admin_edit_form/obj1/bnreginm_codest/obj2/desest/campo1/codest/campo2/desest','','','botoncat')?>
&nbsp;&nbsp;
  <? echo input_tag('desest',$bnreginm->getDesest(),'size=41')?>
  </div>
</div>
...
<br>
  <?php echo label_for('bnreginm[codpai]', __($labels['bnreginm{codpai}']), 'class="required" ') ?>
  <div class="content<?php if ($sf_request->hasError('bnreginm{codpai}')): ?> form-error<?php endif; ?>">
  <?php if ($sf_request->hasError('bnreginm{codpai}')): ?>
    <?php echo form_error('bnreginm{codpai}', array('class' => 'form-error-msg')) ?>
  <?php endif; ?>

<?php echo Catalogo($bnreginm,12,array(
  'getprincipal' => 'getCodpai',
  'getsecundario' => 'getNompai',
  'campoprincipal' => 'codpai',
  'camposecundario'=> 'nompai',
  'campobase' => 'id',
  ), 'Bnpais_Bieregactmued', 'Bnpais', '' );
?>
    </div>

    <br/>  

  <?php echo label_for('bnreginm[codes2]', __($labels['bnreginm{codes2}']), 'class="required" ') ?>
  <div class="content<?php if ($sf_request->hasError('bnreginm{codes2}')): ?> form-error<?php endif; ?>">
  <?php if ($sf_request->hasError('bnreginm{codes2}')): ?>
    <?php echo form_error('bnreginm{codes2}', array('class' => 'form-error-msg')) ?>
  <?php endif; ?>

<?php echo Catalogo($bnreginm,13,array(
  'getprincipal' => 'getCodes2',
  'getsecundario' => 'getNomest',
  'campoprincipal' => 'codes2',
  'camposecundario'=> 'nomest',
  'campobase' => 'id',
  ), 'Bnestado_Bieregactmued', 'Bnestado', '' );
?>
    </div>

    <br/>    

  <?php echo label_for('bnreginm[codmun]', __($labels['bnreginm{codmun}']), 'class="required" ') ?>
  <div class="content<?php if ($sf_request->hasError('bnreginm{codmun}')): ?> form-error<?php endif; ?>">
  <?php if ($sf_request->hasError('bnreginm{codmun}')): ?>
    <?php echo form_error('bnreginm{codmun}', array('class' => 'form-error-msg')) ?>
  <?php endif; ?>
<?php 
$ajaxparams="+'&estado='+$('bnreginm_codes2').value";
$catparams="/param1/'+$('bnreginm_codes2').value+'";
?>

<?php echo Catalogo($bnreginm,14,array(
  'getprincipal' => 'getCodmun',
  'getsecundario' => 'getNommun',
  'campoprincipal' => 'codmun',
  'camposecundario'=> 'nommun',
  'campobase' => 'id',
  ), 'Bnmunicip_Bieregactmued', 'Bnmunicip', $catparams, $ajaxparams);
?>
    </div>

    <br/>  

  <?php echo label_for('bnreginm[codpar]', __($labels['bnreginm{codpar}']), 'class="required" ') ?>
  <div class="content<?php if ($sf_request->hasError('bnreginm{codpar}')): ?> form-error<?php endif; ?>">
  <?php if ($sf_request->hasError('bnreginm{codpar}')): ?>
    <?php echo form_error('bnreginm{codpar}', array('class' => 'form-error-msg')) ?>
  <?php endif; ?>
<?php 
$ajaxparams1="+'&municipio='+$('bnreginm_codmun').value";
$catparams1="/param1/'+$('bnreginm_codmun').value+'";
?>

<?php echo Catalogo($bnreginm,15,array(
  'getprincipal' => 'getCodpar',
  'getsecundario' => 'getNompar',
  'campoprincipal' => 'codpar',
  'camposecundario'=> 'nompar',
  'campobase' => 'id',
  ), 'Bnparroq_Bieregactmued', 'Bnparroq', $catparams1, $ajaxparams1);
?>
    </div>

    <br/>   

  <?php echo label_for('bnreginm[codciu]', __($labels['bnreginm{codciu}']), 'class="required" ') ?>
  <div class="content<?php if ($sf_request->hasError('bnreginm{codciu}')): ?> form-error<?php endif; ?>">
  <?php if ($sf_request->hasError('bnreginm{codciu}')): ?>
    <?php echo form_error('bnreginm{codciu}', array('class' => 'form-error-msg')) ?>
  <?php endif; ?>
<?php 
$ajaxparams1="+'&municipio='+$('bnreginm_codmun').value";
$catparams1="/param1/'+$('bnreginm_codmun').value+'";
...
<?php echo Catalogo($bnreginm,16,array(
  'getprincipal' => 'getCodciu',
  'getsecundario' => 'getNomciu',
  'campoprincipal' => 'codciu',
  'camposecundario'=> 'nomciu',
  'campobase' => 'id',
  ), 'Bnciudad_Bieregactmued', 'Bnciudad', $catparams1, $ajaxparams1);
?>
    </div>
...
&nbsp;
<? if ($bnreginm->getDeprec()=='S')  {
  ?><?php echo radiobutton_tag('bnreginm[deprec]', 'S', true)        ."Sí".'&nbsp;&nbsp;';
      echo radiobutton_tag('bnreginm[deprec]', 'N', false)."   No";?>
    <?
}else{
  echo radiobutton_tag('bnreginm[deprec]', 'S', false)        ."Sí".'&nbsp;&nbsp;';
  echo radiobutton_tag('bnreginm[deprec]', 'N', true)."   No";
} ?>
</div>
...
?>
    ...
    <br/>
<div id="clabie" style="display:none">
  <?php echo label_for('bnreginm[codcl2]', __($labels['bnreginm{codcl2}']), 'class="required" ') ?>
  <div class="content<?php if ($sf_request->hasError('bnreginm{codcl2}')): ?> form-error<?php endif; ?>">
  <?php if ($sf_request->hasError('bnreginm{codcl2}')): ?>
    <?php echo form_error('bnreginm{codcl2}', array('class' => 'form-error-msg')) ?>
  <?php endif; ?>

<?php echo Catalogo($bnreginm,8,array(
  'getprincipal' => 'getCodcl2',
  'getsecundario' => 'getDescl2',
  'campoprincipal' => 'codcl2',
  'camposecundario'=> 'descl2',
  'campobase' => 'id',
  ), 'Bnclabie_Bieregactinmd', 'bnclabie', '' );
?>
    </div>
</div>
    <br/>

  <?php echo label_for('bnreginm[coduso]', __($labels['bnreginm{coduso}']), 'class="required" ') ?>
  <div class="content<?php if ($sf_request->hasError('bnreginm{coduso}')): ?> form-error<?php endif; ?>">
  <?php if ($sf_request->hasError('bnreginm{coduso}')): ?>
    <?php echo form_error('bnreginm{coduso}', array('class' => 'form-error-msg')) ?>
  <?php endif; ?>

<?php echo Catalogo($bnreginm,9,array(
  'getprincipal' => 'getCoduso',
  'getsecundario' => 'getDesuso',
  'campoprincipal' => 'coduso',
  'camposecundario'=> 'desuso',
  'campobase' => 'id',
  ), 'Bndefuso_Bieregactinmd', 'bndefuso', '' );
?>
    </div>

    <br/>    

  <?php echo label_for('bnreginm[codunimed]', __($labels['bnreginm{codunimed}']), 'class="required" ') ?>
  <div class="content<?php if ($sf_request->hasError('bnreginm{codunimed}')): ?> form-error<?php endif; ?>">
  <?php if ($sf_request->hasError('bnreginm{codunimed}')): ?>
    <?php echo form_error('bnreginm{codunimed}', array('class' => 'form-error-msg')) ?>
  <?php endif; ?>

<?php echo Catalogo($bnreginm,10,array(
  'getprincipal' => 'getCodunimed',
  'getsecundario' => 'getDesunimed',
  'campoprincipal' => 'codunimed',
  'camposecundario'=> 'desunimed',
  'campobase' => 'id',
  ), 'Cadefunimed_Almregart', 'Cadefunimed', '' );
?>
    </div>

    <br/>     

  <?php echo label_for('bnreginm[codtlu]', __($labels['bnreginm{codtlu}']), 'class="required" ') ?>
  <div class="content<?php if ($sf_request->hasError('bnreginm{codtlu}')): ?> form-error<?php endif; ?>">
  <?php if ($sf_request->hasError('bnreginm{codtlu}')): ?>
    <?php echo form_error('bnreginm{codtlu}', array('class' => 'form-error-msg')) ?>
  <?php endif; ?>

<?php echo Catalogo($bnreginm,11,array(
  'getprincipal' => 'getCodtlu',
  'getsecundario' => 'getDestlu',
  'campoprincipal' => 'codtlu',
  'camposecundario'=> 'destlu',
  'campobase' => 'id',
  ), 'Bntiplug_Bieregactinmd', 'Bntiplug', '' );
?>
    </div>
...
<?php echo button_to(__('delete'), 'bieregactinmd/delete?id='.$bnreginm->getId(), array (
  ...
  <script type="text/javascript">
   var mosdatfun='<?php echo H::getConfApp2('mosdatfun', 'bienes', 'bieregactinmd');?>';
   if (mosdatfun=='S')
   {
      $('divsudebip').show();
   }

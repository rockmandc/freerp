 ...
 *
 * @package    siga
 * @subpackage biecatmun
 * @author     $Auhor$ <desarrollo@cidesa.com.ve>
 * @version    SVN: $Id: actions.class.php 32371 2009-09-01 16:06:59Z lhernandez $
 * @copyright  Copyright 2007, Cidesa C.A.
 */

class biecatmunActions extends autobiecatmunActions
{
  ...
  {
    //print $clasemodelo->getBnestadoCodest(); exit;
    $clasemodelo->setBnestadoCodest($clasemodelo->getBnestadoCodest());

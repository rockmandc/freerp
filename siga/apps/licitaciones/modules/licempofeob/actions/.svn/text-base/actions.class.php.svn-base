 ...
 *
 * @package    siga
 * @subpackage licempofeob
 * @author     $Auhor$ <desarrollo@cidesa.com.ve>
 * @version    SVN: $Id: actions.class.php 32371 2009-09-01 16:06:59Z lhernandez $
 * @copyright  Copyright 2007, Cidesa C.A.
 */

class licempofeobActions extends autolicempofeobActions
{
  public function listing()
  {
      $this->c = new Criteria();
      $sql = "(Liempofe.tipconpub='O')";
  ...
  public function configGrid($reg = array(),$regelim = array())
  {
    ...
    $this->obj = Herramientas::getConfigGrid(sfConfig::get('sf_app_module_dir').'/licempofeob/'.sfConfig::get('sf_app_module_config_dir_name').'/grid');
  ...
  {    
    ...
    return $this->redirect('licempofeob/list');
  }

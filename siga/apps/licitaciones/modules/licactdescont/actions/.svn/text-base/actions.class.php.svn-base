...
/**
 * licactdescont actions.
 *
 * @package    siga
 * @subpackage licactdescont
 * @author     $Auhor$ <desarrollo@cidesa.com.ve>
 * @version    SVN: $Id: actions.class.php 32371 2009-09-01 16:06:59Z lhernandez $
 * @copyright  Copyright 2007, Cidesa C.A.
 */

class licactdescontActions extends autolicactdescontActions
{
  ...
  public function editing()
  {
   ...
   public function configGridActas($reg = array(),$regelim = array())
   {
    ...
    if(!(count($reg)>0))
    {
      ...
      if($this->liactdescont->getNumactdes()){
        $c = new Criteria();
        $c->add(LidetactactdescontPeer::NUMACTDES,$this->liactdescont->getNumactdes());
        $reg = LidetactactdescontPeer::doSelectJoinLiactas($c);
      }else{
        $reg = array();
      }
    ...
    switch ($ajax){
      case '1':
           ...
           if($licontrat)
           {
             ...
             $js="";
             $output = '[["liactdescont_tipcom","'.$compra.'",""],["liactdescont_destiplic","'.$modcon.'",""],
                         ["liactdescont_desclacomp","'.$desclacomp.'",""],["liactdescont_numrecofe","'.$numrecofe.'",""],["liactdescont_numexp","'.$numexp.'",""],
                         ["liactdescont_codpro","'.$codpro.'",""],["liactdescont_nompro","'.$nompro.'",""],["liactdescont_rifpro","'.$rifpro.'",""],["liactdescont_nomrepleg","'.$nomrepleg.'",""],
                         ["liactdescont_dirpro","'.$direccion.'",""],["liactdescont_numofe","'.$numofe.'",""],["liactdescont_fecofe","'.$fecofe.'",""],
                         ["liactdescont_monofe","'.H::FormatoMonto($monofe).'",""],["liactdescont_monofelet","'.H::obtenermontoescrito($monofe).'",""],
                         ["liactdescont_monart","'.H::FormatoMonto($monsubofe).'",""],["liactdescont_monrec","'.H::FormatoMonto($monrecofe).'",""],
                         ["liactdescont_objcontcat","'.$licontrat->getObjcont().'",""],
                         ["liactdescont_objcont","'.$licontrat->getObjcont().'",""],
                         ["liactdescont_resolu","'.$licontrat->getResolu().'",""],
                         ["liactdescont_fecrel","'.$licontrat->getFecrel('d/m/Y').'",""],
                         ["liactdescont_numptocuecon","'.$licontrat->getNumptocuecon().'",""],
                         ["","",""]]';
           }else{
      ...
      case '2':
            ...
            $output = '[["liactdescont_nomempadm","'.$nomemp.'",""],["liactdescont_nomcaradm","'.$nomcar.'",""],["liactdescont_coduniadm","'.$coduniadm.'",""],["liactdescont_desuniadm","'.$desuniadm.'",""]]';
        break;
      case '3':
            $coduniadm = '';
            $desuniadm = '';
            ...
            $output = '[["liactdescont_coduniadm","'.$coduniadm.'",""],["liactdescont_desuniadm","'.$desuniadm.'",""],["","",""]]';
        break;
      case '4':
            $nomemp = '';
            $nomcar = '';
            ...
            $output = '[["liactdescont_nomempeje","'.$nomemp.'",""],["liactdescont_nomcareje","'.$nomcar.'",""],["liactdescont_coduniste","'.$coduniste.'",""],["liactdescont_desuniste","'.$desuniste.'",""]]';
        break;
      case '5':
            $coduniste = '';
            $desuniste = '';
            ...
            $output = '[["liactdescont_coduniste","'.$coduniste.'",""],["liactdescont_desuniste","'.$desuniste.'",""],["","",""]]';
        break;
      case '6':
          ...
          if($fecha && $dias)
          {
             ...
             $fecven=null;
          $output = '[["liactdescont_fecven","'.$fecven.'",""],["","",""],["","",""]]';
        break;
      case '7':
           $sw=false;
           $this->ajax='7';
           $numofe= $this->getRequestParameter('numofe','');
           $this->licontrat = $this->getliactdescontOrCreate();
  ...
  public function saving($clasemodelo)
  {
    if(!$clasemodelo->getId()){
      ...
      Licitacion::SalvarGeneral($clasemodelo,'Liactdescont','Numactdes','Obactdescont','O');
      $ret= parent::saving($clasemodelo);
      if($ret!=-1) return $ret;
      return Licitacion::SalvarGridRegActas($clasemodelo, $gridactas, 'Numactdes');
    }else return -1;
  }
  ...
  {
    $c = new Criteria();
    $c->add(LidetactactdescontPeer::NUMACTDES, $clasemodelo->getNumactdes());

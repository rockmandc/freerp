...
class licprebasActions extends autolicprebasActions {
    ...
    public function configGrid($codigo = '', $valmon = '', $reg = array(), $regelim = array()) {
        ...
        if ($this->liprebas->getNumpre())
            $this->obj[1][8]->setHtml(' readonly=false ');
        else
            $this->obj[1][8]->setHtml(' readonly=true ');
    ...
    public function configGridRgo($reg = array(), $regelim = array()) {
        ...
        $this->obj3 = Herramientas::getConfigGrid(sfConfig::get('sf_app_module_dir') . '/licprebas/' . sfConfig::get('sf_app_module_config_dir_name') . '/gridrgo');
    ...
    public function validateEdit() {
        ...
        if ($this->getRequest()->getMethod() == sfRequest::POST) {
            ...
            $this->coderr = Licitacion::ValidarPrebas($this->liprebas, $grid, $gridrgo);
    ...
    public function saving($clasemodelo) {
        $grid = Herramientas::CargarDatosGridv2($this, $this->obj);
        $gridrgo = Herramientas::CargarDatosGridv2($this, $this->obj3);
        Licitacion::SalvarPrebas($clasemodelo, $grid, $gridrgo);

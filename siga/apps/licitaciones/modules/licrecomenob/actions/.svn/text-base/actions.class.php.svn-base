...
/**
 * licrecomenob actions.
 *
 * @package    siga
 * @subpackage licrecomenob
 * @author     $Auhor$ <desarrollo@cidesa.com.ve>
 * @version    SVN: $Id: actions.class.php 32371 2009-09-01 16:06:59Z lhernandez $
 * @copyright  Copyright 2007, Cidesa C.A.
 */

class licrecomenobActions extends autolicrecomenobActions
{
  
  public function listing()
  {
      $this->c = new Criteria();
      $sql = "(Lirecomen.tipconpub='O')";
      $this->c->add(LirecomenPeer::TIPCONPUB,$sql,Criteria::CUSTOM);      
  }  
  ...
  public function configGrid($reg = array(),$regelim = array())
   {
    ...
    $this->obj = Herramientas::getConfigGrid(sfConfig::get('sf_app_module_dir').'/licrecomenob/'.sfConfig::get('sf_app_module_config_dir_name').'/grid');
      ...
      case '1':
        ...
        // http://201.210.211.26:8080/www/wiki/index.php/Agregar_Ajax_para_buscar_una_descripcion
           ...
           $sql="select b.codpro, c.nompro, c.rifpro, d.desemp as destipemp,
                    FormatoNum((a.porleg)) as punleg,
                    FormatoNum(a.portec) as puntec,
                    FormatoNum(a.porfin) as punfin,
                    FormatoNum(a.porfia) as punfia,
                    FormatoNum(b.porvan) as punvan,
                    FormatoNum(a.portipemp) as puntipemp,
                    FormatoNum(0) as punmin,
                    FormatoNum(a.portot) as puntot,
                    '9' as id
                    ...
                    b.codtipemp=d.codemp                    
                    order by puntot desc";
           H::BuscarDatos($sql, $reg);
           $this->configGrid($reg);
           $js='';
           $output = '[["lirecomen_tipcom","'.$compra.'",""],["lirecomen_destiplic","'.$modcon.'",""],
  ...
  public function validateEdit()
  {
    ...
    if($this->getRequest()->getMethod() == sfRequest::POST){
      ...
      $this->coderr = Licitacion::ValidarGridRecOfe($this->lirecomen,$grid);
  ...
  {
    Licitacion::SalvarGeneral($clasemodelo,'Lirecomen','Numrecofe','Obrecome','O');
    $grid = Herramientas::CargarDatosGridv2($this,$this->obj,true);
  ...
  {
    Licitacion::EliminarGridRecomen($clasemodelo);

 ...
 * @version SVN: $Id: actions.class.php 43279 2011-03-30 13:04:05Z cramirez $
 * 
...
class licunisteActions extends autolicunisteActions {
    ...
    public function configGrid($reg = array(), $regelim = array()) {
        ...
        $c = new Criteria();
        $c->add(LidatstedetPeer::CODUNISTE, $this->lidatste->getCoduniste());
        $reg = LidatstedetPeer::doSelect($c);
    ...
    public function saving($clasemodelo) {
        $grid = Herramientas::CargarDatosGridv2($this, $this->obj);
        Licitacion::grabarResponsablesUnidad($clasemodelo, $grid);
    ...
    public function deleting($clasemodelo) {
        $d = new Criteria();
        $d->add(LidatstedetPeer::CODUNISTE, $clasemodelo->getCoduniste());
        $det = LidatstedetPeer::doSelect($d);
        foreach ($det as $r) {
            $r->delete();
        }

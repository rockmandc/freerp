 ...
 *
 * @package    siga
 * @subpackage licanaempob
 * @author     $Auhor$ <desarrollo@cidesa.com.ve>
 * @version    SVN: $Id: actions.class.php 32371 2009-09-01 16:06:59Z lhernandez $
 * @copyright  Copyright 2007, Cidesa C.A.
 */

class licanaempobActions extends autolicanaempobActions
{
  ...
  {
      $this->c = new Criteria();      
      $this->c->add(LianaempPeer::TIPCONPUB,'O');      
  }  
  ...
  public function configGridLeg($reg = array(),$regelim = array())
   {
    ...
    $this->obj = Herramientas::getConfigGrid(sfConfig::get('sf_app_module_dir').'/licanaempob/'.sfConfig::get('sf_app_module_config_dir_name').'/gridleg');
   ...
   public function configGridTec($reg = array(),$regelim = array())
   {
    ...
    $this->obj2 = Herramientas::getConfigGrid(sfConfig::get('sf_app_module_dir').'/licanaempob/'.sfConfig::get('sf_app_module_config_dir_name').'/gridtec');
   ...
   public function configGridFin($reg = array(),$regelim = array())
   {
    ...
    $this->obj3 = Herramientas::getConfigGrid(sfConfig::get('sf_app_module_dir').'/licanaempob/'.sfConfig::get('sf_app_module_config_dir_name').'/gridfin');
    ...
    switch ($ajax){
      case '1':
        ...
        // http://201.210.211.26:8080/www/wiki/index.php/Agregar_Ajax_para_buscar_una_descripcion
           ...
           $c->add(LiplieespPeer::TIPCONPUB,'O');      
           ...
           $output = '[["lianaemp_tipcom","'.$compra.'",""],["lianaemp_destiplic","'.$modcon.'",""],
  ...
  {
    Licitacion::SalvarGeneral($clasemodelo,'Lianaemp','Numanaemp','Obanaemp','O');
    $gridleg = Herramientas::CargarDatosGridv2($this,$this->obj,true);
    $gridtec = Herramientas::CargarDatosGridv2($this,$this->obj2,true);
    $gridfin = Herramientas::CargarDatosGridv2($this,$this->obj3,true);

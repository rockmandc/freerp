 ...
 *
 * @package    siga
 * @subpackage licaclara
 * @author     $Auhor$ <desarrollo@cidesa.com.ve>
 * @version    SVN: $Id: actions.class.php 32371 2009-09-01 16:06:59Z lhernandez $
 * @copyright  Copyright 2007, Cidesa C.A.
 */
class licaclaraActions extends autolicaclaraActions {

    public function listing() {
        $this->c = new Criteria();
        $sql = "(Liaclara.tipconpub is null or Liaclara.tipconpub='B')";
        $this->c->add(LiaclaraPeer::TIPCONPUB, $sql, Criteria::CUSTOM);
    }
    ...
    public function executeAjax() {
        ...
        switch ($ajax) {
            case '1':
                ...
                $output = '[["liaclara_tipcom","' . $compra . '",""],["liaclara_destiplic","' . $modcon . '",""],
                       ["liaclara_desclacomp","' . $desclacomp . '",""],["liaclara_numplie","' . $numplie . '",""]]';
                break;
            case '2':
                $nomemp = '';
                $nomcar = '';
                ...
                $output = '[["liaclara_nomempadm","' . $nomemp . '",""],["liaclara_nomcaradm","' . $nomcar . '",""],["liaclara_coduniadm","' . $coduniadm . '",""],["liaclara_desuniadm","' . $desuniadm . '",""]]';
                break;
            case '3':
                $coduniadm = '';
                $desuniadm = '';
                ...
                $output = '[["liaclara_coduniadm","' . $coduniadm . '",""],["liaclara_desuniadm","' . $desuniadm . '",""],["","",""]]';
                break;
            case '4':
                $nomemp = '';
                $nomcar = '';
                ...
                $output = '[["liaclara_nomempeje","' . $nomemp . '",""],["liaclara_nomcareje","' . $nomcar . '",""],["liaclara_coduniste","' . $coduniste . '",""],["liaclara_desuniste","' . $desuniste . '",""]]';
                break;
            case '5':
                $coduniste = '';
                $desuniste = '';
                ...
                $output = '[["liaclara_coduniste","' . $coduniste . '",""],["liaclara_desuniste","' . $desuniste . '",""],["","",""]]';
                break;
            case '6':
            ...
            case '7':
                ...
                $output = '[["liaclara_nompro","' . $nompro . '",""],["liaclara_nomrepleg","' . $nomrepleg . '",""],["liaclara_rif","' . $rif . '",""]]';
                break;
            default:
                $output = '[["","",""],["","",""],["","",""]]';
        }
    ...
    public function saving($clasemodelo) {
        Licitacion::SalvarGeneral($clasemodelo, 'Liaclara', 'Numacla', 'Aclara');

 ...
 *
 * @package    siga
 * @subpackage licptocue
 * @author     $Auhor$ <desarrollo@cidesa.com.ve>
 * @version    SVN: $Id: actions.class.php 32371 2009-09-01 16:06:59Z lhernandez $
 * @copyright  Copyright 2007, Cidesa C.A.
 */
class licptocueActions extends autolicptocueActions {

    public function listing() {
        $this->c = new Criteria();
        $sql = "(Liptocue.tipconpub is null or Liptocue.tipconpub='B')";
    ...
    public function saving($clasemodelo) {
        Licitacion::SalvarGeneral($clasemodelo, 'Liptocue', 'Numptocue', 'Ptocta');

...
/**
 * liccontratob actions.
 *
 * @package    siga
 * @subpackage liccontratob
 * @author     $Auhor$ <desarrollo@cidesa.com.ve>
 * @version    SVN: $Id: actions.class.php 32371 2009-09-01 16:06:59Z lhernandez $
 * @copyright  Copyright 2007, Cidesa C.A.
 */

class liccontratobActions extends autoliccontratobActions
{
  ...
  public function configGridArt($reg = array(),$regelim = array())
   {
    ...
    $this->obj = Herramientas::getConfigGrid(sfConfig::get('sf_app_module_dir').'/liccontratob/'.sfConfig::get('sf_app_module_config_dir_name').'/gridart');
   ...
   public function configGridRgo($reg = array(),$regelim = array())
   {
    ...
    $this->obj2 = Herramientas::getConfigGrid(sfConfig::get('sf_app_module_dir').'/liccontratob/'.sfConfig::get('sf_app_module_config_dir_name').'/gridrgo');
   ...
   public function configGridForPag($reg = array(),$regelim = array())
   {
    ...
    $this->obj3 = Herramientas::getConfigGrid(sfConfig::get('sf_app_module_dir').'/liccontratob/'.sfConfig::get('sf_app_module_config_dir_name').'/gridforpag');
   ...
   public function configGridCroEnt($reg = array(),$regelim = array())
   {
    ...
    $this->obj4 = Herramientas::getConfigGrid(sfConfig::get('sf_app_module_dir').'/liccontratob/'.sfConfig::get('sf_app_module_config_dir_name').'/gridcroent');
   ...
   public function configGridFia($reg = array(),$regelim = array())
   {
    ...
    $this->obj8 = Herramientas::getConfigGrid(sfConfig::get('sf_app_module_dir').'/liccontratob/'.sfConfig::get('sf_app_module_config_dir_name').'/gridfia');
    ...
    switch ($ajax){
      case '1':
        ...
        // http://201.210.211.26:8080/www/wiki/index.php/Agregar_Ajax_para_buscar_una_descripcion
           ...
           $output = '[["licontrat_tipcom","'.$compra.'",""],["licontrat_destiplic","'.$modcon.'",""],
  ...
  public function saving($clasemodelo)
  {
    ...
    Licitacion::SalvarGeneral($clasemodelo,'Licontrat','Numcont','Obcontrat','O');
    Licitacion::SalvarContrato($clasemodelo, $gridart, $gridrgo, $gridforpag, $gridcroent, $gridfia);

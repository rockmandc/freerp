...
/**
 * licptocueconob actions.
 *
 * @package    siga
 * @subpackage licptocueconob
 * @author     $Auhor$ <desarrollo@cidesa.com.ve>
 * @version    SVN: $Id: actions.class.php 32371 2009-09-01 16:06:59Z lhernandez $
 * @copyright  Copyright 2007, Cidesa C.A.
 */

class licptocueconobActions extends autolicptocueconobActions
{
  ...
  public function listing()
  {
      ...
      $this->c->add(LiptocueconPeer::TIPCONPUB,$sql,Criteria::CUSTOM);      
  }  
    ...
    switch ($ajax){
      case '1':
        ...
        // http://201.210.211.26:8080/www/wiki/index.php/Agregar_Ajax_para_buscar_una_descripcion
           ...
           $c->add(LirecomenPeer::TIPCONPUB,$sql,Criteria::CUSTOM);
           ...
           $js='';
           $output = '[["liptocuecon_tipcom","'.$compra.'",""],["liptocuecon_destiplic","'.$modcon.'",""],
  ...
  {
    Licitacion::SalvarGeneral($clasemodelo,'Liptocuecon','Numptocuecon','Obptocuecon','O');

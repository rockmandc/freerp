 ...
 *
 * @package    Roraima
 * @subpackage licdefemp
 * @author     $Author: cramirez $ <desarrollo@cidesa.com.ve>
 * @version SVN: $Id: actions.class.php 43828 2011-04-23 01:42:18Z cramirez $
 * 
 * @copyright  Copyright 2007, Cide S.A.
 * @license    http://opensource.org/licenses/gpl-2.0.php GPLv2
 */
class licdefempActions extends autolicdefempActions
{

  public function executeIndex()
  {
    $c= new Criteria();
  	$c->add(LidefempPeer::CODEMP,'001');
  	$resul= LidefempPeer::doSelectOne($c);
  	if ($resul)
  	{
  	 $id=$resul->getId();
  	 return $this->redirect('licdefemp/edit?id='.$id);
  	}
  	else
  	{
  	  return $this->redirect('licdefemp/edit');
  	}
  }
  ...
  public function saving($clasemodelo)
  {
    ...
    $clasemodelo->getCodifili()=='' ? $clasemodelo->setCodifili('B') : '';
    $clasemodelo->getCodifiob()=='' ? $clasemodelo->setCodifiob('O') : '';

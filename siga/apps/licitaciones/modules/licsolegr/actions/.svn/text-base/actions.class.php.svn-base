...
class licsolegrActions extends autolicsolegrActions {
    ...
    public function listing() {
        $this->c = new Criteria();
        $sql = "(Lisolegr.tipconpub is null or Lisolegr.tipconpub='B')";
    ...
    public function configGridRgo($reg = array(), $regelim = array()) {
        ...
        $this->obj4 = Herramientas::getConfigGrid(sfConfig::get('sf_app_module_dir') . '/licsolegr/' . sfConfig::get('sf_app_module_config_dir_name') . '/grid_rgo');
    ...
    public function validateEdit() {
        ...
        if ($this->getRequest()->getMethod() == sfRequest::POST) {
            ...
            $this->coderr = Licitacion::ValidarSolEgr($this->lisolegr, $grid, $griduni);
    ...
    public function saving($clasemodelo) {
        ...
        $griduni = Herramientas::CargarDatosGridv2($this, $this->obj3, true);
        $gridrgo = Herramientas::CargarDatosGridv2($this, $this->obj4, true);
        Licitacion::SalvarSolEgr($clasemodelo, $grid, $gridrec, $griduni, $gridrgo);

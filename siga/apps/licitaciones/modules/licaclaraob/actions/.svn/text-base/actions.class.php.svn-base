 ...
 *
 * @package    siga
 * @subpackage licaclaraob
 * @author     $Auhor$ <desarrollo@cidesa.com.ve>
 * @version    SVN: $Id: actions.class.php 32371 2009-09-01 16:06:59Z lhernandez $
 * @copyright  Copyright 2007, Cidesa C.A.
 */

class licaclaraobActions extends autolicaclaraobActions
{
    
  public function listing()
  {
      $this->c = new Criteria();
      $sql = "(Liaclara.tipconpub='O')";
  ...
  {
    Licitacion::SalvarGeneral($clasemodelo,'Liaclara','Numacla','Obaclara','O');

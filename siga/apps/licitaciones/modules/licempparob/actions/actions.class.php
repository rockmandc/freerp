 ...
 *
 * @package    siga
 * @subpackage licempparob
 * @author     $Auhor$ <desarrollo@cidesa.com.ve>
 * @version    SVN: $Id: actions.class.php 32371 2009-09-01 16:06:59Z lhernandez $
 * @copyright  Copyright 2007, Cidesa C.A.
 */

class licempparobActions extends autolicempparobActions
{
    
  public function listing()
  {
      $this->c = new Criteria();
      $sql = "(Liemppar.tipconpub='O')";
  ...
  public function configGrid($reg = array(),$regelim = array())
  {
    ...
    $this->obj = Herramientas::getConfigGrid(sfConfig::get('sf_app_module_dir').'/licempparob/'.sfConfig::get('sf_app_module_config_dir_name').'/grid');

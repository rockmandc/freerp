 ...
 *
 * @package    siga
 * @subpackage licpliemod
 * @author     $Auhor$ <desarrollo@cidesa.com.ve>
 * @version    SVN: $Id: actions.class.php 32371 2009-09-01 16:06:59Z lhernandez $
 * @copyright  Copyright 2007, Cidesa C.A.
 */
class licpliemodActions extends autolicpliemodActions {
    ...
    public function configGridArt($reg = array(), $regelim = array()) {
        ...
        $this->obj = Herramientas::getConfigGrid(sfConfig::get('sf_app_module_dir') . '/licpliemod/' . sfConfig::get('sf_app_module_config_dir_name') . '/gridart');
    ...
    public function configGridUniArt($codigo = '', $reg = array(), $regelim = array()) {
        ...
        $this->obj2 = Herramientas::getConfigGrid(sfConfig::get('sf_app_module_dir') . '/licpliemod/' . sfConfig::get('sf_app_module_config_dir_name') . '/griduniart');
    ...
    public function configGridDep($reg = array(), $regelim = array()) {
        ...
        $this->obj3 = Herramientas::getConfigGrid(sfConfig::get('sf_app_module_dir') . '/licpliemod/' . sfConfig::get('sf_app_module_config_dir_name') . '/griddep');
    ...
    public function configGridMec($reg = array(), $regelim = array()) {
        ...
        $this->obj4 = Herramientas::getConfigGrid(sfConfig::get('sf_app_module_dir') . '/licpliemod/' . sfConfig::get('sf_app_module_config_dir_name') . '/gridmec');
    ...
    public function configGridAct($reg = array(), $regelim = array()) {
        ...
        $this->obj5 = Herramientas::getConfigGrid(sfConfig::get('sf_app_module_dir') . '/licpliemod/' . sfConfig::get('sf_app_module_config_dir_name') . '/gridact');
    ...
    public function configGridPub($reg = array(), $regelim = array()) {
        ...
        $this->obj6 = Herramientas::getConfigGrid(sfConfig::get('sf_app_module_dir') . '/licpliemod/' . sfConfig::get('sf_app_module_config_dir_name') . '/gridpub');
    ...
    public function configGridLeg($reg = array(), $regelim = array()) {
        ...
        $this->obj7 = Herramientas::getConfigGrid(sfConfig::get('sf_app_module_dir') . '/licpliemod/' . sfConfig::get('sf_app_module_config_dir_name') . '/gridleg');
    ...
    public function configGridTec($reg = array(), $regelim = array()) {
        ...
        $this->obj8 = Herramientas::getConfigGrid(sfConfig::get('sf_app_module_dir') . '/licpliemod/' . sfConfig::get('sf_app_module_config_dir_name') . '/gridtec');
    ...
    public function configGridFin($reg = array(), $regelim = array()) {
        ...
        $this->obj9 = Herramientas::getConfigGrid(sfConfig::get('sf_app_module_dir') . '/licpliemod/' . sfConfig::get('sf_app_module_config_dir_name') . '/gridfin');
    ...
    public function configGridFia($reg = array(), $regelim = array()) {
        ...
        $this->obj10 = Herramientas::getConfigGrid(sfConfig::get('sf_app_module_dir') . '/licpliemod/' . sfConfig::get('sf_app_module_config_dir_name') . '/gridfia');
    ...
    public function configGridTipEmp($reg = array(), $regelim = array()) {
        ...
        $this->obj11 = Herramientas::getConfigGrid(sfConfig::get('sf_app_module_dir') . '/licpliemod/' . sfConfig::get('sf_app_module_config_dir_name') . '/gridtipemp');
        ...
        switch ($ajax) {
            case '1':
                ...
                if ($per) {
                    ...
                    $sql = "select b.codart,c.desart,FormatoNum(sum(b.cansol)) as cantid,max(a.id) as id,b.tipconpub from lidetcomint a, lisolegrdet b, caregart c
                    where a.numcomint='$codigo' and
                    a.numsol=b.numsol and
                    b.codart=c.codart
    ...
    public function saving($clasemodelo) {
        ...
        $gridfia = Herramientas::CargarDatosGridv2($this, $this->obj10, true);
        $gridtipemp = Herramientas::CargarDatosGridv2($this, $this->obj11, true);
        Licitacion::SalvarPliegoMod($clasemodelo, $gridart, $griddep, $gridmec, $gridact, $gridpub, $gridleg, $gridtec, $gridfin, $gridfia, $gridtipemp);

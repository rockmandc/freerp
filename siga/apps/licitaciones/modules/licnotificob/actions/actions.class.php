...
/**
 * licnotificob actions.
 *
 * @package    siga
 * @subpackage licnotificob
 * @author     $Auhor$ <desarrollo@cidesa.com.ve>
 * @version    SVN: $Id: actions.class.php 32371 2009-09-01 16:06:59Z lhernandez $
 * @copyright  Copyright 2007, Cidesa C.A.
 */

class licnotificobActions extends autolicnotificobActions
{
    
  public function listing()
  {
      $this->c = new Criteria();
      $sql = "(Linotific.tipconpub='O')";
    ...
    switch ($ajax){
      case '1':
        ...
        // http://201.210.211.26:8080/www/wiki/index.php/Agregar_Ajax_para_buscar_una_descripcion
           ...
           $js='';
           $output = '[["linotific_tipcom","'.$compra.'",""],["linotific_destiplic","'.$modcon.'",""],
  ...
  {
    Licitacion::SalvarGeneral($clasemodelo,'Linotific','Numnotif','Obnotifi','O');

 ...
 *
 * @package    siga
 * @subpackage licanaofeob
 * @author     $Auhor$ <desarrollo@cidesa.com.ve>
 * @version    SVN: $Id: actions.class.php 32371 2009-09-01 16:06:59Z lhernandez $
 * @copyright  Copyright 2007, Cidesa C.A.
 */

class licanaofeobActions extends autolicanaofeobActions
{
    
  public function listing()
  {
      $this->c = new Criteria();
      $sql = "(Lianaofe.tipconpub='O')";
  ...
  public function configGridLeg($reg = array(),$regelim = array())
   {
    ...
    $this->obj = Herramientas::getConfigGrid(sfConfig::get('sf_app_module_dir').'/licanaofeob/'.sfConfig::get('sf_app_module_config_dir_name').'/gridleg');
   ...
   public function configGridTec($reg = array(),$regelim = array())
   {
    ...
    $this->obj2 = Herramientas::getConfigGrid(sfConfig::get('sf_app_module_dir').'/licanaofeob/'.sfConfig::get('sf_app_module_config_dir_name').'/gridtec');
   ...
   public function configGridFin($reg = array(),$regelim = array())
   {
    ...
    $this->obj3 = Herramientas::getConfigGrid(sfConfig::get('sf_app_module_dir').'/licanaofeob/'.sfConfig::get('sf_app_module_config_dir_name').'/gridfin');
   ...
   public function configGridFia($reg = array(),$regelim = array())
   {
    ...
    $this->obj4 = Herramientas::getConfigGrid(sfConfig::get('sf_app_module_dir').'/licanaofeob/'.sfConfig::get('sf_app_module_config_dir_name').'/gridfia');
   ...
   public function configGridTipEmp($reg = array(),$regelim = array())
   {
    ...
    $this->obj5 = Herramientas::getConfigGrid(sfConfig::get('sf_app_module_dir').'/licanaofeob/'.sfConfig::get('sf_app_module_config_dir_name').'/gridtipemp');
    ...
    switch ($ajax){
      case '1':
        ...
        // http://201.210.211.26:8080/www/wiki/index.php/Agregar_Ajax_para_buscar_una_descripcion
           ...
           $output = '[["lianaofe_tipcom","'.$compra.'",""],["lianaofe_destiplic","'.$modcon.'",""],
  ...
  {
    Licitacion::SalvarGeneral($clasemodelo,'Lianaofe','Numanaofe','Obanaofe','O');
    $gridleg = Herramientas::CargarDatosGridv2($this,$this->obj,true);
    $gridtec = Herramientas::CargarDatosGridv2($this,$this->obj2,true);
    $gridfin = Herramientas::CargarDatosGridv2($this,$this->obj3,true);
    $gridfia = Herramientas::CargarDatosGridv2($this,$this->obj4,true);

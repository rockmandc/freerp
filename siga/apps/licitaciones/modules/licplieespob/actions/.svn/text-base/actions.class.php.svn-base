...
/**
 * licplieespob actions.
 *
 * @package    siga
 * @subpackage licplieespob
 * @author     $Auhor$ <desarrollo@cidesa.com.ve>
 * @version    SVN: $Id: actions.class.php 32371 2009-09-01 16:06:59Z lhernandez $
 * @copyright  Copyright 2007, Cidesa C.A.
 */

class licplieespobActions extends autolicplieespobActions
{
 ...
 public function configGridArt($reg = array(),$regelim = array())
  {
    ...
    $this->obj = Herramientas::getConfigGrid(sfConfig::get('sf_app_module_dir').'/licplieespob/'.sfConfig::get('sf_app_module_config_dir_name').'/gridart');
  ...
  public function configGridUniArt($codigo='',$reg = array(),$regelim = array())
  {
    ...
    {
      // Aquí va el código para traernos los registros que contendrá el grid
      $sql="select b.codart,c.despar as desart,FormatoNum(sum(b.cansol)) as cantid, d.coduniste,e.desuniste,e.dirste,
            f.nompai,g.nomedo,h.nommun,i.nompar,j.nomsec,max(b.id) as id
            from lisolegrdet b, ocdefpar c, lisolegrdir d, lidatste e,
            ...
            e.codsec=j.codsec
            group by b.codart,c.despar, d.coduniste,e.desuniste,f.nompai,g.nomedo,h.nommun,i.nompar,j.nomsec,e.dirste";
    ...
    $this->obj2 = Herramientas::getConfigGrid(sfConfig::get('sf_app_module_dir').'/licplieespob/'.sfConfig::get('sf_app_module_config_dir_name').'/griduniart');
  ...
  public function configGridDep($reg = array(),$regelim = array())
  {
    ...
    $this->obj3 = Herramientas::getConfigGrid(sfConfig::get('sf_app_module_dir').'/licplieespob/'.sfConfig::get('sf_app_module_config_dir_name').'/griddep');
  ...
  public function configGridMec($reg = array(),$regelim = array())
  {
    ...
    $this->obj4 = Herramientas::getConfigGrid(sfConfig::get('sf_app_module_dir').'/licplieespob/'.sfConfig::get('sf_app_module_config_dir_name').'/gridmec');
  ...
  public function configGridAct($reg = array(),$regelim = array())
  {
    ...
    $this->obj5 = Herramientas::getConfigGrid(sfConfig::get('sf_app_module_dir').'/licplieespob/'.sfConfig::get('sf_app_module_config_dir_name').'/gridact');
  ...
  public function configGridPub($reg = array(),$regelim = array())
  {
    ...
    $this->obj6 = Herramientas::getConfigGrid(sfConfig::get('sf_app_module_dir').'/licplieespob/'.sfConfig::get('sf_app_module_config_dir_name').'/gridpub');
  ...
  public function configGridLeg($reg = array(),$regelim = array())
  {
    ...
    $this->obj7 = Herramientas::getConfigGrid(sfConfig::get('sf_app_module_dir').'/licplieespob/'.sfConfig::get('sf_app_module_config_dir_name').'/gridleg');
  ...
  public function configGridTec($reg = array(),$regelim = array())
  {
    ...
    $this->obj8 = Herramientas::getConfigGrid(sfConfig::get('sf_app_module_dir').'/licplieespob/'.sfConfig::get('sf_app_module_config_dir_name').'/gridtec');
  ...
  public function configGridFin($reg = array(),$regelim = array())
  {
    ...
    $this->obj9 = Herramientas::getConfigGrid(sfConfig::get('sf_app_module_dir').'/licplieespob/'.sfConfig::get('sf_app_module_config_dir_name').'/gridfin');
  ...
  public function configGridFia($reg = array(),$regelim = array())
  {
    ...
    $this->obj10 = Herramientas::getConfigGrid(sfConfig::get('sf_app_module_dir').'/licplieespob/'.sfConfig::get('sf_app_module_config_dir_name').'/gridfia');
  ...
  public function configGridTipEmp($reg = array(),$regelim = array())
  {
    ...
    $this->obj11 = Herramientas::getConfigGrid(sfConfig::get('sf_app_module_dir').'/licplieespob/'.sfConfig::get('sf_app_module_config_dir_name').'/gridtipemp');
    ...
    switch ($ajax){
      case '1':
        ...
        // http://201.210.211.26:8080/www/wiki/index.php/Agregar_Ajax_para_buscar_una_descripcion
           $this->ajax='1';
           $c = new Criteria();
           $c->add(LisolegrPeer::NUMSOL,$codigo);
           ...
           if($per)
           {
                ...
                $sql="select b.codart,c.despar as desart,FormatoNum(sum(b.cansol)) as cantid,'O' as tipconpub,max(b.id) as id 
                        from lisolegrdet b, ocdefpar c
                        where 
                        b.numsol='$codigo' and
                        b.codart=c.codpar
                        group by b.codart,c.despar";
                H::BuscarDatos($sql, $reg);
                $this->configGridArt($reg);
                
                $compra = $per->getTipcom()=='N' ? 'NACIONAL' : ($per->getTipcom()=='I' ? 'INTERNACIONAL' : '');
                $modcon = H::GetX('Codtiplic','Litiplic','Destiplic',H::GetX('Numsol','Lisolegr','Codtiplic',$codigo));
  ...
  public function validateEdit()
  {
    ...
    if($this->getRequest()->getMethod() == sfRequest::POST){
      ...
      $gridleg = Herramientas::CargarDatosGridv2($this,$this->obj7,true);
      $gridtec = Herramientas::CargarDatosGridv2($this,$this->obj8,true);
      $gridfin = Herramientas::CargarDatosGridv2($this,$this->obj9,true);
      $gridfia = Herramientas::CargarDatosGridv2($this,$this->obj10,true);
      $gridtipemp = Herramientas::CargarDatosGridv2($this,$this->obj11,true);

      $this->coderr = Licitacion::ValidarPliego($this->liplieesp,$gridart,$griddep,$gridmec,$gridact,$gridpub,$gridleg,$gridtec,$gridfin,$gridfia,$gridtipemp);
  ...
  {    
    ...
    $gridfia = Herramientas::CargarDatosGridv2($this,$this->obj10,true);
    $gridtipemp = Herramientas::CargarDatosGridv2($this,$this->obj11,true);
    Licitacion::SalvarGridPliego($clasemodelo, $gridart, $griddep, $gridmec, $gridact, $gridpub, $gridleg, $gridtec, $gridfin, $gridfia, $gridtipemp,'O');

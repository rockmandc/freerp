 ...
 *
 * @package    siga
 * @subpackage licptocueob
 * @author     $Auhor$ <desarrollo@cidesa.com.ve>
 * @version    SVN: $Id: actions.class.php 32371 2009-09-01 16:06:59Z lhernandez $
 * @copyright  Copyright 2007, Cidesa C.A.
 */

class licptocueobActions extends autolicptocueobActions
{
  ...
  public function listing()
  {
      ...
      $this->c->add(LiptocuePeer::TIPCONPUB,$sql,Criteria::CUSTOM);      
  }   
  ...
  public function executeAjax()
  {
    ...
    switch ($ajax){
      case '1':
        ...
        $c->add(LimemoranPeer::TIPCONPUB,$sql,Criteria::CUSTOM);      
        ...
        if($per)
        {
            ...
            $output = '[["liptocue_desclacomp","'.$desclacomp.'",""],["liptocue_nomext","'.$nomext.'",""],["liptocue_acto","'.$acto.'",""],
                        ["liptocue_tipcom","'.$tipcom.'",""],
                        ["liptocue_nompre","'.$nompre.'",""],["liptocue_desprio","'.$desprio.'",""],["liptocue_despro","'.$despro.'",""],
  ...
  {
    Licitacion::SalvarGeneral($clasemodelo,'Liptocue','Numptocue','Obptocta','O');

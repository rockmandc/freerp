...
/**
 * licmemoranob actions.
 *
 * @package    siga
 * @subpackage licmemoranob
 * @author     $Auhor$ <desarrollo@cidesa.com.ve>
 * @version    SVN: $Id: actions.class.php 32371 2009-09-01 16:06:59Z lhernandez $
 * @copyright  Copyright 2007, Cidesa C.A.
 */

class licmemoranobActions extends autolicmemoranobActions
{
  ...
  public function executeAjax()
  {
    ...
    switch ($ajax){
      case '1':
        ...
        $c->add(LiprebasPeer::TIPCONPUB,$sql,Criteria::CUSTOM);
        ...
        if($per)
        {
            ...
            $output = '[["limemoran_desclacomp","'.$desclacomp.'",""],["limemoran_nomext","'.$nomext.'",""],["limemoran_acto","'.$acto.'",""],
                        ["limemoran_tipcom","'.$tipcom.'",""],
                        ["limemoran_nompre","'.$nompre.'",""],["limemoran_desprio","'.$desprio.'",""],["limemoran_despro","'.$despro.'",""],
      ...
      case '6':
          ...
          if($fecha && $dias)
          {
             ...
             $fecven=null;
          $output = '[["limemoran_fecven","'.$fecven.'",""],["","",""],["","",""]]';
        break;
      default:
        $output = '[["","",""],["","",""],["","",""]]';
    }
  ...
  {    
    Licitacion::SalvarGeneral($clasemodelo,'Limemoran','Numemo','Obnumemo','O');

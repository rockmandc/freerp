 ...
 * @version SVN: $Id: actions.class.php 59035 2014-10-15 13:52:27Z dmartinez $
 *
...
class FacpiclicActions extends autoFacpiclicActions
{
  ...
  public function executeList()
  {
    ...
    $this->filters = $this->getUser()->getAttributeHolder()->getAll('sf_admin/fcsollic/filters');


     // 15    // pager
    $this->pager = new sfPropelPager('Fcsollic', 15);
    $c = new Criteria();
    $c->add(FcsollicPeer::STASOL,'N',Criteria::NOT_EQUAL);
  ...
  public function configGrid($reg = array(),$regelim = array())
  {
    ...
    $c->add(FcactpicPeer::NUMDOC,$sql1,Criteria::CUSTOM);
  ...
  public function saving($fcsollic)
  {
	...
	if ($fcsollic->getOperacion()!='')
	{
		...
		elseif ($fcsollic->getOperacion()=='S') {
                    if ($fcsollic->getFunsus()=="")
                      return 738;
                    else if ($fcsollic->getMotsus()=="")
                      return 739;
                    else if ($fcsollic->getFecsus()=="")
                      return 740;
                    else
                      $error = Hacienda::Grabar_Facpiclic_Suspencion_Cancelacion($fcsollic);
                    }

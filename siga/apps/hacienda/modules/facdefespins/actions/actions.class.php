...
class FacdefespinsActions extends autoFacdefespinsActions
{
  ...
  public function executeIndex()
  {
    ...
    $resul= FcdefinsPeer::doSelectOne($c);
    if ($resul)
    {
     $id=$resul->getId();
     return $this->redirect('facdefespins/edit?id='.$id);
    }
    else
    {
      return $this->redirect('facdefespins/edit');
    }
  }

  public function editing()
  {
    if (!$this->fcdefins->getId())
      $this->fcdefins->setCodemp('001');
    ...
    switch ($ajax){
      case '1':
          ...
          if ($reg)
          {
              ...
              $js="alert_('El C&oacute;digo no se encuentra registrado');";
          }

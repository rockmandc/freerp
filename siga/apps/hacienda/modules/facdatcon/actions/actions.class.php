 ...
 * @version SVN: $Id: actions.class.php 44651 2011-06-03 19:25:48Z amelendez $
 *
...
class FacdatconActions extends autoFacdatconActions
{
  ...
  {
    $grid = Herramientas::CargarDatosGridv2($this,$this->grid);
    if (Hacienda::salvar_grid_Facdatcon($fcconrep, $grid) == -1 ) {

           if($fcconrep->getFunrec()==''){
             $fcconrep->setFunrec($this->getUser()->getAttribute('loguse'));
              }

              $ref=split("-",$fcconrep->getCodpar1());
              if(count($ref) > 0){
 ...
 /**
  ...
  protected function updateFcconrepFromRequest()
  {
    ...
    if (isset($fcconrep['clacon']))
    {
     ...
     if (isset($fcconrep['funrec']))
    {
      $this->fcconrep->setFunrec($fcconrep['funrec']);
    }

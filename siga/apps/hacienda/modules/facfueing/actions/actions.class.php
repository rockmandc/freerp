 ...
 * @version SVN: $Id: actions.class.php 45027 2011-06-30 16:09:28Z amelendez $
 * 
...
class FacfueingActions extends autoFacfueingActions
{
  ...
  {
     if (!$this->fcfuepre->getId())
     {
         $this->fcfuepre->setInieje(date('Y').'-01-01');
         $this->fcfuepre->setFineje(date('Y').'-12-31');
         $this->fcfuepre->setFecufa(date('Y-m-d'));
         $this->fcfuepre->setFeccie(date('Y').'-12-31');
         $this->fcfuepre->setFecest(date('Y').'-12-31');
     }
  ...
  public function executeAjax()
  {
    ...
    switch ($ajax){
      case '1':
        ...
        {
           $dato=$reg->getDescta();
        }else $js="alert_('El C&oacute;digo de la Cuenta Contable No existe.');";
      ...
      case '2':
        ...
        {
           $dato=$reg->getNompre();
        }else $js="alert_('El C&oacute;digo de la Presupuestario de Ingreso No existe.');";
        $output = '[["'.$cajtexmos.'","'.$dato.'",""],["javascript","'.$js.'",""],["","",""]]';
        break;
      default:
        $output = '[["","",""],["","",""],["","",""]]';

 ...
 * @version SVN: $Id: actions.class.php 50475 2013-01-16 21:24:26Z dmartinez $
 *
...
class FacpicsollicActions extends autoFacpicsollicActions
{
  ...
  protected function updateFcsollicFromRequest()
  {
    ...
    {
      $this->fcsollic->setHorini($fcsollic['horini']);
          }
    if (isset($fcsollic['horcie']))
    {
      $this->fcsollic->setHorcie($fcsollic['horcie']);
          }
    ...
    {
      $this->fcsollic->setHorainie($fcsollic['horainie']);
          }
    if (isset($fcsollic['horaciee']))
    {
      $this->fcsollic->setHoraciee($fcsollic['horaciee']);
          }
  ...
  {
    $ano=substr(H::getX_vacio('NUMSOL','Fcsollic','Fecini',$this->fcsollic->getNumsol()),0,4);
    $c = new Criteria();
    //$c->add(FcactpicPeer::NUMDOC,$this->fcsollic->getNumsol());
    $sql1="fcactpic.numdoc='".$this->fcsollic->getNumsol()."' and (fcactpic.ANODEC='".$ano."' or fcactpic.ANODEC is null) and (fcactpic.MODO='E' or fcactpic.MODO is null)";
    $c->add(FcactpicPeer::ANODEC,$sql1,Criteria::CUSTOM);
    ...
    switch ($ajax){
      case '1':
	    ...
	    $correlativo="";
          ...
          $t= new Criteria();
           $t->setLimit(1);
           $t->addDescendingOrderByColumn(FcmodlicPeer::REFMOD);
           $reg= FcmodlicPeer::doSelectOne($t);
           if ($reg)
           {
               $refmod=str_pad(($reg->getRefmod()+1),12,'0',STR_PAD_LEFT);
           }else $refmod='000000000001';
	      $c= new Criteria();
          ...
          $output = '[["fcsollic_licmodificada","I",""],["fcsollic_nomcon","'.$nomcon.'",""],["fcsollic_dircon","'.$dircon.'",""],["fcsollic_idlic","'.$refmod.'",""],["fcsollic_fechlic","'.$fecha.'",""],["javascript","' . $javascript . '",""]]';
      ...
      case '2':
        ...
        $numero = $this->getRequestParameter('numero','');
          ...
          $output = '[["fcsollic_licmodificada","I",""],["fcsollic_nomconrep","'.$nomcon.'",""],["fcsollic_dirconrep","'.$dircon.'",""],["fcsollic_idlic","'.$refmod.'",""],["fcsollic_fechlic","'.$fecha.'",""],["javascript","' . $javascript . '",""]]';
        break;
      ...
      case '3':
	    ...
	    $correlativo="";
          ...
          $output = '[["fcsollic_licmodificada","'.$i.'",""],["fcsollic_catcon","'.$catcon.'",""],["fcsollic_desubicat","'.$descatcon.'",""],["fcsollic_idlic","'.$refmod.'",""],["fcsollic_fechlic","'.$fecha.'",""],["javascript","' . $javascript . '",""]]';
      break;
      ...
      case '4':
          ...
          $numero = $this->getRequestParameter('numero','');
           ...
           if ($reg)
           {
      	  ...
      	  $javascript = $javascript . " $('autorizacion').show();";
          $output = '[["fcsollic_licmodificada","I",""],["fcsollic_idlic","'.$refmod.'",""],["fcsollic_fechlic","'.$fecha.'",""],["javascript","' . $javascript . '",""]]';
      break;
      case '5':
	    $correlativo="";
          $numero = $this->getRequestParameter('numero','');
          ...
          $output = '[["fcsollic_licnegada","'.$i.'",""],["fcsollic_idlic","'.$refmod.'",""],["fcsollic_fechlic","'.$fecha.'",""],["javascript","' . $javascript . '",""],["fcsollic_operacion","N",""]]';
      break;
      case '6':
       ...
       break;
      case '7':
        $cajtexmos = $this->getRequestParameter('cajtexmos',''); $cajtexcom = $this->getRequestParameter('cajtexcom');
        $i=""; $fecha=""; $refmod="";


        $c= new Criteria();
        $c->add(FcrutasPeer::CODRUT,$codigo);
        $result= FcrutasPeer::doSelectOne($c);
        if ($result)
        {
             $dato= $result->getDesrut();
            $fecha = date("d/m/Y");
        ...
        {
          $cajtexcom=""; $cajtexmos=""; $dato="";
          $javascript="alert('La Ruta No Existe'); $('fcsollic_codrut').value=''; $('fcsollic_codrut').focus();";
        }
        $output = '[["'.$cajtexmos.'","'.$dato.'",""],["fcsollic_licmodificada","'.$i.'",""],["fcsollic_idlic","'.$refmod.'",""],["fcsollic_fechlic","'.$fecha.'",""],["javascript","' . $javascript . '",""]]';
       break;
      case '8':
	    $correlativo="";
        $fecha = date("d/m/Y");

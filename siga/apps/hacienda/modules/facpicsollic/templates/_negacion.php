...
<tr>
    <th>
		<ul  class="sf_admin_actions" >
                    <input type="button" name="Submit1" value="Negacion" class="sf_admin_action_delete" id="btnneg" onclick="Mostrar_Negacion();" />
		</ul>
    </th>
    <th>
      &nbsp;
...
<?php }  ?>
    ...
    function Mostrar_orden_preimpresa()
    {
      ...
      {
            var numlicdes=$('fcsollic_numsol').value;
            var anodeclara=$('fcsollic_fecsol').value.substring(6,10);

          var  ruta='http://'+'<? echo $this->getContext()->getRequest()->getHost();?>';
          pagina=ruta+"/<? echo $sf_user->getAttribute('reportes_web');?>/haciebda/r.php?r=fcrlicencia.php&numlicdes="+numlicdes+"&anodeclara="+anodeclara;

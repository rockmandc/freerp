 ...
 *
 * @package    siga
 * @subpackage facdeftasas
 * @author     $Auhor$ <desarrollo@cidesa.com.ve>
 * @version    SVN: $Id: actions.class.php 32371 2009-09-01 16:06:59Z lhernandez $
 * @copyright  Copyright 2007, Cidesa C.A.
 */

class facdeftasasActions extends autofacdeftasasActions
{
    ...
    switch ($ajax){
      case '1':
        ...
        if ($reg)
            ...
            $js="alert('El Rubro no existe...'); $('fcdeftasas_codfue').value=''; $('fcdeftasas_codfue').focus(); ";
  ...
  {
    $datos=H::getX_vacio('CODTAS', 'Fcplatas', 'CODTAS', $clasemodelo->getCodtas());
    if ($datos)
        return 6;
    else

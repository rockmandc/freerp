 ...
 */
 ?>
    ...
    <td><?php echo link_to($fcdeclar->getNumdec() ? $fcdeclar->getNumdec() : __('-'), 'facvehdec/edit?id='.$fcdeclar->getId().'&numdecl='.$fcdeclar->getNumdec().'&numrefe='.$fcdeclar->getNumref()) ?></td>

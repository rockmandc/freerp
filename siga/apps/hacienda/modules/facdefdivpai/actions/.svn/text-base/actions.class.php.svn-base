...
/**
 * facdefdivpai actions.
 *
 * @package    siga
 * @subpackage facdefdivpai
 * @author     $Auhor$ <desarrollo@cidesa.com.ve>
 * @version    SVN: $Id: actions.class.php 32371 2009-09-01 16:06:59Z lhernandez $
 * @copyright  Copyright 2007, Cidesa C.A.
 */

class facdefdivpaiActions extends autofacdefdivpaiActions
{
  ...
  {
    $p= new Criteria();
    $p->add(FcestadoPeer::CODPAI,$clasemodelo->getCodpai());
    $reg= FcestadoPeer::doSelectOne($p);
    if ($reg)
      return 6;
    else {

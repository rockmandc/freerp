...
<?php
      echo radiobutton_tag('fcreginm[nacconrep]', 'V', true,array('disabled' => true)).'&nbsp;&nbsp;'."Venezolano(a)".'&nbsp;&nbsp;&nbsp;&nbsp;';
      echo radiobutton_tag('fcreginm[nacconrep]', 'E', false,array('disabled' => true)).'&nbsp;&nbsp;'."Extranjero(a)".'&nbsp;&nbsp;&nbsp;&nbsp;';
}
elseif ($fcreginm->getNacconrep()=="E")
{
      echo radiobutton_tag('fcreginm[nacconrep]', 'V', false,array('disabled' => true)).'&nbsp;&nbsp;'."Venezolano(a)".'&nbsp;&nbsp;&nbsp;&nbsp;';

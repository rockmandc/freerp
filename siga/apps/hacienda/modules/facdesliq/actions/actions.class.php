    ...
    switch ($ajax){
      case '1':
          ...
          if ($reg)
          {
              ...
              $js="alert_('El C&oacute;digo Fuente asociado no se encuentra registrado');";
          }
        $output = '[["'.$cajtexmos.'","'.$dato.'",""],["javascript","'.$js.'",""],["","",""]]';
        break;
      case '2':
          $t= new Criteria();
          $t->add(CarecaudPeer::CODREC,$codigo);
          $reg= CarecaudPeer::doSelectOne($t);
          if ($reg)
          {
              $dato=$reg->getDesrec();
          }else {
              $js="alert_('El C&oacute;digo del Recaudo no se encuentra registrado');";
          }
        $output = '[["'.$cajtexmos.'","'.$dato.'",""],["javascript","'.$js.'",""],["","",""]]';
        break;
      default:

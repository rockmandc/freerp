...
/**
 * nominctracue actions.
 *
 * @package    siga
 * @subpackage nominctracue
 * @author     $Auhor$ <desarrollo@cidesa.com.ve>
 * @version    SVN: $Id: actions.class.php 32371 2009-09-01 16:06:59Z lhernandez $
 * @copyright  Copyright 2007, Cidesa C.A.
 */

class nominctracueActions extends autonominctracueActions
{
  public function executeIndex()
  {
    $c= new Criteria();
    $resul= NpinctraPeer::doSelectOne($c);
    if ($resul)
    {
     $id=$resul->getId();
     return $this->redirect('nominctracue/edit?id='.$id);
    }
    else
    {
      return $this->redirect('nominctracue/edit');
    }
  }

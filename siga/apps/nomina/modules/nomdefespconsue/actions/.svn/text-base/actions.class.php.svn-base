...
class nomdefespconsueActions extends autonomdefespconsueActions
{
  ...
  public function configGrid()
  {
    ...
    $this->configGridSalarioIntegralFideicomiso();
  ...
  public function configGridSalarioIntegral()
  {
    ...
    $reg2 = NpconsalintPeer::doSelectJoinAll($c);
   ...
   *
   */
  public function configGridSalarioIntegralFideicomiso()
  {
    $c = new Criteria();
    $c->addAscendingOrderByColumn(NpconsalintfidPeer::CODNOM);
    $c->addAscendingOrderByColumn(NpconsalintfidPeer::CODCON);
    $reg2 = NpconsalintfidPeer::doSelectJoinAll($c);

    $this->columnas = Herramientas::getConfigGrid(sfConfig::get('sf_app_module_dir').'/nomdefespconsue/'.sfConfig::get('sf_app_module_config_dir_name').'/grid_salintfid');
  ...
  $params = array (
    ...
    $this->columnas[1][2]->setHTML('type="text" size=5 maxlength=3 onBlur="javascript:event.keyCode=13; ajaxconcepto(event,this.id);"');
    $this->columnas[1][0]->setAjax('nomdefespconsue',2,2);
    $this->obj7 =$this->columnas[0]->getConfig($reg2);

    $this->npasiconsue->setObj7($this->obj7);
  }  
  ...
  protected function saving($npasiconsue)
  {
    ...
    $grid6=Herramientas::CargarDatosGridv2($this,$this->obj6);
    $grid7=Herramientas::CargarDatosGridv2($this,$this->obj7);
    Nomina::salvarConceptosReportes($npasiconsue,$grid1,$grid2,$grid3,$grid4,$grid5,$grid6,$grid7);
    return -1;

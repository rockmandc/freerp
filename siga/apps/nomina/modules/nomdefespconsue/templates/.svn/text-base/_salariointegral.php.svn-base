...
<script language="JavaScript" type="text/javascript">
 ...
 function ajaxconcepto(e,id)
 {
   var aux = id.split("_");
    ...
    if ($(id).value!='')
    {
      new Ajax.Request('/nomina'+getEnv()+'.php/nomdefespconsue/ajax', {asynchronous:true, evalScripts:false, onComplete:function(request, json){AjaxJSON(request, json), validargrid(id); }, parameters:'ajax=3&cajtexmos='+descripcion+'&nomina='+nom+'&cajtexcom='+id+'&codigo='+cod})
    }
  }
 }
</script>

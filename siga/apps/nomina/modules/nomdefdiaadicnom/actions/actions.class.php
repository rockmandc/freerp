...
$this->Bitacora('Guardo');
  ...
  public function configGrid($codnom='')
  {
    $sql="Select coalesce((select (CASE when codcon is not null then 1 end) as check1
            from  npdiaadicnom where codnom='".$codnom."' and a.codnom = codnom and codcon = a.codcon  ),0) as check,a.codcon,b.nomcon, (select preant
            from  npdiaadicnom where codnom='".$codnom."' and a.codnom = codnom and codcon = a.codcon  ) as preant, 9 as id
    ...
    $col4 = new Columna('Prestación');
    $col4->setTipo(Columna::COMBO);
    $col4->setEsGrabable(true);
    $col4->setNombreCampo('preant');
    $col4->setCombo(array('P' => 'Antiguedad', 'A' => 'Antiguedad Adicional', 'V' => 'Vacaciones'));
    $col4->setHTML(' ');

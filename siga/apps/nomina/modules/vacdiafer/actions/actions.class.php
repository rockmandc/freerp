...
$this->Bitacora('Guardo');
   ...
   *
   */
  public function configGrid($codniv='')
  {
    $diaferniv=H::getConfApp2('diaferniv', 'nomina', 'vacdiafer');
      if ($diaferniv=='S'){
        if ($codniv!=''){
          $c = new Criteria();
          $c->add(NpvacdiaferPeer::CODNIV,$codniv);
          $per = NpvacdiaferPeer::doSelect($c);
        }else {
          $c = new Criteria();
          $c->add(NpvacdiaferPeer::CODNIV,'X');
          $per = NpvacdiaferPeer::doSelect($c);
        }
      }else {
        $c = new Criteria();
  ...
  public function executeAjax()
  {
     ...
     {
       $t= new Criteria();
       $t->add(NpestorgPeer::CODNIV,$codigo);
       $regt=NpestorgPeer::doSelectOne($t);
       if ($regt)
        $dato=$regt->getDesniv();
       else {
        $js="alert('La Ubicaci&oacute;n Administrativa no esta registrada'); $('$cajtexcom').value=''; $('$cajtexmos').value=''; $('$cajtexcom').focus();";
       }        

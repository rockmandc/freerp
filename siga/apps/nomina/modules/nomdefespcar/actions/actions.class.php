  ...
  public function executeAjax()
	{
     ...
     $cajtexcom=$this->getRequestParameter('cajtexcom');
      ...
      else  if ($this->getRequestParameter('ajax')=='4')
      {
        ...
        $t= new Criteria();
        $t->add(ViadefnivPeer::CODNIV,$this->getRequestParameter('codigo'));
        $regt= ViadefnivPeer::doSelectOne($t);
        if ($regt)
          $dato=$regt->getDesniv();
        else $js="alert('El Nivel no existe'); $('".$cajtexcom."').value=''; $('".$cajtexmos."').value=''; $('".$cajtexcom."').focus();";
...
/**
  ...
  public function getLabels()
  {
    ...
    $cametiretcar=H::getConfApp2('cametiretcar', 'nomina', 'nomdefespcar');
    if ($cametiretcar=='S')
      $labels['npcargos{retcar}'] = 'Otras Retribuciones';
    return $labels;
  }

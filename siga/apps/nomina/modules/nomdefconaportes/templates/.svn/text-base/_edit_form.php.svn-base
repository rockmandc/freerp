...
<script language="JavaScript" type="text/javascript">
  ...
  function ajax(e,id)
 {
   var aux = id.split("_");
    ...
    if ($(id).value!='')
    {
      new Ajax.Request('/nomina'+getEnv()+'.php/nomdefconaportes/ajax', {asynchronous:true, evalScripts:false, onComplete:function(request, json){AjaxJSON(request, json), validargrid(id); }, parameters:'ajax=2&cajtexmos='+descripcion+'&nomina='+nom+'&cajtexcom='+id+'&codigo='+cod})
    }
  }
 }
</script>

...
<br>
<?php echo label_for('nptipcon[apliregant]', __($labels['nptipcon{apliregant}']), 'class="required"') ?>
  <div class="content<?php if ($sf_request->hasError('nptipcon{apliregant}')): ?> form-error<?php endif; ?>">
  <?php if ($sf_request->hasError('nptipcon{apliregant}')): ?>
    <?php echo form_error('nptipcon{apliregant}', array('class' => 'form-error-msg')) ?>
  <?php endif; ?>

  <?php echo select_tag('nptipcon[apliregant]', options_for_select(array('S'=>'SI','N'=>'NO'),$nptipcon->getApliregant()),array(
      ));?>
</div>
<br>
...
<br>
  ...
  <?php echo label_for('nptipcon[fecfin108]', __($labels['nptipcon{fecfin108}']), 'class="required"') ?>
  <div class="content<?php if ($sf_request->hasError('nptipcon{fecfin108}')): ?> form-error<?php endif; ?>">
  <?php if ($sf_request->hasError('nptipcon{fecfin108}')): ?>
    <?php echo form_error('nptipcon{fecfin108}', array('class' => 'form-error-msg')) ?>
  <?php endif; ?>

  <?php $value = object_input_date_tag($nptipcon, 'getfecfin108', array (
  'size' => 11,
  'maxlength' => 10,
  'rich' => true,
  'calendar_button_img' => '/sf/sf_admin/images/date.png',
  'control_name' => 'nptipcon[fecfin108]',
  'date_format' => 'dd/MM/yyyy',
  'onkeyup' => "javascript: mascara(this,'/',patron,true)",
),date('Y-m-d')); echo $value ? $value : '&nbsp;' ?>
...
<br>
<br>
  <?php echo label_for('nptipcon[mesini]', __($labels['nptipcon{mesini}']), 'class="required" ') ?>
  <div class="content<?php if ($sf_request->hasError('nptipcon{mesini}')): ?> form-error<?php endif; ?>">
  <?php if ($sf_request->hasError('nptipcon{mesini}')): ?>
    <?php echo form_error('nptipcon{mesini}', array('class' => 'form-error-msg')) ?>
  <?php endif; ?>

  <?php $value = object_input_tag($nptipcon, 'getMesini', array (
  'size' => 7,
  'control_name' => 'nptipcon[mesini]',
)); echo $value ? $value : '&nbsp;' ?>
    </div>

    <br>
<?php echo label_for('nptipcon[trimfis]', __($labels['nptipcon{trimfis}']), 'class="required"') ?>
  <div class="content<?php if ($sf_request->hasError('nptipcon{trimfis}')): ?> form-error<?php endif; ?>">
  <?php if ($sf_request->hasError('nptipcon{trimfis}')): ?>
    <?php echo form_error('nptipcon{trimfis}', array('class' => 'form-error-msg')) ?>
  <?php endif; ?>

  <?php echo select_tag('nptipcon[trimfis]', options_for_select(array('S'=>'SI','N'=>'NO'),$nptipcon->getTrimfis()),array(
      ));?>
</div>

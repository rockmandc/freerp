  ...
  public function executeAjax()
	{
	 ...
	 {
      $cod=$this->getRequestParameter('codigoconcepto');
      ...
      $c = new Criteria();
      $c->add(NpdefmovPeer::CODNOM,$this->getRequestParameter('codigonomina'));
      if ($filconusu == 'S') {
      ...
      $reg=NpdefcptPeer::doSelectOne($c);
       ...
       {  
          ...
          $dato="";
          $js="alert('El Concepto no existe'); $('npasiconemp_codcon').value='';";
          $this->configGrid();
       }

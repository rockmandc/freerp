...
<br>
 ...
 <br>
  <?php echo label_for('nptipcar[docsn]', __($labels['nptipcar{docsn}']), 'class="required"') ?>
  <div class="content<?php if ($sf_request->hasError('nptipcar{docsn}')): ?> form-error<?php endif; ?>">
  <?php if ($sf_request->hasError('nptipcar{docsn}')): ?>
    <?php echo form_error('nptipcar{docsn}', array('class' => 'form-error-msg')) ?>
  <?php endif; ?>

  <?php $value = object_checkbox_tag($nptipcar, 'getDocsn', array (
  'control_name' => 'nptipcar[docsn]',
)); echo $value ? $value : '&nbsp;' ?>
    </div>
</div>    
</fieldset>

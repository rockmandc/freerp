...
<script type="text/javascript">
 function importante()
 {
   ...
   f.action='/nomina'+getEnv()+'.php/nomnomcienomesp/realizarcierre?numsem='+$F('npnomesptipos_numsem')+"&ultfec="+$F('npnomesptipos_ultfec')+"&profec="+$F('npnomesptipos_profec')+"&codnomesp="+$F('npnomesptipos_codnomesp')+"&codnom="+$F('npnomesptipos_codnom');
   f.submit();
 }

...
//		date('d/m/Y',strtotime($dato2));
  ...
  $valgencom=H::getConfApp2('valgencom', 'nomina', 'nomnomcienomesp');
   if ($valgencom=='S'){
      $dateFormat = new sfDateFormat('es_VE');
      $fec1 = $dateFormat->format($profec, 'i', $dateFormat->getInputPattern('d'));
      
      $t= new Criteria();
      $t->add(NpnomcomPeer::CODNOM,$codigo);
      $t->add(NpnomcomPeer::CODNOMESP,$codnomesp);

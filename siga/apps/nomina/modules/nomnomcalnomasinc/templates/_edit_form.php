 ...
 * @version    SVN: $Id:_edit_form.php 34097 2009-10-16 19:24:31Z dmartinez $
 */
// date: 2007/08/21 17:26:03
?>
<?php echo form_tag('nomnomcalnomasinc/save', array(
...
<?php echo javascript_include_tag('nomina/nomnomcalnomasinc') ?>
<?php echo javascript_include_tag('progressbar') ?>
...
<div class="form-row">
  ...
  <?php echo input_auto_complete_tag('npnomina[codnom]', $npnomina->getCodnom(),
    'nomnomcalnomasinc/autocomplete?ajax=1',  array('autocomplete' => 'off','size' => 5, 'maxlength' => 3,
	'onKeypress' => "javascript:cadena=this.value;cadena=cadena.toUpperCase();$('npnomina_codnom').value=cadena",
	'onBlur'=> remote_function(array(
			  'url'      => 'nomnomcalnomasinc/ajax',
...
<input id="opsiview" type="text" value="" style="display:none">
&nbsp;&nbsp;&nbsp;&nbsp;
...
<tr>
 ...
 <th colspan="2">
  <div>
    <div id="progress_bar"></div><span id="linfo" style="font-size: 18px;">Sin Nóminas</span>
...
/*      #progress_bar {  
    ...
    progress_bar.step.bind(progress_bar,100);
    </script>
...
<?php echo submit_to_remote('btnCalcular', 'Calcular Nomina', array(
			   ...
			   'with'     => "'ajax=2&codnom='+$('npnomina_codnom').value+'&numsem='+$('npnomina_numsem').value+'&desde='+$('npnomina_ultfec').value+'&hasta='+$('npnomina_profec').value+'&opsi='+$('opsi_SI').checked+'&msem2='+$('msem2').value+'&nomnom='+$('npnomina_nomnom').value",
));
...
<?php echo button_to(__('delete'), 'nomnomcalnomasinc/delete?id='.$npnomina->getId(), array (
  'post' => true,

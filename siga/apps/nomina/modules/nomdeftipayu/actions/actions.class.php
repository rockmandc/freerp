...
/**
 * nomdeftipayu actions.
 *
 * @package    siga
 * @subpackage nomdeftipayu
 * @author     $Auhor$ <desarrollo@cidesa.com.ve>
 * @version    SVN: $Id: actions.class.php 32371 2009-09-01 16:06:59Z lhernandez $
 * @copyright  Copyright 2007, Cidesa C.A.
 */

class nomdeftipayuActions extends autonomdeftipayuActions
{
  ...
  public function executeAjax()
  {
    ...
    switch ($ajax){
      case '1':
        $p= new Criteria();
        $p->add(NppartidasPeer::CODPAR,$codigo);
        $result= NppartidasPeer::doSelectOne($p);
        if ($result)
          $dato=$result->getNompar();
        else
          $js="alert('La Partida Presupuestaria no existe'); $('nptipayu_codpar').value=''; $('nptipayu_codpar').focus();";

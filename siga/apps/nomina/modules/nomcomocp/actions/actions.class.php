...
$this->Bitacora('Guardo');
  ...
  public function configGrid($codtipcar='',$fecdes='',$pascar='',$numfil=100)
  {
    ...
    $tipcar=H::getX_vacio('CODTIPCAR','Nptipcar','Docsn',$codtipcar);
  ...
  protected function getNpcomocpOrCreate($id = 'id', $codtipcar = 'codtipcar', $fecdes = 'fecdes')
  {
    if (!$this->getRequestParameter($codtipcar))
    {
      ...
      $this->configGrid($this->getRequestParameter('npcomocp[codtipcar]'),$this->getRequestParameter('npcomocp[fecdes]'),$this->getRequestParameter('npcomocp[pascar]'));
  ...
  public function executeAjax()
  {
   ...
   if ($this->getRequestParameter('ajax')=='1')
   {
	 ...
	 $dato='';
	 $c = new Criteria();
   $c->add(NptipcarPeer::CODTIPCAR,$this->getRequestParameter('codigo'));
	 $d=NptipcarPeer::doSelectOne($c);
	 if(!$d)
	 {
	 	$js.="$('npcomocp_codtipcar').value='';";		
     $js.="alert('Tipo de Cargo no existe');";

...
<?php echo form_tag('npforasiconemp/list', array('method' => 'get','name'=>'sf_admin_filters_form')) ?>

  <fieldset>
    <h2><?php echo __('filters') ?></h2>
    <div class="form-row">
    <label for="filters_codemp"><?php echo __('Código del Empleado:') ?></label>
    <div class="content">
  ...
  'maxlength' => 16,
        ...
        <div class="form-row">
    <label for="filters_codnom"><?php echo __('Código de la Nómina:') ?></label>
    <div class="content">
  ...
  'maxlength' => 3,
        ...
        <div class="form-row">
    <label for="filters_nomemp"><?php echo __('Nombre del Empleado:') ?></label>
    <div class="content">
  ...
  'size' => 10,
        ...
        <div class="form-row">
    <label for="filters_codcar"><?php echo __('Código del Cargo:') ?></label>
    <div class="content">
  ...
  <ul class="sf_admin_actions">
    <li><?php echo button_to(__('reset'), 'npforasiconemp/list?filter=filter', 'class=sf_admin_action_reset_filter') ?></li>

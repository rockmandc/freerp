...
class nomnomcalnomActions extends autonomnomcalnomActions
{
  ...
  CalculoNomina::ValidicionPorEmpleado($codnom,$desde,$hasta,$opsi,$msem,$cont);
    ...
    $sql="delete from tmpcalculo".$codnom." where codnom ='".$codnom."' ";
    Herramientas::insertarRegistros($sql);


  $sql="select codnom from tmpcalculo".$codnom;
  if (!(Herramientas::BuscarDatos($sql,$tabla)))
  {
    $sql = "drop table tmpcalculo".$codnom;
    Herramientas::insertarRegistros($sql);
  }
  ...
  $cajtexmos=$this->getRequestParameter('cajtexmos');
    ...
    ////////////////////////////////////////////////////////////////////////////////////
      ...
      {
          try{
              $sql = "select id,codnom,condicion from tmpcalculo".$codnom." where codnom='".$codnom."'";
              if (Herramientas::BuscarDatos($sql,$npnomina))
            {
              $tabla=true;
            }else
            ...
            $sql = "CREATE TABLE tmpcalculo".$codnom." (id int4 NOT NULL,
		  ...
		  if(is_array($varemp))
			...
			if ($intpre=='S')
			{
	            CierredeNomina::Validarcodprenominav2($codnom,$desde,$sobregiro);

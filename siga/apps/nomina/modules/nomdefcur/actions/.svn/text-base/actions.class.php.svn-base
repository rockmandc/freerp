...
class nomdefcurActions extends autonomdefcurActions
{
 ...
 public function configGridClase($codcur='')
  ...
  {    
    ...
    $col1 = new Columna('Externo');
    $col1->setTipo(Columna::CHECK);
    $col1->setNombreCampo('instr');
    $col1->setEsGrabable(true);
    $col1->setHTML(' ');

    $params = array('param1' => "'+$(this.id).up().previous(0).descendants()[0].checked+'");
    $col2 = new Columna('Cédula');
    $col2->setTipo(Columna::TEXTO);
    $col2->setEsGrabable(true);
    $col2->setAlineacionObjeto(Columna::CENTRO);
    $col2->setAlineacionContenido(Columna::CENTRO);    
    $col2->setNombreCampo('cedpro');
    $col2->setCatalogo('npinstructores','sf_admin_edit_form',array('cedpro' => 2,'nompro' => 3), 'Nomdefcur_npinstructores',$params);
    $col2->setHTML('type="text" size="15" maxlength="10"');
    ...
    $col3->setAlineacionObjeto(Columna::IZQUIERDA);
    $col3->setAlineacionContenido(Columna::IZQUIERDA);
    $col3->setNombreCampo('nompro');
    $col3->setHTML('type="text" size="60" maxlength="100"');
  ...
  public function validateEdit()
  {
    ...
    $novalins=H::getConfApp2('novalins','nomina','nomdefcur');

...
<br>
  <?php echo label_for('nptippar[unico]', __($labels['nptippar{unico}']), 'class="required"') ?>
  <div class="content<?php if ($sf_request->hasError('nptippar{unico}')): ?> form-error<?php endif; ?>">
  <?php if ($sf_request->hasError('nptippar{unico}')): ?>
    <?php echo form_error('nptippar{unico}', array('class' => 'form-error-msg')) ?>
  <?php endif; ?>

  <?php $value = object_checkbox_tag($nptippar, 'getUnico', array (
  'control_name' => 'nptippar[unico]',
)); echo $value ? $value : '&nbsp;' ?>
    </div>

<br>
  <?php echo label_for('nptippar[hcmfunamb]', __($labels['nptippar{hcmfunamb}']), 'class="required"') ?>
  <div class="content<?php if ($sf_request->hasError('nptippar{hcmfunamb}')): ?> form-error<?php endif; ?>">
  <?php if ($sf_request->hasError('nptippar{hcmfunamb}')): ?>
    <?php echo form_error('nptippar{hcmfunamb}', array('class' => 'form-error-msg')) ?>
  <?php endif; ?>

<?php echo select_tag('nptippar[hcmfunamb]', options_for_select(array('H' => 'HCM', 'F' => 'Funerario', 'A' => 'Ambas'),$nptippar->getHcmfunamb(),'include_custom=Seleccione una ..'),array()) ?>
    </div>

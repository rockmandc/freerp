...
class fadefvehActions extends autofadefvehActions
{
    ...
    switch ($ajax) {
        case '1':
            ...
            if ($reg) {
                ...
                $js = "alert('El Código de la Empresa no Existe'); $('fadefveh_codemptra').value=''; $('fadefveh_nomemptra').value=''; $('fadefveh_codemptra').focus();";
            }

 ...
 */
class fadefchoActions extends autofadefchoActions {
    ...
    public function executeAjax() {
        ...
        switch ($ajax) {
            case '1':
                $t = new Criteria();
                $t->add(FaemptraPeer::CODEMPTRA, $codigo);
                $reg = FaemptraPeer::doSelectOne($t);
                if ($reg) {
                    $dato = $reg->getNomemptra();
                } else {
                    $js = "alert('El Código de la Empresa no Existe'); $('fadefcho_codemptra').value=''; $('fadefcho_nomemptra').value=''; $('fadefcho_codemptra').focus();";
                }

...
<tr>
 ...
 <?php if($facliente->getId()!='') : ?>
 <th>
 <?php echo link_to_seniat($facliente->getRifpro()) ?>
 </th>
 <th>
 <?php echo link_to_snc($facliente->getRifpro()) ?>
 </th>
 <?php endif; ?>
...
<th>
    <br>
  <?php echo label_for('facliente[esprospec]', __($labels['facliente{esprospec}']), 'class="required" ') ?>
...
<?php echo label_for('facliente[codcta]', __($labels['facliente{codcta}']), 'class="required"') ?>
  ...
  'onBlur'=> remote_function(array(
   'url'      => 'facliente/ajax',
   'complete' => 'AjaxJSON(request, json)',
   'condition' => "$('facliente_codcta').value != ''",
...
<?php echo label_for('facliente[codctaant]', __($labels['facliente{codctaant}']), 'class="required"') ?>
  ...
  'onBlur'=> remote_function(array(
   'url'      => 'facliente/ajax',
   'complete' => 'AjaxJSON(request, json)',
   'condition' => "$('facliente_codctaant').value != ''",
   'with' => "'ajax=2&cajtexmos=facliente_desctaant&cajtexcom=facliente_codctaant&codigo='+this.value"
      ))
)); echo $value ? $value : '&nbsp;' ?>
&nbsp;
<?php echo  button_to_popup('...',cross_app_link_to('herramientas','catalogo').'/metodo/Contabb_Facliente/clase/Contabb/frame/sf_admin_edit_form/obj1/facliente_desctaant/obj2/facliente_codctaant/campo1/descta/campo2/codcta')?>
&nbsp;
<?php $value = object_input_tag($facliente, 'getDesctaant', array (
  'disabled' => true,
  'size' => 60,
  'control_name' => 'facliente[desctaant]',
)); echo $value ? $value : '&nbsp;' ?></div>
...
<?php tabPageOpenClose("tp1", "tabPage5", 'Personas Contactos');?>
<fieldset id="sf_fieldset_none" class="">
<div class="form-row">
<br/>
<div id="divgrid">
  ...
  <?php $value = get_partial('grid', array('type' => 'edit', 'facliente' => $facliente)); echo $value ? $value : '&nbsp;' ?>

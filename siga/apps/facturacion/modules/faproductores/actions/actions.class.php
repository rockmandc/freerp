...
/**
 * faproductores actions.
 *
 * @package    siga
 * @subpackage faproductores
 * @author     $Auhor$ <desarrollo@cidesa.com.ve>
 * @version    SVN: $Id: actions.class.php 32371 2009-09-01 16:06:59Z lhernandez $
 * @copyright  Copyright 2007, Cidesa C.A.
 */

class faproductoresActions extends autofaproductoresActions
{
  ...
  {
     $c= new Criteria();
     $c->add(OpbenefiPeer::CEDRIF, $clasemodelo->getRifprod());
     $ben= OpbenefiPeer::doSelectOne($c);
     if (!$ben)
     {
      $benefi= new Opbenefi();
      $benefi->setCedrif($clasemodelo->getRifprod());
      $benefi->setNomben($clasemodelo->getNomprod());
      $benefi->setDirben($clasemodelo->getDirprod());
      $benefi->setTelben($clasemodelo->getTelprod());
      $benefi->save();
     }
  ...
  {
    $esta=H::getX_vacio('RIFPROD','Fafactur','Rifprod',$clasemodelo->getRifprod());
    if ($esta!='')
      return 6;
    else

...
$this->Bitacora('Guardo');
  ...
  protected function updateFaartpvpFromRequest()
  {
    ...
    if (isset($faartpvp['artdesde']))
    {
      $this->faartpvp->setArtdesde($faartpvp['artdesde']);
    }
    if (isset($faartpvp['desartdesde']))
    {
      $this->faartpvp->setDesartdesde($faartpvp['desartdesde']);
    }
    if (isset($faartpvp['arthasta']))
    {
      $this->faartpvp->setArthasta($faartpvp['arthasta']);
    }
    if (isset($faartpvp['desarthasta']))
    {
      $this->faartpvp->setDesarthasta($faartpvp['desarthasta']);
    }
    if (isset($faartpvp['monaum']))
    {
      $this->faartpvp->setMonaum($faartpvp['monaum']);
    }
    if (isset($faartpvp['tipo']))
    {
      $this->faartpvp->setTipo($faartpvp['tipo']);
    }
    if (isset($faartpvp['precio']))
    {
      $this->faartpvp->setPrecio($faartpvp['precio']);
    }   
  }

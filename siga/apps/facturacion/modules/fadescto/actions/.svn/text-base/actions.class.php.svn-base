 ...
 */
class fadesctoActions extends autofadesctoActions
{
  private $coderror = -1;
      ...
      case '1':
        ...
        if ($result) {
          if ($result->getCargab()=='C')
            ...
            $js="alert_('La Cuenta Contable no es Cargable'); $('fadescto_codcta').value=''; $('fadescto_codcta').focus();";
        }else
          $js="alert_('La Cuenta Contable no existe'); $('fadescto_codcta').value=''; $('fadescto_codcta').focus();";
   ...
   *
   */
  public function saving($fadescto)
  {
    return parent::saving($fadescto);
  }

  public function deleteFarecarg($fadescto)
  {
    ...
    try {
      ...
      parent::deleteFarecarg($fadescto);

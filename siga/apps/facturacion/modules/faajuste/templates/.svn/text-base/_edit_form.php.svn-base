...
<table>
  <tr>
	...
	<th>
	   ...
	   <?php echo  button_to_popup('...',cross_app_link_to('herramientas','catalogo').'/metodo/Factura_FanotentNew/clase/Fafactur/frame/sf_admin_edit_form/obj1/faajuste_codref/campo1/reffac/','','','botoncat')?></th>
		</div>
	</th>
  </tr>
</table>
...
<br/>
<div id="divcoddirec">
  <?php if($labels['faajuste{coddirec}']!='.:') { ?>
  <?php echo label_for('faajuste[coddirec]', __($labels['faajuste{coddirec}' ]), 'class="required" Style="text-align:left; width:150px"') ?>
  <div class="content<?php if ($sf_request->hasError('faajuste{coddirec}')): ?> form-error<?php endif; ?>">
  <?php if ($sf_request->hasError('faajuste{coddirec}')): ?>
    <?php echo form_error('faajuste{coddirec}', array('class' => 'form-error-msg')) ?>
  <?php endif; }?>  
  
    
  <?php echo Catalogo($faajuste, 5, array (
  ...
  <tr>
    <th>
		<div id="divmonaju">
		  ...
		  <?php $value = object_input_tag($faajuste, array('getMonaju',true), array (
		  'size' => 20,
		  //'readonly' => true,
...
<script language="javascript">
 ...
 $('divreffactura').hide();
 var habrefaju='<?php echo H::getConfApp2('habrefaju', 'facturacion', 'faajuste');?>';
 if (habrefaju=='S')
 	$('faajuste_refaju').readOnly=false;
 ...
 function habilitarefere(id)
 {
  ...
  {
      var  refaju='<? echo $faajuste->getRefaju();?>';

      var  ruta='http://'+'<?echo $this->getContext()->getRequest()->getHost();?>';
      var nomreporte='<?php echo H::getConfApp2('nomreporte', 'facturacion', 'faajuste'); ?>';
      if (nomreporte!='')
        pagina=ruta+"/<?php echo $sf_user->getAttribute('reportes_web');?>/facturacion/r.php?r="+nomreporte+".php&refdes="+refaju+"&refhas="+refaju;
      else
      	pagina=ruta+"/<?php echo $sf_user->getAttribute('reportes_web');?>/facturacion/r.php?r=farnotentpre.php&coddes="+refaju+"&codhas="+refaju;


      window.open(pagina,refaju,"menubar=yes,toolbar=yes,scrollbars=yes,width=1200,height=800,resizable=yes,left=1000,top=80");      
  }

  ...
  public function executeAjax()
	{
     ...
     $cajtexcom=$this->getRequestParameter('cajtexcom');
      ...
      else  if ($this->getRequestParameter('ajax')=='3')
      {
        $js=""; $dato="";
        $q= new Criteria();
        $q->add(CotiptraPeer::CODTIPTRA,$this->getRequestParameter('codigo'));
        $result= CotiptraPeer::doSelectOne($q);
        if ($result)
          $dato=$result->getDestiptra();
        else
          $js="alert_('El Tipo de Transaci&oacute;n no existe'); $('facorrelat_codtiptra').value=''; $('facorrelat_codtiptra').focus();";
 ...
 /* public function handleErrorEdit()
  ...
  protected function saveFadefart($fadefcaj)
  {
   ...
   /* if($codcat!=-1){
    ...
    $resp= Facturacion::salvarCuentas($this->getRequestParameter('facorrelat[ctadev]'),$this->getRequestParameter('facorrelat[ctavco]'),$this->getRequestParameter('facorrelat[generaop]'),$this->getRequestParameter('facorrelat[generacom]'),$this->getRequestParameter('facorrelat[apliclades]'),$this->getRequestParameter('facorrelat[codmon]'),$this->getRequestParameter('facorrelat[codtiptra]'));
    if($resp!=-1){
      $this->coderror = $resp;
      return $this->coderror;
    }

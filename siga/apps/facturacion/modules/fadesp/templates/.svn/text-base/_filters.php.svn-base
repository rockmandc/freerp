...
<?php echo form_tag('fadesp/list', array('method' => 'get')) ?>
  ...
  'date_format' => 'dd/MM/yy',
        ...
        <div class="form-row">
    <label for="filters_reqart"><?php echo __('Referencia:') ?></label>
    <div class="content">
  ...
  'size' => 8,
        ...
        <div class="form-row">
    <label for="filters_stadph"><?php echo __('Estatus:') ?></label>
    <div class="content">
    <?php echo input_tag('filters[stadph]', isset($filters['stadph']) ? $filters['stadph'] : null, array (
  'size' => 1,
)) ?>
    </div>
    </div>

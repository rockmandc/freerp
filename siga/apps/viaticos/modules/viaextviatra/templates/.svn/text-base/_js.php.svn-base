<script language="Javascript">
    ...
    function calculamontofinal(id,colu)
    {
        if($(id).readOnly==false)
        {
            ...
            $(idcamdol).value=number_format(parseFloat(valor)/4.3,2,',','.');
    ...
    {
            toAjax(3,getUrlModuloAjax(),$(id).value,'','&fecdes='+$('viaextviatra_fecextdes').value+'&fechas='+$('viaextviatra_fecexthas').value+'&id='+id);
    }    
</script>

...
/**
 * viarevcalviatra actions.
 *
 * @package    siga
 * @subpackage viarevcalviatra
 * @author     $Auhor$ <desarrollo@cidesa.com.ve>
 * @version    SVN: $Id: actions.class.php 32371 2009-09-01 16:06:59Z lhernandez $
 * @copyright  Copyright 2007, Cidesa C.A.
 */

class viarevcalviatraActions extends autoviarevcalviatraActions
{
  ...
  public function configGrid($fecdes="", $fechas="", $reg = array())
  {
    ...
    if ($fecdes!="" && $fechas!="") {
     ...
     $this->obj = Herramientas::getConfigGrid(sfConfig::get('sf_app_module_dir').'/viarevcalviatra/'.sfConfig::get('sf_app_module_config_dir_name').'/grid');
      ...
      case '1':
        if($fecdes!='' && $fechas!=''){
            ...
            if($fecdes<=$fechas){
                ...
                $output = '[["viarevcalviatra_fecdes","",""],["viarevcalviatra_fechas","",""],["javascript","'.$js.'",""]]';
                $this->configGrid();
            }
        }else{
            $this->params=array();
  ...
  public function saving($clasemodelo)
  {
    ...
    Viaticos::reversarCalculoViatico($grid);
  ...
  {
    $this->forward('viarevcalviatra', 'create');
  }
}

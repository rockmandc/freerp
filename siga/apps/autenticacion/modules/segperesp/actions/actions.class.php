 ...
 *
 * @package    siga
 * @subpackage segperesp
 * @author     $Auhor$ <desarrollo@cidesa.com.ve>
 * @version    SVN: $Id: actions.class.php 32371 2009-09-01 16:06:59Z lhernandez $
 * @copyright  Copyright 2007, Cidesa C.A.
 */

class segperespActions extends autosegperespActions
{
  ...
  {
      $procesos=array();
      $segperesp = new Segperesp();
      $segperesp->setCodapl("CI0");
      $segperesp->setProceso("Devoluciones en efectivo");
      $procesos[]= $segperesp;
//      $segperesp = new Segperesp();
//      $segperesp->setCodapl("CI0");
//      $segperesp->setProceso("Proceso B");
//      $procesos[]= $segperesp;
//      $segperesp = new Segperesp();
//      $segperesp->setCodapl("CI0");
//      $segperesp->setProceso("Proceso C");
//      $procesos[]= $segperesp;
      $this->columnas = Herramientas::getConfigGrid('grid_procesos');
      $this->obj = $this->columnas[0]->getConfig($procesos);
      $this->segperesp->setGrid($this->obj);
...
//
//            $this->params = array();
//                    $this->segperesp = $this->getSegperespOrCreate();
//                    $this->updateSegperespFromRequest();
...
//                    $this->configGrid();
  ...
  public function executeAjax()
  {
    ...
    switch ($ajax){
      case '1':
        ...
        $nomemp= Segperesp::getNomusu($codigo);
        $output = '[["segperesp_nomemp","' . $nomemp . '",""],["","",""],["","",""]]';
        break;
      default:
        $output = '[["","",""],["","",""],["","",""]]';
    }
  ...
  public function saving($clasemodelo)
  {
        ...
        Autenticacion::SalvarProcesosEspeciales($clasemodelo, $grid);
        return -1;

...
<br><br>
<?php echo label_for('usuarios[feccad]', __($labels['usuarios{feccad}']), 'class="required" ') ?>
  <div class="content<?php if ($sf_request->hasError('usuarios{feccad}')): ?> form-error<?php endif; ?>">
  <?php if ($sf_request->hasError('usuarios{feccad}')): ?>
    <?php echo form_error('usuarios{feccad}', array('class' => 'form-error-msg')) ?>
  <?php endif; ?>

  <?php $value = object_input_date_tag($usuarios, 'getFeccad', array (
  'rich' => true,
  'calendar_button_img' => '/sf/sf_admin/images/date.png',
  'control_name' => 'usuarios[feccad]',
...
<br>
  <?php echo label_for('usuarios[esgeren]', __($labels['usuarios{esgeren}']), 'class="required" ') ?>
  <div class="content<?php if ($sf_request->hasError('usuarios{esgeren}')): ?> form-error<?php endif; ?>">
  <?php if ($sf_request->hasError('usuarios{esgeren}')): ?>
    <?php echo form_error('usuarios{esgeren}', array('class' => 'form-error-msg')) ?>
  <?php endif; ?>

  <?php if($usuarios->getEsgeren()=='S') $val = true; else $val=false; ?>
  <?php echo "Sí ".radiobutton_tag('usuarios[esgeren]', 'S', $val) ?>
  <?php echo "  No ".radiobutton_tag('usuarios[esgeren]', 'N', !$val) ?>
    </div>
    <br>
...
<div id="grupos" style="display:none">
  <?php echo label_for('usuarios[codgru]', __($labels['usuarios{codgru}']), 'class="required" ') ?>
  <div class="content<?php if ($sf_request->hasError('usuarios{codgru}')): ?> form-error<?php endif; ?>">
  <?php if ($sf_request->hasError('usuarios{codgru}')): ?>
    <?php echo form_error('usuarios{codgru}', array('class' => 'form-error-msg')) ?>
  <?php endif; ?>

   <?php $value = object_input_tag($usuarios, 'getCodgru', array (
  'size' => 10,
  'maxlength' => 3,
  'control_name' => 'usuarios[codgru]',
  'onBlur'=> remote_function(array(
        'url'      => 'usuarios/ajax',
        'condition' => "$('usuarios_codgru').value != ''",
        'complete' => 'AjaxJSON(request, json)',
          'with' => "'ajax=2&cajtexmos=usuarios_desgru&cajtexcom=usuarios_codgru&codigo='+this.value"
        ))
)); echo $value ? $value : '&nbsp;' ?>
&nbsp;&nbsp;&nbsp;
  <?php echo  button_to_popup('...',cross_app_link_to('herramientas','catalogo').'/metodo/Seggrupo_Segasigpergru/clase/Seggrupo/frame/sf_admin_edit_form/obj1/usuarios_codgru/obj2/usuarios_desgru/campo1/codgru/campo2/desgru','','','botoncat')?>
 &nbsp;&nbsp;&nbsp;
  <?php $value = object_input_tag($usuarios, 'getDesgru', array (
  'disabled' => true,
  'size' => 60,
  'control_name' => 'usuarios[desgru]',
)); echo $value ? $value : '&nbsp;' ?> </div>
</br>
</div>
</div>
...
<script language="JavaScript" type="text/javascript">
  ...
  var permiporgrupo='<?php echo $permiporgrupo ?>';
  if (permiporgrupo=='S')
  {
  	$('grupos').show();
  }

...
<?php
  if(array_key_exists($menu,$m)){
	  foreach ($m[$menu] as $val) {
	    ...
	    //<input type="button" onclick="var w=window.open('/compras'+getEnv()+'.php/generales/catalogo/clase/Caramart/frame/sf_admin_edit_form/obj1/caregart_ramart/obj2/caregart_nomram','true','menubar=no,toolbar=no,scrollbars=yes,width=490,height=490,resizable=yes,left=500,top=80');w.focus();return false;" value="..." class=""/>

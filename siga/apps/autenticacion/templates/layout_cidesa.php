  ...
  <td width="100%">
      ...
      <tr>
        <td width="100%"><table width="100%" height="0%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td  colspan="2" valign="medium" background=" /images/borrar_05.jpg" class="pie_pagina">Usuario: <?php echo $sf_user->getAttribute('usuario','Sin Autenticar') ?> (<?php if(isset($_SESSION["nomemp"])) echo $_SESSION["nomemp"] ?>)  |
                    M&oacute;dulo: <?php echo $sf_context->getModuleName() ?></td>  
                  <td colspan="2"  width="100%" valign="medium" background=" /images/borrar_05.jpg" align="right"> <br><a href="<?php if (SF_ENVIRONMENT=='dev') echo "/".sfConfig::get('app_autenticacion')."_dev.php/principal"; else echo "/".sfConfig::get('app_autenticacion').".php/principal" ?>"><img src="/images/inicio.png" width="20" height="20" /></a>&nbsp;
...
<tr>
      <td valign="top" >
        <table width="100%" border="0" cellpadding="0" cellspacing="0" >
          ...
          <tr>
            <td height="10" align="CENTER"><strong><font size='1'></font></strong></td>
          </tr>

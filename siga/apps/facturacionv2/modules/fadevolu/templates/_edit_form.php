...
<table>
    <tr>
        <th>
<div id="divtipodevo">
     <?php echo label_for('fadevolu[tipdev]', __($labels['fadevolu{tipdev}' ]), 'class="required" Style="text-align:left; width:150px"') ?>
     <div class="content<?php if ($sf_request->hasError('fadevolu{tipdev}')): ?> form-error<?php endif; ?>">
     <?php if ($sf_request->hasError('fadevolu{tipdev}')): ?>
        <?php echo form_error('fadevolu{tipdev}', array('class' => 'form-error-msg')) ?>
     <?php endif; ?>
      <?php echo radiobutton_tag('fadevolu[tipdev]', 'C', false,array('onClick'=> remote_function(array(
           'url'      => 'fadevolu/ajax',
           'complete' => 'AjaxJSON(request, json)',
           'script'   => true,
           'with'   => "'ajax=4&codigo='+this.value"
            ))))        ."Contado".'&nbsp;&nbsp;';
            echo radiobutton_tag('fadevolu[tipdev]', 'R', false,array('onClick'=> remote_function(array(
           'url'      => 'fadevolu/ajax',
           'complete' => 'AjaxJSON(request, json)',
           'script'   => true,
...
<table>
  <tr>
    <th>
		<div id="divpasuse">
                    <?php echo label_for('fadevolu[pasuse]', __($labels['fadevolu{pasuse}' ]), 'class="required" Style="text-align:left; width:150px"') ?>
            <div class="content<?php if ($sf_request->hasError('fadevolu{pasuse}')): ?> form-error<?php endif; ?>">
     <?php if ($sf_request->hasError('fadevolu{pasuse}')): ?>
        <?php echo form_error('fadevolu{pasuse}', array('class' => 'form-error-msg')) ?>
     <?php endif; ?></div>
		  <?php echo object_input_tag($fadevolu, 'getPasuse', array('name' => 'fadevolu[pasuse]', 'control_name' => 'fadevolu[pasuse]','',)) ?>
		</div>
    </th>
  </tr>
</table>
  ...
  <tr>
    <th>
		<div id="divmondev">
		  ...
		  <?php $value = object_input_tag($fadevolu, array('getMondev',true), array (
		  'size' => 20,
		  'readonly' => true,

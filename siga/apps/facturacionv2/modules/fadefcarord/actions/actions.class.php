 ...
 *
 * @package    siga
 * @subpackage fadefcarord
 * @author     $Auhor$ <desarrollo@cidesa.com.ve>
 * @version    SVN: $Id: actions.class.php 32371 2009-09-01 16:06:59Z lhernandez $
 * @copyright  Copyright 2007, Cidesa C.A.
 */

class fadefcarordActions extends autofadefcarordActions
{
  ...
  public function editing()
  {
        ...
        $mascaras = explode("-", $mascara);
        $cadena = '';
        $opciones = array();

        foreach ($mascaras as $v){
            if($cadena!=''){
                $cadena = $cadena.'-'.$v;
            }else{
                $cadena=$v;
  ...
  {
      $q = FadefcarordPeer::doSelectOne(new Criteria());

      if($q)
          $this->redirect('fadefcarord/edit?id='.$q->getId());
      else
          $this->forward('fadefcarord', 'create');
  }

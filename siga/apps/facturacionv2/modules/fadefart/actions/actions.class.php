...
/*
 ...
 /* public function handleErrorEdit()
  ...
  {
  	$lote = Facturacionv2::salvarNumlot($this->getRequestParameter('facorrelat[numlot]'));
    /*if($lote!=-1){
      $this->coderror = $lote;
      return $this->coderror;
    }*/
  	$codcat = Facturacionv2::salvarCodcat($this->getRequestParameter('facorrelat[codcat]'));
   /* if($codcat!=-1){
      $this->coderror = $codcat;
      return $this->coderror;
    }*/
    $resp= Facturacionv2::salvarCuentas($this->getRequestParameter('facorrelat[ctadev]'),$this->getRequestParameter('facorrelat[ctavco]'),$this->getRequestParameter('facorrelat[generaop]'),$this->getRequestParameter('facorrelat[generacom]'),$this->getRequestParameter('facorrelat[apliclades]'),$this->getRequestParameter('facorrelat[codmon]'));
    if($resp!=-1){
      $this->coderror = $resp;
      return $this->coderror;
    }
    ...
    $grid=Herramientas::CargarDatosGrid($this,$this->obj);
    $resp=Facturacionv2::salvarFacorrelat($fadefcaj,$grid,$this->getRequestParameter('facorrelat[proform]'));
    if($resp!=-1){
      $this->coderror = $resp;
      return $this->coderror;
    }
  ...
  public function setVars()
  {
    ...
    $c = new Criteria();
    $dato=CadefubiPeer::doSelectOne($c);
    if ($dato)
    { $this->esta1='1';}
    else { $this->esta1='0';}

    $c = new Criteria();
    $data=CacatsncPeer::doSelectOne($c);
    if ($data)
    { $this->esta2='1';}
    else { $this->esta2='0';}

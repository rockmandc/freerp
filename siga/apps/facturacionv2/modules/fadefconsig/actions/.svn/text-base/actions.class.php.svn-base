 ...
 *
 * @package    siga
 * @subpackage fadefconsig
 * @author     $Auhor$ <desarrollo@cidesa.com.ve>
 * @version    SVN: $Id: actions.class.php 32371 2009-09-01 16:06:59Z lhernandez $
 * @copyright  Copyright 2007, Cidesa C.A.
 */

class fadefconsigActions extends autofadefconsigActions
{

  // Para incluir funcionalidades al executeEdit()
  public function editing()
  {
     if (!$this->faconsignatario->getId())
    {
       $t= new Criteria();
       $t->setLimit(1);
       $t->addDescendingOrderByColumn(FaconsignatarioPeer::CODCON);
       $reg= FaconsignatarioPeer::doSelectOne($t);
       if ($reg)
       {
           $this->faconsignatario->setCodcon(str_pad(($reg->getCodcon()+1),15,'0',STR_PAD_LEFT));
       }else $this->faconsignatario->setCodcon('000000000000001');
    }

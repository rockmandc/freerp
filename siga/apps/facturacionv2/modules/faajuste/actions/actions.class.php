...
$this->Bitacora('Guardo');
    ...
    switch ($ajax){
      ...
      /*  if (($difpreaju<0 && $this->getRequestParameter('tipo')=='DEBITO') || ($difpreaju>0 && $this->getRequestParameter('tipo')=='CREDITO'))
        ...
        //{
          ...
          {
             $cantival=Facturacionv2::chequearCantPedido($this->getRequestParameter('referencia'),$this->getRequestParameter('articuloaju'),$codigo,$this->getRequestParameter('solicit'),$cantaju,$precioaju,&$cantidadaju,&$canent);
          }else if ($this->getRequestParameter('tipref')=='NE'){
             $cantival=Facturacionv2::chequearCantNota($this->getRequestParameter('referencia'),$this->getRequestParameter('articuloaju'),$codigo,$this->getRequestParameter('solicit'),$this->getRequestParameter('tipref'),$this->getRequestParameter('canentart'),$cantaju,&$cantidadaju,&$canent,&$canrealped,&$canrealdes,&$canpuedoaju);
             $cantidadaju=0;
          }else{
            $cantival=true;
            $cantidadaju=0;
          ...
          if ($cantival)
          {
           if ($cantaju>H::tofloat($this->getRequestParameter('solicit'))) //Ajuste por arriba
           {
           	 ...
           	 {
                   $rerec=Facturacionv2::ajusteRecargo($this->getRequestParameter('articuloaju'),$this->getRequestParameter('referencia'),$this->getRequestParameter('descart'));
                   if ($difpreaju==0)
  ...
  protected function saveFaajuste($faajuste)
  {
    ...
    {
  	  $grid2=Herramientas::CargarDatosGrid($this,$this->obj);
	  $this->coderror=Facturacionv2::salvarFaajuste($faajuste,$grid2);
    }
  ...
  {
    Facturacionv2::eliminarFaajuste($faajuste);
    return -1;
  }

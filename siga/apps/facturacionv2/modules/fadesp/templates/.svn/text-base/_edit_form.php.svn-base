...
<?php
  ...
  <div class="form-row" id="divusualms">
    <?php echo label_for('cadphart[codalmusu]', __('Almacenes Por Usuario: '), 'class="required" Style="text-align:left; width:150px"') ?>
    <div class="content">
    <?php
      ...
      if($codalm == '') echo label_for('cadphart[codalmusu]', __('Usuario sin Almacen Asociado'), 'class="required" Style="text-align:left; width:150px"').'<br><br><br>';
      else echo select_tag('cadphart[codalmusu]',options_for_select($almacenes,$cadphart->getCodalmusu()!='' ? $cadphart->getCodalmusu() : $codalm), ( (count($almacenes)==1 || $cadphart->getId()) ? 'disabled=true' : '').' style=width:500px');
    ?>
    </div>
  </div>
  </fieldset>
	...
	<th>
		<table>
			<tr>
				<th>
					<div id="divreqart">
					  ...
					  'onBlur'=> remote_function(array(
				        ...
				        'script' => true,
				        'with' => "'ajax=2&cajtexmos=cadphart_desreq&cajtexcom=cadphart_reqart&codigo='+this.value+'&tipref='+$(cadphart_tipref).value+'&codalm='+$(cadphart_codalmusu).value"
						  ))
			  )); echo $value ? $value : '&nbsp;' ?>
				...
				<th>
					<div id="divrefpedido">
				   <?php echo  button_to_popup('...',cross_app_link_to('herramientas','catalogo')."/metodo/Fapedido_Fanotent/clase/Fapedido/frame/sf_admin_edit_form/obj1/cadphart_reqart/campo1/nroped/param1/'+$('cadphart_codalmusu').value+'",'','','botoncat')?></th>
					</div>
				</th>
				<th>
					<div id="divreffactura">
				   <?php echo  button_to_popup('...',cross_app_link_to('herramientas','catalogo')."/metodo/Factura_Fanotent/clase/Fafactur/frame/sf_admin_edit_form/obj1/cadphart_reqart/campo1/reffac/param1/'+$('cadphart_codalmusu').value+'",'','','botoncat')?></th>
					</div>
				</th>
				<th>

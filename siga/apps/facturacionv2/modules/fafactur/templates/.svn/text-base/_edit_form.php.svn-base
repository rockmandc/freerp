...
<?php echo object_input_hidden_tag($fafactur, 'getTipoped', array('id' => 'fafactur_tipoped', 'name' => 'fafactur[tipoped]')) ?>
...
<?php echo object_input_hidden_tag($fafactur, 'getCodalmusu', array('id' => 'fafactur_codalmusu', 'name' => 'fafactur[codalmusu]')) ?>
...
<?php
  ...
  {  ?>
  <h2 class="h2" style="display:none" onclick="javascript: return $('divusualms').toggle();"><?php echo __('Almacenes') ?></h2>
  <fieldset  style="display:none" id="sf_fieldset_usualms" class="">
  <div class="form-row" id="divusualms">
    ...
    <?php
      ...
      else echo select_tag('fafactur[codalmusu]',options_for_select($almacenes,$fafactur->getCodalmusu()!='' ? $fafactur->getCodalmusu() : $codalm), ( (count($almacenes)==1 || $fafactur->getId()) ? 'disabled=true' : '').' style=width:500px');
    ?>
    </div>
  </div>
  </fieldset>
...
<br>
  <div align="center">
   <?php
 echo select_tag('fafactur[codcaj]', options_for_select(FadefcajPeer::getCajas($sf_user->getAttribute('usualms',array())), $fafactur->getCodcaj()), array (
  'style' => 'width:200px'
))
?>
...
<?php if($fafactur->getId()) : ?>
  <?php if($fafactur->getEstatus()!='') : ?>
    <div class="warning-ok">
      <h2><?php echo $fafactur->getEstatus() ?></h2>
    </div>
  <?php endif; ?>

  <?php if($fafactur->getEstatus()!='') : ?>
    <div class="warning-ok">
      <h2><?php echo $fafactur->getNotacredito() ?></h2>
    </div>
  <?php endif; ?>
<?php endif; ?>
...
<tr>
<th>
<div id="divreffac" style="width:320px">
...
<th>
<div id="divfecfac" style="width:280px">
  <?php echo label_for('fafactur[fecfac]', __($labels['fafactur{fecfac}' ]), 'class="required" Style="text-align:left; width:100px"') ?>
...
<div id="divnumcontrol">
  <?php echo label_for('fafactur[numcontrol]', __($labels['fafactur{numcontrol}' ]), 'class="required" Style="text-align:left; width:100px"') ?>
  <div style="width:280px" class="content<?php if ($sf_request->hasError('fafactur{numcontrol}')): ?> form-error<?php endif; ?>">
...
<br>
  <div style="display:<?php if($fafactur->getId() && $fafactur->getProform()=='') echo 'none'; else echo '';?>">
...
<br>
  <div id="thproform" style="display:<?php if((!$fafactur->getRefproform()) && $fafactur->getProform()=='') echo 'none'; else echo '';?>">
...
<table><tr><th>
<div id="divtipref" style="width:100px">
  <?php echo label_for('fafactur[tipref]', __($labels['fafactur{tipref}' ]), 'class="required" Style="text-align:left; width:150px"') ?>
  <div style="width:260px" class="content<?php if ($sf_request->hasError('fafactur{tipref}')): ?> form-error<?php endif; ?>">
...
<br/>
<div id="divtipcte">
  <?php echo label_for('fafactur[tipcte]', __($labels['fafactur{tipcte}' ]), 'class="required" Style="text-align:left; width:150px"') ?>
  <div class="content<?php if ($sf_request->hasError('fafactur{tipcte}')): ?> form-error<?php endif; ?>">
  <?php if ($sf_request->hasError('fafactur{tipcte}')): ?>
    <?php echo form_error('fafactur{tipcte}', array('class' => 'form-error-msg')) ?>
  <?php endif; ?>
  <?php echo select_tag('fafactur[tipcte]', options_for_select(FatipctePeer::TiposCliente(),$fafactur->getCodtipcli())) ?>
    </div>
</div>
<br/>
...
<div id="divcodprg">
    <?php echo label_for('fafactur[codprg]', __($labels['fafactur{codprg}' ]), 'class="required" Style="text-align:left; width:150px"') ?>
    <div class="content<?php if ($sf_request->hasError('fafactur{codprg}')): ?> form-error<?php endif; ?>">
    <?php if ($sf_request->hasError('fafactur{codprg}')): ?>
    <?php echo form_error('fafactur{codprg}', array('class' => 'form-error-msg')) ?>
    <?php endif; ?>
    <?php echo select_tag('fafactur[codprg]', options_for_select(FadefprgPeer::getProgramasVigentes(),$fafactur->getCodprg(),'include_custom=Seleccione uno'), array( 
            'onChange'=> "javascript:CambioCombos()"))?>
    </div>
</div>
<br/>

<div id="divconcre">
     <?php echo label_for('fafactur[concre]', __($labels['fafactur{concre}' ]), 'class="required" Style="text-align:left; width:150px"') ?>
        <div class="content<?php if ($sf_request->hasError('fafactur{concre}')): ?> form-error<?php endif; ?>">
     <?php if ($sf_request->hasError('fafactur{concre}')): ?>
        <?php echo form_error('fafactur{concre}', array('class' => 'form-error-msg')) ?>
     <?php endif; ?>

      <?php echo radiobutton_tag('fafactur[concre]', 'C', true,array('onClick'=> remote_function(array(
           'update'   => 'comboconpag',
           'url'      => 'fafactur/ajax',
           'complete' => 'AjaxJSON(request, json)',
           'script'   => true,
           'with'   => "'ajax=34&codprg='+$('fafactur_codprg').value+'&cliente='+$('fafactur_rifpro').value+'&codigo='+this.value"
            ))))        ."Contado".'&nbsp;&nbsp;';
            echo radiobutton_tag('fafactur[concre]', 'R', false,array('onClick'=> remote_function(array(
           'update'   => 'comboconpag',
           'url'      => 'fafactur/ajax',
           'complete' => 'AjaxJSON(request, json)',
           'script'   => true,
    ...
    <tr>
        <th>
            ...
            <?php endif; ?>
                ...
                <div id="comboconpag">
                    <?php echo select_tag('fafactur[codconpag]', options_for_select(FaconpagPeer::TipPagos(),$fafactur->getCodconpag(),array(
                        'onChange'=> remote_function(array(
                        'update'   => 'comboconpag',
                        'url'      => 'fafactur/ajax',
                        'complete' => 'AjaxJSON(request, json)',
                        'script'   => true,
                        'with'   => "'ajax=35&codprg'=+$('fafactur_codprg').value+'&cliente='+$('fafactur_rifpro').value+'&codconpag='+$('fafactur_codconpag').value"
                    ))))) ?>
                </div>
            </div>
            </div>
...
<br>
  ...
  <div  class="form-row"> 
  <?php echo label_for('fafactur[fecfac]', __('Fecha Desde'), 'class="required" Style="text-align:left; width:150px"') ?>
...
?>   
    <br>
  <?php echo label_for('fafactur[fecfac]', __('Fecha Hasta'), 'class="required" Style="text-align:left; width:150px"') ?>
    <?php  $value = object_input_date_tag($fafactur, 'getFecfac', array (
	'rich' => true,
	'calendar_button_img' => '/sf/sf_admin/images/date.png',
	'control_name' => 'fafactur[fechas]',
	'date_format' => 'dd/MM/yyyy',
	'size' => 10,
	'maxlength' => 10,
	'onkeyup' => "javascript: mascara(this,'/',patron,true)",
...
if (gridfaclib=='S' && consul!="")
{
 ...
 function perderfocus(e,id,totcol)
 {
  ...
  function CambioCombos(){
    var idart01="ax_0_2";
    if($(idart01).value !=''){
       alert("Si cambia el cliente, el programa o la condición de pago, podrían surgir cambios en la lista de artículos a facturar");

...
$this->Bitacora('Guardo');
  ...
  protected function saveFaartpvp($faartpvp)
	{
		$grid=Herramientas::CargarDatosGrid($this,$this->obj);
		Facturacionv2::salvarFaactpre($faartpvp,$grid,$this->getRequestParameter('faartpvp[tipo]'),$this->getRequestParameter('faartpvp[precio]'),$this->getRequestParameter('faartpvp[monaum]'));
		return -1;
	}

  ...
  public function validateEdit()
    ...
    $resp4=-1;
     ...
     $this->facliente = $this->getFaclienteOrCreate();
       ...
       $corcodpro=H::getConfApp2('corcodpro','facturacion', 'facliente');
       $codpro = $facliente['codpro'];
       if($codpro=='########' && $corcodpro==false){
          $this->coderror = 1175;
          return false;
       }         
...
$this->Bitacora('Guardo');
  ...
  {
    Clientev2::salvarFacliente($facliente);
  }
  ...
  public function executeDelete()
  {
	...
	if((!$fafactur)&&(!$fapedido)&&(!$fapresup)){
      try
      {
        ...
        Clientev2::eliminarFacliente($this->facliente);

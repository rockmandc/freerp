...
<tr>
 <th>
  ...
  'onBlur'  => "javascript: mask_numeral(this);",
)); echo $value ? $value : '&nbsp;' ?>
    </div>
 </th>
 <th>
...
<table>
 <tr>
 <th>
    <div class="span4 well" style="width:120px">
      <H2>Nacionalidad</H2>
 ...
 <th>
    <div class="span4 well" style="width:180px">
 ...
 <th>
    ...
    <?  if ($facliente->getTipper()=='N'){
        ...
        echo radiobutton_tag('facliente[tipper]','G', false) .'&nbsp;&nbsp;'. "Gubernamental"."<br>";
        ...
        echo radiobutton_tag('facliente[tipper]','G', false) .'&nbsp;&nbsp;'. "Gubernamental"."<br>";
      }elseif ($facliente->getTipper()=='G'){
        echo radiobutton_tag('facliente[tipper]','J', false) .'&nbsp;&nbsp;'. "Jurídica"."<br>";
        echo radiobutton_tag('facliente[tipper]','N', false) .'&nbsp;&nbsp;'. "Natural"."<br>";
        echo radiobutton_tag('facliente[tipper]','G', true) .'&nbsp;&nbsp;'. "Gubernamental"."<br>";
      }else{
        echo radiobutton_tag('facliente[tipper]','J', true) .'&nbsp;&nbsp;'. "Jurídica"."<br>";
        echo radiobutton_tag('facliente[tipper]','N', false) .'&nbsp;&nbsp;'. "Natural"."<br>";
        echo radiobutton_tag('facliente[tipper]','G', false) .'&nbsp;&nbsp;'. "Gubernamental"."<br>";
...
<?php endif; ?> <?php $value = object_input_tag($facliente, 'getTelpro', array (
 ...
 <th>
 <?php echo label_for('facliente[faxpro]', __($labels['facliente{faxpro}']), 'class="required" style="width:40px"') ?>
...
<div class="span4 well" style="width:580px">
<h2><?php echo __('Datos Persona Contacto')?></h2>
...
<br>
<div class="span4 well" style="width:580px">
<h2><?php echo __('Datos Representante Legal')?></h2>

...
class fanotcreActions extends autofanotcreActions
{
  ...
  public function executeAjax()
  {
    ...
    switch ($ajax){
      case '1':
        ...
        if (!$per) {
           $js = "$('fanotcre_reffac').value='';
                  $('fanotcre_nompro').value='';
                  alert('La Factura no está registrada');
                  $('fanotcre_reffac').focus();";
        } else {
           $dato = $per->getNompro();
        }
        $output = '[["fanotcre_nompro","'.$dato.'",""],["javascript","'.$js.'",""],["","",""]]';
        break;
      default:
        $output = '[["","",""],["","",""],["","",""]]';
    }

...
class fadefcajActions extends autofadefcajActions
{
    ...
    switch ($ajax){
      case '1':
        ...
        if($nombre)
            ...
            $js= "alert('El código del almacén no existe'); $('Cadefalm_Almtraspaso').value=''; $('Cadefalm_Almtraspaso').focus();";
  ...
  public function saving($clasemodelo)
  {
    ...
    $salvar = parent::saving($clasemodelo);
    Facturav2::salvarCorrelativoFactura($clasemodelo,'caj'.$clasemodelo->getId().$clasemodelo->getCodalm()); 
    return $salvar;
  }

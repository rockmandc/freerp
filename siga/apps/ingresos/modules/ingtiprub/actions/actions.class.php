 ...
 */
class ingtiprubActions extends autoingtiprubActions
{
      ...
      case '1':
        ...
        if ($reg)
        {
          ...
          $reg2=CiasiiniPeer::doSelect($cc);
            if (!$reg2)
               $javascript="alert('Código presupuestario no tiene asignacion inicial'); $('citiprub_codpre').value=''; $('citiprub_codpre').focus();";
            else
              $dato=$reg->getNompre();
        }
        else
          $javascript="alert('Código presupuestario no existe'); $('citiprub_codpre').value=''; $('citiprub_codpre').focus();";

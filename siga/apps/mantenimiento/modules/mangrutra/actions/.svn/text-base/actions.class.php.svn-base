 ...
 *
 * @package    siga
 * @subpackage mangrutra
 * @author     $Auhor$ <desarrollo@cidesa.com.ve>
 * @version    SVN: $Id: actions.class.php 32371 2009-09-01 16:06:59Z lhernandez $
 * @copyright  Copyright 2007, Cidesa C.A.
 */

class mangrutraActions extends automangrutraActions
{
        ...
        if (strlen($codigo)==$lonniv)
        {
          ...
          if ($reg)
          {
             $dato=$reg->getDesniv();           
              ...
              $js="alert_('La La Ubicaci&oacute;n Administrativa no existe'); $('mangrutra_codniv').value=''; $('mangrutra_desniv').value=''; $('mangrutra_codniv').focus();"; 
          }
        }else {
          $js="alert_('La Ubicaci&oacute;n Administrativa no es de &Uacute;ltimo Nivel'); $('mangrutra_codniv').value=''; $('mangrutra_desniv').value=''; $('mangrutra_codniv').focus();"; 
        }

...
function ajaxmostrardetalle(e,id)
{
 ...
 {
   window.open('/compras'+getEnv()+'.php/almdetsol/edit/?formulario='+formulario,formulario,'menubar=no,toolbar=no,scrollbars=yes,width=1200,height=800,resizable=yes,left=1000,top=80');
 }

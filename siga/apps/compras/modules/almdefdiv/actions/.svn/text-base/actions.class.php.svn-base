 ...
 *
 * @package    siga
 * @subpackage almdefdiv
 * @author     $Auhor$ <desarrollo@cidesa.com.ve>
 * @version    SVN: $Id: actions.class.php 32371 2009-09-01 16:06:59Z lhernandez $
 * @copyright  Copyright 2007, Cidesa C.A.
 */

class almdefdivActions extends autoalmdefdivActions
{
  ...
  public function executeAjax()
  {
    ...
    switch ($ajax){
      case '1':
        $t= new Criteria();
        $t->add(CadefdirecPeer::CODDIREC,$codigo);
        $resp= CadefdirecPeer::doSelectOne($t);
        if ($resp)
          $dato=$resp->getDesdirec();
        else
          $js="alert_('El C&oacute;digo de la Direcci&oacte;n no esta registrado'); $('cadefdivi_coddirec').value=''; $('cadefdivi_coddirec').focus();";

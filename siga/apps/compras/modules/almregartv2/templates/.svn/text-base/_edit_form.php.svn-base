...
<?php echo form_tag('almregartv2/edit', array(
  'id'        => 'sf_admin_edit_form',
  'name'      => 'sf_admin_edit_form', 'onsubmit'  => 'return false;',
  'multipart' => true,
)) ?>
<?php use_helper('tabs') ?>
<?php echo javascript_include_tag('dFilter', 'ajax', 'compras/almregartv2', 'tools','observe', 'Javascript', 'Grid', 'I18N') ?>
...
<?php $value = object_input_tag($caregart, 'getCodart', array (
  ...
  {
       echo radiobutton_tag('caregart[tipo]', 'A', $valor1, array('id'=>'caregart_tipo_A', 'tabindex' => 101))        ."Artículo".'&nbsp;&nbsp;';
       echo "<br>".radiobutton_tag('caregart[tipo]', 'S', !$valor1, array('id'=>'caregart_tipo_S', 'tabindex' => 101))."   Servicio";
  }
...
<th>
<?php echo  button_to_popup('...',cross_app_link_to('herramientas','catalogo').'/metodo/Contabb_Almregart/clase/Contabb/frame/sf_admin_edit_form/obj1/caregart_codcta','','','botoncat')?>
</th>
<th>
    &nbsp;&nbsp;
</th>
<th>
<div id="clasifica">
<?php echo label_for('caregart[claart]', __($labels['caregart{claart}']), 'class="required" ') ?>
  <div class="content<?php if ($sf_request->hasError('caregart{claart}')): ?> form-error<?php endif; ?>">
  <?php if ($sf_request->hasError('caregart{claart}')): ?>
    <?php echo form_error('caregart{claart}', array('class' => 'form-error-msg')) ?>
  <?php endif; ?>
   <?php if ($caregart->getClaart()=='C')  {?>
  <?php echo radiobutton_tag('caregart[claart]', 'R', false)        ."Regional".'&nbsp;&nbsp;';
      echo radiobutton_tag('caregart[claart]', 'C', true)."   Central";?>
<?php }else{
  echo radiobutton_tag('caregart[claart]', 'R', true)        ."Regional".'&nbsp;&nbsp;';
  echo radiobutton_tag('caregart[claart]', 'C', false)."   Central";
} ?>
<div>
   </th>
 </tr>
...
<br>    
  ...
  <?php echo label_for('caregart[codbar]', __($labels['caregart{codbar}']), 'class="required" ') ?>
  <div class="content<?php if ($sf_request->hasError('caregart{codbar}')): ?> form-error<?php endif; ?>">
  <?php if ($sf_request->hasError('caregart{codbar}')): ?>
    <?php echo form_error('caregart{codbar}', array('class' => 'form-error-msg')) ?>
  <?php endif; ?>

  <?php $value = object_input_tag($caregart, 'getCodbar', array (
  'size' => 30,
  'maxlength' => 32,
  'control_name' => 'caregart[codbar]',
)); echo $value ? $value : '&nbsp;' ?>
   </div>    
...
<?php echo input_auto_complete_tag('caregart[ramart]', $caregart->getRamart(),
    'almregartv2/autocomplete?ajax=1',  array('autocomplete' => 'off','maxlength' => 6, 'tabindex' => 104, 'onBlur'=> remote_function(array(
        'url'      => 'almregartv2/ajax',
        'complete' => 'AjaxJSON(request, json)',
...
<br>
  ...
  'tabindex' => 106,
    ...
    <th>&nbsp;&nbsp;</th>
    <th>
       <?php echo label_for('caregart[tippro]', __($labels['caregart{tippro}']), 'class="required" ') ?>
      <div class="content<?php if ($sf_request->hasError('caregart{tippro}')): ?> form-error<?php endif; ?>">
      <?php if ($sf_request->hasError('caregart{tippro}')): ?>
        <?php echo form_error('caregart{tippro}', array('class' => 'form-error-msg')) ?>
      <?php endif; ?>
      
       <?php echo select_tag('caregart[tippro]', options_for_select(array('M' => 'Materia Prima', 'T' => 'Producto terminado'),$caregart->getTippro(),'include_custom=Seleccione'),array()) ?>
      </div>
   </th>
   <th>&nbsp;&nbsp;</th>
    <th>
   <? if ($caregart->getNacimp()=='I')  {
  ?><?php echo radiobutton_tag('caregart[nacimp]', 'N', false)        ."Nacional".'&nbsp;&nbsp;';
      echo radiobutton_tag('caregart[nacimp]', 'I', true)."   Importado";?>
    <?
}else{
  echo radiobutton_tag('caregart[nacimp]', 'N', true)        ."Nacional".'&nbsp;&nbsp;';
  echo radiobutton_tag('caregart[nacimp]', 'I', false)."   Importado";
} ?>
   </th>
   </tr>   
  </table>
...
<br>
  ...
  <?php echo label_for('caregart[codunimed]', __($labels['caregart{codunimed}']), 'class="required" ') ?>
  <div class="content<?php if ($sf_request->hasError('caregart{codunimed}')): ?> form-error<?php endif; ?>">
  <?php if ($sf_request->hasError('caregart{codunimed}')): ?>
    <?php echo form_error('caregart{codunimed}', array('class' => 'form-error-msg')) ?>
  <?php endif; ?>

  <?php  $value = object_input_tag($caregart, 'getCodunimed', array (
  'size' => 15,
  'control_name' => 'caregart[codunimed]',
  'maxlength' => 6,
  'onBlur'=> remote_function(array(
        'url'      => 'almregartv2/ajax',
        'complete' => 'AjaxJSON(request, json)',
        'condition' => "$('caregart_codunimed').value != ''",
        'script' => true,
          'with' => "'ajax=12&cajtexmos=caregart_desunimed&codigo='+this.value"
        ))
)); echo $value ? $value : '&nbsp;' ?>
&nbsp;&nbsp;
<?php echo button_to_popup('...',cross_app_link_to('herramientas','catalogo').'/metodo/Cadefunimed_Almregart/clase/Cadefunimed/frame/sf_admin_edit_form/obj1/caregart_codunimed/obj2/caregart_desunimed/campo1/codunimed/campo2/desunimed','','','botoncat')?>
&nbsp;&nbsp;
<?php $value = object_input_tag($caregart, 'getDesunimed', array (
 'size' => 60,
 'disabled' => true,
  'control_name' => 'caregart[desunimed]',
)); echo $value ? $value : '&nbsp;' ?>
    </div>
 <table>
   <tr>
...
<br>
<fieldset id="sf_fieldset_none" class="">
<legend><?php echo __('Cargar Almacenes en Lote')?></legend>
<div class="form-row">
<?php $mascaraubi= Herramientas::ObtenerFormato('Cadefart','Forubi');?>
<?php echo label_for('caregart[codubi]', __($labels['caregart{codubi}']), 'class="required"') ?>
  <div class="content<?php if ($sf_request->hasError('caregart{codubi}')): ?> form-error<?php endif; ?>">
  <?php if ($sf_request->hasError('caregart{codubi}')): ?>
    <?php echo form_error('caregart{codubi}', array('class' => 'form-error-msg')) ?>
  <?php endif; ?>
  <?php $value = object_input_tag($caregart, 'getCodubi', array (
  'size' => 10,
  'maxlength' => strlen($mascaraubi),
  'control_name' => 'caregart[codubi]',
  'onKeyPress' => "javascript:return dFilter (event.keyCode, this,'$mascaraubi')",
  'onBlur'=> remote_function(array(
       'url'      => 'almregartv2/ajax',
       'script'   => true,
       'condition' => "$('caregart_codubi').value != ''",
       'complete' => 'AjaxJSON(request, json)',
       'with' => "'ajax=10&cajtexmos=caregart_nomubi&codigo='+this.value"
        ))
  )); echo $value ? $value : '&nbsp;' ?>
 &nbsp;
<?php echo  button_to_popup('...',cross_app_link_to('herramientas','catalogo')."/metodo/Cadefubi_Almregart/clase/Cadefubi/frame/sf_admin_edit_form/obj1/caregart_codubi/obj2/caregart_nomubi/campo1/codubi/campo2/nomubi",'','','botoncat')?>

  <?php $value = object_input_tag($caregart, 'getNomubi', array (
  'disabled' => true,
   'size' => 60,
  'control_name' => 'caregart[nomubi]',
)); echo $value ? $value : '&nbsp;' ?>
</div>    
...
<li>
<input id="cagalm" class="sf_admin_action_save" type="button" value="Cargar Almacenes" onClick="cargaalmacen();">
</li>
<li>
<input id="asiubi" class="sf_admin_action_save" type="button" value="Asignar Ubicación" onClick="asigubica();">
</li>
</ul>
</div>    
</fieldset>
...
<div id="divGrid" style="display:none">
  <?php echo grid_tag_v2($objAlmUbi); ?>
</div>
...
<?php include_partial('edit_actions', array('caregart' => $caregart)) ?>
  ...
  <ul class="sf_admin_actions">
    <li class="float-rigth"><?php if ($caregart->getId()): ?> <?php echo button_to(__('delete'), 'almregartv2/delete?id='.$caregart->getId(), array (
  'post' => true,

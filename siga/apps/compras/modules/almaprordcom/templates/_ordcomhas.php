...
<?php echo button_to_popup('...',cross_app_link_to('herramientas','catalogo')."/metodo/CaOrdCom_Almaprordcom/clase/Caordcom/frame/sf_admin_edit_form/obj1/caordcom_ordcomhas/campo1/ordcom",'','','botoncat')?>
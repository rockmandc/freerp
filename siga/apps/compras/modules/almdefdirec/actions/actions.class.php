 ...
 *
 * @package    siga
 * @subpackage almdefdirec
 * @author     $Auhor$ <desarrollo@cidesa.com.ve>
 * @version    SVN: $Id: actions.class.php 32371 2009-09-01 16:06:59Z lhernandez $
 * @copyright  Copyright 2007, Cidesa C.A.
 */

class almdefdirecActions extends autoalmdefdirecActions
{
        ...
        if ($resp) {
          ...
          if ($categoriasusu!='')
          {
            ...
            if ($regs2) {
              ...
              $js = "alert_('La Categoria Presupuestaria no esta asociada a este Usuario'); $('cadefdirec_codcat').value=''; $('cadefdirec_codcat').focus();";             
            }
          }          
        }else
          $js="alert_('El C&oacute;digo de la Categoria no esta registrado'); $('cadefdirec_codcat').value=''; $('cadefdirec_codcat').focus();";
  ...
  {
    $encontro=H::getX_vacio('CODDIREC','Cadefdivi','Coddirec',$clasemodelo->getCoddirec());
    if ($encontro=='')

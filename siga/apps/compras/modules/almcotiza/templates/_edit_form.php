...
<table>
 <tr>
  ...
  <?php endif; ?>
  <?php if ($cacotiza->getTipmon()=='')  $var=H::getX_vacio('CODEMP', 'Opdefemp', 'Codmon', '001'); else $var=$cacotiza->getTipmon();?>
  ...
  'onChange' => remote_function(array(
   ...
   'with' => "'ajax=6&cajtexmos=cacotiza_valmon&nuevo='+$('id').value+'&valmone='+$('cacotiza_valmon').value+'&variable=$var&codigo='+this.value"
      ))      
  )); ?></div> <div> 
    </div><?php echo input_hidden_tag('posneg', $aumdis) ?>
  </th>
  <th>&nbsp;&nbsp;&nbsp;&nbsp;</th>
  <th> <?php echo label_for('cacotiza[valmon]', __($labels['cacotiza{valmon}']), 'class="required" ') ?>
  <div class="content<?php if ($sf_request->hasError('cacotiza{valmon}')): ?> form-error<?php endif; ?>">
  <?php if ($sf_request->hasError('cacotiza{valmon}')): ?>
    <?php echo form_error('cacotiza{valmon}', array('class' => 'form-error-msg')) ?>
  <?php endif; ?>
  
  <?php $value = object_input_tag($cacotiza, array('getValmon',true), array (
  'size' => 7,
...
<br>
 ...
 <th>
  ...
  <?php $value = object_input_tag($cacotiza, 'getRefsol', array (
  'maxlength' => 8,
  'size' => 8,
  'readonly'  =>  $cacotiza->getId()!='' ? true : false ,
  'control_name' => 'cacotiza[refsol]',  
...
<?php $mascararif2=H::getX_vacio('CODEMP', 'Cadefart', 'forpro', '001'); ?>
  ...
  <?php $value = object_input_tag($cacotiza, 'getRifpro', array (
  'maxlength' => $mascararif2=='' ? 15 : strlen($mascararif2),
  'size' => 15,
  'readonly'  =>  $cacotiza->getId()!='' ? true : false ,
  'control_name' => 'cacotiza[rifpro]',
  'onKeyDown' => " if ($('id').value=='' && '$mascararif2'!='') {javascript: cadena=this.value;cadena=cadena.toUpperCase();document.getElementById('cacotiza_rifpro').value=cadena; dFilter (event.keyCode, this,'$mascararif2')}",
  'onBlur'=> remote_function(array(
      'url'      => 'almcotiza/ajax',
      'before' => "cadena=rayitas(this.value);document.getElementById('cacotiza_rifpro').value=cadena;",
      'complete' => 'AjaxJSON(request, json)',
      'condition' => "$('cacotiza_rifpro').value != '' && $('id').value == ''",
      'script'   => true,
      'with' => "'ajax=1&cajtexmos=cacotiza_nompro&cajtexcom=cacotiza_rifpro&fecha='+$('cacotiza_feccot').value+'&refsol='+$('cacotiza_refsol').value+'&codigo='+this.value"
      ))
)); echo $value ? $value : '&nbsp;' ?>      

<?php echo  button_to_popup('...',cross_app_link_to('herramientas','catalogo')."/metodo/Cotizaciones/clase/Caprovee/frame/sf_admin_edit_form/obj1/cacotiza_rifpro/obj2/cacotiza_nompro/campo1/rifpro/campo2/nompro/param1/'+$('cacotiza_refsol').value+'",'','','botoncat');?>
...
<div>
  ...
  <tr>
    ...
    <?php echo label_for('cacotiza[moncot]', __($labels['cacotiza{moncot}']), 'class="required" Style="width:150px"') ?>
...
<br>
<tr>
<?php echo label_for('cacotiza[monrec]', __($labels['cacotiza{monrec}']), 'class="required" Style="width:150px"') ?>
...
<br>
<tr>
  <?php echo label_for('cacotiza[canite]', __($labels['cacotiza{canite}']), 'class="required" Style="width:150px"') ?>
  <div class="content<?php if ($sf_request->hasError('cacotiza{canite}')): ?> form-error<?php endif; ?>">
  <?php if ($sf_request->hasError('cacotiza{canite}')): ?>
    <?php echo form_error('cacotiza{canite}', array('class' => 'form-error-msg')) ?>
  <?php endif; ?>

 <?php $value = object_input_tag($cacotiza, 'getCanite', array (
  'size' => 20,
  'readonly'=> true,
  'control_name' => 'cacotiza[canite]',
)); echo $value ? $value : '&nbsp;' ?>
    </div>
</tr>
</table>
...
<div class="form-row">
 ...
 <?php $value = object_input_tag($cacotiza, 'getConpag', array (
  'maxlength' => 4,
  'size' => 4,  
  'control_name' => 'cacotiza[conpag]',  
  'onBlur'=> remote_function(array(
      'url'      => 'almcotiza/ajax',
      'complete' => 'AjaxJSON(request, json)',
...
<?php $value = object_input_tag($cacotiza, 'getForent', array (
  'maxlength' => 4,
  'size' => 4,  
  'control_name' => 'cacotiza[forent]',  
  'onBlur'=> remote_function(array(
      'url'      => 'almcotiza/ajax',
      'complete' => 'AjaxJSON(request, json)',
...
<?php echo label_for('cacotiza[numproc]', __($labels['cacotiza{numproc}']), 'class="required"') ?>
<div class="content<?php if ($sf_request->hasError('cacotiza{numproc}')): ?> form-error<?php endif; ?>">
<?php if ($sf_request->hasError('cacotiza{numproc}')): ?> <?php echo form_error('cacotiza{numproc}', array('class' => 'form-error-msg')) ?>
<?php endif; ?>

<?php $value = object_input_tag($cacotiza, 'getNumproc', array (
'size' => 20,
'maxlength'  =>  30,
'control_name' => 'cacotiza[numproc]',
)); echo $value ? $value : '&nbsp;' ?>
</div>
</div>
	...
	var manesolcorr='<?php echo $mansolocor; ?>';
     ...
     var valor='<?php echo H::getX_vacio('CODMON','Tsdesmon','Valmon',H::getX_vacio('CODEMP', 'Opdefemp', 'Codmon', '001'));?>';
      if (valor!="")
      {
         ...
         var num2=toFloat('cacotiza_valmon');
         if (num2==0)
          $('cacotiza_valmon').value=format(calculo.toFixed(6),'.',',','.');
      }
}
         ...
         if (validarnumero(id))
        {
           ...
           var cal=numero*numero2;
            if (numero<=cal || document.sf_admin_edit_form.cacotiza_tipo_T.checked)
            {
	         ...
	         $(total).value=format(producto.toFixed(6),'.',',','.');
...
$('cacotiza_moncot').value=format(numdos.toFixed(2),'.',',','.');
 }
 }

...
function validar(e,id)
{
  ...
  if (e.keyCode==13 || e.keyCode==9)
  {
   if ($(id).value!="")
   {
    new Ajax.Request('/compras'+getEnv()+'.php/almsolegr/ajax', {asynchronous:true, evalScripts:false, onComplete:function(request, json){AjaxJSON(request, json)}, parameters:'ajax=8&fecemi='+fecemi+'&codigo='+fecac})
    }
  }
}
</script>

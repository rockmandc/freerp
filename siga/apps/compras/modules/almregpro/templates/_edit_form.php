 ...
 * @version    SVN: $Id: _edit_form.php 61952 2015-05-08 13:28:51Z dmartinez $
 */
...
<?php use_helper('PopUp', 'tabs', 'DoubleList', 'Javascript', 'Linktogob') ?>
...
<tr>
 ...
 <?php if($caprovee->getId()!='') : ?>
 <th>
 <?php echo link_to_seniat($caprovee->getRifpro()) ?>
 </th>
 <?php endif; ?>
 <th>
 <?php echo link_to_snc($caprovee->getRifpro()) ?>
 </th>
</tr>
</table>
</div>
...
<?php }else if ($caprovee->getNitpro()=='N'){?>
  ...
  echo radiobutton_tag('caprovee[nitpro]', 'G', false, array('onClick' => 'colocaletra(this.value);', 'readonly'  =>  $caprovee->getId()!='' ? true : false))." Gubernamental".'<br>';
  echo radiobutton_tag('caprovee[nitpro]', 'C', false, array('onClick' => 'colocaletra(this.value);', 'readonly'  =>  $caprovee->getId()!='' ? true : false))." Cooperativa".'<br>';?>
<?php }else if ($caprovee->getNitpro()=='G'){?>
  <?php echo radiobutton_tag('caprovee[nitpro]', 'J', false, array('onClick' => 'colocaletra(this.value);', 'readonly'  =>  $caprovee->getId()!='' ? true : false))." Jurídica".'<br>';
  echo radiobutton_tag('caprovee[nitpro]', 'N', false, array('onClick' => 'colocaletra(this.value);', 'readonly'  =>  $caprovee->getId()!='' ? true : false))." Natural".'<br>';
  ...
  echo radiobutton_tag('caprovee[nitpro]', 'C', false, array('onClick' => 'colocaletra(this.value);', 'readonly'  =>  $caprovee->getId()!='' ? true : false))." Cooperativa".'<br>';?>
<?php }else if ($caprovee->getNitpro()=='C'){?>
  <?php echo radiobutton_tag('caprovee[nitpro]', 'J', false, array('onClick' => 'colocaletra(this.value);', 'readonly'  =>  $caprovee->getId()!='' ? true : false))." Jurídica".'<br>';
  echo radiobutton_tag('caprovee[nitpro]', 'N', false, array('onClick' => 'colocaletra(this.value);', 'readonly'  =>  $caprovee->getId()!='' ? true : false))." Natural".'<br>';
  echo radiobutton_tag('caprovee[nitpro]', 'G', false, array('onClick' => 'colocaletra(this.value);', 'readonly'  =>  $caprovee->getId()!='' ? true : false))." Gubernamental".'<br>';
...
<?php $mascararif2=H::getX_vacio('CODEMP', 'Cadefart', 'forpro', '001'); 
$longrif=H::getConfApp2('longrif', 'compras', 'almregpro');
$long=15;
if ($longrif!='')
  $long=$longrif;
?>
   ...
   <?php $value = object_input_tag($caprovee, 'getRifpro', array (
    'size' => 15,
    'maxlength' => $mascararif2=='' ? $long : strlen($mascararif2),
    'readonly'  =>  $caprovee->getId()!='' ? true : false ,
    'control_name' => 'caprovee[rifpro]',
    'onKeyDown' => " if ($('id').value=='' && '$mascararif2'!='') {javascript: cadena=this.value;cadena=cadena.toUpperCase();document.getElementById('caprovee_rifpro').value=cadena;  dFilter (event.keyCode, this,'$mascararif2')}",
    'onBlur' => "javascript:cadena=rayitas(this.value);document.getElementById('caprovee_rifpro').value=cadena; validarFormatoRIF(this.value);",
  )); echo $value ? $value : '&nbsp;' ?>
    </div>
  </th>
 </tr>
...
<?php }?>
   ...
   <th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
 <th><div id="clapdval" style="display:none">
   <fieldset id="sf_fieldset_none" class="">
    <legend><h2><?php echo  __('Clasificación :') ?></h2></legend>
    <div class="form-row"  align="left">
    <?php  if ($caprovee->getClapro()=='M'){
      echo radiobutton_tag('caprovee[clapro]','M', true) .'&nbsp;&nbsp;'. "MINPAL"."<br>";
      echo radiobutton_tag('caprovee[clapro]','E', false) .'&nbsp;&nbsp;'. "ESTADO"."<br>";
      echo radiobutton_tag('caprovee[clapro]','P', false) .'&nbsp;&nbsp;'. "PRIVADA"."<br>";

    }elseif ($caprovee->getClapro()=='E'){
      echo radiobutton_tag('caprovee[clapro]','M', false) .'&nbsp;&nbsp;'. "MINPAL"."<br>";
      echo radiobutton_tag('caprovee[clapro]','E', true) .'&nbsp;&nbsp;'. "ESTADO"."<br>";
      echo radiobutton_tag('caprovee[clapro]','P', false) .'&nbsp;&nbsp;'. "PRIVADA"."<br>";
    }elseif ($caprovee->getClapro()=='P'){
      echo radiobutton_tag('caprovee[clapro]','M', false) .'&nbsp;&nbsp;'. "MINPAL"."<br>";
      echo radiobutton_tag('caprovee[clapro]','E', false) .'&nbsp;&nbsp;'. "ESTADO"."<br>";
      echo radiobutton_tag('caprovee[clapro]','P', true) .'&nbsp;&nbsp;'. "PRIVADA"."<br>";
...
<br>
  ...
  <?php echo label_for('caprovee[codniv]', __($labels['caprovee{codniv}']), 'class="required"') ?>
  <div class="content<?php if ($sf_request->hasError('caprovee{codniv}')): ?> form-error<?php endif; ?>">
  <?php if ($sf_request->hasError('caprovee{codniv}')): ?>
    <?php echo form_error('caprovee{codniv}', array('class' => 'form-error-msg')) ?>
  <?php endif; ?>

  <?php $value = get_partial('codniv', array('type' => 'edit', 'caprovee' => $caprovee)); echo $value ? $value : '&nbsp;' ?>
    </div>
    <br>
</fieldset>
...
<br>
  ...
  <?php echo label_for('caprovee[estapo]', __($labels['caprovee{estapo}']), 'class="required" ') ?>
  <div class="content<?php if ($sf_request->hasError('caprovee{estapo}')): ?> form-error<?php endif; ?>">
  <?php if ($sf_request->hasError('caprovee{estapo}')): ?>
    <?php echo form_error('caprovee{estapo}', array('class' => 'form-error-msg')) ?>
  <?php endif; ?>

<?php
	echo
	select_tag('caprovee[estapo]]', options_for_select(
	Constantes::ListaEstCapApor(),
	$caprovee->getEstapo())
	);
?>
...
<?php echo label_for('caprovee[fecact]', __($labels['caprovee{fecact}']), 'class="required"') ?>
  <div class="content<?php if ($sf_request->hasError('caprovee{fecact}')): ?> form-error<?php endif; ?>">
  <?php if ($sf_request->hasError('caprovee{fecact}')): ?>
    <?php echo form_error('caprovee{fecact}', array('class' => 'form-error-msg')) ?>
  <?php endif; ?>

  <?php $value = object_input_date_tag($caprovee, 'getFecact', array (
  'rich' => true,
  'calendar_button_img' => '/sf/sf_admin/images/date.png',
  'control_name' => 'caprovee[fecact]',
)); echo $value ? $value : '&nbsp;' ?>
    </div>
...
<script language="JavaScript" type="text/javascript" >
  ...
  var manclapro='<?php echo H::getConfApp2('manclapro', 'compras', 'almregpro'); ?>';
  if (manclapro=='S')
    $('clapdval').show();
...
function validarFormatoRIF(id)
{
  if (id!="")
  {
    var mascara='<?php echo $mascararif2=H::getX_vacio('CODEMP', 'Cadefart', 'forpro', '001'); ?>';
    if (mascara!="") {
    var letra='ABCDEFGHIJKLMNOPQRSTUVWXYZ';
    var numero='1234567890';
    var val=id.split("-");
    var rup=parseInt(val.length);
    var descrip='<?php echo H::getX_vacio('CODEMP', 'Cadefart', 'Despro', '001'); ?>';
    ...
    if (id.length==descrip.length)
    {
       if (rup==rup2)
       {
        ...
        while (j<rup2)
        {
           ...
           {               
               ...
               if (pos!=-1)
               {
                   ...
                   if (pos2==-1)
                   {
                       alert_('El Rif no cumple con el Formato Definido, existe un caracter que debe ser una Letra');
                        $('caprovee_rifpro').value='';
                        $('caprovee_rifpro').focus();
                   }
                   ...
                   if (pos!=-1)
                   {
                       ...
                       if (pos2==-1)
                       {
                           alert_('El Rif no cumple con el Formato Definido, existe un caracter que debe ser un N&uacute;mero');
                            $('caprovee_rifpro').value='';
                            $('caprovee_rifpro').focus();
                       }
                   }
        ...
        alert_('El Rif no cumple con el Formato Definido');
        $('caprovee_rifpro').value='';
        $('caprovee_rifpro').focus();
    }
    }else {

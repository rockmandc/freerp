...
&nbsp;
<?php echo  button_to_popup('...',cross_app_link_to('herramientas','catalogo').'/metodo/Careqart_Almdes/clase/Careqart/frame/sf_admin_edit_form/obj1/cadphart_reqart/obj2/cadphart_desreq','','','botoncat')?>
&nbsp;&nbsp;
...
if ($catubibnu=='S') {?>
<?php echo  button_to_popup('...',cross_app_link_to('herramientas','catalogo')."/metodo/Bnubica_Pagemiord/clase/Bnubica/frame/sf_admin_edit_form/obj1/cadphart_codori/obj2/cadphart_nomcat/campo1/codubi/campo2/desubi/param1/".$lonubi,'','','botoncat')?>
<?php }else {?>
<?php echo  button_to_popup('...',cross_app_link_to('herramientas','catalogo').'/metodo/Bnubibie_Almdes/clase/Bnubibie/frame/sf_admin_edit_form/obj1/cadphart_codori/obj2/cadphart_nomcat/campo1/codubi/campo2/desubi','','','botoncat')?>
<?php }?>
&nbsp;&nbsp;
...
<br>
<?php echo label_for('cadphart[coddirec]', __($labels['cadphart{coddirec}']), 'class="required" Style="width:200px"') ?>
  ...
  <?php $value = object_input_tag($cadphart, 'getCoddirec', array (
  'size' => 20,
  'control_name' => 'cadphart[coddirec]',
  'maxlength' => 4,
  'readonly' => true,
)); echo $value ? $value : '&nbsp;' ?>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <?php $value = object_input_tag($cadphart, 'getDesdirec', array (
  'disabled' => true,
  'size' => 57,
  'control_name' => 'cadphart[desdirec]',
)); echo $value ? $value : '&nbsp;' ?>
    </div>    
<br>
...
<div class="form-row">
  <div align ="left" class="content<?php if ($sf_request->hasError('cadphart{obsdph}')): ?> form-error<?php endif; ?>">
  <?php if ($sf_request->hasError('cadphart{obsdph}')): ?>
    <?php echo form_error('cadphart{obsdph}', array('class' => 'form-error-msg')) ?>
  <?php endif; ?>

  <?php $value = object_textarea_tag($cadphart, 'getObsdph', array (
  'size' => '80x5',
  'maxlength' => 2000,
  'control_name' => 'cadphart[obsdph]',
...
<script type="text/javascript">
 ...
 function enter(valor)
 {
  ...
  function Mostrar_orden_preimpresa()
  {
    ...
    var coddphdes=$('cadphart_dphart').value;
    var coddphhas=$('cadphart_dphart').value;
    


    var  ruta='http://'+'<?echo $this->getContext()->getRequest()->getHost();?>';
    pagina=ruta+"/reportes/reportes/compras/r.php=?r=cardphpre.php&coddphdes="+coddphdes+"&coddphhas="+coddphhas;

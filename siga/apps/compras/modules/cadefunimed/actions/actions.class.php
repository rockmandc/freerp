 ...
 *
 * @package    siga
 * @subpackage cadefunimed
 * @author     $Auhor$ <desarrollo@cidesa.com.ve>
 * @version    SVN: $Id: actions.class.php 32371 2009-09-01 16:06:59Z lhernandez $
 * @copyright  Copyright 2007, Cidesa C.A.
 */

class cadefunimedActions extends autocadefunimedActions
{
  /**
  ...
  public function executeList()
  {
    ...
    $this->filters = $this->getUser()->getAttributeHolder()->getAll('sf_admin/cadefunimed/filters');


     // 15    // pager
    $this->pager = new sfPropelPager('Cadefunimed', 15);
    $c = new Criteria();
    //$this->c ? $c=$this->c : '';
    $c->addAscendingOrderByColumn('to_number('.CadefunimedPeer::CODUNIMED.',\'999\')');

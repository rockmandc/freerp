...
class almreqserActions extends autoalmreqserActions
{
  ...
  public function executeAjax()
	{
	 ...
	 if ($this->getRequestParameter('ajax')=='1')
        ...
        if ($resul)
        {
           ...
           $js="alert('El Art&iacute;culo no esta Registrado'); $('$cajtexcom').value='';";
        }
       $output = '[["'.$cajtexmos.'","'.$dato.'",""],["'.$cajunidad.'","'.$dato1.'",""],["javascript","'.$js.'",""]]';
	    }
  ...
  public function configGrid()
   {
	...
	$col2->setHTML('type="text" size="20x1" readonly=true');
	...
	$col4->setHTML('type="text" size="20x1" readonly=true');
  ...
  $col6 = new Columna('Realizado el...(Fecha)');
  $col6->setTipo(Columna::FECHA);
  $col6->setEsGrabable(false);
  $col6->setNombreCampo('fecrea');
  $col6->setAlineacionObjeto(Columna::CENTRO);
	...
	$col6->setJScript('onKeyUp = "this.value=formateafecha(this.value);"');
  $col6->setVacia(true);

  $col7 = new Columna('Unidad de Medida');
  ...
  public function validateEdit()
    {
      ...
      if (Tesoreria::validarFechaPerContable($this->getRequestParameter('careqartser[fecreq]')))
      {
        $this->coderror=521;
        return false;
      }  

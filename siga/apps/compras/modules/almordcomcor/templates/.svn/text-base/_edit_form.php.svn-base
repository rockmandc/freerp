 ...
 * @version    SVN: $Id: _edit_form.php 41604 2010-12-02 22:43:10Z dmartinez $
 */
...
<?php echo javascript_include_tag('dFilter','compras/almordcomcor','ajax','tools', 'observe') ?>
...
echo input_tag('caordcom[refsol]', $caordcom->getRefsol(), array (
 ...
 'onBlur'=> remote_function(array(
          ...
          'url' => 'almordcomcor/grid?ajax=1&referencia=1',
...
<?php endif; ?>
  ...
  'onBlur'=> remote_function(array(
            //  'update'   => 'div_recargo',
          'script' => true,
        'url'      => 'almordcomcor/grid_recargos',
...
<?php echo submit_to_remote('Submit2', 'Generar Comprobante', array(
         'update'   => 'comp',
         'url'      => 'almordcomcor/ajaxcomprobante',
         'script'   => true,
...
<?php echo submit_to_remote('Submit2', 'Generar Compromiso', array(
         'url'      => 'almordcomcor/ajaxcompromiso',
         'script'   => true,
         'complete' => 'AjaxJSON(request, json)' )) ?>
...
<?php echo select_tag('caordcom[codpai]', options_for_select($pais,$caordcom->getCodpai(),'include_custom=Seleccione'),array('onChange'=> remote_function(array(
    'update'   => 'divEstados',
    'url'      => 'almordcomcor/combosnc?par=1',
...
<?php echo button_to(__('delete'), 'almordcomcor/delete?id='.$caordcom->getId(), array (
  'post' => true,

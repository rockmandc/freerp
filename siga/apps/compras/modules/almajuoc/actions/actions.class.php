...
$this->Bitacora('Guardo');
 ...
 /**
  ...
  public function executeAjaxfila()
  {
    ...
    $montorecargo = Compras::Calcular_RecargoAju($reg_ordcom->getOrdCom(),$ajuste,$codart,$codcat,$costo,$desart);
    ...
    $grid[$fila][9] = number_format($montototal,2,',','.');
      ...
      $javascript = "ActualizarSaldosGrid('caartord',ArrTotales_caartord);";
 ...
 protected function deleteCaajuoc($caajuoc)
  {
      ...
      if($coderr!=-1)
      {
         ...
         $this->getRequest()->setError('delete', $err);
          ...
          return $this->forward('almajuoc', 'list');
      }else {

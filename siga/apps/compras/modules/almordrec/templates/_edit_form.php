...
<br>
  ...
  <?php echo label_for('carcpart[coddirec]', __($labels['carcpart{coddirec}']), 'class="required" Style="width:200px"') ?>
  <div class="content<?php if ($sf_request->hasError('carcpart{coddirec}')): ?> form-error<?php endif; ?>">
  <?php if ($sf_request->hasError('carcpart{coddirec}')): ?>
    <?php echo form_error('carcpart{coddirec}', array('class' => 'form-error-msg')) ?>
  <?php endif; ?>

  <?php $value = object_input_tag($carcpart, 'getCoddirec', array (
  'size' => 20,
  'control_name' => 'carcpart[coddirec]',
  'maxlength' => 4,
  'readonly' => true,
)); echo $value ? $value : '&nbsp;' ?>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <?php $value = object_input_tag($carcpart, 'getDesdirec', array (
  'disabled' => true,
  'size' => 57,
  'control_name' => 'carcpart[desdirec]',
)); echo $value ? $value : '&nbsp;' ?>
    </div>    
<br>
<table>
...
<th>
  ...
  <?php $deshafacent=H::getConfApp2('deshafacent','compras','almordrec');?>

  <?php $value = object_input_tag($carcpart, 'getNumfac', array (
  'size' => 20,
  'control_name' => 'carcpart[numfac]',
  'maxlength' => 15,
  'readonly'  =>  $carcpart->getId()!='' && $carcpart->getNumfac()!=''&& $deshafacent=='S' ? true : false ,
)); echo $value ? $value : '&nbsp;' ?>
    </div>
</th>
<th>&nbsp;&nbsp;&nbsp;&nbsp;</th>
...
<?php echo label_for('carcpart[nroent]', __($labels['carcpart{nroent}']), 'class="required" ') ?>
  ...
  'maxlength' => 8,
  'readonly'  =>  $carcpart->getId()!=''  && $carcpart->getNroent()!='' && $deshafacent=='S' ? true : false ,
)); echo $value ? $value : '&nbsp;' ?>
    </div>
</th>
<th>&nbsp;&nbsp;&nbsp;&nbsp;</th>
...
function Mostrar_orden_preimpresa()
  {
    ...
    var codrcpdes=$('carcpart_rcpart').value;
    var codrcphas=$('carcpart_rcpart').value;   


    var  ruta='http://'+'<?echo $this->getContext()->getRequest()->getHost();?>';
    pagina=ruta+"/reportes/reportes/compras/r.php=?r=carrcppre.php&codrcpdes="+codrcpdes+"&codrcphas="+codrcphas;

...
function ajaxmostrardetallereq(e,id)
{
  ...
  if(confirm("¿Desea visualizar el detalle de la Solicitud de Requisición?"))
  {
 ...
 {
   window.open('/compras'+getEnv()+'.php/almdetsolreq/edit/?formulario='+formulario,formulario,'menubar=no,toolbar=no,scrollbars=yes,width=1200,height=800,resizable=yes,left=1000,top=80');
 }
</script>
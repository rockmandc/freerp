      ...
      case '1':
        ...
        $this->labels = $this->getLabels();
    		...
    		if ($msj==''){
    			...
    			$javascript="";
          $dato=H::getX_vacio('CODPRE','Cpdeftit', 'Nompre',$codigo);

    		}else{
    			$this->configGrid($movs);
    			$javascript="alert('$msj'); $('cpdeftit_codpre').value=''; $('cpdeftit_nompre').value=''; $('cpdeftit_codpre').focus();";
    		}
		$output = '[["cpdeftit_dismon","'.$dismon.'",""],["cpdeftit_nompre","'.$dato.'",""],["cpdeftit_dispor","'.$dispor.'",""],["javascript","'.$javascript.'",""]]';
        break;
      default:
        $output = '[["","",""],["","",""],["","",""]]';
    }

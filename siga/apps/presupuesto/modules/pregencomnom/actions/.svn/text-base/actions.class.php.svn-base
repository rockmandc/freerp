...
/**
 * pregencomnom actions.
 *
 * @package    siga
 * @subpackage pregencomnom
 * @author     $Auhor$ <desarrollo@cidesa.com.ve>
 * @version    SVN: $Id: actions.class.php 32371 2009-09-01 16:06:59Z lhernandez $
 * @copyright  Copyright 2007, Cidesa C.A.
 */

class pregencomnomActions extends autopregencomnomActions
{
  public function executeIndex()
  {
    return $this->forward('pregencomnom', 'edit');
  }
  ...
  public function configGrid($arreglo=array())
  {
    ...
    $this->columnas = Herramientas :: getConfigGrid(sfConfig :: get('sf_app_module_dir') . '/pregencomnom/' . sfConfig :: get('sf_app_module_config_dir_name') . '/grid');
  ...
  public function executeAjax()
  {
    ...
    switch ($ajax){
      ...
      case '3':
        ...
        $especial = $this->getRequestParameter('especial','');
        $codnomesp = $this->getRequestParameter('codnomesp','');
        
        Presupuesto::mostrarAsignacionesPresuspuestarias($codigo,$fecnom,$gasto,$banco,$especial,$codnomesp,$arreglo);
        $this->params=array();
  ...
  {
    $grid = Herramientas::CargarDatosGridv2($this,$this->obj);
    Presupuesto::generarCompromisoNomina($clasemodelo,$grid);
  ...
  public function executeEdit()
  {
    ...
    if ($this->getRequest()->getMethod() == sfRequest::POST)
    {
      ...
      if($this->saveCpcompro($this->cpcompro) ==-1){
        ...
        {
          return $this->redirect('pregencomnom/create');
        }
        else if ($this->getRequestParameter('save_and_list'))
        {
          return $this->redirect('pregencomnom/list');
        }
        else
        {
            return $this->redirect('pregencomnom/edit');
        }

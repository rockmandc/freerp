 ...
 * @version SVN: $Id: actions.class.php 58990 2014-10-10 13:29:18Z dmartinez $
 *
  ...
  public function executeAjax(){
    ...
    switch ($ajax){
      case '1':
        ...
        $js="alert_('La Categoria Presupuestaria no es de &Uacute;ltimo Nivel'); $('cpdeftit_codpre').value=''; $('cpdeftit_codpre').focus();";
    	}
	      $this->configGrid($reg,$LonCat,$LonPar);
        $nompre = H::getX_vacio('Codcat','npcatpre','nomcat',$codpre);

        $output = '[["cpdeftit_codpre","'.$codpre.'",""],["cpdeftit_nompre","'.$nompre.'",""],["javascript","'.$js.'",""],["","",""]]';
        break;
        default:
        $output = '[["","",""],["","",""],["","",""]]';
       case '2':
          ...
          if ($nompre==''){
            $error=H::obtenerMensajeError(1325);
             $js="alert('$error'); $('cpdeftit_codigo11').value=''; $('cpdeftit_codigo11').focus();";
          }else {
            $this->Longitudes($LonCat,$LonPar);
            $this->setVars($LonCat);
          if (strlen($codpre)==($LonCat-1)){
          ...
          if(H::BuscarDatos($sql,$regs)){
            ...
            $js="alert_('La Categoria Presupuestaria no es de &Uacute;ltimo Nivel'); $('cpdeftit_codigo11').value=''; $('cpdeftit_codigo11').focus();";
          }
          }

		  $output = '[["cpdeftit_nombre1","'.$nompre.'",""],["javascript","'.$js.'",""],["","",""]]';
		  break;

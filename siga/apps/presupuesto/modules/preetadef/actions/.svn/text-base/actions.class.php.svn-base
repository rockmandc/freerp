 ...
 *
 * @package    siga
 * @subpackage preetadef
 * @author     $Auhor$ <desarrollo@cidesa.com.ve>
 * @version    SVN: $Id: actions.class.php 32371 2009-09-01 16:06:59Z lhernandez $
 * @copyright  Copyright 2007, Cidesa C.A.
 */

class preetadefActions extends autopreetadefActions
{
  public function executeIndex() {
      ...
      if ($dato) {
          $id=$dato->getId();
          return $this->redirect('preetadef/edit?id='.$id);
      }
      else {
          return $this->redirect('preetadef/edit');
      }
  }
  ...
  public function executeAjax()
  {
    ...
    switch ($ajax){
      case '1':
        ...
        $q= new Criteria();
        $q->add(CpdefnivPeer::CODEMP,'001');
        $result= CpdefnivPeer::doSelectOne($q);
        if ($result){
          if ($etadef=='C') {
            $result->setEtadef('A');

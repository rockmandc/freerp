 ...
 * @version SVN: $Id: actions.class.php 54883 2013-12-18 12:31:15Z dmartinez $
 * 
 * @copyright  Copyright 2007, Cide S.A.
 * @license    http://opensource.org/licenses/gpl-2.0.php GPLv2
 */
class precongenActions extends autoprecongenActions
{
  ...
  public function executeIndex()
  {
  	...
  	{
  	 $id=$resul->getId();
  	 return $this->redirect('precongen/edit?id='.$id);
  	}
  	else
  	{
  	  return $this->redirect('precongen/edit');
  	}
  }
    ...
    switch ($ajax){
      case '1':
        ...
        if ($reg)
        {
            ...
            $js="alert_('El Tipo de Documento no existe'); $('cpdefniv_tipcom').value=''; $('cpdefniv_nomdoc').value=''; $('cpdefniv_tipcom').focus();";
        }
      ...
      case '2':
        ...
        if ($reg)
        {
            ...
            $js="alert_('El Beneficiario no existe'); $('cpdefniv_cedrif').value=''; $('cpdefniv_nomben').value=''; $('cpdefniv_cedrif').focus();";
        }
        $output = '[["'.$cajtexmos.'","'.$dato.'",""],["javascript","'.$js.'",""]]';
        break;        
      default:

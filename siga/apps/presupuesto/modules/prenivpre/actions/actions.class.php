 ...
 * @version SVN: $Id: actions.class.php 59252 2014-10-29 13:19:07Z dmartinez $
 *
    	...
    	switch ($ajax) {
          ...
          case '2':
            ...
            if ($reg)
            {
                ...
                $js="alert_('El Tipo de Documento no existe'); $('cpdefniv_tipcau').value=''; $('cpdefniv_tipcau').focus();";
            }
          ...
          case '3':
            ...
            if ($reg)
            {
                ...
                $js="alert_('El Tipo de Documento de Compromiso no existe'); $('cpdefniv_tipcom').value=''; $('cpdefniv_tipcom').focus();";
            }
            $output = '[["'.$cajtexmos.'","'.$dato.'",""],["javascript","'.$js.'",""]]';
            break;
          case '4':
            ...
            if ($reg)
            {
                ...
                $js="alert_('La Cedula/RIF no existe'); $('cpdefniv_cedrif').value=''; $('cpdefniv_cedrif').focus();";
            }
            $output = '[["'.$cajtexmos.'","'.$dato.'",""],["javascript","'.$js.'",""]]';
            break;
      		default:

...
/**
 * condefcencos actions.
 *
 * @package    siga
 * @subpackage condefcencos
 * @author     $Auhor$ <desarrollo@cidesa.com.ve>
 * @version    SVN: $Id: actions.class.php 32371 2009-09-01 16:06:59Z lhernandez $
 * @copyright  Copyright 2007, Cidesa C.A.
 */

class condefcencosActions extends autocondefcencosActions
{
  ...
  {
    $gracencom=H::getConfApp2('gracencom', 'contabilidad', 'condefcencos');
    if ($gracencom=='S'){
      $t= new Criteria();
      $t->add(CadefcenPeer::CODCEN,$clasemodelo->getCodcencos());
      $result=CadefcenPeer::doSelectOne($t);
      if (!$result){
        $centro_new= new Cadefcen();
        $centro_new->setCodcen($clasemodelo->getCodcencos());
        $centro_new->setDescen($clasemodelo->getDescencos());
        $centro_new->save();
      }
    }

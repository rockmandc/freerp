...
class conasigcencosActions extends autoconasigcencosActions
{
  ...
  public function configGrid($numcom='')
  {
    ...
    if ($cccompras=='S')
        $this->columnas[1][3]->setCatalogo('cadefcen','sf_admin_edit_form',array('codcen' => 4, 'descen' => 5),'Cadefcen_Almsolegr');
    else 
        $this->columnas[1][3]->setCatalogo('codefcencos','sf_admin_edit_form',array('codcencos' => 4, 'descencos' => 5),'Codefcencos_Conasigcencos');

 ...
 */
class confincomajActions extends autoconfincomajActions
{

  // Para incluir funcionalidades al executeEdit()
  /**
   * FunciÃ³n para colocar el codigo necesario en
   * el proceso de ediciÃ³n.
   * AquÃ­ se pueden buscar datos adicionales que necesite la vista
   * Esta funciÃ³n es parte de la acciÃ³n executeEdit, que maneja tanto
   * el create como el edit del formulario.
   * Generalmente aqui se debe y puede colocar los llamados a los configGrid
   * Para generar la informaciÃ³n de configuraciÃ³n de los grids.
   *
   */
  ...
  public function configGrid($reg = array(),$regelim = array())
  {
     ...
     $this->columnas = Herramientas::getConfigGrid(sfConfig::get('sf_app_module_dir').'/confincomaj/'.sfConfig::get('sf_app_module_config_dir_name').'/grid_contabc1');
  ...
  public function executeAjax()
  {
    ...
    switch ($ajax){
    		...
    		if($per->getStatus()=='A')
    		{
    			...
    			$c = new Criteria();
      			...
      			if($objper)
      			{
      				...
      				$js.="alert('Se ha Realizado la operaciÃ³n con Exito.........');";
      			}      				
      			else
      				$js.="alert('No se pudo realizar la operacion del Comprobante');";
    		}    		
    		else
    			$js.="alert('El Periodo se Encuentra Cerrado no se puede realizar la operaciÃ³n');";
      ...
      case '2':
        ...
        $colref = $auxid[0].'_'.$auxid[1].'_3';

        $output = '[["'.$auxid[0].'_'.$auxid[1].'_2","'.$dato.'",""],["javascript","'.$javascript.'",""],["javascript","$('."'$colref'".').value=$('."'contabc_reftra'".').value",""]]';
       break;
      case '3':
  ...
  /**
   * FunciÃ³n para colocar el codigo necesario para
   * el proceso de guardar.
   * Esta funciÃ³n debe retornar un valor igual a -1 si no hubo
   * Inconvenientes al guardar, y != de -1 si existe algÃºn error.
   * Si es diferente de -1 el valor devuelto debe ser un cÃ³digo de error
   * VÃ¡lido que exista en el archivo config/errores.yml
   *
   */

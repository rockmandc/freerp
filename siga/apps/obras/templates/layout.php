  ...
  <td width="100%">
      ...
      <tr>
        <td width="100%"><table width="100%" height="0%" border="0" cellpadding="0" cellspacing="0">
            ...
            <a href= "javascript: var w = window.open('<?php if (SF_ENVIRONMENT=='dev') echo "/".sfConfig::get('app_autenticacion')."_dev.php/ayudas?m=".sfConfig::get('app_this'); else echo "/".sfConfig::get('app_autenticacion').".php/ayudas?m=".sfConfig::get('app_this'); ?>')"><img src="/images/help.png" width="20" height="20" /></a>&nbsp;

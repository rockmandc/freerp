...
<script language="JavaScript" type="text/javascript">
  ...
  {
    window.open('/tesoreria'+getEnv()+'.php/confincomgen/edit/id/'+document.getElementById("cobtransa_idrefer").value,'...','menubar=no,toolbar=no,scrollbars=yes,width=1200,height=800,resizable=yes,left=1000,top=80');
  }
</script>
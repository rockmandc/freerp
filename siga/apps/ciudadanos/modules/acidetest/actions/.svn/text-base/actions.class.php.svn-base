 ...
 *
 * @package    siga
 * @subpackage acidetest
 * @author     $Auhor$ <desarrollo@cidesa.com.ve>
 * @version    SVN: $Id: actions.class.php 32371 2009-09-01 16:06:59Z lhernandez $
 * @copyright  Copyright 2007, Cidesa C.A.
 */

class acidetestActions extends autoacidetestActions
{
  ...
  public function listing()
  {
    ...
    if($id!=''){
      ...
      $this->c = new Criteria();
      $criterion = $this->c->getNewCriterion(AtdetestPeer::ATDENUNCIAS_ID,$id);
      $criterion->addOr($this->c->getNewCriterion(AtdetestPeer::ATAYUDAS_ID,$id));

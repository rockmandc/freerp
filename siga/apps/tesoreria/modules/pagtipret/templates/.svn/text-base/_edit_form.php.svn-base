...
<br>
 ...
 <br>
  ...
  <?php echo " Si " . radiobutton_tag('optipret[consustra]', 'S', $val, array('onClick'=> remote_function(array(
       ...
       'url'      => 'pagtipret/datos',
       'script'   => true,
           'with' => "'ajax=S&unitri='+document.getElementById('optipret_unitri').value+'&factor='+document.getElementById('optipret_factor').value+'&porsus='+document.getElementById('optipret_porsus').value+'&basimp='+document.getElementById('optipret_basimp').value+'&basimp1='+document.getElementById('optipret_basimp1').value+'&mbasmi='+document.getElementById('optipret_mbasmi').value+'&mbasmi1='+document.getElementById('optipret_mbasmi1').value+'&mbasma='+document.getElementById('optipret_mbasma').value+'&mbasma1='+document.getElementById('optipret_mbasma1').value+'&porret='+document.getElementById('optipret_porret').value"
        )))) ?>
  &nbsp;&nbsp;
...
<th>&nbsp;&nbsp;&nbsp;&nbsp;</th>
<th>
<div id="montoocul3" style="display:none">
   <?php echo label_for('monbasmax', __('Monto Base Máximo'),'class="required"') ?>
  <?php $value = object_input_tag($optipret, array('getMbasma',true), array (
  'size' => 7,
  'control_name' => 'optipret[mbasma]',
  'onBlur' => "javascript:event.keyCode=13; return entermontootro(event, this.id)",
)); echo $value ? $value : '&nbsp;' ?>
</div>
</th>
<th>
<div id="montoocul4" style="display:none">
  <?php echo label_for('expre', __('expresado en Unidades Tributarias'),'class="required"') ?>
</div>
</th>
</tr>
...
<th>&nbsp;&nbsp;&nbsp;&nbsp;</th>
<th>
<div id="montoocula3" style="display:none">
   <?php echo label_for('monbasmax', __('Monto Base Máximo'),'class="required"') ?>
  <?php $value = object_input_tag($optipret, array('getMbasma',true), array (
  'size' => 7,
  'control_name' => 'optipret[mbasma1]',
  'onBlur' => "javascript:event.keyCode=13; return entermontofactor(event, this.id)",
)); echo $value ? $value : '&nbsp;' ?>
</div>
</th>
<th>
<div id="montoocula4" style="display:none">
  <?php echo label_for('expre', __('expresado en Unidades Tributarias'),'class="required"') ?>
</div>
</th>
</tr>

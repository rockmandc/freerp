...
class pagdefempActions extends autopagdefempActions {
    ...
    public function executeAjax() {
        ...
        if ($this->getRequestParameter('ajax') == '1') {
            ...
            $dato = CpdocpagPeer::getNomext($this->getRequestParameter('codigo'));
            $output = '[["' . $cajtexmos . '","' . $dato . '",""]]';
        }
    ...
    protected function updateOpdefempFromRequest() {
        ...
        if (isset($opdefemp['codmon'])) {
            $this->opdefemp->setCodmon($opdefemp['codmon']);
        }
        if (isset($opdefemp['tippag'])) {
            $this->opdefemp->setTippag($opdefemp['tippag']);
        }
        if (isset($opdefemp['corpagele'])) {
            $this->opdefemp->setCorpagele($opdefemp['corpagele']);
        }
        if (isset($opdefemp['tipagele'])) {
            $this->opdefemp->setTipagele($opdefemp['tipagele']);
        }
        if (isset($opdefemp['rifemp'])) {
            $this->opdefemp->setRifemp($opdefemp['rifemp']);
        }
        if (isset($opdefemp['numneg'])) {
            $this->opdefemp->setNumneg($opdefemp['numneg']);
        }
        if (isset($opdefemp['ordamo'])) {
            $this->opdefemp->setOrdamo($opdefemp['ordamo']);
        }
        if (isset($opdefemp['ordant'])) {
            $this->opdefemp->setOrdant($opdefemp['ordant']);
        }
        if (isset($opdefemp['reppreimpop'])) {
            $this->opdefemp->setReppreimpop($opdefemp['reppreimpop']);
        }
        if (isset($opdefemp['ordantcom'])) {
            $this->opdefemp->setOrdantcom($opdefemp['ordantcom']);
        }
        if (isset($opdefemp['corciecaj'])) {
            $this->opdefemp->setCorciecaj($opdefemp['corciecaj']);
        }
        if (isset($opdefemp['ordhcm'])) {
            $this->opdefemp->setOrdhcm($opdefemp['ordhcm']);
        }
        
        if (isset($opdefemp['comiva'])) 
            $this->opdefemp->setComiva($opdefemp['comiva']);
        
        if (isset($opdefemp['comislr'])) 
            $this->opdefemp->setComislr($opdefemp['comislr']);
        
        if (isset($opdefemp['comltf'])) 
            $this->opdefemp->setComltf($opdefemp['comltf']);
        
        if (isset($opdefemp['comrs'])) 
            $this->opdefemp->setComrs($opdefemp['comrs']);

        if (isset($opdefemp['ordcarava'])) {
            $this->opdefemp->setOrdcarava($opdefemp['ordcarava']);
        }
        if (isset($opdefemp['ordciecaj'])) {
            $this->opdefemp->setOrdciecaj($opdefemp['ordciecaj']);
        }
        if (isset($opdefemp['nomfirrep']))
        {
          $this->opdefemp->setNomfirrep($opdefemp['nomfirrep']);
        }
        if (isset($opdefemp['ranfirrep']))
        {
          $this->opdefemp->setRanfirrep($opdefemp['ranfirrep']);
        }
        if (isset($opdefemp['carfirrep']))
        {
          $this->opdefemp->setCarfirrep($opdefemp['carfirrep']);
        }
        if (isset($opdefemp['agropnomesp']))
        {
          $this->opdefemp->setAgropnomesp($opdefemp['agropnomesp']);
        }
        if (isset($opdefemp['nomreptras']))
        {
          $this->opdefemp->setNomreptras($opdefemp['nomreptras']);
        }
    ...
    public function executeAutocomplete() {
        if ($this->getRequestParameter('ajax') == '1') {
            ...
            $this->tags = Herramientas::autocompleteAjax('TIPCAU', 'Cpdoccau', 'Tipcau', $this->getRequestParameter('opdefemp[ordamo]'));
        }else if ($this->getRequestParameter('ajax') == '11') {
            $this->tags = Herramientas::autocompleteAjax('TIPCAU', 'Cpdoccau', 'Tipcau', $this->getRequestParameter('opdefemp[ordcarava]'));
        }else if ($this->getRequestParameter('ajax') == '12') {
            $this->tags = Herramientas::autocompleteAjax('TIPCAU', 'Cpdoccau', 'Tipcau', $this->getRequestParameter('opdefemp[ordciecaj]'));
        }
    }
...
public function getLabels()
  {
    ...
    $cametiordamo=H::getConfApp2('cametiordamo', 'tesoreria', 'pagdefemp');
    if ($cametiordamo=='S')
      $labels['opdefemp{ordamo}'] = 'Anticipo:';
    return $labels;
  }
}

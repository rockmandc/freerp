...
$this->Bitacora('Guardo');
  ...
  protected function updateTsdefbanFromRequest()
  {
    ...
    if (isset($tsdefban['codmon']))
    {
      $this->tsdefban->setCodmon($tsdefban['codmon']);
    }
    if (isset($tsdefban['codcom']))
    {
      $this->tsdefban->setCodcom($tsdefban['codcom']);
    }
    if (isset($tsdefban['codtiptra']))
    {
      $this->tsdefban->setCodtiptra($tsdefban['codtiptra']);
    }
    if (isset($tsdefban['codadi']))
    {
      $this->tsdefban->setCodadi($tsdefban['codadi']);
    }
    if (isset($tsdefban['codubi']))
    {
      $this->tsdefban->setCodubi($tsdefban['codubi']);
    }
    if (isset($tsdefban['coddirec']))
    {
      $this->tsdefban->setCoddirec($tsdefban['coddirec']);
    }
    if (isset($tsdefban['conformable']))
    {
      $this->tsdefban->setConformable($tsdefban['conformable']);
    }
    if (isset($tsdefban['monconfor']))
    {
      $this->tsdefban->setMonconfor($tsdefban['monconfor']);
    }
    if (isset($tsdefban['agenban']))
    {
      $this->tsdefban->setAgenban($tsdefban['agenban']);
    }
    if (isset($tsdefban['corchetran']))
    {
      $this->tsdefban->setCorchetran($tsdefban['corchetran']);
    }
    if (isset($tsdefban['nomciu']))
    {
      $this->tsdefban->setNomciu($tsdefban['nomciu']);
    }
    if (isset($tsdefban['arerep']))
    {
      $this->tsdefban->setArerep($tsdefban['arerep']);
    }
    if (isset($tsdefban['aterep']))
    {
      $this->tsdefban->setAterep($tsdefban['aterep']);
    }
    if (isset($tsdefban['cuebcv']))
    {
      $this->tsdefban->setCuebcv($tsdefban['cuebcv']);
    }
    if (isset($tsdefban['escajchi']))
    {
      $this->tsdefban->setEscajchi($tsdefban['escajchi']);
    }
  }
   ...
   $cajtexmos=$this->getRequestParameter('cajtexmos');
    ...
    if ($this->getRequestParameter('ajax')=='1')
	  ...
	  { 
        ...
        if ($result) {
          if ($result->getCargab()=='C')
            ...
            $js="alert_('La Cuenta Contable no es Cargable'); $('tsdefban_codcta').value=''; $('tsdefban_codcta').focus();";
        }else
          $js="alert_('La Cuenta Contable no existe'); $('tsdefban_codcta').value=''; $('tsdefban_codcta').focus();";
        
        $output = '[["cargable","'.$dato2.'",""],["javascript","'.$js.'",""]]';
	  }
	  ...
	  { 
             ...
             $dato=H::getX_vacio('CODCOM', 'Tscomban', 'Descom', $this->getRequestParameter('codigo'));
             if ($dato=='')
                 $js="alert_('La Comisi&oacute;n Bancaria no existe'); $('$cajtexcom').value=''; $('$cajtexmos').value=''; $('$cajtexcom').focus();";
    ...
    { 
             ...
             $dato=H::getX_vacio('CODTIPTRA', 'Cotiptra', 'Destiptra', $this->getRequestParameter('codigo'));
             if ($dato=='')
                 $js="alert_('El tipo de Transacci&oacute;n no existe'); $('tsdefban_codtiptra').value=''; $('$cajtexmos').value=''; $('tsdefban_codtiptra').focus();";
    ...
    {      
      ...
      if ($lonubi==strlen($this->getRequestParameter('codigo')))
      {
        $p= new Criteria();
        $p->add(BnubicaPeer::CODUBI,$this->getRequestParameter('codigo'));
        $resul= BnubicaPeer::doSelectOne($p);
        if ($resul)
        {
          $dato=$resul->getDesubi();
        }else $js="alert_('La Ubicaci&oacute;n Administrativa no esta Registrada'); $('$cajtexcom').value=''; $('$cajtexmos').value=''; $('$cajtexcom').focus();";
      }else $js="alert_('La Ubicaci&oacute;n Administrativa no es de &Uacute;ltimo Nivel'); $('$cajtexcom').value=''; $('$cajtexmos').value=''; $('$cajtexcom').focus();";
      $output = '[["'.$cajtexmos.'","'.$dato.'",""],["javascript","'.$js.'",""]]';
    ...
    { 
         ...
         if ($dato=='')
             $js="alert_('El Estado no existe'); $('tsdefban_coddirec').value=''; $('$cajtexmos').value=''; $('tsdefban_coddirec').focus();";

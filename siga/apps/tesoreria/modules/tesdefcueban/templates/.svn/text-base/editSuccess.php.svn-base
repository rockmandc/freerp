...
<?php include_partial('tesdefcueban/edit_form', array('tsmovban_credito_debito' => $tsmovban_credito_debito, 'tsmovlib_credito_debito' => $tsmovlib_credito_debito, 'tsdefban' => $tsdefban, 'loncta' => $loncta, 'labels' => $labels, 'mascaracontabilidad' => $mascaracontabilidad, 'obj'=>$obj, 'grupo' => $grupo, 'mascaraubi' => $mascaraubi, 'lonubi' => $lonubi)) ?>
</div>

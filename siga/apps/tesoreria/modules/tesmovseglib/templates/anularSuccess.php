...
<div class="form-row" align="center">
   <input type="button" value="Salvar" id="guarda" onClick="salvar();">
</div>
<div id="divAnul"></div>
</div>
</form>
...
//	f.submit();
	...
	new Ajax.Updater('divAnul','/tesoreria'+getEnv()+'.php/tesmovseglib/salvaranu', {asynchronous:true, evalScripts:true, onComplete:function(request, json){AjaxJSON(request, json)}, parameters:'reflib='+reflib+'&reflib2='+reflib2+'&refpag='+refpag+'&feclib='+feclib+'&tipmov='+tipmov+'&id='+id+'&numcue='+numcue+'&numcom='+numcom+'&desanu='+desanu+'&monmov='+monmov+'&numcomadi='+numcomadi+'&feccomadi='+feccomadi+'&compadic='+compadic+'&fechacom='+fechacom+'&numcom='+numcom+'&numcom2='+numcom2+'&fecanu='+fecanu})
}

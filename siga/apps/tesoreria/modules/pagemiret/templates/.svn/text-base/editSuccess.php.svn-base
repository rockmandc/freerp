...
<?php include_partial('pagemiret/edit_form', array('opordpag' => $opordpag, 'mascara' => $mascara, 'lonmas' => $lonmas, 'obj' => $obj, 'labels' => $labels, 'formulario' => $formulario, 'tipo' => $tipo, 'concepto' => $concepto, 'tiporet' => $tiporet, 'nomext' => $nomext, 'numdesh' => $numdesh, 'numero' => $numero, 'impordret'=> $impordret)) ?>
</div>

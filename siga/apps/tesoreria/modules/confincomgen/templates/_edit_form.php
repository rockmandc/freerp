...
<script type="text/javascript">
var deshab='<?php echo $bloqfec; ?>';
var blocomlib='<?php echo H::getConfApp2('blocomlib', 'tesoreria', 'tesmovseglib')?>';
var nomformulario='<?php echo $sf_request->getParameter('formulario','')?>';
if (deshab=='S' || (nomformulario=='sf_admin/tesmovseglib/confincomgen0' && blocomlib=='S'))
{

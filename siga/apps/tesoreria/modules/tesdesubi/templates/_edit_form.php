...
<br>
  ...
  <?php if($labels['bnubica{carjefuni}']!='.:') { ?>
  <?php echo label_for('bnubica[carjefuni]', __($labels['bnubica{carjefuni}' ]), 'class="required" Style="text-align:left; width:150px"') ?>
  <div class="content<?php if ($sf_request->hasError('bnubica{carjefuni}')): ?> form-error<?php endif; ?>">
  <?php if ($sf_request->hasError('bnubica{carjefuni}')): ?>
    <?php echo form_error('bnubica{carjefuni}', array('class' => 'form-error-msg')) ?>
  <?php endif; }?>



  <?php $value = object_input_tag($bnubica, 'getCarjefuni', array (
  'size' => 80,
  'maxlength' => 250,
  'control_name' => 'bnubica[carjefuni]',
)); echo $value ? $value : '&nbsp;' ?>
...
<fieldset id="sf_fieldset_none" class="">
<legend><?php echo __('Datos Punto de Cuenta')?></legend>
<div class="form-row">
<div id="divcorpta">
  <?php if($labels['bnubica{corpta}']!='.:') { ?>
  <?php echo label_for('bnubica[corpta]', __($labels['bnubica{corpta}' ]), 'class="required" Style="text-align:left; width:150px"') ?>
  <div class="content<?php if ($sf_request->hasError('bnubica{corpta}')): ?> form-error<?php endif; ?>">
  <?php if ($sf_request->hasError('bnubica{corpta}')): ?>
    <?php echo form_error('bnubica{corpta}', array('class' => 'form-error-msg')) ?>
  <?php endif; }?>  
  
   
  
  <?php $value = object_input_tag($bnubica, 'getCorpta', array (
  'size' => 7,
  'onKeyPress' => 'javascript:return validaEntero(event)',
  'control_name' => 'bnubica[corpta]',
)); echo $value ? $value : '&nbsp;' ?>
...
<br/>
<div id="divprepta">
  <?php if($labels['bnubica{prepta}']!='.:') { ?>
  <?php echo label_for('bnubica[prepta]', __($labels['bnubica{prepta}' ]), 'class="required" Style="text-align:left; width:150px"') ?>
  <div class="content<?php if ($sf_request->hasError('bnubica{prepta}')): ?> form-error<?php endif; ?>">
  <?php if ($sf_request->hasError('bnubica{prepta}')): ?>
    <?php echo form_error('bnubica{prepta}', array('class' => 'form-error-msg')) ?>
  <?php endif; }?>  
  
   
  
  <?php $value = object_input_tag($bnubica, 'getPrepta', array (
  'size' => 20,
  'maxlength' => 8,
  'control_name' => 'bnubica[prepta]',
)); echo $value ? $value : '&nbsp;' ?>

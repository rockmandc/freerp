...
class tesaprordtesActions extends autotesaprordtesActions
{
  ...
  public function configGridOrdenes($n1="", $n2="")
  {
    ...
    if ($n1=="" && $n2=="")
    {
     ...
     $sql = "(opordpag.numord>='$n1' and opordpag.numord<='$n2') and ((opordpag.APROBADOTES<>'A' and opordpag.APROBADOTES<>'R') or opordpag.APROBADOTES isnull) ".$sql2."";
  ...
  protected function saving($opordpag)
  {
	...
	while ($i<$concom)
	{
     ...
     if ($this->getUser()->getAttribute('grabo',null,$formulario[$i])=='S')
     {
      ...
      $numerocomp = Comprobante::SalvarComprobante($numcom,$reftra,$feccom,$descom,$debito,$credito,$grid,$this->getUser()->getAttribute('grabar',null,$formulario[$i]),'TES');

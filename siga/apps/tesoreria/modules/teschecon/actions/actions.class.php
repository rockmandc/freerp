 ...
 *
 * @package    siga
 * @subpackage teschecon
 * @author     $Auhor$ <desarrollo@cidesa.com.ve>
 * @version    SVN: $Id: actions.class.php 32371 2009-09-01 16:06:59Z lhernandez $
 * @copyright  Copyright 2007, Cidesa C.A.
 */

class tescheconActions extends autotescheconActions
{
  ...
  public function executeList()
  {
    ...
    $c = new Criteria();
    $sql="(tscheemi.conformado is null or tscheemi.conformado='N') and tscheemi.monche>=tsdefban.monconfor";
    $c->add(TscheemiPeer::CONFORMADO,$sql,Criteria::CUSTOM);
  ...
  {
     if ($this->tscheemi->getFecconfor()=='')
      $this->tscheemi->setFecconfor(date('d/m/Y'));
    if ($this->tscheemi->getHorconfor()=='')
     $this->tscheemi->setHorconfor(date('h:i A'));
  ...
  public function validateEdit()
  {
    ...
    if($this->getRequest()->getMethod() == sfRequest::POST){
        ...
        $fecreal = $dateFormat->format($this->getRequestParameter('tscheemi[fecconfor]'), 'i', $dateFormat->getInputPattern('d'));
        $horreal=date('h:i A', strtotime($this->getRequestParameter('tscheemi[horconfor]')));
        if ($fecreal>$fecser){
           $this->coderr=5001;
           return false;
        }

...
function ajax(id)
 {
   ...
   var aux = id.split("_");
    ...
    new Ajax.Request('/tesoreria'+getEnv()+'.php/pagrepret/ajax', {asynchronous:true, evalScripts:false, onComplete:function(request, json){AjaxJSON(request, json), validargrid(id);}, parameters:'ajax=1&cajtexmos='+descripcion+'&cajtexcom='+id+'&codigo='+cod})
 }
</script>

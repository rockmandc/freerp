  ...
  <?php echo input_tag('tscheemi[numeroord]', $tscheemi->getNumeroord(), array (
         'size' => 15,
          ...
          'onBlur'=> remote_function(array(
	        ...
	        'with' => "'ajax=7&cajtexmos=tscheemi_numeroord&mostrardato=S&operacion='+document.getElementById('tscheemi_operacion').value+'&numord='+$('tscheemi_numeroord').value+'&tipdoc='+$('tscheemi_tipdoc').value+'&numcue='+document.getElementById('tscheemi_numcue').value+'&coddirec='+$('tscheemi_coddirec').value+'&fecord='+$('tscheemi_fecord').value"
	        ))
          ))?>
<br><br>
  ...
  <?php echo input_date_tag('tscheemi[fecord]', $tscheemi->getFecord(), array (
         'size' => 10,
          ...
          'onBlur'=> remote_function(array(
	        ...
	        'with' => "'ajax=7&cajtexmos=tscheemi_fecord&mostrardato=S&operacion='+document.getElementById('tscheemi_operacion').value+'&numord='+$('tscheemi_numeroord').value+'&tipdoc='+$('tscheemi_tipdoc').value+'&numcue='+document.getElementById('tscheemi_numcue').value+'&coddirec='+$('tscheemi_coddirec').value+'&fecord='+this.value"
	        ))
          ))?>
<br><br>
<?php } ?>

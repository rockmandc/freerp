...
<?php include_partial('tesmovemiche/edit_form', array('tscheemi' => $tscheemi, 'impche'=> $impche, 'numcomegr' => $numcomegr, 'numches'=> $numches, 'numcues'=> $numcues, 'gridOrdPag' => $gridOrdPag, 'gridCompro' => $gridCompro, 'gridPrecom' => $gridPrecom, 'gridPagdir' => $gridPagdir, 'mensajeBen' => $mensajeBen, 'bloqueaopc' => $bloqueaopc, 'valoropc' => $valoropc, 'labels' => $labels, 'comprobaut' => $comprobaut, 'gencomaut' => $gencomaut, 'bloqfec' => $bloqfec, 'scheque' => $scheque)) ?>
</div>

...
function genericTest($b, $modulo, $solo, $m, $app, $hostname)
{

  $lime = $b->test();

  if(!strstr($modulo,'.php') && ($solo=='formularios' || $solo=='all' || $solo=='forms')){
  ...
  }elseif(strstr($modulo,'.php') && ($solo=='all' || $solo=='reportes'  || $solo=='reports')){

...
//             $block  = "S";
             $pos    = 1;
             $sqldet = "select a.*, to_char(a.fecres,'dd/mm/yyyy') as fecres From cpsolmovadi a Where trim(a.refadi)='".trim($codigo)."' order by a.codpre";
             ...
             while (!$tb2->EOF)
             {
                ...
                $_POST["x".$pos."7"] = $tb2->fields["tipo"];
                $_POST["x".$pos."8"] = $tb2->fields["monto"];
                $_POST["x".$pos."9"] = $tb2->fields["iva"];
                  ...
                  while ($i<=$numfil)
                  {
                     ?>
                        <tr>
                          ...
                          <td  align="left" class="grid_line01_br"><input name="x<? print $i;?>1" id="x<? print $i;?>1" type="text" class="grid_txt01" size="32" maxlength="<?print strlen($_SESSION["formato"]);?>" onKeyDown="javascript:return dFilter (event.keyCode, this,'<?print $_SESSION["formato"];?>');" align="right"  value="<? print  $_POST["x".$i."1"];?>" onblur="enterGRID(event,this.id,'trash','x<? print $i;?>8');" ></td>
                          <td  align="right" class="grid_line01_br"><input name="x<? print $i;?>8" id="x<? print $i;?>8" type="text" class="grid_txt02" size="16" value="<? if (empty($_POST["x".$i."8"])) {print number_format(0,2,'.',',');}  else {print number_format($_POST["x".$i."8"],2,'.',',');}  ?>" align="right"  onblur="entermontob(event,'x<? print $i;?>1',this.id,'x<? print $i;?>4','Mon')"></td>
                          <td  align="right" class="grid_line01_br"><input name="x<? print $i;?>9" id="x<? print $i;?>9" type="text" class="grid_txt02" size="16" value="<? if (empty($_POST["x".$i."9"])) {print number_format(0,2,'.',',');}  else {print number_format($_POST["x".$i."9"],2,'.',',');}  ?>" align="right"  onblur="entermontob(event,'x<? print $i;?>1',this.id,'x<? print $i;?>4','Mon')"></td>
                          ...
                          <td  align="right" class="grid_line01_br "><? $v1=$_POST["x".$i."7"];?><select name="x<? print $i;?>7" id="x<? print $i;?>7">
                                     <option value="<? print $_POST["x".$i."7"] ?>"><? 
                                     if ($v1=='O') print '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ORIGEN&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
                                         else if ($v1=='D') print '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DESTINO&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
                                         else print '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'?></option>
                                    <? if ($v1!=''){ ?>	<option value="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option> <? } ?>
                                    <? if ($v1!='C'){ ?> <option value="O" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ORIGEN&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option> <? } ?>
                                    <? if ($v1!='P'){ ?> <option value="D" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DESTINO&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option> <? } ?>
                                      </select></td>
                       </tr>
                    <?
                    $i=$i+1;
        ...
        if (document.getElementById(id).value!="")
        {
          ...
          if (a==false)
          {
            ...
            if ((aux!="") && (r!='-'))
            {
              ...
              sql2=cadena;
              if (document.form1.tipo[0].checked)  campo2 = 'A';   else  campo2 = 'D';
              mensaje="El Título Presupuestario no tiene asignación Inicial";
              pagina="gridatos.php?cuantos="+cuantos+"&id="+id+"&donde="+donde+"&foco="+foco+"&campo2="+campo2+"&sql="+sql+"&sql2="+sql2+"&mensaje="+mensaje+"&anocierre="+anocierre;
              //alert(pagina);
    ...
    function dispo(cod,id,donde,foco,row)
     {
         ...
         if ((document.getElementById(cod).value!="") && (r!='-') && (document.getElementById('getf').value=='S'))
      {
        ...
        var referencia=document.getElementById('codigo').value;
        var monmov=document.getElementById(id).value;
        ...
        else
        {
          ...
          str3= str3.replace(',','');
           ...
           var numy9=parseFloat(stry9);
            ...
            document.getElementById(y3).value=calculo;

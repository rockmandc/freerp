...
$numfil=$_SESSION["configemp"]["aplicacion"]["presupuesto"]["modulos"]["PreSolTrasla"]["numfil"];
if ($numfil=='') $numfil=250;
...
while ($i<=$numfil) {
  ...
  $_POST["e".$i."1"]= "";
  $_POST["e".$i."2"]= number_format(0,2,'.',',');
  $_POST["f".$i."1"]= "";
  $_POST["f".$i."2"]= number_format(0,2,'.',',');
  $i=$i +1;
}
//CARGAR MASCARA
...
<script>
  function  actualizarsaldos2()
  {
    ...
    i=1;
    var acum3=0;
    var nfil=parseInt('<?php echo $numfil; ?>');
    while (i<=nfil)
    {
      var x3="x"+i+"3";
           ...
           for (i=1;i<=150;i++)
	       {
             ...
             while (seguir==true)
             {
	             ...
	             var mondes=parseFloat(str2);
                     ...
                     var calcu=parseFloat(mondes - monori - resto)

	             dif= parseFloat(format(calcu.toFixed(3),'.','.',','));
	             if (dif >=0)
	             {
                       seguir=false;

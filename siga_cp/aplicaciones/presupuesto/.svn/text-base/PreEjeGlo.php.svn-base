...
<body>
<form name="form1" onsubmit="return false;" method="post" action="PreEjeGlo.php?var=<? echo 'C'; ?>">
...
<table width="100%" align="center" class="bodyline">
                ...
                <tr>
                  ...
                  echo "<option value='00' selected='selected'	>00</option>";
                              for ($i=1;$i<=$numper;$i++)
                              {
                                $i=str_pad($i,2,'0',(int)STR_LEFT_PAD);
                                if ($i==$per)
                                {
...
<script language="JavaScript">
    ...
    function buscarenter()
    {
     ...
     /// window.open(pagina,"Catalogo","menubar=no,toolbar=no,scrollbars=yes,width=580,height=400,resizable=yes,left=50,top=50");
          ...
          pagina='http://'+host+'/herramientas.php/generales/catalogo/metodo/Preasiini_Cpdeftit/clase/Cpdeftit/frame/form1/obj1/'+campo+'/obj2/'+campo2+'/campo1/codpre/campo2/nompre/submit/true';

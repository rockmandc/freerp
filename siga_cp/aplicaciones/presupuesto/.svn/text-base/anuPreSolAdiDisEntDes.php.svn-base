...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  if ($operacion=='S')   //Salvar de la pantalla de Anular
  {
    ...
    if ($tool->validarFechaPresup($fecanu))
    {
      ...
      ?>
        <script>
          alert('Se ha Anulado esta Solicitud de Crédito de Adición o Disminución para Entes Descentralizados...');
  ...
  if ($operacion=='E') //eliminar
  {
    ...
    ?>
      <script>
          alert('Se ha Eliminado esta Solicitud de Crédito de Adición o Disminución para Entes Descentralizados...');
          window.opener.document.location=("PreSolAdiDisEntDes.php");
         close();
      </script>
    <?
...
function anular()
{
  ...
  fecpre='<? print $fecpre;?>';
   f.action="anuPreSolAdiDisEntDes.php?operacion=A&codigo="+codigo+"&fecpre="+fecpre;
  f.submit();
...
function eliminar()
{
  f = document.form1;
  fecpre   = '<? print $fecpre;?>';
  f.action = "anuPreSolAdiDisEntDes.php?operacion=E&fecpre="+fecpre;
  f.submit();
}
function cancelar()
{
...
function salvar()
{
  ...
  else if (compareDate2(fecha, fecpre) < 0)
  {
    ...
    codigo=f.codigo.value;
    f.action="anuPreSolAdiDisEntDes.php?operacion=S&codigo="+codigo;
    f.submit();
  }
}

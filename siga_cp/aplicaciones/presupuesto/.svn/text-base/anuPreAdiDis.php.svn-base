         ...
         if (!$error)
         {
          ...
          ?>
            <script>
              ...
              window.opener.document.location=("PreAdiDis.php");
              close();
            </script>
          <?
         }else {
...
function anular()
{
  ...
  fecpre='<? print $fecpre;?>';
   f.action="anuPreAdiDis.php?operacion=A&codigo="+codigo+"&fecpre="+fecpre;
  f.submit();
...
function eliminar()
{
  f=document.form1;
  fecpre='<? print $fecpre;?>';
     f.action="anuPreAdiDis.php?operacion=E&fecpre="+fecpre;
  f.submit();
}
function cancelar()
{
...
function salvar()
{
  ...
  {
    codigo=f.codigo.value;
    f.action="anuPreAdiDis.php?operacion=S&codigo="+codigo;
    f.submit();
  }
}

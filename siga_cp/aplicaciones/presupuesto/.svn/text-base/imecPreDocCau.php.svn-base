...
$z= new tools();
  ...
  /////////////////////////////////////
    ...
    if ($imec=='I')
    {
      try
      {
        $sql="insert into cpdoccau (tipcau,nomext,nomabr,refier,afeprc,afecom,afecau,afedis,codtiptra)
            values ('".$tipdoc."','".$nomext."','".$nomabr."','".$radio."','".$radio0."','".$radio1."','".$radio3."','".$radio2."','".$codtiptra."')";

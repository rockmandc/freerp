...
if (!empty($_POST["var"]))
{
  ...
  if ($tb=$z->buscar_datos($sql))
  {
    ...
    $codtiptra=$tb->fields["codtiptra"];
    $sql2="select destiptra from cotiptra where codtiptra='".$codtiptra."' ";
    if ($tb2=$z->buscar_datos($sql2))
    {
      $destiptra=$tb2->fields["destiptra"];
    }
    else
    {
      $destiptra="";
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                   ...
                   <tr>
                        ...
                        <td>
                          <input name="codtiptra" type="text"  class="imagenInicio" id="codtiptra" onMouseOver="this.className='imagenFoco'" onMouseOut="this.className='imagenInicio'" value="<? print $codtiptra;?>" size="13" maxlength="15" onKeyPress="enterB(event,'codtiptra','destiptra','nomabr')">
                          <input name="Submit2" type="button" class="botton" value="..." onClick="catalogoB('codtiptra','destiptra','nomabr','C');">
                          <input name="destiptra" type="text"  class="imagenInicio" id="destiptra" onMouseOver="this.className='imagenFoco'" onMouseOut="this.className='imagenInicio'" value="<? print $destiptra;?>" size="48" readonly="true">
                        </td>
                      </tr>
                </table>
                </td>
...
<script language="JavaScript">
    ...
    function enterB(e,id,donde,foco)
    {
      if (e.keyCode==13)
      {
        aux= document.getElementById('codtiptra').value;
        if (aux!="")
        {
          f=document.form1;
          cuantos='Predocau1';
          sql='select destiptra as campo1 from cotiptra where trim(codtiptra)=trim(�'+aux+'�) order by codtiptra';

...
$modulo=$_SESSION["modulo"] . " > Def. Especificas > ".$forma;
  ...
  {
    //Datos Cabecera
    $sql="select rupcat,ruppar,nivdis,forpre,to_char(fecini,'dd/mm/yyyy') as fecini,to_char(feccie,'dd/mm/yyyy') as feccie,
      to_char(fecper,'dd/mm/yyyy') as fecper,
      numper,coraep,asiper
      from fordefniv where codemp='001'";
    if ($tb=$z->buscar_datos($sql))
    {
    ...
    $grid4=array();
    $arre=array();
    $sql="select * from forniveles order by consec";
    $tb=$bd->select($sql);
    $cont=0;
    while (!$tb->EOF)
    {
...
<table width="100%" align="center">
  <tr>
<td width="100%">
      <? require_once('../../lib/general/top_f.php'); ?>
    </td>
  </tr>
  <tr>
    ...
    if ($check!='1')
        ...
        else
        {
          ...
          ?>
                      ...
                      <tr>
                        <td class="box"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="bodyline">
                            <tr>
                              ...
                              <td width="65%"><table width="99%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td colspan="2"> <fieldset>
                                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                          <td width="12%">&nbsp;</td>
                                          <td width="45%">Asignaci&oacute;n Periodica</td>
                                          <td >
                       <label>
                       <? if ($asigper=='S') { ?>
                       ...
                       <? } ?>
                        ...
                        <? if ($numper!='12'){ ?> <option value="12">12</option> <? } ?>
                                  ...
                                  <tr>
                                    <td> <fieldset>
                                      <legend>Inicio de Correlativo AEP</legend>
                                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                          <td align="center"><input name="corr" type="text" id="corr" value="<? print $corr;?>"></td>
                                        </tr>
                                      </table>
                                      </fieldset></td>
                                    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                          <td><div align="center"><a href='javascript: periodos();'><img src="../../images/periodos.gif" width="77%" height="14%"></a></div></td>
                                        </tr>
                                      </table></td>
                                  </tr>
...
<script language="JavaScript">
    ...
    function validar_fecha2()
    {
     ...
     function periodos()
     {
      ...
      window.open(pagina,"Periodos","menubar=no,toolbar=no,scrollbars=no,width=300,height=280,resizable=yes,left=350,top=300");
     }
        ...
        if(confirm("�Realmente desea Salvar?"))
        {
          if (validar_fecha2())
          {
              if (verificar() && chequea_niveles())
              {
                ...
                imec='<? print $imec;?>';
                f.action="imecPreNivPreFor.php?imec="+imec;
                f.submit();
              }
              else
              {

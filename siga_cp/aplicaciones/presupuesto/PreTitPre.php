          ...
          <table width="100%" border="0">
            ...
            else
            {
             ...
             <?
                    ...
                    <td><select name="tiptit" id="tiptit" style="width:152px"  >
                            <option value="C" <? if (trim($tiptit)=="C") {
                                  print "selected";
                                }?>>CENTRALIZADO</option>
                            <option value="D" <? if (trim($tiptit)=="D") {
                                  print "selected";
  ...
  function onButtonClick(itemId,itemValue)// TOOLBAR
    {
      ...
      else if(itemId == '0_save')
      {
        ...
        var novalcta='<?php echo $novalcta; ?>';
        if (save=='S')
        {
        if(confirm("¿Realmente desea Salvar?"))
        {
          ...
          if (document.form1.codigopre.value=="")
            ...
            { alert("No puede salvar sin introducir la Descripción del Código Presupuestario"); }
              else if (document.form1.codcta.value=="" && loncod==lonfor && novalcta=="")
              { 

...
$modulo=$_SESSION["modulo"] . " > Def. Especificas > Documentos > ".$forma;
  ...
  {
    $var=$_POST["var"];
    if (!empty($_POST["tipdoc"])) {$tippag=strtoupper(trim($_POST["tipdoc"]));}
  /*  if ($var=='C') //CONSULTA
    {
      $tippag=strtoupper(trim($_POST["tipdoc"]));
    }
    else */
    if ($var=='1')//PRIMERO
    {
      if ($tb=$z->primerRegistro('cpdocpag','tippag'))
      {
        $tippag=strtoupper(trim($tb->fields["tippag"]));
      }
    }
    else if ($var=='2')//ANTERIOR
    {
      if (!empty($tippag))
      {
          $aux=strtoupper(trim($tippag));
        //chekeamos q no sea el primero
          $tb=$z->primerRegistro('cpdocpag','tippag');
          $tippag=strtoupper(trim($tb->fields["tippag"]));
          if ($aux!=$tippag)
          {
            $tb=$z->anteriorRegistro('cpdocpag','tippag',$aux,'N');
          }
          else
          {
            $tb=$z->ultimoRegistro('cpdocpag','tippag');
          }
      }
      else
      {
    ...
    else if ($var=='3')//SIGUIENTE
    {
      if (!empty($tippag))
      {
        ...
        if ($aux!=$tippag)
        {
          $tb=$z->proximoRegistro('cpdocpag','tippag',$aux,'N');
        }
         else
        {
          $tb=$z->primerRegistro('cpdocpag','tippag');
    ...
    {
      if ($tb=$z->ultimoRegistro('cpdocpag','tippag'))
      {
        $tippag=strtoupper(trim($tb->fields["tippag"]));
      }
    }
      //TRAER DATOS
      $sql="select * from cpdocpag where trim(upper(tippag))='".$tippag."' ";
      if ($tb=$z->buscar_datos($sql))
      {
        $tipdoc=$tb->fields["tippag"];
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                              ...
                              <td><input name="nomext" type="text" id="nomext" class="imagenInicio" onMouseOver="this.className='imagenFoco'" onMouseOut="this.className='imagenInicio'" size="75" value="<? print $nomext;?>" onKeyPress="focos(event,'nomabr')"></td>
                            </tr>
                            <tr>
                              <td>&nbsp;</td>
                              <td>&nbsp;</td>
                    ...
                    <table width="95%" border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                          ...
                                          <td width="20%"><label>
                                            <? if (($refprc=='N') || ($refprc=='')) { ?>
                                            <input type="radio" name="radio" id="radio" value="N" checked>
                                            <? } else { ?>
          ...
          <tr>
            <td>
              <div class="tabber">
                 <div class="tabbertab">
                  <h2>Precompromiso</h2>
                    <table width="522" height="100%" align="left" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF" class="recuadro">
                    <tr valign="middle">
                     ...
                     <fieldset>
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <td width="37%">
                          <label>
                          <? if ($afeprc=='S') { ?>
                          <input type="radio" name="radio0" id="radio0" value="S" checked>
                          <? } else { ?>
                        ...
                        <td width="38%">
                          <label>
                          <? if ($afeprc=='R') { ?>
                          <input type="radio" name="radio0" id="radio0" value="R" checked>
                          <? } else { ?>
                        ...
                        <td width="25%">
                          <label>
                          <? if (($afeprc=='N') || ($afeprc=='')) { ?>
                          <input type="radio" name="radio0" id="radio0" value="N" checked>
                          <? } else { ?>
                     ...
                     <fieldset>
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <td width="37%">
                          <label>
                          <? if ($afecom=='S') { ?>
                          <input type="radio" name="radio1" id="radio1" value="S" checked>
                          <? } else { ?>
                        ...
                        <td width="38%">
                          <label>
                          <? if ($afecom=='R') { ?>
                          <input type="radio" name="radio1" id="radio1" value="R" checked>
                          <? } else { ?>
                        ...
                        <td width="25%">
                          <label>
                          <? if (($afecom=='N') || ($afecom=='')) { ?>
                          <input type="radio" name="radio1" id="radio1" value="N" checked>
                          <? } else { ?>
                     ...
                     <fieldset>
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <td width="37%">
                          <label>
                          <? if ($afecau=='S') { ?>
                          <input type="radio" name="radio3" id="radio3" value="S" checked>
                          <? } else { ?>
                        ...
                        <td width="38%">
                          <label>
                          <? if ($afecau=='R') { ?>
                          <input type="radio" name="radio3" id="radio3" value="R" checked>
                          <? } else { ?>
                        ...
                        <td width="25%">
                          <label>
                          <? if (($afecau=='N') || ($afecau=='')) { ?>
                          <input type="radio" name="radio3" id="radio3" value="N" checked>
                          <? } else { ?>
                     ...
                     <fieldset>
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <td width="37%">
                          <label>
                          <? if ($afepag=='S') { ?>
                          <input type="radio" name="radio4" id="radio4" value="S" checked>
                          <? } else { ?>
                          <input type="radio" name="radio4" id="radio4" value="S">
                          <? } ?>
                          Suma
                          </label>
                        </td>
                        <td width="38%">
                          <label>
                          <? if ($afepag=='R') { ?>
                          <input type="radio" name="radio4" id="radio4" value="R" checked>
                          <? } else { ?>
                          <input type="radio" name="radio4" id="radio4" value="R">
                          <? } ?>
                          Resta
                          </label> </td>
                        <td width="25%">
                          <label>
                          <? if (($afepag=='N') || ($afepag=='')) { ?>
                          <input type="radio" name="radio4" id="radio4" value="N" checked>
                          <? } else { ?>
                     ...
                     <fieldset>
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <td width="37%">
                          <label>
                          <? if ($afedis=='S') { ?>
                          <input type="radio" name="radio2" id="radio2" value="S" checked>
                          <? } else { ?>
                        ...
                        <td width="38%">
                          <label>
                          <? if ($afedis=='R') { ?>
                          <input type="radio" name="radio2" id="radio2" value="R" checked>
                          <? } else { ?>
                        ...
                        <td width="25%">
                          <label>
                          <? if (($afedis=='N') || ($afedis=='')) { ?>
                          <input type="radio" name="radio2" id="radio2" value="N" checked>
                          <? } else { ?>
...
<script language="JavaScript">
      ...
      function consulta()
      {
          ...
          var campo='nomext';
          var foco='submit';
          //sql='Select nomext as Nombre_Extendido,tippag as Tipo,nomabr as Nombre_Abreviado From CPDocPag where upper(nomext) like upper(�%�)  Order By tippag';
          ...
          pagina='http://'+host+'/herramientas.php/generales/catalogo/metodo/Cpdocpag_Predocpag/clase/Cpdocpag/frame/form1/obj1/tipdoc/campo1/tippag/submit/true';
     ...
     function salvar()
    {
      ...
      if (save=='S')
      {
        if(confirm("�Realmente desea Salvar?"))
        {
          ...
          {
            imec='<? print $imec;?>';
            f.action="imecPreDocPag.php?imec="+imec;
            f.submit();
          }
        }
      }
    ...
    function verificar()
    {
      ...
      if (!verificar_campo_clave(0,f.tipdoc.value,"No puede salvar sin introducir un Tipo del Pago"))
      {
        return false;
      }

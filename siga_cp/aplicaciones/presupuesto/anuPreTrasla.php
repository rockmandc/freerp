...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  if ($tool->validarFechaPresup($fecpre))
  {
        ...
        $error=false;
         $sqlDet="select coddes as codpre, monmov as monmov From CPMovTra Where trim(Reftra)='".trim($codigo)."'";
         ...
         if (!$error)
         {
            ...
            <?
             ...
             print 'jfdgaksdf'; exit();
             ?>
              <script>
                alert('El Traslado no se puede anular debido a que Existe un movimiento asociado con el titulo presupuestario...');
                window.opener.document.location=("PreTrasla.php");
                 close();
              </script>
            <?
        ...
        $error=false;
         ...
         if (!$error)
         {
          ...
          $bd->completeTransaccion();
             ...
             ?>
          <script>
            alert('El Traslado no se puede eliminar debido a que Existe un movimiento asociado con el titulo presupuestario...');
            window.opener.document.location=("PreTrasla.php");
            close();
          </script>
        <?

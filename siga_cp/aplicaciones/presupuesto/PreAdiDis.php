          ...
          if (!$tb->EOF)
           {
            ...
            if (strtoupper(trim($status))=="N")
            {
             ...
             while (!$tb2->EOF)
             {
                ...
                if ($tb2->fields["tipo"]=='O')
                   $_POST["x".$pos."7"]="ORIGEN";
                else
                    $_POST["x".$pos."7"]="DESTINO";
                $tb2->MoveNext();
                $pos=$pos+1;
             }
              ...
              <? print  $estado;?>
                 ...
                 <tr>
                  ...
                  <? } ?>
                                  ...
                                  <tr>
                      <td width="1">&nbsp;</td>
                     <td width="94">&nbsp;Clasificación: </td>
                      <td width="180"><? if ($imec=='M') { ?>
                        <select name="clasifica" id="clasifica" style="width:152px" disabled="true">
  <? } else { ?>
                          <select name="clasifica" id="clasifica" style="width:152px"  >
  <? } ?>
                            <option value="C" <? if (trim($clasifica)=="C") {
                                              print "selected";
                                            }?>>CR&Eacute;DITO</option>
                            <option value="R" <? if (trim($clasifica)=="R") {
                                              print "selected";
                                              }?>>REFORMULACI&Oacute;N</option>
                  ...
                  while ($i<=$numfil)
                  {
                     ?>
                        <tr>
                          ...
                          <td  align="right" class="grid_line01_br"><input name="x<? print $i;?>7" id="x<? print $i;?>7" type="text" class="breadcrumbv2" size="16" value="<? print  $_POST["x".$i."7"];?>" align="right" readonly="true"></td>
                        </tr>
                    <?
                    $i=$i+1;
                  }  //while

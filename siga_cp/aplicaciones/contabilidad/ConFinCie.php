            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="2">
                ...
                <tr >
                  <td height="22" colspan="3"  align="right"><div align="center">
                    ...
                    <input type="button" name="cerrar" value="Generar Comprobantes de Cierre" onClick="formulario('2')">
                  </div></td>
                </tr>
  ...
  function formulario(dato)
           {
               ...
               if (dato=='1')
               {
                   var esqori=$('esquemaorigen').value;
                   var esqdes=$('esquemadestino').value;
					f.action="imecConFinComGen.php?var=1&esqori="+esqori+"&esqdes="+esqdes;
               		f.submit();
               }else{
               		f.submit();
               }

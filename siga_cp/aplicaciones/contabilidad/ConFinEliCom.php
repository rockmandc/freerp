...
$modulo="";
$forma="Eliminar Comprobantes Anulados";
...
<table width="100%" border="0" align="center">
  ...
  <table width="485" border="0"  class="box">
    <tr>
        <td class="breadcrumb">FREERP  <? echo $modulo; ?>
      </tr>
      <tr>
...
<table width="100%"  border="0" cellpadding="0" cellspacing="0">
  ...
  // Se elimino STACOM='R'
  // Por Rene y Vannesa 15-09-08
  //$sql="Select * From CONTABC Where STACOM='N' OR STACOM='R' Order By FecCom,NumCom asc";
  $sql="Select * From CONTABC Where STACOM='N'  Order By FecCom,NumCom asc";
    ...
    $i=$i+1;
      ...
      Mensaje("No Existen Comprobantes para Eliminar");
    ?>
    <tr>
...
<script language="JavaScript">
  ...
  function Limpiar()
         ...
         function onButtonClick(itemId,itemValue)// TOOLBAR
    {
      ...
      else if(itemId == '0_delete')
      {
        if(confirm("¿Realmente desea Eliminar?"))
        {
          ...
          if (estado=='Si'){
            f.action="imecConFinEliCom.php?imec=<? echo 'S'; ?>";
            f.submit();
          }
        }
      }
    ...
    aToolBar.loadXML("../../lib/general/_toolbarV4.xml")

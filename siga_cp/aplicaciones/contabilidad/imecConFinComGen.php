...
//validar(array(11,15),'contabilidad','confincie.php');            //Seguridad  del Sistema
...
$z= new tools();
 ...
 function TrasladarSaldos()
 {
 	...
 	$CodOrigen="SIMA".$esqori;//$_SESSION["esquemaorigen"];
  	$CodDestino="SIMA".$esqdes; //$_SESSION["esquemadestino"];
     ...
     $sql = "update ".chr(34)."$CodDestino".chr(34).".contabb
     		 ...
     		 ".chr(34)."$CodOrigen".chr(34).".contabb1.PerEje='12')
                 where
                 ".chr(34)."$CodDestino".chr(34).".contabb.codcta in (select codcta from  ".chr(34)."$CodOrigen".chr(34).".contabb)    
                 ";

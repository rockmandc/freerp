...
class Compras extends baseClases
{
	...
	{
	 $sql="select distinct(a.codpro) as codigo, b.nompro as nombre from carcpart a, caprovee b where (a.codpro=b.codpro) and (a.codpro like '%V_0%' AND b.nompro like '%V_1%') order by codpro ";
	...
	{
		$sql="Select distinct(ordcom) as orden, desord as descripcion from caordcom where ordcom like 'OS%' and ( ordcom like '%V_0%' AND desord like '%V_1%' ) order by ordcom";

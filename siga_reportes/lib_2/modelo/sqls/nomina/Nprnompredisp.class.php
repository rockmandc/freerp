...
class Nprnompredisp extends BaseClases {
  ...
  public function SQLp($codempdes,$codemphas,$tipnomdes,$tipnomhas,$codcardes,$codcarhas,$especial,$codnomesp,$codcondes,$codconhas,$cod1)
    ...
    public function SQLnomnom($codnom)
    {
      ...
      return $this->select($sql);
        ...
        public function SQLdisponibilidad($codpre)
    {
      $sql="select  monasi + coalesce(obtener_ejecucion(codpre,'01','12',anopre,'TRA'),0)+
		 coalesce(obtener_ejecucion(codpre,'01','12',anopre,'ADI'),0) -
	       ( coalesce(obtener_ejecucion(codpre,'01','12',anopre,'PRC'),0)+
		 coalesce(obtener_ejecucion(codpre,'01','12',anopre,'TRN'),0)+
		 coalesce(obtener_ejecucion(codpre,'01','12',anopre,'DIS'),0))  as DISP

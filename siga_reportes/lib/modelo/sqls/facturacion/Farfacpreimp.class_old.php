...
$sql= "select distinct (a.reffac) as reffac, to_char(a.fecfac,'dd/mm/yyyy') as fecha,
          ...
          d.numero as numero,a.observ as observacion, a.obstra as nota, mondesc as descuento

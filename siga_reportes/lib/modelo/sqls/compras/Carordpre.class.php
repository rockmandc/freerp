...
class Carordpre extends baseClases
{
  ...
  $sql="SELECT DISTINCT A.ORDCOM,
      ...
      A.DOCCOM AS DOCCOM,
      E.TELPRO AS TELPRO, b.dtoart as dcto,a.notord as obs, b.canaju as canaju
      ...
      f.codartpro=b.codcat
      ORDER BY A.ORDCOM,to_char(a.fecord,'DD/MM/YYYY'),B.CODCAT, b.desart";

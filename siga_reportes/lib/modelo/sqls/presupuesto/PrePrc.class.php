...
/////////////////////////////////////////////////////////////7777777
  	   ...
  	   $sql= " SELECT
			   ...
			   (B.MonImp-B.MonAju) as Mon_Aju
				...
				AND B.CODPRE LIKE RTRIM('".$comodin."')".$staprc."
				UNION
				SELECT
				...
				AND (B.CODPRE >=RTRIM('".$codpre1."') AND B.CODPRE<=RTRIM('".$codpre2."'))
				AND B.CODPRE LIKE RTRIM('".$comodin."')".$stacom."
				UNION
				SELECT
				...
				AND (B.CODPRE >=RTRIM('".$codpre1."') AND B.CODPRE<=RTRIM('".$codpre2."'))
				AND B.CODPRE LIKE RTRIM('".$comodin."')".$stacau."
				UNION
				SELECT
				...
				AND (B.CODPRE >=RTRIM('".$codpre1."') AND B.CODPRE<=RTRIM('".$codpre2."'))
				AND B.CODPRE LIKE RTRIM('".'%'.$comodin."')".$stapag."ORDER BY fecha,referencia desc,codigo,estat

...
class Cabecera
{
  ...
  function poner_cabecera($objeto,$rep,$configuracion,$pagina,$departamento)
  {
    if($configuracion=="p")
    {
      ...
      //if($pagina=="s")
      {
       ...
       $objeto->Ln(-5);
        $objeto->Cell(180,10,'Multiequipos Samoa C.A.',0,0,'C');
      $objeto->Ln(5);
      $objeto->Cell(180,10,'Rif: J-40060588-1',0,0,'C');
      $objeto->Ln(3);
  ...
  public function getCabecera($pdf,$titulo='',$departamento='')
  {
	...
	$pdf->Cell(180,5,'Multiequipos Samoa C.A.',0,0,$c['empresa']['pos']);

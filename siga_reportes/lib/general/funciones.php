...
function LlenarComboSql($sql,$campo1,$campo2,$seleccionado='',$con,$primer='0')
  {

  	 if ($primer!="0")
       {?> <option value="" selected><? print $primer;?></option>  <?}
  ...
  $decimal=" BOLÍVARES CON ".substr($monchar,$pospunto+1)."/100";
  ...
  return $sexto.$sepmil6.$quinto.$sepmil5.$cuarto.$sepmil4.$tercero.$sepmil3.$segundo.$sepmil2.$primero.$sepmil1.$decimal.' CENTIMOS.';
 // return $sexto.$sepmil6.$quinto.$sepmil5.$cuarto.$sepmil4.$tercero.$sepmil3.$segundo.$sepmil2.$primero.$sepmil1.' Bs.'.$decimal.' CENTIMOS.';
}//function montoescrito($numero,$con)
  /////////////////////////////////////////////////////////////////////////////////////////////////////

function anoescrito($numero,$con)
  {
  $poscoma=0;
  $nombre='';
  $contmil=0;
...
function TraerModuloReporte()
{
	$aux = split('/',$_SERVER["REQUEST_URI"]);
	$modulo = $aux[count($aux)-2];

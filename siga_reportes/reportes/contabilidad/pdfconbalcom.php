<?
	...
	class pdfreporte extends fpdf
	{
		...
		function pdfreporte()
		{
			...
			$this->objConbalcom = new Conbalcom();
			$this->ChequearActualizar();
			$this->obtenerFecha();		   
            $this->arrp = $this->objConbalcom->SQLP($this->periodo, $this->fecha_ini, $this->fecha_cie, $this->nivel, $this->codcta1, $this->codcta2, $this->comodin);
		...
		function ChequearActualizar()
		{
		  if ($this->actualizar=='SI'){
			 ...
			 $this->objConbalcom->actualizar_balance();

        ...
        <div align="left">&nbsp; 
          <table width="612" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF"> 
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>Flujo de Caja 
            ...
            <tr bordercolor="#6699CC"> 
              ...
              <td colspan="2"> <div align="left"> </div>
                <div align="left">
                  <input name="filtro" type="text" class="breadcrumb" id="filtro" value="%" size="50" >
</div></td>
            </tr>
            <tr bordercolor="#6699CC"> 
...
{
	f=document.form1;
	f.titulo.value="Flujo de Caja";
	f.action="rconrflucaj.php";
	f.submit();
}
function cerrar()
{

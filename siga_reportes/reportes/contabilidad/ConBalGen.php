          ...
          <table width="548" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr>
              ...
              <td>
                <div align="left">
                  <?
				$tb=$bd->select("SELECT DISTINCT(CODCTA)  FROM CONTABB WHERE CODCTA<'5' ORDER BY CODCTA");
				print $tb->GetMenu('codcta1','1',true,false,0,'class=breadcrumb');
				?>
              </div></td>
              <td>
                <div align="left">
				<?
   			    $tb2=$bd->select("SELECT DISTINCT(CODCTA)  FROM CONTABB WHERE CODCTA<'5' ORDER BY CODCTA DESC");
				print $tb2->GetMenu('codcta2',false,true,false,0,'class=breadcrumb');
				?>
				</div></td>
              ...
              <td colspan="2"><?
				  $tb10=$bd->select("SELECT numrup as nrorup FROM CONTABA");
					if (!$tb10->EOF)
						{
						 $auxnivel=$tb10->fields["nrorup"];
						 $auxnivel2=$tb10->fields["nrorup"];
						 }

			  ?>
                <input name="auxnivel2" type="text" class="breadcrumb" id="auxnivel2" size="8" maxlength="10" value="<? print $auxnivel; ?>">
                <font color="#000066" size="4"><strong>
             ...
             <tr bordercolor="#6699CC">
              ...
              <td> <div align="left"> </div>
                <div align="left">
                  ...
                  <input name="p_fecha" type="text" class="breadcrumb" id="p_fecha" datepicker="true" value="">
                </div></td>
            ...
            <tr bordercolor="#6699CC">
              ...
              <td colspan="2"> <div align="left"></div>
                <div align="left">
                  <input name="elaborado" type="text" class="breadcrumb" id="elaborado" value="" size="75">
                  <input name="sqls" type="hidden" id="sqls">
                </div></td>
            </tr>
		      ...
		      <tr bordercolor="#6699CC">
              <td class="form_label_01"> <div align="left"><strong>Cargo Elaborado Por:</strong></div></td>
              <td colspan="2"> <div align="left"></div>
                <div align="left">
                  <input name="car_elaborado" type="text" class="breadcrumb" id="car_elaborado" value="" size="75">
                  <input name="sqls" type="hidden" id="sqls">
                </div></td>
            </tr>
              ...
              <td colspan="2"> <div align="left"></div>
                <div align="left">
                  <input name="revisado" type="text" class="breadcrumb" id="revisado" value="" size="75">
                  <input name="sqls" type="hidden" id="sqls">
                </div></td>
            </tr>

				      <tr bordercolor="#6699CC">
              <td class="form_label_01"> <div align="left"><strong>Cargo Revisado Por:</strong></div></td>
              <td colspan="2"> <div align="left"></div>
                <div align="left">
                  <input name="car_revisado" type="text" class="breadcrumb" id="car_revisado" value="" size="75">
                  <input name="sqls" type="hidden" id="sqls">
                </div></td>
            </tr>

					      <tr bordercolor="#6699CC">
              <td class="form_label_01"> <div align="left"><strong>Aprobado Por:</strong></div></td>
              <td colspan="2"> <div align="left"></div>
                <div align="left">
                  <input name="aprobado" type="text" class="breadcrumb" id="aprobado" value="" size="75">
                  <input name="sqls" type="hidden" id="sqls">
                </div></td>
            </tr>

				      <tr bordercolor="#6699CC">
              <td class="form_label_01"> <div align="left"><strong>Cargo Aprobado Por:</strong></div></td>
              <td colspan="2"> <div align="left"></div>
                <div align="left">
                  <input name="car_aprobado" type="text" class="breadcrumb" id="car_aprobado" value="" size="75">
                  <input name="sqls" type="hidden" id="sqls">
                </div></td>
            </tr>
...
{
	f=document.form1;
	f.titulo.value="Estado de Situación Financiera";
	f.action="rConBalGen.php";
	f.submit();
}
function cerrar()
{

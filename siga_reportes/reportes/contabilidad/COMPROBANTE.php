          ...
          <table width="612" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr bordercolor="#6699CC"> 
              ...
              <td> <div align="left"> </div>
				...
				?>
                  <input name="fecha1" type="text" class="breadcrumb" id="fecha1" value="<? print $fecha1;?>" size="12" datepicker="true">
                </div></td>
              <td><input name="fecha2" type="text" class="breadcrumb" id="fecha2" value="<? print $fecha2;?>" size="12" datepicker="true"></td>
            </tr>

	   <tr>
              <td class="form_label_01"><div align="left"><strong>Comprobante Nro:</strong></div></td>
              <td><div align="left">
              ...
              <td><input name="com2" type="text" class="breadcrumb" id="com2"
                   value="<?$sql="select max(numcom) as cod from contabc";
                                        LlenarTextoSql($sql,"cod",$bd); ?>" size ="20">
                  <input type="button" name="Button2" value="..." onClick=" catalogo1('com2');">
              </td>
            </tr>
...
{
	f=document.form1;
	f.titulo.value="COMPROBANTE DE DIARIO";
	f.action="rCOMPROBANTE.php";
	f.submit();
}
function cerrar()
{

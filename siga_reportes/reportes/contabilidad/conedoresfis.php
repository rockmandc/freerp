          ...
          <table width="548" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr>
              <td class="form_label_01">
				...
				?>" class="breadcrumb" id="codctades" size="15" maxlength="100">
                ...
                LlenarTextoSql($sql,"codcta",$bd);
				?>" class="breadcrumb" id="codctahas" size="15" maxlength="100">
            ...
            <tr>
              ...
              <td>
			  <input name="auxnivel" type="text" class="breadcrumb" id="auxnivel" size="8" maxlength="10" value="<?
              	$sql="SELECT numrup as codcta FROM CONTABA";
                LlenarTextoSql($sql,"codcta",$bd);
                ?>">
			  </td>
              <td>&nbsp;</td>

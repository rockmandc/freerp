              ...
              <td>
                  <input name="com2" type="text" class="breadcrumb" id="com2"
                   value="<?$sql="select max(numcom) as cod from contabc";
 					LlenarTextoSql($sql,"cod",$bd); ?>" size ="20">
 					 <input type="button" name="Button4" value="..." onClick=" catalogo3('com2');">
			  </td>
            </tr>
            <tr bordercolor="#6699CC"> 
...
{
	f=document.form1;
	f.titulo.value="RESUMEN DE COMPROBANTES";
	f.action="rCONRESCOM.php";
	f.submit();
}
function cerrar()
{
...
function catalogo2()
{
   ...
   {
      mysql='select numcom as numero, descom as descripcion from contabc order by numcom';

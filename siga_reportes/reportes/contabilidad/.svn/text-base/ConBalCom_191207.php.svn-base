            ...
            <tr>
             <!-- <td class="form_label_01"><div align="left"><strong>Cuenta Contable:</strong></div></td>-->
               <td class="form_label_01">
                <div align="left"><strong>Código de la Cuenta:</strong></div></td>
              <td>
                <div align="left">
                  <?
				$tb=$bd->select("SELECT CODCTA  FROM CONTABB order by codcta");
				print $tb->GetMenu('CODCTA','1',true,false,0,'class=breadcrumb');
				?>
              </div></td>
              <td>
                <div align="left">
				<? 
   			    $tb2=$bd->select("SELECT CODCTA  FROM CONTABB order by codcta desc");
				print $tb2->GetMenu('CODCTA1','7',true,false,0,'class=breadcrumb');								
				?>
				</div></td>
            </tr>
            <tr>

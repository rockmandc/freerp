...
var $inv;
		...
		function pdfreporte()
		{
			...
			$this->sql="SELECT  A.ORDEN,
								A.TITULO,
								A.CUENTA,
								SUBSTR(A.NOMBRE,1,50) AS NOMBRE,
								A.DEBITO,
								A.CREDITO,
								A.SALDO as SALDO,
								A.CARGABLE
						...
						(SELECT RTRIM(A.CODCTA) AS ORDEN,
						    A.CODCTA AS TITULO,
							A.CODCTA AS CUENTA,						 	
						 	SUBSTR(B.DESCTA,1,50) AS NOMBRE,
						 	A.TOTDEB AS DEBITO,
						 	A.TOTCRE AS CREDITO,
							 A.SALACT AS SALDO,
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		function Header()
		{
			...
			$this->cell(40,10,"Hasta: ".$dia."-".$mes."-".$year);		
			//$this->cell(20,10,"Hasta: ".$this->fecha_cie);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
         /****ARCHIVO EXCEL***/
         $nombre_archivo="estado_resultado".strftime('%d_%m_%Y',time()).".xls";
				 ...
				 $this->setFont("Arial","",8);  
					 ...
					 //and trim($tb->fields["cargable"]=='C'))
					 {
						...
						$descta=$tb->fields["titulo"]." ".$tb->fields["nombre"];		
 					    $this->cell($this->anchos[0],10,$tb->fields["cuenta"]);
 					    $this->cell($this->anchos[1],10,$descta);
						...
						//Esta cadena muestra  las cuentas con saldo 0
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
$cadena=$tb->fields["cuenta"]."\t".$tb->fields["nombre"]."\t".$tb->fields["saldo"]."\t".chr(13).chr(10);
fputs($depositos,$cadena);
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			  ...
			  if (($niv == (($this->nrorup)-2) and (($this->nrorup)-2) >0) and (trim($tb->fields["cargable"]=='C')) and (trim($tb->fields["saldo"]<>0)) ){
				  $this->cell($this->anchos[3],10,number_format($tb->fields["saldo"],2,'.',','),0,0,'R');
			   } else{
				   ...
				   if (( ($niv == (($this->nrorup)-4) and (($this->nrorup)-4) >0) or 
					   ...
					   (trim($tb->fields["cargable"]=='N'))  and  (trim($tb->fields["titulo"]=='TOTAL')) and (trim($tb->fields["saldo"]<>0)) )
					  {
						...
						/// Para hacer la raya ////
							   if ( ($niv == ($this->nrorup)-4) and ((($this->nrorup)-4) >0) and 
								   ($mov<>'C') and (trim($tb->fields["titulo"]=='TOTAL')) ) 
									{ $this->Line($this->GetX()+4,$this->GetY()+2,$this->GetX()+35,$this->GetY()+2); }

						/// ///// ////							
						
						 $this->cell($this->anchos[4],10,"");
						...
						$this->cell($this->anchos[6],10,number_format($tb->fields["saldo"],2,'.',','),0,0,'R');			
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			 ...
			 $this->cell(188,10,"    TOTAL RESULTADO DEL EJERCICIO     ");				 

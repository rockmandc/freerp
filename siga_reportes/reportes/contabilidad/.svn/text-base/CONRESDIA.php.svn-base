        ...
        <div align="left">&nbsp; 
          <table width="612"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF"> 
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>RESUMEN 
                  DE DIARIO 
            ...
            <tr bordercolor="#6699CC"> 
              ...
              <td><select name="per1" class="breadcrumb" id="per1">
              ...
              <td><select name="per2" class="breadcrumb" id="per2">
                  <option value="12">12</option>
                  <option value="11">11</option>
                  <option value="10">10</option>
                  <option value="09">09</option>
            ...
            <tr>
              ...
              <td><div align="left">
                  <input name="com1" type="text" class="breadcrumb" id="com1"
                   value="<?$sql="select min(a.codcta) as cod from contabb1 a, contabb b where a.codcta=b.codcta";
 					LlenarTextoSql($sql,"cod",$bd); ?>" size ="20">
                  <input type="button" name="Button1" value="..." onClick=" catalogo1('com1');">
              </div></td>
              <td><input name="com2" type="text" class="breadcrumb" id="com2"
                   value="<?$sql="select max(a.codcta) as cod from contabb1 a, contabb b where a.codcta=b.codcta";
 					LlenarTextoSql($sql,"cod",$bd); ?>" size ="20">
                  <input type="button" name="Button2" value="..." onClick=" catalogo1('com2');">              </td>
            </tr>
            <tr> 
...
{
	f=document.form1;
	f.titulo.value="RESUMEN DE DIARIO";
	f.action="rCONRESDIA.php";
	f.submit();
}
function cerrar()
{
   ...
   {
      mysql='select distinct (a.codcta) as cod, b.descta from contabb1 a, contabb b where a.codcta=b.codcta';

          ...
          <table width="548" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr>
              <td class="form_label_01">
                <div align="left"><strong>Codigo de la Cuenta:</strong></div></td>
              <td><div align="left">
                    <input name="codcta1" type="text" value="<?
				$sql="SELECT min(CODCTA) as codcta FROM CONTABB";
                LlenarTextoSql($sql,"codcta",$bd);
				?>" class="breadcrumb" id="codcta1" size="15" maxlength="100">
                    <input type="button" name="Button" value="..." onClick="catalogo('codcta1');">
                </div></td>
                <td><div align="left"> </div>
                  <div align="left">
                    <input name="codcta2" type="text" value="<?
				$sql="SELECT max(CODCTA) as codcta FROM CONTABB";
                LlenarTextoSql($sql,"codcta",$bd);
				?>" class="breadcrumb" id="codcta2" size="15" maxlength="100">
                    <input type="button" name="Button" value="..." onClick="catalogo('codcta2');">
                </div></td>
            </tr>
            <tr>
              ...
              <td><select name="nivel" class=breadcrumb id="nivel">
            ...
            <tr>
              ...
              <td><select name="actualiza" class=breadcrumb id="actualiza">
...
{
    pagina="../../lib/general/catalogoobj.php?campo="+campo+"&sql=SELECT DISTINCT(CODCTA) as Cuenta FROM CONTABB ORDER BY CODCTA";

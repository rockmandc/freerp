            ...
            <tr>
              ...
              <td>
                <div align="left">
			  	...
			  	$tb=$bd->select("SELECT DISTINCT(CODCTA) as codcta FROM CONTABB ORDER BY CODCTA");
               ?>
                  <select name="codcta1" class="breadcrumb" id="select2">
                    <?
				  	while(!$tb->EOF)	
					{
				  ?>

          ...
          <table width="548" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr>
              ...
              <td>
                <div align="left">
                  <?
				//NO se sabe que hace el GetMenu();
				//$tb=$bd->select("SELECT DISTINCT(CODCTA)  FROM CONTABB where codcta!=' ' ORDER BY CODCTA ");
				//print $tb->GetMenu('codcta1','1',true,false,0,'class=breadcrumb');
				 ...
				 <?			  	
			  	   $tb=$bd->select("SELECT DISTINCT(CODCTA)  FROM CONTABB where codcta!=' ' ORDER BY CODCTA ");
                 ?>
                <select name="codcta1" class="breadcrumb" id="codcta1">
                  <?
				  	while(!$tb->EOF)	
					{
				  ?>
              ...
              <td>
                <div align="left">
				<?			  	
			  	   $tb=$bd->select("SELECT DISTINCT(CODCTA)  FROM CONTABB where codcta!=' ' ORDER BY CODCTA DESC ");
                 ?>
                <select name="codcta2" class="breadcrumb" id="codcta2">
                  <?
				  	while(!$tb->EOF)	
					{
				  ?>

        ...
        <div align="left">&nbsp;
          <table width="612" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF">
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>Mayor Anal&iacute;tico
	    ...
	    <tr>
            ...
            <tr bordercolor="#6699CC">
              ...
              <td> <div align="left"> </div>
				...
				?>
                  <input name="feccom1" type="text" class="breadcrumb" id="feccom1" value="<? print $fecini;?>" size="12" datepicker="true">
</div></td>
              <td><input name="feccom2" type="text" class="breadcrumb" id="feccom2" value="<? print $fecdes;?>" size="12" datepicker="true"></td>
            </tr>
			  <tr bordercolor="#6699CC">
...
{
	f=document.form1;
	f.titulo.value="Mayor Analitico";
	f.action="rconmayana.php";
	f.submit();
}
function cerrar()
{

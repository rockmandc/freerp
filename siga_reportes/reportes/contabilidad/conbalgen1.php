            ...
            <tr>
              ...
              <td>
                <div align="left">
                  ...
                  <a href="#"><img src="../../img/search.gif" align="top" onclick="catalogo('conbalgen1',0); "></a>   <!--AQUI SE HACEN LOS CATÁLOGOS -->

              </div></td>
              <td>
                <div align="left">
                  <? $tb=$bd->select("SELECT DISTINCT(codcta) FROM CONTABB  where codcta<'5' ORDER BY codcta desc");?>

                  <input name="codcta2" type="text" class="breadcrumb" id="codcta2" value="<? echo $tb->fields['codcta'] ?>" size ="20">
                  <a href="#"><img src="../../img/search.gif" align="top" onclick="catalogo('conbalgen1',1); "></a>   <!--AQUI SE HACEN LOS CATÁLOGOS -->

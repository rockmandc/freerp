        ...
        <div align="left">&nbsp;
          <table width="647"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF">
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>Historico Nomina de Pago por Nivel Organizacional
         ...
         <td class="form_label_01"><strong>Revisado Por: </strong></td>
             ...
             <tr>
              <td class="form_label_01"><strong>  </strong></td>
                ...
                <td><input name="revisado2car" type="text" class="breadcrumb" id="revisado2car" value="Directora de Administración y Finanzas " size="30"></td>
...
function enviar()
{
  ...
  f.action="rnprhistnomdefniv.php";
  f.submit();
}
function cerrar()
{

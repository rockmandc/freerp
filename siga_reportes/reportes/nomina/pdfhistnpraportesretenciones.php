...
//	A.fecnom >= to_date('".$this->fecreg1."','dd/mm/yyyy') AND A.fecnom <= to_date('".$this->fecreg2."','dd/mm/yyyy')
			...
			{
				$cond="";
				if ($this->tipnom=='001' and $this->especial == 'N')
					{
				...
				$this->sql2="SELECT
						...
						A.fecnom <= to_date('".$this->fecreg2."','dd/mm/yyyy') and
                        			a.codcon=e.codcon  and 	
						montorethist('".$this->codtipapodes."','A',A.CODNOM,B.CODEMP,A.CODCAR,'".$this->fecreg1."','".$this->fecreg2."') > 0
...

				{
					//DETALLE DEL TIPO DE APORTE Y RENTENCION
						...
						while (!$tb2->EOF)
						{
							...
							if ($tb2->fields["monto"] > $this->tope and ( $this->tb->fields["codtipapo"]=='0001' or $this->tb->fields["codtipapo"]=='0002') ){
								$tb2->fields["monto"]=$this->tope;
							}

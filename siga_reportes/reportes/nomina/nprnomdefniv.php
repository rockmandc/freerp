      ...
      <tr>
        ...
        ?>" class="breadcrumb" id="tipnomesp" size="20" maxlength="50">
           ...
           <tr>
              ...
              <td ><input name="elaborado" type="text" class="breadcrumb" id="elaborado" value=" " size="30"></td>
              <td ><input name="elaboradocar" type="text" class="breadcrumb" id="elaboradocar" value="Dirección de Recursos Humanos" size="30"></td>

            </tr>
              <tr>
         <td class="form_label_01"><strong>Revisado Por: </strong></td>
              <td ><input name="revisado" type="text" class="breadcrumb" id="revisado" value="" size="30"></td>
             ...
             <tr>
              <td class="form_label_01"><strong>  </strong></td>
                ...
                <td><input name="revisado2" type="text" class="breadcrumb" id="revisado2" value=" "  size="30"></td>
                <td><input name="revisado2car" type="text" class="breadcrumb" id="revisado2car" value="Director de Administración y Finanzas" size="30"></td>

            </tr>
             <tr>
              <td class="form_label_01"><strong> </strong></td>

                  <td><input name="revisado3" type="text" class="breadcrumb" id="revisado3" value=" " size="30"></td>
...
{
  f=document.form1;
  f.titulo.value="Nómina de Pago por Nivel Organizacional";
  f.action="rnprnomdefniv.php";
  f.submit();
}
function cerrar()
{

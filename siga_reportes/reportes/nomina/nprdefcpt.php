        ...
        <div align="left">&nbsp;
          <table width="612" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr bordercolor="#6699CC">
			  ...
			  <td>
                  <div align="left">
                    <input name="codcon1" type="text" value="<?
				$sql="SELECT min(CODCON) as cod FROM NPASICONEMP";
                LlenarTextoSql($sql,"cod",$bd);
				?>" class="breadcrumb" id="codcon1" size="15" maxlength="20">
                    <input type="button" name="Button" value="..." onClick="catalogo4('codcon1');">
                </div></td>
              <td><input name="codcon2" type="text" value="<?
				$sql="SELECT max(CODCON) as cod FROM NPASICONEMP";
                LlenarTextoSql($sql,"cod",$bd);
				?>" class="breadcrumb" id="codcon2" size="15" maxlength="20">
                  <input type="button" name="Button2" value="..." onClick="catalogo4('codcon2');">
              </td>
            </tr>
            <tr bordercolor="#FFFFFF">
              <td class="form_label_01">&nbsp;</td>
...
{
	f=document.form1;
	f.titulo.value="Cat\u00E1logo de Conceptos";
	f.action="rnprdefcpt.php";
	f.submit();
}
function cerrar()
{
...
function catalogo4(campo)
  {
      mysql='SELECT distinct (CODCON) as codigo, nomcon as nombre FROM npdefcpt';

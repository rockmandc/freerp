        ...
        <div align="left">&nbsp;
          <table width="677"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF">
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>TXT PRESTAMOS
            ...
            <tr>
              ...
              <td>
                  <? 	$tb=$bd->select("SELECT (CODCON) as codcon FROM NPNOMCAL where codcon='D21'");  ?>
		 	      <input type="text" name="codcondes" class="breadcrumb" id="codcondes" value="<?php print $tb->fields["codcon"] ?>" size="15">
                  <input type="button" name="boton" value="..." onClick="catalogo4('codcondes')" >
		      </td>
...
{
	f=document.form1;
	f.titulo.value="TXT PRESTAMOS";
	f.action="rhistnptxtprestamos2.php";
...
{
      mysql='select codcon as codigo, nomcon as Descripcion from npdefcpt  where nomcon like *%PRESTAMO%* order by codcon asc limit 50';
	  pagina="../../lib/general/catalogoobj.php?sql="+mysql+"&campo="+campo;
	  window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=500,height=400,resizable=yes,left=50,top=50");
}
</script>

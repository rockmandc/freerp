...
<form name="form1" method="post" action="">
        ...
        <div align="left">&nbsp;
          <table width="689"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF">
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>VARIACIONES
                  DE NOMINA POR PERIODO
            ...
            <tr>
              <td class="form_label_01"> <div align="left"><strong> Conceptos:</strong></div></td>
              <td> <div align="left">
                  <?
 ...
 <tr>
              ...
              <td> <div align="left"> </div>
                <div align="left">
                  <input name="fechades" type="text" class="breadcrumb" id="fechades" datepicker="true" value="">
                </div></td>
            </tr>
            <tr>
              <td  colspan="2" class="form_label_01"><strong>Si no Selecciona una fecha toma por defecto la ultima en el historico</strong></td>
            </tr>
            <tr>
              <td class="form_label_01"><strong>Elaborado por:</strong></td>
              <td colspan="2"> <div align="left">
                  <input name="ela" type="text" class="breadcrumb" id="ela" size="65">
                </div></td>
            </tr>
            <tr>
              <td class="form_label_01"><strong>Revisado por:</strong></td>
              <td colspan="2"> <div align="left">
                  <input name="rev" type="text" class="breadcrumb" id="rev" size="65">
                </div></td>
            </tr>
            <tr>
              <td class="form_label_01"><strong>Autorizado por:</strong></td>
              <td colspan="2"> <div align="left">
                  <input name="auto" type="text" class="breadcrumb" id="auto" size="65">
                </div></td>
            </tr>
            <tr>
              <td class="form_label_01"><strong>C. Presupuestaria:</strong></td>
              <td colspan="2"> <div align="left">
                  <input name="pre" type="text" class="breadcrumb" id="pre" size="65">
                </div></td>
            </tr>
            <tr bordercolor="#FFFFFF">
...
{
	f=document.form1;
	f.titulo.value="VARIACIONES DE NÓMINA";
	f.action="rNPRVARPER.php";
	f.submit();
}
function cerrar()
{

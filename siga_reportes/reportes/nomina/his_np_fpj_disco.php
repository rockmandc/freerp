  ...
  <table width="760"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr>
        ...
        <div align="left">&nbsp;
          <table width="647" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF">
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>Fondo de Pensiones y Jubilados
     ...
     <tr>
           ...
           <tr>
                 <td height="23" class="form_label_01"><strong>Fecha de Nomina  : </strong></td>
              <td> <div align="left"> </div>
                <div align="left">
                  <?
            ...
            <tr>
              ...
              <td colspan="2"><input name="elaborado" type="text" class="breadcrumb" id="elaborado" size="60"></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td colspan="2"><input name="autorizado" type="text" class="breadcrumb" id="autorizado" size="60"></td>
            </tr>
            <tr bordercolor="#6699CC">
...
{
	f=document.form1;
	f.titulo.value="Fondo de Pensiones y Jubilados ";
	f.action="rhis_np_fpj_disco.php";
	f.submit();
}
function cerrar()
{

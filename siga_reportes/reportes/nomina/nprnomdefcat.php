        ...
        <div align="left">&nbsp;
          <table width="647"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF">
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>Listado de Prenomina  por Categor&iacute;a
...
{
	f=document.form1;
	f.titulo.value="Nómina de Pago por Categor\u00EDa";
	f.action="rnprnomdefcat.php";
	f.submit();
}
function cerrar()
{

        ...
        <div align="left">&nbsp;
          <table width="647"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF">
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>Personal Egresado
            ...
            <tr>
              ...
              <td>
                <div align="left">
                  <?
					$tb2=$bd->select("Select to_char(min(fecret),'dd/mm/yyyy') as fecretmin,to_char(max(fecret),'dd/mm/yyyy') as fecretmax from nphojint");
				?>
  					<input typer="text" class="breadcrumb" value="<? echo $tb2->fields["fecretmin"]?>" id="fecretdes" name="fecretdes" size="20" maxlength="10" datepicker="true"/>
              </div></td>
              <td><input typer="text" class="breadcrumb" value="<? echo $tb2->fields["fecretmax"]?>" id="fecrethas" name="fecrethas"  size="20" maxlength="10" datepicker="true"/></td>
            </tr>
                        <tr>
...
{
	f=document.form1;
	f.titulo.value="Personal Egresado";

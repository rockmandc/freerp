...
/*		function llenartitulosmaestro()
			...
			function Cuerpo()
		{
			...
			//-----------------------sql2--------------------------
			 $this->sql2="SELECT NOMNOM as nombre,ultfec,profec FROM NPNOMINA WHERE
			 codnom='".$this->codnom."'";
			 $tb2b=$this->bd->select($this->sql2);
			   $this->setFont("Arial","B",8);
			 $this->cell(0,5,"Nómina: ".$tb2->fields["codnom"]."      ".strtoupper($tb2b->fields["nombre"])."   Del:".date('d/m/Y',strtotime($tb2b->fields['ultfec']))."    Al:".date('d/m/Y',strtotime($tb2b->fields['profec'])));
			//-----------------------fin--------------------------
				// $this->cell(45,5,"            Del:".$this->fecreg1);
				 ...
				 $this->ln();
				 $this->cell(30,4,"   ".strtoupper($tb2->fields["codcon"]));
			...
			while(!$tb->EOF)
			{
			 ...
			 $this->SetLineWidth(0.2);
				 ...
				 //$this->cell(20,8,"TOTAL CONCEPTO:  ".strtoupper( $codcon."   ".strtoupper( $nomcon)));
 					$this->MultiCell(170,8,"TOTAL CONCEPTO:  ".strtoupper($codcon."   ".strtoupper($nomcon)));
 ...
 //		  		 $this->Line(10,$this->GetY(),200,$this->GetY());
			...
			//-----------------------fin--------------------------
				// $this->cell(45,5,"            Del:".$this->fecreg1);
				 ...
				 $this->cell(100,4,"   Descripción Concepto  ");
				 $this->ln();
				 $this->cell(30,4,"   ".$tb->fields["codcon"]);
...
//------------------FIRMAS
 ...
 $this->ln(4);
				...
				// $this->cell(106,5,"José Luis Alvernia");
			       // $this->cell(150,5,"Rebeca Uzcátegui D'Lima");

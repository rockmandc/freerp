  ...
  <table width="760"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
   ...
   <!-- codigo de nomina -->
        ...
        ?>" class="breadcrumb" id="tipnomesp" size="20" maxlength="50">
                <input type="button" name="Button3" value="..." onClick="catalogo55('tipnomesp');">
              </div></tr>
...
{
	f=document.form1;
	f.titulo.value="RELACIÓN NÓMINA CONCEPTO";
	f.action="rNPRRELCONC.php";
	f.submit();
}
function cerrar()
{

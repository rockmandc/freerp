...
class pdfreporte extends fpdf
{
	...
	function Formato()
	{
		...
		$this->cell(150,4,'RAZÓN SOCIAL DE LA EMPRESA O NOMBRE DEL PATRONO',1,0,'C');
		$this->multicell(40,4,'NÚMERO DE EMPRESA',1,'C');
		$emp = $this->objeto->sqlempresa();
		$this->setFont("arial",B,9);
		$this->cell(150,6,'CONTRALORÍA MUNICIPAL DE CHACAO',1,0,'C');
		$this->cell(40,6,"D  2   4   5   3   0  2  6  1",0,0,'R');
		$this->setFont("arial","",7);
		...
		$this->multicell(190,4,'DIRECCIÓN DE EMPRESA',1,'C');
		$this->multicell(190,6,$emp[0]["diremp"],1,'C');
		$this->cell(110,4,'APELLIDOS Y NOMBRES DEL PATRONO O REPRESENTANTE LEGAL',1,0,'C');
		$this->cell(40,4,'CÉDULA DE INDENTIDAD N°',1,0,'C');
		$this->multicell(40,4,'TELÉFONO',1,'C');
		...
		$this->multicell(40,4,'CÉDULA DE IDENTIDAD N°',1,'C');
		...
		$this->multicell(40,6,$this->arrp[0]["nacemp"].'-'.$this->arrp[0]["cedemp"],1,'C');
		$this->ln();
		$this->setx(60);
		...
		$this->rowm($totales);
		$this->ln();
		$this->multicell(190,5,"Observación: ".$this->observ."\n\n",1);
		$this->ln();
		$this->setFont("arial","B",8);
		$this->multicell(190,4,"DECLARACIÓN JURADA",0,'C');
		$this->setFont("arial","",7);
		$this->multicell(190,4,"CERTIFICÓ BAJO FE DE JURAMENTO QUE LA INFORMACIÓN QUE ANTECEDE ES CIERTA" .

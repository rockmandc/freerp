      ...
      <tr>
        ...
        ?>" class="breadcrumb" id="tipnomesp" size="20" maxlength="50">
         ...
         <td class="form_label_01"><strong>Revisado Por: </strong></td>
              ...
              <td><input name="revisadocar" type="text" class="breadcrumb" id="revisadocar" value="Director Recursos Humanos" size="30"></td>
             ...
             <tr>
              <td class="form_label_01"><strong>  </strong></td>
                ...
                <td><input name="revisado2car" type="text" class="breadcrumb" id="revisado2car" value="Director de Administracion y Finanzas (E)" size="30"></td>

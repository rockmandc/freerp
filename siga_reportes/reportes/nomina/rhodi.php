        ...
        <div align="left">&nbsp;
          <table width="612" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF">
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>Establecimiento de los Objetivos de Desempe&ntilde;o Individual
...
{
	f=document.form1;
	f.titulo.value="             ESTABLECIMIENTO DE LOS OBJETIVOS DE DESEMPEÑO INDIVIDUAL";
	f.action="rrhodi.php";
	f.submit();
}
function cerrar()

          ...
          <table width="612"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr> 
              ...
              <td> <div align="left"> 
			  	...
			  	$tb=$bd->select("select codban from npbancos order by codban");
			  ?>
                  <select name="cod1" class="breadcrumb" id="cod1">
					...
					{
				  ?>
                    <option value="<? print $tb->fields["codban"];?>"><? print $tb->fields["codban"];?></option>
                    <?
					$tb->MoveNext();
					}
				?>
              ...
              <td> 
                <?
			  	...
			  	$tb2=$bd->select("select codban from npbancos order by codban desc");
			  ?>
				...
				{
			  ?>
                  <option value="<? print $tb2->fields["codban"];?>"><? print $tb2->fields["codban"];?></option>
                  <?
				  $tb2->MoveNext();
					}
				?>

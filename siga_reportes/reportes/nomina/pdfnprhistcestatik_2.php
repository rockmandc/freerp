<?
	...
	class pdfreporte extends fpdf
	{
		function pdfreporte()
		{
		    ...
		    $this->arrp = $this->objNprcestatik->SQLp($this->especial,$this->codnomdes,$this->codnomhas,$this->codcondes,$this->nomminesp,$this->fecnomhas);
		...
		foreach ($this->arrp as $dato)
      	{
			...
			$this->SetAligns(array("L","L","C","C"));
			$this->SetBorder(0);
			$this->Row(array($dato["codemp"],$dato["nomemp"],H::FormatoMonto($dato["cantidad"],0,0),H::FormatoMonto($dato["saldo"])));
			$acum+=$dato["saldo"];

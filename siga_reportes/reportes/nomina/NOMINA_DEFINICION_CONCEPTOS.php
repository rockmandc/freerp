        ...
        <div align="left">&nbsp;
          <table width="612"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr>
              ...
              <td class="form_label_01"> <div align="left"><strong>N&oacute;minas:</strong></div></td>
              <td> <div align="left">
                <input name="nom1" type="text" class="breadcrumb" id="nom1" value="<?$sql="select min(codnom) as codnom from npnomina";
					LlenarTextoSql($sql,"codnom",$bd); ?>" size ="20">
					<input type="button" name="Button1" value="..." onClick="catalogo('nom1');">
                </div></td>


              <td> <div align="left">
                <input name="nom2" type="text" class="breadcrumb" id="nom2" value="<?$sql="select max(codnom) as codnom from npnomina";
					LlenarTextoSql($sql,"codnom",$bd); ?>" size ="20">
					<input type="button" name="Button2" value="..." onClick="catalogo('nom2');">
                </div></td>
            </tr>

<!-- HASTA AQUI ESTAN LOS DE NOMINA -->
            <tr>
              <td class="form_label_01"><strong>C&oacute;digo Concepto:</strong></td>
              <td>
                <input type="text" name="cod1" class="breadcrumb" id="cod1" value="<?$sql="select min(codcon) as codcon from npdefcpt";
 				LlenarTextoSql($sql,"codcon",$bd); ?>" size ="20">
                <input type="button" name="Button3" value="..." onClick="catalogo2('cod1');">
                  </td>
               <td>
                <input type="text" name="cod2" class="breadcrumb" id="cod2" value="<?$sql="select max(codcon) as codcon from npdefcpt";
 				LlenarTextoSql($sql,"codcon",$bd); ?>" size ="20">
                <input type="button" name="Button3" value="..." onClick="catalogo2('cod2');">
                  </td>
            </tr>
            <tr>
...
{
	f=document.form1;
	f.titulo.value="DEFINICIÓN DE CONCEPTOS";
	f.action="rNOMINA_DEFINICION_CONCEPTOS.php";
	f.submit();
}
function cerrar()
{
...
function catalogo(campo)
   {
      mysql='select codnom as CODIGO,nomnom as DESCRIPCION from npnomina order by codnom';
...
function catalogo2(campo)
   {
      mysql=' select codcon as CODIGO from npdefcpt order by codcon ';
	  pagina="../../lib/general/catalogoobj.php?sql="+mysql+"&campo="+campo;
	  window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=500,height=400,resizable=yes,left=50,top=50");
   }
function catalogo1()

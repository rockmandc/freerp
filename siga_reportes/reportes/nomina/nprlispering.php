        ...
        <div align="left">&nbsp;
          <table width="647"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF">
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>Personal Ingresado
            ...
            <tr>
              <td class="form_label_01">
                <div align="left"><strong>Fecha Desde:</strong></div></td>
              <td>
                <div align="left">
                  <?
					$tb2=$bd->select("Select to_char(min(fecing),'dd/mm/yyyy') as fecingmin,to_char(max(fecing),'dd/mm/yyyy') as fecingmax from nphojint");
				?>
  					<input typer="text" class="breadcrumb" value="<? echo $tb2->fields["fecingmin"]?>" id="fecingdes" name="fecingdes" size="20" maxlength="10" datepicker="true"/>
              </div></td>
              <td><input typer="text" class="breadcrumb" value="<? echo $tb2->fields["fecingmax"]?>" id="fecinghas" name="fecinghas"  size="20" maxlength="10" datepicker="true"/></td>
            </tr>
            <tr>
              ...
              <td colspan="2"> <div align="left">
			  	...
			  	$tb=$bd->select("SELECT distinct a.CODNOM,a.NOMNOM
								FROM NPNOMINA a, npasicaremp b where a.codnom=b.codnom order BY a.CODNOM");
			  ?>
           ...
           <tr>
              ...
              <td height="26" class="form_label_01"> <div align="left"><strong>Estatus
                  Especial:</strong></div></td>
              <td colspan="2" valign="middle"> <select name="estatus" class="breadcrumb" id="estatus">
...
{
	f=document.form1;
	f.titulo.value="Personal Ingresado";

        ...
        <div align="left">&nbsp;
          <table width="647"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF">
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>Historico Relacion General de Asignaciones/Deducciones
           ...
           <tr>
              ...
              <td><div align="left">
				...
				$sql="SELECT to_char(MIN(fecnom),'DD/MM/YYYY') as fecemi FROM nphiscon a";
              ...
              <td><input name="fechas" type="text" value="<?
				$sql="SELECT to_char(Max(fecnom),'DD/MM/YYYY') as fecemi FROM nphiscon a";
                LlenarTextoSql($sql,"fecemi",$bd);
...
{
	f=document.form1;
	f.titulo.value="Historico Relacion general de Asignaciones / Deducciones";
	f.action="rnprhistrelgenasided.php";
	f.submit();
}
function cerrar()
{

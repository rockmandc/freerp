        ...
        <div align="left">&nbsp; 
          <table width="612"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF"> 
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>CATEGORIAS 
                  PRESUPUESTARIAS 
            ...
            <tr> 
              <td class="form_label_01"> <div align="left"><strong>C&oacute;digo 
                  Categor&iacute;a:</strong></div></td>
              <td> <div align="left"> 
                  <?
			  	
			  	$tb=$bd->select("select codcat from npcatpre order by codcat");
			  ?>
                  <select name="cod1" class="breadcrumb" id="cod1">
					...
					{
				  ?>
                    <option value="<? print $tb->fields["codcat"];?>"><? print $tb->fields["codcat"];?></option>
                    <?
					$tb->MoveNext();
					}
				?>
              ...
              <td> 
                <?
			  	...
			  	$tb2=$bd->select("select codcat from npcatpre order by codcat desc");
			  ?>
				...
				{
			  ?>
                  <option value="<? print $tb2->fields["codcat"];?>"><? print $tb2->fields["codcat"];?></option>
                  <?
				  $tb2->MoveNext();
					}
				?>
...
{
	f=document.form1;
	f.titulo.value="CATEGORIAS PRESUPUESTARIAS";
	f.action="rNPRCATPRE.php";
	f.submit();
}
function cerrar()
{

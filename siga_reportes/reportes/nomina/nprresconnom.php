        ...
        <div align="left">&nbsp;
          <table width="689"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr bordercolor="#FFFFFF">
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>RESUMEN GENERAL DE CONCEPTOS POR NOMINA
		 ...
		 <td> <div align="left">
            ...
            <td>&nbsp;</td>
			 ...
			 <tr>
              ...
              <td ><input name="elaboradocar" type="text" class="breadcrumb" id="elaboradocar" value=" " size="30"></td>
            ...
            <tr>
              ...
              <td><input name="revisadocar" type="text" class="breadcrumb" id="revisadocar" value=" " size="30"></td>
...
{
	f=document.form1;
	f.titulo.value="RESUMEN GENERAL DE CONCEPTOS POR NÓMINA";
	f.action="rnprresconnom.php";
	f.submit();
}
function cerrar()
{

  ...
  <table width="760"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
        ...
        <div align="left">&nbsp;
          <table width="689"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr bordercolor="#FFFFFF">
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>RESUMEN GENERAL DE  CONCEPTOS
   ...
   <!-- codigo de nomina -->
        ...
        ?>" class="breadcrumb" id="tipnomesp" size="20" maxlength="50">
                ...
                <td> <div align="left">
               	<input name="elaborado" type="text" class="breadcrumb" id="elaborado"
                   value="" size ="25">
 			      </div></td>
			<tr>
				<td class="form_label_01"> <div align="left"><strong>Revisado por:</strong></div></td>
                <td> <div align="left">
               	<input name="revisado" type="text" class="breadcrumb" id="revisado"
                   value="" size ="25">
 			      </div></td>
			</tr>
...
{
	f=document.form1;
	f.titulo.value="RESUMEN GENERAL DE CONCEPTOS";
...
function catalogo8(campo)
   {
      ...
      mysql='SELECT distinct(b.CODNOM)as CODIGO,b.NOMNOM as DESCRIPCION FROM NPASICAREMP a, NPNOMINA b where a.codnom=b.codnom';

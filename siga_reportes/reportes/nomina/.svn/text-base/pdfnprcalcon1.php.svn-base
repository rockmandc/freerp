		...
		function Header()
		{
			...
			if ($this->pag)
			{
				$this->cab->poner_cabecera($this,$_POST["titulo"],"p","s");
				   ...
				   $this->setFont('arial',"B",9);
					$this->setXY(15,28);
					$this->cell(0,5,'CÁLCULO DE CONCEPTOS',0,0,'C');

					$this->setFont('arial',"B",8);
					$this->setXY(15,38);
					$this->cell(100,5,'De la nómina:   '.$this->pcodnom.'     a la nómina:   '.$this->pcodnom1 );
					$this->setXY(20,45);
					$this->cell(60,5,'Nómina:   '.$this->tb->fields["nomnom"]);

					$this->setXY(20,52);
					$this->cell(50,5,'Código Concepto');$this->cell(50,5,'Nombre Concepto');
					$this->setXY(35,57);

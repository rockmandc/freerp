<?
    ...
    require_once("../../lib/modelo/sqls/nomina/Relacion_federal_disco_historico.class.php");
	...
	var $bd;
		...
		function pdfreporte()
		{
		    ...
		    $this->arrp = $this->fed->sqlp($this->coddes,$this->codhas,$this->codespdes,$this->codesphas,$this->banco,$this->especial,$this->fechamax);

		    $this->arrp2 = $this->fed->nomina($this->coddes,$this->codhas,$this->codespdes,$this->codesphas,$this->banco,$this->especial,$this->fechamax);
...
function Cuerpo()
		...
		// $this->SetBorder(1);
         ...
         //$lineatxt3 = "670".str_pad($this->cuenta,20,'0',STR_PAD_LEFT)."0000".$mes.$this->quincena.$this->codfederal.str_pad($monto1,13,'0',STR_PAD_LEFT)."000000000000000000000000000000000";
			...
			$lineatxt = str_pad($dato["codemp"],15,' ',STR_PAD_RIGHT)."00".substr($dato["cuenta_banco"],10).str_pad($monto,15,'0',STR_PAD_LEFT)."NOMINA".$this->quincena;

        ...
        <div align="left">&nbsp; 
          <table width="647"  border="1" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF"> 
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>NOMINA DE PAGO POR CATEGORIA DESDE HISTORICO
            ...
            <tr bordercolor="#6699CC"> 
              ...
              <td><div align="left"> </div>
				...
				$sql="select min(b.codemp) as cod from  nphojint b";
                LlenarTextoSql($sql,"cod",$bd);				
				?>" class="breadcrumb" id="codempdes" size="18" maxlength="16">
                    <input type="button" name="Button" value="..." onClick="catalogo('codempdes');">
                </div></td>
                <td><div align="left"> </div>
                  <div align="left">
                    <input name="codemphas" type="text" value="<?
				$sql="select max(b.codemp) as cod from  nphojint b";
                LlenarTextoSql($sql,"cod",$bd);				
				?>" class="breadcrumb" id="codemphas" size="18" maxlength="16">
                    <input type="button" name="Button" value="..." onClick="catalogo('codemphas');">
                </div></td>
            </tr>
            <tr bordercolor="#6699CC">
              ...
              <td><div align="left"> </div>
                ...
                LlenarTextoSql($sql,"cod",$bd);				
				?>" class="breadcrumb" id="codcardes" size="18" maxlength="16">
                    <input type="button" name="Button" value="..." onClick="catalogo1('codcardes');">
                </div></td>
                <td><div align="left"> </div>
                  <div align="left">
                    <input name="codcarhas" type="text" value="<?
				$sql="SELECT max(CODcar) as cod FROM NPASICAREMP where (nomcar<>'') ";
                LlenarTextoSql($sql,"cod",$bd);				
				?>" class="breadcrumb" id="codcarhas" size="18" maxlength="16">
                    <input type="button" name="Button" value="..." onClick="catalogo1('codcarhas');">
                </div></td>
            </tr>
            <tr>
              <td class="form_label_01"><strong>C&oacute;digo Categoria :</strong></td>
              <td><div align="left"> </div>
                  <div align="left">
                    <input name="codcatdes" type="text" value="<?
				$sql="SELECT min(codcat) as cod FROM NPCATPRE";
                LlenarTextoSql($sql,"cod",$bd);				
				?>" class="breadcrumb" id="codcatdes" size="18" maxlength="16">
                    <input type="button" name="Button" value="..." onClick="catalogo2('codcatdes');">
                </div></td>
                <td><div align="left"> </div>
                  <div align="left">
                    <input name="codcathas" type="text" value="<?
				$sql="SELECT max(codcat) as cod FROM NPCATPRE";
                LlenarTextoSql($sql,"cod",$bd);				
				?>" class="breadcrumb" id="codcathas" size="18" maxlength="16">
                    <input type="button" name="Button" value="..." onClick="catalogo2('codcathas');">
                </div></td>
            </tr>
            ...
            <tr>
              ...
              <td><div align="left"> </div>
                ...
                LlenarTextoSql($sql,"cod",$bd);				
				?>" class="breadcrumb" id="codcondes" size="18" maxlength="16">
                    <input type="button" name="Button" value="..." onClick="catalogo3('codcondes');">
                </div></td>
                <td><div align="left"> </div>
                  <div align="left">
                ...
                LlenarTextoSql($sql,"cod",$bd);				
				?>" class="breadcrumb" id="codconhas" size="18" maxlength="16">
                    <input type="button" name="Button" value="..." onClick="catalogo3('codconhas');">
                </div></td>
            </tr>
            <tr>
            ...
            <tr> 
              ...
              <td> <div align="left"> </div>
                <div align="left"> 
                    <input name="fecnomdes" type="text" class="breadcrumb" id="fecnomdes" datepicker="true" value="">
                </div></td>
              <td><input name="fecnomhas" type="text" class="breadcrumb" id="fecnomhas" datepicker="true" value=""></td>
            </tr>
            <tr>
...
{
	f=document.form1;
	f.titulo.value="NÃ³mina de Pago por CategorÃa";
	f.action="rnprhisnomdefcat.php";
	f.submit();
}
function cerrar()
{
...
{
pagina="../../lib/general/catalogoobj.php?campo="+campo+"&sql=SELECT codcat as Codigo, UPPER(nomcat) as Nombre FROM NPCATPRE ORDER BY CODCAT";
window.open(pagina,"Catalogo","menubar=no,toolbar=no,scrollbars=yes,width=500,heigth=400,resizable=yes,left=50,top=50");
}

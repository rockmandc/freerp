        ...
        <div align="left">&nbsp;
          <table width="647"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF">
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>Historico Nomina Para las Firmas por Categoria
            ...
            <tr bordercolor="#6699CC">
             ...
             <tr>
              <td class="form_label_01"><strong>C&oacute;digo Categor&iacute;a :</strong></td>
			  <td>
                  <div align="left">
                    <input name="codcatdes" type="text" value="<?
				$sql="SELECT min(codcat) as cod FROM NPCATPRE ";
                LlenarTextoSql($sql,"cod",$bd);
				?>" class="breadcrumb" id="codcatdes" size="20" maxlength="20">
                    <input type="button" name="Button" value="..." onClick="catalogo3('codcatdes');">
                </div></td>
              <td><input name="codcathas" type="text" value="<?
				$sql="SELECT max(codcat) as cod FROM NPCATPRE";
                LlenarTextoSql($sql,"cod",$bd);
				?>" class="breadcrumb" id="codcathas" size="20" maxlength="20">
                  <input type="button" name="Button2" value="..." onClick="catalogo3('codcathas');">
              </td>
            </tr>
...
<tr>
 ...
 <tr>
        ...
        ?>" class="breadcrumb" id="tipnomesp1" size="20" maxlength="50">
                <input type="button" name="Button3" value="..." onClick="catalogo5('tipnomesp1');">
              </div></td>
         ...
         <td> <div align="left">
                   ...
                   value="<?$sql="SELECT max(CODNOMESP) as codnom from NPNOMESPTIPOS where trim(codnomesp)!=''";
                     LlenarTextoSql($sql,"codnom",$bd); ?>" size ="20">
                      <input type="button" name="Button3" value="..." onClick="catalogo5('tipnomesp2');">
                   </div></td>
...
{
	f=document.form1;
	f.titulo.value="Nomina Para las Firmas por Categoria";
	f.action="rnprhistnomfirdefcat.php";
	f.submit();
}
function cerrar()
{
   ...
   {
      pagina="../../lib/general/catalogoobj.php?campo="+campo+"&sql=SELECT distinct(CODcar) as Codigo,(nomcar) as Nombre FROM NPASICAREMP order by codcar";
	  window.open(pagina,"Catalogo","menubar=no,toolbar=no,scrollbars=yes,width=500,heigth=400,resizable=yes,left=50,top=50");
   }
      function catalogo3(campo)
   {
      pagina="../../lib/general/catalogoobj.php?campo="+campo+"&sql=SELECT codcat as Codigo, (nomcat) as Nombre FROM NPCATPRE ORDER BY CODCAT";
	  window.open(pagina,"Catalogo","menubar=no,toolbar=no,scrollbars=yes,width=500,heigth=400,resizable=yes,left=50,top=50");
   }
      function catalogo4(campo)
   {
      pagina="../../lib/general/catalogoobj.php?campo="+campo+"&sql=SELECT distinct(CODCON) as Codigo,(NOMCON) as Nombre FROM NPASICONEMP order by CODCON";
	  window.open(pagina,"Catalogo","menubar=no,toolbar=no,scrollbars=yes,width=500,heigth=400,resizable=yes,left=50,top=50");
   }

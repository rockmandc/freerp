        ...
        <div align="left">&nbsp;
          <table width="677"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF">
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>5 Dias de Prestaciones
            ...
            <tr>
              ...
              <input name="codtipapodes" type="text"  value="<?
                $sql="SELECT min(CODTIPAPO) as codtipapo FROM NPTIPAPORTES where CODTIPAPO='0013' ";
            ...
            <tr>
              <td class="form_label_01"> <div align="left"><strong>Tipo N&oacute;mina desde:</strong></div></td>
			  ...
			  ?>
				...
				?>
                        ...
                        <tr>
              <td class="form_label_01"> <div align="left"><strong>Tipo N&oacute;mina hasta:</strong></div></td>
              <td colspan="2"> <div align="left">
                  <?
			  ...
			  ?>
                  <select name="tipnom2" class="breadcrumb" id="tipnom2">
                    <?
				  	while(!$tb->EOF)
					{
				  ?>
   ...
   <tr bordercolor="#6699CC">
          ...
          <!--  <tr>
            ...
            <tr>
              ...
              <td colspan="2"><input name="auto" type="text" class="breadcrumb" id="auto" value="Dulce Ramirez"  size="80"></td>
            </tr>
            <tr bordercolor="#FFFFFF">
...
{
	f=document.form1;
	f.titulo.value="5 Dias de Prestaciones";
	f.action="rhistnpprestaciones5dias.php";

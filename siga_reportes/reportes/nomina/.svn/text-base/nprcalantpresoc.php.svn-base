        ...
        <div align="left">&nbsp; 
          <table width="612"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF"> 
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>ANTICIPOS SOBRE PRESTACIONES SOCIALES
            ...
            <tr> 
              ...
              <td> <div align="left"> 
			  	...
			  	$tb=$bd->select("Select distinct A.codemp,nomemp from npantpre A,NPHOJINT B WHERE A.CODEMP=B.CODEMP  order by CODEMP");
			  ?>
              ...
              <td> 
                <?
			  	...
			  	$tb2=$bd->select("Select distinct A.codemp,nomemp from npantpre A,NPHOJINT B WHERE A.CODEMP=B.CODEMP  order by CODEMP  desc");
			  ?>
            ...
            <tr>
              <td class="form_label_01"> <div align="left"><strong>Historico:</strong></div></td>
              <td> <div align="left">
                  
                  <select name="histo" class="breadcrumb" id="histo">                  
...
{
	f=document.form1;
	f.titulo.value="ANTICIPOS SOBRE PRESTACIONES SOCIALES";
	f.action="rnprcalantpresoc.php";
	f.submit();
}

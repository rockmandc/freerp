	...
	class pdfreporte extends fpdf
	{
		...
		function pdfreporte()
		{
			...
			$this->sqll="	SELECT DISTINCT(C.CODEMP) as codemp, to_char(C.FECRET,'dd/mm/yyyy') as fecret,
						...
						f.nomban as nomban,	LTRIM(RTRIM(g.CODCAR)) as CODCAR, cast(g.CODCAR as int ) as codcarord,a.NOMCAR as nomcar,
						E.DESNIV as desniv,
						...
						NPCATPRE D,	NPESTORG E,	nphiscon G,	NPDEFCPT H, npcargos a
						WHERE
					    ...
					    E.CODNIV=C.CODNIV AND g.codcar=a.codcar and
					...
					--	B.STATUS='V' AND
						...
						f.nomban ,	LTRIM(RTRIM(g.CODCAR)) , cast(g.CODCAR as int ) ,a.NOMCAR ,
						E.DESNIV ,
						C.STAEMP,
						G.CODCON ,H.NOMCON,
						H.OPECON

        ...
        <div align="left">&nbsp;
          <table width="612"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF">
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>CONCEPTOS
                  POR NOMINA
            ...
            <tr bordercolor="#6699CC">
             ...
             <tr>
			  ...
			  <td>
                  <div align="left">
                    <input name="cod1" type="text" value="<?
				$sql="SELECT min(CODCON) as cod FROM NPASICONEMP";
                LlenarTextoSql($sql,"cod",$bd);
				?>" class="breadcrumb" id="cod1" size="20" maxlength="20">
                    <input type="button" name="Button" value="..." onClick="catalogo4('cod1');">
                </div></td>
              <td><input name="cod2" type="text" value="<?
				$sql="SELECT max(CODCON) as cod FROM NPASICONEMP";
                LlenarTextoSql($sql,"cod",$bd);
				?>" class="breadcrumb" id="cod2" size="20" maxlength="20">
                  <input type="button" name="Button2" value="..." onClick="catalogo4('cod2');">
              </td>
            </tr>
            <tr>
              <td class="form_label_01"> <div align="left"><strong>Tipo Concepto:</strong></div></td>
              <td colspan="2"> <div align="left">
                  <select name="tip" class="breadcrumb" id="tip">
                    <option value="T">Todos</option>
                    <option value="A">Asignaciones</option>
                    <option value="D">Deducciones</option>
                    <option value="P">Aportes</option>
                    <option value="C">Descuentos</option>
                  </select>
                </div></td>
            </tr>
            <tr>
              ...
              <td colspan="2"> <div align="left">
			  	...
			  	$tb=$bd->select("select distinct a.codnom,a.nomnom from npnomina a, npasiconnom b where (a.codnom=b.codnom) order by a.codnom");
			  ?>
...
{
	f=document.form1;
	f.titulo.value="CONCEPTOS POR NOMINA";
	f.action="rNPRCONNOM.php";
	f.submit();
}
function cerrar()
{
...
function catalogo4(campo)
  {
      mysql='SELECT distinct (CODCON) as codigo, nomcon as nombre FROM NPASICONEMP';

        ...
        <div align="left">&nbsp;
          <table width="612"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF">
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>NIVELES
                  ORGANIZACIONALES
            ...
            <tr>
			  ...
			  <td><div align="left"> </div>
				...
				?>" class="breadcrumb" id="cod1" size="20" maxlength="20">
                    <input type="button" name="Button" value="..." onClick="catalogo('cod1');">
                </div></td>
              <td><input name="cod2" type="text" value="<?
				...
				?>" class="breadcrumb" id="cod2" size="20" maxlength="20">
                  <input type="button" name="Button2" value="..." onClick="catalogo('cod2');"></td>
            </tr>
            <tr>
...
{
	f=document.form1;
	f.titulo.value="NIVELES ORGANIZACIONALES";
	f.action="rNPRNIVORG.php";
	f.submit();
}
function cerrar()
{
   ...
   {
      pagina="../../lib/general/catalogoobj.php?campo="+campo+"&sql=select codniv as Codigo, desniv as descripcion from npestorg order by codniv";

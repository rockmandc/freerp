...
class pdfreporte extends fpdf
{
	...
	function Formato()
	{
	    ...
	    $this->Row(array("INSCRIPCIÓN DE TRABAJADOR\nEN EL IVSS","MODIFICACIÓN DE DATOS","CAMBIO DE NÚMERO\nDE CÉDULA DE IDENTIDAD","RELACIÓN DE\nFAMILIARES"));
	    $this->SetBorder(0);
	    $this->setJump(3);
	    $this->setFont("arial","",7);
	    $this->setX(20);
		...
		$this->ln();
		$this->setX(20);
		$this->cell(147,6,'1.                             RAZÓN SOCIAL DE LA EMPRESA O NOMBRE DEL PRATRONO',1,0,'L');
		//$this->cell(3);
		$this->multicell(36,6,'2. NÚMERO DE LA EMPRESA',1,'L');
	...
	//	$this->cell(3);
	    ...
	    $this->setJump(3);
	    $this->Row(array("V","E","3.  CÉDULA DE IDENTIDAD Nº","","4. NÚMERO DE ASEGURADO"," 5.  SUC. DPTO. DPCIA."));
	    $this->SetBorder(0);
	    $this->setJump(7);
	    $this->setFont("arial","",7);
	    $this->setX(20);
        ...
        $this->setxy(85,$y1-2);
	    $this->setFont("arial","B",6);
	    $this->multicell(35,2,"EL NÚMERO DE ASEGURADO SE CONFROMA CON \"1\" SI ES VENEZOLANO, \"2\" SI ES EXTRANJERO Y EL NÚMERO DE CÉDULA DE IDENTIDAD",0,'C');
       ...
       /// casillas 6 - 8
	    ...
	    $this->SetBorder(1);
	    $this->setFont("arial","B",7);
	    $this->Row(array("6.                      APELLIDOS Y NOMBRES DEL TRABAJADOR","7.    FECHA DE NACIMIENTO","8.     CONDICIÓN\nTRABAJADOR"));
	    ...
	    $this->SetBorder(1);
	    $this->setFont("arial","B",7);
	    $this->Row(array("9. SEXO","10. ZURDO","11. INGRESO A EMPRESA","12. SALARIO SEMANAL","13. OCUPACIÓN U OFICIO"," COD. OCUPACIÓN"));
        $this->setXY(20,$this->gety());
	    ...
	    $monto=($this->sueldo[0]["monto"]*12)/52;
		
		$monto_sueldmin=((int)$this->sueldomin*12)/52;
				
		if ($monto>=$monto_sueldmin)          
		{
	    ...
	    if($this->arrp[0]["sexemp"]=='F' and $this->arrp[0]["derzur"]='D'){
			$this->Row(array("","X","","X","",$this->arrp[0]["dian"],$this->arrp[0]["mesn"],$this->arrp[0]["anon"],H::FormatoMonto($monto),$this->arrp[0]["nomcar"],""));
	    ...
	    $this->SetBorder(1);
	    $this->setFont("arial","B",7);
	    $this->Row(array("14.                      DOMICILIO Y DIRECCIÓN EXACTA DEL TRABAJADOR","COD. CENTRO ASISTENCIAL","CN.CT."));
        $this->setXY(20,$this->gety());
		$this->SetWidths(array(143,25,15));
	    ...
	    $this->setx(20);
	    $this->setFont("arial","B",7);
	    $this->multicell(183,5,"DECLARACIÓN DE FAMILIARES",1,'C');
		...
		$this->setJump(4);
            ...
            $this->multicell(66.5,5,"21.                        ACTA DE FISCALIZACIÓN",1,'L');
            //DETALLE
            ...
            $this->setxy(20,263-$m);
            $this->setFont("arial","B",9);
            $this->multicell(0,5,"EL FORMULARIO Y SU TRAMITACIÓN SON COMPLETAMENTE GRATUITOS\nwww.ivss.gov.ve",0,'C');

	...
	class pdfreporte extends fpdf
	{
		...
		function Cuerpo()
		{
			...
			while(!$tb->EOF)
			{
				 ...
				 $this->cell($this->anchos[1],3,$tb->fields["opecon"]);
				 $x=$this->getx();
				 $this->cell($this->anchos[2],3,"");
				 $this->cell($this->anchos[3],3,$tb->fields["codpar"]);
				 $this->cell($this->anchos[4],3,$tb->fields["acuhis"]);
				 $this->cell($this->anchos[5],3,$tb->fields["inimon"]);
				 $this->cell($this->anchos[6],3,$tb->fields["conact"]);
				 $this->cell($this->anchos[5],3,$tb->fields["impcpt"]);
				 $this->cell($this->anchos[6],3,$tb->fields["afepre"]);
				 $this->setx($x);
				  $this->multicell($this->anchos[2],3,$tb->fields["nomcon"]);

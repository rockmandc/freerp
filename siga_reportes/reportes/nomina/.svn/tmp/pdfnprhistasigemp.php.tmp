<?
	...
	/*	$this->line(350,$y,350,190);
		...
		$this->line(163,$y,163,190);*/
         ...
         $this->ln();
         $this->line(10,$this->gety(),$x1,$this->gety());
		...
		$this->SetFillTable(0);
			...
			foreach($this->arrp2 as $dato2)//para recorrer todas las asignaciones
            {
               ...
               $this->arrp3=$this->nprhistasigemp->montoasignaciones($dato["codemp"],$this->tipnom,$dato2["codcon"],$this->fechades,$this->fechahas);
...
//generar el listado en excel
				...
				$this->PutLink(trim($dir).'?tipnom='.$this->tipnom.'&codempdes='.$this->codempdes.'&codemphas='.$this->codemphas.'&codcardes='.$this->codcardes.'&codcarhas='.$this->codcarhas.'&codnivdes='.$this->codnivdes.'&codnivhas='.$this->codnivhas.'&codcondes='.$this->codcondes.'&codconhas='.$this->codconhas.'&fechades='.$this->fechades.'&fechahas='.$this->fechahas.'&especial='.$this->especial.'&tipnomesp1='.$this->tipnomesp1.'&tipnomesp2='.$this->tipnomesp2.'&schema='.$_SESSION["schema"],'Listado en Excel');

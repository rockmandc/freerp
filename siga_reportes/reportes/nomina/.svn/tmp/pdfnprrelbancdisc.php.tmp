<?
	...
	class pdfreporte extends fpdf
	{
		...
		function Cuerpo()
		{
		    ...
		    $tb=$this->bd->select($this->sql);
		    $this->setXY(10,35);
			$this->cell(15,6,"NÓMINA :".$tb->fields["codnom"]);
			...
			//    $this->cell(13,6,);
				$this->ln(4);
				$this->cell(13,6,"Cantidad de Trabajadores de la nómina: ".$cont2);
			...
			$this->ln(4);
				  $this->sql3="SELECT nomnom as nombre FROM NPNOMINA
					 WHERE CODNOM='".$nom."';";
  				  $tb3=$this->bd->select($this->sql3);
				  $this->cell(13,6,"Total Nómina ".$tb3->fields["nombre"]."   ".number_format($acum2,2,'.',','));
			//    $this->cell(13,6,);
				$this->ln(4);
				$this->cell(13,6,"Cantidad de Trabajadores de la nómina: ".$cont2);

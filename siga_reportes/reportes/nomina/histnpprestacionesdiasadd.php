        ...
        <div align="left">&nbsp;
          <table width="677"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF">
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>5 Dias de Prestaciones + Dias Adicional
...
{
	f=document.form1;
	f.titulo.value="Dias Adicionales";
	f.action="rhistnpprestacionesdiasadd.php";

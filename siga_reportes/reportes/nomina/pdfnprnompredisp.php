<?
  ...
  require_once("../../lib/modelo/sqls/nomina/Nprnompredisp.class.php");
  ...
  class pdfreporte extends fpdf
  {
    ...
    function pdfreporte()
    {
      ...
      $this->objNprnompre = new Nprnompredisp();
  ...
  /*    $this->cell(55,4,"Código Presupuestario");
      ...
      $this->cell(30,4,"Aporte");
       $this->cell(20,4,"Disponibilidad",0,0,"C");*/
         $this->setWidths(array(30,40,35,45,25,23,20,20,20));
      $this->setAligns(array("C","C","C","C","C","C","C","C","C"));
       $this->Row(array("Código Presupuestario","Descripción","Cuenta Contable","Descripción","Asignacion","Deducion","Aporte","Disponibilidad","Diferencia"));
      $this->ln(8);
    }
    ...
    {
      $this->setWidths(array(30,40,35,45,25,23,20,20,20));
      $this->setAligns(array("L","L","C","L","R","R","R","R","R"));
      ...
      for ($i=0;$i<count($this->arrp);$i++)
      {
        ...
        $this->arrp2 = $this->objNprnompre->SQLdisponibilidad($this->arrp[$i]["codpre"],'');
        $diferencia=H::FormatoMonto(($this->arrp[$i]["asigna"]+$this->arrp[$i]["aporte"])-$this->arrp2["0"]["disp"]);
        $this->Row(array($this->arrp[$i]["codpre"],$this->arrp[$i]["nompre"],$this->arrp[$i]["codcta"],$this->arrp[$i]["descta"],$asigna,$deduci,$aporte,H::FormatoMonto($this->arrp2["0"]["disp"]),$diferencia));

...
require_once("../../lib/modelo/sqls/nomina/Nprhisrecpag.class.php");
...
class pdfreporte extends fpdf
{
  function pdfreporte()
  {
    ...
    $this->cabe='s';
      ...
      $this->codnomdes= H::GetPost('codnommin');
      ...
      $this->especial=H::GetPost('especial');
       ...
       $this->especialdesde=H::GetPost('nomminesp');
       $this->especialhasta=H::GetPost('nommaxesp');

      $this->objNprhisrecpag = new Nprhisrecpag();
      $this->arrp = $this->objNprhisrecpag->SQLp($this->codnomdes,$this->codempdes,$this->codemphas,$this->codcardes,$this->codcarhas,$this->codcondes,$this->codconhas,
	$this->especial,$this->nomminesp,$this->nommaxesp,$this->fecnomdes,$this->fecnomhas);
  ...
  function br()
  {
    $arrnumrec = $this->objNprhisrecpag->sqlnumrel();
    ...
    {
      $arrcont = $this->objNprhisrecpag->sqlcontador($this->codnomdes,$this->codempdes,$this->codemphas,
      											  $this->codcardes,$this->codcarhas,$this->codcondes,$this->codconhas);
      $numrecnew = $this->numrec + $arrcont[0]["numemp"];
      $this->objNprhisrecpag->sqlnpdefgen($numrecnew);
    ...
    function Cuerpo()
    {
      ...
      {
        $arrcorrel = $this->objNprhisrecpag->sqlbuscacorrel($obj["codemp"],$obj["codcar"],$obj["codnom"]);
        ...
        {
          $this->objNprhisrecpag->sqlnpnomcal($this->numrec,$obj["codemp"],$obj["codcar"],$obj["codnom"]);
          $this->numrec--;
        }
      }else
      {
      ...
      $this->cell(32,5,"Sueldo");//// COMENTADO PARA QUE NO IMPRIMA SUELDO
      $this->ln();
      $this->setFont("Arial","",10);
      $this->SetFillColor(170,170,170);
      $this->Rect(16,$this->GetY(),22,4,"F"); //sombrea cedula
      $this->Rect(48,$this->GetY(),112,4,"F"); //sombrea nombre
      $this->cell(9,5,"");
      ...
      //$arrsueldo = $this->objNprhisrecpag->sqlcalulasueldo($obj["codcar"]);
      //$this->cell(30,5,H::FormatoMonto($arrsueldo[$this->index]["valor"]),0,0,"R");
      //$arrsueldo = $this->objNprrecpag->sqlcalulasueldo2($obj["codemp"]);
      //$arrsueldo = $this->objNprhisrecpag->sqlcalulasueldo($obj["nomina2"],$obj["codemp"],$this->fecnomdes,$this->fecnomhas);
     // $this->cell(30,5,H::FormatoMonto(($arrsueldo[$this->index]["valor"])*2),0,0,"R");

     $arrsueldo = $this->objNprhisrecpag->sqlcalulasueldo($obj["nomina2"],$obj["codemp"],$this->fecnomdes,$this->fecnomhas);
          $this->cell(30,5,H::FormatoMonto(($arrsueldo[$this->index]["valor"])*2),0,0,"R");  ///COMENTADO PARA QUE NO IMPRIMA SUELD
     /////// COMENTADO PARA NO IMPRIMIR EL SUELDO
      $this->setFont("Arial","B",8);
      $this->ln();
      $this->cell(5,5,"");
     ...
     // $this->addpage();
      ...
      {
          //****PRESTAMOS OTORGADOS
           $this->arrpcuotas = $this->objNprhisrecpag->sqlcuotas($ref);
     ///H::PrintR($this->arrpcuotas);exit;
      //$this->arrpcoutas
      	...
      	$this->setFont("Arial","B",10);
	    	...
	    	$this->setFont("Arial","B",10);
			$this->SetWidths(array(130,25,25));
   ...
   $this->ln(20);
         ...
         // $arrsueldo = $this->objNprrecpag->sqlcalulasueldo2($obj["codemp"]);
          $arrsueldo = $this->objNprhisrecpag->sqlcalulasueldo($obj["nomina2"],$obj["codemp"],$this->fecnomdes,$this->fecnomhas);
          $this->cell(30,5,H::FormatoMonto(($arrsueldo[$this->index]["valor"])*2),0,0,"R");  ///COMENTADO PARA QUE NO IMPRIMA SUELDO
        ...
        $arrprestamos = $this->objNprhisrecpag->sqlprestamos($obj["codcon"]);
        $arrnpasiconemp =  $this->objNprhisrecpag->sqlnpasiconemp($obj["codemp"],$obj["codcar"],$obj["codcon"]);
...
//---------------------------------
      ...
      $this->arrpcuotas = $this->objNprhisrecpag->sqlcuotas($obj["codemp"]);
     //H::PrintR($this->arrpcuotas);exit;
      //$this->arrpcoutas

...
require_once("../../lib/general/Herramientas.class.php");
	...
	header("Content-Disposition: attachment; filename=/TXT_CESTATIKET_".date('d/m/Y').".txt");
           ...
           if ($especial == 'S')
	    	...
	    	$sql="select b.cedemp, b.nomemp ,a.monto as saldo, a.cantidad as cantidad
						from
...
///////regular
		echo $cliente.';'.$producto.';'.$arrp->fields["cedemp"].';'.$arrp->fields["nomemp"].';'.$punto.';'.$pedido.';'.H::FormatoMonto($arrp->fields["saldo"]).';'.H::FormatoMonto($arrp->fields["cantidad"],0).';28,50;'.chr(10);

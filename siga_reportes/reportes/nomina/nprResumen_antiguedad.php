        ...
        <div align="left">&nbsp;
          <table width="612" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF">
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>Resumen Antiguedad
            ...
            <tr bordercolor="#6699CC">
              <td width="144" class="form_label_01"><strong>Tama&ntilde;o Hoja:</strong></td>
...
<div align="left">
            ...
            <tr bordercolor="#6699CC">
              <td bordercolor="#FFFFFF" class="form_label_04">&nbsp;</td>
              <td>&nbsp;</td>
              <td>&nbsp;
            ...
            <tr bordercolor="#6699CC">
            <div align="left">
            	  <td class="form_label_01"><strong>Edad Desde: </strong></td>
                <td colspan="2">
                   <?
			  $tbw=$bd->select("SELECT min(edaemp) as edad FROM NPHOJINT");
		     ?>

		  <input type="text"  name="edadesde" class="breadcrumb" id="edadesde" value="<?php print $tbw->fields["edad"] ?>">
              ...
              <div align="left">
              <td class="form_label_01"><strong>Edad Hasta: </strong></td>
              <td colspan="2" 
               
                <?
				  $tbw=$bd->select("SELECT max(edaemp) as edad FROM NPHOJINT");
				  ?>

		  <input type="text"  name="edahasta" class="breadcrumb" id="edahasta" value="<?php print $tbw->fields["edad"] ?>">
...
<div align="left">
 ...
 <td height="26" class="form_label_01"> <div align="left"><strong>Sexo:</strong></div></td>
              <td colspan="2" valign="middle"> <select name="sexemp" class="breadcrumb" id="sexemp">
...
{
	f=document.form1;
	f.titulo.value="ANTIGUEDAD ADMINISTRACIÓN PÚBLICA";
	f.action="rnprResumen_antiguedad.php";
	f.submit();
}
function cerrar()
{
...
{
 	mysql='SELECT codemp as Codigo, nomemp as Nombre FROM NPHOJINT order by codemp asc';

<?
    ...
    require_once("../../lib/modelo/sqls/nomina/Relacion_venezuela_disco.class.php");
...
function Cuerpo()
		...
		$nombre_archivo="/tmp/bancovenezuela_"."_".strftime('%d_%m_%y',time()).".txt";
		...
		//print $this->arrp2[0][nomina];exit;
         ...
         ////PRIMERA LINEA
         $lineatxt1 = "HCONTRALORIA MUNICIPAL DE CHACAO         ".str_pad($this->cuenta,20,'0',STR_PAD_LEFT)."01".str_pad($fecha,8,'0',STR_PAD_LEFT).str_pad($monto1,13,'0',STR_PAD_LEFT)."03291".chr(13);
 ...
 $lineatxt = "0".str_pad($dato["cuenta_banco"],20,'0',STR_PAD_LEFT).str_pad($monto,11,'0',STR_PAD_LEFT)."0770".str_pad($dato["nomemp"],40,' ').str_pad($dato["cedemp"],10,'0',STR_PAD_LEFT)."003291 ";

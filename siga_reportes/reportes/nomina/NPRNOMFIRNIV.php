        ...
        <div align="left">&nbsp;
          <table width="647"  border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF">
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>Nomina para la Firma
	      ...
	      <tr>
              ...
              <td colspan="2"><?
					$tb2=$bd->select("SELECT distinct(a.CODNOM),a.NOMNOM as nombre FROM npnomina a,npasicaremp b where a.codnom=b.codnom order by a.CODNOM");
				?>

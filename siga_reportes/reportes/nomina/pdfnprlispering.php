<?
	...
	class pdfreporte extends fpdf
	{
		...
		function pdfreporte()
		{
			...
			$this->sql="select a.cedemp,a.nomemp,to_char(a.fecing,'dd/mm/yyyy') as fecing,
		...
		function Header()
		{
			...
			$this->setwidths(array(18,65,20,45,80,30));
			$this->setAligns('C');
			$this->setborder(true);
			$this->rowm(array("CÉDULA","NOMBRE","FECHA DE INGRESO","CARGO","DEPENDENCIA","NÓMINA"));
			$this->setwidths(array(18,65,20,45,80,30));

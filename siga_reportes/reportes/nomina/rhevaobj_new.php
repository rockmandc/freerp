        ...
        <div align="left">&nbsp;
          <table width="612" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF">
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>Evaluaci&oacute;n de Desempe&ntilde;o 
...
{
	f=document.form1;
	f.titulo.value="EVALUACIÓN DE DESEMPEÑO";
	f.action="rrhevaobj_new.php";
	f.submit();
}
function cerrar()
{

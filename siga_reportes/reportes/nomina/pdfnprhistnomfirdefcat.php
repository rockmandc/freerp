  ...
  class pdfreporte extends fpdf
  {
	...
	(CASE WHEN H.OPECON='P' THEN coalesce(sum(G.MONTO),0) ELSE 0 END) as APORTE, cast(REPLACE(c.cedemp,'.', '') as int )
            ...
            WHERE
              ...
              g.CODCAT>= ('".$this->codcatdes."') AND
              g.CODCAT <= ('".$this->codcathas."') AND
              g.CODCAR>= ('".$this->codcardes."') AND
              g.CODCAR <= ('".$this->codcarhas."') AND
    ...
    function Header()
    {
      $this->cab->poner_cabecera($this,"Nomina Para las Firmas por Categoria",$this->conf,"s");

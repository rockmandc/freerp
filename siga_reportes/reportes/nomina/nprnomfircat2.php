    ...
    <tr>
        ...
        <div align="left">&nbsp;
          <table width="647"  border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF">
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>N&oacute;mina para la Firma
	 ...
	 <tr>
        ...
        ?>" class="breadcrumb" id="tipnomesp" size="20" maxlength="50">
                <input type="button" name="Button3" value="..." onClick="catalogo5('tipnomesp');">
              </div></tr>
...
{
	f=document.form1;
	f.titulo.value="Nómina para la Firma por Categor\u00EDa";
	f.action="rnprnomfircat2.php";
	f.submit();
}
function cerrar()
{

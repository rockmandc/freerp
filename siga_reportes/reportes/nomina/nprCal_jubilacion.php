        ...
        <div align="left">&nbsp;
          <table width="612" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF">
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>Cálculo de Jubilación
            ...
            <tr bordercolor="#6699CC">
              <td class="form_label_01"><strong>Empleado: </strong></td>
              <td colspan="2">
                <?
               ...
               <input type="button" name="boton" value="..." onClick="catalogo1('coddesde')" >              </td>
            </tr>
            <tr bordercolor="#6699CC">
...
{
	f=document.form1;
	f.titulo.value="HOJA INTEGRAL";
	f.action="rnprCal_jubilacion.php";
	f.submit();
}
function cerrar()
{

		...
		function pdfreporte()
		{
			...
			$this->sql="SELECT
						distinct	A.CODEMP as codemp,
							...
							A.NUMCUE as numcue,
							A.OBSEMP as obsemp,
							(CASE WHEN A.TIEFID='N' THEN 'No' ELSE 'Si' END) as tipo,
							c.desniv as ubica
		...
		function Cuerpo()
		{
			...
			while(!$tb->EOF)
			{
				...
				// $this->cell(35,10,'Código Empleado');
				 ...
				 $this->cell(50,10,'Edad');				
				// $this->cell(60,10,'Nro. Resolución / Nombramiento');
				...
				// $this->cell(35,10,'Nacionalidad');
				 ...
				 $this->cell(50,10,$tb->fields["edaemp"]);				
				...
				// $this->cell(35,10,$tb->fields["nacemp"]);
				 $this->ln(3);
				 $this->setFont("Arial","B",8);
				 $this->cell(60,10,'Denominación del Cargo:');
				 $this->cell(60,10,'Nivel del Cargo:');
				 $this->cell(60,10,'Ubicación Administrativa:');
				 //$this->cell(35,10,'Fecha Nacimiento');
				 //$this->cell(50,10,'Edad');
				 //$this->cell(30,10,'Lugar de Nacimiento');
				 //$this->cell(60,10,'Dirección de Habitación');
				 //$this->cell(30,10,'Código Ciudad');
				 //$this->cell(35,10,'Telefono');
				 //$this->cell(25,10,'Celular');
				 $this->ln(3);
				 $this->setFont("Arial","",8);
				 $this->cell(60,10,$tb->fields["nomcar"]);
				  $this->cell(60,10,$tb->fields["ubica"]);
				  $this->cell(60,10,$tb->fields["ubica"]);				
				// $this->cell(35,10,$tb->fields["fecnac"]);
				// $this->cell(50,10,$tb->fields["edaemp"]);
				 $this->setFont("Arial","",6);
				 ...
				 $this->setFont("Arial","",8);
				 //$this->cell(50,10,$tb->fields["codpos"]);
			...
			//	 $this->cell(30,10,"");
				 ...
				 //$this->cell(50,10,$tb->fields["derzur"]);
				 //$this->cell(30,10,$tb->fields["fecing"]); 
				 $y=$this->gety();
				 // $this->setxy(120,$y+3);
				 ...
				 //$this->cell(50,10,'Número Poliza Seguro');
				 $this->cell(30,10,'');
			...
			//	 $this->cell(30,10,'Codigo Banco');
				 ...
				 //$this->cell(50,10,$tb->fields["numpolseg"]);
				 $this->cell(30,10,'');
				   ...
				   // $this->SetTextColor(0,0,0);
					...
					$this->ln(3);
						 ...
						 while(!$tbInfFam->EOF)
						 {
							 ...
							 $this->cell(60,10,$tbInfFam->fields["nomfam"]);
 							 $this->cell(3,10,'');
...
//print '<pre>';print $sql; exit;
				...
				//	$this->SetTextColor(0,0,0);
					$this->ln(6);
 				    $this->setFont("Arial","B",8);
					$this->cell(8,10,'');
					$this->cell(75,10,'Título Obtenido');
					$this->cell(70,10,'Descripción');
					$this->cell(65,10,'Instituto');
					$this->cell(15,10,'Duración');
...
*/
				  ///EXPERIENCIA LABORAL
				 $sql="SELECT  coalesce (NOMEMP,'CONTRALORÍA MUNICIPAL DE CHACAO') as EMPRESA,
						CODCAR,
						DESCAR,
						to_char(FECINI,'dd/mm/yyyy') as fecini,
						to_char(FECTER,'dd/mm/yyyy') as fecter, fecter as ano,
						SUEOBT,
						STACAR
						FROM
							NPEXPLAB
						WHERE
							CODEMP = '".$tb->fields["codemp"]."'  /*and fecter is not null*/
						ORDER BY ano desc";
						//print '<pre>';print $sql; exit; SUBSTR(fecter,1,4) as ano,

<?
	...
	class pdfreporte extends fpdf
	{
		...
		function Header()
		{
			...
			$this->ln();
			$this->cell(150,4,'para participar en el PROCESO DE CONSULTA DE PRECIOS, señalado a continuacion:');

			$this->setFont("Arial","B",8);
			$this->ln();
			$this->cell(160,3,'Procedimiento Nro. '.$this->proc);
			...
			//cuadro 2
			$this->line(15,76,200,76);
			$this->setXY(15,76);
			$this->setFont("Arial","B",8);
			$this->cell(20,5,'   Cantidad');
			$this->cell(60,5,'Unidad de Medida');
			$this->cell(100,5,'                Denominacion');
        	       $this->line(15,81,200,81);
			$this->line(35,76,35,177);
			$this->line(62,76,62,177);
			
			$this->line(15,76,15,177);
			$this->line(200,76,200,177);
			...
			$this->setXY(15,180);
			$this->setFont("Arial","",8);
			$this->multicell(190,3,'OBSERVACIONES: ' .$this->arrp2[0]["obsreq"]);
			$this->setXY(15,198);
			...
			$this->setXY(15,206);
			$this->cell(185,5,'LAPSO Y LUGAR PARA ACLARATORIAS:    Hasta  el  día ' .$this->fecacl. ',  por  escrito  a  traves de oficio,   fax o e-mail  contactos:  José Oropeza');              
			$this->setXY(15,209);
			$this->cell(185,5,'.');
			$this->setXY(15,213);
			$this->cell(185,5,'LAPSO Y ENTREGA DE OFERTAS:    Hasta  el día, '.$this->fecacl2. ' ,  4:00 pm,    las  cuales   deberán   ser  enviadas   vía  fax   al    (0212 285-31-74)'); 
			$this->setXY(15,216);
			$this->cell(185,5,'o vía electrónica  (e-mail)  compras@cmchacao.gob.ve detallando:  Precio  Unitario,  cantidades, precio total,  IVA   y precio total de la  oferta,'); 
  			$this->setXY(15,219);
			$this->cell(185,5,' Nro. de procedimiento,  tiempo  o  fecha  de entrega,  validez  de  la  oferta,  condiciones  de  pago, dirección,  teléfonos, RIF, firmada y sellada.');
			$this->setXY(15,222);
			$this->cell(185,5,'');			
			$this->setXY(15,226);
			...
			$this->setXY(15,240);
			$this->cell(185,5,'Firma: Dir. Adm. y Servicios - Compras                                                               Recibido por el Proveedor (Segun R.L.C.P. Art Nro.33)');	
			$this->setXY(15,254);

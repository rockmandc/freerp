        ...
        <div align="left">&nbsp; 
          <table width="612" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF"> 
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>Catalogo de Ramos de Art&iacute;culos
            ...
            <tr bordercolor="#6699CC"> 
              <td class="form_label_01"> <div align="left"><strong>C&oacute;digo Ramo de Art&igrave;culo:</strong></div></td>
              <td> <div align="left">
				<?
			  	$tb=$bd->select("SELECT DISTINCT(ramart) as cod FROM CARAMART ORDER BY RAMART");
				  ?>
              ...
              <td> <div align="left"> 
				<?
			  	$tb=$bd->select("SELECT DISTINCT(ramart) as cod FROM CARAMART ORDER BY RAMART DESC");
				 ?>
...
{
	f=document.form1;
	f.titulo.value="Catalogo de Ramos de Articulos";

        ...
        <div align="left">&nbsp;
          <table width="612" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF">
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>LISTADO RESUMEN DE ORDENES
                  DE COMPRAS
            ...
            <tr>
              <td class="form_label_01"><strong>Orden de Compra:</strong></td>
              <td>
                <?

			  	$tb=$bd->select("select min(ordcom) as valor from caordcom where ordcom like 'OC%'");
			  ?>
...
<?
			  	...
			  	$tb=$bd->select("select max(ordcom) as valor from caordcom where ordcom like 'OC%'");
			  ?>
...
window.close();
   ...
   {
     mysql='select a.ordcom as Orden,b.nompro as Proveedor from caordcom a,caprovee b where a.codpro=b.codpro and upper(b.nompro) like upper(¿%¿) and a.ordcom like ¿OC%¿ order by a.ordcom';
	  pagina="../../lib/general/catalogoobj.php?sql="+mysql+"&campo="+campo;
	  window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=500,height=400,resizable=yes,left=50,top=50");
   }

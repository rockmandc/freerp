        ...
        <div align="left">&nbsp; 
          <table width="612" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF"> 
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>Catalogo de Ubicaciones
            ...
            <tr bordercolor="#6699CC"> 
              <td class="form_label_01"> <div align="left"><strong>Codigo de Ubicaci&ograve;n:</strong></div></td>
              <td> <div align="left">
			  <?
			  	$tb=$bd->select("select codubi as codubi from cadefubi");
			  ?>
                  <select name="codubi1" class="breadcrumb" id="codubi1">
                    <?
				  	while(!$tb->EOF)	
					{
				  ?>
                    <option value="<? print $tb->fields["codubi"];?>"><? print $tb->fields["codubi"];?></option>
                    <?
					$tb->MoveNext();
					}
				?>
              ...
              <td> <div align="left"> 
			 <?
			  	$tb=$bd->select("select codubi as codubi from cadefubi order by codubi desc");
			  ?>
...
{
	f=document.form1;
	f.titulo.value="Catalogo de Ubicaciones";

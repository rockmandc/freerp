        ...
        <div align="left">&nbsp; 
          <table width="612" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF"> 
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>Catalogo de Almacenes
            ...
            <tr bordercolor="#6699CC"> 
              <td class="form_label_01"> <div align="left"><strong>C&oacute;digo de Almacen:</strong></div></td>
              <td> <div align="left">
				<?
		  		$tb=$bd->select("SELECT DISTINCT CODALM as cod FROM CADEFALM ORDER BY CODALM");
			  ?>
              ...
              <td> <div align="left"> 
			<?
		  		$tb=$bd->select("SELECT DISTINCT CODALM as cod FROM CADEFALM ORDER BY CODALM desc");
			  ?>
...
{
	f=document.form1;
	f.titulo.value="Catalogo de Almacenes";
	f.action="rcardefalm.php";
	f.submit();
}
function cerrar()
{

        ...
        <div align="left">&nbsp; 
          <table width="612" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF"> 
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>Catalogo de Recargos
            ...
            <tr bordercolor="#6699CC"> 
              <td class="form_label_01"> <div align="left"><strong>C&oacute;digo Recargo:</strong></div></td>
              <td> <div align="left">
				<?
		  		$tb=$bd->select("SELECT DISTINCT CODRGO as cod FROM CARECARG ORDER BY CODRGO");
  			    ?>
              ...
              <td> <div align="left"> 
				<?
		  		$tb=$bd->select("SELECT DISTINCT CODRGO as cod FROM CARECARG ORDER BY CODRGO desc");
  			    ?>
            ...
            <tr bordercolor="#6699CC">
              <td class="form_label_01"><strong>Tipo de Recargo: </strong></td>
              <td><select name="tipo" class="breadcrumb" id="tipo">
...
{
	f=document.form1;
	f.titulo.value="Catalogo de Recargos";

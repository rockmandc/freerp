	...
	function Cuerpo()
	 {
		...
		$this->setFont("Arial","",9);
	       ...
	       $this->multicell(185,5,'    La  Contraloría  Municipal  de  Chacao,  a  través  del área de Compras  de la  Dirección de Administración y Servicios, procedió a una consulta de precios para '.$this->tb->fields["desreq"].'. Se procedió a solicitar el presupuesto a las empresas que se detallan a continuación: ');
		 ...
		 $this->multicell(195,5,' Una vez realizado el análisis de precios se seleccionó a la(s) empresa(s): ');
		  ...
		  $this->SetY(210);
                ...
                $this->ln(4);
                $this->cell(125,5,'DIRECTOR DE ADMINISTRACION Y SERVICIOS',C,0,0);
                ...
                $this->cell(155,5,'          COORDINADOR(A) DE FINANZAS');

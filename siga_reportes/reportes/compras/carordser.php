		...
		?>" class="breadcrumb" id="ordcomhas" size="12" maxlength="8">
  		...
  		<a href="#"><img src="../../img/search.gif" align="top" onclick="catalogo('carordser',5); "></a>
            ...
            <tr>
              ...
              <td colspan="2" valign="top"><div align="left">
                  <input name="diradm" type="text" value="Lic. Herman Castes " id="diradm" size="40" maxlength="45" class="breadcrumb">
              </div></td>
            </tr>
            <tr>
              <td height="24" class="form_label_01"><div align="left"><strong>CONTRALOR MUNICIPAL:</strong></div></td>
              <td colspan="2" valign="top"><div align="left">
                  <input name="cont" type="text" value="Wilmer Hernandez" id="cont" size="40" maxlength="45" class="breadcrumb">
              </div></td>
            </tr>
	<tr>

	...
	$this->arrp=array("no_vacio");
		...
		function Cuerpo()
		{
			...
			/*	 $this->cell($this->anchos[0],10,$tb->fields["articulo"]);
				 ...
				 $this->cell($this->anchos[4],10,H::FormatoMonto($tb->fields["eximin"]));*/
				   $this->setwidths(array(25,68,38,30,30));
$this->setaligns(array("L","L","C","R","R"));
//$this->Setborder(true);
$this->rowm(array($tb->fields["articulo"],$tb->fields["des"],$tb->fields["unimed"],H::FormatoMonto($tb->fields["exiact"]),H::FormatoMonto($tb->fields["eximin"])));

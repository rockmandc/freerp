<?
    ...
    require_once("../../lib/modelo/sqls/compras/Caregmovart.class.php");
	...
	class pdfreporte extends fpdf
	{
		...
		function pdfreporte()
		{
			...
			$this->caregmovart = new Caregmovart();
			$this->llenarTitulosAnchos();
			$this->SetAutoPageBreak(true,25);

		    $this->arrp = $this->caregmovart->sqlp($this->almdes,$this->almhas);
		...
		function Cuerpo()
		{
				...
				//Detalle de Entradas
				$this->arrent = $this->caregmovart->sqlentradas($this->codartdes,$this->codarthas,$this->fecdes,$this->fechas,$alm);
				...
				$this->arrrec = $this->caregmovart->sqlrecepcion($this->codartdes,$this->codarthas,$this->fecdes,$this->fechas,$alm);
				...
				//Detalle de Salidas
				$this->arrsal = $this->caregmovart->sqlsalidas($this->codartdes,$this->codarthas,$this->fecdes,$this->fechas,$alm);
				...
				$this->arrdes = $this->caregmovart->sqldespachos($this->codartdes,$this->codarthas,$this->fecdes,$this->fechas,$alm);

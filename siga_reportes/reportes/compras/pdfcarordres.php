...
//print '<pre>'; print $this->sql;exit;
	...
	function getAncho($pos)
	{
		...
		function Header()
		{
			...
			$this->cab->poner_cabecera_f($this,"LISTADO RESUMEN DE ORDENES DE COMPRAS: "."DESDE   ".$this->fecreg1."   HASTA   ".$this->fecreg2,"l","s","n");
	 ...
	 $this->ln();
				...
				// $this->cell($this->anchos2[9]-8,4,"".H::FormatoMonto($this->amonord),0,0,'R');

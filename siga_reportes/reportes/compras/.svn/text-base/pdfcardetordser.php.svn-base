...
//print $this->sql;exit;
	...
	function llenartitulos2()
		...
		function Header()
		{
			...
			$this->cab->poner_cabecera_f($this,H::GetPost("titulo")." DE SERVICIO:  "."DESDE   ".$this->fecreg1."   HASTA   ".$this->fecreg2,"l","s","n");
			else
			$this->cab->poner_cabecera_f($this,H::GetPost("titulo"),"l","s","n");

	...
	function llenartitulos2()
		{
				...
				$this->titulos2[5]="No Despachada";
				$this->titulos2[6]=" Total";
		...
		function Header()
		{
			$this->cab->poner_cabecera_F($this,H::GetPost("titulo")." DESDE ".$this->fecreg1." HASTA ".$this->fecreg2,"l","s");
			...
			{
				$this->cell($this->anchos2[$i],7,$this->titulos2[$i],0,0,'L');
			}
			...
			function Cuerpo()
		{
			...
			if(!$tb->EOF)
			{
				$ref=$tb->fields["adphart"];
				 ...
				 $this->multicell($this->anchos[6]+10,3," ".$tb->fields["nomori"]);
...
//				 $this->ln();
	...
	//			 $this->Line(10,$this->GetY()+5,270,$this->GetY()+5);
				...
				$y=$this->gety();
				 ...
				 $this->setxy(140,$y);
				 $this->multicell(70,5,"".$tb->fields["nomdes"]);

      ...
      <td rowspan="2" valign="top" class="cell_padding_01"> <p class="breadcrumb">Reportes
        ...
        <div align="left">&nbsp;
          <table width="612" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr>
              <td height="23" class="form_label_01"><strong>Fecha Inventario:</strong></td>
              <td> <div align="left"> </div>
                <div align="left">
                  <?

			  	$tb=$bd->select("select to_char(min(FECINV),'DD/MM/YYYY') as valor FROM CAINVFIS");
				if(!$tb->EOF)
				{
					$fecini=$tb->fields["valor"];
				}
				?>
                  <input name="fechainv" type="text" class="breadcrumb" id="fechainv" value="<? print $fecini;?>" datepicker="true">
                </div></td>
            </tr>
            <tr>
...
{
	f=document.form1;
	f.titulo.value="RELACIÓN INVENTARIO ALMACEN";

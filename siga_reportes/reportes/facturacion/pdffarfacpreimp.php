...
//--------------- REPORTE SUPERIOR DERECHO
     ...
     //       SEPARAR LA FECHA
                ...
                $this->SetXY(158,75);
                $this->setFont("Helvetica","",10);
                $this->Multicell(50,4,$fecven[0].'/'.$fecven[1].'/'.$fecven[2]);
                ...
                $this->Multicell(20,4,'Asesor:');
                 ...
                 $this->SetXY(158,80);
                $this->setFont("Helvetica","",9);
                $this->Multicell(50,4,$dato["nomcon"]);
...
//-------------------------------------------------------------------- LINEA SUPERIOR REPORTE ARTICULOS
        ...
        $this->Line(5,97,211,97); // LINEA SUPERIOR REPORTE ARTICULOS 1
                   ...
                   // H::PrintR($dato1);exit;
                    ...
                    if($dato1["codart"]!=$codart)

                       {
                        ...
                        $this->SetX(1);
                      	$this->SetWidths(array(30,100,35,13,27));
...
*/
 ...
 $this->Line(5,178,211,178); // LINEA SUPERIOR REPORTE ARTICULOS 2

  $this->Line(5,205,211,205); // LINEA SUPERIOR REPORTE ARTICULOS 2
...
//   CREDITOS
                   ...
                   $this->Image("../../img/logo_1.jpg", 7, 207, 36);
                  // $this->writeHTML('<img src="../../img/logo_1.jpg" width="104"> '); 
                   ...
                   $this->SetX(5);
				   $this->writeHTML('4- No se <b>ACEPTAN DEVOLUCIONES</b> después de recibida la mercancia.<br>');
                   $this->SetX(5);
                   $this->writeHTML('5- <b>USTED PUEDE EFECTUAR SU PAGO EN:</b><br>');
                   $this->SetX(5);

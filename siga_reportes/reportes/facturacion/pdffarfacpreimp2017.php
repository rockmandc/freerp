...
*/
 ...
 $this->Line(5,189,211,189); // LINEA SUPERIOR REPORTE ARTICULOS 2

  $this->Line(5,285,211,285); // LINEA SUPERIOR REPORTE ARTICULOS 2
...
//   CREDITOS
                   ...
                   $this->Image("../../img/logo_1.jpg", 7, 210, 36);

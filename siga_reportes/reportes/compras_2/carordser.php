...
<?php include_once("../../lib/general/formtop.php")?>
		...
		?>" class="breadcrumb" id="ordcomdes" size="12" maxlength="8">
  		<a href="#"><img src="../../img/search.gif" align="top" onclick="catalogo('carordser',0); "></a>
	      </td>
              <td valign="top">
		...
		?>" class="breadcrumb" id="ordcomhas" size="12" maxlength="8">
  		<a href="#"><img src="../../img/search.gif" align="top" onclick="catalogo('carordser',1); "></a>
	      </td>
            </tr>
            <tr>
  		...
  		<a href="#"><img src="../../img/search.gif" align="top" onclick="catalogo('carordser',2); "></a>
              </div></td>
              <td valign="top">
  		...
  		<a href="#"><img src="../../img/search.gif" align="top" onclick="catalogo('carordser',3); "></a>
			  </td>
            </tr>
            <tr>
  		...
  		<a href="#"><img src="../../img/search.gif" align="top" onclick="catalogo('carordser',4); "></a>
              </td>
  		...
  		<a href="#"><img src="../../img/search.gif" align="top" onclick="catalogo('carordser',5); "></a>
		</td>
            </tr>
            <tr>
            ...
            <tr>
              <td height="24" class="form_label_01"><div align="left"><strong>OFICINA DE PLANIFICACION Y PRESUPUESTO:</strong></div></td>
            ...
            <tr>
              ...
              <td colspan="2" valign="top"><div align="left">
                  <input name="diradm" type="text" value="Lic. Esther Norelia Pérez " id="diradm" size="40" maxlength="45" class="breadcrumb">
              </div></td>
            </tr>
            <tr>
              <td height="24" class="form_label_01"><div align="left"><strong>CONTRALOR MUNICIPAL:</strong></div></td>
              <td colspan="2" valign="top"><div align="left">
                  <input name="cont" type="text" value="Rafael Sáez" id="cont" size="40" maxlength="45" class="breadcrumb">
              </div></td>
            </tr>
	<tr>
              <td height="24" class="form_label_01"><div align="left"><strong>CLAUSULA DE FIEL CUMPLIMIENTO:</strong></div></td>
              <td colspan="2" valign="top"><div align="left">
                  <input name="cumpl" type="text" value=" " id="cumpl" size="40" maxlength="45" class="breadcrumb">
              </div></td>
            </tr>
	<tr>
              <td height="24" class="form_label_01"><div align="left"><strong>CLAUSULA PENAL:</strong></div></td>
              <td colspan="2" valign="top"><div align="left">
                  <input name="penal" type="text" value=" " id="penal" size="40" maxlength="45" class="breadcrumb">
              </div></td>
            </tr>

...
<?php include_once("../../lib/general/formtop.php")?>
            ...
            <tr bordercolor="#6699CC">
              ...
              <td>
				 <?
			  	$tb=$bd->select("SELECT REQART as cod FROM CAREQARTSER ORDER BY REQART asc");
			  ?>
              ...
              <td>
			 <?
			  	$tb=$bd->select("SELECT REQART as cod FROM CAREQARTSER ORDER BY REQART desc");
			  ?>
            ...
            <tr bordercolor="#6699CC">
              ...
              <td>
				<?
			  	$tb=$bd->select("SELECT DISTINCT CODCAT as cod FROM CAARTREQSER ORDER BY CODCAT ASC");
			   ?>
              ...
              <td>
				<?
			  	$tb=$bd->select("SELECT DISTINCT CODCAT as cod FROM CAARTREQSER ORDER BY CODCAT desc");
			   ?>
          ...
          <!--  <tr>
              ...
              <?
			  	$ts=$bd->select("SELECT DISTINCT MIN(to_date(FECREQ,'yyyy-mm-dd')) as fecha FROM  CAREQARTSER");
			  	if(!$ts->EOF)
				{
              ...
              <?
			  	$tr=$bd->select("SELECT DISTINCT MAX(to_date(FECREQ,'yyyy-mm-dd')) as fecha FROM  CAREQARTSER");
				if(!$tr->EOF)
				{
	   ...
	   <tr>
              <td height="24" class="form_label_01"><div align="left"><strong>MOTIVACION:</strong></div></td>

              <td colspan="2" valign="top"><div align="left">

                  <input name="mot" type="text" value=" " id="mot" size="100" maxlength="300" class="breadcrumb">
              </div></td>
          
	    </tr>

		<tr>
              <td height="24" class="form_label_01"><div align="left"><strong> Responsable Unidad Solicitante:</strong></div></td>

              <td colspan="2" valign="top"><div align="left">

                  <input name="resp" type="text" value=" " id="mot" size="60" maxlength="110" class="breadcrumb">
              </div></td>

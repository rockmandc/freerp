		...
		while (!$tb->EOF) {
			...
			if ($tb->fields["ordcom"] != $ref) //Imprimimos encabezado
				...
				if ($tb->fields["tipord"] != "S") {
					$this->Cell(150, 5, "AJUSTES A LA ORDEN DE COMPRA", 0, 0, 'C');
				} else {
					$this->Cell(150, 5, "AJUSTE A LA ORDEN DE SERVICIO", 0, 0, 'C');
				}
...
/*				$this->SetXY(185,6);
				...
				if ($tb->fields["tipord"] != "S") {
					$var = "OC";
					$var2="ORDEN DE COMPRA";
				} else {
					$var = "OS";
					$var2="ORDEN DE SERVICIO";
				}
/*				$this->SetXY(135, 6);
...
//				$this->SetXY(42, 79);
			...
			if (($MiY > 208) && (!$tb->EOF)) {
				...
				$this->SetXY(60+20+10, 240);
				$this->SetFont("Arial", "B", 8);
				$this->Cell(50, 5, 'COORDINADOR(A)', 0, 0, 'C');
				$this->Rect(60+20, $this->GetY(), 70, 25);
				//Finanzas
				$this->Rect(150, $this->GetY(), 60, 5);
				$this->SetXY(110+20+30, 240);
				$this->SetFont("Arial", "B", 8);
...
*/
			...
			$this->MultiCell(70, 4,$this->nom );
				...
				if ($descuento > 0) {
					...
					if ($this->t !== "S") {
						$tipo = "AJUSTE A ORDEN DE COMPRA";
					} else
						if ($this->t == "S") {
							$tipo = "AJUSTE A ORDEN DE SERVICIO";
						}

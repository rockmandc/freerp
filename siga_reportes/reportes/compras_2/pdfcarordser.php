...
//////////////////DETALLE
 ...
 $this->SetFont("Arial","",7);
  ...
  //  $this->line(10,234, 205, 234);
    ...
    $this->SetXY(15,238);
    $this->Cell(60,4,'OFICINA DE PLANIFICACION Y PRESUPUESTO',0,0,'C');
     ...
     while($this->i < $eof and $ref==$this->arrp[$this->i]["ordcom"])
      {
        ...
        if($lineas>$lineasrestante){
          ...
          $this->SetFont("Arial","",8);
          $this->SetWidths(array(11,24,55,30,13,30,31));
          $this->SetAligns(array('C','L','J','C','R','R','R'));
          $paginaantes=$this->PageNo();
          //if(strlen(rtrim($this->arrp[$this->i]["desres"]))>95) $this->SetFont("Arial","",6);
          $this->Row(array((string)$contador,substr( $this->arrp[$this->i]["codcat"],6,2).'-'.$this->arrp[$this->i]["codpar1"],rtrim($this->arrp[$this->i]["desres"]),$this->arrp[$this->i]["unimed"],H::FormatoMonto($this->arrp[$this->i]["cantot"],0,0),H::FormatoMonto($this->arrp[$this->i]["preart"]),H::FormatoMonto(($this->arrp[$this->i]["cantot"]*$this->arrp[$this->i]["preart"]))));

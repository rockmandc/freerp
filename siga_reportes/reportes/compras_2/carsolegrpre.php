...
$titulo='REQUISICIÓN/PRESUPUESTO BASE';
...
<?php include_once("../../lib/general/formtop.php")?>
            ...
            <tr>
              <td height="45" class="form_label_01"><div><strong>REQUISICIÓN : </strong></div></td>
              <td valign="top">
            ...
            <tr>
              <td class="form_label_01"><strong>COORDINADOR DAF :</strong></td>
              <td colspan="2"><input name="logistica" type="text" class="breadcrumb" id="logistica" value="" size="62"></td>
            </tr>
              <tr>
              <td class="form_label_01"><strong>DIR. ADMINISTRACION:</strong></td>

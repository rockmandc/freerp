...
$titulo='SOLICITUD DE BIENES MUEBLES Y MATERIALES                                                      .';
...
<?php include_once("../../lib/general/formtop.php")?>
            ...
            <tr bordercolor="#6699CC">
              <td class="form_label_01"><strong>SOLICITUD DE BIENES MUEBLES Y MATERIALES: </strong></td>
              <td>
				 <?
 		...
 		<tr>
              ...
              <td colspan="2" valign="top"><div align="left">
                  ...
                  <input name="mot" type="text" value=" " id="mot" size="60" maxlength="290" class="breadcrumb">
              </div></td>

        ...
        <div align="left">&nbsp;
          <table width="612" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF">
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>Inventario
            ...
            <tr>
             ...
             <tr>
              <td class="form_label_01"> <div align="left"><strong>C&oacute;digo Ubicaci&oacute;n:</strong></div></td>
              <td>
                <?

			  	$tb=$bd->select("select min(codubi) as valor from CAALMUBI ");
			  ?>
               <input type="text" name="codubides" class="breadcrumb" id="codubides" value="<? print $tb->fields["valor"];?>" />
               <input type="button" name="Button" value="..." onClick="catalogo2('codubides');" />
                </td>
...
{
    pagina="../../lib/general/catalogoobj.php?campo="+campo+"&sql=SELECT codubi as Codigo, nomubi as Nombre FROM CADEFUBI order by codubi";
	window.open(pagina,"Catalogo","menubar=no,toolbar=no,scrollbars=yes,width=500,heigth=400,resizable=yes,left=50,top=50");
}
</script>
<?$bd->closed();?>

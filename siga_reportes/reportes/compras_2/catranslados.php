...
<?php include_once("../../lib/general/formtop.php")?>
       ...
       <?
        ...
        ?>
          ...
          <a href="#"><img src="../../img/search.gif" align="top" onclick="catalogo('catranslados',1);" ></a>
            ...
            <tr bordercolor="#6699CC">
              ...
              <td> <div align="left">
        <?
          $tb=$bd->select("SELECT min(CODART) as cod FROM CADETTRA");
            ?>
          ...
          <a href="#"><img src="../../img/search.gif" align="top" onclick="catalogo('catranslados',2);" ></a>
              ...
              <td> <div align="left">
        <?
          $tb=$bd->select("SELECT max(CODART) as cod FROM CADETTRA");
            ?>
        ...
        <?
          $ts=$bd->select("SELECT to_char(min(FECTRA),'dd/mm/yyyy') as fecha FROM CATRAALM");
          if(!$ts->EOF)
        {
        ...
        <?
          $tr=$bd->select("SELECT to_char(max(FECTRA),'dd/mm/yyyy') as fecha FROM CATRAALM");
        if(!$tr->EOF)
        {

<?
  ...
  require_once("../../lib/modelo/sqls/bienes/Bm2lista.class.php");
  ...
  class pdfreporte extends fpdf
  {
    ...
    function pdfreporte()
    {
      ...
      $this->objBm2lista = new Bm2lista();
      $this->arrp = $this->objBm2lista->sqlp($this->ubiorides,$this->ubiorihas,$this->fecdes,$this->fechas,$this->codactmin,$this->codactmax, $this->codmuemin, $this->codmuemax,$this->coddisdes,$this->coddishas,$this->nrodismuemin,$this->nrodismuemax);
    ...
    function llenartitulosmaestro()
    {
        ...
        $this->titulo[]="CANTIDAD DE MOVIMIENTOS";
        $this->ancho[]=$ancho*12.45;
        $this->titulo[]="TIPO DE MOVIMIENTO";
        $this->ancho[]=$ancho*12.45;
...
////////////////////
      ...
      //$arrp1 = $this->objBm2lista->sqldatos();
      $this->setFont("Arial","",10);
      $this->ln();
		
		$this->MultiCell(200,2,"RESUMEN DESDE  ". $this->fecdes. "  HASTA EL  ".$this->fechas);	
	      //$this->MultiCell(200,2,"PERIODO DE LA CUENTA: ".H::ObtenerMesenLetras(substr(date('d/m/Y'),3,2))." ".substr(date('d/m/Y'),6,4));
$this->ln();
  ...
  $this->setFont("Arial","",8);
    ...
    function Cuerpo()
    {
    	...
    	foreach($this->arrp as $registro)
    	{
    		...
    		if ($acodubi!=$registro["codubiori"])
				{
					...
					$this->arrp2=$this->objBm2->sqlp2($registro["codubiori"]);
				 	foreach($this->arrp2 as $arrp2){
						 ...
						 $this->SetXY(70,58.5);
						 $this->setFont("Arial","",8);
		    			 $this->Cell(120,5,$registro["desubiori"],0,0,'L');
		    		     $this->SetXY(95,58);
						 $this->setFont("Arial","",8);
    		...
    		$this->RowM(array($registro["numero"],$registro["tipdismue"]));
	  		$this->indice++;

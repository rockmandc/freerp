       ...
       //  $this->Line(235,$this->GetY(),270,$this->GetY());
		...
		// $this->t_activo2=0;
		 ...
		 $this->sety(185);
			...
			$this->Line(100,$this->GetY(),100,$this->GetY()+23);
			$this->Line(180,$this->GetY(),180,$this->GetY()+23);
			$this->Line(270,$this->GetY(),270,$this->GetY()+23);
			$this->SetTextColor(150,0,0);
			...
			if ($this->nota<>''){
			$this->multicell(265,2,"Nota: ".substr($this->nota,0,540));
			}
...
$this->setBorder(1);
		...
		//	 $this->ln();
           ...
           /*  if ($this->gety()>160){
						 ...
						 $this->SetXY(85,46);
						 $this->setFont("Arial","",10);
		    			 $this->Cell(120,5,$bdesubi.' :  '.$dirubi2,0,0,'L');
              }*/
			 		...
			 		//	 $this->Line(10,$this->GetY()+2,270,$this->GetY()+2);
		 			 ...
		 			 /*    $this->SetX(10);
						 ...
						 $this->ln();
				 		 ...
				 		 $this->SetX(195);
						 $this->cell(45,5,"Total de Activo:");

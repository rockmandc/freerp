...
<form name="form1" method="post" action="">
  ...
  <table width="760"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
        ...
        <div align="left">&nbsp;
          <table width="612"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF">
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>SITUACION
                  DE BIENES MUEBLES
	...
	<tr bordercolor="#6699CC"> 
              <td class="form_label_01"><strong>Situaci&oacute;n del Bien:</strong></td>
...
{
	f=document.form1;
	f.titulo.value="SITUACION DE BIENES MUEBLES";

...
<?php include_once("../../lib/general/formtop.php")?>
             <tr bordercolor="#6699CC">
              <td class="form_label_01"><strong>Año</strong></td>
              <td>
            ...
            <tr bordercolor="#6699CC">
              <td class="form_label_01"><strong>Período</strong></td>
              <td>
            ...
            <tr bordercolor="#6699CC">
              ...
              <input name="codpredesde" type="text"  value="<?
				...
				<a href="#"><img src="../../img/search.gif" align="top" onclick="catalogo('libranza',0); "></a>
              </td>
              <td>
              <input name="codprehasta" type="text"  value="<?
				...
				<a href="#"><img src="../../img/search.gif" align="top" onclick="catalogo('libranza',1); "></a>
			  </td>
            </tr>
            <tr bordercolor="#6699CC">

<?
    ...
    require_once("../../lib/modelo/sqls/presupuesto/Precau.class.php");
...
$this->cab=new cabecera();
		   ...
		   $this->precau= new Precau();
		   $this->arrp=$this->precau->sqlp($this->fecprc1,$this->fecprc2,$this->tipprc1,$this->tipprc2,$this->pre1,$this->pre2,$this->codpre1,$this->codpre2,$this->comodin,$this->combodes);
		//  H::printR($this->arrp);
		...
		function llenartitulosmaestro2()
		{
				...
				$this->titulos2[1]="";
				$this->titulos2[2]="";
				$this->titulos2[3]="Causado";
				$this->titulos2[4]="Pagado";
				$this->titulos2[5]="Ajuste";
				$this->titulos2[6]="Monto Ajustado";
  ...
  function llenaranchos()
	{
		...
		function Header()
		{
			$this->cab->poner_cabecera_f_b($this,$_POST["titulo"],$this->conf,"s","s");
				$this->cell(0,5,"Desde  ".$this->fecprc1."  Hasta  ".$this->fecprc2,0,0,'C');
				$this->ln();

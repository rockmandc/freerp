      ...
      <td rowspan="2" valign="top" class="cell_padding_01"> <p class="breadcrumb">Reportes
        ...
        <div align="left">&nbsp;
          <table width="612"  border="0" align="center" cellspacing="0" bordercolor="#FFFFFF" class="grid_line01_tl">
		    ...
		    <tr bordercolor="#FFFFFF"style="display:none">
              ...
              <td colspan="2">
    			 <?
			  	   ...
			  	   $sql="SELECT CONSEC||' - '||NOMEXT as agrupar FROM CPNIVELES WHERE CATPAR='C' ORDER BY CONSEC desc";
                 ?>

                <select name="agrupar" class="breadcrumb" id="agrupar" >
				 <? LlenarComboSql($sql,"agrupar","agrupar","xx",$bd,"0") ?>
                </select></td>
            </tr>
            <tr style="display:none">
              ...
              <td><?
               ...
               ?>
                  <select name="niveldesde" class="breadcrumb" id="niveldesde">
                    <?
				  	while(!$tb->EOF)
					{
				  ?>
              ...
              <td><?
               ...
               ?>
                  <select name="nivelhasta" class="breadcrumb" id="nivelhasta">
                    <?
				  	while(!$tb->EOF)
					{
				  ?>
              ...
              <td> <div align="left">
                <select name="nivhasta" class="breadcrumb" id="nivhasta">
                 <?
				    ...
				    LlenarComboSql($sql,"consec","nomext","xx",$bd,"0");
			     ?>
			     </select>
			  </div></td>
              <td> </tr>
        ...
        <!--    <tr bordercolor="#FFFFFF">
            ...
            <tr bordercolor="#FFFFFF">
              <td height="24" class="form_label_01">
                <div align="left"><strong>Totales :</strong></div></td>
              <td> <div align="left">
                <select name="consepar" class="breadcrumb" id="consepar">
                 <?
			  	    //$tb=$bd->select("select nomext,consec from cpniveles where catpar='P' order by consec deSC");
			  	    $sql="select nomext,consec from cpniveles where catpar='C' order by consec deSC";

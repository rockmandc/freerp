...
<form name="form1" method="post" action="rpredetcom.php">
          ...
          <table width="612" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr bordercolor="#6699CC">
             ...
             <tr bordercolor="#6699CC">
              ...
              <td valign="top">
			  <?
			  $tb1=$bd->select("SELECT min(refcau) as valor FROM cpcausad");
			  ?>
			  ...
			  <?
			  $tb1=$bd->select("SELECT max(refcau) as valor FROM cpcausad");
			  ?>
 ...
 <tr bordercolor="#6699CC">
              <td height="26" valign="top" class="form_label_01"><strong>Fecha de Causado :</strong></td>
              <td valign="top">
			  <?
			  $tb1=$bd->select("SELECT to_char(min(feccau),'dd/mm/yyyy') as feccom FROM cpcausad");
			  ?>
              ...
              <td valign="top">
                  ...
                  <?
			  $tb1=$bd->select("SELECT to_char(max(feccau),'dd/mm/yyyy') as feccom FROM cpcausad");
			  ?>
              ...
              <tr bordercolor="#6699CC">
              <td height="26" valign="top" class="form_label_01"><strong>Tipo de Causado:</strong></td>
              <td valign="top">
			  <?
			  $tb1=$bd->select("SELECT min(tipcau) as valor FROM cpdoccau");
			  ?>
              ...
              <td valign="top"><font color="#00FFCC">
			  <?
			  $tb1=$bd->select("SELECT max(tipcau) as valor FROM cpdoccau");
			  ?>
...
function catalogo1(campo)
{
    ...
    pagina="../../lib/general/catalogoobj.php?campo="+campo+"&sql=SELECT distinct(refcau) as referencia FROM cpcausad order by refcau asc";
...
{
    pagina="../../lib/general/catalogoobj.php?campo="+campo+"&sql=SELECT DISTINCT(tipcau) as tipo, nomext as Nombre FROM cpdoccau ORDER BY tipcau ";
	window.open(pagina,"Catalogo","menubar=no,toolbar=no,scrollbars=yes,width=500,heigth=400,resizable=yes,left=50,top=50");
}

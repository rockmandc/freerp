<?
	...
	class pdfreporte extends fpdf
	{
		...
		//	$this->getCabecera(H::GetPost("titulo"),"");
		    ...
		    $this->SetBorder(1);
		    $y=$this->getY();
			$this->Rowm(array($this->titulos[0].chr(10)." ",$this->titulos[1].chr(10)." "));
			$this->setXY(50,$y);
			$this->SetWidths(array($this->anchos[2]));
			$this->SetAligns(array("C"));
		    $this->SetBorder(1);
		    $this->Rowm(array($this->titulos[2]));
		    $this->setX(50);
		    $this->Rowm(array($this->titulos[13]));
		    $this->setX(50);
		    ...
		    $this->Rowm(array($this->titulos[6],$this->titulos[7],$this->titulos[8],$this->titulos[9],$this->titulos[10],$this->titulos[11],$this->titulos[12]));
			$this->setXY(110,$y);
			$this->setFont("Arial","B",9);
			$this->SetWidths(array($this->anchos[3]));
			$this->SetAligns(array("C"));
		    $this->SetBorder(1);
		    $this->Rowm(array($this->titulos[3].chr(10)." ".chr(10)." "));
			$this->setXY(130,$y);
			$this->SetWidths(array($this->anchos[2]));
			$this->SetAligns(array("C"));
		    $this->SetBorder(1);
		    $this->Rowm(array($this->titulos[4]));
		    $this->setX(130);
		    $this->Rowm(array($this->titulos[13]));
		    $this->setX(130);
			$this->SetWidths(array($this->anchos[6],$this->anchos[7],$this->anchos[8],$this->anchos[9],$this->anchos[10],$this->anchos[11],$this->anchos[12]));
		...
		function Cuerpo()
		{
             foreach($this->arrp as $dato)
				...
				foreach($this->arrdet as $det)
                {
					...
					$this->SetAligns(array("C","C","C","C","C","C","C","C","C","R","C","C","C","C","C","C","C","R"));
		    		$this->SetBorder(1);
		    		$this->Rowm(array($dato["reftra"],substr($dato["fectra"],8,2)."/".substr($dato["fectra"],5,2)."/".substr($dato["fectra"],0,4),$a1[0],$a1[1],$a1[2],$a1[3],$a1[4],$a1[5],$a1[6],H::FormatoMonto($det["monmov"]),$a2[0],$a2[1],$a2[2],$a2[3],$a2[4],$a2[5],$a2[6],H::FormatoMonto($det["monmov"])));
		    		$this->SetWidths(array($this->anchos[0],$this->anchos[1],$this->anchos[6],$this->anchos[7],$this->anchos[8],$this->anchos[9],$this->anchos[10],$this->anchos[11],$this->anchos[12],$this->anchos[3],$this->anchos[6],$this->anchos[7],$this->anchos[8],$this->anchos[9],$this->anchos[10],$this->anchos[11],$this->anchos[12],$this->anchos[3]));
					$this->SetAligns(array("C","C","C","C","C","C","C","C","C","R","C","C","C","C","C","C","C","R"));
					}else{
					$a1=split("-",$det["codori"]);
					...
					$this->SetAligns(array("C","C","C","C","C","C","C","C","C","R","C","C","C","C","C","C","C","R"));
		    		$this->SetBorder(1);
		    		$this->Rowm(array("","",$a1[0],$a1[1],$a1[2],$a1[3],$a1[4],$a1[5],$a1[6],H::FormatoMonto($det["monmov"]),$a2[0],$a2[1],$a2[2],$a2[3],$a2[4],$a2[5],$a2[6],H::FormatoMonto($det["monmov"])));
		    		$this->SetWidths(array($this->anchos[0],$this->anchos[1],$this->anchos[6],$this->anchos[7],$this->anchos[8],$this->anchos[9],$this->anchos[10],$this->anchos[11],$this->anchos[12],$this->anchos[3],$this->anchos[6],$this->anchos[7],$this->anchos[8],$this->anchos[9],$this->anchos[10],$this->anchos[11],$this->anchos[12],$this->anchos[3]));
					$this->SetAligns(array("C","C","C","C","C","C","C","C","C","R","C","C","C","C","C","C","C","R"));
					}
                    ...
                    $this->SetWidths(array($this->anchos[0],$this->anchos[1],$this->anchos[6],$this->anchos[7],$this->anchos[8],$this->anchos[9],$this->anchos[10],$this->anchos[11]+$this->anchos[12],$this->anchos[3],$this->anchos[6],$this->anchos[7],$this->anchos[8],$this->anchos[9],$this->anchos[10],$this->anchos[11],$this->anchos[12],$this->anchos[3]));
                	$this->SetAligns(array("C","C","C","C","C","C","C","C","R","C","C","C","C","C","C","C","R"));
		    		$this->SetBorder(0);
		    		$this->setFont("Arial","B",7);
		    		 //$this->settextcolor(0,0,225);
		    		$this->Rowm(array("","","","","","","","Sub-Total",H::FormatoMonto($dato["tottra"]),"","","","","","","",H::FormatoMonto($dato["tottra"])));
		    		$this->SetBorder(1);
		    		...
		    		$this->SetBorder(1);
		    		$this->setFont("Arial","B",7);
		    		$this->Rowm(array("TOTAL",H::FormatoMonto($total),"",H::FormatoMonto($total)));
		    		$total=0;
		    ...
		    $this->SetBorder(1);
            $this->ln();
			$this->Rowm(array("REVISADO","CONFORMADO"));
			// $this->ln();
			$this->setJump(8);
		    $this->Rowm(array($this->revisado,$this->conformado));
		    $this->setJump(2);
		     $this->Rowm(array("Analista de Presupuesto","Director de la Oficina de Planificación y Presupuesto"));
            }
	}

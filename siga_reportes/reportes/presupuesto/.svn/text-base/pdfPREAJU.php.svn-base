<?
  ...
  class pdfreporte extends fpdf
  {
    ...
    function llenartitulosdetalle()
    {
        ...
        $this->titulos2[2]="Monto del Ajuste";
    ...
    function Header()
    {
      ...
      {
        $this->cell($this->anchos2[$i],10,$this->titulos2[$i],0,0,'L');
      }
      $this->ln();
    ...
    function Cuerpo()
    {
      ...
      if(!$tb2->EOF)
      {
        ...
        $y=$this->gety();
        $this->cell($this->anchos[0],5,$tb->fields["referencia"],0,0,'L');
        $this->cell($this->anchos[1],5,$tb->fields["fecha"],0,0,'L');
        $this->cell($this->anchos[2],5,"",0,0,'C');
        $this->cell($this->anchos[3],5,$tb->fields["arefere"],0,0,'L');
        $this->setxy(50,$y);
        $this->multicell($this->anchos[2],5,$tb->fields["tipo"],0,'L');
        $this->ln();
      ...
      while(!$tb->EOF)
      {
        ...
        $this->setFont("Arial","",8);
        //Detalle
        $this->cell($this->anchos2[0],5,$tb->fields["bcodpre"]);
        $this->cell($this->anchos2[1],5,substr($tb->fields["adesaju"],0,60));
        $this->cell($this->anchos2[2],5,number_format($tb->fields["bmonaju"],2,',','.'),0,0,'R');
        $this->ln();

        ...
        <div align="left">&nbsp;
          <table width="612" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF">
              <td colspan="3" class="form_label_01"><div align="center"><font color="#000066" size="4"><strong> Certificaci&oacute;n Presupuestaria
            ...
            <tr bordercolor="#6699CC">
              ...
              <td>
                <?
			  	...
			  	$tb=$bd->select("Select Distinct(pereje) as pereje from CPPEREJE order by pereje");
               ?>
              ...
              <td>
                <?
			  	$tb=$bd->select("Select Distinct(pereje) as pereje from CPPEREJE order by pereje desc");
               ?>
            ...
            <tr>
              ...
              <td colspan="2"><input name="filtro" type="text" class="breadcrumb" id="filtro" value="%" size="60"></td>
               ...
               <tr>
              <td class="form_label_01"><strong>Numero de Gaceta Municipal :</strong></td>
              <td colspan="2"><input name="gaceta" type="text" class="breadcrumb" id="gaceta" value="" size="30"></td>
            </tr>
               <tr>
              <td class="form_label_01"><strong>Decreto N#:</strong></td>
              <td colspan="2"><input name="decre" type="text" class="breadcrumb" id="decre" value="" size="30"></td>
            </tr>
            <tr bordercolor="#FFFFFF">

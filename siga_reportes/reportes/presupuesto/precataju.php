        ...
        <div align="left">&nbsp; 
          <table width="612" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF"> 
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>Catalogo de Documentos de Ajustes
            ...
            <tr bordercolor="#6699CC"> 
              <td class="form_label_01"> <div align="left"><strong>Tipo de Ajuste:</strong></div></td>
              <td> <div align="left">
			  <?
			  	$tb=$bd->select("SELECT tipaju as tipaju FROM cpdocaju ORDER BY tipaju");
			  ?>
                  <select name="tipaju1" class="breadcrumb" id="tipaju1">
                    <?
				  	while(!$tb->EOF)	
					{
				  ?>
              ...
              <td> <div align="left"> 
			 <?
			  	$tb=$bd->select("SELECT tipaju as tipaju FROM cpdocaju ORDER BY tipaju desc");
			  ?>
                  <select name="tipaju2" class="breadcrumb" id="tipaju2">
                    <?
				  	while(!$tb->EOF)	
					{
				  ?>
...
{
	f=document.form1;
	f.titulo.value="Catalogo de Documentos de Ajustes";
	f.action="rprecataju.php";
	f.submit();
}
function cerrar()
{

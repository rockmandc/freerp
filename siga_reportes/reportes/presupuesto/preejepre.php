          ...
          <table width="612"  border="0" align="center" cellspacing="0" bordercolor="#FFFFFF" class="grid_line01_tl">
            ...
            <tr bordercolor="#FFFFFF">
              ...
              <td> <div align="left">
                <select name="nivhasta" class="breadcrumb" id="nivhasta">
                 <?
				    ...
				    LlenarComboSql($sql,"consec","nomext","xx",$bd);
              ...
              <td><?
			  	...
			  	$tb=$bd->select("select min(consec) as niv from cpniveles union all select max(consec) from cpniveles");
               ?>
              ...
              <td><?
			  	$tb=$bd->select("select consec as niv from cpniveles where catpar='P' order by consec desc");
               ?>
                  <select name="nivhasta" class="breadcrumb" id="nivhasta">
                    <?
				  	while(!$tb->EOF)
              ...
              <td colspan="2"> <div align="left"></div>
                <div align="left">
                  ...
                  <input name="sqls" type="hidden" id="sqls">
                        ...
                        <tr bordercolor="#FFFFFF">
              <td style="visibility:hidden" class="form_label_01"><strong>Asignaci&oacute;n: </strong></td>
              <td colspan="2">
                <select name="asignacion" style="visibility:hidden" class="breadcrumb" id="select2">
                  <option>Acumulados</option>
                  <option>Parciales</option>
                </select> </td>
            </tr>
            <tr bordercolor="#FFFFFF">
              <td height="24" style="visibility:hidden" class="form_label_01">
                <div align="left"><strong>Totales Por Partidas :</strong></div></td>
              <td> <div align="left">
                <select name="consepar" style="visibility:hidden" class="breadcrumb" id="consepar">
                 <?
			  	    //$tb=$bd->select("select nomext,consec from cpniveles where catpar='P' order by consec deSC");
			  	    $sql="select nomext,consec from cpniveles where catpar='P' order by consec deSC";
              ...
              <td> </tr>
		    <tr bordercolor="#FFFFFF">
              <td style="visibility:hidden" class="form_label_01"><strong>Nivel Categoria:</strong></td>
              <td colspan="2">
    			 <?
			  	   ...
			  	   $sql="SELECT CONSEC||' - '||NOMEXT as agrupar FROM CPNIVELES WHERE CATPAR='C' and consec <> '0' ORDER BY CONSEC desc";
                 ?>

                <select name="agrupar" style="visibility:hidden" class="breadcrumb" id="agrupar" >
				 <? LlenarComboSql($sql,"agrupar","agrupar","",$bd) ?>
                </select></td>
            </tr>

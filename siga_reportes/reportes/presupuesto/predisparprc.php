          ...
          <table width="612"  border="0" align="center" cellspacing="0" bordercolor="#FFFFFF" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF">
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>Ejecuci&oacute;n
                  Presupuestaria por Espec&iacute;fica (PreCompromisos)
		    ...
		    <tr>
              ...
              <td>
                <div align="left">
                  <?
			    $tb=$bd->select("select to_char(fecini,'dd/mm/yyyy') as fecini,to_char(feccie,'dd/mm/yyyy') as feccie from contaba");
			  ?>
			  	<input size="15" type="text" name="fecdes" class="breadcrumb" id="fecdes" value="<? echo $tb->fields["fecini"]?>" datepicker="true"

              </div></td>
              <td>
                <div align="left">
			  	<input size="15" type="text" name="fechas" class="breadcrumb" id="fechas" value="<? echo $tb->fields["feccie"]?>"datepicker="true"
              </div></td>
            </tr>
		    <tr bordercolor="#FFFFFF">
...
function enviar()
{
	if (verificar())
	{
		...
		{
			f=document.form1;
			f.titulo.value="Ejecución Presupuestaria por Específica (PreCompromisos)";

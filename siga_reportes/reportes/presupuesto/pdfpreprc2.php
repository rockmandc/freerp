  ...
  function llenaranchos()
	{
		...
		function Header()
		{
			...
			$this->ln();
			$this->setX(170);
			//$this->cell(90,5,"ANTES DEL  PRE-COMPROMISO",1,0,'C');
			$this->ln();
		    $this->SetWidths(array($this->anchos[0],$this->anchos[1],$this->anchos[2],$this->anchos[3],$this->anchos[4],$this->anchos[5]+$this->anchos[6]+28,$this->anchos[7],$this->anchos[8]));
			$this->SetAligns(array("C","C","C","C","C","C","C","C","C"));
		    $this->SetBorder(1);
			$this->Row(array($this->titulos[0],$this->titulos[1],$this->titulos[2],$this->titulos[3],$this->titulos[4],$this->titulos[5],$this->titulos[7],$this->titulos[8]));
		...
		function Cuerpo()
		{
		    ...
		    $this->SetBorder(1);
			$this->Row(array($aux[2],$aux[3],$aux[4],$aux[5],$aux[6],$dato["desprc"],H::FormatoMonto($dato["monasi"]),H::FormatoMonto($dato["monimp"])));

//,H::FormatoMonto($dato["monasi"]-$dato["monimp"])));
			$acum1+=$dato["monasi"];
			$acum2+=$dato["monimp"];
		    ...
		    $this->SetBorder(1);
			$this->Row(array("TOTALES",H::FormatoMonto($acum1),H::FormatoMonto($acum2)));

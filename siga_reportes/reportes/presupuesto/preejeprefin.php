        ...
        <div align="left">&nbsp;
          <table width="612"  border="0" align="center" cellspacing="0" bordercolor="#FFFFFF" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF">
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>Estado de la Ejecuci&oacute;n
                  Presupuestaria y Financiera del Presupuesto de Gasto
            ...
            <tr bordercolor="#FFFFFF">
              ...
              <td colspan="2"> <div align="left"></div>
                <div align="left">
                  <input name="elaborado" type="text" class="breadcrumb" id="elaborado" value="" size="30">
                  <input name="cargo1" type="text" class="breadcrumb" id="cargo1" value="" size="20">
                </div></td>
            ...
            <tr bordercolor="#FFFFFF">
              ...
              <td colspan="2"> <div align="left"></div>
                <div align="left">
                  <input name="revisado" type="text" class="breadcrumb" id="revisado" value="" size="30">
                  <input name="cargo2" type="text" class="breadcrumb" id="cargo2" value="" size="20">
                </div></td>
            </tr>
            <tr bordercolor="#FFFFFF">
              ...
              <td colspan="2"> <div align="left"></div>
                <div align="left">
                  <input name="aprobado" type="text" class="breadcrumb" id="aprobado" value="" size="30">
                  <input name="cargo3" type="text" class="breadcrumb" id="cargo3" value="" size="20">
                </div></td>
            </tr>
...
function enviar()
{
	if (verificar())
	{
		...
		{
			f=document.form1;
			f.titulo.value="Estado de la Ejecución Presupuestaria y Financiera del Presupuesto de gastos";
			f.action="rpreejeprefin.php";
			f.submit();
		}else

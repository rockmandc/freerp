...
WHERE RTRIM(A.CODUBI)=RTRIM(B.CODUBI) AND A.STAMUE='A' AND RTRIM(A.CODACT) >= RTRIM('".$this->codact1."') AND
			...
			function Cuerpo()
		{
			...
			if(!$tb2->EOF)
			{
				$ref=$tb2->fields["acodubi"];
				 ...
				 $this->bdesubi=$tb2->fields["bdesubi"];
				 $this->ln();
			...
			while(!$tb->EOF)
			{
			    ...
			    $this->SetLineWidth(0.2);
				 ...
				 $this->SetLineWidth(0.3);
 		 		 $this->setFont("Arial","B",8);
				 $this->ln();
				 $this->cell(180,4,"Total Ubicación: ".$this->bdesubi,0,0,'R');
				 $this->bdesubi=$tb->fields["bdesubi"];
				 $this->setx(10);
				...
				if($tb->fields["acodact"]!=$ref2)
				{
				 ...
				 $this->Line(202,$this->GetY(),230,$this->GetY());
		 		 ...
		 		 $this->setFont("Arial","B",8);
		 		 $this->setx(100);
		 	     $this->cell(100,6,"Total Tipo de Activo:   ".$desubi,0,0,'R');
		 		 $this->setx(10);
 			     $this->cell(20,6,"");
				 $this->cell(20,6,"                                                                                                                                                                                                                           ".H::FormatoMonto($this->acum));
		 		 $this->setFont("Arial","",8);

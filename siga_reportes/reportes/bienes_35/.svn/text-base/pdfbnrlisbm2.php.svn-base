<?
  ...
  require_once("../../lib/modelo/sqls/bienes/Bm2.class.php");
  ...
  class pdfreporte extends fpdf
  {
    ...
    function pdfreporte()
    {
      ...
      $this->objBm2 = new Bm2();
      $this->arrp = $this->objBm2->sqlp($this->ubiorides,$this->ubiorihas,$this->fecdes,$this->fechas,$this->codactmin,$this->codactmax, $this->codmuemin, $this->codmuemax,$this->coddisdes,$this->coddishas,$this->nrodismuemin,$this->nrodismuemax);
...
////////////////////
      ...
      $this->ln();
		      ...
		      $this->MultiCell(200,2,"8.- PERIODO DE LA CUENTA: ".H::ObtenerMesenLetras(substr(date('d/m/Y'),3,2))." ".substr(date('d/m/Y'),6,4));
$this->ln();

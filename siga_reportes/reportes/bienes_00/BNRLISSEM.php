          ...
          <table width="612"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr> 
			  ...
			  <input name="codact1" type="text" value="<?
				$sql="SELECT min(a.codact) as cod FROM bnregsem a, bndefact b where a.codact = b.codact";
			  ...
			  <input name="codact2" type="text" value="<?
				$sql="SELECT max(a.codact) as cod FROM bnregsem a, bndefact b where a.codact = b.codact";
                LlenarTextoSql($sql,"cod",$bd);
            ...
            <tr bordercolor="#6699CC"> 
              ...
              <td> 
			  <input name="codsem1" type="text" value="<?
				$sql="SELECT min(codsem) as cod FROM bnregsem";
                LlenarTextoSql($sql,"cod",$bd);
				?>" class="breadcrumb" id="codsem1" size="20">
              <input type="button" name="Button5" value="..." onClick="catalogo3('codsem1');">
			  </td>
              <td> 
			  <input name="codsem2" type="text" value="<?
				$sql="SELECT max(codsem) as cod FROM bnregsem";
                LlenarTextoSql($sql,"cod",$bd);
				?>" class="breadcrumb" id="codsem2" size="20">
              <input type="button" name="Button6" value="..." onClick="catalogo3('codsem2');">
			  </td>
            </tr>
            <tr> 
...
{
 	pagina="../../lib/general/catalogoobj.php?campo="+campo+"&sql=SELECT a.codact as codigo, b.desact as descripcion FROM bnregsem a, bndefact b where a.codact = b.codact ORDER BY a.codact";
...
{
 	pagina="../../lib/general/catalogoobj.php?campo="+campo+"&sql=SELECT DISTINCT(codmue) as codigo, dessem as descripcion FROM bnregsem ORDER BY codmue ASC";
	window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=500,height=400,rezizable=yes, left=50,top=50");
}
</script>
</html>

      ...
      <td rowspan="2" valign="top" class="cell_padding_01"> <p class="breadcrumb">Reportes 
        ...
        <div align="left">&nbsp; 
          <table width="612"  border="1" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr> 
              ...
              <td> 
                <?
			  	...
			  	$tb=$bd->select("SELECT DISTINCT (a.codact) as cod, b.desact as des FROM bnregsem a, bndefact b where a.codact = b.codact ORDER BY a.codact");
			  ?>
                <select name="codact1" class="breadcrumb" id="codact1">
                  <?
				  	while(!$tb->EOF)	
					{
				  ?>
              ...
              <td> 
                <?
			  	...
			  	$tb=$bd->select("SELECT DISTINCT (a.codact) as cod, b.desact as des FROM bnregsem a, bndefact b where a.codact = b.codact ORDER BY a.codact DESC");
			  ?>
                <select name="codact2" class="breadcrumb" id="codact2">
                  <?
				  	while(!$tb->EOF)	
					{
				  ?>
            ...
            <tr> 
              <td height="30" class="form_label_01"><strong>C&oacute;digo del 
                Bien: </strong></td>
              <td> 
                <?
               ...
               ?>
                ...
                <select name="codsem1" class="breadcrumb" id="codsem1">
                  <?
				  	while(!$tb->EOF)	
					{
				  ?>
                  <option value="<? print $tb->fields["codsem"];?>"><? print $tb->fields["codsem"]." / ".substr($tb->fields["dessem"],0,20);?></option>
                  <?
				  	$tb->MoveNext();
					}
				?>
              ...
              <td> 
               ...
               ?>
                <select name="codsem2" class="breadcrumb" id="select">
                  <?
				  	while(!$tb->EOF)	
					{
				  ?>
            ...
            <tr> 
              ...
              <td> <div align="left"> </div>
				...
				if(!$tb->EOF)
				{
			  	...
			  	$tb2=$bd->select("SELECT to_char(MAX(feccom),'DD/MM/YYYY') as fecha FROM bnregsem");
				if(!$tb2->EOF)
				{

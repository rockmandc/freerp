        ...
        <div align="left">&nbsp;
          <table width="612"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF">
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>UBICACIÓN DE ACTIVOS MUEBLES
            ...
            <tr>
              ...
              <td><div align="left">
				...
				$sql="SELECT min(codact) as codact FROM bndefact, bndefins where length(codact)=bndefins.lonact and codact like '2%' group by bndefins.lonact";
              ...
              <td><input name="acthas" type="text" value="<?
				$sql="SELECT max(codact) as codact FROM bndefact, bndefins where length(codact)=bndefins.lonact and codact like '2%' group by bndefins.lonact";
                LlenarTextoSql($sql,"codact",$bd);
...
{
	f=document.form1;
	f.titulo.value="UBICACIÓN DE ACTIVOS MUEBLES ";
    f.action="rbnrubiactmue.php";
	f.submit();
}
function cerrar()
{
...
function catalogo2(campo)
   {
      mysql='SELECT distinct(codact) as Codigo, a.desact as Descripcion FROM bndefact as a, bndefins as b where length(codact)=b.lonact and codact like ?2% ? group by a.codact, b.lonact, a.desact order by codact';
	  pagina="../../lib/general/catalogoobj.php?sql="+mysql+"&campo="+campo;
	  window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=500,height=400,resizable=yes,left=50,top=50");
   }

        ...
        <div align="left">&nbsp;
          <table width="612"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF">
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>UBICACIONES
            ...
            <tr>
              <td class="form_label_01"><strong>C&oacute;digo Ubicaci&oacute;n:</strong></td>
              <td>
                <?

			  	$tb=$bd->select("SELECT DISTINCT(codubi), desubi FROM bnubibie where length(codubi)=14 ORDER BY codubi");
			  ?>



                <select name="codubi1" class="breadcrumb" id="select4">
                  <?
				  	while(!$tb->EOF)
					{
				  ?>
                  <option value="<? print $tb->fields["codubi"];?>"><? print ($tb->fields["desubi"]);?></option>
                  <?
										$tb->MoveNext();
					}
              ...
              <td>
                <?
			  	...
			  	$tb=$bd->select("SELECT DISTINCT(codubi), desubi FROM bnubibie   where length(codubi)=14  ORDER BY codubi DESC");
			  ?>
                <select name="codubi2" class="breadcrumb" id="codubi2">
                  <?
				  	while(!$tb->EOF)
					{
				  ?>
...
{
	f=document.form1;
	f.titulo.value="LISTADO DE UBICACIONES";

            ...
            <tr>
              ...
              <td>
                <?
			  	...
			  	$tb=$bd->select("SELECT DISTINCT(a.codact) as cod, b.desact as des FROM bnsegmue a, bndefact b where a.codact = b.codact ORDER BY a.codact");
			  ?>
              ...
              <td>
                <?
			  	...
			  	$tb=$bd->select("SELECT DISTINCT(a.codact) as cod, b.desact as des FROM bnsegmue a, bndefact b where a.codact = b.codact ORDER BY a.codact DESC");
			  ?>
            ...
            <tr>
              ...
              <td>
                <?
			  	...
			  	$tb=$bd->select("SELECT DISTINCT(codmue) FROM bnsegmue ORDER BY codmue ASC");
               ?>
              ...
              <td>
                <?
			  	...
			  	$tb=$bd->select("SELECT DISTINCT(codmue) FROM bnsegmue ORDER BY codmue DESC");
               ?>
            ...
            <tr bordercolor="#6699CC">
              ...
              <td>
                <?
			  	...
			  	$tb=$bd->select("SELECT DISTINCT(nrosegmue) FROM bnsegmue ORDER BY nrosegmue ASC");
               ?>
                ...
                <select name="numpol1" class="breadcrumb" id="numpol1">
                  <?
					...
					{
				  ?>
                  <option value="<? print $tb->fields["nrosegmue"];?>"><? print $tb->fields["nrosegmue"];?></option>
                  <?
					$tb->MoveNext();
					}
				?>
              ...
              <td>
                <?
			  	...
			  	$tb=$bd->select("SELECT DISTINCT(nrosegmue) FROM bnsegmue ORDER BY nrosegmue DESC");
               ?>
            ...
            <tr bordercolor="#6699CC">
              ...
              <td> <div align="left"> </div>
                <div align="left">
			  	...
			  	$tb=$bd->select("SELECT to_char(MIN(fecsegmue),'DD/MM/YYYY') as fecha FROM bnsegmue");
				...
				if(!$tb->EOF)
				{
			  	...
			  	$tb2=$bd->select("SELECT to_char(MAX(fecsegmue),'DD/MM/YYYY') as fecha FROM bnsegmue");
				if(!$tb2->EOF)
				{
...
{
	f=document.form1;
	f.titulo.value="SEGURO DE BIENES MUEBLES";

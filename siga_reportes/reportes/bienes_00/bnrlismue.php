      ...
      <td rowspan="2" valign="top" class="cell_padding_01"> <p class="breadcrumb">Reportes
        ...
        <div align="left">&nbsp;
          <table width="612"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr>
              <td class="form_label_01"> <div align="left"><strong>Ubicaci&oacute;n
                  :</strong></div></td>
              <td>
			  <input name="codubides" type="text" value="<?
				$sql="SELECT DISTINCT min(a.codubi) as cod FROM bnregmue a, bnubibie b where a.codubi = b.codubi";
                LlenarTextoSql($sql,"cod",$bd);
				?>" class="breadcrumb" id="codubides" size="20">
              <input type="button" name="Button1" value="..." onClick="catalogo1('codubides');">
              </td>
              <td>
			  <input name="codubihas" type="text" value="<?
				$sql="SELECT DISTINCT max(a.codubi) as cod FROM bnregmue a, bnubibie b where a.codubi = b.codubi";
                LlenarTextoSql($sql,"cod",$bd);
				?>" class="breadcrumb" id="codubihas" size="20">
              <input type="button" name="Button2" value="..." onClick="catalogo1('codubihas');">
              </td>
            </tr>
            <tr>
              <td class="form_label_01"><strong>C&oacute;digo del Activo:</strong></td>
              <td>
			  <input name="codact1" type="text" value="<?
				$sql="SELECT min(a.codact) as cod FROM bnregmue a, bndefact b where a.codact = b.codact";
                LlenarTextoSql($sql,"cod",$bd);
				?>" class="breadcrumb" id="codact1" size="20">
              <input type="button" name="Button3" value="..." onClick="catalogo2('codact1');">
			  </td>
              <td>
			  <input name="codact2" type="text" value="<?
				$sql="SELECT max(a.codact) as cod FROM bnregmue a, bndefact b where a.codact = b.codact";
                LlenarTextoSql($sql,"cod",$bd);
				?>" class="breadcrumb" id="codact2" size="20">
              <input type="button" name="Button4" value="..." onClick="catalogo2('codact2');">
			  </td>
            </tr>
            <tr bordercolor="#6699CC">
              <td class="form_label_01"><strong>C&oacute;digo del Bien: </strong></td>
              <td>
			  <input name="codmue1" type="text" value="<?
				$sql="SELECT min(codmue) as cod FROM bnregmue";
                LlenarTextoSql($sql,"cod",$bd);
				?>" class="breadcrumb" id="codmue1" size="20">
              <input type="button" name="Button5" value="..." onClick="catalogo3('codmue1');">
			  </td>
              <td>
			  <input name="codmue2" type="text" value="<?
				$sql="SELECT max(codmue) as cod FROM bnregmue";
                LlenarTextoSql($sql,"cod",$bd);
				?>" class="breadcrumb" id="codmue2" size="20">
              <input type="button" name="Button6" value="..." onClick="catalogo3('codmue2');">
			  </td>
            </tr>
            <tr bordercolor="#6699CC">
...
{
 	pagina="../../lib/general/catalogoobj.php?campo="+campo+"&sql=SELECT DISTINCT (a.codubi) as codigo, b.desubi as descripcion FROM bnregmue a, bnubibie b where a.codubi = b.codubi ORDER BY a.codubi";
...
{
 	pagina="../../lib/general/catalogoobj.php?campo="+campo+"&sql=SELECT a.codact as codigo, b.desact as descripcion FROM bnregmue a, bndefact b where a.codact = b.codact ORDER BY a.codact";
	window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=500,height=400,rezizable=yes, left=50,top=50");
}
function catalogo3(campo)
{
 	pagina="../../lib/general/catalogoobj.php?campo="+campo+"&sql=SELECT DISTINCT(codmue) as codigo, desmue as descripcion FROM bnregmue ORDER BY codmue ASC";
	window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=500,height=400,rezizable=yes, left=50,top=50");
}
</script>
<?$bd->closed();?>

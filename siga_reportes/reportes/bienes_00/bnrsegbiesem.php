            ...
            <tr> 
              ...
              <td> 
                <?
			  	...
			  	$tb=$bd->select("SELECT DISTINCT(a.codact) as cod, b.desact as des FROM bnsegsem a, bndefact b where a.codact = b.codact ORDER BY a.codact");
			  ?>
              ...
              <td> 
                <?
			  	...
			  	$tb=$bd->select("SELECT DISTINCT(a.codact) as cod, b.desact as des FROM bnsegsem a, bndefact b where a.codact = b.codact ORDER BY a.codact DESC");
			  ?>
            ...
            <tr> 
              ...
              <td> 
                <?
			  	...
			  	$tb=$bd->select("SELECT DISTINCT(codsem) FROM bnsegsem ORDER BY codsem ASC");
               ?>
                ...
                <select name="codsem1" class="breadcrumb" id="select6">
                  <?
					...
					{
				  ?>
                  <option value="<? print $tb->fields["codsem"];?>"><? print $tb->fields["codsem"];?></option>
                  <?
					$tb->MoveNext();				  
					}
				?>
              ...
              <td> 
                <?
			  	...
			  	$tb=$bd->select("SELECT DISTINCT(codsem) FROM bnsegsem ORDER BY codsem DESC");
               ?>
            ...
            <tr bordercolor="#6699CC"> 
              ...
              <td> 
                <?
			  	...
			  	$tb=$bd->select("SELECT DISTINCT(nrosegsem) FROM bnsegsem ORDER BY nrosegsem ASC");
               ?>
                ...
                <select name="numpol1" class="breadcrumb" id="numpol1">
                  <?
					...
					{
				  ?>
                  <option value="<? print $tb->fields["nrosegsem"];?>"><? print $tb->fields["nrosegsem"];?></option>
                  <?
					$tb->MoveNext();				  
					}
				?>
              ...
              <td> 
                <?
			  	...
			  	$tb=$bd->select("SELECT DISTINCT(nrosegsem) FROM bnsegsem ORDER BY nrosegsem DESC");
               ?>
            ...
            <tr bordercolor="#6699CC"> 
              ...
              <td> <div align="left"> </div>
                <div align="left"> 
			  	...
			  	$tb=$bd->select("SELECT to_char(MIN(fecsegsem),'DD/MM/YYYY') as fecha FROM bnsegsem");
				...
				if(!$tb->EOF)
				{
			  	...
			  	$tb2=$bd->select("SELECT to_char(MAX(fecsegsem),'DD/MM/YYYY') as fecha FROM bnsegsem");
				if(!$tb2->EOF)
				{
...
{
	f=document.form1;
	f.titulo.value="SEGURO DE BIENES SEMOVIENTES";

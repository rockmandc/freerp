          ...
          <table width="612"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr>
			  ...
			  <input name="codact1" type="text" value="<?
				$sql="SELECT min(a.codact) as cod FROM bnreginm a, bndefact b where a.codact = b.codact";
			  ...
			  <input name="codact2" type="text" value="<?
				$sql="SELECT max(a.codact) as cod FROM bnreginm a, bndefact b where a.codact = b.codact";
                LlenarTextoSql($sql,"cod",$bd);
            ...
            <tr bordercolor="#6699CC">
              ...
              <td>
			  <input name="codinm1" type="text" value="<?
				$sql="SELECT min(codinm) as cod FROM bnreginm";
                LlenarTextoSql($sql,"cod",$bd);
				?>" class="breadcrumb" id="codinm1" size="20">
              <input type="button" name="Button5" value="..." onClick="catalogo3('codinm1');">
				</td>
              <td>
			  <input name="codinm2" type="text" value="<?
				$sql="SELECT max(codinm) as cod FROM bnreginm";
                LlenarTextoSql($sql,"cod",$bd);
				?>" class="breadcrumb" id="codinm2" size="20">
              <input type="button" name="Button6" value="..." onClick="catalogo3('codinm2');">
			  </td>
            </tr>
            <tr bordercolor="#6699CC">
...
{
 	pagina="../../lib/general/catalogoobj.php?campo="+campo+"&sql=SELECT a.codact as codigo, b.desact as descripcion FROM bnreginm a, bndefact b where a.codact = b.codact ORDER BY a.codact";
...
{
 	pagina="../../lib/general/catalogoobj.php?campo="+campo+"&sql=SELECT DISTINCT(codinm) as codigo, desinm as descripcion FROM bnreginm ORDER BY codmue ASC";
	window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=500,height=400,rezizable=yes, left=50,top=50");
}
</script>
</html>

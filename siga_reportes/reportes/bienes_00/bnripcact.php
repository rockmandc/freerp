        ...
        <div align="left">&nbsp;
          <table width="612"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF">
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>VALORES
                  DE IPC
            ...
            <tr bordercolor="#6699CC">
              <td class="form_label_01"><strong>A&ntilde;o del IPC:</strong></td>
              <td>
                <?

			  	$tb=$bd->select("SELECT min(anoipc) as anoipc FROM bnipcact");
               ?>
                <input name="anoipc1" type="text" value="<?print $tb->fields["anoipc"];

			  ?>"class="breadcrumb" id="anoipc1" size="16" maxlength="100">

         				<input type="button" name="Button" value="..." onClick="catalogo1('anoipc1');">
         		</td>
            <td>
                <?

			  	$tb=$bd->select("SELECT max(anoipc) as anoipc FROM bnipcact");
               ?>
                <input name="anoipc2" type="text" value="<?print $tb->fields["anoipc"];

			  ?>"class="breadcrumb" id="anoipc2" size="16" maxlength="100">

         				<input type="button" name="Button" value="..." onClick="catalogo1('anoipc2');">
</td>
            </tr>
            <tr>
              <td class="form_label_01">&nbsp;</td>
...
{
	f=document.form1;
	f.titulo.value="LISTADO DE VALORES DE IPC";
...
{
    pagina="../../lib/general/catalogoobj.php?campo="+campo+"&sql=SELECT distinct(anoipc) as anoipc FROM bnipcact order by anoipc";

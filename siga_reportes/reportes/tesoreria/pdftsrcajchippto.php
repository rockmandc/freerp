<?
  ...
  class pdfreporte extends fpdf
  {
    ...
    function Header()
    {
				...
				$this->setwidths(array(30,76,20,25,45));
				$this->setBorder(true);
				$this->setFont("Arial","B",9);
				$this->setaligns(array("C","C","C","C","C"));
				$this->rowm(array('Imputación Presupuestaria', 'Titulo Presupuestario ','Monto','Disponibilidad','Disponibilidad Presupuestaria Proyectada de Salidas de Caja Chica'));
    ...
    function Cuerpo()
    {
    	...
    	foreach($this->arrp as $dato)
    	{
           ...
           $this->rowm(array($dato["codpre"],$dato["nompre"],H::FormatoMonto($dato["monto"]), H::FormatoMonto($saldo),H::FormatoMonto($saldo-$dato["monto"])));
    	}
    		$this->ln();

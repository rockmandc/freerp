      ...
      <td rowspan="2" valign="top" class="cell_padding_01"> <p class="breadcrumb">Reportes
		...
		<tr>
            ...
            <tr>
              ...
              <td colspan="2"><input name="apro" type="text" class="breadcrumb" id="apro" value="" size="60"></td>
            </tr>

            <tr>
              <td class="form_label_01"> <div align="left"><strong>Elaborado por:</strong></div></td>
              <td colspan="2"> <div align="left">
                  <input name="ela" type="text" class="breadcrumb" id="ela" value="" size="60">
                </div></td>
            </tr>
            <tr>
...
{
	f=document.form1;
	f.titulo.value="CONCILIACION BANCARIA";
	f.action="rTSRCONCILCMC.php";
	f.submit();
}
function cerrar()
{

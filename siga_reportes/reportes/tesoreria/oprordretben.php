...
{
    pagina="../../lib/general/catalogoobj.php?campo="+campo+"&sql=select distinct(rtrim(a.cedrif)) as cedula,a.nombre as nomben from  opbenefi a, opordpag b,opretord c,optipret d where a.cedrif = b.cedrif and b.numord = c.numord and c.codtip=d.codtip order by rtrim(a.cedrif)";
...
{
    pagina="../../lib/general/catalogoobj.php?campo="+campo+"&sql=select codtip as codigo ,destip as descripcion from optipret order by codtip";
	window.open(pagina,"Catalogo","menubar=no,toolbar=no,scrollbars=yes,width=500,heigth=400,resizable=yes,left=50,top=50");
}

function catalogo3(campo)
{
    pagina="../../lib/general/catalogoobj.php?campo="+campo+"&sql=select distinct(codpre) as codigo from opretord order by codpre";
	window.open(pagina,"Catalogo","menubar=no,toolbar=no,scrollbars=yes,width=500,heigth=400,resizable=yes,left=50,top=50");
}
</script>
<? $bd->closed(); ?>

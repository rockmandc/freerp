<?
  ...
  class pdfreporte extends PDF_ADDS
  {
    ...
    function pdfreporte()
    {
     ...
     // $this->decreto=str_replace('*',' ',H::GetPost("decreto"));
      ...
      if ($this->status=="Pagadas"){$this->condicion=" (A.STATUS='I')";}
      if ($this->status=="No Pagadas"){$this->condicion=" (A.STATUS='N')";}
      if ($this->status=="Anuladas") { $this->condicion=" (A.STATUS='A' )";}
  ...
  if ($this->fecorddes!="" and $this->fecordhas!=""){
    ...
    function Header()
    {
			...
			$this->Image("../../img/logo_1.jpg",10, 4, 20);
			$this->SetXY(39,8);
   ...
   //     $this->line(110,210,110, 225);
	...
	$this->line(154,238,154,255);//la ultima
	 $this->SetLineWidth(0.2);
				...
				$this->Cell(36,4,'DIRECTOR(A) ',0,0,'C');
				$this->Cell(36,4,'ANALISTA ',0,0,'C');
				$this->Cell(36,4,'DIRECTOR(A) ',0,0,'C');
				...
				//$this->Cell(36,4,'Lic. Esther Norelia Pérez',0,0,'C');
				//$this->Cell(52,4,'RAFAEL SAEZ',0,0,'C');
				$this->SetXY(10,255);
				$this->setFont("Arial","B",6);
            	$this->Cell(36,4,'FORMA 035 ',0,0,'L');
              $this->Cell(160,4,' LVF/LR/FT/IG ',0,0,'R');
			;
...
//ENCABEZADO
         ...
         //   print '<pre>'; print $sqlcom2; exit;
           ...
           // $this->MultiCell(43,4,$fecha);
            ...
            $this->SetFont("Arial","B",6);
            $this->SetXY(29,56-$this->r);//strlen
            $this->MultiCell(175,2,substr($tbgen->fields["desord"],0,520));//concepto
            $this->SetXY(10,190);
            $this->SetFont("Arial","B",8);

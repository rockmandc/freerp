	...
	class pdfreporte extends fpdf
	{
		...
		function pdfreporte()
		{
			...
			if ($this->status=='T'){
			    ...
			    $estatus=" B.STATUS = '".$this->status."' AND ";
				...
				RTRIM(A.CEDRIF) >= RTRIM('".$this->bendes."') AND RTRIM(A.CEDRIF) <= RTRIM('".$this->benhas."') AND
...
//print '<pre>'; print $this->sql0;
	...
	function llenartitulosmaestro()
		...
		function Header()
		{
			...
			$ubica = count($parte)-2;
			$this->cab->poner_cabecera_f($this,$_POST["titulo"],"l","s","n");
...
//print '<pre>'; print $this->sql;
		...
		while (!$tb->EOF and !$tb0->EOF)
		{
             ...
             //    print '<pre>' ; print $this->sql2;
				 ...
				 $this->cell(21,7,number_format($mret,2,',','.'),0,0,'R');
				//--------

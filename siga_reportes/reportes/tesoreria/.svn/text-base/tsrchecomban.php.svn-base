...
$catalogo[] = tesoreria::catalogo_reflib('numche1');
$catalogo[] = tesoreria::catalogo_reflib('numche2');
...
$_SESSION['tsrchecomban'] = $catalogo;
...
<?php include_once("../../lib/general/formtop.php")?>
		...
		<tr>
             ...
             <td width="180"> <div align="left">
                   ...
                   value="<?$sql="SELECT min(reflib) as codmin,max(reflib) as codmax FROM tsmovlib";
 					LlenarTextoSql($sql,"codmin",$bd); ?>" size ="22">
 					 <a href="#"><img src="../../img/search.gif" align="top" onclick="catalogo('tsrchecomban',0); "></a>
 			      </div></td>

              <td width="180"> <div align="left">
               	<input name="numche2" type="text" class="breadcrumb" id="numche2"
                   value="<? LlenarTextoSql($sql,"codmax",$bd); ?>" size ="22">
 					 <a href="#"><img src="../../img/search.gif" align="top" onclick="catalogo('tsrchecomban',1); "></a>
 			      </div></td>
		...
		<tr>
             ...
             <td> <div align="left">
                   ...
                   value="<?$sql="SELECT min(NUMCUE) as codmin,max(NUMCUE) as codmax FROM tsmovlib";
 					LlenarTextoSql($sql,"codmin",$bd); ?>" size ="22">
 					<a href="#"><img src="../../img/search.gif" align="top" onclick="catalogo('tsrchecomban',2); "></a>
 			      </div></td>

              <td> <div align="left">
               	<input name="numcue2" type="text" class="breadcrumb" id="numcue2"
                   value="<? LlenarTextoSql($sql,"codmax",$bd); ?>" size ="22">
                   <a href="#"><img src="../../img/search.gif" align="top" onclick="catalogo('tsrchecomban',3); "></a>
 			      </div></td>
	...
	<!--	<tr>
             ...
             <td> <div align="left">
                   ...
                   value="<?$sql="SELECT min(cedrif)as codmin,max(cedrif)as codmax FROM OPBENEFI";
 					LlenarTextoSql($sql,"codmin",$bd); ?>" size ="22">
 					 <a href="#"><img src="../../img/search.gif" align="top" onclick="catalogo('tsrchecomban',4); "></a>
 			      </div></td>

              <td> <div align="left">
               	<input name="ben2" type="text" class="breadcrumb" id="ben2"
                   value="<? LlenarTextoSql($sql,"codmax",$bd); ?>" size ="22">
 					 <a href="#"><img src="../../img/search.gif" align="top" onclick="catalogo('tsrchecomban',5); "></a>
 			      </div></td>

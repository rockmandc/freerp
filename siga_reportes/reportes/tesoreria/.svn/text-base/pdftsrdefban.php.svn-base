		...
		function pdfreporte()
		{
			...
			$this->sql="
								...
								WHERE
										...
										A.TIPCUE >= ('".$this->tipcta1."') AND
										A.TIPCUE <= ('".$this->tipcta2."') AND
										(A.NUMCUE) >= ('".$this->ncta1."') AND
										(A.NUMCUE) <= ('".$this->ncta2."')
								GROUP BY
										A.NUMCUE,
										A.NOMCUE,
		...
		function Cuerpo()
		{
			...
			while(!$tb->EOF)
			{
				 ...
				 $this->cell(20,4,"          Intereses Ganados  ");
		 		 $this->setFont("Arial","",8);
				 $this->cell(20,4,"                                     ".H::FormatoMonto($tb->fields["aantban"]));
		 		 $this->setFont("Arial","B",8);
				 $this->cell(20,4,"                                                              Saldo Anterior  ");
		 		 $this->setFont("Arial","",8);
		 		 $this->setx(140);
				 $this->cell(20,4,H::FormatoMonto($tb->fields["aantban"]),0,0,'R');
				 $this->setx(175);
				 $this->cell(20,4,H::FormatoMonto($tb->fields["aantlib"]),0,0,'R');
				 $this->ln();
		 		 $this->setFont("Arial","B",8);
				 $this->cell(20,4,"                                                                                                                 Débitos  ");
		 		 $this->setFont("Arial","",8);
		 		 $this->setx(140);
				 $this->cell(20,4,H::FormatoMonto($tb->fields["adebban"]),0,0,'R');
				 $this->setx(175);
				 $this->cell(20,4,H::FormatoMonto($tb->fields["adeblib"]),0,0,'R');
				 $this->ln();
		 		 $this->setFont("Arial","B",8);
				 ...
				 $this->cell(20,4,"                                                              Créditos  ");
		 		 $this->setFont("Arial","",8);
		 		 $this->setx(140);
				 $this->cell(20,4,H::FormatoMonto($tb->fields["acreban"]),0,0,'R');
				 $this->setx(175);
				 $this->cell(20,4,H::FormatoMonto($tb->fields["acrelib"]),0,0,'R');
				 $this->ln();
				 $this->ln();
		 		 $this->setFont("Arial","B",8);
				 $this->cell(20,4,"                                                                                                                 Saldo Actual  ");
		 		 $this->setFont("Arial","",8);
		 		 $this->setx(140);
				 $this->cell(20,4,H::FormatoMonto($tb->fields["actual"]),0,0,'R');
				  $this->setx(175);
				 $this->cell(20,4,H::FormatoMonto($tb->fields["actual2"]),0,0,'R');
				 $this->ln();
				 $this->ln();
				 $this->ln();

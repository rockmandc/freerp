...
//Reporte Original
			...
			foreach($this->arrp as $objtb)
			{
				if($objtb["anumcue"]!=$ref)
				{
					 ...
					 $this->SetLineWidth(0.2);
			 		 $this->setFont("Arial","B",7);
			 		 $this->setWidths(array(55,75,30));
					 $this->setAligns(array("L","R","R"));
			 		 $this->setBorder(false);
			 		 $this->Row(array("CANTIDAD DE COMISIONES BANCARIAS : ".$this->cont,"TOTAL : ",H::FormatoMonto($this->acum2)));
		 		 	 $this->setWidths(array(0,30,25,75,30));
					 $this->setAligns(array("L","C","C","L","R"));
					 $this->setBorder(array(1,1,1,1,1));
					 $this->index=$i;
			 ...
			 $this->setAligns(array("L","R","R"));
	 		 ...
	 		 $this->Row(array("CANTIDAD DE COMISIONES BANCARIAS : ".$this->cont,"TOTAL : ",H::FormatoMonto($this->acum2)));
			// $this->cell(10,4);
			// $this->cell(80,4,"TOTAL COMISIONES BANCARIAS:         ".$this->cont);
			// $this->cell(80,4,"TOTAL BANCO                ".H::FormatoMonto($this->acum2));

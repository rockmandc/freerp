      ...
      <td rowspan="2" valign="top" class="cell_padding_01"> <p class="breadcrumb">Reportes
        ...
        <div align="left">&nbsp;
          ...
          <!--  <tr>
			...
			<tr>
              <td class="form_label_01"> <div align="left">
                  <p><strong> DIRECTOR DE ADM. Y FINANZAS:</strong></p>
                </div></td>
              <td colspan="2"> <div align="left"><strong>
                  <input name="aprobado" type="text" class="breadcrumb" id="aprobado"  size="60" value="Lic. Esther Norelia Pérez">
                  </strong> </div></td>
            </tr>
			<tr>
              <td class="form_label_01"> <div align="left">
              ...
              <td colspan="2"> <div align="left"><strong>
                  <input name="presidencia" type="text" class="breadcrumb" id="presidencia"  size="60" value="Rafael Sáez">
                  </strong> </div></td>
            </tr>
...
function catalogo(campo)
   {
      mysql='SELECT CEDRIF as cedula, NOMBEN as nombre FROM opbenefi ORDER BY UPPER(CEDRIF) ASC ';
...
function catalogo3(campo)
   {
      mysql='SELECT NUMORD as numero, NOMBEN as nombre , to_char(FECEMI,¿dd/mm/yyyy¿)  as fecha FROM opordpag ORDER BY UPPER(NUMORD) ASC  limit 2000';
	   pagina="../../lib/general/catalogoobj.php?sql="+mysql+"&campo="+campo;
	  window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=500,height=400,resizable=yes,left=50,top=50");
   }

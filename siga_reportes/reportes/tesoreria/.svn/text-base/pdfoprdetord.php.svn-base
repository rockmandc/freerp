...
//print '<pre>'; print $this->sql; exit;
		...
		function Header()
		{
			...
			$ubica = count($parte)-2;
			$this->cab->poner_cabecera($this,$_POST["titulo"]."  DESDE  ".$this->fecreg1."  HASTA  ".$this->fecreg2,"p","s",$parte[$ubica]);
		...
		while(!$tb->EOF)
			{
			 ...
			 $this->SetLineWidth(0.3);
		    	 ...
		    	 $this->Line(105,$this->GetY(),210,$this->GetY());
				 $this->setx(123);

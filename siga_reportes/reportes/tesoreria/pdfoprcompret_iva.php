<?
	...
	class pdfreporte extends fpdf
	{
		...
		function pdfreporte()
		{
			...
			$this->numcomp=trim(H::GetPost("numcomp"));
				...
				$this->sql="select a.numord,to_char(b.fecemi,'dd/mm/yyyy') as fecemi, b.cedrif,b.nomben,c.nitben, c.dirben, c.telben,to_char(a.fecfac,'dd/mm/yyyy') as fecfac, a.numfac,
							...
							left outer join tscheemi d on (b.numche = d.numche) and b.cedrif=d.cedrif
							where
		...
		$this->setxy(143,190);
		//$this->cell(25,5,"Contralor Municipal");
		//$this->line(135,187,180,187);
		$this->setxy(135,187);
		$this->cell(25,5,$this->diradm);
              $this->setxy(266,185);
              $this->setFont("Arial","B",6);
              $this->cell(5,25,"LVF/LR/FT/IG/LV ",0,0,'R');
...
#			$this->Rect(225,88,45,12);
		...
		//	$this->Cell(50,5,"Fecha de Entrega");
			...
			$this->Rect(210,$this->GetY()-4,60,24);
	//		$this->ln();
		//	$this->Rect(10,$this->GetY()+10,195,11);
...
#		 $this->cell(65,5,$this->ano."  -  ".$_POST["co"]);
	...
	//	 $this->cell(20,5,'aqui1'.$tb2->fields["fecemi"]);
		 $this->cell(20,5,$this->fechasys);
		 #$this->cell(20,5,$tb2->fields["fecret"]);

			$puntoy=$this->GetY();
			$this->SetXY(226,79);
		//	$this->Cell(45,5,'aqui2'.$this->fechasys,0,0,'C');
			#$this->SetXY(226,94);
		 ...
		 $this->ln(12);
		 $this->cell(15,5,"");
		 	$this->sqla="select nomemp, diremp, tlfemp from empresa where codemp='001'";
			$tba=$this->bd->select($this->sqla);
		//	$this->setFont("Arial","B",8);
			$this->cell(115,5,strtoupper($tba->fields["nomemp"]));
		// $this->cell(115,5,strtoupper($this->ag));
	//	 $this->cell(115,5,'CONTRALORIA MUNICIPAL DEL MUNICIPIO CHACAO');
		 //$this->cell(20,5,strtoupper($this->rif));
		 $this->cell(40,5,"G-20000239-5");//RIF
		 ...
		 $y=$this->getY();
		 $this->setx(28);
		 $this->multicell(95,3,strtoupper($tba->fields["diremp"]));
		 $this->SetXY(145,$y);
		 	 $this->cell(115,5,strtoupper($tba->fields["tlfemp"]));//TLF
		...
		$this->setXY(210,75);
		$this->setFont("Arial","B",9);//t
		$this->cell(10,4,"Dirección: ");
		$this->setXY(210,79);
		$this->setFont("Arial","",7);
		$this->multicell(60,4,$dir.' Tlf: '.$tel);
	    $this->setFont("Arial","",8);
...
$this->ln(4);
      ...
      //  $this->cell(13,5,$tb->fields["tiptra"],1,0,"C");
		...
		$this->cell(27,5,number_format($tb->fields["moniva"],2,',','.'),1,0,"R");           $moniva=$moniva+$tb->fields["moniva"];

              $this->cell(27,5,number_format($tb->fields["monret"],2,',','.'),1,0,"R");
		...
		$this->cell(12,5,"");
		$this->cell(26,5,number_format($moniva,2,',','.'),1,0,"R");
		$this->setFont("Arial","B",12);
		 $this->SetFillColor(195,195,195);
		$this->cell(27,5,number_format($monret,2,',','.'),1,0,"R");
		$this->setFont("Arial","",6);
		}

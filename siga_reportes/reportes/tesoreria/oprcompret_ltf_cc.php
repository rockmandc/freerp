          ...
          <table width="678"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF">
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>COMPROBANTE
                  DE RETENCION DE LEY DE TIMBRE FISCAL
            ...
            <tr>
              ...
              <td colspan="2"> <div align="left"><strong>
                  <input name="ag" type="text" class="breadcrumb" id="ag" value="CONTRALORIA MUNICIPAL DEL MUNICIPIO CHACAO" size="89">
                  </strong> </div></td>
            </tr>
            <tr>
              ...
              <td colspan="2"> <div align="left"><strong>
                  <input name="rif" type="text" class="breadcrumb" id="rif" value="G-20000239-5" size="40">
                  </strong> </div></td>
            </tr>
            <tr>
              <td class="form_label_01"> <div align="left"><strong>Direcci&oacute;n
                  ...
                  :</strong></div></td>
              <td colspan="2"> <div align="left"><strong>
                  <input name="dire" type="text" class="breadcrumb" id="dire" value="Av. Francisco de Miranda, Urbanizacion Los Palos Grandes, Edificio Centro Plaza, Torre C, Piso 20, Oficina Unica, Altamira" size="89">
                  </strong> </div></td>
            </tr>
            <tr>
            ...
            <tr>
              <td height="39" class="form_label_01"> <div align="left"><strong>Sobreescribir
            ...
            <tr>
              ...
              <td width="8"><font color="#FF0000" size="-4" align="left"><strong> </strong></font></td>
            </tr>
...
{
	f=document.form1;
	f.titulo.value="COMPROBANTE DE RETENCION DE LEY DE TIMBRE FISCAL";
	f.action="roprcompret_ltf_cc.php";
	f.submit();
}
function cerrar()
{

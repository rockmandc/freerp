        ...
        <div align="left">&nbsp;
          <table width="612" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF">
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>CATALOGO DE ACTIVOS
            ...
            <tr>
             ...
             <td> <div align="left">
                   ...
                   value="<?$sql="select min(codact) as codact from bndefact";
 					LlenarTextoSql($sql,"codact",$bd); ?>" size ="20">
 					 <input type="button" name="Button5" value="..." onClick=" catalogo3('cat1');">
 			      </div></td>

              <td> <div align="left">
               	<input name="cat2" type="text" class="breadcrumb" id="cat2"
                   value="<?$sql="select max(codact) as codact from bndefact";
 					LlenarTextoSql($sql,"codact",$bd); ?>" size ="20">
...
function catalogo3(campo)
   {
      ...
      mysql='SELECT DISTINCT(codact) as CODIGO, desact as DESCRIPCION FROM bndefact ORDER BY codact ASC';
	  ...
	  //select codact as CODIGO, desact DESCRIPCION from bndefact order by codact asc
   }
...
function catalogo4(campo)
   {
      ...
      mysql='SELECT DISTINCT(codact) as CODIGO, desact as DESCRIPCION FROM bndefact ORDER BY codact DESC';
	  pagina="../../lib/general/catalogoobj.php?sql="+mysql+"&campo="+campo;
	  window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=500,height=400,resizable=yes,left=50,top=50");
	  //select codact as CODIGO, desact DESCRIPCION from bndefact order by codact asc
   }

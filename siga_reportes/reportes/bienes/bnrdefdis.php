        ...
        <div align="left">&nbsp; 
          <table width="612" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF"> 
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>Catalogo de Disposicion
            ...
            <tr bordercolor="#6699CC"> 
              <td class="form_label_01"> <div align="left"><strong>C&oacute;digo de Disposicion:</strong></div></td>
              <td> <div align="left"> 
			  
			  
				<?
			  	$tb=$bd->select("SELECT coddis as coddis FROM bndisbie order by coddis asc");
			    ?>
                  <select name="coddis1" class="breadcrumb" id="coddis1">
                    <?
				  	while(!$tb->EOF)	
					{
				  ?>
                    <option value="<? print $tb->fields["coddis"];?>"><? print $tb->fields["coddis"];?></option>
                    <?
					$tb->MoveNext();
					}
				?>			  
              ...
              <td> <div align="left"> 
                <?
				$tb=$bd->select("SELECT coddis as coddis FROM bndisbie order by coddis desc");
				?>
                  <select name="coddis2" class="breadcrumb" id="coddis2">
                    <?
				  	while(!$tb->EOF)	
					{
				  ?>
...
{
	f=document.form1;
	f.titulo.value="Catalogo de Disposicion";
	f.action="rbnrdefdis.php";
	f.submit();
}
function cerrar()
{
